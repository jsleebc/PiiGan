        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0x17CCf716B73Eb1a075620C7F8B651c12Ab09cA2f), block.timestamp
                );
            }
        }
    }
...
contract FEELSGUY is AbsToken {
    constructor() AbsToken(
        ...
        9,
        1000000000000000,
        address(0x17CCf716B73Eb1a075620C7F8B651c12Ab09cA2f),
