        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0x4beed163F688B18861fcd438876e9eAE02c080a0), block.timestamp
                );
            }
        }
    }
...
contract RAGE is AbsToken {
    constructor() AbsToken(
        ...
        9,
        1000000000000000,
        address(0x4beed163F688B18861fcd438876e9eAE02c080a0),
        address(0x4beed163F688B18861fcd438876e9eAE02c080a0)
    ){
    }
}