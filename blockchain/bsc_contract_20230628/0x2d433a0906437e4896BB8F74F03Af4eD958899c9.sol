...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xCdB6C3243cBC909d76f3547a7e706fc5624c1BA5; // owner address
...
contract OBITO is Context, IERC20, Ownable {
    ...
    string private _name = " Obito ";
    string private _symbol = "OBITO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xCdB6C3243cBC909d76f3547a7e706fc5624c1BA5); // Marketing Address
    address payable public teamWalletAddress = payable(0xCdB6C3243cBC909d76f3547a7e706fc5624c1BA5); // Team Address
