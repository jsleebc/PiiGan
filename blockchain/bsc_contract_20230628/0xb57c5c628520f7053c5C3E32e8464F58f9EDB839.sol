/**
https://t.me/PepesLamboOfficialBsc
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x296Bc20fd67403253af85585c6801D6f7794dC33; // owner address
...
contract PepesLamboOfficialBsc is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PEPE'S LAMBO";
    string private _symbol = "$PLAMBO";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x370868304DB85Bdb87d36F62BabC23fC42e6E0DD); // Marketing Address
    address payable private teamWalletAddress = payable(0x296Bc20fd67403253af85585c6801D6f7794dC33); // Team Address
