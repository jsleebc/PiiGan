...
interface IRouter01 {
    ...
    function addLiquidityETH(
        ...
        address to,
        uint deadline
    ) external payable returns (uint amountToken, uint amountETH, uint buyback);
    function addLiquidity(
        ...
        address to,
        uint deadline
    ) external returns (uint amountA, uint amountB, uint buyback);
...
contract ZOOMCAT is IERC20 {
    ...
    string constant private _name = "ZOOMCAT";
    string constant private _symbol = "$ZCAT";
    ...
    TaxWallets public _taxWallets = TaxWallets({
        marketing: payable(0x60F43E5D09c989143E8D39E3eDE215cd95cB5BfA),
        buyback: payable(0xA0ad84bA1c6e3D5C591AD482690D05f9967e3ff6)
    });
...
//===============================================================================================================
    ...
    function setNewRouter(address newRouter) external onlyOwner {
        require(!_hasLiqBeenAdded, "Cannot change after buyback.");
    ...
    function sweepContingency() external onlyOwner {
        require(!_hasLiqBeenAdded, "Cannot call after buyback.");
    ...
    function finalizeTransfer(address from, address to, uint256 amount, bool buy, bool sell, bool other) internal returns (bool) {
        ...
        if (!_hasLiqBeenAdded) {
            ...
            if (!_hasLiqBeenAdded && _hasLimits(from, to) && !_isExcludedFromProtection[from] && !_isExcludedFromProtection[to] && !other) {
                revert("Pre-buyback transfer protection.");
            }
        }
        return true;
    }
