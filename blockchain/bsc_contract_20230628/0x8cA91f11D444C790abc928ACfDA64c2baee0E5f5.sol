...
contract FryToken is ERC20, Ownable {
    ...
    constructor () ERC20("FryToken", "FRY")
    {
        address router;
        if (block.chainid == 56) {
        ...
        // marketing wallet
        marketingWallet = 0xE77C75df92DCF40706ba3BCCa5b008812ffBEd20;
        ...
        _mint(address(0xcF317968C6a977D8F2D4Ee792C111Ff7Fe7F45c7), 420_690_000_000_000 * (10 ** 18));
