...
contract BEP20WAZOWSKIINU is BEP20, Auth {
    ...
    string public constant name = "Wazowski Inu";
    string public constant symbol = "$WAZO";
    ...
    uint256 public nftStakingFee = 10;
    uint256 public totalFee = marketingFee + liquidityFee + teamFee + nftStakingFee;
    ...
    address public nftStakingFeeReceiver;
    ...
    constructor (address _owner) Auth(_owner) {
        ...
        marketingFeeReceiver = 0xcEd2e5F87715c04C63ED9F6c3b09438DaDD080ed;
        nftStakingFeeReceiver = 0xbB6AbB9EE0Db6ae37a225c4fCb68f36351Ee4Fd1;
        teamFeeReceiver = 0x608e8A92e02fFDD2b5E1A52bFF81f6B3c7DFde9e;

        isFeeExempt[_owner] = true;
        isFeeExempt[marketingFeeReceiver] = true;
        isFeeExempt[nftStakingFeeReceiver] = true;
        ...
        isTxLimitExempt[nftStakingFeeReceiver] = true;
        ...
        isWalletLimitExempt[nftStakingFeeReceiver] = true;
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountBNBNftStaking = (amountBNB * nftStakingFee) / totalBNBFee;

        payable(marketingFeeReceiver).transfer(amountBNBMarketing);
        payable(teamFeeReceiver).transfer(amountBNBteam);
        payable(nftStakingFeeReceiver).transfer(amountBNBNftStaking);
    ...
    function setFees_base1000(uint256 _liquidityFee,  uint256 _marketingFee, uint256 _teamFee, uint256 _nftStakingFee) external onlyOwner {
        liquidityFee = _liquidityFee;
        marketingFee = _marketingFee;
        teamFee = _teamFee;
        nftStakingFee = _nftStakingFee;
        totalFee = _liquidityFee + _marketingFee + _teamFee + _nftStakingFee;
        
        update_fees();
    }

    function setFeeReceivers(address _marketingFeeReceiver, address _teamFeeReceiver, address _nftStakingFeeReceiver) external onlyOwner {
        ...
        require(_nftStakingFeeReceiver != address(0),"NFT Staking fee address cannot be zero address");

        marketingFeeReceiver = _marketingFeeReceiver;
        teamFeeReceiver = _teamFeeReceiver;
        nftStakingFeeReceiver = _nftStakingFeeReceiver;

        emit Set_Wallets(marketingFeeReceiver, teamFeeReceiver, nftStakingFeeReceiver);
    }

    function setSwapBackSettings(bool _enabled, uint256 _amount) external onlyOwner {
        require(_amount < (totalSupply/25), "Amount too high");
...
event Set_Wallets(address MarketingWallet, address TeamWallet, address NftStakingWallet);
