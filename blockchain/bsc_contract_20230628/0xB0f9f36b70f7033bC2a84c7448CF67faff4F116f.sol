...
contract OSHIB is Context, IBEP20, Ownable {
    ...
    string private _name = "Optimism Shib";
    ...
    uint256 public numTokensSellToAddToLiquidity = 1200000 * 10 ** _decimals;

    address public _market = 0xcD39db939B5cBA2664F45B8AC7568bf00446FE4c;
    address public _receiver = 0x3349C314504AFf44092C54FdD041366295D603FC;
    ...
    constructor() {
        ...
        emit Transfer(address(0), _receiver, _tTotal);
    }
