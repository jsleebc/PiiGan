/**
TELEGRAM : https://t.me/STOPEPEBSC

🐸 ⛔️ STOPEPE ⛔️ 🐸 is a global movement against Pepe projects.

📌 Our Vision is to kill every Pepe theme project and make STOPEPE known worldwide. 

🔥 We will not stop until we hit higher Market Cap than the original Pepe!

Are you ready to kill the fucking Pepe 🐸 ⛔️ ⁉️
*/

pragma solidity ^0.8.5;
// SPDX-License-Identifier: MIT

//https://t.me/SquidChad
interface IERC20 {
...
contract STOPEPE is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xfd65B47859BF32E223Fa178591274cf8b8c18300); 
    address payable public Wallet_Dev = payable(0xfd65B47859BF32E223Fa178591274cf8b8c18300);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =1000000 * 10**6* 10**6 * 10**_decimals;
    string private constant _name = "STOPEPE"; 
    string private constant _symbol = unicode"$STOPEPE"; 
    uint8 private txCount = 0;
    uint8 private swapTrigger = 10; 
    uint256 public _Tax_On_Buy = 5;
    uint256 public _Tax_On_Sell = 5;
    uint256 public Percent_Marketing = 77;
    uint256 public Percent_Dev = 0;
    uint256 public Percent_Burn = 10;
    uint256 public Percent_AutoLP = 13; 
    ...
    constructor () {
        _owner =0xfd65B47859BF32E223Fa178591274cf8b8c18300;
