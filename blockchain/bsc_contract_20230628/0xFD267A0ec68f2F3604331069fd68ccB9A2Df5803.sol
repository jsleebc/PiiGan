...
Telegram : https://t.me/SatoshiNakamotoBep20
Twitter : https://twitter.com/SatoshiBSC
*/
...
contract SATOSHI is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x835531050bEFe8512D75F15f51C8d7E8D90CfD3D); 
    address payable public teamWalletAddress = payable(0x835531050bEFe8512D75F15f51C8d7E8D90CfD3D); 
    ...
    uint256 private _totalSupply = 60501 * 10**_decimals; 
    ...
    function setWalletLimit(uint256 newLimit) external onlyOwner {
        _walletMax  = _totalSupply * newLimit / 100;
    }

    function setNumTokensBeforeSwap(uint256 newLimit) external onlyOwner() {
        minimumTokensBeforeSwap = _totalSupply * newLimit / 100;
    }
