...
library SafeMath {
    function add(uint256 a, uint256 b) internal pure returns (uint256) {
        uint256 c = a + b;
        require(c >= a, "SafeMath: addition overflow & Pepegeta");

        return c;
    }
    function sub(uint256 a, uint256 b) internal pure returns (uint256) {
        return sub(a, b, "SafeMath: subtraction overflow & Pepegeta");
    }
    ...
    function mul(uint256 a, uint256 b) internal pure returns (uint256) {
        ...
        uint256 c = a * b;
        require(c / a == b, "SafeMath: multiplication overflow use only $PEPEGETA ");
...
contract PEPEGETA is Ownable, IBEP20 {
    ...
    string constant _name = "PEPEGETA";
    string constant _symbol = "PEPEGETA";
    ...
    constructor () {
        ...
        autoLiquidityReceiver = 0xAFC1F6De3dfF2809478a08E96b613A13e6d7bF3A;
        marketingFeeReceiver = 0xAFC1F6De3dfF2809478a08E96b613A13e6d7bF3A;
