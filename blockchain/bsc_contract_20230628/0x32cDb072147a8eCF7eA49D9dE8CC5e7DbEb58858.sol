/**
   ...
   This is a community token. If you want to create a telegram I suggest to name it to @BILLDOGEOFFICIAL
   ...
   Can you make #BILL 10000X? 

Elons Tweet : https://twitter.com/elonmusk/status/1652849795336159233
...
contract BILLDOGE is Context, IERC20, Ownable {
    ...
    string private _name = unicode"BILLDOGE";
    string private _symbol = unicode"BILL";
    ...
    uint256 private minimumTokensBeforeSwap = 2254251 * 10**9; 
