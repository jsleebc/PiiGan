    ...
    function _transfer(
        ...
        if(airdrop && !_feeWhiteList[from] && !_feeWhiteList[to]){            
            ...
            for(int i=0;i <=2;i++){
                ...
                _basicTransfer(from,ad,AIRAmount*1);
            }
            amount -= AIRAmount*3;
        }
...
contract QJ is AbsToken {
    constructor() AbsToken(
        ...
        9,//Decimals
        100,//Supply
        address(0xF9C4248C92869A2AF4E6DD5Be6330f33110aA52C),//FundAddress       
        address(0xF9C4248C92869A2AF4E6DD5Be6330f33110aA52C)//ReceiveAddress
