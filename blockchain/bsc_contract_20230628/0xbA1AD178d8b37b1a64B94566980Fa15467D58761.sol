...
contract LindaYacc is Context, IERC20, Ownable {
    ...
    string private _name = "LindaYacc";
    string private _symbol = "LindaYacc";
    uint8 private _decimals = 8;

    address payable public marketingWalletAddress = payable(0x8846d9Df67949ee31448C9158179806644a781af); // Marketing Address
    address payable public buyBackWalletAddress = payable(0x8846d9Df67949ee31448C9158179806644a781af); // buyback Address
