...
contract GDA is Context, IERC20, Ownable {
    ...
    string private _name     = "Great Dog Again";
    string private _symbol   = "GDA";
    uint8  private _decimals = 9;
   
    uint256 private constant MAX = type(uint256).max;
    uint256 private _tTotal = 210_000_000_000_000_000 * (10 ** _decimals);
    ...
    { 
        ...
        marketingWallet = 0x23CE221061C66C3f9Fa21C7e8256737b400A542f;
        cexWallet = 0xDB23349F1dD97398e57750820E60abB61113E438;
        ...
        _isExcludedFromFees[address(cexWallet)] = true;
        ...
        _rOwned[address(cexWallet)] = _rTotal;
        _tOwned[address(cexWallet)] = _tTotal;

        emit Transfer(address(0), address(cexWallet), _tTotal);
    }
