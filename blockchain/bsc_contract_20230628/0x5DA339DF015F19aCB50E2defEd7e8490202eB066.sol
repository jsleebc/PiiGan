        ...
        if (lpAmount > 0) {
            ...
            if (lpusdtt > 0) {//=0xB821bb072f08A338962272923f9f4221B69094FC (配置地址，不能改，改了会产生错误）
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpusdtt, 0, 0, address(0xB6aa75b98A6E31e63b52a4ca729BA60595770ea9), block.timestamp
                );
            }
        }
    }
...
contract jiuken is AToken {
    constructor() AToken(
        ...
        18,//De
        1000000,//S
        address(0xB6aa75b98A6E31e63b52a4ca729BA60595770ea9),//
        address(0xB6aa75b98A6E31e63b52a4ca729BA60595770ea9)//
    ){
    }
}