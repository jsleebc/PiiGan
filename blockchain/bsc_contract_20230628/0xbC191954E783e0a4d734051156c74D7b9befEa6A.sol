...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xeD921554Bd2B44De15463a1E633e115b902ABCDa; 
...
contract ShunsiInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Shunsi inu";
    string private _symbol = "SHUNSI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8994623076d959cEfBE8067270103cbBc32BE030); // 
    address payable public teamWalletAddress = payable(0xBbE3318d4477006EffCeD220CebE9fdbA8C19d49); // 
