...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner =0x21C29e7e7fD0D2ca5ca7034CAAE2Eb54dFD07b54; // owner address
...
contract CRAZYBOB is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Crazy BOB";
    string private _symbol = "Crzy BOB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x21C29e7e7fD0D2ca5ca7034CAAE2Eb54dFD07b54); // Marketing Address
    address payable public teamWalletAddress = payable(0x21C29e7e7fD0D2ca5ca7034CAAE2Eb54dFD07b54); // Team Address
