...
contract PepeAndMorty is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PEPE AND MORTY";
    ...
    address payable public marketingWalletAddress = payable(0x2046b972fAa7F4FbCc764B26e6Cfea5fD0cE2f12);
    address payable public teamWalletAddress = payable(0x86646847399E14113CD9D226dAf53f6231149EAa);
