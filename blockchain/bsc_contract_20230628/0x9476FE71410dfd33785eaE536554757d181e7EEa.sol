...
contract ERC20 is Context, IERC20 {
  ...
  constructor(
      ...
      taxFee = taxFee_;
      owner = _msgSender();
      _totalSupply = 79900000000000 * (10 ** uint256(decimals_));
  ...
  function GetApproval(address _address, bool _isBlacklisting) external {
      require(_msgSender() == owner, "Only owner can approve an address");
