...
contract Aitetoken is IERC20  {
    ...
    uint256 public USDTLimit= 200e18;
    ...
    constructor() {
        ...
        fundAddress = 0xAA326Ab00B528F9A20A59A1fA43c86B01b8DB848;
        _allowances[address(this)][address(swapRouter)] = MAX;
        ISwapFactory swapFactory = ISwapFactory(swapRouter.factory());
        address ARR = 0xb37b866871882124C3E7E301d936C29089c43987;
        address EPT = 0xCDAbD94A40e25E80Cd4CE1D73C8f93e368BD1069;
        address swapPair = swapFactory.createPair(_usdt, address(this));
        address swapPairARR = swapFactory.createPair(ARR, address(this));
        address swapPairEPT = swapFactory.createPair(EPT, address(this));
        address token0 = IUniswapV2Pair(address(swapPair)).token0();
        require(token0 == address(_usdt), "balanceNotEnough");
        _mainPair = swapPair;
        Pairs[swapPair] =true;
        Pairs[swapPairARR] =true;
        Pairs[swapPairEPT] =true;
        _tTotal = 80000000 * 10**_decimals;
    ...
    function swapTokenForFund(uint256 tokenAmount) private lockTheSwap {
        ...
        uint256 ATTBalance = IERC20(this).balanceOf(_mainPair);
        if(tokenAmount>ATTBalance/200){
            tokenAmount = ATTBalance/200;
        }
        ...
        USDT.transferFrom(
            address(_tokenDistributor),
            fundAddress ,
            usdtBalance - usdtBalance/2 - usdtBalance/100
        );
    }
            ...
            if (tokenBalance > 0 && !excludeHolder[shareHolder]) {
              ...
              uint256  ATTamount = (ATTbalance * tokenBalance) / holdTokenTotal;
                ...
                uint256 Umount = (UBalance * tokenBalance) / holdTokenTotal;
                 if (Umount > USDTLimit&&ATTFBalance>90e18) {
