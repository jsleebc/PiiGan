...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x0a728e44891479F90A57Def322F2Fa27dB7A8BB9; // owner address
...
contract UPTREND is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "UPTREND";
    string private _symbol = "UPTREND";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0a728e44891479F90A57Def322F2Fa27dB7A8BB9); // Marketing Address
    address payable public teamWalletAddress = payable(0x0a728e44891479F90A57Def322F2Fa27dB7A8BB9); // Team Address
