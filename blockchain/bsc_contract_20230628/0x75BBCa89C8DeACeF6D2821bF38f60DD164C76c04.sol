...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x879A48706D210f46f1a573050fE3fE92f1e3ce52; // owner address
...
contract PEPOPO is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PEPOPO";
    string private _symbol = "PEPOPO";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xCE79950772bC7f55a5d1Bdc4C1543e8aFE91E098); // Marketing Address
    address payable private teamWalletAddress = payable(0xCE79950772bC7f55a5d1Bdc4C1543e8aFE91E098); // Team Address
