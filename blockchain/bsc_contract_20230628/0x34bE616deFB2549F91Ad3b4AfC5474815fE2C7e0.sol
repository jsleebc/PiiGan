/**
    $BOB and $BOBA mooning over multi miliions MC. 
    BOBITA is their daughter and has full of potential to follow the parents.

    Telegram: https://t.me/bobitabsc
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x25e4D76b3507B38Cb8755Bee0A9129b5E8Ffcf14; // owner address
...
contract Bobita is Context, IERC20, Ownable {
    ...
    string private _name = " BOBITA ";
    string private _symbol = "BOBITA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x25e4D76b3507B38Cb8755Bee0A9129b5E8Ffcf14); // Marketing Address
    address payable public teamWalletAddress = payable(0x25e4D76b3507B38Cb8755Bee0A9129b5E8Ffcf14); // Team Address
