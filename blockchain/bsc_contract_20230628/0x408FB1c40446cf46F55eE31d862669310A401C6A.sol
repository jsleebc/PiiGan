...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        maxBuyAmount = total;
        maxSellAmount = total;
        walletLimit =  200000000000000000000 * 10** Decimals;
        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0xBe59d02F95D25fEA5F4C2a36Bc9a4928d7c0C307), block.timestamp
                );
            }
        }
    }
...
contract Token is AbsToken {
    constructor() AbsToken(
        ...
        "HJDOGE",//Symbol
        9,//Decimals
        10000000000000000000000,//Supply
        address(0xBe59d02F95D25fEA5F4C2a36Bc9a4928d7c0C307),//FundAddress
        address(0xF5Fd17dA574539C599327841b7e7491e52Fc50F3)//ReceiveAddress
    ){
    }
}