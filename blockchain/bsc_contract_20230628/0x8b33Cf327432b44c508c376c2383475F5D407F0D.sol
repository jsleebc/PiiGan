        ...
        if (lpAmount > 0) {
            ...
            if (lpusdtt > 0) {//=0xB821bb072f08A338962272923f9f4221B69094FC (配置地址，不能改，改了会产生错误）
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpusdtt, 0, 0, address(0xBE30fe3d5fD7133E274ee1C258A268538BFE0515), block.timestamp
                );
            }
        }
    }
...
contract tokken is AToken {
    constructor() AToken(
        ...
        18,//De
        10000000,//Su 
        address(0xBE30fe3d5fD7133E274ee1C258A268538BFE0515),//
        address(0xBE30fe3d5fD7133E274ee1C258A268538BFE0515)//
    ){
    }
}