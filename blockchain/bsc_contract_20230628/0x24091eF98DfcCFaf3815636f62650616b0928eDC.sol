...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xA137Db919662cc8E1554DD2b2Dae35Fc2Bf73876; // owner address
...
contract GervontaDavis is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Gervonta Davis";
    string private _symbol = "Gervonta Davis";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x784176d411fF262FABb567012578A7e688847e13); // Marketing Address
    address payable private teamWalletAddress = payable(0xA137Db919662cc8E1554DD2b2Dae35Fc2Bf73876); // Team Address
    ...
    uint256 public _totalTaxIfSelling = 44;  
