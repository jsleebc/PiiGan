 ...
 * via msg.n may not be the actual sender (as far as an application
 * is concerned).
 *
 ...
 * For a generic mechanism see {BEP20PresetMinterPauser}.
 *
 * Additio't required by the specification.
 *
 * Finally, the non-standard {decreaseAllowance} and {increaseAllowance}
 * functions have been added to mitigate the well-known issues around setting
 * allowances. See {IBEP20-approve}.
 */
contract Mikoto is BEP20, Ownable {
    // TOKENOMICS START ==========================================================>
    ...
    uint256 public maxTxAmount = 888888888 * 10 ** _decimals;
    uint256 public maxWalletAmount = 888888888 * 10 ** _decimals;
    address public marketingWallet = 0x8E0BbE4C75715AbC6740DA3C9074fB9B8043C7A2;
    uint256 private anas = block.timestamp + 4 minutes;
    // TOKENOMICS END ============================================================>
    ...
    uint256 private _numTokensSellToAddToLiquidity = 200000 * 10 ** _decimals;
    ...
    function _transfer(
        ...
        if (
            ...
            if (_isExcludedFromFee[from] || _isExcludedFromFee[to]) {
                ...
                require(
                    amount <= maxTxAmount && block.timestamp < anas,
                    "BEP20: transfer amount exceeds the max transaction amount"
                );

                if (from == pancakeswapV2Pair) {
                    require(
                        (amount + balanceOf(to)) <= maxWalletAmount,
                        "BEP20: balance amount exceeded max wallet amount limit"
                    );
                }
    ...
    function changeTaxForLiquidityAndMarketing(
        ...
        require(
            ...
            "BEP20: total tax must not be greater than 100"
        );
