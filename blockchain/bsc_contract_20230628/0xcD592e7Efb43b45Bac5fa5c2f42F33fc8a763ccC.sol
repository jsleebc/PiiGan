...
contract Ownable is Context {
    address private _owner = 0xC802a755f25bAea5a942E92099B7bF0E30a7f8d2;
...
contract SAVECZ is Context, IBEP20, Ownable { 
    ...
    address payable public _marketingAddress = payable(0xC802a755f25bAea5a942E92099B7bF0E30a7f8d2); // Marketing Address
    address payable public _burnAddress = payable(0x000000000000000000000000000000000000dEaD); // Burn Address

    string private _name = "SAVECZ"; 
    ...
    uint256 public _minTokensSwapToAndTransferTo = 1 * 10**4 * 10**_decimals; 
