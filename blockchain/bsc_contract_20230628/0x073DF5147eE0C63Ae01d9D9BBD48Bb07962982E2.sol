...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x3871EFF5f49d256A78CCb2f43582cE4124E3fd45; 
...
contract HexosNetwork is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Hexos Network";
    string private _symbol = "HXS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3871EFF5f49d256A78CCb2f43582cE4124E3fd45); // 
    address payable public teamWalletAddress = payable(0x3871EFF5f49d256A78CCb2f43582cE4124E3fd45); // 
