...
contract AbsToken is IERC20, Ownable {
    ...
    address private fundAddress = 0x43f8A8fbd9DAC8D1Eb94C0dE7F336319d7d278Ce;
    address private receiveAddress = 0x9B41D3133236Af4ae8F70b107e192C51E9a0aCe4;

    string private _name = "K02";
    string private _symbol = "K02";
    uint8 private _decimals = 6;

    mapping(address => bool) public _feeWhiteList;
    mapping(address => bool) public _blackList;
    mapping(address => bool) public _lockAddressList;
    mapping(address => bool) public _PreWhiteList;   
    ...
    uint256 public startPreWhiteBlock;
    ...
    function _transfer(
        ...
        if (!_feeWhiteList[from] && !_feeWhiteList[to]) {
            ...
            if (0 == startTradeBlock) {
                if (startPreWhiteBlock > 0 && (_PreWhiteList[to])) {

                } else {
                    require(0 < startAddLPTime && _swapPairList[to], "!startAddLP");
                }
            }
            ...
            if (_swapPairList[from]) {
				require(0 < startTradeBlock || _PreWhiteList[to], "!Trading");
    ...
    function startPreWhite() external onlyOwner {
        require(0 == startPreWhiteBlock, "trading");
        startPreWhiteBlock = block.number;
    }
    ...
    function SetPreWhiteList(address [] calldata addList, bool enable) external onlyOwner {
        for (uint256 i = 0; i < addList.length; i++) {
            _PreWhiteList[addList[i]] = enable;
        }
    }    
