...
contract BEP20FTC is Context, IBEP20, Ownable {
    ...
    string public _name;
    uint256 public constant INIT_BLOCK_TIME = 1686074400;
    ...
    function liquidSupply() public view returns (uint256) {
        ...
        uint256 liquidAmt = day.mul(day.add(1)).mul(800e18);
        ...
        returns (bool)
    {
        ...
        require(_balances[address(this)] >= lockedSupply(), "Exceeding liquid supply");
