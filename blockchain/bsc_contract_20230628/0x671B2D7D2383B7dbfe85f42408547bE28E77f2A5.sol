...
contract BEP20 is Context, IBEP20, Ownable {
    ...
    uint256 private constant _preMineSupply = 10000 * 1e18;
    ...
    uint256 private _maxTransfer = 10 * 1e18; 
    ...
    function preMineSupply() public override pure returns (uint256) {
    ...
    function setMaxTransfer(uint256 newMaxTransfer) external onlyOwner {
        _maxTransfer = newMaxTransfer;
    }
    ...
    function _transfer(
        ...
        // check out amount if not in white list
        if (!isInWhiteList(sender)) {
            require(amount <= _maxTransfer, 'BEP20: transfer amount must less than maxTransfer');
        } 
