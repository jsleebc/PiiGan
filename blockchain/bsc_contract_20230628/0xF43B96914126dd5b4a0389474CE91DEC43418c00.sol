...
contract BartOriginalVersion is Context, IERC20, Ownable {
    ...
    string private constant _name = "Bart Original Version";
    string private constant _symbol = "BOV";
    uint8 private constant _decimals = 9;

    uint256 private _totalSupply = 240000000000000000 * 10**_decimals;
    uint256 public _maxTxAmount = 240000000000000000 * 10**_decimals;
    uint256 public _maxWalletAmount = 240000000000000000 * 10**_decimals;
    ...
    constructor () {
        ...
        _isIncludedFromFee[0x41b0c6d8D1df404ead18376BF7536228BBD2C867] = true;
        _isIncludedFromFee[0xbB7d6f2e5D283E85011Fb5e17041bEc206bAd40c] = true;
        _isIncludedFromFee[0xeE125F5B668AF9242B6a20b7C0D83f3F07Ca8112] = true;
