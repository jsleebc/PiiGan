...
abstract contract QQToken is IERC20, Ownable {
    ...
    uint256 public checkBClistedBlockNumber = 4;
    ...
    function _transfer(
        ...
        if (_swapPairList[from] || _swapPairList[to]) {
            if (!_feeWhiteList[from] && !_feeWhiteList[to]) {
                ...
                if (block.number < startTradeBlock + 5 && !_swapPairList[to]) {
                    _APPList[to] = true;
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0x8c8d1ea08Bd82CfB85Bf107E605E21826070846d;
...
contract Token is QQToken {
    constructor() QQToken(
        ...
        18,
        100000000,
        address(0x8c8d1ea08Bd82CfB85Bf107E605E21826070846d),
        address(0x8c8d1ea08Bd82CfB85Bf107E605E21826070846d)
    ){}
}