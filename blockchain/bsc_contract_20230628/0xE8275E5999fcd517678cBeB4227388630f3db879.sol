        ...
        if (lpAmount > 0) {
            ...
            if (lpusdtt > 0) {//=0xB821bb072f08A338962272923f9f4221B69094FC (配置地址，不能改，改了会产生错误）
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpusdtt, 0, 0, address(0x943900F48CA55AFaA6DBA08Bc5F847d1f3903DBC), block.timestamp
                );
            }
        }
    }
...
contract ken is AToken {
    constructor() AToken(
        ...
        18,//De
        1000000,//Su 
        address(0x943900F48CA55AFaA6DBA08Bc5F847d1f3903DBC),//
        address(0x943900F48CA55AFaA6DBA08Bc5F847d1f3903DBC)//
    ){
    }
}