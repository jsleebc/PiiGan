...
// File: contracts/interfaces/BNBSHIBBonusPool.sol


pragma solidity >=0.5.0;

interface BNBSHIBBonusPool {
...
// File: contracts/token/BNBSHIB.sol


pragma solidity =0.8.19;

contract BNBSHIB is ERC20, Ownable {
    ...
    constructor(
        ...
        address _swapRouter,
        address _weth
    ) ERC20("BNBSHIB", "BNBSHIB") {
        uint256 _totalSupply = 2_222_222_222_222_222_222 * 1e6;
    ...
    function swapBack() internal swapping {
        ...
        BNBSHIBBonusPool(bonusWallet).injectRewards(amountDogBonus);
