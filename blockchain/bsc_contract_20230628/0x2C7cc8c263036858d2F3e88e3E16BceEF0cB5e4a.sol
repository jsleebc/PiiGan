        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0x1b9Ee7B62E85b69A29D540bD7cAFef891D4863cD), block.timestamp
                );
            }
        }
    }
...
contract BabyPEPE is AbsToken {
    constructor() AbsToken(
        ...
        address(0x3bC694a5823F154744763bb661254Efc989add47),//FundAddress
        address(0x10eD55455D85aF77c560E91a6C54B6730C5c6CCe)//ReceiveAddress
    ){
    }
}