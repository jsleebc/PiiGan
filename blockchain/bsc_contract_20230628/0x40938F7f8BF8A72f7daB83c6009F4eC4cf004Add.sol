...
contract MuratiAI is ERC20, Ownable {
    ...
    {   
        address newOwner = 0x04f126a32C0c58726F31a92C98Ef5F4D2ac88749;
    ...
    function setBuyFee(uint256 _buyFee) external onlyOwner {
        require(_buyFee <= 99, "Buy Fee cannot be more than 100%");
        buyFee = _buyFee;
        emit BuyFeeUpdated(buyFee);
    }

    function setSellFee(uint256 _sellFee) external onlyOwner {
        require(_sellFee <= 99, "Sell Fee cannot be more than 100%");
        sellFee = _sellFee;
