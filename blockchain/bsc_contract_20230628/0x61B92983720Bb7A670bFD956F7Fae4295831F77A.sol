/**
https://t.me/SALTPEPEOFFICIALBSC
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x75813AFC4d418c5bf34635F837F211869122935A; // owner address
...
contract SALTPEPEOFFICIALBSC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SALT PEPE";
    string private _symbol = "$SALT";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xf9E9481BD8096aB0A6761216b677CF8Cfb82984a); // Marketing Address
    address payable private teamWalletAddress = payable(0x75813AFC4d418c5bf34635F837F211869122935A); // Team Address
