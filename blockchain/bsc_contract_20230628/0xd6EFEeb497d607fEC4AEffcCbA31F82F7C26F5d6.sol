...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xaEe07421475d06630fD706aD404695a1cF1b4E08;
...
contract PEPEBOOM is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x218e07B572e9Ea16CEb623A443C20D0Dc0385Deb;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "PEPEBOOM";
    string private _symbol = "PEPEBO";
