/**
Telegram: https://t.me/HalfPepeGLOBAL
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xAfF66e0DC8DD00af6c8b7A132FA847F83525448b; // owner address
...
contract HAPE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Half Pepe";
    string private _symbol = "HAPE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0Ec3e65cF56c957f37D2507d3011a0dE56DEd1e1); // Marketing Address
    address payable public teamWalletAddress = payable(0x0Ec3e65cF56c957f37D2507d3011a0dE56DEd1e1); // Team Address
