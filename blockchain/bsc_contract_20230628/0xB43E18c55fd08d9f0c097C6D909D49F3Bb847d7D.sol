...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2F4c507e35382993625A3291C150ECA5E30827F2; // owner address
...
contract BartPepe is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Bart Pepe";
    string private _symbol = "BP";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xBb74347ceD817902e13A7C46807772a6B729F6b3); // Marketing Address
    address payable private teamWalletAddress = payable(0x2F4c507e35382993625A3291C150ECA5E30827F2); // Team Address
