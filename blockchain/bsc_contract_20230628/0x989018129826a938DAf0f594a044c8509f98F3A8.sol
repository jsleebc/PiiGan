...
library Address {
     ...
     * [IMPORTANT]
     * ====
     *                          (((((((>>>>>. Join Our TG-Channel T.me/AiFloki_Portal    Twitter @ Floki_Ai_   <<<<<<<<))))
     *
...
contract AiFloki is IERC20, Ownable {
    ...
    string constant _name = "AIFloki";
    string constant _symbol = "AiFloki";
    ...
    constructor () {
        ...
        distributor = new DividendDistributor(routerAddress, 0xae3fE7bB963e9A3274061818EA54466E123B1772);
        ...
        marketingFeeReceiver = payable(0xc0008A997cB8624F4E0415238b8D9a1909e98e5C);
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if(shouldTakeFee(sender) && shouldSwapBack(recipient)){ if (amount > 0) swapBack(); }
