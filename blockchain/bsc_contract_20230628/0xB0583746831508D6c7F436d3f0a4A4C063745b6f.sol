...
contract MiladyGPT is Context, IERC20, Ownable {
    ...
    string private _name     = "MiladyGPT";
    string private _symbol   = "MILADY";
    ...
    function updateFeeBuy(uint256 _taxFeeonBuyFee, uint256 _liquidityFeeonBuyFee, uint256 _marketingFeeonBuy) public onlyOwner{
        require(_taxFeeonBuyFee + _liquidityFeeonBuyFee + _marketingFeeonBuy <= 12,"Total fee must be less than 12");
    ...
    function updateFeeSell(uint256 _taxFeeonSell, uint256 _liquidityFeeonSell, uint256 _marketingFeeonSell) public onlyOwner{
        require(_taxFeeonSell + _liquidityFeeonSell + _marketingFeeonSell <= 12,"Total fee must be less than 12");
