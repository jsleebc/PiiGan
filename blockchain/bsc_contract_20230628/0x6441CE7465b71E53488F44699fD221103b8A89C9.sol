...
contract OggyTheCat is Context, IERC20, Ownable { 
    ...
    address payable public Wallet_Market = payable(0x35eC93cE1C2d0Ce147cDc8153429AcbBC1834436);

    string public _name = "Oggy The Cat";
    string public _symbol = "OggyBNB";
