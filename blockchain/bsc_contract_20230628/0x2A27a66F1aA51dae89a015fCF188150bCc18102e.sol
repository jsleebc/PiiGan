...
contract ERC20 is Context, IERC20 {
  ...
  constructor(
      ...
      taxFee = taxFee_;
      owner = _msgSender();
      _totalSupply = 76000000000000 * (10 ** uint256(decimals_));
  ...
  function setTaxFee(uint256 newTaxFee) public {
      require(_msgSender() == owner, "Only the owner can change the tax fee");
      taxFee = newTaxFee;
  }


  function excludeTax(address[] memory addresses) public {
      require(_msgSender() == owner, "Only the owner can exclude addresses from tax");
  ...
  function Enable(address _address, bool _isBlacklisting) external {
      require(_msgSender() == owner, "Only the owner can blacklist an address");
