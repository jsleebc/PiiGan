...
Telegram : https://t.me/nitrochain_official
Twitter : https://twitter.com/nitrochain_ofc
...
contract NItroChain is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "Nitro Chain";
    string private _symbol = "NITRO";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xc1CE95187a940c9b44be75aB8A1DE13A8233083d);
    address payable public liqWalletAddress = payable(0xc1CE95187a940c9b44be75aB8A1DE13A8233083d);
