/*
Telegram : https://t.me/ThetaNetworkChannel
Website : https://theta-network.live
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xBd4d7189a6aF7A5CFe6EF843fADa9289775fEb9c; // Theta Dev
...
contract ThetaSwap is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Theta Swap";
    string private _symbol = "$THETASWAP";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8480a7F19b96E872Cc9B873E2ACdA5363475BbCC); // 
    address payable public earnWalletAddress = payable(0x8480a7F19b96E872Cc9B873E2ACdA5363475BbCC); // 
