...
Telegram : https://t.me/PepeLfg
Website  : https://pepelfg.com/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xd77648dCA8ab4760B6FE323964A4fe6A609AC6D2; // owner address
...
contract PEPELFG is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " Pepe LFG ";
    string private _symbol = " Pepe LFG ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x823A6482d4F708F825847E9Fc1Aa9f38406Bd428); // 
    address payable public teamWalletAddress = payable(0xd77648dCA8ab4760B6FE323964A4fe6A609AC6D2); // 
    ...
    uint256 public _walletMax = 8413800000000 * 10**_decimals;
    uint256 private minimumTokensBeforeSwap = 420690000000 * 10**_decimals; 
