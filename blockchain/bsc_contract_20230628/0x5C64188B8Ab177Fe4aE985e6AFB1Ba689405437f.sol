...
contract WOJAKSIMPSON is Context, IERC20, Ownable {
    ...
    string private constant _name = "Wojak Simpson";
    string private constant _symbol = "WOMPSON";
    uint8 private constant _decimals = 9;
    
    uint256 private _tTotal = 69420000 * 10**9 * 10**9;
