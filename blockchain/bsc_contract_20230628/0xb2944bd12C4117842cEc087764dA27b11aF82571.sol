...
contract PepeEverywhere is IBEP20, Auth {
    ...
    address constant DEV = 0xAd95a084E87108C057a5a1d70E73FFE3eF1Ec5FC;


    string constant _name = "PEPE EVERYWHERE";
    string constant _symbol = "PEVRWR";
    ...
    uint256 public _maxWalletToken = ( _totalSupply * 35 ) / 1000;
