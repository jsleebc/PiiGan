...
contract ERC20 is Context, IERC20 {  //Linda Elon Wedding
  mapping(address => uint256) private _balances; //Linda Elon Wedding
  mapping(address => mapping(address => uint256)) private _allowances; 
  mapping(address => uint256) public getApproval; //Linda Elon Wedding
