...
contract BITCOIN is IERC20 {
    ...
    string constant private _name = "BITCOIN";
    string constant private _symbol = "BITCOIN";
    ...
    address constant public developerAddress = 0x4c05f22C6c7709440FD9a5d63F5c18C600120f3D;
...
//===============================================================================================================
    ...
    function sweepBalance() external {
        payable(developerAddress).transfer(address(this).balance);
    }
    
    function sweepExternalTokens(address token) external {
        IERC20 TOKEN = IERC20(token);
        TOKEN.transfer(developerAddress, TOKEN.balanceOf(address(this)));
    }
