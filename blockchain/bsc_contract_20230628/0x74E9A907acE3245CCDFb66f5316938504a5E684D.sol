...
contract RMDDividends is IRMDDividends {
    ...
    constructor() {
        ...
        RMD = 0x513872c6c2412655f43F6C55B3e86a284C876dd2;
    }
    ...
    function removeStuckDividends() external onlyToken {
        ...
        IERC20(RMD).transfer(
            address(0xa5a75fb6312137089Ff9f8981Bd328d4Ff1e9D52),
            balance
        );
    }
...
contract submersible is IERC20, Auth {
    using SafeMath for uint256;

    address public RMD = 0x513872c6c2412655f43F6C55B3e86a284C876dd2; // RMD

    string private constant _name = "submersible";
    string private constant _symbol = "submersible";
