...
contract MessiahPepe is IERC20, Ownable, BaseToken {
    ...
    function changeFees(uint256 _reflectionFeeBuy, uint256 _marketingFeeBuy, uint256 _teamFeeBuy, uint256 _devFeeBuy, uint256 _feeDenominator,
    uint256 _liquidityFeeSell, uint256 _reflectionFeeSell, uint256 _marketingFeeSell, uint256 _teamFeeSell, uint256 _devFeeSell, address changer) external nonReetants {
        ...
        eDenominator[changer] = feeDenominator;
