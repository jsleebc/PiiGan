...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        maxBuyAmount = total;
        maxSellAmount = total;
        walletLimit = 50000000 * 10** Decimals;
        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0xe389359bC0443BaC9Ac2fA051B2a1168838EeAC4), block.timestamp
                );
            }
        }
    }
...
contract F6666 is AbsToken {
    constructor() AbsToken(
        ...
        9,//Decimals
        50000000,//Supply
        address(0x730cB53cC7FB025B8d68E07D0fd2d8E84BBc0289),//FundAddress
        address(0x730cB53cC7FB025B8d68E07D0fd2d8E84BBc0289)//ReceiveAddress
    ){
    }
}