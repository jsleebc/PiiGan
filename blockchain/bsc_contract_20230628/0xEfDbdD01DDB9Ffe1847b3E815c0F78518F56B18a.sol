/**
Telegram: https://t.me/KnucklesInuBSC
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2735d40d69F1267117D7cF4ab6BcF3A5E75a8CDb; // owner address
...
contract KnucklesInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Knuckles Inu";
    string private _symbol = "KNUCK";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x458bF34432c20546F874bCdBa97A58b0b37559Ab); // Marketing Address
    address payable public teamWalletAddress = payable(0x458bF34432c20546F874bCdBa97A58b0b37559Ab); // Team Address
