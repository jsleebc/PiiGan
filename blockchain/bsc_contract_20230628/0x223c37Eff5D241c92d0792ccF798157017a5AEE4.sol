...
contract Didi is Context, IERC20, Ownable {
 ...
 uint256 private constant _tTotal = 22 * (10**16) * (10**9);
 ...
 address payable private _marketingAddress = payable(0xfeA23e246AB9EE14358F7123fc1cf3f453Af7c25);
 address payable private _marketing2Address = payable(0xfeA23e246AB9EE14358F7123fc1cf3f453Af7c25);
