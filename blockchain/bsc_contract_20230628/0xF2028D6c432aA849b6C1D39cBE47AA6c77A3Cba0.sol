...
📋 EQVETRINA decentralized oracle networks that will be provide tamper-proof inputs, outputs, and computations to support advanced smart contracts on any blockchain.

📋 EVTR MISSION
Design, build, and operate a healthy and sustainable passive income cryptocurrency, with a highly involved, and inclusive. 
even we all know , market share does not always correlate with the on-chain metric which is very important in terms of daily transactions and active addresses.

📋 Therefore, enterprises are eager to learn about blockchain roadmap best practices to implement successful blockchain projects. Blockchain is still a mysterious phenomenon for many business leaders all over the world, despite the massive body of literature associated with it. So, it is essential to learn about blockchain as a technology ecosystem rather than considering it as another new technology product.so we're to propose everyone with secure, fast and trusted network. 
EVTR will be the solution for all problem.

Group Link : https://t.me/+FZohEVyE6uw3ZDFl
*/
...
contract Eqvetrina is IBEP20, Auth {
    ...
    address DEV = 0x26815A23ceEbcC94dC0323A07CC02b1252801DEE;

    address private autoLiquidityReceiver;
    address private marketingFeeReceiver;

    string constant _name = "EQVETRINA";
    string constant _symbol = "EVTR";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x50b57B7b5f275CFabcfc59CcFf3eb9bccA5960a0;
