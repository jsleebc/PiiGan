// Telegram : https://t.me/buffedoggyportal
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x3162F39e0A2A1C36b8BDE6C55F986b375801aa88;
...
contract BUFFEDOGGY is Context, IERC20, Ownable {
    ...
    string private constant _name = "BUFFED OGGY"; // 
    string private constant _symbol = "BOGGY"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 2;
    address payable public  _marketingWallet = payable(0x3162F39e0A2A1C36b8BDE6C55F986b375801aa88);
