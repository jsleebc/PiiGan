/**
https://t.me/LiquidityBurnNetwork
*/
...
contract LBN is Context, IERC20, Ownable {
    ...
    address payable public  _marketingWallet = payable (0x595Dc6d7C3A2324511488a797A064AC0Ae4f2C2d);
    ...
    string private constant _name = "Liquidity Burn Network";
    string private constant _symbol = "$LBN";
