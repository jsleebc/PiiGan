...
contract DLM is ERC20, Ownable {
    using SafeMath for uint256;

    string private _name = "DLM";
    ...
    constructor () Ownable() {
        ...
        distributor = new DividendDistributor(baseToken,30 minutes,1 * 10 ** 9,_totalSupply.div(1000000));
        ...
        allot=Allot(2,3,0,3,8);
        fees=Fee(8,8,8,100);
        marketingFeeReceiver = 0xf0c75950E649e6F2e9c6d0C7470C906d36fC76a4;
