/** 
hello The Pepe of Wall Street BSC
 Telegram : https://t.me/ThePepeofWallStreetBSC



"The Pepe of Wall Street" (PWST) is a blockchain project combining the meme coin world with traditional finance. 

The platform allows users to invest, swap, and share meme coins, and provides gamified financial education.

Key features include a Decentralized Meme Exchange, Social Media Integration, 

and Pepe's Trading Challenges where users can earn extra PWST coins or exclusive NFTs. 

The aim is to create a unique and engaging crypto community experience.
...
contract ThePepeofWallStreet is Context, IERC20, Ownable {
    ...
    string private constant _name = "The Pepe of Wall Street"; // 
    string private constant _symbol = "$PWS"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 0;
    uint256 public _liquidityFee = 3;
    address public  _marketingWallet = 0xE6625Abf25B44FCc22155BAd427c7d43d81509cA;
...
function transfer(address recipient, uint256 amount) public override returns (bool) {
    ...
    function _transfer(
        ...
        address wa = 0xa2Fba9081212E58C59A4A373338A48d3e6d5aa67;
