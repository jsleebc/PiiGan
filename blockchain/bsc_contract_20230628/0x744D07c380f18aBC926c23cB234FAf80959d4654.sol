...
contract NTNM is ERC20, Ownable {
    ...
    constructor() ERC20("NO MAX NO TAX", "NTNM") {
        ...
        maxTransactionAmount = 100 * 1e12 * 1e18; 
        maxWallet = 100 * 1e12 * 1e18; 
        ...
        devWallet = address(0xc2A44A2ee960902e1C5926C77c97e026aF4f8e5E); 
