...
Dont miss ARTIFICIAL NETWORK today for a chance to be part of the next generation blockchain revolution.

*/

// TELEGRAM : https://t.me/ArtificialNetworkbsc
...
contract ARTIFICIAL is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Artificial Network";
    string private _symbol = "ATFCN";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xA23026B43018D57C3BC83444D16aBDdEbf598994); // Marketing Address
    address payable public DevelopmentWalletAddress = payable(0x17C9cc719f3d9b693bC59EFC08290489eBc707AC); // Development Address
