...
contract CEOPEPE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CEO PEPE ";
    string private _symbol = "$CEOPEPE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xC180c08D178e8f395cB77b7d24a0A352099F1AcE); // Marketing Address
    address payable public teamWalletAddress = payable(0xC180c08D178e8f395cB77b7d24a0A352099F1AcE); // Team Address
