...
contract Tube is Context, IERC20, IERC20Metadata, Ownable {
    using SafeMath for uint256;

    mapping(address => uint256) private _balances;
    mapping(address => mapping(address => uint256)) private _allowances;
    
    string private _name = "TUBE";
    string private _symbol = "TUBE";
    ...
    address public marketingAddress = address(0xc972e7df14a86c2bC01BA2696F63Cd6E2Cb019E1);
