...
Welcome to Kenta on BSC - Let's keep helping reviving the BSC space!
...
contract Kenta is Context, IERC20, Ownable {
    ...
    string private constant _name = "Kenta"; // 
    string private constant _symbol = "KENTA"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 0;
    uint256 public _liquidityFee = 5;
    address public  _marketingWallet = 0xBF3467db9d32408DBB2e7C2dCbDa61bB410fFaEF;
