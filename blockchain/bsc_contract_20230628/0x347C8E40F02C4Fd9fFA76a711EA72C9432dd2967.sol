...
contract MARSU is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x547da44A0802d98BCD110c4f771f79aE580C896e); 
    address payable public Wallet_Dev = payable(0x75BAE3F4009484d239553BCdCE824d94a4C85394);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =10000000000000 * 10**2* 10**2 * 10**_decimals;
    string private constant _name = "MARSU"; 
    string private constant _symbol = unicode"MARSU"; 
    ...
    constructor () {
        _owner =0x75BAE3F4009484d239553BCdCE824d94a4C85394;
