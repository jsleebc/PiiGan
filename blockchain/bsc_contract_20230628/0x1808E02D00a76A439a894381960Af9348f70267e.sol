...
CODE IS LEGAL PROPERTY OF MRSPEPE TEAM                                     
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0x02E98Ae28f9d3f3fc1134De2415b4c425EcE621c); // PEPE
...
contract MrsPepe is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "MRS PEPE";
    string constant _symbol = "MRSPEPE";
    uint8 constant _decimals = 9;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address RewardToken = 0x02E98Ae28f9d3f3fc1134De2415b4c425EcE621c; // PEPE
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0x02E98Ae28f9d3f3fc1134De2415b4c425EcE621c;
        marketingWallet = 0x02E98Ae28f9d3f3fc1134De2415b4c425EcE621c;
        devWallet = 0x02E98Ae28f9d3f3fc1134De2415b4c425EcE621c;
