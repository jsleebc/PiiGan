...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xeAAe2FdD46f3b4077d59337F42700EB7327DA8DA; // owner address
...
contract hashbetchain is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Hashbet Chain";
    string private _symbol = "HBC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xeAAe2FdD46f3b4077d59337F42700EB7327DA8DA); // Marketing Address
    address payable public teamWalletAddress = payable(0xeAAe2FdD46f3b4077d59337F42700EB7327DA8DA); // Team Address
