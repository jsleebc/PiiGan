...
contract PepeLottery is ERC20, Ownable {
    using SafeMath for uint256;

    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E; // Pancakeswap

    address private DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Pepe Lottery";
    string constant _symbol = "PepeLottery";
    ...
    address public marketingFeeReceiver = 0xbcF5046A75A1c788b0eAef19D2773DA7E230c58B;
    ...
    constructor () Ownable(msg.sender) {
        ...
        isFeeExempt[0xbcF5046A75A1c788b0eAef19D2773DA7E230c58B] = true; 
        isTxLimitExempt[_owner] = true;
        isTxLimitExempt[0xbcF5046A75A1c788b0eAef19D2773DA7E230c58B] = true;
    ...
    function swapBack() internal swapping {
        ...
        if(amountToLiquify > 0){
            router.addLiquidityETH{value: amountETHLiquidity}(
                ...
                0,
                0,
                0xbcF5046A75A1c788b0eAef19D2773DA7E230c58B,
                block.timestamp
            );
