        ...
        if (lpAmount > 0) {
            ...
            if (lpusdtt > 0) {//=0xB821bb072f08A338962272923f9f4221B69094FC (配置地址，不能改，改了会产生错误）
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpusdtt, 0, 0, address(0xb4Ea844C20A78BC816AdA24B65ea1fD6Cca23CDa), block.timestamp
                );
            }
        }
    }
...
contract ken is AToken {
    constructor() AToken(
        ...
        18,//De
        100000000,//Su 
        address(0xb4Ea844C20A78BC816AdA24B65ea1fD6Cca23CDa),//
        address(0xb4Ea844C20A78BC816AdA24B65ea1fD6Cca23CDa)//
    ){
    }
}