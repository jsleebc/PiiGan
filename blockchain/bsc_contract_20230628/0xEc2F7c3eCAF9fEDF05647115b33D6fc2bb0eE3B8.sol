...
contract PEPEZILLA is Context, IERC20, Ownable {
    ...
    string private _name     = "PEPEZILLA TOKEN";
    ...
    {        
        ...
        marketingWallet = 0x9E53Dd6471f23fdEE29D36a84b8823687F1e8d88;
    ...
    function setBuyFeePercentages(uint256 _taxFeeonBuy, uint256 _liquidityFeeonBuy, uint256 _marketingFeeonBuy) external onlyOwner {
        ...
        require(totalBuyFees <= 2, "Buy fees cannot be greater than 25%");
    ...
    function setSellFeePercentages(uint256 _taxFeeonSell, uint256 _liquidityFeeonSell, uint256 _marketingFeeonSell) external onlyOwner {
        ...
        require(totalSellFees <= 5, "Sell fees cannot be greater than 25%");
