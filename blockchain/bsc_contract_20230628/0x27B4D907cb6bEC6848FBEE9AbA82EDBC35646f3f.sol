...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x81217B28658bfF5A0b3C9aB62800f02F5e1ec00e; // RE
...
contract ResidentEvil is Context, IERC20, Ownable {
    ...
    string private _name = "Resident Evil";
    string private _symbol = "RE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x81217B28658bfF5A0b3C9aB62800f02F5e1ec00e); // RE
    address payable public earnWalletAddress = payable(0x81217B28658bfF5A0b3C9aB62800f02F5e1ec00e); //  RE
