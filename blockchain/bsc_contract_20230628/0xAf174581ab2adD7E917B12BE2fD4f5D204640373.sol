 ...
 * allowances. See {IERC20-approve}.
 */
 contract ApedMax is ERC20, Ownable {
    // TOKENOMICS START ==========================================================>
    string private _name = "Aped Max";
    string private _symbol = "APEDMAX";
    uint8 private _decimals = 9;
    uint256 private _supply = 100000000000000;
    uint256 public taxForLiquidity = 20;
    uint256 public taxForMarketing = 79;
    uint256 public maxTxAmount = 300000000000  * 10**_decimals;
    uint256 public maxWalletAmount = 3000000000000  * 10**_decimals;
    address public marketingWallet = 0x56714e57D5447de3a2a7d735396f1554AA2b4B85;
    // TOKENOMICS END ============================================================>
    ...
    uint256 private _numTokensSellToAddToLiquidity = 5000000000000 * 10**_decimals;
    ...
    function _transfer(address from, address to, uint256 amount) internal override {
        ...
        require(!blacklist[to], "ERC20: recipient is blacklisted");
    ...
    function changeTaxForLiquidityAndMarketing(uint256 _taxForLiquidity, uint256 _taxForMarketing)
        ...
        returns (bool)
    {
        require((_taxForLiquidity+_taxForMarketing) <= 80, "ERC20: total tax must not be greater than 80");
