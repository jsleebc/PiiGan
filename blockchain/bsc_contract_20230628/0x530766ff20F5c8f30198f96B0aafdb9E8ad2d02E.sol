...
contract DENIAL is IERC20, Ownable {
    ...
    string _name = "DENIAL";
    string _symbol = "DENIAL";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1 * 10**9 * 10**_decimals;
    uint256 public _maxTxAmount = (_totalSupply * 25) / 10000;
    uint256 public _maxWalletSize = (_totalSupply * 100) / 10000;   
    ...
    constructor () {
        ...
        devFeeReceiver = 0x6A2EFcDEbc0b5863bA3eA6bEF5920195530542a9;
        marketingFeeReceiver = 0x6A2EFcDEbc0b5863bA3eA6bEF5920195530542a9;
