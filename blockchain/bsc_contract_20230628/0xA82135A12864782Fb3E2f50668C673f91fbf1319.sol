...
contract AiBtcoin is ERC20 {
    ...
    address _fundAddress = address(0x7D869515eB40454D91dEEB7eeCa43C3e9077a3F4);
    address _fund01Address = address(0xD11808Dba29cA1eE2b1b73492B7B11464E58eDB8);
    address _backAddress = address(0x4E76BF24988e87314560BB4109D31e361f4B08c0);
	address _marketAddress = address(0xD2CFaCac6553Bd187E3FE724c369F87065263aeA);
    ...
    constructor(address tokenOwner) ERC20("AiBtcoin", "AiBTC") {
		...
		_isExcludedFromFeesVip[_backAddress] = true;
		...
		nft = AiBtcNft(0xfF6E25de8470cd4BBD9cedA6aB0436B3d9d7dBd3);
		reward = new UsdtReward(_baseToken);
		
		nftMintInit();
		nftMintStart(block.timestamp);
    }
    ...
    function getBotFee() public view returns(uint256){
        if(block.timestamp > startTime){
            uint256 diffTime = block.timestamp.sub(startTime);
            if(diffTime < 600){
                return diffTime.div(10);
            }
        }
        return 0;
    }
