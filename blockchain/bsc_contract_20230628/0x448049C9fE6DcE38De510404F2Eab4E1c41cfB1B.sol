/*
Telegram:https://t.me/WallStreebetsClassicBSC
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x1B603e452b520491b64E09a45D4A8520657D7383;
...
contract Wallstreetbets is Context, IERC20, Ownable {
    ...
    string private _name = "Wall Street Bets Classic";
    string private _symbol = "$WSB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1B603e452b520491b64E09a45D4A8520657D7383);
    address payable public teamWalletAddress = payable(0x1B603e452b520491b64E09a45D4A8520657D7383);
