...
contract elmo is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x59AD8C7Fc7058E806829626F45D5aC759A8c2380); // Marketing Address
    address payable private teamWalletAddress = payable(0x5Bf7A9ba8a70aDDc5B4d34092360cd3DC7cC311b); // Team Address
