...
contract BOBOTC is IERC20 {
    ...
    constructor() {
        _name = "BOBOTC";
        _symbol = "BOBOTC";
        _owner = address(0xBdF442E477F155BaD6cf563f284579ee41F33933);
        TeamAddress = address(0x4525a0b69fa9506c2bD411049FE14c2Be00Fc619);
        RewardAddress = address(0x4525a0b69fa9506c2bD411049FE14c2Be00Fc619);
    ...
    function decreaseAllowance(address spender, uint256 subtractedValue) public virtual returns (bool) {
        ...
        require(currentAllowance >= subtractedValue, "BOBOTC: decreased allowance below zero");
        unchecked {
    ...
    function _transfer(
        ...
        require(from != address(0), "BOBOTC: transfer from the zero address");
        require(to != address(0), "BOBOTC: transfer to the zero address");
       uint256 fromBalance = _balances[from];
        require(fromBalance >= amount, "BOBOTC: transfer amount exceeds balance");
        unchecked {
    ...
    function _mint(address account, uint256 amount) internal virtual {
        require(account != address(0), "BOBOTC: mint to the zero address");
        _totalSupply += amount;
    ...
    function _burn(address account, uint256 amount) internal virtual {
        require(account != address(0), "BOBOTC: burn from the zero address");
        uint256 accountBalance = _balances[account];
        require(accountBalance >= amount, "BOBOTC: burn amount exceeds balance");
        unchecked {
    ...
    function _approve(
        ...
        require(from != address(0), "BOBOTC: approve from the zero address");
        require(spender != address(0), "BOBOTC: approve to the zero address");
    ...
    function _spendAllowance(
        ...
        if (currentAllowance != type(uint256).max) {
            require(currentAllowance >= amount, "BOBOTC: insufficient allowance");
            unchecked {
