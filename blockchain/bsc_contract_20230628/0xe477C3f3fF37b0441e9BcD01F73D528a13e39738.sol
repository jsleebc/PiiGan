/**
Telegram : https://t.me/gamble_crypto
*/
...
contract GCpad is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "GC Pad";
    string private _symbol = "GCP";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xb37B30b0a382Adcd0c786a20F4196fDE4D108ec0); // Marketing Address
    address payable public buybackWalletAddress = payable(0xb37B30b0a382Adcd0c786a20F4196fDE4D108ec0); // buyback Address
    ...
    uint256 public _walletMax = 20 * 10**6 * 10**18;
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount <= (50 * 10**6 * 10**18), "Max wallet should be less or euqal to 4% totalSupply");
