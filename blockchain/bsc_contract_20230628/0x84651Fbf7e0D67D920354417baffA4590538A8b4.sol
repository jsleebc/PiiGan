...
contract BABYQUACK is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x94db91f8C46Ac0A28797e394dCC173949A5c9505); 
    address payable public Wallet_Dev = payable(0x30cE9d0721ba95C77658Ef40359CFFa109cdbe1d);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =40000000000000 * 10**1* 10**1 * 10**_decimals;
    string private constant _name = "BABYQUACK "; 
    string private constant _symbol = unicode"BABYQUACK"; 
    ...
    constructor () {
        _owner = 0x30cE9d0721ba95C77658Ef40359CFFa109cdbe1d;
