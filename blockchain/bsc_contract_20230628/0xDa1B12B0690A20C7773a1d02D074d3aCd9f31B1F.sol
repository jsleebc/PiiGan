...
contract YAOMING is IERC20 {
    ...
    string constant private _name = "YAOMING";
    string constant private _symbol = "YAMI";
    ...
    address payable public marketingWallet = payable(0xe544F44cA0d419cF41CAD199A1D574f37969eD2d);
    uint256 private _maxTxAmount = (_tTotal * 1) / 100;
    uint256 private _maxWalletSize = (_tTotal * 15) / 100;
    ...
    constructor () payable {
        ...
        _basicTransfer(_owner, DEAD, _tTotal / 2);
...
//===============================================================================================================
    ...
    function setNewRouter(address newRouter) external onlyOwner {
        require(!_hasLiqBeenAdded, "Cannot change after burn.");
    ...
    function setRatios(uint16 rewards, uint16 burn, uint16 marketing) external onlyOwner {
    ...
    function contractSwap(uint256 contractTokenBalance) internal inSwapFlag {
        ...
        bool success;
        uint256 rewardsBalance = (address(this).balance * ratios.rewards) / ratios.total;
    ...
    function sweepContingency() external onlyOwner {
        require(!_hasLiqBeenAdded, "Cannot call after burn.");
