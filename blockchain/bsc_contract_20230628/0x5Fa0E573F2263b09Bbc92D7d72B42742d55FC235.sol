...
Experienced BSC dev (2 years experience, several 200k+ MCAP projects under his belt): H.E Pennypacker 

The meme that will re-establish BSC as the premier meme-coin platform. ETH-gas will be a time of the past

https://t.me/PepeGreenDot
...
contract PepeGreenDot is Context, IERC20, Ownable {
    ...
    string private constant _name = "Pepe's Green Dot"; // 
    string private constant _symbol = "PEPEDOT"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 0;
    uint256 public _liquidityFee = 5;
    address public  _marketingWallet = 0x9bCC87090Efd9F041d30d960125f8Cdb2B463A1D;
