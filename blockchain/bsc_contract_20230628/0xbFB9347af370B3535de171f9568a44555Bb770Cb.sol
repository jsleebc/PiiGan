...
Ava A.I. is a BSC project that's fueled by a powerful machine-learning utility 
which generates a great variety of art styles on simple prompts.  Whether it's 
anime, pixel graphics, realistic, impressionist or high fantasy, Ava A.I. is 
capable of fabricating your very own master artist.

TG: https://t.me/avaaibsc
Twitter: https://twitter.com/avaaibsc
...
contract avaai is Context, IERC20, Ownable {
    ...
    string constant _name = unicode"Ava Ai";
    string constant _symbol = unicode"AVA";
    ...
    feeRatesStruct public buyRates =
        feeRatesStruct({
            rfi: 0, // 0 RFI rate, in %
            dev: 0, // development fee in %
            Marketing: 14, // Marketing fee in %
            lp: 1, // lp rate in %
