...
https://t.me/FortyForNetworkPORTAL
https://44-Network.com/
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x9A33fABC7399B3b8e638Fc31E8d1546C63C06d8A; 
...
contract FORTYFOURNETWORK is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "44 Network";
    string private _symbol = "44";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9A33fABC7399B3b8e638Fc31E8d1546C63C06d8A); 
    address payable public teamWalletAddress = payable(0x9A33fABC7399B3b8e638Fc31E8d1546C63C06d8A); 
    ...
    uint256 public _walletMax = 13333333 * 10**_decimals;
