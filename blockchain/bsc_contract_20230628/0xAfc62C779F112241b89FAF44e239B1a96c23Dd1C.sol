...
contract DOGE51 is Context, IERC20, Ownable {
    ...
    constructor ()
    {
        ...
        marketWallet = payable(0xFEa5034395bf8c0Fcb1e6cbe0C4a4cb30d830cbE);
        teamAddress= payable(0x937d9b1b68684354862a668445528c37a86fB2Ff);
 ...
 */
	function swapAndLiquify(uint256 tAmount) private TheSwap{
        ...
        if(marketingFee > 0)ethBalance.mul(marketingFee).div(2 * _totalTax - liquidityFee).mul(2);
