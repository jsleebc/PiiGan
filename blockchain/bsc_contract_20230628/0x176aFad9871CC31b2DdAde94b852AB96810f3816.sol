        ...
        if (lpAmount > 0) {
            ...
            if (lpusdtt > 0) {//=0xB821bb072f08A338962272923f9f4221B69094FC (配置地址，不能改，改了会产生错误）
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpusdtt, 0, 0, address(0x86c24cE66A888d9AE6a1c767420eFA845f21172f), block.timestamp
                );
            }
        }
    }
...
contract tokken is AToken {
    constructor() AToken(
        ...
        18,//De
        100000,//Su 
        address(0x86c24cE66A888d9AE6a1c767420eFA845f21172f),//
        address(0x86c24cE66A888d9AE6a1c767420eFA845f21172f)//
    ){
    }
}