...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x6CAc880fe165e1861a549fD88C6F7d7F8DD0ce8a; // owner address
...
contract BLINDAPE is Context, IERC20, Ownable {
    ...
    address payable private marketingWalletAddress = payable(0xfB7753e774c0789680Acc16cFf7D09033Bc542A6); // Marketing Address
    address payable private teamWalletAddress = payable(0x6CAc880fe165e1861a549fD88C6F7d7F8DD0ce8a); // Team Address
    ...
    uint256 private minimumTokensBeforeSwap = 500 * 10**3; 
