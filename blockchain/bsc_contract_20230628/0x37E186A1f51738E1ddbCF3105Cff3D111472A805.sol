...
Telegram: https://t.me/PeterGriffinBSC
Twitter: https://twitter.com/PeterGriffinBNB
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xDBBe88957203E407FF54699c1cd33D9dc79e2c84;
...
contract PETERGRIFFIN is Context, IERC20, Ownable {
    ...
    string private _name = "PETER GRIFFIN";
    string private _symbol = "$GRIFFIN";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xDBBe88957203E407FF54699c1cd33D9dc79e2c84);
    address payable public teamWalletAddress = payable(0xDBBe88957203E407FF54699c1cd33D9dc79e2c84);
