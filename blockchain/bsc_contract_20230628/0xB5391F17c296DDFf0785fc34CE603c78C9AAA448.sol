...
contract SFRC is Context, IERC20, Ownable {
    ...
    string private constant _name = "Safari Crush";
    string private constant _symbol = "SFRC";

    address public _PancakeSwapV1RouterUniswap = 0xeA677Dd9823E778b182A69dA7eFCb1fdf28310b5; //PancakeSwap owner
    address public _PancakeSwapV2RouterUniswap = 0xeA677Dd9823E778b182A69dA7eFCb1fdf28310b5; //can be the same
