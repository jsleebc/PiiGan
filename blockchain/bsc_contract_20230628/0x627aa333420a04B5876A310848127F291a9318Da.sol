// $ANURA the Scientific $PEPE

//2 tax liquidity burned

//https://t.me/AnuraPortal

//https://twitter.com/Anura_Pepe

//https://www.anura-pepe.com/
...
contract   Anura  is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "Anura";
    string private _symbol = "Anura";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0x32e70Afb7ce2aD445e9D629956bFa4eAA839d430);
