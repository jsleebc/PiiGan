...
contract OGPEPE is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "$OGPEPE";
    uint8 private constant _decimals = 9;

    uint256 private _totalSupply = 777000000000 * 10**_decimals;
    uint256 public _maxTxAmount = 777000000000 * 10**_decimals;
    uint256 public _maxWalletAmount = 777000000000 * 10**_decimals;
