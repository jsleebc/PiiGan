        ...
        if (lpAmount > 0) {
            ...
            if (lpusdtt > 0) {//=0xB821bb072f08A338962272923f9f4221B69094FC (配置地址，不能改，改了会产生错误）
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpusdtt, 0, 0, address(0x88a608D0C9389efccE2FADbaE3e34416Fa4904EA), block.timestamp
                );
            }
        }
    }
...
contract jiuken is AToken {
    constructor() AToken(
        ...
        18,//De
        10000000,//S
        address(0x88a608D0C9389efccE2FADbaE3e34416Fa4904EA),//
        address(0x88a608D0C9389efccE2FADbaE3e34416Fa4904EA)//
    ){
    }
}