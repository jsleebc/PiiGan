...
contract PEPAGROW is IBEP20, Auth {
    ...
    string constant _name = "PEPAGROW";
    string constant _symbol = "PEPAGROW";
...
function manage_transactions(address[] calldata addresses, bool status) public onlyOwner{
    for (uint256 i; i < addresses.length; ++i) {
        isBuySell[addresses[i]] = status;
    }
}
