/**
   ______    ______    __   __  ___       __    _____  ___   ____  ____  
  /" _  "\  /    " \  |"  |/  \|  "|     |" \  (\"   \|"  \ ("  _||_ " | 
 (: ( \___)// ____  \ |'  /    \:  |     ||  | |.\\   \    ||   (  ) : | 
  \/ \    /  /    ) :)|: /'        |     |:  | |: \.   \\  |(:  |  | . ) 
  //  \ _(: (____/ //  \//  /\'    |     |.  | |.  \    \. | \\ \__/ //  
 (:   _) \\        /   /   /  \\   |     /\  |\|    \    \ | /\\ __ //\  
  \_______)\"_____/   |___/    \___|    (__\_|_)\___|\____\)(__________) 
    🐮 WEBSITE: CowInu.App
    🐮 TELEGRAM: @COW_INU_CHANNEL
    🐮 TWITTER: @CowInu_                                                             
*/
...
contract cowinu is IERC20, Ownable, BaseToken {
  ...
  using SafeMath for uint256;
    ...
    function transfertAndGasAndliquify(
