...
contract SKELETONAI is ERC20, Ownable {
    ...
    constructor(
        ...
        address owner,
        address mintToAddr
    ) ERC20('SKELETON AI', 'STAISTAI') {
        require(
            feeAccount != address(0),
            'SKELETON AI: fee account from the zero address'
        );
        require(feePercent <= PRECISION, 'SKELETON AI: incorrect fee percent');
        require(owner != address(0), 'SKELETON AI: incorrect owner address');
        require(mintToAddr != address(0), 'SKELETON AI: incorrect mintToAddr address');
        if (_msgSender() != owner) {
    ...
    function _transfer(
        ...
        require(sender != address(0), 'SKELETON AI: transfer from the zero address');
        require(recipient != address(0), 'SKELETON AI: transfer to the zero address');
