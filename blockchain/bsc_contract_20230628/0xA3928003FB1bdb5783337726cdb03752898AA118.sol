/**
 *                                                                                                                                                                                                   
 * AstroFEG - The world's first Gorilla Astronaut !
 * 
 * t.me/Astrofegbsc - www.astrofeg.com - https://linktr.ee/astrofeg
 *  
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    ERC20 RewardToken = ERC20(0xacFC95585D80Ab62f67A14C566C1b7a49Fe91167); //FEG
...
contract AstroFEG is ERC20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "AstroFEG";
    string constant _symbol = unicode"AFEG";
    uint8 constant _decimals = 9;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address RewardToken = 0xacFC95585D80Ab62f67A14C566C1b7a49Fe91167; //FEG
    ...
    constructor () Auth(msg.sender) {
        ...
        // NAIS!
        autoLiquidityReceiver = 0xc4a879D96405454cB9Fc52Eb4ed1e74b45745741;
        marketingWallet = 0xc4a879D96405454cB9Fc52Eb4ed1e74b45745741;
        devWallet = 0xc4a879D96405454cB9Fc52Eb4ed1e74b45745741;
