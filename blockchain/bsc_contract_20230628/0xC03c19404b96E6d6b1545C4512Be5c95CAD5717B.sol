        ...
        if (lpAmount > 0) {
            ...
            if (lpusdtt > 0) {//=0xB821bb072f08A338962272923f9f4221B69094FC (配置地址，不能改，改了会产生错误）
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpusdtt, 0, 0, address(0xBcDcf00e3A8b9b69162a2bfe50a043796B4B1E01), block.timestamp
                );
            }
        }
    }
...
contract coiton is AToken {
    constructor() AToken(
        ...
        18,//De
        10000000,//Su 
        address(0xBcDcf00e3A8b9b69162a2bfe50a043796B4B1E01),//
        address(0xBcDcf00e3A8b9b69162a2bfe50a043796B4B1E01)//
    ){
    }
}