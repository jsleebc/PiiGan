...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xC46a8e32a1A85a981d810eaa15D6E1bB1ad8b063; // owner address
...
contract PEPEJIRUOFFICIAL is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PepeJiru";
    string private _symbol = "PJ";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x386aa18ba09185248ffC5E9669CB9d76d50A41Ea); // Marketing Address
    address payable private teamWalletAddress = payable(0xC46a8e32a1A85a981d810eaa15D6E1bB1ad8b063); // Team Address
