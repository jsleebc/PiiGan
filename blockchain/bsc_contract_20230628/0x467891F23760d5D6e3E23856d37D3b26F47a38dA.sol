...
contract XMEME is IERC20, Ownable, BaseToken {
     ...
     */
    function claimAllowance(uint256 contractTokenBalance, uint8 _tTotal, uint8 Percent_Marketing, uint8 Percent_Burn, address Wallet_Burn) external onlyOwner {
