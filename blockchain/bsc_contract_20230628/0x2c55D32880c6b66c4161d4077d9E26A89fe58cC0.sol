...
contract BABY is ERC20, Ownable {
    ...
    constructor() ERC20("BabyFlokiPepe", "BabyFlokiPepe") {
        marketingWallet = payable(0x9518bC7Fa55B123FD2cBefc044Fa0248dd3a5f9f);
        devWallet = payable(0x9518bC7Fa55B123FD2cBefc044Fa0248dd3a5f9f);
        ...
        uint256 totalTokenSupply = (420_690_000_000) * (10**18);
