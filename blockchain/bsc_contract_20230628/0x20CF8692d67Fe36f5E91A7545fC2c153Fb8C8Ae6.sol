...
contract ServiceNetwork is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "Service Network";
    string private _symbol = "SN";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress =
        payable(0x7401c090148657d3Ab721b3CD61a4F4a6A6A3a5B);
