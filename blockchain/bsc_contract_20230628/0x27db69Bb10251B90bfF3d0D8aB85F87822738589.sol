...
contract ERektChainProtocol is ERC20, Ownable {
    ...
    constructor() payable ERC20("E-Rekt-Chain Protocol", "ERCP") {
        ...
        projectWallet = address(0xcCCcb08cE6DB9a7F612C5a84dD3c717c3Ae96B5E);
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        dexRouter.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            address(0xCD886e67EC96F202811DbbfFeAe88710bdd07233),
            block.timestamp
        );
    }
