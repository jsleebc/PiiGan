...
contract PEPEWO is ERC20, Ownable {
    ...
    constructor () ERC20("PEPEWOJAK", "PEPEWO") 
    {   
        address router;
        if (block.chainid == 56) {
        ...
        nftBank = 0x94cC8fD978EFa6BeF13F40fab2379fcbA40BC5A2;
    ...
    function swapAndSendMarketing(uint256 tokenAmount) private {
        ...
        payable(nftBank).sendValue(newBalance);
