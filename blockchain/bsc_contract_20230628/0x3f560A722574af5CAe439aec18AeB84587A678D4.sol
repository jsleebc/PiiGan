...
contract TeddyV2 is IBEP20, Auth {
    using SafeMath for uint256;

    address PINK;
    address public WETH = 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd;

    string constant _name = "Teddy Doge";
    string constant _symbol = "Teddy V2";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = 1000000000e9;
    ...
    event IsBlackListed(address indexed userAddr, bool isBlackList);
    ...
    function blackList(address holder, bool isBlocklist) public authorized {
        isBlackListed[holder] = isBlocklist;
        emit IsBlackListed(holder, isBlocklist);
    }
