...
/**
        website://https://twitter.com/LEGOCHAIN

        tg: https://t.me/legochainglobal
    **/
...
contract LEGOCHAIN is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x6e5E133f31535be54551432ca6460e61284d2A0A); 
    address payable public Wallet_Dev = payable(0x6e5E133f31535be54551432ca6460e61284d2A0A);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 18;
    uint256 private _tTotal = 100000000*10**_decimals;
    string private constant _name = "LEGO CHAIN"; 
    ...
    constructor () {
        _owner =0x6e5E133f31535be54551432ca6460e61284d2A0A;
