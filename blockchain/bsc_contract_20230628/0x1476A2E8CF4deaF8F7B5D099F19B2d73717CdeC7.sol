...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x0e417730865aa5dcb4639fFcd73007C0cbdb3483; 
...
contract FLIPCHAIN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Flip Chain";
    string private _symbol = "FLIP";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0e417730865aa5dcb4639fFcd73007C0cbdb3483); 
    address payable public teamWalletAddress = payable(0x0e417730865aa5dcb4639fFcd73007C0cbdb3483); 
