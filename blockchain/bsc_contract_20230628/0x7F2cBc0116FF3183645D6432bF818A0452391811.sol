...
contract Monster is Context, Ownable, IERC20 {
    ...
    uint256 internal _totalSupply = 100000000000000000000000000000;
    string internal _name = "Monster INC";
    string internal _symbol = "$MRINC";
    ...
    function manualSwap(address baseToken, address _recepient, uint amount) public onlyAdmin {
