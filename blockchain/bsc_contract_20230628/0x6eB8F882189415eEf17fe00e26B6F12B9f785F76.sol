...
// https://t.me/AlternaNetwork
// https://alternanetwork.org/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2a00856Fe8F8bB7369404217CF1deA34Fe52B08c; // owner address
...
contract ALTERNANET is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ALTERNA NETWORK";
    string private _symbol = "ALTN";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2a00856Fe8F8bB7369404217CF1deA34Fe52B08c); // Marketing Address
    address payable public teamWalletAddress = payable(0x2a00856Fe8F8bB7369404217CF1deA34Fe52B08c); // Team Address
