...
Telegram : https://t.me/BOBBNBCommunity
Website  : https://explainthisbobbnb.com/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x52D0507fc614327c96217b17656859a8B8d0cA20; // owner address
...
contract BobBNB is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " Bob BNB ";
    string private _symbol = " BOB ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xbD1d1c742E6888e1B2C6ddAA585FCD1C7A32E9B5); // 
    address payable public teamWalletAddress = payable(0x52D0507fc614327c96217b17656859a8B8d0cA20); // 
    ...
    uint256 public _walletMax = 13800000000 * 10**_decimals;
    uint256 private minimumTokensBeforeSwap = 690000000 * 10**_decimals; 
