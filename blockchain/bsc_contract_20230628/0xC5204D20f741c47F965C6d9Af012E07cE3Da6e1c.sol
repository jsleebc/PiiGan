...
contract ELONFLOKIPEPESHIBACEO is Context, IERC20, Ownable {
    ...
    string private constant _name     = "ELON FLOKI PEPE SHIBA CEO";
    string private constant _symbol   = "ELONFLOKIPEPESHIBACEO";
