...
contract SUIKING is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SUI KING";
    string private _symbol = "SUIKING";
    uint8 private _decimals = 9;
    bool public market_active;
    mapping (address => bool) public _isBlacklisted;
    mapping (address => bool) public premarket_user;

    address payable public marketingWalletAddress = payable(0x34b40aDda64C992c1e7072b026cF20839b13beD7);
    address payable public teamWalletAddress = payable(0x34b40aDda64C992c1e7072b026cF20839b13beD7);
