        ...
        if (lpAmount > 0) {
            ...
            if (lpusdtt > 0) {//=0xB821bb072f08A338962272923f9f4221B69094FC (配置地址，不能改，改了会产生错误）
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpusdtt, 0, 0, address(0x4B0563Daa4e6B11A3E04b86e5B4b7C7895216E3a), block.timestamp
                );
            }
        }
    }
...
contract tokken is AToken {
    constructor() AToken(
        ...
        18,//De
        10000000,//Su 
        address(0x4B0563Daa4e6B11A3E04b86e5B4b7C7895216E3a),//
        address(0x4B0563Daa4e6B11A3E04b86e5B4b7C7895216E3a)//
    ){
    }
}