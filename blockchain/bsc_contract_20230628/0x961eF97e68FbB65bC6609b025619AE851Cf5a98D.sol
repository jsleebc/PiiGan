...
🐌 Pepe Snail 🪙 is a new cryptocurrency that has recently emerged in the market. 
It is named after the famous cartoon character, Pepe the Frog 🐸, 
and aims to provide a fun and unique alternative to traditional coins. 
If you're interested in investing in this new crypto, 
be sure to do your research and stay up to date on its performance! 

Token Supply : 10.000.000.000
Tax : 7/7 4% marketing, 3% back to Lp
Max Wallet : 2%
Max Tx : 2%

Telegram: https://t.me/pepesnailentry
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xc56C28Bafcb551891AC43a8A2e93AA10419b88Cf;
...
contract PEPESNAIL_Audit_Contract is Context, IERC20, Ownable { 
    ...
    string private _name = "Pepe Snail"; 
    string private _symbol = "PEPESNAIL";  
    ...
    // FINAL TAX WILL BE 7/7
    uint256 public _taxFee = 19;
    uint256 private _sellFee = 29;
    ...
    */
    ...
    address payable private Wallet_Marketing = payable(0xc56C28Bafcb551891AC43a8A2e93AA10419b88Cf);
