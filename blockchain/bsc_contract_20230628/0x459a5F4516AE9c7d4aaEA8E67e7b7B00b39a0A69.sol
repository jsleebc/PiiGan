...
contract PEPE_KING_ETH is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "PEPE KING ETH";
    string constant _symbol = "PEPEK";
    ...
    address public pair;
    address ts_Project = 0xB56f84fBE5A08BE7D80e5cF64b83fad1b136BBb0;
    ...
    uint256 public swapThreshold = _totalSupply / 1000; // Swap for distribuition 1% of total supply
    bool inSwap;
    ...
    constructor() Auth(msg.sender) {
        ...
        address owner_ = 0xD054a138eA69dCDD642D087D6C0Bb69552546Bbd;
