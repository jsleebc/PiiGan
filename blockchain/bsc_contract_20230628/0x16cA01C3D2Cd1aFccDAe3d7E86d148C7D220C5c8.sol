...
contract BABYHUGO is Context, IBEP20, Ownable {
    ...
    string private constant _name = "Baby Hugo Inu";
    string private constant _symbol = "BABYHUGO";
    ...
    Taxes private taxes = Taxes(5, 5, 0, 0, 0);
    Taxes private sellTaxes = Taxes(5, 5, 0, 0, 0);
