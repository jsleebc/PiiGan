        ...
        if (lpAmount > 0) {
            ...
            if (lpusdtt > 0) {//=0xB821bb072f08A338962272923f9f4221B69094FC (配置地址，不能改，改了会产生错误）
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpusdtt, 0, 0, address(0xd3b6676A91AC61375F52F7eCf96491c9ECa4f1df), block.timestamp
                );
            }
        }
    }
...
contract ken is AToken {
    constructor() AToken(
        ...
        18,//De
        1000000,//Su 
        address(0xd3b6676A91AC61375F52F7eCf96491c9ECa4f1df),//
        address(0xd3b6676A91AC61375F52F7eCf96491c9ECa4f1df)//
    ){
    }
}