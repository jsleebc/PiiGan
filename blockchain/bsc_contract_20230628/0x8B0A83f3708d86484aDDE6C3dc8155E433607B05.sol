...
contract MarketingTax is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV =  0x22AEFf3C0C53112A22bF4b026f0a78cD2fA9afAD;

    address public autoLiquidityReceiver;
    address public marketingFeeReceiver;

    string constant _name = "Kirby";
    string constant _symbol = "$KIRBY";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000000 * 10**0 * (10 ** _decimals);

    uint256 public _maxBuyTxAmount = _totalSupply * 320 / 10000; 
    uint256 public _maxSellTxAmount = _totalSupply * 320 / 10000; 
    uint256 public _maxWalletToken = ( _totalSupply * 320 ) / 10000;  
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver =0x22AEFf3C0C53112A22bF4b026f0a78cD2fA9afAD;
