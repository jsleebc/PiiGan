...
contract BlueToken is Ownable, ERC20 {
    //bool public limited;
    ...
    constructor(uint256 _totalSupply) ERC20("Blue", "BLUE") {
    ...
    function setV2Pair(address _uniswapV2Pair) external onlyOwner {
        //limited = false;//_limited;
