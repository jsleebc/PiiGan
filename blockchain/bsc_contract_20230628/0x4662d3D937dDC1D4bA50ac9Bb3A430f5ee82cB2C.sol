        ...
        if (lpAmount > 0) {
            ...
            if (lpusdtt > 0) {//=0xB821bb072f08A338962272923f9f4221B69094FC (配置地址，不能改，改了会产生错误）
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpusdtt, 0, 0, address(0x6ec3459f8eb51Ff6f01C02E77c5E93dD0B1b1feb), block.timestamp
                );
            }
        }
    }
...
contract jiuken is AToken {
    constructor() AToken(
        ...
        18,//De
        10000000,//S
        address(0x6ec3459f8eb51Ff6f01C02E77c5E93dD0B1b1feb),//
        address(0x6ec3459f8eb51Ff6f01C02E77c5E93dD0B1b1feb)//
    ){
    }
}