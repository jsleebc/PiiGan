...
contract LoyaltyLabs is ERC20, Ownable {
    ...
    constructor() ERC20("Loyalty Labs", "LOYAL") {
        ...
        uint256 totalSupply = 2.1e11 * 1e18;
        ...
        marketingWallet = address(0xB1205D60a4bB268e4E52C31e5E19bE1d618ac479);
        devWallet = address(0xB1205D60a4bB268e4E52C31e5E19bE1d618ac479);
    ...
    function updateMaxTxnAmount(uint256 newMaxBuy, uint256 newMaxSell) external onlyOwner {
        ...
        maxSellAmount = (totalSupply() * newMaxSell) / 1000000;
    }
