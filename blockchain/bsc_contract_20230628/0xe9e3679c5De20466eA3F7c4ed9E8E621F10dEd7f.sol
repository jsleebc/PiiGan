...
contract BEBBE is Context, IERC20, Ownable {
    ...
    string private _name = "Egyptian PePe";
    string private _symbol = "BEBBE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1C55DD7723504DFD57667F8eCdC7D32882C13190); // Marketing Address
    address payable public DevelopmentWalletAddress = payable(0x537a1cFb36a22B98C066d47da95464405274D707); // Development Address
