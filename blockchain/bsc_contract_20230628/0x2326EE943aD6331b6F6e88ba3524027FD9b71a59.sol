...
contract PEPEYATCHCLUB is Context, IERC20, Ownable {
    ...
    string private constant _name = "Pepe Yatch Club";
    string private constant _symbol = "PCLUB";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0x62d7CC8C41d5e19940bD0e1660288119987e04b0);
    address payable private _marketingAddress = payable(0x62d7CC8C41d5e19940bD0e1660288119987e04b0);
