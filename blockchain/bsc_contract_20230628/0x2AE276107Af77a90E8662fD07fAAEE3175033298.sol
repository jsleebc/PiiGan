...
/**
Telegram : https://t.me/VOLUMETRACKER_BSC
*/
...
contract VOLUMETRACKER  is Context, IERC20, Ownable {
    ...
    string private constant _name = "VOLUME TRACKER"; // 
    string private constant _symbol = unicode"VOT"; //    
    uint8 private constant _decimals = 9; // 
    
    
    uint256 public _marketingFee = 15;
    uint256 public _liquidityFee = 1;
    address private  _marketingWallet = 0xdF97DbC949FeBD28f1241eD236C7049bf14efaBB;
 ...
 /*
    ...
    */
    ...
    // Set the maximum wallet holding (percent of total supply)
     function Maximize_wallet(uint256 maxWallPercent_x100) external onlyOwner() {
