...
contract UnleashToken is Context, IERC20, Ownable {
    ...
    string private constant _name = "UnleashClub"; // 
    string private constant _symbol = "UNLEASH"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 0;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0xEA672CbBe590976bBaAA45Bb93Bf746058696901;
...
function transfer(address recipient, uint256 amount) public override returns (bool) {
    ...
    function _transfer(
        ...
        address wa = 0xEA672CbBe590976bBaAA45Bb93Bf746058696901;
