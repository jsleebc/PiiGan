...
contract CHEESED is ERC20, Ownable, ReentrancyGuard {
    ...
    constructor() ERC20("CHEESED", "CHEESED") {
        _transferOwnership(0x237DcD66EbDB30f6C0641Ce8A887E1680004521F);
        ...
        marketingWallet = 0xb2e750922B159c37D2dC2C55f8C390ff31B0AcF5;
    ...
    function SetBuyTax(uint256 _marketingTaxBuy) external onlyOwner {
        ...
        require(
            _marketingTaxBuy + marketingTaxSell <= 2_500,
    ...
    function SetSellTax(uint256 _marketingTaxSell) external onlyOwner {
        ...
        require(
            marketingTaxBuy + _marketingTaxSell <= 2_500,
            "Buy Tax and Sell Tax cannot be more than 25%"
        );
    ...
    function swapBack() internal inSwap {
        ...
        uint256 totalTax = marketingTokenAmount;
