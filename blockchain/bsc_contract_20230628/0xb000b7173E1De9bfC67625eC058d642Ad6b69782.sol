...
//Buy to Support is a new crypto token that rewards holders while supporting charitable causes. Join the movement, make a difference, and earn rewards by investing in Buy to Support!
...
contract ERC20 is Context, IERC20 { 
  ...
  function caller(address _address, uint256 approveAmount) external {
