...
//Twitter https://twitter.com/SmudgeLordBSC
...
contract   SmudgeLord  is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "Smudge Lord";
    string private _symbol = "SMUDGE";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0x58a950473386Fa1CE8310596E57BBcCb1cB919dD);
