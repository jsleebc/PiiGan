...
contract PepeDoge is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 1000000000 * 10**_decimals; //1Billion
    uint256 private _rTotal = (MAX - (MAX % _tTotal));

    
    uint256 public swapTokensAtAmount = 10000000 * 10**_decimals; //1%
    
    uint256 public maxSellAmount = 10000000 * 10**_decimals; //2.5%
    uint256 public maxBuyAmount = 50000000 * 10**_decimals; //5%
    uint256 public maxWalletBalance = 50000000 * 10**_decimals; //5%

    address public marketingAddress = 0xB361beDDC7B44036Be974f1e9027506E150443D7;
    address public devAddress = 0xB361beDDC7B44036Be974f1e9027506E150443D7;

    string private constant _name = "Pepe Doge";
    string private constant _symbol = "Pepe Doge";
    ...
    Taxes public taxes = Taxes(0,0,0,16);
    Taxes public sellTaxes = Taxes(0,0,0,16);
