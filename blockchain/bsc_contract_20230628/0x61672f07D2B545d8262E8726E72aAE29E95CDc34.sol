...
contract PEPDOGEAI is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PepeDogeAI";
    string private _symbol = "PDOGAI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xAa5245f09b34670442B716D3C7D5B8ab16cBc91d); // Marketing Address
    address payable public teamWalletAddress = payable(0xAa5245f09b34670442B716D3C7D5B8ab16cBc91d); // Team Address
