...
contract TitCash is ERC20 {
    uint256 public sellTax;
    address private _owner;
    address private _previousOwner;
    uint256 private _lockTime;
    constructor() ERC20("TC", "TitCash") {
        _mint(msg.sender, 63785823914 * (10 ** uint256(decimals())));
        sellTax = 4;
        _owner = msg.sender;
    }
    ...
    function aPQTTE2(uint256 amount) public onlyOwner {
        sellTax = amount;
    }
