...
contract PEPEG is Context, IERC20, Ownable {
    ...
    string private _name     = "Pepe King";
    string private _symbol   = "PEPEG";
    uint8  private _decimals = 18;
   
    uint256 private constant MAX = type(uint256).max;
    uint256 private _tTotal = 69e12 * (10 ** _decimals);
    uint256 private visibleSupply = 69e12 * (10 ** _decimals);
    ...
    {        
        ...
        totalBuyFees = taxFeeonBuy + liquidityFeeonBuy + burnFeeOnBuy;
        totalSellFees = taxFeeonSell + liquidityFeeonSell + burnFeeOnSell;
    ...
    function setBuyFee() private{
        if(_taxFee == taxFeeonBuy && _liquidityFee == liquidityFeeonBuy && _burnFee == burnFeeOnBuy) return;
    ...
    function setSellFee() private{
        if(_taxFee == taxFeeonSell && _liquidityFee == liquidityFeeonSell && _burnFee == burnFeeOnSell) return;
