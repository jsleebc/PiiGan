...
contract FASTCHAIN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Fast Chain";
    string private _symbol = "FAST";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xCf2DB1AC18125Bd7B979ac4cf6921b0b28a85920); // Marketing Address
    address payable public DevelopmentWalletAddress = payable(0xC84e1640100826Bb8e6c08125BCDFbC68f62e74f); // Development Address
