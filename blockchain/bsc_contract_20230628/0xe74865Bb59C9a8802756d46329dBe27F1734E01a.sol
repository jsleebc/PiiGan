...
contract MIPEPE is ERC20, Ownable {
    ...
    uint256 public maxWalletAmount= 5_000_000 ether;
    ...
    uint256 public pendingCharityFee;

    address payable public marketingAddress = payable(0x468A03c7B7Ff1dc86CF5eb42A731DAC5e70c62ca);
    address public charityAddress = 0xab2e80037A7265A981E7Fe9a75809EFf92Df8AD2;
    ...
    constructor() ERC20("MIPEPE", "MIPEPE") {
        ...
        _isExcludedFromLimits[charityAddress] = true;
        ...
        _isExcludedFromFees[charityAddress] = true;
        _mint(owner(), 690_420_000_000_000 * (10**18));
    }
    ...
    function setSwapTokensAtAmount(uint256 amount) external onlyOwner {
        require(amount > 1000 ether, "Zero: Swap amount cant't be 0!");
    ...
    function setBuyFee(uint256 _newlpfee, uint256 _newmarketingfee, uint256 _newcharityfee) public onlyOwner {
        require((_newlpfee + _newmarketingfee + _newcharityfee + sellLPFee + sellMarketingFee + sellCharityFee) <= maxFeePercent,"Fee exceed the maximum limit");
        buyLPFee = _newlpfee;
    ...
    function setSellFee(uint256 _newlpfee, uint256 _newmarketingfee, uint256 _newcharityfee) public onlyOwner {
        require((_newlpfee + _newmarketingfee + _newcharityfee + buyLPFee + buyMarketingFee + buyCharityFee) <= maxFeePercent,"Fee exceed the maximum limit");
        sellLPFee = _newlpfee;
    ...
    function swapOnDemand() external onlyOwner {
        swapping = true;
        uint256 contractTokenBalanceforlp = balanceOf(address(this))-pendingmarketingFees-pendingCharityFee;
    ...
    function feeClaim() internal {
        ...
        pendingCharityFee = 0;
        super._transfer(address(this), charityAddress, amount);
    }
...
/////////////////////////// transfer
    function _transfer(
        ...
        if(takeFee) {
            ...
            uint256 cfee = amount * buyCharityFee / 100;
            uint totalfee = lpfee + mfee + cfee;  
            pendingmarketingFees = pendingmarketingFees + mfee;
            pendingCharityFee = pendingCharityFee + cfee;
            ...
            uint256 cfee = amount * sellCharityFee / 100;
            uint totalfee = lpfee + mfee + cfee;  
            pendingmarketingFees = pendingmarketingFees + mfee;
            pendingCharityFee = pendingCharityFee + cfee;
            super._transfer(from, address(this), totalfee);
