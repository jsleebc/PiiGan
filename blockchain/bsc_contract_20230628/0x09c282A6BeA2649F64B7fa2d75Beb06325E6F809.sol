...
// Telegram : https://t.me/kawamatsuinu
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xff02e85ab0bD2b8d89CDccE74D067188DB2360E2; // owner address
...
contract KAWAMATSUINU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "KAWAMATSU INU";
    string private _symbol = "KAI";
    uint8 private _decimals = 6;

    address payable public marketingWalletAddress = payable(0xff02e85ab0bD2b8d89CDccE74D067188DB2360E2); // Marketing Address
    address payable public teamWalletAddress = payable(0xff02e85ab0bD2b8d89CDccE74D067188DB2360E2); // Team Address
