...
contract HappyPEPEYachtClub is IERC20 {
    ...
    string constant private _name = "Happy PEPE Yacht Club";
    string constant private _symbol = "HPYC";
    ...
    TaxWallets public _taxWallets = TaxWallets({
        marketing: payable(0x221FE0Af62CebcC4D916d60D919A77814332C592),
        development: payable(0x221FE0Af62CebcC4D916d60D919A77814332C592)
    });
