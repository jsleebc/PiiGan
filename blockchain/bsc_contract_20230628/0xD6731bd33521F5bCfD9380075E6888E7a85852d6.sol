...
contract BongoCat is ERC20, Ownable {
    ...
    //Wallets
    address public marketingWallet = 0x4E4eFA8636529E93AcFe943B5e813Eb62be16BC5 ;
    ...
    constructor() ERC20("BongoCat", "$BCAT") {
    ...
    function setBuyTaxes(uint256 _marketingTax) external onlyOwner {
        ...
        require(_marketingTax <= 10, "Can not set buy fees higher than 2%");
    ...
    function setTransferFees(uint256 _transferTaxes) external onlyOwner {
        ...
        require(_transferTaxes <= 5, "Can not set transfer tax higher than 2%");
