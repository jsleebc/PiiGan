...
contract NarutoBOX is Context, IERC20, Ownable {
    ...
    string private constant _name = "NarutoBOX";
    string private constant _symbol = "NarutoBOX";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0x05061d51C0f1Dc7d7206142558d9464d80550018);
    address payable private _marketingAddress = payable(0x05061d51C0f1Dc7d7206142558d9464d80550018);
    ...
    constructor () {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x8547e2E16783Fdc559C435fDc158d572D1bD0970);
