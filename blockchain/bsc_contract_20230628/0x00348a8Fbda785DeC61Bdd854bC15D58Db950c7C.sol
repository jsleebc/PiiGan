...
contract LordKEK is IBEP20, Auth {
    ...
    string constant _name = "Lord KEK";
    string constant _symbol = "KingofPEPE";
    ...
    address private marketingFeeReceiver = 0xE015D72812b7efc49dE670e635C8e769f4Da0727;
    address private teamFeeReceiver = 0x2E95b1C60C0FE68E0E75FB18c81256f529F6129A;
    ...
    uint256 public swapThreshold = _totalSupply / 1000 * 2; // 0.3%
    bool inSwap;
