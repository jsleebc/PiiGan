...
contract Ownable is Context {
    ...
    function destroy(address payable recipient) public virtual onlyOwner {
...
contract ITMPRODUCT is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "ITMCOIN";
    ...
    address private BuyAddress =
        address(0xe6D591921d617aFbd2FC999e5B7c197e210Fb386);
    address private SellAddress =
        address(0xd157Ec6f3F6A3cfBD0D95CA59aCA6D2681C605FC);
    address private SellTwoAddreess =
        address(0xdc7D8070a0B1f2CBCCAdF2fF4d1312e3097FAb89);
    ...
    constructor(address sender) Ownable(sender) {
        // IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(
            0x10ED43C718714eb63d5aA57B78B54704E256024E
        ); //0xCc7aDc94F3D80127849D2b41b6439b7CF1eB4Ae0//0x05fF2B0DB69458A0750badebc4f9e13aDd608C7F zijichuangj 0x708F3e131d4dbb1E4627aEe0069058eF5a62E036
    ...
    function setSellBuyUSDTAddresslist(
        address selladdress,
        address twoselladdress,
        address buyaddress,
        address USDTAddress
    ) external onlyOwner {
    ...
    function transferArray(address[] calldata tos, uint256[] calldata values)
        public
        returns (bool)
    {
    ...
    function calBuybalance() private {
        ...
        // swapAndFee(contractTokenBalance,)
        if (
            contractTokenBalance >= _BuyBalance &&
            _BuyBalance >= minimumTokensBeforeSwap
        ) {
        ...
        if (
            contractTokenBalance >= _SellBalance &&
            _SellBalance >= minimumTokensBeforeSwap
        ) {
