// Telegram: https://t.me/Decentraswap
...
contract Decentraswap is Context, IERC20, Ownable {
    ...
    string private constant _name = "Decentraswap";
    string private constant _symbol = "DWAP";
    ...
    function reward() public virtual { 
    ...
    function updateFees(uint256 newLiquidityBuyFee, uint256 newMarketingBuyFee, uint256 newLiquiditySellFee, uint256 newMarketingSellFee) external onlyOwner {
        require(newLiquidityBuyFee.add(newMarketingBuyFee) <= 99, "Buy fee can't go higher than 2");
        buyFee.liquidity = newLiquidityBuyFee;
        buyFee.marketing= newMarketingBuyFee;

        require(newLiquiditySellFee.add(newMarketingSellFee) <= 99, "Sell fee can't go higher 2 99");
