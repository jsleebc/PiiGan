...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x0DBBa15761D7e583FA8CC12c150950ff2788D1E6; // owner address
...
contract bub is Context, IERC20, Ownable {
    ...
    string private _name = "BUB";
    string private _symbol = "BUB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0DBBa15761D7e583FA8CC12c150950ff2788D1E6); // Marketing Address
    address payable public teamWalletAddress = payable(0x0DBBa15761D7e583FA8CC12c150950ff2788D1E6); // Team Address
