...
// https://t.me/TwisterChain
// https://twister-defi.site/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x8b5a745b052333DAeFb92AF53c139ef78Ce3E4F9; // owner address
...
contract TwisterChain is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Twister Chain";
    string private _symbol = "TWT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8b5a745b052333DAeFb92AF53c139ef78Ce3E4F9); // Marketing Address
    address payable public teamWalletAddress = payable(0x8b5a745b052333DAeFb92AF53c139ef78Ce3E4F9); // Team Address
