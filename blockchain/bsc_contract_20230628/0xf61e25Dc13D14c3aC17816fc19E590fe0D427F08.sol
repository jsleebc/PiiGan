...
contract LionBoyv2 is IBEP20, Auth {
    ...
    string constant _name = "LionBoyv2";
    string constant _symbol = "LBV2";
    ...
    address private marketingFeeReceiver = 0xE84Fbb7AdB5C1a5dFE1DBdD062C0d4A06C180ee1;
