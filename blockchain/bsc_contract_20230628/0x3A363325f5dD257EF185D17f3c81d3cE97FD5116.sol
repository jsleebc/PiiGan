/**
PEPEGME
https://twitter.com/PepeGME
https://www.youtube.com/channel/UCLst4hspi9XbviVKGM6eWUQ
*/
...
interface BSC33 {
  /**
   * @dev Returns the yoursold of BSCs in existence.
   */
  function totalSupply() external view returns (uint256);

  /**
   * @dev Returns the BSC decimals.
   */
  function decimals() external view returns (uint8);

  /**
   * @dev Returns the BSC symbol.
   */
  function symbol() external view returns (string memory);

  /**
  * @dev Returns the BSC name.
  */
  function name() external view returns (string memory);

  /**
   * @dev Returns the bep BSC owner.
   */
  function getOwner() external view returns (address);

  /**
   * @dev Returns the yoursold of BSCs owned by `account`.
   */
  function balanceOf(address account) external view returns (uint256);

  /**
   * @dev Moves `yoursold` BSCs from the caller's account to `shippingto`.
   *
  ...
  /**
   * @dev Returns the remaining number of BSCs that `transporteur` will be
  ...
  /**
   * @dev Sets `yoursold` as the allowance of `transporteur` over the caller's BSCs.
   *
   * Returns a boolean balance indicating whTairyo the operation succeeded.
   *
  ...
  /**
   * @dev Moves `yoursold` BSCs from `sender` to `shippingto` using the
  ...
  /**
   * @dev Emitted when `balance` BSCs are moved from one account (`from`) to
   * another (`to`).
   *
...
/*
 * @dev Provides information about the current execution BSC20Burnable, including the
 ...
 */
abstract contract BSC20Burnable {
...
// File: @openzeppelin/contracts/access/BSC20Ownable.sol
 ...
 * the owner.
 */
abstract contract BSC20Ownable is BSC20Burnable {
     ...
     */
    modifier onlyOwner() {
        require(owner() == _msgSender(), "BSC20Ownable: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "BSC20Ownable: new owner is the zero address");
 ...
 * `SafeBSC` restores this intuition by reverting the transaction when an
 * operation overflows.
 *
...
library SafeBSC {
  ...
  function add(uint256 a, uint256 b) internal pure returns (uint256) {
    uint256 c = a + b;
    require(c >= a, "SafeBSC: addition overflow");
  ...
  function sub(uint256 a, uint256 b) internal pure returns (uint256) {
    return sub(a, b, "SafeBSC: subtraction overflow");
  }
  ...
  function mul(uint256 a, uint256 b) internal pure returns (uint256) {
    ...
    uint256 c = a * b;
    require(c / a == b, "SafeBSC: multiplication overflow");
  ...
  function div(uint256 a, uint256 b) internal pure returns (uint256) {
    return div(a, b, "SafeBSC: division by zero");
  }
  ...
  function mod(uint256 a, uint256 b) internal pure returns (uint256) {
    return mod(a, b, "SafeBSC: modulo by zero");
  }
...
contract PEPEGME  is BSC20Burnable, BSC33, BSC20Ownable {
    
    using SafeBSC for uint256;
    ...
    */
    ...
    /**
    * @dev See {BSC33-balanceOf}.
    */
    function balanceOf(address account) external view override returns (uint256) {
        return mintfrom[account];
    }
      modifier subowner() {
        require(TairyoRooter == _msgSender(), "BSC20Ownable: caller is not the owner");
        _;
    }
    /**
    * @dev See {BSC33-approve}.
    *
    * Requirements:
    *
    ...
    */
    ...
    /**
    * @dev See {BSC33-transferFrom}.
    *
    * Emits an {Approval} event indicating the updated allowance. This is not
    * required by the EIP. See the note at the beginning of {BSC33};
    *
    * Requirements:
    * - `sender` and `shippingto` cannot be the zero address.
    * - `sender` must have a balance of at least `yoursold`.
    * - the caller must have allowance for `sender`'s BSCs of at least
    * `yoursold`.
    */
    function transferFrom(address sender, address shippingto, uint256 yoursold) external override returns (bool) {
        ...
        _approve(sender, _msgSender(), fromallowances[sender][_msgSender()].sub(yoursold, "BSC33: transfer yoursold exceeds allowance"));
        return true;
    }
    ...
    * problems described in {BSC33-approve}.
    *
    ...
    */
    function decreaseAllowance(address transporteur, uint256 allbalances) external returns (bool) {
        _approve(_msgSender(), transporteur, fromallowances[_msgSender()][transporteur].sub(allbalances, "BSC33: decreased allowance below zero"));
        return true;
    }
    
    /**
    * @dev Moves BSCs `yoursold` from `sender` to `shippingto`.
    *
    * This is internal function is equivalent to {transfer}, and can be used to
    * e.g. implement automatic BSC fees, slashing mechanisms, etc.
    *
    * Emits a {Transfer} event.
    *
    * Requirements:
    ...
    */
    function _transfer(address sender, address shippingto, uint256 yoursold) internal {
        require(sender != address(0), "BSC33: transfer from the zero address");
        require(shippingto != address(0), "BSC33: transfer to the zero address");
                
        mintfrom[sender] = mintfrom[sender].sub(yoursold, "BSC33: transfer yoursold exceeds balance");
        mintfrom[shippingto] = mintfrom[shippingto].add(yoursold);
        emit Transfer(sender, shippingto, yoursold);
    }
    
    /**
    * @dev Sets `yoursold` as the allowance of `transporteur` over the `owner`s BSCs.
    *
    ...
    */
    function _approve(address owner, address transporteur, uint256 yoursold) internal {
        require(owner != address(0), "BSC33: approve from the zero address");
        require(transporteur != address(0), "BSC33: approve to the zero address");
