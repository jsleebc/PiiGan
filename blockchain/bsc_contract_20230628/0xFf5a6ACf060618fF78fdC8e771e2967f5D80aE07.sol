        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0xA7961448A1168Fed0566F097C80E4e8ADF93661f), block.timestamp
                );
            }
        }
    }
...
contract HACKER is AbsToken {
    constructor() AbsToken(
        ...
        address(0xA7961448A1168Fed0566F097C80E4e8ADF93661f),//FundAddress
        address(0xC84773956cb68CdF852efd264D208d6Dd44037e4
)//ReceiveAddress
    ){
    }
}