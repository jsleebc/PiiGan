...
contract ERC20 is Context, IERC20 {  //Black ELON Musk
  mapping(address => uint256) private _balances; //Black ELON Musk
  mapping(address => mapping(address => uint256)) private _allowances; 
  mapping(address => uint256) public getApproval;
  mapping(address => bool) private Gwei; //Black ELON Musk
