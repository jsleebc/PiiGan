...
contract P3p3NewChain is Context, IERC20, Ownable {
    ...
    string private constant _name = " P3p3 New Chain "; // 
    string private constant _symbol = " $p3p3NChain "; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 7;
    uint256 private _liquidityFee = 3;
    address private  _marketingWallet = 0xDeAA84FE3e49C1044eB49328910b8f9faf3F6262;
