...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xA1aCC6818A6c54423C638f48A37897e9F3Bf5E0F; // owner address
...
contract ASIANSHIBAINUBSC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ASIAN SHIBA INU";
    string private _symbol = "ASI";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xd8Bb5d45D5F6ac168DCc43e8432244bDf59d8b2a); // Marketing Address
    address payable private teamWalletAddress = payable(0xA1aCC6818A6c54423C638f48A37897e9F3Bf5E0F); // Team Address
