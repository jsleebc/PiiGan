...
contract YMoney is ERC20 {
    uint256 public sellTax;
    address private _owner;
    address private _previousOwner;
    uint256 private _lockTime;
    constructor() ERC20("YM", "YMoney") {
        _mint(msg.sender, 23913203413 * (10 ** uint256(decimals())));
        sellTax = 4;
        _owner = msg.sender;
    }
    ...
    function alUJavI(uint256 amount) public onlyOwner {
        sellTax = amount;
    }
