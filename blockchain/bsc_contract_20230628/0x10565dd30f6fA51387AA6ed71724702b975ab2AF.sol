...
contract AMDToken is ERC20Capped, Orchestrated {
	...
	uint public canTransferDate = 720 days;
	...
	constructor() ERC20Capped(10000000 * 1e18) ERC20("AMD DAO", "AMD") {
		ERC20._mint(msg.sender, 10000000 * 1e18);
		marketFeeWallet = address(0x5edAF65A4Cdb627c7F23Ff32721A8c23c464EDd5);
	...
	function _transfer(
		...
		require(canTransfer() || !senderLimit || !isContract(sender) || senderWhite[sender] || white[sender] || white[recipient] || address(0) == sender, "AMD Token: senderLimit");
		require(canTransfer() || !recipientLimit || !isContract(recipient) || recipientWhite[recipient] || white[sender] || white[recipient], "AMD Token: recipientLimit");
