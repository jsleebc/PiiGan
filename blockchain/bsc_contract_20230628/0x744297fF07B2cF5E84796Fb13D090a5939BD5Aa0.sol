...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x4D2e616E2cFefc1C4B2804787df3cFd276075A2D; // owner address
...
contract WW1PEPETHEFROGOFFICIALBSC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "WW1 PEPE THE FROG";
    string private _symbol = "WPTF";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x39FC4c363FDbE9C9C9F5F4281Ddf536c4D4adC4E); // Marketing Address
    address payable private teamWalletAddress = payable(0x4D2e616E2cFefc1C4B2804787df3cFd276075A2D); // Team Address
