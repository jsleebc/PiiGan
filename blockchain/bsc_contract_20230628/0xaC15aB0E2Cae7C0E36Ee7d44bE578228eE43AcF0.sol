...
contract PEEPE is IBEP20, Auth {
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 300 / 30000; // 3%
    uint256 public _maxSellTxAmount = _totalSupply * 300 / 30000; // 3%
    uint256 public _maxWalletToken = ( _totalSupply * 300 ) / 30000; // 3%
