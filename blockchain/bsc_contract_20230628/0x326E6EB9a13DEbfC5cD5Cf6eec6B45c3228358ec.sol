...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xC91d0916558373cF5ff30d1950B1415f977D4Dbc; // owner address
...
contract PIGCHAIN is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = " PIG CHAIN ";
    string private _symbol = " PIG ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xC91d0916558373cF5ff30d1950B1415f977D4Dbc); //
    address payable public teamWalletAddress = payable(0xC91d0916558373cF5ff30d1950B1415f977D4Dbc); //
