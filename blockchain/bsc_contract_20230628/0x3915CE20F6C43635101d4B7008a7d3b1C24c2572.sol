...
contract Peperise is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Peperise", "Peperise") {

        address _owner = msg.sender;

        _decimals = 9;

        uint256 totalSupply = 1000000000000000000 * (10**_decimals);
        
        buyTotalFees = 2;
        
        sellTotalFees = 3;

        marketingWallet = address(0xA7c59e3cF6502bC0Bb3641BDdB6C60A58294d041); // set as marketing wallet
