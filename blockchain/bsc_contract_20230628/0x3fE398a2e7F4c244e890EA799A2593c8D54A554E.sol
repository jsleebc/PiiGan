...
contract Token is Ownable {
    ...
    constructor(address marketing_, string memory tokenName_, string memory Tokensymbol_) {
...
contract AppleAI is Token {
    
    constructor(address marketing_, string memory name_, string memory symbol_) Token(marketing_, name_, symbol_) {
