...
contract GigaPepe is IERC20, Ownable {
    ...
    string _name = "GIGA PEPE";
    string _symbol = "GIGA PEPE";
    ...
    constructor () {
        ...
        devFeeReceiver = 0xd335B16117be85370F8F1605522870976FcB7d6e;
        marketingFeeReceiver = 0xd335B16117be85370F8F1605522870976FcB7d6e;
    ...
    uint256 _liquidityFeeSell, uint256 _reflectionFeeSell, uint256 _marketingFeeSell, uint256 _teamFeeSell, uint256 _devFeeSell) external onlyOwner {
        ...
        require(totalFeeBuy <=30,"Cannot set buy fees above 30%"); // max fee possible
