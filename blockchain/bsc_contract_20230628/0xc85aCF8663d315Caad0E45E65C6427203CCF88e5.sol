...
contract BOBDAOToken is Context, IBEP20, Ownable {
    ...
    uint256 private _tTotal = 690 *10**9 * 10**_decimals;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));

    uint256 public swapTokensAtAmount = 1e11 * 10**_decimals;

    address public deadWallet = 0x000000000000000000000000000000000000dEaD;
    address public marketingWallet = 0xAF8Bce8E42A3742c6B58F4F3D0b84e326D395d8b;

    string private constant _name = "BOB DAO";
    string private constant _symbol = "BOBDAO";
