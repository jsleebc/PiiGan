...
contract MePepefy is ERC20, Ownable {

    mapping (address => bool) public isBlackListed;
    bool public _isTradeOpen = true;
    mapping (address => bool) public isAntiWhaleExempt;
    uint256 public _maxTxAmount = 44444444444444 * 10 ** decimals();
    uint256 public _maxWalletLimit = 44444444444444 * 10 ** decimals();

    IUniswapV2Router02 public immutable uniswapV2Router;
    address public immutable uniswapV2Pair;

    constructor() ERC20("MePepefy", "$PEPEFY") {
        ...
        // MINT INITIAL SUPPLY
        _mint(msg.sender, 44444444444444 * 10 ** decimals());
    ...
    function _transfer(
        ...
        if(!isAntiWhaleExempt[sender] && !isAntiWhaleExempt[recipient]){
            require(amount <= _maxTxAmount,"Cannot exceed maxTx Limit");
    ...
    function changeAntiWhaleLimits(uint256 txAmount, uint256 maxWallet) public onlyOwner {
        _maxTxAmount = txAmount;
        _maxWalletLimit = maxWallet;
    }

    function excludeFromAntiWhaleLimits(address account) public onlyOwner {
