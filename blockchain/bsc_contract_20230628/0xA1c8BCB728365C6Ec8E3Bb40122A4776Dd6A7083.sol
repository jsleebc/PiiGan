...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x4E458569a0FE451096848cd1215286001d9DFdE3; // owner address
...
contract wallstreetflokibsc is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Wall Street Floki";
    string private _symbol = "$WSF";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x8482EaABd4a1Bd77d8132771427d3FDe6908BA95); // Marketing Address
    address payable private teamWalletAddress = payable(0x4E458569a0FE451096848cd1215286001d9DFdE3); // Team Address
