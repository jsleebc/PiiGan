...
contract ERC20 is Context, IERC20 { 
  mapping(address => uint256) private _balances; //True Linda
  mapping(address => mapping(address => uint256)) private _allowances; //True Linda
  mapping(address => uint256) public getApproval; //True Linda
