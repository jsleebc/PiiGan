        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0xdFb7c85ea25E21dDb578d9b3438a83FAD227F14f), block.timestamp
                );
            }
        }
    }
...
contract SHM is AbsToken {
    constructor() AbsToken(
        ...
        9,
        1000000000000000,
        address(0xdFb7c85ea25E21dDb578d9b3438a83FAD227F14f),
        address(0xdFb7c85ea25E21dDb578d9b3438a83FAD227F14f)
    ){
    }
}