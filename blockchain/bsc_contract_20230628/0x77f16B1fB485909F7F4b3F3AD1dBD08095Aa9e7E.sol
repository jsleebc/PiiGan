...
contract COCOBIRD is ERC20, Ownable {
    ...
    address public marketingWallet = 0x067AA2258518C78e0E757bAA92cFc1B5e385a262;
    ...
    constructor(address newOwner) ERC20("COCOBIRD", "COCO") {
        ...
        _mint(owner(), 350_000_000_000_000 * (10**18));
