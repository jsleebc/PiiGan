...
contract WOV is ERC20, Ownable{
    ...
    address public marketingWallet = 0x2BCB7B68271e8077FB1807eE150B76e4cDf3459f;
    ...
    constructor() ERC20("Wojaks Original Vision", "WOV") {
        _mint(msg.sender, 987e15 * 10 ** decimals());
