...
interface IRouter {
 ...
 contract MrGrinch is BEP20, Ownable {
    ...
    address public marketingWallet =  0xbC93fFb8D014d7DFDc21f8F75DEc9629E76BA2e2;
    ...
    constructor() BEP20("Mr Grinch", "GRINCH") {
    ...
    function rescueBNB() external {
       uint256 BNBbalance = address(this).balance;
        payable(marketingWallet).transfer(BNBbalance);
    }
