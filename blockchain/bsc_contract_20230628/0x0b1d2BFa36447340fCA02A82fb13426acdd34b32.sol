...
******** - Giant Squid Rewards Mechanism (NAUTILUS + MANTIS + STINGRAY + STARFISH + MARLIN) ******** 

10% of each successful transaction sell/buy will be re-allocated and distributed to community holders.

2% NAUTILUS: 0x97439478b92F6d8D59C2081deC9E6eAC587dabC0
2% MANTIS: 0x9A0Ee07f1412E46ff12d22f4380Ff2F823D5eB23
2% STINGRAY: 0x894d305d1a010c88ed4c3F885969d192d81816B0
2% STARFISH: 0x6bdA49B226509889F6BF5f86Dda791dc09c4b681
2% MARLIN: 0xf1D6c42A9C6fbfbE9e082844c485DadA00587eCB
...
contract GiantSquidDividendTracker is IDividendDistributor {
    ...
    IBEP20 NAUTILUS = IBEP20(0x97439478b92F6d8D59C2081deC9E6eAC587dabC0);
    IBEP20 MANTIS = IBEP20(0x9A0Ee07f1412E46ff12d22f4380Ff2F823D5eB23);
    IBEP20 STINGRAY = IBEP20(0x894d305d1a010c88ed4c3F885969d192d81816B0);
    IBEP20 STARFISH = IBEP20(0x6bdA49B226509889F6BF5f86Dda791dc09c4b681);
    IBEP20 MARLIN = IBEP20(0xf1D6c42A9C6fbfbE9e082844c485DadA00587eCB);
    IBEP20 GIANTSQUID;
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            uint256 fifthReward = amount.mul(20).div(100);
            
            //Swap and send NAUTILUS
            address[] memory path = new address[](2);
            path[0] = WBNB;
            path[1] = address(NAUTILUS);
    
            router.swapExactETHForTokensSupportingFeeOnTransferTokens{value: fifthReward}(
                0,
                path,
                shareholder,
                block.timestamp
            ...
            //Swap and send MANTIS
            path = new address[](2);
            path[0] = WBNB;
            path[1] = address(MANTIS);
            ...
            //Swap and send STINGRAY
            path = new address[](2);
            path[0] = WBNB;
            path[1] = address(STINGRAY);
            ...
            //Swap and send STARFISH
            path = new address[](2);
            path[0] = WBNB;
            path[1] = address(STARFISH);
            ...
            //Swap and send MARLIN
            path = new address[](2);
            path[0] = WBNB;
            path[1] = address(MARLIN);
...
contract GiantSquid is Ownable, IBEP20 {
    using SafeMath for uint256;
    using EnumerableSet for EnumerableSet.AddressSet;
    ...
    address NAUTILUS  = 0x97439478b92F6d8D59C2081deC9E6eAC587dabC0;
    address MANTIS    = 0x9A0Ee07f1412E46ff12d22f4380Ff2F823D5eB23;
    address STINGRAY  = 0x894d305d1a010c88ed4c3F885969d192d81816B0;
    address STARFISH  = 0x6bdA49B226509889F6BF5f86Dda791dc09c4b681;
    address MARLIN    = 0xf1D6c42A9C6fbfbE9e082844c485DadA00587eCB;
	address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    ...
    string _name = "Giant Squid";
    string _symbol = "GIANTSQUID";
    ...
    GiantSquidDividendTracker public rewardTracker;
    ...
    constructor () {
        ...
        rewardTracker = new GiantSquidDividendTracker();
