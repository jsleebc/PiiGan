...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7B815f6833006178062602E72DC120f5c0590231;
...
contract TheGrinchCoin is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x504A0365e9A72e90448085C284c1337f5d7170F4;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 400000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "TheGrinchCoin";
    string private _symbol = "TGHC";
