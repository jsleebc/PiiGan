...
contract COCO is IBEP20, Auth {
    ...
    address DEV =  0x8C35691F8D6BBCD6A70F76d4e4fb41b8566Ff5F7;

    address public autoLiquidityReceiver;
    address public marketingFeeReceiver;

    string constant _name = "COCO";
    string constant _symbol = "COCO";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 350000000000000 * 10**0 * (10 ** _decimals);
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver =0x43B96BC85C7EB6B97030dcdA90489CCD6A42C152;
