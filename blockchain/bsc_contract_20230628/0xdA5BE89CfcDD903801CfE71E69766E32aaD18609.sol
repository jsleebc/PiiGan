...
contract HugoInu is ERC20, Ownable {
    ...
    HugoInuDividendTracker public dividendTracker;

    address public constant deadWallet = 0x000000000000000000000000000000000000dEaD;
    address public marketingWallet = 0x0e6A0eb21C2152425802449B557d3a47472867D7;


    uint256 public swapTokensAtAmount = 5e9 * 10**9;
    ...
    Taxes public buyTaxes = Taxes(4, 4, 2);
    Taxes public sellTaxes = Taxes(4, 4, 2);
    ...
    constructor() ERC20("Hugo Inu", "HUGO") {
        dividendTracker = new HugoInuDividendTracker();
        ...
        /*
            ...
            and CANNOT be called ever again
        */
        _tokengeneration(owner(), 420000000000000000 * (10**9));
    }

    receive() external payable {}

    function updateDividendTracker(address newAddress) public onlyOwner {
        HugoInuDividendTracker newDividendTracker = HugoInuDividendTracker(
            payable(newAddress)
        );
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(
            ...
            "HugoInu: Account is already the value of 'excluded'"
        );
        _isExcludedFromFees[account] = excluded;
    ...
    function setSwapTokensAtAmount(uint256 amount) external onlyOwner {
        require(amount < 5e13,"Swap Threshold should be less than 1% of total supply");
    ...
    function _setAutomatedMarketMakerPair(address newPair, bool value) private {
        require(
            ...
            "HugoInu: Automated market maker pair is already set to that value"
        );
        automatedMarketMakerPairs[newPair] = value;
    ...
    function setGasForProcessing(uint256 newValue) external onlyOwner {
        require(
            ...
            "HugoInu: gasForProcessing must be between 200,000 and 500,000"
        );
        require(
            newValue != gasForProcessing,
            "HugoInu: Cannot update gasForProcessing to same value"
        );
...
contract HugoInuDividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor()
        DividendPayingToken("HugoInu_Dividen_Tracker", "HugoInu_Dividend_Tracker")
    {
        claimWait = 3600;
    ...
    function _transfer(
        ...
        require(false, "HugoInu_Dividend_Tracker: No transfers allowed");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(
            ...
            "HugoInu_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours"
        );
        require(
            newClaimWait != claimWait,
            "HugoInu_Dividend_Tracker: Cannot update claimWait to same value"
        );
