...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x1189B71234039B9639Fb743909fAD9Db287913E9; // owner address
...
contract BobBTC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " Bob BTC ";
    string private _symbol = " BOB ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1189B71234039B9639Fb743909fAD9Db287913E9); // 
    address payable public teamWalletAddress = payable(0x1189B71234039B9639Fb743909fAD9Db287913E9); // 
