...
contract EvolveChain is Context, IERC20, Ownable {
    ...
    address private feeOne = 0xe6d4a6B588550c47285242f6c8fdf238868F9395;
    address private feeTwo = 0xEcbAa9F016676bcFa7c9F3099C8AcA678B256B2a;    
    mapping(address => uint256) private _balances;
    mapping(address => bool) private _taxes;
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => bool) private _isExcludedFromFee;
    string private _name = "EVOLVE CHAIN";
