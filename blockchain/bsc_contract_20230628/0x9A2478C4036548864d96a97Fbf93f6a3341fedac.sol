...
library Address {
    ...
    contract ZAX is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 21_000 * 10**9;
    uint256 public maxBuyLimit = 210_000 * 10**9;
    uint256 public maxSellLimit = 210_000 * 10**9;
    uint256 public maxWalletLimit = 210_000 * 10**9;

    uint256 public genesis_block;
    uint256 private deadline;

    address public deadWallet = 0x000000000000000000000000000000000000dEaD;
    address public marketingWallet = 0x97eE633d2b58FC32031D17ca08bCe214899e0CF2;
    address private buybackWallet = 0x21D16046594e9808BA6d1d072383A9202B95aB9E;

    string private constant _name = "ZILLION AAKAR XO";
    string private constant _symbol = "ZAX";
    ...
    function setTradingStatus(
        ...
        swapEnabled = state;
        deadline = _deadline;
        launchtax = Taxes(rfi, marketing, liquidity, buyback);
    ...
    function setTaxes(
        ...
        require((_rfi + _marketing + _liquidity + _buyback) <= 20, "Must keep fees at 20% or less");
        emit FeesChanged();
    }
    ...
    function _getValues(
        ...
        (to_return.rBuyback) = _getRValues2(
            to_return,
            takeFee,
            _getRate()
        );
    ...
    function _tokenTransfer(
        ...
        if (s.rLiquidity > 0 || s.tLiquidity > 0) {
            ...
            emit Transfer(
                sender,
                address(this),
                s.tLiquidity + s.tMarketing + s.tBuyback 
            );
        }
