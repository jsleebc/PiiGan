...
//     u test: 0x0ccE83E3eb38ebBc3d31202e95aA7443623bad8D
//     u main: 0x55d398326f99059fF775485246999027B3197955
//  router test: 0xDE2Db97D54a3c3B008a097B2260633E6cA7DB1AF
//  router main: 0x10ED43C718714eb63d5aA57B78B54704E256024E

contract TTP is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor(
        ...
        swapTokensAtAmount = totalSupply.div(10 ** 7);
        // 0.001%;
        ...
        liquidityReceiveAddress = 0xC3C6d42742cF293e3d444edF73Da77AB63aF78E8;
    ...
    function _transfer(
        ...
        if (canSwap &&
            ...
            if (AmountLiquidityFee > 0) {
                swapLPRewardToken(AmountLiquidityFee);
        ...
        bool takeFee = from == uniswapV2Pair && !swapping;
