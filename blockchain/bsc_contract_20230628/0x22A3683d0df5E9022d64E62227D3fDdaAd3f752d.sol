...
contract SpongeBobToken is Ownable, IERC20 {
    ...
    uint256 private _totalSupply = 40400000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply * 20 / 1000;
    uint256 public _walletMax = _totalSupply * 20 / 1000;

    string constant private _name = "SpongeBob";
    string constant private _symbol = "SPONGE";
    ...
    constructor() {
        ...
        lpWallet = msg.sender;
        projectAddress = 0xD48FEaA6A2F2665a5586d1c5A33ba5F78a3BcDDd;
