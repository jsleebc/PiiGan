...
contract SynergyLand is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Synergy Land";
    string private _symbol = "SNG";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x71909e784D79390Ccd62f0407c14a0692793AF9B); // Marketing Address
    address payable public teamWalletAddress = payable(0x71909e784D79390Ccd62f0407c14a0692793AF9B); // Team Address
