...
contract PENGUINS is ERC20, Ownable {
    ...
    constructor () ERC20("PUDGY PENGUINS REFUND", "PENGUINS") 
    {   
        address router;
        if (block.chainid == 56) {
        ...
        marketingWallet = 0x7fA620d86daf8E87402f649EB40317c828047202;
        stakingWallet = 0x7fA620d86daf8E87402f649EB40317c828047202;
        treasuryWallet = 0x7fA620d86daf8E87402f649EB40317c828047202;
