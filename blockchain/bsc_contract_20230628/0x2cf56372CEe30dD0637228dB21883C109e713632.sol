...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xCd19a3F80ce1f6F16B4daaaaacC26005D0955251;
...
contract ONLYPEPE is Context, IERC20, Ownable {
    ...
    string private constant _name = "ONLY PEPE"; // 
    string private constant _symbol = "PAP"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 6;
    uint256 public _liquidityFee = 2;
    address payable public  _marketingWallet = payable(0xCd19a3F80ce1f6F16B4daaaaacC26005D0955251);
