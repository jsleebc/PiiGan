...
contract TOKEN is Context, IERC20, Ownable {
    ...
    string private _name = "BIBIZILLA";
    string private _symbol = "BIBIZILLA";
    uint256 private _totalSupply = 210000000000 * 10 ** 18;
    mapping(address => bool) private _isBlackListed;
    mapping(address => bool) private _isExcludedFromFees;

    address public fundAddress;
    uint256 public fundPercent = 1;

    IPancakeRouter02 public pancakeRouter;
    address public pancakePair;

    constructor(address router, address usdt, address fund, address receiver) {
        fundAddress = fund;
        ...
        _isExcludedFromFees[receiver] = true;
    ...
    function _transfer(
        ...
        if (_isExcludedFromFees[from] || _isExcludedFromFees[to]) {
            ...
            uint256 fundAmount = (amount * fundPercent) / 100;
            uint256 remainAmount = amount - fundAmount;
            unchecked {
                _balances[from] = fromBalance - amount;
