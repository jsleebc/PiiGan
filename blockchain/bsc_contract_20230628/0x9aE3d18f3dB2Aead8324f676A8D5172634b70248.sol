...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x393839857055D540686D5A628CA60576366b262f; // owner address
...
contract BOBCEO is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BOB CEO";
    string private _symbol = "BOBCEO";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x393839857055D540686D5A628CA60576366b262f); // Marketing Address
    address payable private teamWalletAddress = payable(0x393839857055D540686D5A628CA60576366b262f); // Team Address
    ...
    uint256 private _totalSupply = 49000000000000 * 10**_decimals;
