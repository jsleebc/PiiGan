...
contract Deadpepe is Context, IERC20, Ownable {
    ...
    address payable public marketingWallet =
        payable(0x641Fe8749e9043AcA184575b9E8FE056503cdead);
    ...
    //Supply Definition.
    uint256 private _tTotal = 420_069_000_000 ether;
    uint256 private _tFeeTotal;
    //Token Definition.
    string public constant name = "DeadPepe";
    ...
    uint256 public minimumTokensBeforeSwap = 100_069_000 ether;
...
//View the wallets that are excluded from view.
    ...
    //SetFees to zero, disable swapAndliquify.
    function setZeroFee() external onlyOwner{
        require(sellFee !=0, "Fees are already 0");
        sellFee = 0;
        swapAndLiquifyEnabled = false;
        emit AuditLog("All Fees are now 0 and Swapandliquify Disable:", msg.sender);
    }
