...
contract ERC20TaxToken is Context, IERC20, LockToken
{
    ...
    address payable public marketingAddress = payable(0xe6038874E08dEC97e99563287Fd40888bF047abB);
    address payable public devAddress = payable(0x82CeF727a356fD960e608121cA2A6e7E40b900Fa);
    address public newOwner = 0x82CeF727a356fD960e608121cA2A6e7E40b900Fa;
    ...
    string private _name = "$LAMBO BSC";
    ...
    uint256 public _sellMarketingFee = 55;
    ...
    uint256 private minimumTokensBeforeSwap = 200000000 * 10**18;
