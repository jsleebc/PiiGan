...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0xE72D0888b108d2FafF5714C28c493C48808DFe52); //Pepe Grow
...
contract BABYPEPEGROW is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Baby Pepe Grow";
    ...
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address RewardToken = 0xE72D0888b108d2FafF5714C28c493C48808DFe52; //Pepe Grow
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0xE9327751d1b480dE8443b06eB609Ad2D64407c30;  //marketingwallet
        BackUp = 0xE9327751d1b480dE8443b06eB609Ad2D64407c30; //backup wallet
    ...
    function changeFeeReceivers(address newLiquidityReceiver, address newMarketingWallet, address newBackUp) external onlyOwner {
