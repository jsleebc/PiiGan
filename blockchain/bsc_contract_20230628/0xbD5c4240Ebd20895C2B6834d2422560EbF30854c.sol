...
SAITAMA + PEPE = SAIPEPE

Tired of dog meme tokens? welcome to SAIPEPE. 
SAIPEPE is a new digital currency inspired by the popular Pepe meme character and the community-driven nature of meme culture.

https://t.me/saipepeofficial
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x9fAa4Fb424142dD46d9Bc4Baa572Fc72033a7ea3; // owner address
...
contract SAIPEPE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SAITAMA PEPE";
    string private _symbol = "$SAIPEPE";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x9fAa4Fb424142dD46d9Bc4Baa572Fc72033a7ea3); // Marketing Address
    address payable private teamWalletAddress = payable(0x9fAa4Fb424142dD46d9Bc4Baa572Fc72033a7ea3); // Team Address
