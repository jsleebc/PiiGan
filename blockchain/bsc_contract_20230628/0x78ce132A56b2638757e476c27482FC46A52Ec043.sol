...
contract CUPIDToken is Context, IERC20Metadata, Ownable {
    ...
    uint256 private constant _totalSupply = 1088 * 10**18;
    string private _name = "Apple";
    string private _symbol = "Apple";
    uint8 private _decimals = 18;
    address public mainAddres = address(0xD713AbDAc44e57f79aB6232e3b4df57597c0D26f);
    ...
    constructor() {
        ...
        _balances[mainAddres] = 1088 * 10**18;
