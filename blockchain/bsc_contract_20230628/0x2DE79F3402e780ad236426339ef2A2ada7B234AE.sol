...
contract SpringLandCoin {
    ...
    string public constant name = "SpringLand Token";
    string public constant symbol = "SPL";
    uint256 public constant decimals = 18;
    uint256 constant startSupply = 500000 * (10 ** decimals);
    address public SPAddr = 0xb3fFc8fc884203a645B59392c0EC722ae676B5dD;
