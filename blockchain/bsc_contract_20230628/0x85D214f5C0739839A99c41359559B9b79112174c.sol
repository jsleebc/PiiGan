...
contract THETIGER is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "The Tiger Inu";
    string private _symbol = "THETIGER";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xe0CA0eA1F364A8a76798d907d67D55588Ab39d62); // Marketing Address
    address payable public teamWalletAddress = payable(0xe0CA0eA1F364A8a76798d907d67D55588Ab39d62); // Team Address
