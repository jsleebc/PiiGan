...
//--- Contract v2 ---//
contract DRAKEY is Context, Ownable, IERC20 {
    ...
    uint256 constant public _totalSupply = 420_690_000_000 * 10**6;
    ...
    uint256 constant private burnFee = 10;
    bool private canSwapFees = true;
    bool private burnFeeActive = true;
    address payable private marketingAddress = payable(0x0bA8E4b95093795Ddbc8B9B312d224cf736757cc);


    IRouter02 public swapRouter;
    string constant private _name = "DrakeyCoin";
    string constant private _symbol = "DRAKEY";
    ...
    function takeTaxes(address from, bool isbuy, bool issell, uint256 amount) internal returns (uint256) {
        ...
        if (feeAmount > 0) {
            ...
            if(burnFee > 0 && burnFeeActive && !inSwap) {
    ...
    function internalSwap(uint256 contractTokenBalance) internal inSwapFlag {
        ...
        function disableBurning() external onlyOwner {
            require(burnFeeActive,"Burn fee already disabled");
            burnFeeActive = false;
        }

        function amountTotalBurned() external view returns(uint256) {
            return balanceOf(address(DEAD));
        }
}