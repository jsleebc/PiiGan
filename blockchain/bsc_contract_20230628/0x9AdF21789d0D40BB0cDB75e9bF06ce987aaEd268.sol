        ...
        if (lpAmount > 0) {
            ...
            if (lpusdtt > 0) {//=0xB821bb072f08A338962272923f9f4221B69094FC (配置地址，不能改，改了会产生错误）
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpusdtt, 0, 0, address(0x92fBD5cf7dE97AeA6b35eef4Da68de9F8c5dE141), block.timestamp
                );
            }
        }
    }
...
contract coiton is AToken {
    constructor() AToken(
        ...
        18,//De
        100000000,//Su 
        address(0x92fBD5cf7dE97AeA6b35eef4Da68de9F8c5dE141),//
        address(0x92fBD5cf7dE97AeA6b35eef4Da68de9F8c5dE141)//
    ){
    }
}