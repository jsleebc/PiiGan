...
contract YesIAm is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Yes I Am";
    string private _symbol = "Yes I Am";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x28956F42ED73617e27b4b168129F935cF1E82819); // Marketing Address
    address payable public teamWalletAddress = payable(0x28956F42ED73617e27b4b168129F935cF1E82819); // Team Address
    ...
    uint256 public _walletMax = 5000 * 10**6 * 10**_decimals;
