...
contract DONSPEPE is Context, IBEP20, Ownable {
    ...
    address public marketingWallet = address(0x0BAA9FBdB2A62B36A3a655B125c56d2FbC86E59f);

    string private constant _name = "DonsPepe";
