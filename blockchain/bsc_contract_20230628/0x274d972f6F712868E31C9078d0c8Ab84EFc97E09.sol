...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x31598A7De9e53c5Ea83FA2aC0Ef4F5E3fa84ABdc; // owner address
...
contract Arven is Context, IERC20, Ownable {
    ...
    string private _name = "Arven Network";
    string private _symbol = "ARVN";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x2a011B042C5757CB61c5783219250e6D0Ab13122); // Marketing Address
    address payable public developmentWalletAddress = payable(0x4EaeBF84ABf766130A3cD609095297bFd38D7443); // development Address
    ...
    uint256 public _maxTaxPercentage = 30;
    ...
    function setBuyTaxes(uint256 newLiquidityTax, uint256 newMarketingTax, uint256 newDevelopmentTax) external onlyOwner() {
        require( _totalTaxIfBuying <= _maxTaxPercentage, "Max set tax is 30"); 
    ...
    function setSellTaxes(uint256 newLiquidityTax, uint256 newMarketingTax, uint256 newDevelopmentTax) external onlyOwner() {
        require( _totalTaxIfSelling <= _maxTaxPercentage, "Max set tax is 30"); 
