/**
Telegram: https://t.me/Graph_Chain
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xbbCDF7FB04828c62414206B638f5B7f99B0DA256; // owner address
...
contract Graph is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Graph Chain";
    string private _symbol = "Graph";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xbbCDF7FB04828c62414206B638f5B7f99B0DA256); // Marketing Address
    address payable public teamWalletAddress = payable(0xbbCDF7FB04828c62414206B638f5B7f99B0DA256); // Team Address
