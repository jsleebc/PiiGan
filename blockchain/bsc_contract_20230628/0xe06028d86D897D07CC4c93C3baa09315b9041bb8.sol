...
contract PEPPAPIG is Context, IERC20, Ownable {
    ...
    string private constant _name = "PEPPAPIG";
    string private constant _symbol = "PEPPAPIG";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0xEE05bdea921D269d54e8E14FaF1B5F26236B9a9f);
    address payable private _marketingAddress = payable(0xEE05bdea921D269d54e8E14FaF1B5F26236B9a9f);
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyOwner {
	    ...
	    require(taxFeeOnBuy < 3, "Tax cannot be more than 3.");
