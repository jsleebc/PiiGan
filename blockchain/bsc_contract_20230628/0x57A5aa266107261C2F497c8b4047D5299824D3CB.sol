...
//--- Contract v2 ---//
contract REALZA is Context, Ownable, IERC20 {
    ...
    address payable private marketingAddress = payable(0x0Ab3Ba1f1bEc3a1348f615d208448bb2fb5A5eF8);


    IRouter02 public swapRouter;
    string constant private _name = " 4REALZA COIN";
    string constant private _symbol = "4RZ";
    ...
    function internalSwap(uint256 contractTokenBalance) internal inSwapFlag {
        ...
        function changeTaxes(uint256 buy, uint256 sell) external onlyOwner {
            require(sell <= 8,"Freddy: High Taxes");
            require(buy <= 8,"Freddy: High Taxes");
            buyfee = buy * 10;
            sellfee = sell * 10;
