        ...
        if (lpAmount > 0) {
            ...
            if (lpusdtt > 0) {//=0xB821bb072f08A338962272923f9f4221B69094FC (配置地址，不能改，改了会产生错误）
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpusdtt, 0, 0, address(0x3d1745c5b82cc6c809FA6C1A063996fB76b9028a), block.timestamp
                );
            }
        }
    }
...
contract jiuken is AToken {
    constructor() AToken(
        ...
        18,//De
        10000000,//S
        address(0x3d1745c5b82cc6c809FA6C1A063996fB76b9028a),//
        address(0x3d1745c5b82cc6c809FA6C1A063996fB76b9028a)//
    ){
    }
}