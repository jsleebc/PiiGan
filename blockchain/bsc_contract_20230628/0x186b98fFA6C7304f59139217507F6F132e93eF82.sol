...
contract babyppc is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "babyppc";
    string private _symbol = "babyppc";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0x3ebdA7961A93813456Dd17463EF6CDBA151295AC);
