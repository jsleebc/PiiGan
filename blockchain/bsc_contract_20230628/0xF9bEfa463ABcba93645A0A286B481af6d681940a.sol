...
🐸WELCOME TO PEPEBURGER - (BSC) 🐸

🐸The Pepe trend is not over yet, PEPEBURGER is coming to BSC. Get ready!

🐸Safe Dev launched this token try to give you another opportunity to grab the 
MOONSHOT! Don't missed great entry point here to get your best seat. 🚀
...
🐸Telegram : https://t.me/pepeburgerofc
...
contract PEPEBURGER is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "PEPE-BURGER";
    string private constant _symbol = unicode"$PURG";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 440000000 * 10**_decimals;
    ...
    address payable public DevWallet = payable(0x10f307CaCd2599A9D6CF2Fe5e3Cc72706A0C6149);
    address payable public MarketingWallet = payable(0xfEFaBE01f040f96bE8a0AcEe2D9017732670E020);
