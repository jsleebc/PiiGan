...
/*************************************************************
Web: http://xtradingai.com/

Tg: https://t.me/+-n2aYQT3e4Q5ZjNh
**************************************************************/
...
library Address{
 ...
 contract XTradingAI is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x66A998DfAD81B9f9E147a052993fD2420590399b;
    address public donationWallet = 0x66A998DfAD81B9f9E147a052993fD2420590399b;

    string private constant _name = "x TRADING AI";
    string private constant _symbol = "X TRADING AI";
    ...
    Taxes public taxes = Taxes(0, 4, 0, 4);
    Taxes public sellTaxes = Taxes(0, 4, 0, 5);
