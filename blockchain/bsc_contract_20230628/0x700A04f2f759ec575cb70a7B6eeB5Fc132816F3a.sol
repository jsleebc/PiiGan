...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xDa38fE1333222550966ba29F29547Ea559e4fb04; // owner address
...
contract FlojakBSC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Flojak";
    string private _symbol = "$Flojak";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x1e925D92F1dE75d0e9e16c8E2Af21ffe1290cba0); // Marketing Address
    address payable private teamWalletAddress = payable(0xDa38fE1333222550966ba29F29547Ea559e4fb04); // Team Address
