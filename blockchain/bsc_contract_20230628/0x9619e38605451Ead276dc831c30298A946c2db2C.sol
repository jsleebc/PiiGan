...
contract SNAIL is Context, IBEP20, Ownable {
    ...
    address public marketingWallet = 0x25df1a4d6F8fCe15166E9E15a3373C7e42A476A7
;
    address public opsWallet = 0x70A15EBfdDAAB2093aB8E21A7226A60A91937c12;
    address public devWallet = 0xaEC101Fc5c4481B5F9469787679233fc60AC2900
;

    string private constant _name = "SNAIL";
    ...
    Taxes public taxes = Taxes(3, 4, 2, 0, 1);
    Taxes public sellTaxes = Taxes(3, 4, 2, 0, 1);
