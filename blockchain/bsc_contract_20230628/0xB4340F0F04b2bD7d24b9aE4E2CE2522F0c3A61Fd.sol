...
contract SNOWDOG is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x118368C54D455bA19cE67d0b032470849531A440); 
    address payable public Wallet_Dev = payable(0x118368C54D455bA19cE67d0b032470849531A440);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =10 * 10**6* 10**6 * 10**_decimals;
    string private constant _name = "SNOW DOG"; 
    ...
    constructor () {
        _owner =0x118368C54D455bA19cE67d0b032470849531A440;
