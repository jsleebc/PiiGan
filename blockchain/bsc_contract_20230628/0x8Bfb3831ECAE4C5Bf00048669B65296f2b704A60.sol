...
contract SUI is Context, IERC20, Ownable {
    ...
    string private _name = "SUI LISTING";
    ...
    address payable public marketingWallet = payable(0xE9c2B99E7bACcD8915De9e5198Dc0cb1A427C108);
    ...
    uint256 public numTokensSellToAddToLiquidity = 3000000 * 10**18;
