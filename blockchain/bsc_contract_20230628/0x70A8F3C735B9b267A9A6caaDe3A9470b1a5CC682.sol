...
//StreamBITS is a Web3 video streaming platform that may be used to watch movies, videos, read reviews, and stream services. 

//https://stream-bits.com
...
contract STREAM is ERC20, Ownable {
    ...
    constructor() ERC20("StreamBITS", "STREAM") {
        ...
        marketingWallet = address(0xC7A7eA4870dd9bA6b04366c88B7CaaDbfaE41975); // set as marketing wallet
        devWallet = address(0xC7A7eA4870dd9bA6b04366c88B7CaaDbfaE41975); // set as dev wallet
