...
contract Fuck is Context, IERC20, Ownable {
    ...
    uint256 public maxSellAmount = 25000000 * 10**_decimals; //2.5%
    uint256 public maxBuyAmount = 50000000 * 10**_decimals; //5%
    uint256 public maxWalletBalance = 50000000 * 10**_decimals; //5%

    address public marketingAddress = 0xe153205c0607aE1B10798827e680FEd33fBced5a;
    address public devAddress = 0xe153205c0607aE1B10798827e680FEd33fBced5a;
    ...
    Taxes public taxes = Taxes(0,0,0,5);
    Taxes public sellTaxes = Taxes(0,0,0,5);
