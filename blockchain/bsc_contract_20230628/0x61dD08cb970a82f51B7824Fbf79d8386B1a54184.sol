...
contract RAPTORNETWORK is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Raptor Network";
    string private _symbol = "RAPNET";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0a56174caC500Bfc29E29b29c93DB01dD94Bb533); 
    address payable public buyBackWalletAddress = payable(0xC814338F8C7EEAB895bAf12F4F1Fe83d62Ad0C7C); 
