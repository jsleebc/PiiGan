...
contract JohnCoin is Context, IERC20, Ownable {
    ...
    uint256 public maxHoldLimit = _totalSupply.mul(1).div(100); // this is the max wallet holding limit
    uint256 public maxTxnLimit = _totalSupply.mul(1).div(100); // this is the max wallet holding limit
    uint256 public percentDivider = 1000;
    uint256 public taxDivider = 100;
    ...
    uint256 public marketFeeOnBuying = 3; // 3% will be added to the market address
    uint256 public liquidityFeeOnBuying = 2; // 1% will be added to the liquidity

    uint256 public marketFeeOnSelling = 40; // 2% will be added to the market address
    uint256 public liquidityFeeOnSelling = 2; // 1% will be added to the liquidity
    ...
    constructor() {
        marketWallet = payable(0x57e182bD905C1C6AE5AAE923977E292407dA2C1D);
        devWallet = payable(0x57e182bD905C1C6AE5AAE923977E292407dA2C1D);
    ...
    function setBuyFeePercent(
        ...
        require(
            _marketFee.add(_lpFee) <= taxDivider.mul(5).div(100),
    ...
    function setSellFeePercent(
        ...
        require(
            _marketFee.add(_lpFee) <= taxDivider.mul(45).div(100),
            "can't be more than 45%"
        );
    }
    ...
    function totalBuyFeePerTx(uint256 amount) public view returns (uint256) {
        uint256 fee = amount
            .mul(marketFeeOnBuying.add(liquidityFeeOnBuying))
            .div(taxDivider);
        return fee;
    }
    ...
    function totalSellFeePerTx(uint256 amount) public view returns (uint256) {
        uint256 fee = amount
            .mul(marketFeeOnSelling.add(liquidityFeeOnSelling))
            .div(taxDivider);
        return fee;
    }
    ...
    function setFeeCountersOnBuying(uint256 amount) private {
        liquidityFeeCounter += amount.mul(liquidityFeeOnBuying).div(taxDivider);
        marketFeeCounter += amount.mul(marketFeeOnBuying).div(taxDivider);
    }
    ...
    function setFeeCountersOnSelling(uint256 amount) private {
        ...
        marketFeeCounter += amount.mul(marketFeeOnSelling).div(taxDivider);
    }
