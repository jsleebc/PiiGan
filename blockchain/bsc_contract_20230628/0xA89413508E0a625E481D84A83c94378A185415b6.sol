...
contract TateCartel is ERC20, Ownable {
    ...
    constructor() ERC20("Tate Cartel", "$TATE") {
        ...
        uint256 totalSupply = 133769420000000 * 1e18;
    ...
    function updateBuyFees(uint256 _marketingFee, uint256 _liquidityFee) external onlyOwner {
        ...
        buyTotalFees = buyMarketingFee + buyLiquidityFee;
        require(buyTotalFees <= 15,"Total buy fees cannot be greater than 15%");
    }
    ...
    function updateSellFees(uint256 _marketingFee, uint256 _liquidityFee) external onlyOwner {
        ...
        sellTotalFees = sellMarketingFee + sellLiquidityFee;
        require(sellTotalFees <= 15,"Total sell fees cannot be greater than 15%");
    }
