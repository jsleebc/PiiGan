/**    
    Game Story
    One day, a meteorite crashed into the Tree of Harmony on Miguel Island, 
    causing it to produce jewel-shaped fruits. The island's animals and elves 
    ate the fruits and gained different superpowers. However, 
    as different races battled to monopolize the powers, chaos erupted on the island.
    
    https://matchnova.com
    https://twitter.com/MatchNovaGlobal
*/
