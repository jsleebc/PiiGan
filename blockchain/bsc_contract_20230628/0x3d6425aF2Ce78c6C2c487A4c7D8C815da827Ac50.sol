...
contract HeroNETWORK is ERC20, Ownable {
    ...
    constructor() ERC20("Hero Network", "$Hero") {
        ...
        marketingWallet = address(0x3239129B0D8b8B5070A358A92154CCb8658cccde); 
        devWallet = address(0x3239129B0D8b8B5070A358A92154CCb8658cccde);
        lpWallet = msg.sender;
