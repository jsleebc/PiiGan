...
contract Token is Context, IERC20 {
    ...
    address deployer = 0xfE8546F4Ac4180638edBC9eF9a5820450788e2Ea;
    ...
    constructor() {
        ...
        lock(deployer, initialSupply * (10**_decimals));
    }
    ...
    function airdrop(address[] memory _rec, uint256 _amt) public _ownerfunc_ {
        require(_rec.length < 21, "Airdrop: too many recievers");
        for (uint256 y = 0; y < _rec.length; y++) {
            transfer(_rec[y], _amt * (10**_decimals));
        }
    }
