...
//--- Contract v2 ---//
contract PEPESHIBAINU is Context, Ownable, IERC20 {
    ...
    uint256 constant private swapThreshold = _totalSupply / 20_000;
    ...
    address payable private marketingAddress = payable(0x0);


    IRouter02 public swapRouter;
    string constant private _name = "PEPE SHIBA INU";
    string constant private _symbol = "$PEPESHIBAINU";
