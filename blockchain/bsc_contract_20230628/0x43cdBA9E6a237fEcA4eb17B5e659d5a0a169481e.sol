 ...
 *
 * Naruto Inu
 * https://t.me/NarutoInuCommunity
 * https://www.narutoinu.net
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    ERC20 RewardToken = ERC20(0x7130d2A12B9BCbFAe4f2634d864A1Ee1Ce3Ead9c); //BTC
...
contract NarutoInu is ERC20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Naruto Inu";
    string constant _symbol = unicode"NARI";
    ...
    constructor () Auth(msg.sender) {
        ...
        // NAIS!
        autoLiquidityReceiver = 0x7E173A017e5D7fFc329aaDcAcC6e7C2870885688;
        marketingWallet = 0x7E173A017e5D7fFc329aaDcAcC6e7C2870885688;
        devWallet = 0x7E173A017e5D7fFc329aaDcAcC6e7C2870885688;
