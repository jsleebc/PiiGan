...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x9C8a4C3784B11683ad75CDc4147bb467Bcf3cAF7; // Theta Dev
...
contract VelvetNetwork is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Velvet Network";
    string private _symbol = "VELVET";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9C8a4C3784B11683ad75CDc4147bb467Bcf3cAF7); // 
    address payable public earnWalletAddress = payable(0xB773DDfe8D07c3Ea58bCE1739e77851a988844b9); // 
