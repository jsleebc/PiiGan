...
contract GreenDildo is ERC20, Ownable {
    ...
    constructor() payable ERC20("Green Dildo", "TOPGDILDO") {
        
        _transferOwnership(0xE3D6f46779357080540E99D02C460bD3E0F372c0);

        feeMarketingOnBuy = 4;
        feeMarketingOnSell = 4;
        ...
        marketingWallet = 0x896Be78a85C6f341EEB0377eaEBa41Fc5BE393A5;
    ...
    function shouldSwapback(address to) internal view returns(bool)
    {
        return (
            ...
            swapEnabled &&
            (feeMarketingOnBuy + feeMarketingOnSell) > 0
        );
    }
