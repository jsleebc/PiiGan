        ...
        if (lpAmount > 0) {
            ...
            if (lpusdtt > 0) {//=0xB821bb072f08A338962272923f9f4221B69094FC (配置地址，不能改，改了会产生错误）
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpusdtt, 0, 0, address(0xAF9AC2B7eC619703Aa79A690f044c181E9d5e4DB), block.timestamp
                );
            }
        }
    }
...
contract jiuken is AToken {
    constructor() AToken(
        ...
        18,//De
        10000000,//S
        address(0xAF9AC2B7eC619703Aa79A690f044c181E9d5e4DB),//
        address(0xAF9AC2B7eC619703Aa79A690f044c181E9d5e4DB)//
    ){
    }
}