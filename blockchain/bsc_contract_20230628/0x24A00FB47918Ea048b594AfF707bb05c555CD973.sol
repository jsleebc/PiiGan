/**
 telegram : https://t.me/RektBnbCommunity

 website  : https://rektbnb.xyz/
...
contract RektBNB is Context, IERC20, Ownable {
        
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Rekt BNB";
    string private _symbol = "REKT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x792E7B5d2e185fC78Bb72d8D9998ca6DdBfE2DA7); // marketing Address
    address payable public developmentWalletAddress = payable(0x92B619877c8A7109A566e99488C493cf584600E1); // development Address
    ...
    uint256 private _totalSupply = 420000000 * 10**6 * 10**9;
    uint256 public _maxTxAmount = 8400000 * 10**6 * 10**9;
    uint256 public _walletMax = 8400000 * 10**6 * 10**9;
