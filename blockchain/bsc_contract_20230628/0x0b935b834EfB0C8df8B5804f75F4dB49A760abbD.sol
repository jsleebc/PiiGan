/**
Ancient token - longterm project on BSC.

Website: https://ancienttoken.net/
Telegram: https://t.me/Ancient_token
*/
...
contract Ancient is IERC20, Ownable {
  ...
  /* rOwned = ratio of tokens owned relative to [[circulating]] supply */
    ...
    uint256 smallSwapThreshold = 60000 * 10**_decimals; 
    uint256 largeSwapThreshold = 90000 * 10**_decimals; 
    ...
    constructor () {
        ...
        devFeeReceiver = 0x1c989B7D6ffc5b64553D25e8a7aF47CC20907976;
        marketingFeeReceiver = 0x88129dd47eA28181D6b0605550Fab170B55d0050;
    ...
    uint256 _liquidityFeeSell, uint256 _reflectionFeeSell, uint256 _marketingFeeSell, uint256 _teamFeeSell, uint256 _devFeeSell) external onlyOwner {
        ...
        require(totalFeeBuy <=11,"Cannot set buy fees above 11%"); // Max Buy Fee possible to set
        require(totalFeeSell <=11,"Cannot set sell fees above 11%"); // Max Fee Sell possible to set
