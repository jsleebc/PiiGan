...
contract Luck365 is ERC20,Ownable{
    using SafeMath for uint256;
    uint256 public constant maxSupply =   1e18*21000000;
    ...
    address public constant routeraddr = 0x10ED43C718714eb63d5aA57B78B54704E256024E;

    uint256 public constant burnRateMax = 10000;
    uint256 public constant burnRateUL = 300;
    uint256 public buyburnRate = 100;
    uint256 public sellburnRate =  100;
    uint256 public tranburnRate = 0;
    address public govAddress =0xa006E8d1B0A03353b6df27d16ab65D0A93621077;

    mapping(address => bool) public whitelist;
    event WhitelistUpdate(address indexed _address, bool statusBefore, bool status);

    constructor() ERC20("Luck365.win", "Luck365")  {
        _mint(govAddress, maxSupply);
        router = IPancakeSwapRouter(routeraddr);
    ...
    function setMM(address pair, bool value) external  {
    ...
    function setBurnRate(uint256 _tranburnRate,uint256 _buyburnRate,uint256 _sellburnRate)  external {

        require(msg.sender == govAddress, "!gov");
        require(_tranburnRate <= burnRateUL, "too high");
        require(_buyburnRate <= burnRateUL, "too high");
        require(_sellburnRate <= burnRateUL, "too high");
        tranburnRate = _tranburnRate;
