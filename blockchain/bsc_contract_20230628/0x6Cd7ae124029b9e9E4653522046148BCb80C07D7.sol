...
/*
    Pepechain - Welcome to Pepe Tokens World!
    Pepechain includes all pepe tokens in its ecosystem, offering Swap, 
    View and similar benefits for them. Pepechain visitors can instantly 
    have information about all Pepe tokens.
    
    100% Working Ecosystem & DAPP for Pepe World!
    
    Website: pepechain.net
    Pepechain World: pepechain.net/world
    Pepechain APE: pepechain.net/ape
    Pepechain DEX VIEW: view.pepechain.net
    Pepechain SWAP: swap.pepechain.net

    Telegram: t.me/pepechaintoken
    Twitter: twitter.com/pepechainbsc
*/
...
// Pepechain Constructor
contract PepechainToken is Context, IERC20, Ownable {
    ...
    string private _symbol = "PECH";
    uint8 private _decimals = 9;
    address public deadAddress = 0x0000000000000000000000000000000000000000;
    address public charityWallet = 0x8b8f4903a137b66a2640157BDa37e64E1C204a62;
    ...
    // Max Transfer Constructor
    uint256 public numTokensSellToAddToLiquidity = 7770000000 * 10**9;
    uint256 public _maxTxAmount = 777000000000 * 10**9;
