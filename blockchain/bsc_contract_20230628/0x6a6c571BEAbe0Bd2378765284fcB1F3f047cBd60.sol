...
// TELEGRAM : https://t.me/Onigirlinuportal
// WEBSITE  : https://twitter.com/Onigirlinu
...
contract ONIGIRLINU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ONIGIRL INU";
    string private _symbol = "ONIGIRL";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xe43e0bd26cb5B229831ea5d9543a6EDe75F43737); // Marketing Address
