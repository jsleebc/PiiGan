...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0x4f833cc89Ad9f2C300288B3C7a26927a473458a2); 
...
contract MINITOADY is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "MINI TOADY";
    string constant _symbol = "$MTOADY";
    uint8 constant _decimals = 18;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address RewardToken = 0x4f833cc89Ad9f2C300288B3C7a26927a473458a2; 
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0xc0429eb3Eb9581AB8e6EdF9FA789638ca72C17FC;
        buybackWallet = 0xc0429eb3Eb9581AB8e6EdF9FA789638ca72C17FC;
