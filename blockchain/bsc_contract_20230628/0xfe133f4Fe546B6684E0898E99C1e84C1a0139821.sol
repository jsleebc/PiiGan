/*
 telegram : https://t.me/TheRiseofGruMinions
 twitter  :https://twitter.com/TheRiseofGru00
 website  :https://www.theriseofgru.net/
*/
...
contract Minions is Context, IERC20, Ownable {
    ...
    string private _name = "Minions Rise of Gru";
    string private _symbol = "MINIONS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x62e78d4D7d42F7a4dEaf64E03c051a625CF6707A); // marketing Address
    address payable public developmentWalletAddress = payable(0x62e78d4D7d42F7a4dEaf64E03c051a625CF6707A); // development Address
    ...
    uint256 private _totalSupply = 10400 * 10**9;
    uint256 public _maxTxAmount = 208 *  10**9;
    uint256 public _walletMax = 208 * 10**9;
    uint256 private minimumTokensBeforeSwap = 0.00000001 * 10**9; 
