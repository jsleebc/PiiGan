//https://t.me/Pepenaruto_bsc_community
...
contract PepeNaruto is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "PePuTo";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0x7Fe0dEA78741c8F2B8fbCAb2B172A814d86CC283);
    address payable private _marketingAddress = payable(0x7Fe0dEA78741c8F2B8fbCAb2B172A814d86CC283);
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyOwner {
	    require(redisFeeOnBuy < 98, "Redis cannot be more than 100.");
	    require(redisFeeOnSell < 98, "Redis cannot be more than 100.");
	    require(taxFeeOnBuy < 98, "Tax cannot be more than 100.");
	    require(taxFeeOnSell < 98, "Tax cannot be more than 100.");
