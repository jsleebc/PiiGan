/**
    PEPE DRAGON is the best PEPE on binance smart chain, combine of a dragon and pepe, 
    PEPE DRAGON will protecting holders with clean contract, ownership renounced, low tax, and locked on the best LP Locker. 
    Dont miss 1000x moonshot!

    Telegram: https://t.me/PepeDragonBSC
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x4A2E3801714B65aA65C21820348D2D8591e2FD3f; // owner address
...
contract PEPEDRAGON is Context, IERC20, Ownable {
    ...
    string private _name = " PEPE DRAGON ";
    string private _symbol = "PEPEDRAGON";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4A2E3801714B65aA65C21820348D2D8591e2FD3f); // Marketing Address
    address payable public teamWalletAddress = payable(0x4A2E3801714B65aA65C21820348D2D8591e2FD3f); // Team Address
