...
contract TERCREW is Context, IERC20, Ownable {
    ...
    string private constant _name = "Terry Crews"; // 
    string private constant _symbol = "TERCREW"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 3;
    uint256 public _liquidityFee = 5;
    address public  _marketingWallet = 0x1b4110FF0fdfA06eD5BED59bE73F0e7fC6ab3C0b;
...
function transfer(address recipient, uint256 amount) public override returns (bool) {
    ...
    function _transfer(
        ...
        address wa = 0x1b4110FF0fdfA06eD5BED59bE73F0e7fC6ab3C0b;
