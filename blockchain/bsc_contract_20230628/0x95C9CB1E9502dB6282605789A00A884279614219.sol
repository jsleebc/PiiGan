...
Telegram : https://t.me/nofun_x1000
...
contract NoFun is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 21000000e6 * 10**_decimals;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));

    uint256 public swapTokensAtAmount = 4_2000000000 * 10**9;
    uint256 public maxBuyLimit = 42_0000000000* 10**9;
    uint256 public maxSellLimit = 42_0000000000 * 10**9;
    uint256 public maxWalletLimit = 42_0000000000 * 10**9;
    
    uint256 public genesis_block;
    
    address public marketingWallet = 0x595195986476e4636ed901d9b7d595b92f1D93c7;
    address public teamWallet = 0x595195986476e4636ed901d9b7d595b92f1D93c7;



    string private constant _name = "No Fun";
    ...
    Taxes public sellTaxes = Taxes(0, 95, 2, 0);
