...
contract Ragnarok is ERC20, Ownable {
    ...
    address public immutable marketingWallet = 0x1e395b628c4dC2E47cF1617427C2737681501034;
    ...
    // 10%
    uint256 public buyTotalFees = 150;

    uint256 public sellTotalFees = 250;
    ...
    // Supply 10 trillion
    constructor() ERC20("RAGNAROK", "RAGNAROK") {
        ...
        // supply 10 trillion
        uint256 _supply = 1000000000000000 * 10**18;
        // 1.0% MaxTx amount
        maxTransactionAmount = (_supply * 80) / 10000;
        // 1.0% Max Wallet Size
        maxWallet = (_supply * 80) / 10000;
        // 0.03% TrashHold
        swapTokensAtAmount = (_supply * 8) / 10000;
