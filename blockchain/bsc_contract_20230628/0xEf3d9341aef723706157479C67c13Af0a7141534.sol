...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x31800c6d52896B55F9E4EbD4331Cd7fb6715cEd2; // owner address
...
contract TACOCAT is Context, IERC20, Ownable {
    ...
    string private _name = "Taco Cat";
    string private _symbol = "TACOCAT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8C56915228e9158E119d84406a6DedEc5F73C0Ba); // Marketing Address
    address payable public teamWalletAddress = payable(0xC44e5Abc45167eeB823359BD86fADbEEe46507a4); // Team Address
