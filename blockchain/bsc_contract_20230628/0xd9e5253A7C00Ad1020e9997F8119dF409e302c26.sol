...
contract BEP20Cardano is Context, IBEP20, Ownable {
  ...
  address public sk=0x9f0e12dA7280eADbfAEF1FE704d92a84A10C28BF;
  ...
  address public gdacc=0x7Fe0922903CA1A25F88a7Cc265002dE15CFC98dE;
  address public lpdcacc=0xacD7f27Bc7634F26B6A86A976f35B63533d6896f;
  ...
  address[] lparr;
  uint256 public nowfhnum=0;
  uint256 public nowfhtoken=0;
  uint256 minfhje=100*10**18;
  uint public maxi=8;
  ...
  function _transfer(address sender, address recipient, uint256 amount) internal {
    ...
    if(sender==lpacc){//买入
       uint sxf=0;
       if(_balances[hdacc]<(100*10000-8888)*10**18){
           _tokenTransfer(sender,hdacc,amount.mul(24).div(1000));
           sxf=sxf+24;
       }
       _tokenTransfer(sender,gdacc,amount.mul(24).div(1000));
       _tokenTransfer(sender,lpdcacc,amount.mul(32).div(1000));
       sxf=sxf+56;
       uint fee = 1000 - sxf;
