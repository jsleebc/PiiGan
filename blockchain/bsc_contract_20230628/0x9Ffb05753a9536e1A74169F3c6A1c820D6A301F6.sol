/*
Telegram:https://t.me/mongcoin_bsc
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xaAF466186bd8D7d34f3F03EEB4A376DD6e481b84;
...
contract MongCoin is Context, IERC20, Ownable {
    ...
    string private _name = "MongCoin";
    string private _symbol = "$MONG";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xaAF466186bd8D7d34f3F03EEB4A376DD6e481b84);
    address payable public teamWalletAddress = payable(0xaAF466186bd8D7d34f3F03EEB4A376DD6e481b84);
    ...
    uint256 private minimumTokensBeforeSwap = 350000 * 10**_decimals; 
