/*
   https://t.me/Extedbitnetworkchannel
   https://extendbitnetwork.com/
...
contract XBN is IERC20, Context, Ownable {
    ...
    string private constant _symbol = "Extendbit Network";
    string private constant _name = "XBN";

    uint256 public Max_Buy_Limit = 20000000 * 10**9;
    uint256 public Max_Sell_Limit = 10000000 * 10**9;

    address private Marketing_Wallet = 0xfb5887B81e42DD8b281964a576e295B588a99B01;
    address private Team_Wallet = 0x58090a18595389cad92060E24C941037bAC1F049;
    ...
    Taxes public sellTaxes = Taxes(0, 5, 0, 4);
