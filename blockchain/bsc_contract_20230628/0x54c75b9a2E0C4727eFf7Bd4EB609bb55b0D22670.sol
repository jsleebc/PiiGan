...
contract GamblingPEPE is Context, Ownable, IERC20 {
    ...
    uint256 internal _totalSupply = 69000000000000000000000000000;
    string internal _name = "Gambling PEPE";
    string internal _symbol = "$GPEPE";
