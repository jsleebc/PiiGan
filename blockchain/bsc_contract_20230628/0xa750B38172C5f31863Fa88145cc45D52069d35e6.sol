...
contract MARIOCEO is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x091b445884A2A0F76D7ecc74Bc91eE1B53fdB853); 
    address payable public Wallet_Dev = payable(0x9fa203d69FF88f0347f2357d2bA0c85A45aBe943);
    ...
    uint256 public Percent_Burn = 18;
    ...
    constructor () {
        _owner = 0x9fa203d69FF88f0347f2357d2bA0c85A45aBe943;
