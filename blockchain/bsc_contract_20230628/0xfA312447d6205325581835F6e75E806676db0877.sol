...
contract CLToken is ERC20, Ownable {
    ...
    constructor( 
        ...
        _mint(_managerAddress, 10000000 * 10 ** 18);
    }

    function updatePancakeRouter(address newAddress) public onlyOwner {
        require(newAddress != address(pancakeRouter), "CLToken: The router already has that address");
    ...
    function _transfer(
        ...
        if(takeFee && from == pancakePair) { //buy
        ...
        } else if(takeFee && to == pancakePair) { //sell
