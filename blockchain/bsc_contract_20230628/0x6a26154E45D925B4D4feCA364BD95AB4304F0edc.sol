...
/*
First decentralized autonomous up-token, with Theia mechanism designed by AI and mathematicians.

Rethink your crypto investing.

Start building your future with us!

Meet our socials: 
- https://lunai.in/
- twitter.com/lunai_bsc
- instagram.com/lunai_bsc
- https://www.youtube.com/@LunAi_bsc
- https://t.me/LunAi_announcement
...
contract LunAI is IERC20, Ownable {
    ...
    string public _name = "Lun AI";
    string public _symbol = "LUNAI";
    ...
    constructor() Ownable() {        
        ...
        autoLiquidityFund = 0x91b3505E9966a6F3BC0860b50498F5d0655a601A;
        treasuryFund = msg.sender;
        marketingFund = 0x027dE319eCECF974669465985115269d6Ad2EA0B;
