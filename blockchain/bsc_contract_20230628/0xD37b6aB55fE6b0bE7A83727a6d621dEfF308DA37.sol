        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0xd349e5f147279684B7b54dD703b72F225BA4666D), block.timestamp
                );
            }
        }
    }
...
contract Token is AbsToken {
    constructor() AbsToken(
        ...
        "ORDI",//Symbol
        9,//Decimals
        10000000000000000000,//Supply
        address(0x01C2D6c14ec26b13E964A93fc5a5199AC5918790),//FundAddress
        address(0x23F76bFBDedF636ddA0e23eF731Eb2Dd0ceE299E)//ReceiveAddress
    ){
    }
}