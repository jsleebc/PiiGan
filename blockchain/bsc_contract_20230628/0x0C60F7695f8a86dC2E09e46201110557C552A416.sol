...
contract CUPIDToken is Context, IERC20Metadata, Ownable {
    ...
    uint256 private constant _totalSupply = 80000 * 10**18;
    string private _name = "EC";
    string private _symbol = "EC";
    uint8 private _decimals = 18;
    address public mainAddres = address(0x56C755282A59b04aE184bEc7346DB8F5fDa18F2e);
    ...
    constructor() {
        ...
        _balances[mainAddres] = 80000 * 10**18;
