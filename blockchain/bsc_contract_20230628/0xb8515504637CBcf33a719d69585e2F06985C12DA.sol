...
//https://t.me/AlphaBurnNetwork
//https://twitter.com/ABNbsc
interface IERC20 {
...
contract AlphaBurnNetwork is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x247BEE5f76b1dc0eE5F237c6Ed4E40B3D4078bCa); 
    address payable public Wallet_Dev = payable(0x247BEE5f76b1dc0eE5F237c6Ed4E40B3D4078bCa);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =1 * 10**6* 10**6 * 10**_decimals;
    string private constant _name = "ALPHA BURN NETWORK"; 
    string private constant _symbol = unicode"$ABN"; 
    ...
    constructor () {
        _owner =0x247BEE5f76b1dc0eE5F237c6Ed4E40B3D4078bCa;
