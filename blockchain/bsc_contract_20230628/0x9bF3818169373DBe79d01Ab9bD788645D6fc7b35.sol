...
https://afford-untech.org/
https://twitter.com/afforduntech
https://t.me/afford_untechglobal
...
contract AffordUntech is Ownable, ERC20 {
    uint256 public immutable maxSupply = 500_000_000 * (10 ** decimals());
    ...
    constructor() ERC20("AFFORD UNTECH", "$AFT") {
    ...
    function _transfer(
        ...
        require(
            ...
            "AFFORD UNTECH: blacklist is forbidden!"
        );
        ...
        require(
            ...
            "AFFORD UNTECH: trade is not open!"
        );

        if (uniswapV2Pair == address(0) && initialized == true) {
            require(
                from == owner() || to == owner(),
                "AFFORD UNTECH: trading is not started"
            );
        }
