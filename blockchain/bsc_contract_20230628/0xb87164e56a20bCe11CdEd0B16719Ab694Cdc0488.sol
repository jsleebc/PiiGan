...
contract CMCDOGE is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x38eD426fb82C9Eca05c055c99a00D94CF390088C); 
    address payable public Wallet_Dev = payable(0x84A81A2C8a5539C78Bce1B1090B0317e6D0de707);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =10000000000000 * 10**2* 10**2 * 10**_decimals;
    string private constant _name = "CMC DOGE"; 
    string private constant _symbol = unicode"CMCDOGE"; 
    ...
    constructor () {
        _owner =0x84A81A2C8a5539C78Bce1B1090B0317e6D0de707;
