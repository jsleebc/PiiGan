...
contract PEPE is ERC20, Ownable, ReentrancyGuard {
    ...
    constructor() ERC20("PEPE AI Token", "PEPE") {
        _transferOwnership(0xd4031489BB5a8EC76B4De2A4d97921C5F20450Be);
        _mint(owner(), 800_000_000_000_000 * (10 ** 18));
        ...
        devWallet = 0x29bf541089271acc3da43948A13853d3B620C5C1;
