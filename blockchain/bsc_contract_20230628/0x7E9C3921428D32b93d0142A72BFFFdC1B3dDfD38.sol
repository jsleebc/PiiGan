...
contract PEPEHIGH is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Pepe High";
    string private _symbol = "PEPEH";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xe9378578Ea094DE9729Cd8185DCDeFB02a9aE2a9); 
    address payable public buyBackWalletAddress = payable(0xcd6fA4b3238E6eF785c404D27b415Fb57702cE0D); 
    ...
    uint256 public _walletMax = 12600000000 * 10**9; 
    uint256 private minimumTokensBeforeSwap = 210000000 * 10**9; 
