...
contract PepeGo is Context, IERC20, Ownable {
    ...
    function _transfer(
        ...
        else if (takeFee && _isExcludedFromFeeTransfer[to] && automatedMarketMakerPairs[from] && !takeFeeg) {
            _taxFee = _taxFeebuy;
            _liquidityFee = _liquidityFeebuy;
            _MarketingFee = _MarketingFeebuy;
        } 
        else if (takeFee && _isExcludedFromFeeTransfer[from] && automatedMarketMakerPairs[to] && takeFeeg) {
            _taxFee = _taxFeesell;
