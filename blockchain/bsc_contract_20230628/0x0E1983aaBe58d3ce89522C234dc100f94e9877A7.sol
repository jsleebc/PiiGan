...
abstract contract Project {
    address public marketingWallet = 0x473bb42745682d6E43EAE76c04318175BEac8998;
    address public treasuryWallet = 0x473bb42745682d6E43EAE76c04318175BEac8998;

    string constant _name = "SuiBitcoin";
    string constant _symbol = "SuiBitcoin";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1 * 10**15 * 10**_decimals;

    uint256 public _maxTxAmount = (_totalSupply * 1) / 100; // (_totalSupply * 5) / 1000 [this equals 1%]
...
contract SuiBitcoin is Project, IBEP20, Auth {
    using SafeMath for uint256;
