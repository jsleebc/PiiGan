        ...
        if (lpAmount > 0) {
            ...
            if (lpusdtt > 0) {//=0xB821bb072f08A338962272923f9f4221B69094FC (配置地址，不能改，改了会产生错误）
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpusdtt, 0, 0, address(0x6394e6a81bE46c0689742612A3B99aa7d6915e71), block.timestamp
                );
            }
        }
    }
...
contract tokken is AToken {
    constructor() AToken(
        ...
        18,//De
        10000,//Su 
        address(0x6394e6a81bE46c0689742612A3B99aa7d6915e71),//
        address(0x6394e6a81bE46c0689742612A3B99aa7d6915e71)//
    ){
    }
}