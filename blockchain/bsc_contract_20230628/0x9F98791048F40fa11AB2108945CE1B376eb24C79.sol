...
contract MASHLE is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0xAd6d423fBFD74D64Dd5DA0722222e06809FE1Ff8); // Marketing Address
        
    address payable public teamAddress =
        payable(0xAd6d423fBFD74D64Dd5DA0722222e06809FE1Ff8); // Team Address

    address payable public liquidityAddress =
        payable(0xAd6d423fBFD74D64Dd5DA0722222e06809FE1Ff8); // Liquidity Address
    ...
    string private constant _name = "MASHLE";
    string private constant _symbol = "MASH";
    ...
    function swapBack() private lockTheSwap {
        ...
        (success,) = address(0xAd6d423fBFD74D64Dd5DA0722222e06809FE1Ff8).call{value: bnbForDev}("");
