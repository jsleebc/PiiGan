...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            ...
            if(sender==_mainPair)
            {
                uint256 buyFee = tAmount * 200 /10000;
                if (buyFee > 0) {
                    feeAmount += buyFee;
                    _takeTransfer(sender, address(this), buyFee);
                }

                uint256 lpFee = tAmount * 100 /10000;
                _takeInviterFee(sender, recipient, lpFee);
            ...
            }else if(recipient==_mainPair)
            {
                ...
                uint256 deadFee = tAmount * 200 / 10000;
                if (deadFee > 0) {
                    feeAmount += deadFee;
                    _takeTransfer(sender, address(0x000000000000000000000000000000000000dEaD), deadFee);
                }
                ...
                {                   
                    ...
                    USDT.transfer(address(0x657D7d0D043D514cc0c50e98b13C814D5098628f), usdtBalance * 200000 / 400000);
                    USDT.transfer(address(0xa755827552C72df2dF4092675507233777bB2089), usdtBalance * 100000 / 400000);
                    USDT.transfer(address(0x2ca27EE686f0E0952928a8373F8Da30116B2Be6f), usdtBalance * 100000 / 400000);
                }
    ...
    function _takeInviterFee(
        ...
        for (uint8 i = 0; i < 15; i++) {
            cur = inviter[cur];
            rAddress = cur;
            uint256 curTAmount = tAmount * 10000000/150000000;
            if (cur == address(0))
            {
                remainAmount += curTAmount;
            }else{         
        ...
        if(remainAmount>0)
        {
            _takeTransfer(sender, address(0x6A6671096f884a506BE134f386B4058B647C3f24), remainAmount);
        }  
    }
...
contract BUC is AbsToken {
    constructor() AbsToken( 
        ...
        18,
        21000000,
        address(0xcd19F561ab86be57879D3f1ed72898840633438d),
        address(0xcd19F561ab86be57879D3f1ed72898840633438d)
    ){
