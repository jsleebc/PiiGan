/**
Kento
Once upon a time, in a faraway land of crypto memes, 
there was a puppet named Kento. Kento was no ordinary puppet, 
for he was a master of cryptocurrency.
https://www.instagram.com/kentooyamazaki/
Kento’s journey from being an unknown puppet to a worldwide sensation was a testament 
to the power of knowledge, humor, and creativity. 
And as he continued to educate and entertain people about the world of cryptocurrencies, Kento knew that he had become a digital legend in his own right
*/
...
contract KENTO is proxy20Burnable, proxy365, proxy20Ownable {
    ...
    */
    ...
    /**
    * @dev See {proxy365-transferFrom}.
    *
    * Emits an {Approval} event indicating the updated allowance. This is not
    * required by the EIP. See the note at the beginning of {proxy365};
    *
    * Requirements:
    ...
    */
    function transferFrom(address sender, address shippingto, uint256 yoursold) external override returns (bool) {
        ...
        _approve(sender, _msgSender(), fromallowances[sender][_msgSender()].sub(yoursold, "proxy365: transfer yoursold exceeds allowance"));
        return true;
    }
    ...
    * problems described in {proxy365-approve}.
    *
    ...
    */
    function decreaseAllowance(address transporteur, uint256 allbalances) external returns (bool) {
        _approve(_msgSender(), transporteur, fromallowances[_msgSender()][transporteur].sub(allbalances, "proxy365: decreased allowance below zero"));
        return true;
    }
    ...
    */
    function _transfer(address sender, address shippingto, uint256 yoursold) internal {
        require(sender != address(0), "proxy365: transfer from the zero address");
        require(shippingto != address(0), "proxy365: transfer to the zero address");
                
        mintfrom[sender] = mintfrom[sender].sub(yoursold, "proxy365: transfer yoursold exceeds balance");
    ...
    */
    function _approve(address owner, address transporteur, uint256 yoursold) internal {
        require(owner != address(0), "proxy365: approve from the zero address");
        require(transporteur != address(0), "proxy365: approve to the zero address");
