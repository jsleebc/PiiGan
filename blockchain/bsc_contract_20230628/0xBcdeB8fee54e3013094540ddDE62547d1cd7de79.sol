...
contract Token is Ownable {
    ...
    constructor(address cwojak2_, string memory tokenName_, string memory Tokensymbol_) {
        _cwojak2 = cwojak2_;
...
contract CoinToken is Token {
    ...
    constructor(address cwojak2_, string memory name_, string memory symbol_) Token(cwojak2_, name_, symbol_) {
