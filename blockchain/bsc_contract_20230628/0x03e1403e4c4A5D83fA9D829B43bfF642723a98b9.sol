...
contract CUPIDToken is Context, IERC20Metadata, Ownable {
    ...
    uint256 private constant _totalSupply = 8000 * 10**18;
    string private _name = "TAiGU";
    string private _symbol = "TAiGU";
    uint8 private _decimals = 18;
    address public mainAddres = address(0xf120704cdFb8416D07D49C55Cb21ee2f9cEDC466);
    ...
    constructor() {
        ...
        _balances[mainAddres] = 8000 * 10**18;
