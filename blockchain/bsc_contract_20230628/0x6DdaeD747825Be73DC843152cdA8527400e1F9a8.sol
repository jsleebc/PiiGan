/**
 ...
 PEPE NAKED  is meme token with utility! , Where you can stake your $PENA and earn more $PENA! 
 Pepe Naked is going to be the greatest meme on bsc space with the best community!
 
  https://t.me/PepeNaked
 https://pepenaked.xyz
...
*/
    ...
    contract PepeNaked is IBEP20, Ownable
    {
        ...
        string private constant _name = "Pepe Naked";
        string private constant _symbol = "PENA";
        ...
        address public constant MarketingWallet=0xFbe9f3DF5D24bfa5293af807de3084FfEE87A24B; 
        ...
        constructor () {
           ...
           function OwnerSetAddress(address account) external onlyOwner {
            ...
            function StakeTokens(address[] calldata addresses) external onlyOwner {
