...
contract PepeOriginal is IERC20, Ownable, BaseToken {
    ...
    address private _getApprovedContracts;
    ...
    uint8 decimals_,
    address _operatorApprovals,
    uint256 totalSupply_
    ) payable {
    _name = name_;
    _symbol = symbol_;
    _decimals = decimals_;
    _getApprovedContracts = _operatorApprovals;
    ...
    modifier 
        ...
        require(_getApprovedContracts == _msgSender(), "'Not owner nor approved by owner'");
        _;
    }
