...
contract AIT is Context, IBEP20, Ownable {
    ...
    string private _symbol = "AITS";
    string private _name = "Artificial intelligence robot Step";
    ...
    uint256 private _lpReardFee = 20;
    uint256 private _marketFee = 10;
    uint256 private _liquidityFee = 30;
     uint256 private _transferFee = 10;
    address private _marketAddress = 0xbD5aaC28825a261aC4Ae299bAB4eC5B726b89E64;
    address private _dividendAddress = 0x094783be5eF0a16768091356f11e99bfBC264E45;
    uint256 public dividendAmount;
    uint256 public liquidityMinNum = 3 * 10 ** _decimals;
    uint256 public dividendMinNum = 2 * 10 ** _decimals;
    ...
    constructor() {
     ...
     function setInviter(address account) public {
        ...
        inviter[msg.sender] = account;
         emit BindInviter(msg.sender,account);

    }

    function setInviterForce(address user, address top) public onlyOwner {
        inviter[user] = top;
        emit BindInviter(user,top);
    }

    function setExcludeFee(address account, bool _exclude) public onlyOwner {
        _excludeFee[account] = _exclude;
    }
     function setMarketAddress(address account) public onlyOwner {
        _marketAddress = account;
    }
    function setMarketFee(uint256 burnFee) public onlyOwner {
        _marketFee = burnFee;
    }
        ...
        if (takeFee) {
            ...
            if(sender==uniswapV2Pair || recipient == uniswapV2Pair){
             ...
             if(isTransfer){
               ...
               uint256 liquidityAmount = amount.mul(_transferFee).div(1000);
            ...
            uint256 marketAmount = amount.mul(_marketFee).div(1000);
