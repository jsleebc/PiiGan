// Let's go to the moon with MINIONS
// NAME: MINIONS
// SYMBOL: MINIONS
// WEBSITE: MINIONSBNB.COM
...
contract MinionsBNB is Context, IERC20, Ownable {
    ...
    string public constant symbol = "MINIONS";
