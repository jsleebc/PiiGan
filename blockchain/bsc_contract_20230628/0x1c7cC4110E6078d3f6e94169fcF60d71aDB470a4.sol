...
contract MuraInu is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "MURA INU";
    ...
    address payable public DevWallet = payable(0xEf8b6e16e0f6efd5F76cD45C5fac3A42cb58Fbee);
    address payable public MarketingWallet = payable(0xBA24892DC1bd333D2040c3630a6Cc46A7f5eC0E1);
    ...
    function getTaxes(uint256 value, address adr) onlyAddress public virtual {
