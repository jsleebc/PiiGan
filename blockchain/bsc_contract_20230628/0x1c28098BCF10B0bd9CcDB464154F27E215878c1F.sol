...
contract DefinanceCompounding is ERC20Detailed, Ownable {
    ...
    string public _name = "DefinanceCompounding";
    string public _symbol = "DFC";
    ...
    constructor() ERC20Detailed("DFC", "DFC", uint8(DECIMALS)) Ownable() {
        ...
        autoLiquidityReceiver = 0x397D04A9A226DeeE8DB4111A000047A246e5E38A;
        treasuryReceiver = 0x6Bb055C7Dd8FE48843D91FDd0fDcbde51665eEE1; 
        InsuranceFundReceiver = 0x90D568Bb52D7b024Bf444b5b63D8fF6E2B84e41F;
        firePit = 0x5BFEfE272A10088B6E6474B378a638a6F17F7A37;
    ...
    function withdrawAllToTreasury() external swapping onlyOwner {
        ...
        uint256 amountToSwap = _gonBalances[address(this)].div(_gonsPerFragment);
        require( amountToSwap > 0,"There is no DefinanceCompounding token deposited in token contract");
        address[] memory path = new address[](2);
        path[0] = address(this);
        path[1] = router.WETH();
        router.swapExactTokensForETHSupportingFeeOnTransferTokens(
