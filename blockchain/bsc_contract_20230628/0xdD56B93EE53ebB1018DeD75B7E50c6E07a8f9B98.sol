...
contract BOBTIGER is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Bob TIGER";
    string private _symbol = "BOBTIGER";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x506385feCBe2F06B625Fbf13974018d27259D484); // Marketing Address
    address payable public teamWalletAddress = payable(0x506385feCBe2F06B625Fbf13974018d27259D484); // Team Address
