...
contract CUPIDToken is Context, IERC20Metadata, Ownable {
    ...
    uint256 private constant _totalSupply = 3600 * 10**18;
    string private _name = "XHUI";
    string private _symbol = "XHUI";
    uint8 private _decimals = 18;
    address public mainAddres = address(0xbE06c27ec5E9A6b73CE10503dA9A8375bD5B0F70);
    ...
    constructor() {
        ...
        _balances[mainAddres] = 3600 * 10**18;
