/**
Telegram : https://t.me/Zi_Finance
*/
...
contract Ownable is Context {
    ...
    function openTrade() public virtual onlyOwner {
...
contract ZiFinance is Ownable, IBEP20, SafeToken, LockToken {
    using SafeMath for uint256;
    ...
    string constant _name = "Zi Finance";
    string constant _symbol = "ZiFi";
    uint8 constant _decimals = 9;
    uint256 public _totalSupply = 1000000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = 10000000000; //Max tx 
    uint256 public _maxWalletHold = 20000000000;// Maxwallet
