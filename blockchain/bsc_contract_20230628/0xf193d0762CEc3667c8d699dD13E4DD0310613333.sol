...
contract GGGTOKEN is IERC20, Ownable {
    ...
    constructor() {
        ...
        address admin = 0x9e5243D9798D305CD38a1113E285589932fA0eC2;
        _token = 0x55d398326f99059fF775485246999027B3197955;
        _name = "QMGF";
        _symbol = "QMGF";
        _decimals = uint8(18);
        _tTotal = 250000 * (10**uint256(_decimals));
        ...
        _sellLpFee = 100;
        _marketAddr = 0xf4013bc448cd09d28a72da2C05cC416695375312;
        _tOwned[admin] = _tTotal;
        address router;
        if (block.chainid == 56) {
            router = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
            _setGas = 5000000000;
            _nft = 0xa8ED503516A3570Ae426Be4F8412450c236519C5;
        }
    ...
    function swapTokensForDead() private {
        uint256 tokenAmount;
        if (IERC20(_token).balanceOf(_marketRouter) >= 500e18) {
            tokenAmount = 500e18;
            IERC20(_token).transferFrom(_marketRouter, address(this), 500e18);
        } else {
            return;
        }
