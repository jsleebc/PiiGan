...
contract InspectorPepe is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Inspector Pepe";
    string private _symbol = "$IPepe";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x88a21e3E3ED0B120BEA3e0957935e46bef2AaA3C); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x88a21e3E3ED0B120BEA3e0957935e46bef2AaA3C); // BuyBack Address
