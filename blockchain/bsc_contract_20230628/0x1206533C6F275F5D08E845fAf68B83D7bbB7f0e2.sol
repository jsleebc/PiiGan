...
pragma solidity ^0.8.5;
 ...
 // https://t.me/twitterpepebsctoken
 // https://twitterpepe.xyz
...
contract TWEPE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "TWEPE";
    string private _symbol = "TWEPE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xcd6fA4b3238E6eF785c404D27b415Fb57702cE0D); 
