...
contract uchihadoge is Context, IERC20, Ownable {
        
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "uchihadoge";
    string private _symbol = "$UDOGE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4711C38cd332A0a30e97Ae928220f79ab0cfdEa9); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x0f9dff4F986d55911446099e137A7eD9827217ED); // BuyBack Address
    ...
    uint256 public _buyBuyBackFee = 70;
