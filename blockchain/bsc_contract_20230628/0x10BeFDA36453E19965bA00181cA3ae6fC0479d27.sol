...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x6AF78eA9Ec87D620aC05F3a14FF6Db4CCE1DaCE0;
...
contract Tuzki is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xF65a7A6b275121E4d17CB73E97D9E9449E65B606;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Tuzki";
    string private _symbol = "Tuzki";
