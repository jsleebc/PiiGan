...
contract STUART is Context, IBEP20, Ownable {
    ...
    address public marketingWallet = address(0x3842798232Cb93d52A20c9FD129f813ADd690E4A);

    string private constant _name = "Stuart Inu";
    ...
    Taxes private taxes = Taxes(2, 5);

    function viewTaxes() external pure returns(uint256 reflections, uint256 liquidity, uint256 marketing) {
        return(2,1,4);
    }

    uint256 constant private liqAllocation = 2_000;
    uint256 constant private marketingAllocation = 8_000;
