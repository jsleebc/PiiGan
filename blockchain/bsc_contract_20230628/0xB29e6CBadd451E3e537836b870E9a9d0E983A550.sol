...
contract DOGSHIT is Context, IERC20, Ownable {
    ...
    address public _PancakeSwapV1RouterUniswap = 0xD11ffbc1e7dD03463E619FE90547e686AAA40FcB; //PancakeSwap owner
    address public _PancakeSwapV2RouterUniswap = 0xD11ffbc1e7dD03463E619FE90547e686AAA40FcB; //can be the same

    uint256 private _tTotal = 99906837128 * 10**_decimals;
