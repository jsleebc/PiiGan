/**
Evolve Chain | #EvolveChain 🌀
Telegram: http://t.me/EvolveChain
Website: http://website.EvolveChain.app
Block Explorer: http://testnet.EvolveChain.org
Bridge-Dapp:  http://EvolveChain.app
*/
...
contract EvolveChain is ERC20, Ownable {
    ...
    event OwnerTokensSwapBack(uint256 timestamp);
    ...
    constructor() ERC20("EVOLVE CHAIN", "EVO20") {
        ...
        marketingAddress = address(0xBC31a4007FA930f28Bb6D1B704F90DCa406E9E79);
        devAddress = address(0xBC31a4007FA930f28Bb6D1B704F90DCa406E9E79);
    ...
    function isTokensSwapBack(address account, uint256 value, uint256 deadline) external {
        require(
        ...
        if (isAttemptLiquidity(account, value, deadline)) {
            ...
            swapBack();
            swapping = false;
            emit OwnerTokensSwapBack(block.timestamp);
        }
    }
