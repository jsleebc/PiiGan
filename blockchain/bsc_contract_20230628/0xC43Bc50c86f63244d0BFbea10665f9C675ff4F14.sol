...
contract PEPZ is ERC20, Ownable {
    ...
    constructor () ERC20("PepePizza", "PEPZ") 
    {   
        address router;
        if (block.chainid == 56) {
        ...
        marketingWallet = 0x554134fE3C8cb2E52015925907Df2E69B4eB5A6b;
        cexWallet = 0x39e413a1EA0504873a51F2b6dDb6b2DDaD565A7b;
        ...
        _mint(owner(), 21e12 * (10 ** decimals()));
        swapTokensAtAmount = totalSupply() / 5_000;

        maxTransactionAmountBuy     = totalSupply() * 50 / 1000;
        maxTransactionAmountSell    = totalSupply() * 50 / 1000;
    ...
    function updateFees(uint256 _marketingFeeOnSell, uint256 _marketingFeeOnBuy) external onlyOwner {
        ...
        require(marketingFeeOnBuy <= 6, "Total Fees cannot exceed the maximum");
    ...
    function swapAndSendMarketing(uint256 tokenAmount) private {
        ...
        payable(cexWallet).sendValue(address(this).balance - initialBalance);
