...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x4a60AC38A3227bAdd3A998bC2B5efD3A85A3d6dc; // owner address
...
contract FlokiOriginal is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Floki Original";
    string private _symbol = "FO";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x6CD712eb8CeC40Fd0159F7dE3b0b307Ece4d5044); // Marketing Address
    address payable private teamWalletAddress = payable(0x4a60AC38A3227bAdd3A998bC2B5efD3A85A3d6dc); // Team Address
