...
//TELEGRAM: https://t.me/babywhitetigermoonofficial
...
contract BabyWhiteTigerMoon is Context, IERC20, Ownable {
    ...
    address public marketingAddress = 0x9829ac43C11489c38a75979fDf6ba954ff7c2Af3;
    address public devAddress = 0x6a8a5216E59BBC4b0FA0D2928DBc3955F295Ad0F;

    string private constant _name = "Baby White Tiger Moon";
    string private constant _symbol = "$BBYWHTETGRMN";
    ...
    Taxes public taxes = Taxes(3,2,5,1);
    Taxes public sellTaxes = Taxes(3,2,5,1);
