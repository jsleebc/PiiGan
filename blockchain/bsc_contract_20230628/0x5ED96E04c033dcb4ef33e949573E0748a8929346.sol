...
contract BABYNOOT is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BABY Noot";
    string private _symbol = "BNOOT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xC814338F8C7EEAB895bAf12F4F1Fe83d62Ad0C7C); 
    address payable public teamWalletAddress = payable(0x0a56174caC500Bfc29E29b29c93DB01dD94Bb533); 
    ...
    uint256 public _walletMax = 16800000000000 * 10**9; 
    uint256 private minimumTokensBeforeSwap = 252000000000 * 10**9; 
