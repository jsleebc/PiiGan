...
contract TopGCEO is ERC20, Ownable {

    mapping (address => bool) private islpPair;
    mapping (address => bool) private _isExcludedFromFees;

    uint256 constant public buyfee = 8;
    uint256 constant public sellfee = 8;
    uint256 constant public transferfee = 0;
    uint256 constant public fee_denominator = 100;
    address public lpPair;

    address public marketingAddress = address(0x1864c00a8cd03073DB110464b06C7A4b683fCaaf);
    address public charityAddress = address(0x2d3C9E2ed9D03ABde4DC59556225E53283E8F1bD);
    ...
    constructor() payable ERC20("TopG CEO", "$TOPG") {
        ...
        dividendTracker = new DividendTracker(420_0 * 10**4, rewardToken);
        ...
        swapTokensAtAmount = totalSupply() / 7_000;
    }
    ...
    function changeWallets(address marketing, address charity) external onlyOwner {
        require(marketing != address(0));
        require(charity != address(0));
        marketingAddress = payable(marketing);
        charityAddress = payable(charity);
    }
            ...
            if(contractTokenBalance > 0) {
                ...
                try swapRouter.swapExactTokensForETHSupportingFeeOnTransferTokens(
                    ...
                    block.timestamp) {}
                        ...
                        uint256 mkt = address(this).balance * 3 / 7;
                        uint256 charity = address(this).balance * 2 / 7;
                        uint256 btcRewards = address(this).balance * 2 / 7;
                        bool success;
                        if(mkt > 0) {(success,) = marketingAddress.call{value: mkt, gas: 35000}("");}
                        if(charity > 0) {(success,) = charityAddress.call{value: charity, gas: 35000}("");}
