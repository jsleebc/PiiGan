...
/*
    ...
    PEPESCOPE
    https://pepescope.site/
    Youtube: https://www.youtube.com/watch?v=zDy8_4noY8M
    Telegram Ann: https://t.me/PepeScopeAnn
    Telegram Chat: https://t.me/PepeScopeChat

    Improved Tokenomics
    Total Supply: 1 Trillion
    Slippage: 8% Slippage
    $PEPE distribution to owners who buy more than 1 BNB of $PEPESCOPE (the more they buy the more): 5%
    All Holders Pepe Rewards: 2%
    LP: 1%
...
contract PEPESCOPELASTO is ERC20, Ownable {
    ...
    constructor () ERC20("PEPESCOPE", "PEPESCOPE") 
    {   
        address router;
        if (block.chainid == 56) {
        ...
        marketingWallet = 0x943091EE2f365123B8597c0E080630798E5B5638;
    ...
    function _transfer(address from,address to,uint256 amount) internal  override {
        ...
        if (_isExcludedFromFees[from] || _isExcludedFromFees[to] || swapping) {
            ...
            if (block.timestamp > launchTime + 86400){
                _totalFees = 0;
            } else{
