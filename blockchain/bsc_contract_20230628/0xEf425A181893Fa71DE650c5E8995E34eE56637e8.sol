...
contract TROLLBNB is Context, IERC20, Ownable {
    ...
    string private constant _name = "TROLL BNB";
    string private constant _symbol = "TROLLBNB";
 ...
 function manualSwap() external {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        uint256 convertQuota = contractTokenBalance.mul(2).div(4);
		uint256 burnQuota = contractTokenBalance.div(4);
