...
contract StuartInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Stuart INU";
    string private _symbol = "STUART";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x538a2446439F955E6b9442baF58A0715f04B47fF); // Marketing Address
    address payable public teamWalletAddress = payable(0x538a2446439F955E6b9442baF58A0715f04B47fF); // Team Address
