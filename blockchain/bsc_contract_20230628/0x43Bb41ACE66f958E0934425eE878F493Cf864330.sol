...
contract BicassoAI {
    ...
    uint256 private _totalSupply = 1000000000 ether; //1b tokens
    string private _name = "Bicasso AI";
    ...
    constructor() {
        _owner = msg.sender;
        //first round, price 1bnb = 30,000 token
        ...
        _mint(_owner,_totalSupply.div(50));
    }
    ...
    function _mint(address account, uint256 amount) internal {
        ...
        require(_cap.add(amount) <= _totalSupply, "ERC20: mint exceeds total suplly");
