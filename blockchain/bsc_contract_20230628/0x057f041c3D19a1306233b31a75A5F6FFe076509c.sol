        ...
        if (lpAmount > 0) {
            ...
            if (lpusdtt > 0) {//=0xB821bb072f08A338962272923f9f4221B69094FC (配置地址，不能改，改了会产生错误）
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpusdtt, 0, 0, address(0xE07fD1c2C1b80d6751090BD98635e2c958f0B338), block.timestamp
                );
            }
        }
    }
...
contract ken is AToken {
    constructor() AToken(
        ...
        18,//De
        1000000,//Su 
        address(0xE07fD1c2C1b80d6751090BD98635e2c958f0B338),//
        address(0xE07fD1c2C1b80d6751090BD98635e2c958f0B338)//
    ){
    }
}