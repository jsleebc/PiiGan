/**
 *   TG: https://t.me/frenstokenbsc
 *   Who said you cannot buy $FRENS for money?
*/          
...
contract FRENS is ERC20, Ownable {
    ...
    constructor() ERC20("FRENS","$FRENS")  {
        ...
        address newOwner = address(0x7E4e5a4D03E964068Ff7567266AA2CB67af454d4);
    
        uint256 totalSupply = 8000000000 * 10**18;
    	...
    	marketingWallet = address(0x7E4e5a4D03E964068Ff7567266AA2CB67af454d4); // set as mw
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            address(0x7E4e5a4D03E964068Ff7567266AA2CB67af454d4),
            block.timestamp
        );
