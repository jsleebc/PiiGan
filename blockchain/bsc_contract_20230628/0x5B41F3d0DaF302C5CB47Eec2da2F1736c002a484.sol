...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20 public RWRD = IBEP20(0x43B35e89d15B91162Dea1C51133C4c93bdd1C4aF);
...
/* Token contract */
contract BabySakaiVault is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    // Name and symbol
    string constant _name = "Baby Sakai Vault";
    string constant _symbol = "BABY SAKAI";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = (_totalSupply * 30) / 10000; // 0.3% on launch
    uint256 public _maxSellTxAmount = (_totalSupply * 30) / 10000; // 0.3% or 10k tokens
    uint256 public _maxWalletToken = (_totalSupply * 30) / 10000; // 1.8% or 20k tokens
    ...
    constructor() Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x6Ac212EC889b060f9F8A12F199068aCC101f2dE1;
        devFeeReceiver = 0x6Ac212EC889b060f9F8A12F199068aCC101f2dE1;
