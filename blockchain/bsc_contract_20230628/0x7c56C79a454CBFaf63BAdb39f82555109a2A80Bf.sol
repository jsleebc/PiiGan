...
contract AxleGames is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    //varies for bsc tesenet and mainnet verify accordingly!
    address public feeWallet     = 0x2a2A8c7cF19867B9ab170fda864401EcA446CE39;
    address public pinkAntiBot_  = 0x8EFDb3b642eb2a20607ffe0A56CFefF6a95Df002;
    address public uniswapV2Router02_  = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address public firstVerifier = 0xfdB4b586745D677d981366Fd9e4e6FAaDb63fAa4;
    ...
    event FirstVerifierUpdated(address indexed newAddress, address indexed oldAddress);
    event LiquidityWalletUpdated(address indexed newLiquidityWallet, address indexed oldLiquidityWallet);

    constructor() ERC20("AxleGames", "AXLE") {

    	IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(uniswapV2Router02_);
    ...
    function setbuyFee(uint256 value) external onlyOwner{
        require(value < 25, "buy fee cannot be more than 25%");
        buyFee = value;
    }

    function setsellFee(uint256 value) external onlyOwner{
        require(value < 25, "sell fee cannot be more than 25%");
        sellFee = value;
    }
    ...
    function setfeeWallet(address feaddress) public onlyOwner {
        require(feaddress != address(0), "new address is zero address");
        feeWallet = feaddress;
    }
    ...
    function setFirstverifier(address faddress) public onlyOwner {
        ...
        emit FirstVerifierUpdated(faddress, address(firstVerifier));
