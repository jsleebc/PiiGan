...
📋 Decentralized oracle networks provide tamper-proof inputs, outputs, and computations to support advanced smart contracts on any blockchain.
...
🧿 Telegram :
https://t.me/glorioustech_bsc
🧿 Website :
https://glorioustech.org
*/
...
contract Glorioustech is IBEP20, Auth {
    ...
    address DEV = 0x0555C95319F383e12aFa2258A3E710B4e0F2adc8;

    address private autoLiquidityReceiver;
    address private marketingFeeReceiver;

    string constant _name = "GLORIOUSTECH";
    string constant _symbol = "$GTECH";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xbfA026bAd6eF65d5c26f1D06D19C840E9fBbD096;
