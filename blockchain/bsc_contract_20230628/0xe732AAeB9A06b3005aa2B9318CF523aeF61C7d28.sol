...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x697993D9695356D8bC240e1011cF976d6D570fcC; // owner address
...
contract OfCourseIStillLoveYou is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Of Course I Still Love You";
    string private _symbol = "$OFCISLY";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xe313642eDaC2CbEA8a17E81C56C2838D53B77509); // Marketing Address
    address payable private teamWalletAddress = payable(0xe313642eDaC2CbEA8a17E81C56C2838D53B77509); // Team Address
