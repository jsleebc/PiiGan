...
abstract contract AbsToken is IERC20, Ownable {
    ...
    uint256 public _buyLPDividendFee = 75;
    uint256 public _sellLPDividendFee = 75;
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            ...
            uint256 burnAmount = tAmount * 25 / 10000;
            if (burnAmount > 0) {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0x5Af3b82cE859269cab9Daba27A8bF970FC7347D5;
...
contract QD is AbsToken {
    constructor() AbsToken(
        ...
        address(0xe65cAed354BA8C4216b08Ce909A614687F1d9adD),
    
        address(0x99fa9c595e65d31D23643e9b36E2178AdD6eF2F5)
    ){
