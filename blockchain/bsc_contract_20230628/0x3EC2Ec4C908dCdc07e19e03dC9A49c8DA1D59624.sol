...
contract Token is ERC20, Ownable {
    ...
    constructor() ERC20("Limousinecoin", "LMC") {

        address _owner = 0xc628fa437756bc88A9a8352FFA5916a0DC14B033;

        _decimals = 8;

        uint256 totalSupply = 30000000 * (10**_decimals);
        ...
        marketingWallet = address(0x11806feB014CCE3fb53DEd8791338CbDc4F1f00d); // set as marketing wallet
    	devWallet = address(0x68aB0Ac5540b92cf8cb4f43559F1073924e1d0d5); // set as dev wallet
    ...
    function updateBuyFees(uint256 _marketingFee, uint256 _liquidityFee, uint256 _devFee, uint256) external onlyOwner {
