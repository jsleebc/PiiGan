...
Pepain coin, if you felt pain because Pepe mooned, this is the time to buy Pepain coin. We inflict pain to jeets

https://t.me/PepainCoin
...
contract pepain is ERC20, Ownable {
    uint256 public marketingFeeOnBuy = 0;
    uint256 public marketingFeeOnSell = 2;

    address public marketingWallet = 0x2dFBe199F18cdF76B9aD853e914cfb303C0D331B;
    ...
    uint256 public blocktime = 1;
    uint256 public endBlock;

    uint256 public walletLimit = 500;
    uint256 public txLimit = 500;
    ...
    constructor() ERC20("Pepain Coin", "PEPAIN") {
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(
            getRouterAddress()
        );
        address _uniswapV2Pair = IUniswapV2Factory(_uniswapV2Router.factory())
            .createPair(address(this), getRouterAddress());
    ...
    function setFees(
        ...
        require(
            ...
            "Marketing fee on buy cannot be more than 0%"
        );
        require(
            _marketingFeeOnSell <= 2,
            "Marketing fee on sell cannot be more than 2%"
        );
