...
contract FAMEPEPEcoin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FamePepeCoin";
    string private _symbol = "FAMEPEPE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x04E1d441b4A08f510d6dd3EaAf941e2c9d2636cC); // Marketing Address
    address payable public teamWalletAddress = payable(0x04E1d441b4A08f510d6dd3EaAf941e2c9d2636cC); // Team Address
