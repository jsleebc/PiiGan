...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x45f68a01e2346B7FF1210016ed92b7559ED4Ae0E;
...
contract PEPOGE is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xdFDC1260912247BcE0f24207F9bF7c91db0c9989;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "PEPOGE";
    string private _symbol = "PEPOGE";
