/**
Telegram https://t.me/byteecosystem
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x4c3AC9dEc84e1D3f7edea12102d30381aa2AAdaD; // owner address
...
contract byteeco is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Byte Ecosystem";
    string private _symbol = "BYTE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x5959BFC9bB07e438FE38F13ad94A8DD6251B8f4b); // Marketing Address
    address payable public teamWalletAddress = payable(0x580F5B7480F143ef319d7eF5028aDBd2952EDd04); // Team Address
