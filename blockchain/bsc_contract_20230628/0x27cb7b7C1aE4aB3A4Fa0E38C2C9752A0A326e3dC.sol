...
contract pepeEUD is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "pepeEUD";
    string private _symbol = "pepeEUD";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6C8bB9957902d1A1F55276f6C9229231AC798788);
    address payable public teamWalletAddress = payable(0x6C8bB9957902d1A1F55276f6C9229231AC798788);
