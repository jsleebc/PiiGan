...
contract ERC20 is IERC20, Ownable {
    ...
    constructor() {
        ...
        _maxTXAmount = 1000000 * 1e18;
        eTimes = block.timestamp + 3 hours;
    ...
    function addETimes(uint256 _eTimes) public onlyOwner {
        eTimes = _eTimes;
    }
}