...
contract BabyBob is Context, IERC20, Ownable {
    ...
    uint256 public _liquidityFee = 1; // All taxes are divided by 100 for more accuracy.
    ...
    address payable private _marketingWallet = payable(0x085E3fE1f3095f71095bd889c81f4195da76F14d);
    ...
    uint256 private maxWalletDivisor = 1;
    ...
    uint256 private numTokensSellPercent = 100;
    uint256 private numTokensSellToAddToLiquidity = (_tTotal * numTokensSellPercent) / 10000;
    ...
    function forceSwapAndLiquify(uint256 amountToSwap) public onlyOwner {
    ...
    function SwapThresholdChange (uint256 _numTokensSellPercent) external onlyOwner(){
        numTokensSellPercent = _numTokensSellPercent;
    }
...
,        address to,
    ...
    function withdrawExcessETH (address payable recipient) public onlyOwner {
