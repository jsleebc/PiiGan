...
contract BABYTOADY is Context, IERC20, Ownable {
    ...
    address payable public buyBackWalletAddress = payable(0xce154F6aBA96ba70037576a0206B86c2C691f2e6); 
    ...
    uint256 private minimumTokensBeforeSwap = 90000000000 * 10**9; 
