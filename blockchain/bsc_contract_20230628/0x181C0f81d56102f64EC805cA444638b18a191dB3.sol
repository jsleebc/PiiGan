...
contract PEPEDAO is ERC20, Ownable {
    ...
    constructor () ERC20("PEPE DAO", "PEPED") 
    {   
        address router;
        if (block.chainid == 56) {
        ...
        marketingWallet = 0x069a9310B3CB158B918D7ba94086a70b54D286aA;

        _isExcludedFromFees[owner()] = true;
        _isExcludedFromFees[address(0xdead)] = true;
        _isExcludedFromFees[address(this)] = true;
        _isExcludedFromFees[0x407993575c91ce7643a4d4cCACc9A98c36eE1BBE] = true; //pinklock
        _isExcludedFromFees[0x069a9310B3CB158B918D7ba94086a70b54D286aA] = true;

        _mint(address(0x069a9310B3CB158B918D7ba94086a70b54D286aA), 1e11 * (10 ** decimals()));
