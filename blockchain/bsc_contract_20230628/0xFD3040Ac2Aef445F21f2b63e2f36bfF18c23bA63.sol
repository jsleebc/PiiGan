...
contract BSCToken is ERC20, Ownable {
    ...
    uint256 public killTime2 = 30;
    uint256 public maxBuyNum = 10000;
    ...
    function kill(address sender, address recipient, uint256 amount) internal {
        ...
        if (block.timestamp < launchedAtTimestamp + killTime2) {
            if (!isPair(sender) && !isPair(recipient)) {
                ...
                uint256 _amount = getPrice().mul(amount).mul(310).div(1e18);
