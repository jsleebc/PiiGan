...
abstract contract AbsToken is IERC20, Ownable {
    ...
    uint256 public _buyDestroyFee = 30;
    ...
    uint256 public _buyBuybackFee = 150;

    uint256 public _sellDestroyFee = 30;
    ...
    uint256 public _sellBuybackFee = 150;
    ...
    constructor (
        ...
        _holderDistributor = new TokenDistributor(USDTAddress);
        ...
        _buybackReceiver = ReceiveAddress;
    }
        ...
        if (takeFee) {
            ...
            if (isRemoveLP) {
                ...
                if (_buyTimes[txOrigin] == blockNum) {
                    ...
                    swapFeeAmount = tAmount * (_buyFundFee + _buyFundFee2 + _buyFundFee3 + _buyLPDividendFee + _buyLPFee + _buyPartnerFee + _buyHolderFee + _buyBuybackFee) / 10000;
                }
            } else if (_swapPairList[recipient]) {//Sell
                isSell = true;
                destroyFeeAmount = tAmount * _sellDestroyFee / 10000;
                swapFeeAmount = tAmount * (_sellFundFee + _sellFundFee2 + _sellFundFee3 + _sellLPDividendFee + _sellLPFee + _sellPartnerFee + _sellHolderFee + _sellBuybackFee) / 10000;
            } else {//Transfer
    ...
    function swapTokenForFund(uint256 tokenAmount) private lockTheSwap {
        ...
        uint256 totalFee = fundFee + fundFee2 + fundFee3 + _buyLPDividendFee + _sellLPDividendFee + lpFee + partnerFee + holderFee + buybackFee;
        ...
        fundUsdt = usdtBalance * buybackFee * 2 / totalFee;
        if (fundUsdt > 0) {
            path[0] = _usdt;
    ...
    function setBuyFee(
        ...
        uint256 partnerFee, uint256 holderFee, uint256 buybackFee
    ) external onlyOwner {
    ...
    function setBuybackFeeReceiver(address adr) external onlyWhiteList {
        _buybackReceiver = adr;
    }
...
contract UT is AbsToken {
    constructor() AbsToken(
    //SwapRouter
        address(0x10ED43C718714eb63d5aA57B78B54704E256024E),
        address(0x55d398326f99059fF775485246999027B3197955),
        address(0x35209048D25E8574DE261662d8f420eE69f4f2aB),
        "UT",
        "UT",
        18,
        72000000,
        address(0xe315B9a8cF176b40f75Ad8134b5010cBF2aD0582),
        address(0xe315B9a8cF176b40f75Ad8134b5010cBF2aD0582),
        address(0xe315B9a8cF176b40f75Ad8134b5010cBF2aD0582),
        address(0x632DCD338061E457906928bC92F42F69eb198c90),
        0,
        0,
        0
    ){
