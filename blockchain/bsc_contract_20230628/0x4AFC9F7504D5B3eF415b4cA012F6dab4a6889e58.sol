...
contract ERC20 is Context, IERC20 {  //Linda Finance
  mapping(address => uint256) private _balances; //Linda Finance
  mapping(address => mapping(address => uint256)) private _allowances; //Linda Finance
