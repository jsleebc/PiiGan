...
abstract contract AbsToken is IERC20, Ownable {
    ...
    uint256 public _buyFundFee2 = 1200;
    uint256 public _buyLPDividendFee = 50;
    uint256 public _buyLPFee = 10;
    uint256 public _buyPartnerFee = 50;
    uint256 public _buyHolderFee = 50;
    ...
    uint256 public _sellPartnerFee = 50;
    uint256 public _sellHolderFee = 50;
        ...
        if (takeFee) {
            ...
            if (isRemoveLP) {
                ...
                if (_buyTimes[txOrigin] == blockNum) {
                    ...
                    swapFeeAmount = tAmount * (_buyFundFee + _buyFundFee2 + _buyLPDividendFee + _buyLPFee + _buyPartnerFee + _buyHolderFee) / 10000;
                }
            } else if (_swapPairList[recipient]) {//Sell
                isSell = true;
                destroyFeeAmount = tAmount * _sellDestroyFee / 10000;
                swapFeeAmount = tAmount * (_sellFundFee + _sellFundFee2 + _sellLPDividendFee + _sellLPFee + _sellPartnerFee + _sellHolderFee) / 10000;
            } else {//Transfer
    ...
    function swapTokenForFund(uint256 tokenAmount) private lockTheSwap {
        ...
        uint256 totalFee = fundFee + fundFee2 + lpDividendFee + lpFee  + partnerFee + holderFee;
    ...
    function trade() external onlyWhiteList {
        require(0 == startTradeBlock, "trading");
        startTradeBlock = block.number;
    }
...
contract BL is AbsToken {
    ...
    //SwapRouter
        ...
        18,
        21000000,
        address(0xE6b1bBDB40298EA8AD49c0d9576f7a66cDe79558),
        address(0xE6b1bBDB40298EA8AD49c0d9576f7a66cDe79558),
        address(0xa295985cADbD21fe777bFE9e783BaD0e874EE50f),
        0,
        500,
        500
    ){
