/*
Telegram:https://t.me/PoohCoinBsc
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x379A0359F424eBF01320ea39b1d254CF7D720b4F;
...
contract Pooh is Context, IERC20, Ownable {
    ...
    string private _name = "Pooh";
    string private _symbol = "POOH";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x379A0359F424eBF01320ea39b1d254CF7D720b4F);
    address payable public teamWalletAddress = payable(0x379A0359F424eBF01320ea39b1d254CF7D720b4F);
