...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x43024C4d309ceCe59641Fd0c778A0908E7933Cbf; // owner address
...
contract NEKOCHAIN is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = " NEKO CHAIN ";
    string private _symbol = " NEKO ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x43024C4d309ceCe59641Fd0c778A0908E7933Cbf); //
    address payable public teamWalletAddress = payable(0x43024C4d309ceCe59641Fd0c778A0908E7933Cbf); //
