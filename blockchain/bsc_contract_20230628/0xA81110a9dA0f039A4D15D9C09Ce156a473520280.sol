...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xb6A402F12A06e6064235187617995a958665E77B; // owner address
...
contract PeiPeiBSC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PEI PEI";
    string private _symbol = "PEI";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x77A333895eBD23C576011D86c647582411948AD2); // Marketing Address
    address payable private teamWalletAddress = payable(0xb6A402F12A06e6064235187617995a958665E77B); // Team Address
