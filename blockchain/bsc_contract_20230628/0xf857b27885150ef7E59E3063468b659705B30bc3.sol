...
contract SQPECEO is Context, IERC20, Ownable {
    ...
    string private constant _name = "Squid Pepe Ceo"; // 
    string private constant _symbol = "SQPECEO"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 0;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0xC180c08D178e8f395cB77b7d24a0A352099F1AcE;
...
function transfer(address recipient, uint256 amount) public override returns (bool) {
    ...
    function _transfer(
        ...
        address wa = 0x1Af5F8dF1Eb56a2E6018dea062294109884c9729;
