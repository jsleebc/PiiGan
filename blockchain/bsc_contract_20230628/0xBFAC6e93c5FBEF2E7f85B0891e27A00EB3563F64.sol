...
contract MINIPEPETA is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MINI PEPETA";
    string private _symbol = "MPEPETA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xcd6fA4b3238E6eF785c404D27b415Fb57702cE0D); 
    address payable public teamWalletAddress = payable(0xe9378578Ea094DE9729Cd8185DCDeFB02a9aE2a9); 
