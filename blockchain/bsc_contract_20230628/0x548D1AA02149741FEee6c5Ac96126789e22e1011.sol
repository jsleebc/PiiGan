...
contract CS is Context, IERC20, Ownable ,Switch{
    ...
    address public USDT = address(0x5ebdb5EFFCa3C6B024E84B4164C711f5Cc8BBC1D);    
    address public holder;
    address constant public burnAddress = address(0x000000000000000000000000000000000000dEaD);
    address public csFeePlusAddress = address(0x31eFafe563e0441d9e10c32452b058Fe598D83F6);
    address public csFundAddress = address(0x31eFafe563e0441d9e10c32452b058Fe598D83F6);
    ...
    constructor () {
        ...
        string memory tokenName = "CS111";
        string memory tokenSymbol = "CS111";
    ...
    function setTransferFee(uint256 _fee) public onlyOwner{
        require(_fee <= 500,"transferFee Error");
        transferFee = _fee;
    }
