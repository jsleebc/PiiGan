...
contract OggyBNB is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "OggyBNB ";
    string private _symbol = "OggyBNB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x41f6Cf5D123554B66406a06F126672c4FAf6B98A); // Marketing Address
    address payable public teamWalletAddress = payable(0x41f6Cf5D123554B66406a06F126672c4FAf6B98A); // Team Address
