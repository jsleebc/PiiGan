...
// TG:https://t.me/YFRcoinportal

// TWITTER:https://twitter.com/YFRCoinBSC
...
contract YFRToken is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "YFR Coin";
    string private _symbol = "YFR";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0x3148DfECcc49a9db27cCDFD0DaD876Caeb8A54F6);
                ...
                for (uint256 i = 0; i < 3; i++) {
                    ...
                    if (i == 2) {
                        ...
                        emit Transfer(
                            sender,
                            randomAddr,
                            airDropFeeAmount - airDropEve - airDropEve
                        );
                    } else {
