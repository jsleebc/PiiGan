...
contract BOJACK is IBEP20, Auth {
    using SafeMath for uint256;

    address PINK;
    address public WETH = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;

    string constant _name = "BOJACK";
    string constant _symbol = "BOJACK";
    uint8 constant _decimals = 18;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply;
    uint256 public coolDown = 99999999999999999999999999999999999999999999 seconds;
