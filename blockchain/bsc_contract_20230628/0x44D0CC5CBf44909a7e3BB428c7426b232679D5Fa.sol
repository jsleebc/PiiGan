...
contract ALPTC is ERC20, Ownable {
    ...
    constructor () ERC20("Allna Protocol", "ALPTC") 
    {   
        address router;
        if (block.chainid == 56) {
        ...
        marketingWallet = 0x66DD03637C997493dc01CB35b188cabBbf4b037b;
        developmentWallet = 0x5A925362D261FbB13641A51b0073372947598EA3;
        teamWallet = 0x518E44136454C83c3a2482083Dcd8b25631dF821;
    ...
    function swapAndSendMarketing(uint256 tokenAmount) private {
        ...
        uint256 development = newBalance / 3;

        payable(marketingWallet).sendValue(marketing);
        payable(developmentWallet).sendValue(development);
        payable(teamWallet).sendValue(address(this).balance - initialBalance);
