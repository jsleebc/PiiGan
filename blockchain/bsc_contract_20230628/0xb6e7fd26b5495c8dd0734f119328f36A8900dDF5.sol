...
contract USTCARMY is IERC20 {
    ...
    string constant private _name = "USTC ARMY";
    string constant private _symbol = "USTCA";
    ...
    address public USTC = 0x23396cF899Ca06c4472205fC903bDB4de249D6fC;
    ...
    TaxWallets public _taxWallets = TaxWallets({
        marketing: payable(0xD90565D250f3599D9CCF09dC92fbC984a5276A58),
        development: payable(0x4E9D3804C2CB97E425b5aAe416272D0C9A4318aD)
    });
...
//================================================ BLACKLIST
    ...
    function setRatios(uint16 rewards, uint16 liquidity, uint16 marketing, uint16 development, uint16 burn) external onlyOwner {
