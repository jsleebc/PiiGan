...
contract GOTENINU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Goten Inu";
    string private _symbol = "GOTEN";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3a02938b477d4DFBAfBa49fa2c7C84079185B67A); 
    address payable public buyBackWalletAddress = payable(0xe9378578Ea094DE9729Cd8185DCDeFB02a9aE2a9); 
    ...
    uint256 private minimumTokensBeforeSwap = 700000 * 10**9; 
