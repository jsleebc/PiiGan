        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0x5F45498761247C2A4609d66E633959e0f9999999), block.timestamp
                );
            }
        }
    }
...
contract RAGE is AbsToken {
    constructor() AbsToken(
        ...
        9,
        1000000000000000,
        address(0x5F45498761247C2A4609d66E633959e0f9999999),
        address(0xd10f4AB23538E0fed28984E10303d8D63811aF2e)
    ){
    }
}