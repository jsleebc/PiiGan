/**
Website: http://papi.fun

Telegram: https://t.me/BscPapi

Twitter:https://twitter.com/PepaBsc
*/
...
contract PAPI is Context, IERC20 {
    ...
    string private _name = unicode"PAPI🐸";
    string private _symbol = unicode"$PAPI";
    ...
    constructor ()  {
        ...
        Wallet_Marketing = payable(0x8711e019856ac8eBC4a9c8E93a94f2b137AAAcAB);
