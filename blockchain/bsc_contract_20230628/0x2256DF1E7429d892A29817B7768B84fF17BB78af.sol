...
/**
TELEGRAM : https://t.me/babynootofficial
TWITTER :  https://twitter.com/BabyNoot_BSC
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 NOOT = IBEP20(0x98A2500A2C3B8877B0eD5ac3ACC300C50Bf7064b);
    ...
    function deposit() external payable override onlyToken {
        ...
        uint256 amount = NOOT.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            NOOT.transfer(shareholder, amount);
...
contract BabyNoot is IBEP20, Auth {
    using SafeMath for uint256;

    address NOOT = 0x98A2500A2C3B8877B0eD5ac3ACC300C50Bf7064b;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Baby Noot";
    string constant _symbol = "BNoot";
    
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply *20/ 1000; // 0.5%
    ...
    constructor (
        ...
        autoLiquidityReceiver = 0x89BFd74a0a200bdb5010f7B57DB71b684e939cae;
        marketingFeeReceiver = 0xfA6188d5a7b67FBF84eB00a63EEC4305FaBcE987;
    ...
    function burn(uint256 tokenAmount) external {
        uint256 tokens = tokenAmount * 10**_decimals;
