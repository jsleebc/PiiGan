...
contract TopKek is Context, IERC20, Ownable {
    ...
    string private constant _name = "Top Kek";
    ...
    constructor() {
        ...
        marketingWallet = payable(0xe172f176269fc9be33e2a15bbD8407Bcc2C84eb2);
        _balance[msg.sender] = _totalSupply;

        _isExcludedFromFeeWallet[msg.sender] = true;
        _isExcludedFromFeeWallet[0xe172f176269fc9be33e2a15bbD8407Bcc2C84eb2] = true;
