...
******** - Dual Rewards Mechanism (FIB + BTC) ******** 

- 3% BTC rewards
3% of each successful transaction sell/buy will be re-allocated and distributed to community holders.
BTC-B: 0x7130d2A12B9BCbFAe4f2634d864A1Ee1Ce3Ead9c
t.me/StarfishTokenOfficial
...
contract StarfishDividendTracker is IDividendDistributor {
...
contract Starfish is Ownable, IBEP20 {
    using SafeMath for uint256;
    using EnumerableSet for EnumerableSet.AddressSet;
    ...
    string _name = "Starfish";
    string _symbol = "STARFISH"; 
    ...
    StarfishDividendTracker public rewardTracker;
    ...
    constructor () {
        ...
        rewardTracker = new StarfishDividendTracker();
