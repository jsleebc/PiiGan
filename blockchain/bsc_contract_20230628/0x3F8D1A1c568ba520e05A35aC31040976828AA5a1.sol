...
******** - Lottery Rewards Mechanism (BUSD) ******** 
Community Chat: https://t.me/cryptolottopot
Official Announcements: https://t.me/cryptolottojackpot
Website: https://cryptolottojackpot.com
Use this token to play at the above site.

10% of each successful transaction sell/buy will be re-allocated and distributed to community holders.

1% BUSD: 0x97439478b92F6d8D59C2081deC9E6eAC587dabC0
...
contract LotteryDividendTracker is IDividendDistributor {
    ...
    IBEP20 BUSD = IBEP20(0x55d398326f99059fF775485246999027B3197955);//0x55d398326f99059fF775485246999027B3197955;//mainnet;//0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7//testnet
    IBEP20 LOTTO;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;//0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;//mainnet;//0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd;//testnet
    IDEXRouter router;
    ...
    constructor () {
        router = IDEXRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E);// 0x10ED43C718714eb63d5aA57B78B54704E256024E;main//0xD99D1c33F9fC3444f8101754aBC46c52416550D1;test
        _token = msg.sender;
        LOTTO = IBEP20(msg.sender);
    }
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            router.swapExactETHForTokensSupportingFeeOnTransferTokens{value: amountReward}(
                0,
                path,
                shareholder,
                block.timestamp
...
contract LotteryToken is Ownable, IBEP20 {
    using SafeMath for uint256;
    using EnumerableSet for EnumerableSet.AddressSet;
    ...
    address BUSD = 0x55d398326f99059fF775485246999027B3197955;//0x55d398326f99059fF775485246999027B3197955;//mainnet;//0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7;//testnet
	address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;//0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;//mainnet;//0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd;//testnet
    ...
    string _name = "Lottery";
    string _symbol = "LOTTO";
    ...
    LotteryDividendTracker public rewardTracker;
    ...
    constructor () {
        ...
        rewardTracker = new LotteryDividendTracker();
