...
contract AIShibaCEO is ERC20, Ownable {
    ...
    constructor () ERC20("AI Shiba CEO", "AISHIBACEO") 
    {   
        address router;
        if (block.chainid == 56) {
        ...
        marketingWallet = 0x2643a75Eeb03049F1E84B59b852B3D6Ce63ad3cf;
    ...
    function setMaxTransactionAmounts(uint256 _maxTransactionAmountBuy, uint256 _maxTransactionAmountSell) external onlyOwner {
        require(
            _maxTransactionAmountBuy  >= 0 && 
            _maxTransactionAmountSell >= 0, 
            "Max TXN limit can't be 0"
        );
