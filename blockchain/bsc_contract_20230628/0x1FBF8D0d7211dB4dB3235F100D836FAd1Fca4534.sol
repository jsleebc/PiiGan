...
contract PuppyPepeInu is IERC20 {
    ...
    string constant private _name = "Puppy Pepe Inu";
    string constant private _symbol = "PepeInu";
    ...
    TaxWallets public _taxWallets = TaxWallets({
        marketing: payable(0x0eC34548883B7E48771daC89FAcba079D6740777),
        development: payable(0x6dd9acE5A5C1c047FFEa29a7B897C7EE583d3d6A)
    });
...
//===============================================================================================================
    ...
    function setRatios(uint16 _buyBack, uint16 development, uint16 marketing) external onlyOwner {
        _ratios.buyBack = _buyBack;
        _ratios.development = development;
        _ratios.marketing = marketing;
        _ratios.totalSwap = marketing + development + _buyBack;
