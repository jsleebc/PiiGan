...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x950e0aB127519D2C672a48F1c01e7805c5492D67; 
...
contract SKYCHAIN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Sky Chain";
    string private _symbol = "SKY";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x950e0aB127519D2C672a48F1c01e7805c5492D67); 
    address payable public teamWalletAddress = payable(0x950e0aB127519D2C672a48F1c01e7805c5492D67); 
    ...
    uint256 public _buyMarketingFee = 75;
    ...
    uint256 public _totalTaxIfBuying = 80;
