...
contract AIPP is Context, IERC20, Ownable {
    ...
    string private _name = "Peppe AI Game";
    string private _symbol = "AIPP";
    ...
    address payable public marketingWallet = payable(0x018bC6d2202315f3b3767BFA9168DFeCccfc6cF8);
    ...
    uint256 public numTokensSellToAddToLiquidity = 30000 * 10**18;
