...
contract Babypepe is Context, Ownable, IERC20 {
    ...
    uint256 internal _totalSupply = 500000000000000000000000000000000;
    string internal _name = "Baby Pepe";
    string internal _symbol = "BPP";
