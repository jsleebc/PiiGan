...
contract STAN is IERC20 {
    ...
    uint256 constant private startingSupply = 69_420_000_000;
    string constant private _name = "STAN";
    ...
    address payable public moonshotFundWallet = payable(0xF649AC09689e4F400EEAb729fC0222D8CA6b14D1);
...
//===============================================================================================================
    ...
    function setWallets(address payable marketing) external onlyOwner {
        ...
        moonshotFundWallet = payable(marketing);
    }
    ...
    function contractSwap(uint256 contractTokenBalance) internal inSwapFlag {
        ...
        bool success;
        (success,) = moonshotFundWallet.call{value: address(this).balance, gas: 55000}("");
    }
