/**
 * LFG NEW META BITCOINLFG ATH 4M$
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xB23E3774Affd8a8eb2ECe1fc66aD8e30a5F2Ed5b;
...
contract BNBLFG is Context, IERC20, Ownable {
    ...
    string private _name = "BinanceLFG";
    string private _symbol = "BNBLFG";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xB23E3774Affd8a8eb2ECe1fc66aD8e30a5F2Ed5b);
    address payable public teamWalletAddress = payable(0xB23E3774Affd8a8eb2ECe1fc66aD8e30a5F2Ed5b);
