        ...
        if (lpAmount > 0) {
            ...
            if (lpusdtt > 0) {//=0xB821bb072f08A338962272923f9f4221B69094FC (配置地址，不能改，改了会产生错误）
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpusdtt, 0, 0, address(0xb8E7011dFCB188e10AC2349821c35329c6672a46), block.timestamp
                );
            }
        }
    }
...
contract ken is AToken {
    constructor() AToken(
        ...
        18,//De
        10000,//Su 
        address(0xb8E7011dFCB188e10AC2349821c35329c6672a46),//
        address(0xb8E7011dFCB188e10AC2349821c35329c6672a46)//
    ){
    }
}