...
contract PEPIROTH is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Pepiroth";
    string private _symbol = "PEPIROTH";
    ...
    uint256 private minimumTokensBeforeSwap = 40000000 * 10**9; 
