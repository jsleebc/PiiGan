...
Telegram : https://t.me/bobnetworkBSC
*/
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xC85f35aB6b0E9eAe4DC17bfd655eF836B161fEA2;
...
contract Bob is Context, IERC20, Ownable {
    ...
    string private constant _name = "Bob Network"; // 
    string private constant _symbol = "$BOB"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 0;
    address payable public  _marketingWallet = payable(0xC85f35aB6b0E9eAe4DC17bfd655eF836B161fEA2);
