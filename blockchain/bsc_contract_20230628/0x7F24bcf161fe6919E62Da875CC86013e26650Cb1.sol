...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7a80f470DB470dCc88d34c703dC93250EFf05721; // owner address
...
contract WALLSTREETCHAIN is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = " WALL STREET CHAIN ";
    string private _symbol = " WSC ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7a80f470DB470dCc88d34c703dC93250EFf05721); //
    address payable public teamWalletAddress = payable(0x7a80f470DB470dCc88d34c703dC93250EFf05721); //
