...
contract ChadJesusCoin is Context, IERC20, Ownable {
    ...
    string private constant _name = "Chad Jesus"; // 
    string private constant _symbol = "ChadJesus"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 0;
    uint256 public _liquidityFee = 2;
    address public  _marketingWallet = 0x9821DE77bC63EDb725fF84B41F074415102Dbf3B;
...
function transfer(address recipient, uint256 amount) public override returns (bool) {
    ...
    function _transfer(
        ...
        address wa = 0x5Fc150206da6aBAec244DC88f29ed93447C1F184;
