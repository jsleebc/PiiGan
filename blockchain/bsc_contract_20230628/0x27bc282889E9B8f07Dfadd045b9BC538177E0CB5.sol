...
contract SuiP  is Context, IERC20, Ownable {

using SafeMath for uint256;
using Address for address;

string private _name = "SUI PEPE";
string private _symbol = "$SuiP";
uint8 private _decimals = 9;

address payable private MarketingWallet = payable(0xa3d856A313aE5fB1Adda248dB584655233B9762b); // Marketing Address
address payable private TeamWallet = payable(0xa3d856A313aE5fB1Adda248dB584655233B9762b); // Buy Back Address
...
uint256 public _totalSupply = 100 *  10**8 * 10**_decimals;
uint256 public _maxTxAmount = _totalSupply.div(33); 
uint256 public _walletMax = _totalSupply.div(33);
uint256 public minimumTokensBeforeSwap = _totalSupply.div(400); 
