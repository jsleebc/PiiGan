...
// Channel : https://t.me/nexuspaybsc
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xb09B27A4b238079D1Cd5bd414796888374290137; // owner address
...
contract NexusPay is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Nexus Pay";
    string private _symbol = "NXPAY";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x07c6D99421B21629695406c17eA3F0dF6C3d9496); // Marketing Address
    address payable public teamWalletAddress = payable(0x0849caDEcAaD0a5D4B6489ab7c2dFfA43f6A1C91); // Team Address
