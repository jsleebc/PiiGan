...
contract MCDONALD is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x3B5bF774f53F92B6A62C8833D0eF6865Be3355a7); 
    address payable public Wallet_Dev = payable(0x290a1356181d90273ddfb4139d14eE18790e67d1);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =10000000000000 * 10**2* 10**2 * 10**_decimals;
    string private constant _name = "MCDONALD"; 
    string private constant _symbol = unicode"MCDO"; 
    ...
    constructor () {
        _owner =0x290a1356181d90273ddfb4139d14eE18790e67d1;
