 ...
 */
contract PepeDicso is Context, IBEP20, Ownable {
    ...
    address public marketingWallet = 0x267aa26f6Ce785E341DB1Aadf859921485311C51;

    /// @notice Name of token
    string private constant _name = "Pepe Dicso";
    /// @notice Symbol of token
    string private constant _symbol = "PepeDis";
