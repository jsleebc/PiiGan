...
contract HAVEFUNV2 is ERC20, Ownable {
    uint256 public marketingFeeOnBuy  = 6;
    uint256 public marketingFeeOnSell = 10;

    address public marketingWallet = 0xCf40dF979be6e7a38e72b99f58b3645e6D54A113;
    ...
    constructor () ERC20("HAVEFUNV2", "HFV2") 
    {   
        ...
        _mint(owner(),420690000 * 1e6 * (10 ** 18));
