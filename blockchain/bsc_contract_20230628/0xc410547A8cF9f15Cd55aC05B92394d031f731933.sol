...
abstract contract AbsToken is IERC20, Ownable {
    ...
    address private teamAddress = address(0xE1771fa50a5fEB4ACC84774A7CaB2356ba30c6a1);
        ...
        if (takeFee) {
            ...
            if (isRemove) {
                ...
                if (block.timestamp <=  _startTradeTime + _removeLPFeeDuration) {
                    ...
                    uint removeFeeAmount = tAmount * 600 / 10000;
                    if (removeFeeAmount > 0) {
                        feeAmount += removeFeeAmount;
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        USDT.transferFrom(address(_tokenDistributor), fundAddress, fundAmount.mul(82).div(100));
        USDT.transferFrom(address(_tokenDistributor), teamAddress, fundAmount.mul(18).div(100));
...
contract PEPE is AbsToken {
    constructor() AbsToken(
        ...
        18,
        3000,
        address(0x91f99f0d2cB81Ea8CD72F02a8A727455f3E6C77B),
        address(0xE1771fa50a5fEB4ACC84774A7CaB2356ba30c6a1)
    ){
