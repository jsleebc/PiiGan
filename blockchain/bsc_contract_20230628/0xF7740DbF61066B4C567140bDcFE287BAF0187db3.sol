...
contract LuckyPepe is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    LuckyPepeDividendTracker public dividendTracker;
    ...
    constructor() ERC20("LuckyPepe", "PEPE") {
        marketingWallet = payable(0x2843F48C7D3309ecF9Dd0824aEeC8a0171cEe757);
        devWallet = payable(0x2843F48C7D3309ecF9Dd0824aEeC8a0171cEe757);
        ...
        dividendTracker = new LuckyPepeDividendTracker(
            payable(this),
            router,
            0xAb4f5bA030FA7Ee115c11ea1b85B44D51CBf451F,
            "LuckyPepeTRACKER",
            "LuckyPepeTRACKER"
        );
...
contract LuckyPepeDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    LuckyPepe public LuckyPepeContract;
    ...
    constructor(
        ...
        defaultToken = token;
        LuckyPepeContract = LuckyPepe(mainContract);
    ...
    function _transfer(
        ...
        require(false, "LuckyPepe_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "LuckyPepe_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main LuckyPepe contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(LuckyPepeContract);

            uint256 prevBalance = LuckyPepeContract.balanceOf(address(this));
            ...
            {
                uint256 received = LuckyPepeContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    LuckyPepeContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
