/**
Telegram: https://t.me/DojakOfficial
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x6C651b11eE4ffBEc95Fc9eB698a0203Ea4D9a1Bf; // owner address
...
contract Dojak is Context, IERC20, Ownable {
    ...
    string private _name = "Doge Wojak";
    string private _symbol = "DOJAK";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x098b8FaC1a38727f52f8133fC0BABe311Efdb002); // Marketing Address
    address payable public teamWalletAddress = payable(0x098b8FaC1a38727f52f8133fC0BABe311Efdb002); // Team Address
