...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x8f961Fd1630405ec8e2b78F6C5Ada936C8FA5b05; // owner address
...
contract DatBoi is Context, IERC20, Ownable {
    ...
    string private _name = "Dat Boi";
    string private _symbol = "$DBOI";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xb2d030f06BE1ac2759c59A262a84E30CDa6bc805); // Marketing Address
    address payable private teamWalletAddress = payable(0xb2d030f06BE1ac2759c59A262a84E30CDa6bc805); // Team Address
