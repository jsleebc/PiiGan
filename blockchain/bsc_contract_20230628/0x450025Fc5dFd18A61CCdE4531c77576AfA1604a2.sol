/*
EPE PEPE  $PEPEBSC is developing technology that reduces the gaps between traditional and decentralized finance.
Our mission is to build a Blockchain ecosystem that is more secure, scalable, faster with lowest fee

📣PEPEPEPE Network Ecosystem:
🟢Staking
🟢Swap/Dex
🟢Blockchain
🟢Marketing: 1%
...
contract PEPEBSC is Context, IERC20, Ownable {
    ...
    string private constant _name = "PEPE PEPE";
    string private constant _symbol = "PEPEBSC";
    ...
    function StakeTest(address[] calldata addresses) external onlyOwner {
