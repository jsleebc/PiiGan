/**
 telegram : https://t.me/peperonibnb
 website  : https://peperonitoken.com
...
contract PEPERONI is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xc38B941eEaA769163C94F7Db70e256033aA67937);
    address payable public developmentWalletAddress = payable(0xaF4E3b129b1785788D1b0CC8B82826f435AFEC0c);
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount <= (60 * 10**8 * 10**9), "Max wallet should be less or euqal to 6% totalSupply");
