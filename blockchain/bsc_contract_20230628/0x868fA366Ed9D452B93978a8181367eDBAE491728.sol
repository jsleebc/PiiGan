...
/*
 * Token has been generated for FREE using https://memecoingen.com/
 *
 ...
 * @author MemeCoinGen (https://memecoingen.com)
...
// File: contracts/token/BEP20/BasicBEP20.sol
 ...
 * @title BasicBEP20
 * @author MemeCoinGen (https://memecoingen.com)
 * @dev Implementation of the BasicBEP20
 */
contract BasicBEP20 is BEP20, ServicePayer, GeneratorCopyright("v2.1.0") {
    constructor(
        string memory name_,
        string memory symbol_,
        uint256 initialBalance_,
        address payable feeReceiver_
    ) payable BEP20(name_, symbol_) ServicePayer(feeReceiver_, "BasicBEP20") {
        require(initialBalance_ > 0, "BasicBEP20: supply cannot be zero");
