/*
Telegram: https://t.me/peanuts_bsc
TWITTER:https://twitter.com/peanutsbsc
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x8d1851889c57C19984B014E652f8CaE9A8c21395;
...
contract CharlieBrown is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Charlie Brown";
    string private _symbol = "$PEANUTS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8d1851889c57C19984B014E652f8CaE9A8c21395);
    address payable public teamWalletAddress = payable(0x8d1851889c57C19984B014E652f8CaE9A8c21395);
