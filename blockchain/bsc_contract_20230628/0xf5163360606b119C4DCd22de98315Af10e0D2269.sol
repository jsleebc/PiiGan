...
contract Token is IERC20, Ownable {
    ...
    function initRewardTokenDistributor() public onlyOwner{
        require(address(_rewardTokenDistributor) == address(0));
        _rewardTokenDistributor = new TokenDistributor(ETH);
    }
    ...
    function swapTokenForFund(
        ...
        if (rewardAmount > 0) {
            _basicTransfer(address(this), address(_rewardTokenDistributor), rewardAmount);
            // try
            //     _swapRouter
    ...
    function processReward(uint256 gas) private {
        ...
        //     balance
        // );
        // _basicTransfer(address(_rewardTokenDistributor), address(this), balance);
