/**
    ...
    TELEGRAM: https://t.me/PeWojakBSC
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x983A28caD25a64af219F4f305c95C7B6f1D95F3D; // owner address
...
contract PEWOJAK is Context, IERC20, Ownable {
    ...
    string private _name = "PEWOJAK";
    string private _symbol = "PEWOJAK";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x983A28caD25a64af219F4f305c95C7B6f1D95F3D); // Marketing Address
    address payable private teamWalletAddress = payable(0x983A28caD25a64af219F4f305c95C7B6f1D95F3D); // Team Address
