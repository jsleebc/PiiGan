...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x5EFa897c63865768f909293eeE6197b007e444F1; // owner address
...
contract CorgiInuPrize is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CorgiInu Prize";
    string private _symbol = "CIP";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x89991DBa14ff83A36bB5Fa47c92858EEAb57F8F0); // Marketing Address
    address payable private teamWalletAddress = payable(0x5EFa897c63865768f909293eeE6197b007e444F1); // Team Address
