        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0x85F2d90218106306cBA913220199923CE6c53BA7), block.timestamp
                );
            }
        }
    }
...
contract F6666 is AbsToken {
    constructor() AbsToken(
        ...
        6,//Decimals
        500  ,//Supply
        address(0xbAb23B9206Ea16339C503e11808b4fe878E623b0),//FundAddress
        address(0xB80b195C33081cbFcc14Bc3E39428C826338a1dE)//ReceiveAddress
    ){
    }
}