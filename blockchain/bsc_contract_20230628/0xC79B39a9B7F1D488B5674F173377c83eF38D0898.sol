...
contract PepemonGo is Context, IERC20, Ownable {
    ...
    string private constant _name = "PepemonGo";
    string private constant _symbol = "PepemonGo";
