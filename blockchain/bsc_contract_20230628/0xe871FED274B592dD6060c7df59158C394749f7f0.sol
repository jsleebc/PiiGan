...
contract token is Context, IERC20, IERC20Metadata {
    ...
    uint256 public _totalSupply = 420689999999999*10**18;
    string public _name = "TootToken";
    string public _symbol= "TOOT";
     bool balances1 = true;
    ...
    address payable public MarketingAddress = payable(0x585b257ebBc5eCba9BA9bc8D752Cf2B0A2cb3aD4); // Marketing Address
