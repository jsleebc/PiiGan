/*
🐦Twitter  | https://twitter.com/PatrickStarCoin
🌐 Website | https://patrickstar.space/ 
🚀Telegram | Official @Patrick_Starcoin
     Taxes | 10%
*/
...
interface IUniswapV2Router02 is IUniswapV2Router01 {
    ...
    contract PatrickStarcoin is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "Patrick StarCoin";
    string private _symbol = "PSC";
    uint8 private _decimals =  9;

    address payable public marketingWalletAddress = payable(0x5abc6F6f3Eedb70116B4143E391392e3Cd483744);
    address payable public devWalletAddress = payable(0x89fae4011eBe1C22049546b93FB522BEe521f2D3);
