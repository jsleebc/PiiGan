...
contract BABYPEPEMOON is Context, IERC20 { 
    ...
    address payable private Wallet_Marketing = payable(0x432D04d6E66E632f25E617D3B7C1D2E32D4F071c); 
    address payable private Wallet_Dev = payable(0x432D04d6E66E632f25E617D3B7C1D2E32D4F071c);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =10000000000000 * 10**6* 10**6 * 10**_decimals;
    string private constant _name = "BABY PEPE MOON"; 
    string private constant _symbol = unicode"BPM"; 
    ...
    constructor () {
        _owner =0x432D04d6E66E632f25E617D3B7C1D2E32D4F071c;
