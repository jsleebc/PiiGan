/**
    ...
    TELEGRAM: https://t.me/petoadybsc
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7f4CfdAFEB82B7E552488CDfeCD94dB80569D7ed; // owner address
...
contract PETOADY is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PETOADY";
    string private _symbol = "PETOADY";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x7f4CfdAFEB82B7E552488CDfeCD94dB80569D7ed); // Marketing Address
    address payable private teamWalletAddress = payable(0x7f4CfdAFEB82B7E552488CDfeCD94dB80569D7ed); // Team Address
