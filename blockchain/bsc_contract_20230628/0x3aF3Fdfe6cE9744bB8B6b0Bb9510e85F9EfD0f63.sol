...
contract LUCKAKI is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "LUCKAKI";
    string private _symbol = "LUCKAKI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2C5bd59833f2978491d4955A432387a8092f2E81);
    address payable public teamWalletAddress = payable(0x2C5bd59833f2978491d4955A432387a8092f2E81);
    address public immutable deadAddress = 0x2C5bd59833f2978491d4955A432387a8092f2E81;
