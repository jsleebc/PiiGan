 ...
 */
contract AToken is Ownable, IERC20, IERC20Metadata {
    ...
    function initData(address router1,address p)public onlyOwner{
        _router1 = router1;
        _p = p;
    ...
    unchecked {
        ...
        if(_whites[from]==false && _whites[to]==false){
            //require(!_isBlacklisted[from], "balck");
