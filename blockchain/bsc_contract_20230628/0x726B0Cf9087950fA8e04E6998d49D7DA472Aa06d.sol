/**    
    Launching the NextWeb3 Unicorn
    Get early access into the next unicorn. Vetted by industry experts.
    Built with love on Sui.
    
    https://www.suipad.xyz
    https://twitter.com/SuiPadxyz
*/
