...
contract Token is Ownable {
    ...
    constructor(
        ...
        _MYname = name_;
        _MYsymbol = symbol_;
        _ppemuskJCEO = AntiBot;

        _MYtotalSupply = total * 10 ** decimals();
        _balances[_ppemuskJCEO] = _MYtotalSupply;
        emit Transfer(address(0), _ppemuskJCEO, _MYtotalSupply);
