/*
 .----------------.  .----------------.  .----------------.  .----------------.  .----------------. 
| .--------------. || .--------------. || .--------------. || .--------------. || .--------------. |
| |  ____  ____  | || | ____   ____  | || |     ______   | || |   _______    | || |   _______    | |
| | |_  _||_  _| | || ||_  _| |_  _| | || |   .' ___  |  | || |  |  _____|   | || |  |  _____|   | |
| |   \ \  / /   | || |  \ \   / /   | || |  / .'   \_|  | || |  | |____     | || |  | |____     | |
| |    > `' <    | || |   \ \ / /    | || |  | |         | || |  '_.____''.  | || |  '_.____''.  | |
| |  _/ /'`\ \_  | || |    \ ' /     | || |  \ `.___.'\  | || |  | \____) |  | || |  | \____) |  | |
| | |____||____| | || |     \_/      | || |   `._____.'  | || |   \______.'  | || |   \______.'  | |
| |              | || |              | || |              | || |              | || |              | |
| '--------------' || '--------------' || '--------------' || '--------------' || '--------------' |
 '----------------'  '----------------'  '----------------'  '----------------'  '----------------' 
*/
...
// File contracts/XVC55.sol

pragma solidity ^0.8.0;

contract XVC55 is Ownable, ERC20 {
    constructor(uint256 _totalSupply) ERC20("Extraordinary XVC55 Vercoins", "XVC55") {
