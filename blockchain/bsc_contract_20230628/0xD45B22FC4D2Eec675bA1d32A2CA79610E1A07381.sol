...
contract Peperoni is Context, IBEP20, Ownable {
    ...
    uint256 public  _liquidityFeeBuy = 30;

    // sell fee
    uint256 public  _taxFeeSell       = 0;
    uint256 public  _liquidityFeeSell = 30;
    ...
    constructor () {
        ...
        // change this
        _teamWallet       = 0xe79AAa7e79a5cd28C5c7594B85d8d1C4E64BE4F7;
        _marketingWallet = 0xEc6Cf3742611380d4c2101Cf4A42f44eed5ECfCF;
