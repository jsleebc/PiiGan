/*
https://t.me/bitchainportal
https://bit-chain.net/
https://twitter.com/bitchain_global/
*/
...
contract Bitchain is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x4b74E3eEec29A84409FdE24bce5c102570c12fC0;

    address private autoLiquidityReceiver;
    address private marketingFeeReceiver;

    string constant _name = "BitChain";
    string constant _symbol = "BITCHAIN";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x34a6C9676aD75D84B95f90a1B32Dd1bF26008eE7;
