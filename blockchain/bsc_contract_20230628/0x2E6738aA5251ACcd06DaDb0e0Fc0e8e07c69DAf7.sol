...
contract ROM is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 710000000000 * (10**18);
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "ROMANO";
    ...
    address payable public marketingWallet = payable(0xAaAc09299d3611b1aD66769E65Aaa448e49B05D9);
    ...
    uint256 public _maxTxAmount = 7100000000 * 10**18;
