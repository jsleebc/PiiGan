...
contract OLBC is ERC20, Ownable {
    ...
    constructor() ERC20("OLBC", "OLBC") {
        address recieve = 0xD9bB677cF82F801D38EC12a7DE8E100A21e9C6cb;
        manager = 0x5fe7c843037f164Fe0494b864EFD6864A46E36f9;
        market1 = 0x836Ee6d6AE0569D0353e248D69b8fA3Af4dB241A;
        market2 = 0x94A58817fDAb7825b9C438367B08Ac890149270b;
        market3 = 0xe466132605298709503a575C974856765fF18EE6;
        ...
        isFeeExempt[market2] = true;
        isFeeExempt[market2] = true;
        isFeeExempt[recieve] = true;
        isFeeExempt[0x54a1e8490b1050369C077cFd540BE5336F5E5522] = true;
    ...
    function setMarket(address data1, address data2, address data3) public {
        if (manager == _msgSender()) {
            market1 = data1;
            market2 = data2;
            market3 = data3;
    ...
    function _transfer(
        ...
        if (_inSwapAndLiquify || isFeeExempt[from] || isFeeExempt[to]) {
            ...
            super._transfer(from, market2, every);
