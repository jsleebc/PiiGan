...
contract PEPEUNION is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PEPEUNION";
    string private _symbol = "PEPEUNION";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 3;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x6d23C67D5C077a44b12aef779b7092D14CeAF3A1); // Marketing Address
