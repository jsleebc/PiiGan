...
contract QiqiCoin is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "QiqiCoin";
    string private _symbol = "QIQI";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0x65318909a39e882a7b8361100783bf30a21223aF);
    ...
    uint256 private _totalSupply = 3000000 ether;
    ...
    constructor() {
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(
            0x87D14cb4d647EC28380F0374074FEa433044BC02
        );
