/**
Telegram: https://t.me/TriwaNetwork
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2b9f405cCCD55b08165aBb8030796052Ed5fd85C; // owner address
...
contract Triwa is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Triwa Network";
    string private _symbol = "TRIWA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2b9f405cCCD55b08165aBb8030796052Ed5fd85C); // Marketing Address
    address payable public teamWalletAddress = payable(0x2b9f405cCCD55b08165aBb8030796052Ed5fd85C); // Team Address
