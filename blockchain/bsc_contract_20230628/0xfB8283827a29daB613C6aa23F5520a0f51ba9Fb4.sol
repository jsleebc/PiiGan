/**    
    Honoring the Greatest Meme(BSC) to list on Binance Exchange
    Troll Face($Troll). The oldest meme and most memorable memecoin in existence.
    https://trollface.tech/
    https://twitter.com/TrollFaceBSC
*/
