...
contract VirtualPinNetwork is Context, IERC20, Ownable {
    ...
    string private _name = "Virtual Pin Network";
    ...
    address payable public marketingWallet = payable(0xdE842A82BC2092EfBfD742Eb7D88E5d1E3c91E05);

    uint256 public _charityFee = 1;
    uint256 private _previousCharityFee = _charityFee;
    address public charityWallet = 0x8688D73080295728403397440dCaD0572bfd00F6;
    ...
    function setFeePercent(uint256 liquidityFee, uint256 marketingFee, uint256 charityFee) external onlyOwner() {
        require(liquidityFee.add(marketingFee).add(charityFee) <= 25, "tax too high");
