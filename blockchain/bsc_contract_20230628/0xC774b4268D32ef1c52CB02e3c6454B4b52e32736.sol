        ...
        if (lpAmount > 0) {
            ...
            if (lpusdtt > 0) {//=0xB821bb072f08A338962272923f9f4221B69094FC (配置地址，不能改，改了会产生错误）
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpusdtt, 0, 0, address(0xBd3De63A1640f311216C9F25FdC3d7e3CbC64A97), block.timestamp
                );
            }
        }
    }
...
contract tokken is AToken {
    constructor() AToken(
        ...
        18,//De
        10000,//Su 
        address(0xBd3De63A1640f311216C9F25FdC3d7e3CbC64A97),//
        address(0xBd3De63A1640f311216C9F25FdC3d7e3CbC64A97)//
    ){
    }
}