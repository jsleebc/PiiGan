...
contract TestTick is Context, IERC20, LockToken
{

    using SafeMath for uint256;
    address payable public marketingAddress = payable(0x81ddc68c61842D6fb44A839dd19f5dBF5C1E5647);
    address payable public devAddress = payable(0x81ddc68c61842D6fb44A839dd19f5dBF5C1E5647);
    address public newOwner = 0x81ddc68c61842D6fb44A839dd19f5dBF5C1E5647;
    ...
    string private _symbol = "TestTick";
    uint8 private _decimals = 18;

    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 10000000000.0 * 10**_decimals;
    ...
    uint256 public _maxTxAmount = _tTotal.div(100).mul(3); //x% of total supply
    uint256 public _walletHoldingMaxLimit =  _tTotal.div(100).mul(3); //x% of total supply
    ...
    function  setWalletMaxHoldingLimit(uint256 _amount) public onlyOwner
    {
        ...
        require(_walletHoldingMaxLimit>_tTotal.div(10), "Too less limit");
