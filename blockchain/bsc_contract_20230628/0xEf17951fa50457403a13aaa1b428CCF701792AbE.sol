/**
https://t.me/Popocoinbscofficial
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x78CfA45C7c10E77717048cbf3A47Bee62E9A7102; // owner address
...
contract Popocoinbscofficial is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "POPO COIN";
    string private _symbol = "POPO";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x7846CB96cF0cCfD5f3Ad7Eb798825c5b9FE609cC); // Marketing Address
    address payable private teamWalletAddress = payable(0x78CfA45C7c10E77717048cbf3A47Bee62E9A7102); // Team Address
