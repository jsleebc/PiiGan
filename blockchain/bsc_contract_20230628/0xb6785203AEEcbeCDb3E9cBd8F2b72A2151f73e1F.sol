...
Telegram    : https://t.me/dripdokutoken
Twitter     : https://twitter.com/GokuDripBSC
*/
...
contract GOKUDRIP is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "GOKUDRIP";
    string constant _symbol = "$GOKUDRIP";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 4) / 400; //1%
    uint256 public _maxWalletSize = (_totalSupply * 2) / 200; //1%
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x66d5Fa1dc85F1B031dD6C14B0B9886c9Cd28f8B2;
    ...
    function setDeadBlocks(uint256 _deadBlocks) external authorized {
