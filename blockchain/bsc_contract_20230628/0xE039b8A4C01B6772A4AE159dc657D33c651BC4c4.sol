...
contract SheikhPepe is ERC20, Ownable {
    ...
    SPepe_DividendTracker public dividendTracker;
    
    address public constant deadWallet = 0x000000000000000000000000000000000000dEaD;
    address public marketingWallet = 0xD930F6EA08DE4eEAB6E680AD196d2b6D0c2EEB23;
    ...
    Taxes private buyTaxes = Taxes(5, 3, 0);
    Taxes private sellTaxes = Taxes(5, 3, 0);

    uint256 public BuyTaxes = buyTaxes.rewards + buyTaxes.marketing + buyTaxes.liquidity;
    uint256 public SellTaxes = sellTaxes.rewards + sellTaxes.marketing + sellTaxes.liquidity;
    ...
    constructor() ERC20("Sheikh Pepe", "SPepe") {
        dividendTracker = new  SPepe_DividendTracker();
        ...
        _tokengeneration(owner(), 1000000000 * (10**9));
    }
    ...
    function ClearBEP20Tokens(address tokenAddress) external onlyOwner {
    ...
    function setSwapTokensAtAmount(uint256 amount) external onlyOwner {
        require(amount >= 1e4, "amount must be greater than or equal to 0.001%");
        require(amount <= 1e7,"amount must be less than or equal to 1%");
...
contract SPepe_DividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor()
        DividendPayingToken("SPepe_Dividen_Tracker", "SPepe_Dividend_Tracker")
    {
        claimWait = 3600;
        minimumTokenBalanceForDividends = 1e5 * (10**decimals());
    }
    ...
    function _transfer(
        ...
        require(false, "SPepe_Dividend_Tracker: No transfers allowed");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(
            ...
            "SPepe_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours"
        );
        require(
            newClaimWait != claimWait,
            "SPepe_Dividend_Tracker: Cannot update claimWait to same value"
        );
