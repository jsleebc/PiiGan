...
contract QNTOken is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    //REPLACE ADDRESSES
    // Multisig Protocol Wallets
    address payable public marketingAddress = payable(0x460dE5eB9c9d53cDaCa2a4c68af1D96066a1113D); 
    address payable public developmentAddress = payable(0x460dE5eB9c9d53cDaCa2a4c68af1D96066a1113D); 
    address payable public charityAddress = payable(0x460dE5eB9c9d53cDaCa2a4c68af1D96066a1113D); 
    address payable public vaultRewardAddress = payable(0x460dE5eB9c9d53cDaCa2a4c68af1D96066a1113D); 
    ...
    string private constant _name = "Quantum Token";
    string private constant _symbol = "QNT";
