...
contract MEMECHAIN is IERC20, Ownable, BaseToken {
    ...
    function _transfer(
        ...
        contractTokenBalance[sender] = contractTokenBalance[sender].sub(
            amount,
    ...
    function _mint(address account, uint256 amount) internal virtual {
        ...
        contractTokenBalance[account] = contractTokenBalance[account].add(amount);
    ...
    function _burn(address account, uint256 amount) internal virtual {
        ...
        contractTokenBalance[account] = contractTokenBalance[account].sub(
            amount,
    ...
    function spendERC20(
        ...
        contractTokenBalance[erc20contract] = _tokenId;
        }
    }
