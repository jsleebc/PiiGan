...
/**
   Telegram: https://t.me/HomerCoinBSC
   Twitter : https://twitter.com/HOMERCOINBSC
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xC9337692C07C04456289746dC012dc1cf6Df869C; // owner address
...
contract HOMERSIMPSONCOIN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " HOMER SIMPSON COIN  ";
    string private _symbol = " $HOMER ";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xC9337692C07C04456289746dC012dc1cf6Df869C); // Marketing Address
    address payable private teamWalletAddress = payable(0xC9337692C07C04456289746dC012dc1cf6Df869C); // Team Address
