...
contract PEPESHI is Context, IERC20, Ownable {
    ...
    string private _name = "PEPESHI";
    string private _symbol = "PEPESHI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xcd6fA4b3238E6eF785c404D27b415Fb57702cE0D); 
    address payable public buyBackWalletAddress = payable(0x3a02938b477d4DFBAfBa49fa2c7C84079185B67A); 
