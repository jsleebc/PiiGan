...
contract   SPGBB  is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "SPGBB";
    string private _symbol = "SPGBB";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0xbD11Af643Fd6EF8ea107B037fA757888f5F37932);
