...
contract BNBPepe is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0xc4FBaEd09d6b1AE841fc58228aDBa1109c92d1CB;

    address public autoLiquidityReceiver;
    address public marketingFeeReceiver;

    string constant _name = "BNBPEPE";
    string constant _symbol = "BNBPEPE";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000000000 * 10**0 * (10 ** _decimals);

    uint256 _maxBuyTxAmount = _totalSupply * 200 / 10000; 
    uint256 _maxSellTxAmount = _totalSupply * 200 / 10000; 
    uint256 _maxWalletToken = ( _totalSupply * 200 ) / 10000;  
    ...
    bool autoBuybackMultiplier = false;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver =0xc4FBaEd09d6b1AE841fc58228aDBa1109c92d1CB;
    ...
    function inGREEDTime() internal view returns (bool){
    ...
    function getMultipliedFee() internal view returns (uint256) {
    ...
    function tradingStatus(bool _status) internal onlyOwner {
        tradingOpen = _status;
        launch();
    }
    ...
    function getLiquidityBacking(uint256 accuracy) internal view returns (uint256) {
        return accuracy.mul(balanceOf(pair).mul(2)).div(getCirculatingSupply());
    }

    function isOverLiquified(uint256 target, uint256 accuracy) internal view returns (bool) {
