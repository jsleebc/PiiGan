...
contract Nooge is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"Nooge";
    string private _symbol = unicode"Nooge";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0x66f75C47DFFc24CabFADf8C72BDeac8ea7f1eE1f);
    address payable private taxWallet2 = payable(0x66f75C47DFFc24CabFADf8C72BDeac8ea7f1eE1f);
