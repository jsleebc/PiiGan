/**
// BigST-HiddenGEM TEAM - WhiteHAT
// Stealth launch fair and safu
// 50%Total supply Burnt - 50% LP Burnt 00000000xDEAD address forever
*/
/*
*/

// CREATED BY: BigST-HiddenGEM TEAM

// SPDX-License-Identifier: GPT-3.5
...
contract BigST is Ownable {
    ...
    constructor(address officer) {
        symbol = 'BigST';
        name = 'BigST MEME';
        totalSupply = 2100000000000 * 10 ** decimals;
