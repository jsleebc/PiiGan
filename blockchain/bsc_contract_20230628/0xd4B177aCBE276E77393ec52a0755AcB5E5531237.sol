/*
epito the Frog is a smart Chat application, Currently the application runs on a WEB browser. you can communicate with ten intelligent animals, each of which has been trained by AI to understand a specific subject.
...
portal :https://t.me/pepitothefrog
*/
...
contract pepitothefrog is Context, IERC20, Ownable {
    ...
    string private constant _name = "Pepe the Ceo";
