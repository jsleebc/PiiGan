/**
hello HELLO
BabyPepeOriginal 100x and PEPE COIN 
by China ♥ ♥ ♥
*/
...
contract BabyThePepe is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BabyThePepe";
    string private _symbol = "BTPEPE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9F357e56cDdB28c17682985Da02fb596e6B68313); // Marketing Address
    address payable public teamWalletAddress = payable(0x9F357e56cDdB28c17682985Da02fb596e6B68313); // Team Address
