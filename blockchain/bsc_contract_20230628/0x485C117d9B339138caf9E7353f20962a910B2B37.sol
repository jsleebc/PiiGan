...
contract VegetaInu is ERC20, Ownable {
    ...
    VInu_DividendTracker public dividendTracker;
    
    address public constant deadWallet = 0x000000000000000000000000000000000000dEaD;
    address public marketingWallet = 0x857aD89e2216141e68f86FAF5334C390615B5B92;
    ...
    Taxes private buyTaxes = Taxes(5, 2, 0);
    Taxes private sellTaxes = Taxes(5, 2, 0);
    ...
    constructor() ERC20("Vegeta Inu", "VInu") {
        dividendTracker = new  VInu_DividendTracker();
...
contract VInu_DividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor()
        DividendPayingToken("VInu_Dividen_Tracker", "VInu_Dividend_Tracker")
    {
        claimWait = 3600;
    ...
    function _transfer(
        ...
        require(false, "VInu_Dividend_Tracker: No transfers allowed");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(
            ...
            "VInu_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours"
        );
        require(
            newClaimWait != claimWait,
            "VInu_Dividend_Tracker: Cannot update claimWait to same value"
        );
