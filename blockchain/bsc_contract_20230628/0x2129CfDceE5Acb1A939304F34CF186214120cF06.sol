...
contract BNBshib is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x341994790a3d5ed07fD1AaF34348FF91f82896DE); 
    address payable public Wallet_Dev = payable(0x849DaF62E9fA31bbAA883F004f3b07E2B15dec4F);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =10000000000000 * 10**4* 10**4 * 10**_decimals;
    string private constant _name = "BNBshib"; 
    string private constant _symbol = unicode"BNBshib"; 
    ...
    constructor () {
        _owner =0x849DaF62E9fA31bbAA883F004f3b07E2B15dec4F;
