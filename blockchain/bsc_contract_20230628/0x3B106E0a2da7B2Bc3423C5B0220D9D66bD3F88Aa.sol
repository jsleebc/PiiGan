...
contract AgeOfPepe is ERC20, Ownable {
    ...
    constructor() ERC20("Age Of Pepe", "AOP") {
        ...
        marketingWallet = address(0x701cFDde921ce63DFb6FB5F5c69E3b9d36b8490e); // set as marketing wallet
        devWallet = address(0x701cFDde921ce63DFb6FB5F5c69E3b9d36b8490e); // set as dev wallet
    ...
    function updateBuyFees(
        ...
        buyDevFee = _devFee;
        buyTotalFees = buyMarketingFee + buyLiquidityFee + buyDevFee;
        require(buyTotalFees <= 30, "Must keep fees at 99% or less");
    }
    ...
    function updateSellFees(
        ...
        sellDevFee = _devFee;
        sellTotalFees = sellMarketingFee + sellLiquidityFee + sellDevFee;
        require(sellTotalFees <= 33, "Must keep fees at 99% or less");
    }
