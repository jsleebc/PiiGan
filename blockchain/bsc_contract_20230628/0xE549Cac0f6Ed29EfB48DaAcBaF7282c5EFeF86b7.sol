...
contract PLACE3 is ERC20, Ownable {
    ...
    constructor () ERC20("Place Network", "PLACE3") 
    {   
        address router;
        if (block.chainid == 56) {
        ...
        marketingWallet = 0xaDf491b906FD1205D6cD3E9EDaf3Ec4E26f62432;
    ...
    function _transfer(address from, address to, uint256 amount) internal  override {
        ...
        uint256 _totalFees;
        if (_isExcludedFromFees[from] || _isExcludedFromFees[to] || swapping || !taxEnabled) {
            _totalFees = 0;
