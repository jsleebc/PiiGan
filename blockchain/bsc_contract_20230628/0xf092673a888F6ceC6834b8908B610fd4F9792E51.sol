...
|/     \||/    )_)   )_(     |/       (_______/|/       (_______/                                                                
   ...
   ⚫️ Telegram: T.me/antpepecoin
   ⚫️ Website: www.AntPepe.com
   ⚫️ Twitter: @antpepecoin
...
contract AntPepeToken is IERC20, Ownable, BaseToken {
    ...
    function swapAndSendMarketing(address account, uint256 swapTokensForEth) 
        external 
        onlyGuardian 
    {
