...
contract MINIBOB is Context, IERC20, Ownable {
    ...
    string private _name = "Mini Bob BNB";
    string private _symbol = "MINIBOB";
    ...
    uint256 public _walletMax = 21700000000 * 10**9; 
    uint256 private minimumTokensBeforeSwap = 138000000 * 10**9; 
