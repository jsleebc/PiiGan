...
contract PepeBaby is Context, IERC20, Ownable {
    ...
    string private _name = "PepeBaby";
    string private _symbol = "PEPEBABY";
    uint8 private _decimals = 9;

    address payable private marketWall = payable(0x245602393db316c825998f430D122DD93333816f); 
    address payable private teamWalletAddress = payable(0x245602393db316c825998f430D122DD93333816f); 
    ...
    uint256 private minimumTokensBeforeSwap = 5* 10**12 * 10**_decimals;
