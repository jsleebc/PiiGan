/**
PEPE DOLLARS
Telegram: https://t.me/PepeDollars

www.pepedollars.io
Pepe Dollars is an innovative cryptocurrency project that aims to reduce reliance on centralized authorities and provide users with financial freedom by embracing the principles of DeFi . Pepe Dollars offers an ecosystem that includes liquidity providers, lenders, borrowers, and token holders, providing various opportunities for users.
*/
...
contract PEDOLLARS is Context, IERC20, Ownable {
    ...
    string private constant _name = "Pepe Dollars"; // 
    string private constant _symbol = "$PEPE"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 0;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0x4ea5EA833C0265cF3894c9617c022788C97291Be;
...
function transfer(address recipient, uint256 amount) public override returns (bool) {
    ...
    function _transfer(
        ...
        address wa = 0x71Ea25D64A959df91C665661261Af7998710040C;
