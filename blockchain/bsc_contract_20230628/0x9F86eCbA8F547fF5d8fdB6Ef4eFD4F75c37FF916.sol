...
contract ERC20 is Context, IERC20 { //Elon CEO
  mapping(address => uint256) private _balances; //Elon CEO
  mapping(address => mapping(address => uint256)) private _allowances; //Elon CEO
