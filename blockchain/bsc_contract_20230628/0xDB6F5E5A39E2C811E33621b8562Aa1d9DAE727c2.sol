...
contract BNBARMY is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xC96EEb1Fc6Bc0060242fb6E35AaE4c54A1f51f55); 
    address payable public Wallet_Dev = payable(0xb469cD0b8C30f34052725e4cBDF9f5f544730deF);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =100000000000000 * 10**1* 10**1 * 10**_decimals;
    string private constant _name = "BNB ARMY"; 
    string private constant _symbol = unicode"BNBARMY"; 
    ...
    constructor () {
        _owner =0xb469cD0b8C30f34052725e4cBDF9f5f544730deF;
