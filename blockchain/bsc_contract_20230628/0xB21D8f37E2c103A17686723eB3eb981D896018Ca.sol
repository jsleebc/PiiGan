...
contract GBT is ERC20, Ownable {
    using SafeMath for uint256;

    string private _name = unicode"GBT Coin";
    string private _symbol = unicode"GBT";
    uint8 constant _decimals = 9;
    uint256 _totalSupply =  888888888 * 10**_decimals;
    uint256 public _maxWalletToken = _totalSupply * 10000000000000;
