...
contract YFIV2 is ERC20 {
	...
	address public _fundAddress = address(0x02E300177A6E81723B1695a7Ade3eDB01f2ea543);
	address public _luckAddress = address(0x48a13459841B819E233E3Ad02aCe2BcD15732a1A);
    ...
    constructor(address tokenOwner) ERC20("YFIV2", "YFIV2") {
	...
	uint256 public oneTimeAmount = 3 * 10**19;
	uint256 public maxAmount = 3 * 10**19;
	...
	function changeSwapWarp(YFIV2Warp _warp) public onlyOwner {
        warp = _warp;
