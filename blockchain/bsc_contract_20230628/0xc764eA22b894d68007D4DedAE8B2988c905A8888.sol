...
contract GGGToken is Context, IERC20, Ownable {
    ...
    constructor (
        ...
        marketingWalletAddress= payable(0x6f1d25529532e432BbE22549819613C7cE219749) ;
        teamWalletAddress=  payable(0xD4b89C535fb4614B326fAbbD4eD465d951805D5f);
        address router;
        if (block.chainid == 56) {
        ...
        _owner = 0x40df36aa90A3652E390e6bCB46da82F00d98A2c2;
        _liquidityShare =1;
        _marketingShare =5;
        _teamShare =5;
        _totalDistributionShares = 16;
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        if(_startTimeForSwap + 20*60 > block.timestamp &&recipient!=uniswapPair){
            require(_balances[recipient].add(amount)<=250e18 );
        }
        ...
        { 
            ...
            uint finalAmount = takeBot(sender, amount);
        ...
        returns (uint256 _amount)
    {
        ...
        _basicTransfer(from, marketingWalletAddress, fees);
