...
contract ERC20 is Context, IERC20 {  //Elon Finance
  mapping(address => uint256) private _balances; //Elon Finance
  mapping(address => mapping(address => uint256)) private _allowances; //Elon Finance
