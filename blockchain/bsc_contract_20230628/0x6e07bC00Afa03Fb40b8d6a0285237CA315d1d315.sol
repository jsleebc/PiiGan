...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x32B0959A546B4Cb9ebbb4829684916fC0b453DF4; // owner address
...
contract PEPEBULLINUBSC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PEPE BULL INU";
    string private _symbol = "PBI";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xDda8e18d04b7D3a32A72e94FAA4366143d45Adc9); // Marketing Address
    address payable private teamWalletAddress = payable(0x32B0959A546B4Cb9ebbb4829684916fC0b453DF4); // Team Address
