...
contract PEPETRUMP is ERC20, Ownable {
    ...
    uint256 private treasuryFeeOnBuy;
    uint256 private rewardsFeeOnBuy;

    uint256 public totalBuyFee;

    uint256 private liquidityFeeOnSell;
    uint256 private treasuryFeeOnSell;
    uint256 private rewardsFeeOnSell;
    ...
    constructor() payable ERC20("Pepe Trump Original", "PEPETRUMP") {
        ...
        dividendTracker = new DividendTracker(42_069_000, rewardToken);
        ...
        _mint(owner(), 420_690_000_000_000 * (10 ** 9));
