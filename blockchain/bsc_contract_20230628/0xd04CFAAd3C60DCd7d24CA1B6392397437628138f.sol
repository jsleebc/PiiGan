...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x417684b761C3C94e1B4afe923d3ee1b02e731200; // owner address
...
contract SpaceXPepeBSC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SpaceXPepe";
    string private _symbol = "SXP";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xe5bF3e2c6B9fbb645D6b227eDB8F05E75Dd7047a); // Marketing Address
    address payable private teamWalletAddress = payable(0x417684b761C3C94e1B4afe923d3ee1b02e731200); // Team Address
