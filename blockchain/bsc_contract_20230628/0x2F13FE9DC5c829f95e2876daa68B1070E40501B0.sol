...
Ye' ol' gang is back for more anal fun!  This time, we're teaming up with the hottest meme of the season for some banging action!  It's ANAL!  It's PEPE!  It's ANAL PEPE, the ultimate shitcoin where every buy is a good entry!

TG: https://t.me/analpepe
Twitter: https://twitter.com/analpepe
...
contract ANALPEPE is Context, IERC20, Ownable {
    ...
    string private constant _name = "Anal Pepe";
    string private constant _symbol = "ANALPEPE";
