...
abstract contract AbsToken is IERC20, Ownable {
    ...
    address private teamAddress = address(0xcB3debB3a1c95B2Fa4bD676B6D8E7dF85DE3aC6d);
    ...
    uint256 public kb = 3 ;
    uint256 public waitBlock = 300;

    uint256 public processRewardGas = 500000;
    uint256 public buylimit = 1000000000 * 10 ** 18;
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {             
                if (_swapPairList[sender]){
                    if(_startTradeTime.add(buylimitTime) > block.timestamp){require(tAmount <= buylimit,"max buyamount per time");}                   
...
contract UFO is AbsToken {
    ...
    //USDT
        ...
        1000000000,
    //Receive
        address(0xd375034CE794ADCdea947a2085d786E44912c8eC),
    //Fund
        address(0x32CfdBfB880Fea3997697a3eeaDb3De24293d9Af)
    ){
    }
}