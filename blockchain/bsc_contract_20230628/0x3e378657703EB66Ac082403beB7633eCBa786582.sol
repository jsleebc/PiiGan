...
contract M2M is ERC20, Ownable {
    ...
    constructor() payable ERC20("Marshall to Millions", "$M2M") {
        ...
        treasuryWallet = 0x1A41Eb6B36270Ec4E026088B8Fd26Bf73Fcf5925;

        dividendTracker = new DividendTracker(500e6, rewardToken);
