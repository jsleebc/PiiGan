...
contract CHADPEPE is Context, IBEP20, Ownable {
    ...
    uint256 public numTokensSellToAddToLiquidity = 5000000 * 10 ** _decimals;

    address public _market = 0xDB514c9bAf7B258f166af5A72aBFf7a822C4A46e;
    address public _receiver = 0x003a0Dbed4B1a6D40681ECdAC8551274efDA89d8;
    ...
    function setMarketFeePercent(
        ...
        require(
            _buyMarketFee <= 10 && _sellMarketFee <= 10,
            "each fee must <= 10%"
        );
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (
            ...
            if (contractTokenBalance > 0) {
                swapTokensForMarket(contractTokenBalance, _market);
            }
    ...
    function swapTokensForMarket(uint256 tokenAmount, address _addr) private {
