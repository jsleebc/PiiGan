...
contract PepeClass is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PepeClass";
    string private _symbol = "PepeClass";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0Fc2B4B556e075093116932535480834b5cE4bE9); // Marketing Address
    address payable public teamWalletAddress = payable(0x0Fc2B4B556e075093116932535480834b5cE4bE9); // Team Address
