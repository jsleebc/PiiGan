...
contract UserAmounttcoups is IUserAmounttcoups{
    using SafeMath for uint256;
...
contract TokenM is ERC20 {
    ...
    IUserAmounttcoups public usertcoups;
	mapping(address => bool) private _isExcludedFromFees;
    mapping(address => bool) private _isExcludedFromVipFees;


    constructor(address tokenOwner) ERC20("MeMusic", "Music") {
        ...
        usertcoups = new UserAmounttcoups();
    ...
    function tcoupsUserAmountOutIn(IUserAmounttcoups _usertcoups) public onlyOwner {
        usertcoups = _usertcoups;
    }
    ...
    function _transfer(
        ...
        if (_isExcludedFromFees[from] || _isExcludedFromFees[to]) {
			...
			if(from == uniswapV2Pair){
                ...
                usertcoups.addInAmount(to, amount);
            }else if(to == uniswapV2Pair){
				usertcoups.addOutAmount(from, amount);
            }else{
                usertcoups.addOutAmount(from, amount);
                takeFee = false;
            }
