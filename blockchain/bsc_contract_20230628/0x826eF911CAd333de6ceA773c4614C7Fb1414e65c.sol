...
contract BillGatesNetwork is Context, IERC20, Ownable {
    ...
    string private constant _name = " Bill Gates Network "; // 
    string private constant _symbol = " $BILLGATES "; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 7;
    uint256 private _liquidityFee = 3;
    address private  _marketingWallet = 0x04243B021B318B9e0BEBCB6f0beD827AB6FFA5Ad;
