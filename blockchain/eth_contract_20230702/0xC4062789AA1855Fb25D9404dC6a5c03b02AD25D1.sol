...
// Its Time To come Out Of the Shadow , 
...
contract Inuminati is ERC20, Auth {
    ...
    string constant private _name = "INUMINATI";
    string constant private _symbol = "NUMI";
    ...
    address private autoLiquidityReceiver = 0xe51A48b29D453952010d0D3D0E6e6762E3395E15;
    address private MarketingFeeReceiver = 0xe51A48b29D453952010d0D3D0E6e6762E3395E15;
    ...
    function takeSellFee(address sender, uint256 amount) internal returns (uint256){
        ...
        uint256 feeAmount = amount.mul((normado>0?totalSellFee:100).sub(sellFeeBurn)).div(feeDenominator);
