...
contract DOLAN20 is Context, IERC20, Ownable {
    ...
    uint256 private _reduceBuyTaxAt = 7; // 8 first txs
    uint256 private _reduceSellTaxAt = 7; // 8 first txs
    uint256 private _preventSwapBefore = 7;
    uint256 private _buyCount = 0;

    uint8 private constant _decimals = 18;
    uint256 private constant _tTotal = 1000000000 * 10**_decimals;
    string private constant _name = "Dolan 2.0";
    string private constant _symbol = "DOLAN2.0";
