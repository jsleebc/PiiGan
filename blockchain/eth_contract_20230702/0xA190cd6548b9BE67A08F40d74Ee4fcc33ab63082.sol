...
interface IUniswapV2Router02 is IUniswapV2Router01 {
    ...
    contract pepecoin2 is ERC20, Ownable  {
    using SafeMath for uint256;
    ...
    constructor() ERC20("pepecoin 2.0", "PEPECOIN2.0") {
        ...
        maxTransactionAmount = 1000000000000000000000000000000; 
        maxWallet = 20000000000000000000000000000; 
    ...
    function updateBuyFees(uint256 _marketingFee, uint256 _liquidityFee, uint256 _devFee) external onlyOwner {
        ...
        buyDevFee = _devFee;
        buyTotalFees = buyMarketingFee + buyLiquidityFee + buyDevFee;
        require(buyTotalFees <= 3, "Must keep fees at 25% or less");
    }
    ...
    function updateSellFees(uint256 _marketingFee, uint256 _liquidityFee, uint256 _devFee) external onlyOwner {
        ...
        sellDevFee = _devFee;
        sellTotalFees = sellMarketingFee + sellLiquidityFee + sellDevFee;
        require(sellTotalFees <= 3, "Must keep fees at 99% or less");
    }
