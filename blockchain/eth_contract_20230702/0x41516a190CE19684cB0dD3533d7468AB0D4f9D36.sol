...
🔥 https://pepemon.app/www.pepemon.app/index.html
🍃https://twitter.com/PepemonEth
...
contract PEPEMON is ERC20, Ownable {
    ...
    constructor() ERC20("PEPEMON", "PEPEMON") {
        ...
        maxTransactionAmount = 19555555555557 * 1e18; // 1% from total supply maxTransactionAmountTxn
        maxWallet = 19555555555557 * 1e18; // 2% from total supply maxWallet
		...
		charityWallet = address(0xeA3D5A88E2B6928e78bA2C79E5592a6EefE1CEd8); // 
        marketingWallet = address(0xeA3D5A88E2B6928e78bA2C79E5592a6EefE1CEd8); // 
        devWallet = address(0xeA3D5A88E2B6928e78bA2C79E5592a6EefE1CEd8); // 
