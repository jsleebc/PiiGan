...
contract QKY is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = unicode"Quicky"; 
    string private constant _symbol = unicode"QKY"; 
    ...
    address payable private _marketingWalletAddress = payable(0x257Efa2B5f6d05857C2a28242FF749758b8400d5);
