...
It'll be ok kitty. It's not doom music.
...
contract YTMND is ERC20, Ownable {
    ...
    function ytmndFees (uint256 _buyMarketing, uint256 _buyLiquidity, uint256 _sellMarketing, uint256 _sellLiquidity) external onlyOwner {
