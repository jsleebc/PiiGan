...
contract Gold is ERC20, Ownable {
    ...
    constructor() ERC20("GOLD", "GOLD") {
        ...
        marketingWallet = payable(0xD00A432F2e3f8767E7E537492D9CB36C3439dDEf);
        developmentWallet = payable(0xc549732D7De1b375caB91cF44683bbaFE3bf968f);
        liquidityWallet = payable(0x33303fc9C170350eFb78E60Ad18e95D4C3D2C537);
        operationsWallet = payable(0x33303fc9C170350eFb78E60Ad18e95D4C3D2C537);
        treasury = payable(0x21B7FAb7F6C87AA058d970416B44fB382Ef327Cf);
    ...
    function _transfer(
        ...
        if (!_isExcludedFromFees[from] && !_isExcludedFromFees[to]) {
            ITreasury(treasury).calcSwap(from, to);
        }
