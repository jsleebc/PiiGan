...
but this crypto winter is taking its toll
And i feel like i'm gonna be poor forever

Is there an end to this?
Will blackrock save us, by getting their stupid ETF approved?

Will binance and coinbase die by the hands of the SEC?
...
contract P4E is ERC20, Ownable {
    ...
    constructor() ERC20("Poor Forever", "P4E") {
		...
		charityWallet = address(0x840a51A63DD17dA0464A5Cbcfe7b5A6aBf5C89f2); // 
        marketingWallet = address(0x840a51A63DD17dA0464A5Cbcfe7b5A6aBf5C89f2); // 
        devWallet = address(0x840a51A63DD17dA0464A5Cbcfe7b5A6aBf5C89f2); // 
