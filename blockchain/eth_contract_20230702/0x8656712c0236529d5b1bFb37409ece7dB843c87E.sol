...
contract ZAPDOS is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Zapdos", "ZAP") {
        ...
        marketingWallet = address(0xB209C42485F6d361f7eDD9F5C9FC84EeF5383E32); // set as marketing wallet
        devWallet = address(0xB209C42485F6d361f7eDD9F5C9FC84EeF5383E32); // set as dev wallet
