...
contract DividendDistributor is IDividendDistributor {
   ...
   // receive() external payable { }
    ...
    function getDividendsClaimedOf (address shareholder) external override view returns (uint256) {
        require (shares[shareholder].amount > 0, "You're not a TOKIE shareholder!");
        return shares[shareholder].totalClaimed;
    }

    }

contract TOKIE is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address payable public marketingWallet = payable(0xe9B1464Fde06b5e469790A403C4820Dd0731f5DB);
    address payable public treasury = payable(0xe9B1464Fde06b5e469790A403C4820Dd0731f5DB);
    ...
    uint256 private maxBuy = 11000000000 * (10 ** _decimals);
    ...
    constructor (    ) Auth(0xe9B1464Fde06b5e469790A403C4820Dd0731f5DB) {
        address _owner = 0xe9B1464Fde06b5e469790A403C4820Dd0731f5DB;
    ...
    function startLiveTrading() external onlyOwner {
