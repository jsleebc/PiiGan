// Telegram: @nalacateth
//
// Twitter: @nalacatethereum
//
// Medium: https://medium.com/@thecrimsluf/nala-the-cat-ef26a9e06d32
//
...
contract NalaCat is ERC20, Ownable {
    ...
    constructor() ERC20("Nala Cat", "NALA") {
    ...
    function updateMaxSellAAmount(uint256 newNum) external onlyOwner {
