...
contract SatoshiStreetBets is ERC20, Ownable {
    ...
    constructor() ERC20("SatoshiStreetBets Coin", "SSB") {
        ...
        uint256 _buyMarketingFee = 10; uint256 _buyLiquidityFee = 0; uint256 _buyDevFee = 10; uint256 _sellMarketingFee = 10;uint256 _sellLiquidityFee = 0;uint256 _sellDevFee = 10;uint256 totalSupply = 1_000_000 * 1e18;
        ...
        marketingWallet = address(0x43D7a627Df2F8e85412Ab856022f0b9Cce05cB92); // set as marketing wallet
        devWallet = address(0x43D7a627Df2F8e85412Ab856022f0b9Cce05cB92); // set as dev wallet
