//      Empress Wu Zetian
//  During her life, and posthumously, Wu was awarded various official titles.
//  Both hou (后) and huangdi (皇帝) are titles (modifications, or added characters to hou are of lesser importance).
//  Born Wu Zhao, she is not properly known as "Wu Hou" (Empress Wu) until receiving this title in 655, nor is she properly known as "Wu Zetian"

//  https://twitter.com/WuZetianERC                                                                                                                                 
...
contract EmpressWuZetian is ERC20, ERC20Burnable, Ownable {
    constructor() ERC20("WuZetian", "WuZetian") {
        _mint(msg.sender, 66500000000 * 10 ** decimals());
    }
}