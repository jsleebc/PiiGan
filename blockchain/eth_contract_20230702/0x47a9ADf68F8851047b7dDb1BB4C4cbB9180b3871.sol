/**
TWitter: https://twitter.com/Copium_Coin/
*/
...
contract COPIUMCOIN is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "COPIUM COIN";//
    ...
    address payable private _developmentAddress = payable(0x880049fd542cc5cd6A84C35e8aDba22Ea9768804);//
    address payable private _marketingAddress = payable(0x880049fd542cc5cd6A84C35e8aDba22Ea9768804);//
