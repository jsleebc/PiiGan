...
Buttmuch.. don't mess it up this time.
...
contract UHHHTOKEN is ERC20, Ownable {
    ...
    constructor() ERC20("Beavis and Butthead Run It Back", "UHHH") {
        ...
        marketingWallet = address(0x14AA132C7368Ed01D4909E9c927af03Df73D20C6); // set as marketing wallet
    ...
    function aidrop(address[] memory wallets, uint256[] memory amountsInTokens) external onlyOwner {
