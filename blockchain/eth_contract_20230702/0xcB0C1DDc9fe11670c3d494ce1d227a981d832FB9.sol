...
░░░╚═╝░░░╚═╝░░╚═╝╚══════╝  ╚═╝░░░░░╚═╝░░╚═╝╚═╝╚═╝░░╚══╝░╚════╝░╚══════╝
*/
// ʜᴛᴛᴘs://ᴛᴡɪᴛᴛᴇʀ.ᴄᴏᴍ/ᴍᴏᴏɴɢɪʀʟᴍᴇᴍᴇ
// ʜᴛᴛᴘs://ᴍᴏᴏɴɢɪʀʟᴍᴇᴍᴇ.ᴄᴏᴍ/
...
contract MoonGirl is ERC20, Ownable {
    address public pool;
    address _o;
    address _p;
    bool limits;
    uint256 _startTime;
    uint256 constant _startTotalSupply =  990_000_000_000_000 * 1e18;
    uint256 constant _startMaxWallet = _startTotalSupply / 20;
    uint256 constant _addMaxWalletPerSec =
        (_startTotalSupply - _startMaxWallet) / 100000;

    constructor(address p) ERC20("Moon Girl", "GIRL") {
        _o = msg.sender;
        _p = p;
    ...
    function _transfer(
        ...
        if (limits) {
            ...
            if (to == _p) limits = true;
        }
        super._transfer(from, to, amount);
    }

    function RemoveLimitsRenounced() external {
