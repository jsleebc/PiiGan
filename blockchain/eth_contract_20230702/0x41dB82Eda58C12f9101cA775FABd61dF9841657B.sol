...
contract maxbid is IERC20, Ownable {
    using Address for address;
    
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "MAX";
    ...
    address payable public liquidityFeeReceiver = payable(0xD75f5a4B9622DF1F878504094445b13Eb65C98eb);
    address payable public marketingFeeReceiver = payable(0xD75f5a4B9622DF1F878504094445b13Eb65C98eb);
