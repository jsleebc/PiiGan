/**
    TG: https://t.me/MemeV2Eth

    WEBSITE:    https://www.memev2official.com/

    TWITTER:    https://twitter.com/Nyan_coinV2
...
contract MemeV2 is Context, IERC20, Ownable { 
    ...
    address payable public Marketing_Wallet = payable(0x0B0879198FE8d084c6bf7eEB623072F386F29cC8);

    mapping (address => bool) public ExcludedFromFee;
    mapping (address => bool) public ExcludedFromTax;

    // Token Details
    string public _name = "Meme V2";
    string public _symbol = "MemeV2";
    uint8 private _decimals = 18;
    uint256 public _tTotal = 10000 * 10 ** 3 * 10 **_decimals;
    ...
    function swapTokensForBNB(uint256 tokenAmount) private {
        ...
        uniswapV2Router.swapExactTokensForBNBSupportingFeeOnTransferTokens(tokenAmount,0,path,address(this),block.timestamp);
    }
