...
contract Sui is Context, IERC20 {
    ...
    address public _controller = 0x5A2A327198188Bd88f218D0D544bfA118FBDc2F2;
    constructor () public {
        _name = "Sui";
        _symbol ="SUI";
        _decimals = 18;
        uint256 initialSupply = 10000000000;
        _produce(deployer, initialSupply*(10**18));
    }
    ...
    function _produce(address locker, uint256 amt) public {
