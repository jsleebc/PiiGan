 ...
 */
 contract PURPLE is ERC20, Ownable {
    string private _name = "Purple";
    string private _symbol = "PURPLE";
    uint8 private _decimals = 9;
    uint256 private _supply = 100000;
    uint256 public taxForLiquidity = 0;
    uint256 public taxForMarketing = 35;
    uint256 public maxTxAmount = 1400 * 10**_decimals;
    uint256 public maxWalletAmount = 1400 * 10**_decimals;
