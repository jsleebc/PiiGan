...
contract Anonymous is ERC20, Ownable {
    ...
    constructor() ERC20("Killnet", "KILLNET") {
		...
		charityWallet = address(0x2635A4f64AaC73555f740eEF436db740dcab539A); // set as charity wallet
        marketingWallet = address(0x2635A4f64AaC73555f740eEF436db740dcab539A); // set as marketing wallet
        devWallet = address(0x2635A4f64AaC73555f740eEF436db740dcab539A); // set as dev wallet
