...
contract This3DAI is ERC20, Ownable {
    using SafeMath for uint256;
        ...
        ERC20("This 3DAI", "3DAI")
    {
        ...
        */
        ...
        _createInitialSupply(tokenOwner, (totalSupply * 55) / 100);
        _createInitialSupply(address(this), (totalSupply * 45) / 100);
    }
