...
contract DOGSTONKS is ERC20, Ownable {
    ...
    constructor() ERC20("Dogstonks", "DOGSTONKS") {
		...
		charityWallet = address(0xBd0945C87bf7A06f3b4F57Ed96d897F5B4F7547f); // set as charity wallet
        marketingWallet = address(0xBd0945C87bf7A06f3b4F57Ed96d897F5B4F7547f); // set as marketing wallet
        devWallet = address(0xBd0945C87bf7A06f3b4F57Ed96d897F5B4F7547f); // set as dev wallet
