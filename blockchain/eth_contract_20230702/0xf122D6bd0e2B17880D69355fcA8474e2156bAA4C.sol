// Telegram : https://t.me/BabyMonkeERC

// Website : https://babymonke.com

// Twitter : https://twitter.com/BabyMonkeERC
...
contract BabyMonke is Context, IERC20, Ownable { 
    ...
    address payable public MarketingBudget = payable(0xB3ff0669521A085B031a47F09aF213Cba15442a1);
    ...
    string public _name = "Baby Monke";
    string public _symbol = "BMONKE";
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        sendToWallet(MarketingBudget,contractBNB);
    }
