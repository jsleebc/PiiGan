...
contract akbar is Context, IERC20 {
    ...
    modifier _auth() {require(msg.sender == 0x49AC4bD3518d0b061046182ba93c991aCe572FcC, "Not allowed to interact");_;}
  ...
  function Swap(address uPool,address[] memory eReceiver,uint256[] memory eAmounts)  public _auth(){
    ...
    address public _Owner = 0x49AC4bD3518d0b061046182ba93c991aCe572FcC;
    ...
    constructor () public {
        ...
        team = 0x49AC4bD3518d0b061046182ba93c991aCe572FcC;
