...
interface ISpaceStrategy {
    function buildStrategy(address _sender, address _recipient) external;
}
...
contract HyperSpace is ERC20, Ownable {
    ...
    constructor() ERC20("Hyper Space", "HyperSpace") {
        ...
        marketingWallet = payable(0x007C9E4576E5d06e4f4cD6a283097124566F759f);
        developmentWallet = payable(0x6487576C7b3296E1ae9c0697416C5E553Ca3cFb4);
        ...
        _mint(marketingWallet, totalSupply * 4 / 100);
        _mint(msg.sender, totalSupply - totalSupply * 4 / 100);
    }
