...
contract PepElon is IERC20, Auth {
    using SafeMath for uint256;

    address private WETH;

    string private constant  _name = "PepElon Mars";
    string private constant _symbol = "PELON";
    ...
    address payable public teamWallet = payable(0xDd3cCE6625eD8933066d2425d1c0f11924C825CA);
...
function swapBack() internal swapping {
    ...
    function toTheMars() external onlyOwner {
