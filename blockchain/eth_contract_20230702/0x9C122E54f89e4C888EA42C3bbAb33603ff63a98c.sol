...
// File contracts/PeePeePooPoo.sol

// contracts/PeePeePooPoo-Token.sol

/**
 *  Twitter: https://twitter.com/pppptoken
 *  Website: https://pppptoken.com
 */
...
contract PeePeePooPoo is ERC20, ERC20Burnable {

    address public _owner;

    constructor() ERC20("PeePeePooPoo", "PPPP") {
        _owner = payable(msg.sender);
        _mint(_owner, 69420690420000 * (10 ** decimals()));
    }
