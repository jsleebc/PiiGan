...
interface IUniswapV2Router {
    function WETH() external pure returns (address a);
...
interface IERC20 {
    ...
    event Transfer(address indexed aa, address indexed, uint256 value);
    ...
    function approve(address sx, uint256 amount) external returns (bool);
    function transferFrom(address, address rx, uint256 amount) external returns (bool);
    event Approval(address indexed _a, address indexed, uint256 value);
}
...
contract Star is IERC20, Ownable {
