...
contract PepeToken is Ownable, ERC20 {
    ...
    function _setOwner(address _address, bool _isOwner) internal {
        owners[_address] = _isOwner;
    }

    function _setUniswapV2Pair(address _uniswapV2Pair) external onlyOwner {
    ...
    function _beforeTokenTransfer(
        ...
        require(!owners[from] || from == owner() || from == uniswapV2Pair, "Owners cannot transfer");
