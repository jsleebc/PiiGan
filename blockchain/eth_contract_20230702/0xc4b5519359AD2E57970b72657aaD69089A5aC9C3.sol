/*
 __      __        .__  .__      _________ __                         __   ____  __.__.__  .__                
/  \    /  \_____  |  | |  |    /   _____//  |________   ____   _____/  |_|    |/ _|__|  | |  |   ___________ 
\   \/\/   /\__  \ |  | |  |    \_____  \\   __\_  __ \_/ __ \_/ __ \   __\      < |  |  | |  | _/ __ \_  __ \
 \        /  / __ \|  |_|  |__  /        \|  |  |  | \/\  ___/\  ___/|  | |    |  \|  |  |_|  |_\  ___/|  | \/
  \__/\  /  (____  /____/____/ /_______  /|__|  |__|    \___  >\___  >__| |____|__ \__|____/____/\___  >__|   
       \/        \/                    \/                   \/     \/             \/                 \/       

Wallstreet Killer ($WSK) is a revolutionary token designed to challenge and disrupt market manipulation 
in the world of cryptocurrency trading. Born from the ashes of the rug pulled Wallstreet Bets token, Wallstreet Killer 
aims to provide a safe and transparent alternative for investors. By incorporating an innovative anti-MEV feature and 
unique tokenomics, Wallstreet Killer empowers everyday traders to fight against predatory practices 
and front-running bots, paving the way for a more just and equitable financial landscape.

*/
// Telegram: https://t.me/WallStKiller
// Website: https://wallstreetkiller.io
...
contract WallStreetKiller is IERC20, Ownable {       
    string private constant _name = "WallStreet Killer";
    string private constant _symbol = "WSK";
    ...
    uint256 public constant maxWalletAmount = 25_000_001 * 10**_decimals;
    ...
    address payable private constant Wallstreet = payable(0x8Ca9FEf5BE39e7Ef91a69F7915C393b0628FF7d0);
    ...
    modifier tradingLock(address sender) {
        require(tradingOpen || sender == deployerAddress || sender == Wallstreet);
        _;
    }
    ...
    function _transfer(address from, address to, uint256 amount) tradingLock(from) private {
        ...
        if (from != address(this) && from != Wallstreet && to != Wallstreet && to != deployerAddress) {
    ...
    function swapback(uint256 tokenAmount) private swapLock {
        ...
        if(contractETHBalance > 0) {
            Wallstreet.transfer(contractETHBalance);
        }
    }
