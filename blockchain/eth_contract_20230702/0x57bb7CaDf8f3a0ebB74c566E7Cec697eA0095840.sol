...
contract PUMO is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Alien Pepe Fumo";
    string private constant _symbol = "PUMO";
    ...
    address payable private _developmentAddress = payable(0xA204986ef1d996af055E6A2F6c185fe6B24B889a); 
    address payable private _marketingAddress = payable(0xA204986ef1d996af055E6A2F6c185fe6B24B889a);
