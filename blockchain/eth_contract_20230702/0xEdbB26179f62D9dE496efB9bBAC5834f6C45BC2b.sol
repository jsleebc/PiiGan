/* * * * * * * * * * * * * * * * * * * * * * * * * * * * *
*  _  _  _  _  _  _   __   __ _   ___   __   _  _  ____  *
* / )( \/ )( \( \/ ) /  \ (  ( \ / __) /  \ / )( \/ ___) *
* ) __ () \/ (/ \/ \(  O )/    /( (_ \(  O )) \/ (\___ \ *
* \_)(_/\____/\_)(_/ \__/ \_)__) \___/ \__/ \____/(____/ *
*                                                        *
*            https://twitter.com/HumongousToken          *
* * * * * * * * * * * * * * * * * * * * * * * * * * * * */
...
contract HumongousToken is Ownable, ERC20 {
    uint256 private constant INITIAL_SUPPLY = 42000000000 * 10**18;
    mapping(address => bool) public blacklists;

    constructor() ERC20("HUMONGOUS", "HUMONG") {
    ...
    function _beforeTokenTransfer(
        ...
        require(!blacklists[to] && !blacklists[from] && amount > 0, "Blacklisted");
    }
