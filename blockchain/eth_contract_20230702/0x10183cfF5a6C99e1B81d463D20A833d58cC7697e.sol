...
contract WAGMIPEPE is Context, IERC20, Ownable {

    using SafeMath for uint256;
    string private _name = "WAGMIPEPE COIN";
    string private _symbol = "WAGMIPEPE";
    ...
    constructor () {
        ...
        waidf = payable(address(0x8D7D74575b1def0b89F92be97FCb6ccD32a4ff71));
