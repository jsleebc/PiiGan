...
contract OxNft is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"0xNft";
    string private constant _symbol = unicode"NFT";
