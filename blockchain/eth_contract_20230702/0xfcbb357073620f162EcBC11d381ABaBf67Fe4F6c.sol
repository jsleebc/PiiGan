...
contract shib3 is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "SHIB3.0";
    ...
    address payable private _developmentAddress = payable(0x1538639af4f2E7e2C81BB7C1BC543c71B602a5Ff);
    address payable private _marketingAddress = payable(0x1538639af4f2E7e2C81BB7C1BC543c71B602a5Ff);
