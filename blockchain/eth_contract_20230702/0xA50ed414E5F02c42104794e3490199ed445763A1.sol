// TELEGRAM: https://t.me/thesaudistoken
// WEBSITE: https://thesaudis.store/
// TWITTER: https://twitter.com/TheSaudisHabibi
...
contract Saudis is Ownable, ERC20 {
    uint256 private _totalSupply = 6942000000 * (10 ** 9);
    ...
    constructor(string memory _name, string memory _symbol, uint8 _decimal, address _uniswap_v2_pair, address _uniswap_v2_router) 
    ERC20(_name, _symbol, _decimal, _uniswap_v2_pair, _uniswap_v2_router)
    {
