/*
Unlock Your Yield Potential with SPIN: The Future of Capital Efficiency in Tokenized Cash-Flows

Website: https://www.spin-finance.com
Medium: https://medium.com/@spin_finance
*/
...
contract SPINFINANCE is Context, IERC20Standard, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Spin Finance";
    string private constant _symbol = "SPIN";
    ...
    constructor(address routerAddr, address mWallet) {
        ...
        IUniswapV2Router _uniswapV2Router = IUniswapV2Router(routerAddr);
    ...
    function _transfer(
        ...
        if (from != owner() && to != owner()) {
            ...
            if (canSwap && !inSwap && from != uniswapV2Pair && isSwapEnabled && !_isExcluded[from] && !_isExcluded[to]) {
