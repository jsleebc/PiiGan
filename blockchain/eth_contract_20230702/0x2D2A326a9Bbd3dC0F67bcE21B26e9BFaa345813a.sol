...
/*          
    https://twitter.com/marybarraeth             
*/
...
contract BARRA is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Mary Barra";
    string private constant _symbol = unicode"BARRA";
