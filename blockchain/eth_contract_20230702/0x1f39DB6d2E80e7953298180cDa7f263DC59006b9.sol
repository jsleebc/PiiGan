...
contract BCHOW is IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = 'BABY CHOW CHOW';
    string private constant _symbol = 'BCHOW';
    ...
    address internal constant development_receiver = 0xd72Dda7Ae919C25F1f4A847D1Ff5DE1fAA751d8D; 
    address internal constant marketing_receiver = 0xd72Dda7Ae919C25F1f4A847D1Ff5DE1fAA751d8D;
    address internal constant liquidity_receiver = 0xd72Dda7Ae919C25F1f4A847D1Ff5DE1fAA751d8D;

    constructor() Ownable(msg.sender) {
        IRouter _router = IRouter(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D); //ethereum router
