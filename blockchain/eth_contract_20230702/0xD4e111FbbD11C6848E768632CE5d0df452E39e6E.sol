...
contract TaKuRY is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"TaKuRY";
    string private constant _symbol = unicode"TaKuRY";
    uint256 public _maxTxAmount =   18500000000 * 10**_decimals;
    uint256 public _maxWalletSize = 18500000000 * 10**_decimals;
