...
Welcome to WallStreetGang a fully decentralized Meme token developing multiply utility’s.
We are aiming to make a GANG to attack the whole Wallstreet Lets join forces and get ready
 to show that Wall Street Gang is coming to be a key player on the top of the foodchain! 

-----------use low slippage it's 0 tax after the first 50 TXNs-----------------

 * Telegram -  https://twitter.com/WallStreetGang_
...
contract WSG is Context, IERC20, Ownable {
    ...
    string private constant _name = "Wall Street Gang";
