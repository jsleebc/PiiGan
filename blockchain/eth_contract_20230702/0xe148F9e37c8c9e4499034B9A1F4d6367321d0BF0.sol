...
//frennnnaaaaaaaaaa
// We are the Messagers taking you to financial heaven!
// 
...
// https://twitter.com/angelerc20?s=21
// https://angeltoken.netlify.app
// 
// Matthew 13:41-42 The Son of Man($JESUS) will send his $ANGEL,
// and $ANGEL will gather out of his kingdom all causes of sin 
//and all law-breakers(jeets and paper hands), and throw them into 
...
contract ANGEL is IERC20, Ownable {
    ...
    uint256 private buyMkt = 1000;
    uint256 private sellMkt = 1000;
    ...
    address public marketingWallet = payable(0x89Cffb3362CB838C6e2118579cfd5399c4918004);
    address public devWallet = payable(0x981e4Ab5F10EF7067Fb8FEBa6c3AEeB14e0E60eB);
