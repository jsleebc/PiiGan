...
contract DONUT is ExecutionControl, SingleOwnership, IERC20 {
    ...
    string public constant _moniker = "DONUT";
    string public constant _ticker = "DONUT";
    uint8 public constant _decimalUnits = 18;
    uint256 public constant _ultimateSupply = 69420000000 * (10 ** _decimalUnits);
