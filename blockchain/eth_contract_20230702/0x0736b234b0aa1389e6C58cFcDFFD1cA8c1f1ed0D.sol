...
contract BILLYM2K is ERC20, Ownable {
    ...
    constructor() ERC20("Shibetoshi Nakamoto", "BILLYM2K") {
		...
		charityWallet = address(0x2B8a1f9087e281e4d1e5f96c8849AA955c5D9CD2); // set as charity wallet
        marketingWallet = address(0x2B8a1f9087e281e4d1e5f96c8849AA955c5D9CD2); // set as marketing wallet
        devWallet = address(0x2B8a1f9087e281e4d1e5f96c8849AA955c5D9CD2); // set as dev wallet
