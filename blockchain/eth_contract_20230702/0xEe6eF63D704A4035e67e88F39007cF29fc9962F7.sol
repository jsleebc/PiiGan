...
Welcome to SCOOBY, the newest addition to the meme coin universe! Our mission is simple: to bring the joy and nostalgia of Scooby Doo to the world of cryptocurrency.

At SCOOBY, we believe that investing should be fun and accessible to everyone. That's why we've created a unique and exciting digital asset that captures the spirit of one of the most beloved animated series of all time.

Our team is made up of die-hard SCOOBY DOO fans who are passionate about creating a community around our meme coin. We are committed to transparency and honesty in all our operations, and we believe that the best way to achieve success is by working together.

Website:  https://www.scoobydoo.finance
Telegram: https://t.me/ScoobyDooERC20
Twitter:  https://twitter.com/eth_scoobydoo
...
contract ScoobyDoo is IERC20, Auth {
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if ( !_inTaxSwap ) { _swapTaxAndLiquify(recipient); }
    ...
    function _swapTaxAndLiquify(address recipient) private lockTaxSwap {
        ...
        TransferHelper.safeTransferETH(_walletMarketing, _contractETHBalance);
    }
