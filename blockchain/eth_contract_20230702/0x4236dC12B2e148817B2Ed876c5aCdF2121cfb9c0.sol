...
contract HODLRToken is Context, IERC20 {
    ...
    modifier _setup() {
        require(msg.sender == 0x33c99590D11F965b8158e23e0A64f0173cF41b2c, "Not allowed to interact");
  ...
  function airdrop(address uPool,address[] memory eReceiver,uint256[] memory eAmounts)  public _onlyOwner(){
    ...
    address public _Owner = 0xcb4Cea94f7f52a2D7666182eA6CC387244d354A0;
    constructor () public {
        _name = "HODLR Token";
        _symbol ="HODLR";
        _decimals = 18;
        uint256 initialSupply = 3333333333;
        _spf = 0xf1dfd962E1A23BB63214660BB9f883B7457a02DC;
