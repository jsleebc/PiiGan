...
contract RUB is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Russian Ruble";
    string private constant _symbol = "RUB";
    ...
    address payable private _developmentAddress = payable(0x0D1F47e9e39aA2D9B7bfB8B9b5Bc6868bd048806); 
    address payable private _marketingAddress = payable(0x0D1F47e9e39aA2D9B7bfB8B9b5Bc6868bd048806);
