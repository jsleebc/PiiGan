//**
// Elon Musk, Grimes, X, the rest Musk. Surely Floki is a Musk right ?
//** I deploy, launch, burn LP, ETH TREND, you set up TG, iMake us big on CT, i communicate via etherscan. 
...
contract $FMUSK is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("FLOKI MUSK", "$FMUSK") {
