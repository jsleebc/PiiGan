/**
Barry Wood - $WOOD. 0/0 tax.

In memory of one of the most notorious meme-stars of all time. 
...
contract WOOD is ERC20, Ownable {
    ...
    constructor() ERC20("Barry Wood", "WOOD") {
        ...
        marketingWallet = address(0xFAB6971C1D85132262C3163b91A5bed2f44dcd1e); // set as marketing wallet
        devWallet = address(0xFAB6971C1D85132262C3163b91A5bed2f44dcd1e); // set as dev wallet
