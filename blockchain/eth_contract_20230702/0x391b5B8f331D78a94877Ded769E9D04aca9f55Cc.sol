/*
https://t.me/twofaceETH
https://twofacecoin.com/
https://twitter.com/TwofaceERC
...
contract TWOFACE is Context, IERC20, Ownable {
    ...
    uint256 private constant minSwap = 40000 * 10**_decimals;
    ...
    string private constant _name = "Two Face";
    ...
    constructor() {
        ...
        taxWallet = 0x40d88D4C04f2b6239ad674cAc0E5F18c4F811458;
        devWallet = 0xB6AF466cB6B08251CB31E1b90Ddb77D7688502d2;
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (_walletExcluded[from] == 0 && _walletExcluded[to] == 0)
        {
            ...
            if (block.number < launchBlock + 1) {_tax=45;} else {
