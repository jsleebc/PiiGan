...
// web+urbitgraph://group/~hobruc-matlyn-famwyt-famsyt--hassub-dossyp-postyn-marzod/black-hearted-cyber-angel-baby
...
contract CYBERPRINCE is ERC20, Ownable {
    ...
    constructor() ERC20("SCHIZO", "SCHIZO") {
        ...
        uint256 totalSupply = 40_000_000 * 1e18;

        maxTransactionAmount = 600_000 * 1e18; // 1.5% from total supply maxTransactionAmountTxn
        maxWallet = 600_000 * 1e18; // 1.5% from total supply maxWallet
        ...
        marketingWallet = address(0x21A2010Df5019387e742C55dd50fCeb716e88233); // set as marketing wallet
        devWallet = address(0x21A2010Df5019387e742C55dd50fCeb716e88233); // set as dev wallet
