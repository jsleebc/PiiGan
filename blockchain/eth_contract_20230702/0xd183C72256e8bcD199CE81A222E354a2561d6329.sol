...
contract BuffedPepe is ERC20, Ownable {
    ...
    constructor() ERC20("Buffed Pepe", "BPEPE") {
        ...
        marketingWallet = address(0xfb4fF95eEbAfDc30fc8c229df73967CFC9653C01); // Buffed Pepe
        devWallet = address(owner()); // Buffed Pepe
