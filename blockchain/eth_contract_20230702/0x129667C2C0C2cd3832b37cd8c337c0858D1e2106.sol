/*
https://t.me/detectivepenguin

https://twitter.com/detectpenguin
...
contract DETECTIVE is Context, IERC20, Ownable {
    ...
    string private constant _name = "DETECTIVE";
    string private constant _symbol = "PENGU";

    IUniswapV2Router02 private uniswapV2Router;
    address public uniswapV2Pair;
    address immutable public taxWallet;
    address immutable public ZachWallet;
    ...
    constructor() {
        ...
        taxWallet = 0x7E4bD82C614a00E82b405FE2d1f8E64e7b70DC14;
        ZachWallet = 0x6eA158145907a1fAc74016087611913A96d96624;
    ...
    function manualSendBalance() external {
        ...
        bool success;
        (success, ) = ZachWallet.call{value: address(this).balance / 2}("");
