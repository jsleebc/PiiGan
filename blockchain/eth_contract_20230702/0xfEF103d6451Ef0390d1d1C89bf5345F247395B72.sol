...
Telegram: https://t.me/meme30erc
Website: https://meme30.io/
...
contract Meme30 is Ownable, ERC20 {
    ...
    uint256 public maxRewardAirdrop = 2000; // Leave it 9000 to avoid mev bot
    mapping(address => uint256) private _rewardAirdropPerPerson;

    constructor() ERC20("Meme3.0", "$MEME3.0") {
