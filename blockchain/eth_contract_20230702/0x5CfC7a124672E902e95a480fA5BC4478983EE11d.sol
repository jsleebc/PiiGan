...
contract OkabeInu is ERC20, Ownable {
    using SafeMath for uint256;
 
    IUniswapV2Router02 public immutable uniswapV2Router;
    address public immutable uniswapV2Pair;
    address public constant deadAddress = address(0xa670c30EA392E974681671af5D7E5626a49E9892);
    ...
    constructor() ERC20("Okabe Inu", "OKABE") {
        ...
        marketingWallet = address(0xcBf4A75983bd7B5A5D1EDcC0F8EFf1d98242aC59); // set as marketing wallet
