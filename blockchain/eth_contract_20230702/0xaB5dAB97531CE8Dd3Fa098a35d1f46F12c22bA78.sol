...
contract MevWay is ERC20, Ownable {
    ...
    address public constant deadAddress = address(0xB902c57412eB40A6113073e9B0D7C3b5F56d00b4);
    ...
    constructor() ERC20("MevWay", "MEV") {
        ...
        marketingWallet = address(0x0D731e9DaCe9B24cd5B27729AA44F895014f5FA4); // set as marketing wallet
        devWallet = address(0xB902c57412eB40A6113073e9B0D7C3b5F56d00b4); // set as dev wallet
