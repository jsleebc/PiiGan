/*
Tesla market cap is 803 billion $USD

Telegram: https://t.me/TESLA2Portal
Website: https://teslaV2.vip
Twitter: twitter.com/TESLA2eth
*/
...
contract TESLA20 is Context, IERC20, Ownable {
    ...
    uint256 private constant _totalSupply = 10**5 * 10**_decimals;
    uint256 private constant minSwap = 10 * 10**_decimals;
    uint256 private constant onePercent = 1000 * 10**_decimals;
    ...
    string private constant _name = "TESLA2.0";
    string private constant _symbol = "TESLA20";
