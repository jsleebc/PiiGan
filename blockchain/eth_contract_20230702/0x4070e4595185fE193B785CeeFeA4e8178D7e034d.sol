/*
Civil war about to break-out in Russia. While we enjoy this with popcorn in our hands, let's make some degen bets.

Telegram: https://t.me/prigozhinerc20
...
contract PRIGOZHIN is IERC20, Ownable {
    ...
    string private _name = "Russia Coup D'Etat";
    string private _symbol = "PRIGOZHIN";
    uint8 private _decimals = 18;

    uint private buyFee = 20; // Default, %
    uint private sellFee = 24; // Default, %
    address public marketWallet = 0x7F9049A667a1807Dfb50932F1B8982169a411804; // Marketing Wallet
