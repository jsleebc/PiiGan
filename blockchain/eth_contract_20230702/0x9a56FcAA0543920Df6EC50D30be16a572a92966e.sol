...
contract SHIBAISM  is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Shibaism", "SHIBAISM") {
        ...
        marketingWallet = address(0xD211f9313FA4b12640efe7e5d1E1A238F3364f04);
        devWallet = address(0xD211f9313FA4b12640efe7e5d1E1A238F3364f04);
