/*
https://twitter.com/PrintTheFour
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    address public immutable FOUR = address(0x244b797d622D4DEe8b188b03546ACAAbD0Cf91A0); //UNI
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            shares[shareholder].totalExcluded = getCumulativeDividends(shares[shareholder].amount);
            IERC20(FOUR).transfer(shareholder, amount);
        }
    }
...
contract PrintTheFour is IERC20, Auth {
    using SafeMath for uint256;
    ...
    string private constant  _name = "Print The Four";
    string private constant _symbol = "PTF";
    uint8 private constant _decimals = 9;

    uint256 private _totalSupply = 444444444 * (10 ** _decimals);
    ...
    address payable public marketingWallet = payable(0x30609a85D673290AFbD75693594e5008f65297Ae);
    ...
    function swapBack() internal swapping {
        ...
        swapTokensForFOUR(amountToSwap.div(2));

        uint256 dividends = IERC20(FOUR).balanceOf(address(this));

        bool success = IERC20(FOUR).transfer(address(distributor), dividends);
    ...
    function swapTokensForFOUR(uint256 tokenAmount) private {
    ...
    function setFee (uint256 _fee) external onlyOwner {
        require (_fee <= 4, "Fee can't exceed 4%");
        totalFee = _fee;
    }
