...
contract PepeMoneyMeme is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"PepeMoneyMeme";
    string private constant _symbol = unicode"PEPEMM";
