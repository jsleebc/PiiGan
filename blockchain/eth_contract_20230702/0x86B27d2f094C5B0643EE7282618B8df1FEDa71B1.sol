/**
PEPEE COIN - $PEPPE
Peppe is actually the brainchild of Pepe and Peppa, the quintessential combination of coins that make up the memecoin season.

Website: https://peppecoin.com/
Telegram: https://t.me/peppe_portal
Twitter: https://twitter.com/peppe_erc
...
contract Peppe is ERC20, Ownable {
    using SafeMath for uint256;

    IUniswapV2Router02 public immutable uniswapV2Router;
    address public immutable uniswapV2Pair;

    string private constant _name = "Peppe";
    string private constant _symbol = "PEPPE";
    ...
    function setBuyFees(uint256 _buyMarketingFee, uint256 _buyLiquidityFee) external onlyOwner {
    ...
    function setSellFees(uint256 _sellMarketingFee, uint256 _sellLiquidityFee) external onlyOwner {
