...
contract Woof is ERC20, Ownable {
    ...
    constructor() ERC20("Woof", "WOOF") {
        ...
        devWallet = address(0x6728CDa6ce34fcA0d78DE2F6440176C985ca6667); // set as dev wallet
        marketingWallet = address(0x2E02645417CE323C4ADce8B0D159DdCe2db10C6f); // set as marketing wallet
