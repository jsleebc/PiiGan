...
$FEAR can be your greatest ally or your worst enemy, for in the world of the unknown, $FEAR is the only constant.

NO TAX

tg: https://t.me/FearERC20
tw: https://twitter.com/FearERC20
web: https://fear.pics
...
contract Fear {
    ...
    string public constant name = "Fear";   
    string public constant symbol = "FEAR";   
    ...
    address payable constant deployer = payable(address(0xAA2140135d7B799717CFDDC05F9C7ECd25127c21));
