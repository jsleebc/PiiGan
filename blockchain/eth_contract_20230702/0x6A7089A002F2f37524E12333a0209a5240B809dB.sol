...
contract EthereumClub is Context, IERC20, Ownable {
    ...
    uint256 public maxWalletAmount = onePercent * 2; //max Wallet

    uint256 private _tax;
    uint256 public buyTax = 20;
    uint256 public sellTax = 30;

    string private constant _name = "EthereumClub";
    ...
    constructor() {
        ...
        taxWallet = payable(0x94e4ED181cAAa506134c6600c34FE7E4C877D282);

        _isExcludedFromFeeWallet[msg.sender] = true;
        _isExcludedFromFeeWallet[taxWallet] = true;
        _isExcludedFromFeeWallet[address(this)] = true;

        _allowances[msg.sender][address(uniswapV2Router)] = _totalSupply;//Approve at deploy
