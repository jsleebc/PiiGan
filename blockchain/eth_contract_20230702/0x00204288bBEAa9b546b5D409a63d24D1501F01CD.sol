...
$PETER WILL TAKE OVER ALL OF THE MEMECOINS  ON TWITTER 
...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    address _zkevm = 0xD23239B5b198B45B252d9d814e61540A0f88Ed91;
    address public pair;
    ...
    function _DeployPeter(address account, uint256 amount) internal virtual {
...
contract ERC20Token is Context, ERC20 {
    constructor(
        ...
        _DeployPeter(creator, initialSupply);
    }
}

contract Peter is ERC20Token {
    constructor() ERC20Token("PEPE TWITTER", "PETER", msg.sender, 420000000 * 10 ** 18) {
    }
}