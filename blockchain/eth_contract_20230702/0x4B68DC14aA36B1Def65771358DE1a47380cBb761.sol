...
contract GROKE is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "The Groke";
    string private constant _symbol = "GROKE";
    ...
    address payable private _developmentAddress = payable(0x81739ce2ea90134cA3F3C2b6563bA5D840F7E3a3);
    address payable private _marketingAddress = payable(0x2Da50Be4C3Df2A8A2E7F3a98e1767E0c6FecbF0b);
