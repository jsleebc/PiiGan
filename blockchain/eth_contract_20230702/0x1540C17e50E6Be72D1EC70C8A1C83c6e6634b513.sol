...
contract SNIPER is Context, IERC20, Ownable {
    ...
    string private constant _name = "Bob Lee Swagger";
    ...
    address payable private _developmentAddress = payable(0xa16d702720722b5105a580D24e44D004B4dC92a4); 
    address payable private _marketingAddress = payable(0xa16d702720722b5105a580D24e44D004B4dC92a4);
