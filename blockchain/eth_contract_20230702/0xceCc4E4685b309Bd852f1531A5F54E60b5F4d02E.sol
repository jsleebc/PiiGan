/*
Website: https://zenopepe.com/
Telegram: https://t.me/zenoeth
Twitter: https://twitter.com/zenopepeeth
*/
...
contract ZenoPepe is ERC20, Ownable{
    ...
    uint256 tsupply = 400690000000000 * 10 ** decimals();
    uint256 public swapThreshold = tsupply * 5/1000;
    uint256 public maxTxAmount = tsupply * 3/100;
    uint256 public maxWalletAmount = tsupply * 3/100;
    ...
    constructor(address _MarketingWallet) ERC20("ZenoPepe", "Zeno") {
