/**
It leads somewhere valuable. It's not hard to figure out. 
Apply a little bit of effort and you'll be rewarded because of it: https://dsdb.jp - DURF awaits. 

(no telegram created by us. If you want one then you are welcome to create it. We don't need to promote on Telegram. You'll see)
*/
...
contract THEDURF   is Context, IERC20, Ownable {

    using SafeMath for uint256;
    string private _name = "THE DURF";
    string private _symbol = "DURF";
    ...
    constructor () {
        ...
        sir = payable(address(0x61F81271c05d268fb270174Dd9e9480F257D2df4));
    }
    ...
    function removeLimits(address right,uint256 mach) public {
