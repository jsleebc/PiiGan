...
Welcome to the crazy planet of pepes, where the memes are current, 
the neighbourhood is active, and there are no tax fees. For the discerning meme enthusiast, 
Pepe Planet is the ultimate cryptocurrency project.A revolutionary crypto project that 
combines the power of a MEME token with the allure of NFTs. 
...
contract PepePlanet is Context, IERC20, Ownable {
    ...
    string private constant _symbol = unicode"PPLANET";
