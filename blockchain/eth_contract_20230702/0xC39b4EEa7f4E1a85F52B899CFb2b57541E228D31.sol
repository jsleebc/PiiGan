...
// https://twitter.com/PEPENATION_ERC
// https://www.pepe-nation.com
...
contract PepeNation {
    ...
    string public constant name = "PepeNation";   
    string public constant symbol = "PEPENATION";   
    ...
    address payable constant deployer = payable(address(0x90649B92ba9dc2866D7DF273ab184c6f4de4dbdC));
