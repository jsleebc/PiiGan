...
contract GONDOLA is ERC20, Ownable{
    ...
    address public marketingWallet = 0x140f6d9d695654CF9E66249FE5Ac913A4DFF2A32;
    address private EcoWallet = 0x140f6d9d695654CF9E66249FE5Ac913A4DFF2A32;
    ...
    function GondolaBuyFee (uint256 _marketing, uint256 _liquidity, uint256 _dev) external onlyOwner{
        taxes = Taxes(_marketing, _liquidity, _dev);
        totTax = _marketing + _liquidity + _dev;
    }

    function GondolaSellFee (uint256 _marketing, uint256 _liquidity, uint256 _dev) external onlyOwner{
