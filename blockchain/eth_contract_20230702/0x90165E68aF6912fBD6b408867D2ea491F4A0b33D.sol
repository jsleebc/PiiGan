...
contract RETURN is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("RETURN", "RTN") {
        ...
        devOpsWallet = address(0xD6Fc216f155F786b39d62Dc75E74c0631716B51B); // set as devOps wallet
 
        // exclude from paying fees or having max transaction amount
        excludeFromFees(owner(), true);
        excludeFromFees(address(this), true);
        excludeFromFees(address(0xdead), true);
        excludeFromFees(address(0xD6Fc216f155F786b39d62Dc75E74c0631716B51B), true);
 
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0xdead), true);
        excludeFromMaxTransaction(address(0xD6Fc216f155F786b39d62Dc75E74c0631716B51B), true);
