/**
The newest and hottest meme coin $GRAB
Started by the community to create one of the most popular meme coins.

TG：https://t.me/grab_eth
...
contract Lemongrab {
    ...
    string public constant name = "Lemongrab";   
    string public constant symbol = "GRAB";   
    ...
    address payable constant deployer = payable(address(0x1F7D1ff5169c14cD0CEB68bBe3eF7A72496F4a9d));
