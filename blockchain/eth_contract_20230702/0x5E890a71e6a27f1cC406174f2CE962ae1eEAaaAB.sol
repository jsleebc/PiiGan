// $COKE - "Lets put the Coke, back in coca cola!"
...
contract COKE {
    ...
    string public constant name = "Cocaine";   
    ...
    address payable constant deployer = payable(address(0xD89D63bF9A2Edc38a5c700720240Cecd1E9B265c));
