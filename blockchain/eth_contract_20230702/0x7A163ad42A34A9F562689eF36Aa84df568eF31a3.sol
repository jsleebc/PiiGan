...
|  ___(_)          |  __ \                  |  __ \              | |          
| |_   _ _ __ ___  | |  \/ __ _ _ __ _   _  | |  \/ ___ _ __  ___| | ___ _ __ 
|  _| | | '__/ _ \ | | __ / _` | '__| | | | | | __ / _ \ '_ \/ __| |/ _ \ '__|
| |   | | | |  __/ | |_\ \ (_| | |  | |_| | | |_\ \  __/ | | \__ \ |  __/ |   
\_|   |_|_|  \___|  \____/\__,_|_|   \__, |  \____/\___|_| |_|___/_|\___|_|   
                                      __/ |                                   
                                     |___/                                    

Fire Gary Gensler $FGGHARD

Telegram: https://t.me/FGGHARD
Twitter: https://twitter.com/FGGHARD   
...
contract FGGHARD is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "FGGHARD";
    uint8 private constant _decimals = 9;
    
    address payable private _appAddress = payable(0x74df00caf9d8e8269F428d97B544ad3AA41de9De);
    address payable private _marketingAddress = payable(0xeA2eB0446732baf54beC46126Efc1455dc20a66f);
    address payable private _buybackAddress = payable(0xc4a5789FE79fCb13876f0E93B36eD8439623345B);
    address payable private _burnAddress = payable(0xA8C28AeF66cD04C123eC78Bc68016D8Eff40125A);
