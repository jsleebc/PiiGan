...
contract YINYANG is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"陰陽";
    ...
    address payable private _developmentAddress = payable(0xcb305993100cbAFaBc8b53873b1e6730e8E67Aaf); 
    address payable private _marketingAddress = payable(0xcb305993100cbAFaBc8b53873b1e6730e8E67Aaf);
