...
//TELEGRAM https://t.me/PHYSICALERC
...
contract Physical is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Physical";
    string private _symbol = "$PHYSICAL";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xbB0f25606b3837081FF5A6D942c6eE9786895130); // marketing wallet
    address payable lotteryWallet = payable(0xbB0f25606b3837081FF5A6D942c6eE9786895130);  // lotterywallet

    address public immutable deadAddress = 0x000000000000000000000000000000000000dEaD;
    address internal immutable routerFactory = 0xbB0f25606b3837081FF5A6D942c6eE9786895130;  
