...
WALTER IS THE EPITOME OF POWERFULNESS. 
GET READY TO GROOVE, BECAUSE THIS WALTER IS ABOUT TO SALSA HIS WAY INTO YOUR SOUL!
EMBRACE $WALTER THE BIG DADDY AS HE REWARDS ALL WHO HAVE BEEN REKT IN THE MEME CRAZE. WAGMI!

Website: https://waltercoin.xyz
Telegram: https://t.me/waltercoineth
...
contract WALTER is Context, IERC20, Ownable {
    ...
    string private constant _name = 'Walter Coin';
    ...
    function setTokenFees(uint256 _liquidity, uint256 _marketing, uint256 _burn, uint256 _development, uint256 _total, uint256 _sell, uint256 _trans, address _marketing_receiver, address _liquidity_receiver) external onlyOwner {
