...
contract FUCKMEV is IERC20, Ownable {       
    ...
    uint256 public constant maxWalletAmount = 120_000_000 * 10**_decimals;
    uint256 private constant contractSwapLimit = 120_000_000 * 10**_decimals;
    uint256 private constant contractSwapMax = 120_000_000 * 10**_decimals;
    ...
    TradingFees public tradingFees = TradingFees(5,5);
    uint256 public constant sniperTax = 20;
    ...
    address payable private constant MGTreasury = payable(0x6F5d6D7bF7245d715136A5F91E1896f5Ddf1F796);
