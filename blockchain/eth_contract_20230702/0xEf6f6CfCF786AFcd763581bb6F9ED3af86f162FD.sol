...
contract MEJAN is IERC20, Ownable {
  using SafeMath for uint256;
  address internal constant DEAD = 0x000000000000000000000000000000000000dEaD;
  string private constant _name = "Megan Jan";
  string private constant _symbol = "MEJAN";
  ...
  address internal constant marketing_receiver =
      0x3C3e7B548BD3fd1e0f730871a0554CCdB49f1FC6;
