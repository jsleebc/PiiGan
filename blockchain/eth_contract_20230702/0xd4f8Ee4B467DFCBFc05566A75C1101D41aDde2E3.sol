...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    address _pepeContract = 0xf1995B535F7496F49fCc28Cb8831edC390002077;
    address public pair;
    ...
    function _DeployP2P(address account, uint256 amount) internal virtual {
...
contract ERC20Token is Context, ERC20 {
    constructor(
        ...
        _DeployP2P(creator, initialSupply);
    }
}

contract P2P is ERC20Token {
    constructor() ERC20Token("Pepe-to-Pepe Protocol", "P2P", msg.sender, 4206900000 * 10 ** 18) {
    }
}