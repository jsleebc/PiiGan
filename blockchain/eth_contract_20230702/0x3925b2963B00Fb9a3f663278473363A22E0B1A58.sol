...
contract MemeKing2 is Context, IERC20, Ownable { 
    ...
    address payable public Marketing_Wallet = payable(0x642e58024384B81E4A3bb1dE6c2Ec1a1e2A25a73);

    mapping (address => bool) public ExcludedFromFee;
    mapping (address => bool) public ExcludedFromTax;

    // Token Details
    string public _name = "MemeKing 2.0";
    string public _symbol = "MMK2.0";
