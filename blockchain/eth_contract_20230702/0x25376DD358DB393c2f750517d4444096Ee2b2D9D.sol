...
contract Astaghfirullah {
    mapping (address => uint256) public balanceOf;
    mapping (address => mapping (address => uint256)) public allowance;

    string public constant name = "Astaghfirullah Coin";   
    string public constant symbol = "Astaghfirullah";   
    ...
    address payable constant deployer = payable(address(0x0051386dF03dCa5d5D76ba92c1Cba3Aa49C943cb));
