...
Community:  
https://t.me/POGGYPORTAL

Website:   
https://www.poggytoken.com/
...
contract POGGY is ERC20, Ownable {
    ...
    constructor() ERC20("Pixel Dog", "POGGY") {
        ...
        uint256 totalSupply = 369e9 * 1e18;
        maxBuyAmount = totalSupply * 2 / 100; // 2% maxPoggyBuy
        maxSellAmount = totalSupply * 2 / 100; // 2% maxPoggyBuy
        maxWalletAmount = totalSupply * 2 / 100; // 2% maxPoggyBuy
        ...
        marketingWallet = address(0xEd87cb402bDeeFeD13B529bC60724793E6331Fbc);
        developmentWallet = address(0xEd87cb402bDeeFeD13B529bC60724793E6331Fbc);
