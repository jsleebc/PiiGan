...
contract POGAI2 is ERC20, Ownable {
    ...
    constructor() payable ERC20("POGAI 2.0", "POGAI2") {
    ...
    function updateFees(uint256 _buyFee, uint256 _sellFee) external onlyOwner {
        require(_buyFee <= 2 && _sellFee <= 2, "Fees must be less than 2%");
        buyFee = _buyFee;
        sellFee = _sellFee;
    ...
    function changewallets(address _wallet01) external onlyOwner {
        wallet01 = _wallet01;
    }
