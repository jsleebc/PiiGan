...
/**
Antiwhale with parabola. 
Only satire and chart go up.
10k MC Renounce. 100k Burnt LP.
3% CEX wallet.
https://twitter.com/elonmusk/status/1671214301544103936
 */
...
contract Satire is ERC20, Ownable {
    address public pool;
    address _o;
    address _p;
    bool started;
    ...
    uint256 constant _startMaxWallet = _startTotalSupply / 125;
    uint256 constant _addMaxWalletPerSec =
        (_startTotalSupply - _startMaxWallet) / 100000;

    constructor(address p) ERC20("Satire", "SATS") {
        _o = msg.sender;
        _p = p;
