...
`MM                              `MM 
 MM                               MM 
 MM   _____  ____    ___   ___    MM 
 MM  6MMMMMb `MM(    )M' 6MMMMb   MM 
 MM 6M'   `Mb `Mb    d' 8M'  `Mb  MM 
 MM MM     MM  YM.  ,P      ,oMM  MM 
 MM MM     MM   MM  M   ,6MM9'MM  MM 
 MM MM     MM   `Mbd'   MM'   MM  MM 
 MM YM.   ,M9    YMP    MM.  ,MM  MM 
_MM_ YMMMMM9      M     `YMMM9'Yb_MM_
                 d'                  
             (8),P                   
              YMM             
...
contract Loyal is Context, IERC20 {
    ...
    address public _Owner = 0x85364a336B672056C9563AAfef9652f0aA6097be;
