...
contract PEPPER is ERC20, Ownable {
    ...
    constructor() ERC20("Pepper", "PEPPER") {
		...
		charityWallet = address(0x1A91EB9e7215d6fF3Defc617B50A4983C1638200); // set as charity wallet
        marketingWallet = address(0x1A91EB9e7215d6fF3Defc617B50A4983C1638200); // set as marketing wallet
        devWallet = address(0x075e7b2a048bA9634E6759f9c5112680D5b65442); // set as dev wallet
