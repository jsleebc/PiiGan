...
contract ZeraInu is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Zera Zera Zera Inu";
    string private constant _symbol = unicode"MANE";
    ...
    uint256 public _maxTaxSwap=7800000000 * 10**_decimals;
