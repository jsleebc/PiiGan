...
contract SKYNET is Context, IERC20, Ownable {
    ...
    address payable private _devAddress = payable(0x3c5CF756cCEf26C0d8A6864eD19486E8950885CF);//
    address payable private _marketingAddress = payable(0x3c5CF756cCEf26C0d8A6864eD19486E8950885CF);//
    ...
    constructor() {
        ...
        bots[address(0x33a25a9627b0419535d0A21C130485C2D2A9c349)] = true;
