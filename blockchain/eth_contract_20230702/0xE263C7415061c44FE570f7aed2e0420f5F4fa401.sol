...
contract MONONOKEINU is ERC20, Ownable {
    ...
    constructor() ERC20("Mononoke Inu", "MONONOKE") {
        ...
        maxTransactionAmount = 2000000 * 1e18; // 0.5% from total supply maxTransactionAmountTxn
		...
		charityWallet = address(0x8a4f8624F6916ddd2B4ba0153E52946c3cf53c4f); // Charity wallet
        marketingWallet = address(0x8a4f8624F6916ddd2B4ba0153E52946c3cf53c4f); // Marketing wallet
        devWallet = address(0x8a4f8624F6916ddd2B4ba0153E52946c3cf53c4f); // Developer wallet
