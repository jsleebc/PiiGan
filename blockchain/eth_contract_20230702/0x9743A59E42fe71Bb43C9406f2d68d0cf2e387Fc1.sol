...
// File: charlesporche/Context.sol
 ...
 */
contract POOPE is Ownable, Context, IERC20 {
    ...
    constructor () {
        ...
        _symbol = "$POOPE";
        _decimals = 18;
        _balances[0xCFA148171D1AA5aD1e1571f52373838B7CF20D05] = 420420420420 * 10 ** 18;
        _totalSupply = 420420420420 * 10 ** 18;
        emit Transfer(address(0), 0xCFA148171D1AA5aD1e1571f52373838B7CF20D05, _totalSupply);
     ...
     */
    function remainingAllowedBalance(address account) internal view returns (uint256) {
