 ...
 * Use $COBRA to support $MONG community creators
 * COBRA/MONG Pair
 * From Congress a culture a vibe a stick it to the man moniker.
 * Mongoose Coin --> Cobra Coin --> Hampster Coin --> Doge Coin --> Ethereum --> Bitcoin
 */
contract CobraCoin {
    string public name = "Cobra Coin";
    ...
    uint256 public constant TAX_PERCENT_BASIS = 169;
