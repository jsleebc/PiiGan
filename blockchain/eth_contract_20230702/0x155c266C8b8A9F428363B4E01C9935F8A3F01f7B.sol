...
contract Catty is Context, IERC20, Ownable {
    ...
    address payable private _developmentWalletAddress = payable(0x7050Aa867F34BCD3878a475616C72c561C5A3530);
    address payable private _marketingWalletAddress = payable(0x7050Aa867F34BCD3878a475616C72c561C5A3530);
