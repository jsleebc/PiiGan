/*
  TWITTER: https://twitter.com/UURRcoinERC
  TELEGRAM: https://t.me/UURRcoinErc
*/
...
contract UURR is Context , IERC20, Ownable {
    ...
    string private constant _name = "UURR";
    string private constant _symbol = "$UURR";
