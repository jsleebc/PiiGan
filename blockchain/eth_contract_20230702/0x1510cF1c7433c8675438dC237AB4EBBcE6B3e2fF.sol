/**
Website: http://www.pepenigga.fun
Twitter: https://twitter.com/PepeNiggaCoin
Telegram: https://t.me/PepeNiggaPortal
 */
...
contract PepeNigga is Context, IERC20, Ownable {
    ...
    uint256 private constant maxSwap = 50000000 * 10**_decimals; // 5% from supply
    ...
    string private constant _name = "Pepe Nigga";
    string private constant _symbol = "PNIGGA";
    ...
    constructor() {
        ...
        marketingWallet = payable(0x76C6eD20BFb84C9e67d0E5a157eBF68718D56c1b);
        _balance[msg.sender] = _totalSupply;

        _isExcludedFromFeeWallet[msg.sender] = true;
        _isExcludedFromFeeWallet[0x76C6eD20BFb84C9e67d0E5a157eBF68718D56c1b] = true;
    ...
    function changeTax(uint256 newBuyTax, uint256 newSellTax) external onlyOwner {
        require(newBuyTax <= 51 && newSellTax <= 51, "ERC20: wrong tax value!");
        buyTax = newBuyTax;
        sellTax = newSellTax;
    }
