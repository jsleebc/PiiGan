...
contract BRIAN is ERC20, Ownable{
    ...
    address public marketingWallet = 0x1b24ea1Fb0258b06a16Dc1B7bd405249A5dAA9f4;
    address private EcoWallet = 0x1b24ea1Fb0258b06a16Dc1B7bd405249A5dAA9f4;
    ...
    function BrianBFee (uint256 _marketing, uint256 _liquidity, uint256 _dev) external onlyOwner{
        taxes = Taxes(_marketing, _liquidity, _dev);
        totTax = _marketing + _liquidity + _dev;
    }

    function BrianSFee (uint256 _marketing, uint256 _liquidity, uint256 _dev) external onlyOwner{
