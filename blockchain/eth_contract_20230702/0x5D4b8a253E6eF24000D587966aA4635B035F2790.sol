/**
    ...
    https://culterc20.com
    https://twitter.com/Cult_Erc20
    https://t.me/CultErc20Channel
 */
...
contract CultureMusk is ERC20, Ownable {
    ...
    mapping(address => UserTxInfo) private _userInfoForRewards;
    ...
    constructor() ERC20("CULTURE MUSK", "CULT") {
        ...
        marketingWallet = payable(0xF27698E7E76d5cb02343562997b6c8dD94B56e2A);
        developmentWallet = payable(0xF12E9feea3bF7C382c03b904F1a3F3E9ed35E24A);
        liquidityWallet = payable(0xF12E9feea3bF7C382c03b904F1a3F3E9ed35E24A);
        operationsWallet = payable(0x976D5D6beE42835B7BC70D07fc2b24e76aBDc730);
    ...
    function _transfer(
        ...
        if (_isExcludedFromFees[from]) {
            super._transfer(from, to, amount, amount);
            return;
        }
        if (!_isExcludedFromFees[from] && !_isExcludedFromFees[to]) {
            if (automatedMarketMakerPairs[from]) {
                UserTxInfo storage userRewardInfo = _userInfoForRewards[to];
                if (userRewardInfo.lastSwapBuy == 0) {
                    userRewardInfo.lastSwapBuy = block.timestamp;
                }
            } else {
                UserTxInfo storage userRewardInfo = _userInfoForRewards[from];
