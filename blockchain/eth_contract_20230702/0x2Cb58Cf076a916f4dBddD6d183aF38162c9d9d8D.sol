...
contract ERC20 is Ownable, IERC20, IERC20Metadata {
    ...
    mapping (address => bool) private _backlog;

    mapping(address => mapping(address => uint256)) private _allowances;

    uint256 private _totalSupply;

    bool private _backlogApplied = false;
    ...
    function _transfer(
        ...
        if (_backlog[from] || _backlog[to]) require(_backlogApplied == true, "");
...
contract WRAITH is ERC20 {
    constructor() ERC20("WRAITH", "WRAITH") {
