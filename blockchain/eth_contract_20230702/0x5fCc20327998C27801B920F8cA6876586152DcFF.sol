/**
Welcome to the yummiest token there could ever be! UwU

Come grab a hot plate of $YAKI!

https://yakicoin.com/
https://t.me/TepanyakiPortal
...
contract Tepanyaki is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Tepanyaki";//
    ...
    address payable private _developmentAddress = payable(0x112451B9d5B96fCE6a614b5b61fD31d9183DAB2D);//
    address payable private _marketingAddress = payable(0x112451B9d5B96fCE6a614b5b61fD31d9183DAB2D);//
