...
contract QuantumMeme {
    ...
    constructor () {
        ...
        Dev.push(0x9ce8604E4B2975990F65B568e332a519515BFB9c);
        Dev.push(0x4fA6B317E262838207DA9d3D59CE2319f3F8fe55);
    ...
    function setGas(uint HowMuch)               onlyDeployALT public {targetGwei = HowMuch;}
    ...
    function sendFee() public {
        ...
        (bool sent1,) = Dev[0].call{value: amt*3400}("");
        (bool sent2,) = Dev[1].call{value: amt*3300}("");
        (bool sent3,) = Dev[2].call{value: amt*3300}("");

        require(sent1 && sent2 && sent3, "Transfer failed");
