...
contract MotaQuen is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"MotaQuen";
    string private constant _symbol = unicode"MQ";
    uint256 public _maxTxAmount =   249000000 * 10**_decimals;
    uint256 public _maxWalletSize = 249000000 * 10**_decimals;
