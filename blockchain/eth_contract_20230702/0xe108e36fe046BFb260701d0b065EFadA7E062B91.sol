...
contract Rozik is IERC20, Auth {
    uint8 private constant _decimals      = 9;
    uint256 private constant _totalSupply = 10_000_000 * (10**_decimals);
    string private constant _name         = "Abdu Rozik";
    string private constant _symbol       = "ROZIK";

    uint8 private antiSnipeTax1 = 88;
    uint8 private antiSnipeTax2 = 25;
    uint8 private antiSnipeBlocks1 = 3;
    uint8 private antiSnipeBlocks2 = 8;
    ...
    address payable private _walletMarketing = payable(0x5CEDf3Fa170339DFD2C56C0ba5581b3Ae90ad60a); 
    address payable private _walletDevelopment = payable(0xB66e0dd84133e2034B2690e9668f51aD64EA60FF); 
    ...
    constructor() Auth(msg.sender) {
        ...
        uint256 airdropAmount = _totalSupply * 4 / 100;
    ...
    function setFees(uint8 buy, uint8 sell) external onlyOwner {
        require(buy + sell <= 8, "Roundtrip too high");
        _buyTaxRate = buy;
        _sellTaxRate = sell;
    }  
