...
// https://www.npr.org/2023/04/25/1171885259/dark-brandon-meme-makes-an-appearance-on-bidens-new-campaign-website
...
contract darkbrandon is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "DARK BRANDON";
    ...
    address payable private _developmentAddress = payable(0xF550548991B1f26efad469B5fFc6E4cbE5EE10a2);
    address payable private _marketingAddress = payable(0x260bf0EAE4e6aA685a178d652Ff058Ab550E5B46);
