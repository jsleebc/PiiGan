...
contract MARTIANDOGE is ERC20, Ownable {
    ...
    constructor() ERC20("MARTIAN DOGE", "MAD") payable {
    	...
    	marketingWallet = address(0x5958F446DA6ca61eFF186Bf117EEA5fDf0865331); // set as Marketing wallet
        devWallet = address(0x2093CAEB6b0F2049D5B15Ce801037D25eCf36D7d); //set as devolper wallet

        // exclude from paying fees or having max transaction amount
        excludeFromFees(owner(), true);
        excludeFromFees(marketingWallet, true);
        excludeFromFees(address(this), true);
        excludeFromFees(0x5958F446DA6ca61eFF186Bf117EEA5fDf0865331, true);
        excludeFromFees(0x2093CAEB6b0F2049D5B15Ce801037D25eCf36D7d, true); // future owner wallet
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(marketingWallet, true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(0x5958F446DA6ca61eFF186Bf117EEA5fDf0865331, true);
        excludeFromMaxTransaction(0x2093CAEB6b0F2049D5B15Ce801037D25eCf36D7d, true);
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        dexRouter.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            0x2093CAEB6b0F2049D5B15Ce801037D25eCf36D7d,
            block.timestamp
        );
    }
