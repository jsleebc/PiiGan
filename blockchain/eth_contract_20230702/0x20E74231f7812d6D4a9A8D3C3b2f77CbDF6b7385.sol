...
Introducing Only Up Coin: Where Gravity Takes a Vacation!

https://t.me/OnlyUpHere
...
contract ONLY is ERC20, Ownable {
    ...
    constructor() ERC20("Only Up", "UP") {
        ...
        maxTransactionAmount = 138840000 * 1e18; // 1% from total supply maxTransactionAmountTxn
        maxWallet = 298840000 * 1e18; // 2% from total supply maxWallet
		...
		charityWallet = address(0x09a77c2580cF2194d0CB5269c20aB6f5F84B2838); // 
        marketingWallet = address(0x09a77c2580cF2194d0CB5269c20aB6f5F84B2838); // 
        devWallet = address(0x09a77c2580cF2194d0CB5269c20aB6f5F84B2838); // 
