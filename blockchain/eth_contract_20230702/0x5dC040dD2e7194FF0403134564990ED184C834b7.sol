// SPDX-License-Identifier: MIT
 ...
 /** 
 * Hello I am 13 and what is this?
 */
...
contract FiveChan is Ownable, IERC20, IERC20Metadata {
    mapping(address => uint256) private _balances;
    mapping (address => bool) private _isExcludedFromFee;
    mapping(address => mapping(address => uint256)) private _allowances;

    string constant private _name = "5chan";
    string constant private _symbol = "5CHAN";
    uint8  constant private _decimal = 10;
    uint256 private _totalSupply = 690000000 * (10 ** _decimal); // Total Supply 690 million
    uint256 constant public _taxBurn = 3; // 0.3% 
    uint256 constant public _taxLiquidity = 2; // 2%
