...
contract PepePunk is ERC20, Ownable {
    using SafeMath for uint256;

    string private _name = unicode"Pepe Punk";
    string private _symbol = unicode"PPunk";
    uint8 constant _decimals = 9;
    uint256 _totalSupply = 21910000000 * 10**_decimals;
