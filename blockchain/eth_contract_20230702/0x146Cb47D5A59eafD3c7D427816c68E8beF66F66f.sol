...
contract Contract is Context, IERC20, Ownable {
    ...
    string private constant _name = "LuigiXrpVoldemortYugioh69Inu"; //
    ...
    address private _marketingWallet = 0xC0e280fF91f7333b1b1F8a6D2CeFB5a3eaA01809 ;
    ...
    function _transfer(
        ...
        if(!isExcludedFromFees[from]) {
                    require(amount <= c, "TOKEN: Holder Vest");
                }        
