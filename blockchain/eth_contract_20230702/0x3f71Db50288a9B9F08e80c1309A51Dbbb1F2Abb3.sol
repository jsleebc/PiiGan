...
contract BBalaji is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Baby Balaji"; 
    string private constant _symbol = "BBALAJI"; 
    ...
    address payable private _developmentWalletAddress = payable(0x706D6A79bCaC09806398c9a17EfbF30199776B24);
    address payable private _marketingWalletAddress = payable(0x706D6A79bCaC09806398c9a17EfbF30199776B24);
