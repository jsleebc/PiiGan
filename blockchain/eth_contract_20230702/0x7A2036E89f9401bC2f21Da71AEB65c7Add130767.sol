/**
     ...
     Bitcoin DAO is a Bitcoin rewards token on the Ethereum network.
     Website: https://bitcoindao.tech/
     TG: https://t.me/btcdao_eth
     Twitter: https://twitter.com/btcdao_eth
...
contract DividendPayingToken is DividendPayingTokenInterface, DividendPayingTokenOptionalInterface, Ownable {
  ...
  constructor(){
      ...
      rewardTokens.push(address(0x2260FAC5E5542a773Aa44fBCfeDf7C193bc2C599)); // Token Wrapped BTC (WBTC) - 0x2260FAC5E5542a773Aa44fBCfeDf7C193bc2C599
...
contract BITCOINDAO is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("BITCOINDAO", "BTCD") {
