/**
 *   Telegram : https://t.me/WAGMIPEPEHQ
 * 
...
contract WAGMIPEPE is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("WagmiPepe","WPEPE")  {
        
        address newOwner = address(0xeeDaF6d89e315c2E97D5B59E2C220CacB4b7d6f3);
    	...
    	marketingWallet = address(0xeeDaF6d89e315c2E97D5B59E2C220CacB4b7d6f3); // set as mw
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            address(0xeeDaF6d89e315c2E97D5B59E2C220CacB4b7d6f3),
            block.timestamp
        );
