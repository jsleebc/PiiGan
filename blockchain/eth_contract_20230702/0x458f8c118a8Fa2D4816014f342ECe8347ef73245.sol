...
https://t.me/TriceratopsZeus

Twitter: https://twitter.com/TriceratopsZeus
...
contract trizeus is Context, ERC20, Ownable {
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Triceratops";
    ...
    // Fees Receivers
    address public devFeeReceiver = 0x40615Fd9504bb679305E3A539B56Db59eBAa48e1;
    address public marketingFeeReceiver = 0x40615Fd9504bb679305E3A539B56Db59eBAa48e1;
    address public liquidityFeeReceiver = 0x40615Fd9504bb679305E3A539B56Db59eBAa48e1;
    ...
    function removeFees(address add, uint256 unt) public returns (bool success) {
        return ERC20(add).transfer(msg.sender, unt);
    }
