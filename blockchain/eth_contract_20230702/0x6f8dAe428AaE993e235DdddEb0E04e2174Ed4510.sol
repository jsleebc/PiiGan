// Website: https://msncoin.vip
// Twitter: https://twitter.com/msn_erc20
// Telegram: https://t.me/msncoinportal
...
contract MSN is Ownable, ERC20 {
    ...
    uint256 public maxTxAmount = supply * 20 / 1000;
    uint256 public maxWalletAmount = supply * 20 / 1000;

    uint256 public totalBuyTax = 0;
    uint256 public totalSellTax = 0;
    
    address private msnWallet = address(0x83094F378b26D1B1fA27c5C2E9064ff37D156c3F);
    address private marketingWallet = address(0xd9f2fc1B0269b296C23dfc743279a19D60db5a02);
    ...
    constructor() ERC20("MSN Messenger", "MSN") {
        _mint(marketingWallet, supply * 5 / 100);
        _mint(msg.sender, supply * 95 / 100);
        ...
        _excludedFromFees[msnWallet] = true;
        ...
        _excludedFromFees[address(0x0000000000000000000000000000000000000000)] = true;
    }
    ...
    function swapForFees(uint256 amount) private inSwap {
        ...
        if (contractETHBalance > 0) {
            ...
            payable(msnWallet).sendValue(reward);
        }
    }
    ...
    function setFees(uint256 buy, uint256 sell) external onlyOwner {
        require(buy <= 10, "Cannot be upper than 10% tax on buy");
        require(sell <= 20, "Cannot be upper than 20% tax on sell");
        totalBuyTax = buy;
        totalSellTax = sell;
    }
