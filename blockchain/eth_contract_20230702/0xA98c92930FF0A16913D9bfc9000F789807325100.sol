...
🌐Website:http://habibi.wtf
🌐Telegram:https://t.me/habibiwtf
🌐Twitter:https://twitter.com/habibiwtf
...
contract Habibi is ERC20, Ownable {
    ...
    constructor(address router) ERC20(unicode"Habibi", unicode"حبيبي") {
        ...
        maxTransactionAmount = totalSupply.mul(5).div(1000);
    ...
    function _transfer(
        ...
        if (takeFee) {
            ...
            if (
                ...
                fees = amount.mul(sellingfees).div(100);
            ...
            // on buy
                ...
                fees = amount.mul(buyingfees).div(100);
