...
Pekingese 京巴狗
0/0
TELEGRAM : https://t.me/pekingeseERC
TWITTER : https://twitter.com/pekingeseerc20
*/
...
contract pekin is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Pekingese 京巴狗"; 
    string private constant _symbol = "PEKI";
    ...
    address public marketingWallet = 0x27b9d3EB7E696AB221053CbCcaB271A973daA82f;
...
//============== Owner Functions ===========//
    ...
    function owner_setSellTaxes(uint8 marketingTax, uint8 lpTax) external onlyOwner{
        uint tTax = marketingTax + lpTax;
        require(tTax <= 100, "Can't set tax too high");
