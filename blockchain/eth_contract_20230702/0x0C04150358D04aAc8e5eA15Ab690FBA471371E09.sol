...
contract GAMBIT is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Gambit";
    string private constant _symbol = unicode"GAMBIT";
