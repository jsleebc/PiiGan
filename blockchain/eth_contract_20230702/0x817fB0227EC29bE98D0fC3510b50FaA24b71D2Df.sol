/**
🌐 What is  EVOLVE CHAIN? 🌐
 *Allow parties such as Ethereum to use code to create smart contracts,
  While also, being able to specify the behavior of virtual machines (VMs).
  These "VMS" Are those  that perform contract positions in everday uses.

Telegram: https://t.me/EvolveChain
Website: https://testnet.evolvechain.org
...
contract EvolveChain is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "EVO20";
    ...
    function dripped() public virtual { 
