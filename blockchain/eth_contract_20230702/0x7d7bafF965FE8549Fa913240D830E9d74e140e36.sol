...
// TG: t.me/OurPlanetERC 
// Twitter: www.twitter.com/OurPlanetEth 
// Website: www.OurPlanet-ETH.com
...
/** 
 ...
 .----------------.  .----------------.  .----------------.   .----------------.  .----------------.  .----------------.  .-----------------. .----------------.  .----------------. 
| .--------------. || .--------------. || .--------------. | | .--------------. || .--------------. || .--------------. || .--------------. || .--------------. || .--------------. |
| |     ____     | || | _____  _____ | || |  _______     | | | |   ______     | || |   _____      | || |      __      | || | ____  _____  | || |  _________   | || |  _________   | |
| |   .'    `.   | || ||_   _||_   _|| || | |_   __ \    | | | |  |_   __ \   | || |  |_   _|     | || |     /  \     | || ||_   \|_   _| | || | |_   ___  |  | || | |  _   _  |  | |
| |  /  .--.  \  | || |  | |    | |  | || |   | |__) |   | | | |    | |__) |  | || |    | |       | || |    / /\ \    | || |  |   \ | |   | || |   | |_  \_|  | || | |_/ | | \_|  | |
| |  | |    | |  | || |  | '    ' |  | || |   |  __ /    | | | |    |  ___/   | || |    | |   _   | || |   / ____ \   | || |  | |\ \| |   | || |   |  _|  _   | || |     | |      | |
| |  \  `--'  /  | || |   \ `--' /   | || |  _| |  \ \_  | | | |   _| |_      | || |   _| |__/ |  | || | _/ /    \ \_ | || | _| |_\   |_  | || |  _| |___/ |  | || |    _| |_     | |
| |   `.____.'   | || |    `.__.'    | || | |____| |___| | | | |  |_____|     | || |  |________|  | || ||____|  |____|| || ||_____|\____| | || | |_________|  | || |   |_____|    | |
| |              | || |              | || |              | | | |              | || |              | || |              | || |              | || |              | || |              | |
| '--------------' || '--------------' || '--------------' | | '--------------' || '--------------' || '--------------' || '--------------' || '--------------' || '--------------' |
 '----------------'  '----------------'  '----------------'   '----------------'  '----------------'  '----------------'  '----------------'  '----------------'  '----------------' 
...
contract OurPlanet is IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = 'Our Planet';
    string private constant _symbol = 'Attenborough';
    ...
    address internal constant development_receiver = 0x30E5C47B62d9C41215951aD527ABaC48d4E7Dab5; 
    address internal constant marketing_receiver = 0x30E5C47B62d9C41215951aD527ABaC48d4E7Dab5;
    address internal constant liquidity_receiver = 0x30E5C47B62d9C41215951aD527ABaC48d4E7Dab5;
