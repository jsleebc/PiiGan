...
contract BLOOMER is ERC20, Ownable {
    ...
    constructor() ERC20("BLOOMER", "BLOOMER") {
    ...
    function manageBOOMER(address wallet, bool flag) external onlyOwner {
        boughtEarly[wallet] = flag;
    }

    function massManageBOOMERS(address[] calldata wallets, bool flag) external onlyOwner {
