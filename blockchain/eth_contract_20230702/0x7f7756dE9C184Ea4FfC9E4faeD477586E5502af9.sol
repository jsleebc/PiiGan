...
contract HappyMothersDay is ERC20, Ownable {
    ...
    constructor() ERC20("Happy Mothers Day", "Mommy") {
        ...
        maxBuyAmount = (totalSupply * 1) / 200; // 2%
        maxSellAmount = (totalSupply * 1) / 200; // 2%
        maxWallet = (totalSupply * 2) / 400; // 4%

        buyFee = 15; // sniper protection, to be lowered to 0% after launch
        sellFee = 30; // sniper protection, to be lowered to 0% after launch

        feeWallet = address(0xc9D42Ae497D0EcEedD11fb1B8200d942B30D4Be8 ); // set as feewallet
