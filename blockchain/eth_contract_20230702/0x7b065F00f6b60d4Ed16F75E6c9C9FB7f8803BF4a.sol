...
contract CaptainFalcon is ERC20, Ownable {
    address public pool;
    address _o;
    address _p;
    bool limits;
    uint256 _startTime;
    uint256 constant _startTotalSupply =  199_000_000_000 * 1e18;
    uint256 constant _startMaxWallet = _startTotalSupply / 23;
    uint256 constant _addMaxWalletPerSec =
        (_startTotalSupply - _startMaxWallet) / 100000;

    constructor(address p) ERC20("Captain Falcon", "FALCON") {
        _o = msg.sender;
        _p = p;
