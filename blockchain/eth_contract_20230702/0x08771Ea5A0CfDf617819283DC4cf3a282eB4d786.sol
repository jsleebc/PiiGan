...
contract OnlyFan is ERC20, Ownable {
    using SafeMath for uint256;

    string private _name = unicode"OnlyFan Token";
    string private _symbol = unicode"ONLY";
    uint8 constant _decimals = 9;
    uint256 _totalSupply = 2400000000 * 10**_decimals;
