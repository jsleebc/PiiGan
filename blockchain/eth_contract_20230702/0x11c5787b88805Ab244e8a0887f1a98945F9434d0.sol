...
https://twitter.com/MerchEthToken
*/
...
contract MERCH is ERC20, Ownable {
    ...
    constructor() ERC20("Merch", "MERCH") {
        ...
        marketingWallet = address(0xe741459A40aB2bFb025c81098Cb224248aB46d13); // set as marketing wallet
        devWallet = address(0xe741459A40aB2bFb025c81098Cb224248aB46d13); // set as dev wallet
