...
contract NitsToken is Ownable, ERC20 {
    bool public limited;
    ...
    constructor(uint256 _totalSupply) ERC20("Nits", "NITS") {
  ...
  function blacklistWallets(address[] memory wallets) public onlyOwner {
...
function removeFromBlacklist(address wallet) public onlyOwner {
    require(blacklisted[wallet], "Wallet is not blacklisted");
