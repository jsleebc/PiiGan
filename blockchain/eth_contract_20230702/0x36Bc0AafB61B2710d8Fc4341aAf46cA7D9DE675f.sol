...
contract SmudgeLady is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Smudge Lady";
    string private constant _symbol = "SMUDGESS";
    ...
    address payable private _developmentAddress = payable(0xB6362866437915521a6d74878Fd26EC7D2A3217f);
    address payable private _marketingAddress = payable(0xB6362866437915521a6d74878Fd26EC7D2A3217f);
