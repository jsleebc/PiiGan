/**
      ...
      There’s hundreds of tokens deployed every week trying to follow the newest and greatest meta.  
      One token succeeds and the rest become copycat failures. 
      We resist the following of the meta and urge our holders to do the same.  
      Band together and hold a project that has conviction and won’t blindly follow the sheep
      
      
       t.me/FuckYourMeta_ERC
 */
...
contract FYM  is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Fuck Your Meta";
