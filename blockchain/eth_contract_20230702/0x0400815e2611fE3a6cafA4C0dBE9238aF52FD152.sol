// SPDX-License-Identifier: MIT
    ...
    /*=====================================
    | XAI Forge Meme Ai ERC20             |
    | medium.com/@MemeForge52             |
    | https://twitter.com/XAIForgeMeme    |
    | https://t.me/MemeForgeERC           |
    | AI UTIL IS ALIVE AND MEMING! LFG!   |
    =====================================*/
...
abstract contract Project {
    address public marketingWallet = 0x049a1Bd4e82A724cf6955051Ee8a0eeFC7112850;
    address public devWallet = 0x825256B2751b801ddd9204e7C4CC1A644a0f55f1;

    string constant _name = "XAI Forge";
    string constant _symbol = "MFer";
 ...
 * MainContract
 */
contract MemeForgeAIContract is Project, IERC20, Ownable {
