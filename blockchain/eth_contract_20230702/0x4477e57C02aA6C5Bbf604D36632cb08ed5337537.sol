...
contract PepeLuffy is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Pepe Luffy", "PUFFY") {
        ...
        marketingWallet = address(0xFB627440426b32D994daD07bf8F845947f5B5fd1); // set as marketing wallet
        devWallet = address(0xFB627440426b32D994daD07bf8F845947f5B5fd1); // set as dev wallet
