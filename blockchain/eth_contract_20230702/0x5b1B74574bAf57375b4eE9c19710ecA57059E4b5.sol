...
contract YardGnomes is ERC20 {
    constructor(address initialOwner) ERC20("Yard Gnomes", "GNOMES", 18, initialOwner) {
        mintInitialSupply(initialOwner);
    }

    function mintInitialSupply(address account) private {
