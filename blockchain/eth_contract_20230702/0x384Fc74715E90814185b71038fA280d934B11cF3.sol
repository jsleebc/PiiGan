...
Telegram: https://t.me/WagyuERC20
...
contract WAGYU is Context , IERC20, Ownable {
    ...
    uint256 private _initialBuyTax=15; //start buy tax (20%)
    uint256 private _initialSellTax=15; //start sell tax (20%)
    ...
    string private constant _name = unicode"Dev Needs Wagyu";
