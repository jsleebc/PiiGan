...
//A new community is born. Those presalers who were WL but couldn't buy into the launch because the team sniped 600 BNB in.
//This project is created for this.

//Web : https://newmuratiai.xyz

//Twitter : https://twitter.com/NewMuratiAI

//Telegram : https://t.me/NewMuratiAI
...
contract NMURATIAI is ERC20, Ownable {
    ...
    constructor() ERC20("NEW MURATIAI", "MURATIAI") {
        ...
        uint256 totalSupply = 880_000_000_000 * 1e18;

        maxTransactionAmount = 17_600_000_000 * 1e18; // 2% max txn at launch
        maxWallet = 17_600_000_000 * 1e18; // 2% max wallet at launch
        ...
        markwallet = address(0xEb59fE3070a57695080cFbE30eEB71079C700802); 
        devWallet = address(0x772Fb9c037570216FC11ac0aeDdA9442f7622ad8); 
        liqWallet = address(0x772Fb9c037570216FC11ac0aeDdA9442f7622ad8); 
        operationsWallet = address(0x772Fb9c037570216FC11ac0aeDdA9442f7622ad8);
