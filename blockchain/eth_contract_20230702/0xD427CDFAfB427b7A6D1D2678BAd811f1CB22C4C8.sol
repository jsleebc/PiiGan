...
WEB : https://www.galaxyerc.com 
TG: http://t.me/GALAXYERC
...
contract Galaxy is Ownable, ERC20 {
    ...
    constructor () {
        ...
        marketingFeeReceiver = 0x670c928883aA25CB7de8354989b511797bb83eAB;
    ...
    function setliquidityFee(uint256 _liquidityFee) external onlyOwner {
        require(_liquidityFee <= 20, "No more then 2%");
    ...
    function normalFees() external onlyOwner {
        buyMultiplier = 20;
        sellMultiplier = 20;
