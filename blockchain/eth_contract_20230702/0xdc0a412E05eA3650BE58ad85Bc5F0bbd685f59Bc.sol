...
contract GWToken is Context, IERC20, Ownable {
    ...
    string private constant _name = "GEORGE WASHIGNTON";//
    ...
    address payable private _developmentAddress = payable(0x9dB4b7463EbB3cA585779796e9D145EFf7ac26e4);
    address payable private _marketingAddress = payable(0x9dB4b7463EbB3cA585779796e9D145EFf7ac26e4);
    ...
    uint256 public _maxTxAmount = 40000000 * 1e18; //
    uint256 public _maxWalletSize = 40000000 * 1e18; //
