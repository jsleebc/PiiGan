...
// File contracts/RECOVER.sol

pragma solidity ^0.8.0;

contract RECOVER is Ownable, ERC20 {

    address public init = 0x3797fF9eaa52c53cfc2299f6EACC06b60518561d;

    constructor() ERC20("RECOVER", "RVR") {
        _mint(init, 10000000000000000000000000000000);
    }
