...
//Twitter: https://twitter.com/sun_tzu_erc
...
contract SunTzo is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = unicode"Art Of War";
    string private constant _symbol = unicode"战争的艺术";
    ...
    address payable private _development = payable(0x1ec39B1cC221Ed61F1d92754cA626C690A55Fc3B); 
    address payable private _marketing = payable(0x1ec39B1cC221Ed61F1d92754cA626C690A55Fc3B); 
