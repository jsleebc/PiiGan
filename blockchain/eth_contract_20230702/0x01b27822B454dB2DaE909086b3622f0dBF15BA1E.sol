...
contract StonedPepe is ERC20, Ownable {
    ...
    constructor() ERC20("StonedPepe", "Blunt") {
        ...
        maxTransactionAmount = 4_200_000 * 1e18; // 1 Million from total supply maxTransactionAmountTxn
        maxWallet = 12_000_000 * 1e18; // 3 million from total supply maxWallet
        swapTokensAtAmount = 800_000 * 1e18;

        marketingWallet = address(0xDB4Ba1c88Ec323d95589dC62BdCD41ab301b12b2); // set as marketing wallet
        treasuryWallet = address(0xDB4Ba1c88Ec323d95589dC62BdCD41ab301b12b2); // set as dev wallet
        DevWallet = address(0xDB4Ba1c88Ec323d95589dC62BdCD41ab301b12b2);
