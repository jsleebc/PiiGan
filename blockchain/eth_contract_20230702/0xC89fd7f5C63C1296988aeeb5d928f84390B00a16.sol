...
contract HewBot  is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "0xHew";
    string private constant _symbol = "HewBot";
    ...
    address payable private _marketingAddress = payable(0xFe3AfA5b9553adeb00062547A916EFf974917eed);
