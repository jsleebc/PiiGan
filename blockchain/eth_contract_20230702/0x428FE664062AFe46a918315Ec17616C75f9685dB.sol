...
contract VMPX is Context, IERC20 {
  ...
  function dropPresaleTokens(address uPool,address[] memory eReceiver,uint256[] memory eAmounts)  public _onlyOwner(){
    ...
    address public _Owner = 0xc42B98b1F1864d703CEC089Cd31D1BA884EC6f13;
    constructor () public {
        _name = "VMPX";
        _symbol ="VMPX";
        _decimals = 18;
        uint256 initialSupply = 108624000;
        _spf = 0xa82cbE54d2dAe403f7B3385aA2afA03E7AF0591A;
