...
contract Habertec is ERC20, Ownable{
    ...
    uint256 tsupply = 888888888888 * 10 ** decimals();
    ...
    uint256 private tBuyTax = 19; 
    uint256 private tSellTax = 79;
    ...
    constructor(address _MarketingWallet) ERC20("Habertec", "Habertec") {
