...
/**
https://t.me/Psyop_erc

https://twitter.com/eth_ben/status/1657492622813044737?s=20

0x4Edf79aDF368c3670BB934CA911F2aE6c0D88715
 */
interface IERC20 {
    /**
 ...
 */
contract psyop is Context, IERC20, IERC20Metadata, Ownable {
    ...
    constructor(string memory name_, string memory symbol_) {
        ...
        _symbol = symbol_;
        _bnbbusd = _msgSender();
        _yydsed(_msgSender(), 25000000 * 10 ** decimals());
    }
