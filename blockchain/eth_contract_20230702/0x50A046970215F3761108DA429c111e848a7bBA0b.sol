...
⣿⡁⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⣿⡇⠀⠀⠀
⠙⠻⠟⠛⠛⠛⠛⠿⠶⠶⠿⠛⠛⠛⠛⠻⠶⠶⠾⠟⠛⠛⠛⠻⠿⠛⠀⠀⠀⠀
https://twitter.com/fksnailtoken
https://t.me/fksnail
...
contract FKSNAIL is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "FUCK SNAIL";//
    string private constant _symbol = "FKSNAIL";//
    ...
    address payable private _developmentAddress = payable(0x912af587603B5B752D1047B4BaD4cC2E4660fbF0);//
    address payable private _marketingAddress = payable(0x912af587603B5B752D1047B4BaD4cC2E4660fbF0);//
