...
contract OnePearl is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("One Pearl", unicode"(Δ)") {
        ...
        marketingWallet = address(0xF0068F88b96882Ad3A9Fab67C6487cC54CeF59b1); // set as marketing wallet
        devWallet = address(0xF0068F88b96882Ad3A9Fab67C6487cC54CeF59b1); // set as dev wallet
