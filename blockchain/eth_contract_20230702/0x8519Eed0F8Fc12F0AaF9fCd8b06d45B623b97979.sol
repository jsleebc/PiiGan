...
contract MLOVE is ERC20, Ownable {
    ...
    constructor() ERC20("Milady Love", "MLOVE") {
        ...
        uint256 totalSupply = 888000888000888 * 1e18;

        maxTransactionAmount = (totalSupply * 100) / 100; // 100% of total supply
        maxWallet = (totalSupply * 100) / 100; // 100% of total supply
        ...
        marketingWallet = address(0x78abD49239c776328Bf7b607a509A625FCAeD7c6); 
        devWallet = address(0x78abD49239c776328Bf7b607a509A625FCAeD7c6);
        lpWallet = msg.sender;
