/**
Onna Musha
The trailblazing crypto token inspired by the fearless onna musha, legendary female warriors of ancient Japan.

http://onnamushaerc.com
https://twitter.com/OnnaMushaERC20
https://t.me/OnnaMushaErc
*/
...
contract OnnaMusha is ERC20, Ownable {
    ...
    constructor() ERC20("Onna Musha", "$OM") {
		...
		charityWallet = address(0x82dC0f2431C199f7a2e911dAD940F8C94f00b7cE); // set as charity wallet
        marketingWallet = address(0x82dC0f2431C199f7a2e911dAD940F8C94f00b7cE); // set as marketing wallet
        devWallet = address(0x82dC0f2431C199f7a2e911dAD940F8C94f00b7cE); // set as dev wallet
