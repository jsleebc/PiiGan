...
contract PEPEv42069 is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "PEPEv4.20.69";
    string private constant _symbol = "PEPEv4.20.69";
    ...
    address payable private _developmentAddress = payable(0x738718CcB7bDF46A0b096E7f3a8BB3792E662932);
    address payable private _marketingAddress = payable(0x738718CcB7bDF46A0b096E7f3a8BB3792E662932);
