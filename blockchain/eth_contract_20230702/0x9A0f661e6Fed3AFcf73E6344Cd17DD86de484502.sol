...
contract LISTEN is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Listen Linda";
    string private constant _symbol = "LISTEN";
    ...
    address payable private _developmentAddress = payable(0xC8E989a7480f1c9D014292fC0AC98E9001fDC497);
    address payable private _marketingAddress = payable(0xC8E989a7480f1c9D014292fC0AC98E9001fDC497);
