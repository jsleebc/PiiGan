...
contract Tequila is Context, IERC20, Ownable {
    ...
    string private constant _name = "Trust me you can dance"; 
    ...
    address payable private _developmentWalletAddress = payable(0x90A833DC38EE4caD2d8E8b1460207db16D60219a);
    address payable private _marketingWalletAddress = payable(0x90A833DC38EE4caD2d8E8b1460207db16D60219a);
