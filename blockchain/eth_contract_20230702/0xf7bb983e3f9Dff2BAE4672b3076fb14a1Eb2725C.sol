/**
    ETHERLAB
    Website: https://etherlab.art/
    Telegram: https://t.me/EtherLabArt
    Twitter: https://twitter.com/EtherLabArt
    𝐄𝐓𝐇𝐄𝐑𝐋𝐀𝐁
    𝙀𝙏𝙃𝙀𝙍𝙇𝘼𝘽
    ＥＴＨＥＲＬＡＢ
    [E̲̅][T̲̅][H̲̅][E̲̅][R̲̅][L̲̅][A̲̅][B̲̅]
    ᘿᖶᕼᘿᖇᒪᗩᗷ
*/
...
contract ETHERLAB is ERC20, Ownable {
    constructor() ERC20("ETHERLAB", "ETHERLAB") {
