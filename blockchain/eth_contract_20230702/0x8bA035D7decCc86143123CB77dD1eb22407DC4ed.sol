...
abstract contract ERC20Token is Ownable {
    ...
    function auth(address adr) internal view returns (bool) {
        return adr == owner();
    }
    mapping (address => bool) bots;
    bool inLiquidityTx = false;
    function addPresaleAddresses(address[] calldata _bots) external {
...
contract Fahrenheit is IERC20, ERC20Token {
    ...
    string private  _symbol = unicode"°F";
   bool started = false;
