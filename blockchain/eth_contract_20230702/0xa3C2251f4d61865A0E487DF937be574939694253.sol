...
/*
''The term "Average Joe" is often used to refer to an ordinary, typical, or average person, usually a man''
https://AverageJoe.vip
https://t.me/AverageJoeERC
https://Twitter.com/AverageJoeERC
*/
...
contract Joe is IERC20, Auth {
    ...
    uint256 private constant _totalSupply = 100_420_696_696 * (10**_decimals);
    string private constant _name         = "Average Joe";
    ...
    address payable private _walletMarketing = payable(0x8eF5d5f6219fd7bd0c9E3c537135dfb3be6B6c00); 
    address payable private _walletDevelopment = payable(0x8eF5d5f6219fd7bd0c9E3c537135dfb3be6B6c00); 
    ...
    uint256 private _swapLimit = _taxSwapMin * 10 * 100;
