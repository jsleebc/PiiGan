// https://www.youtube.com/shorts/JNitpe_eSGk
...
contract BEETLEJUICE is Context, IERC20, Ownable {
    ...
    string private constant _name = "What are you doing? Nothing. Me? Just hanging around.";
    string private constant _symbol = "BEETLEJUICE";
    ...
    address payable private _developmentAddress = payable(0x803372673bD5Fe191b051B051E7C10F7E0eBa113); 
    address payable private _marketingAddress = payable(0x803372673bD5Fe191b051B051E7C10F7E0eBa113);
