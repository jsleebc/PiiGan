...
contract LGBTPepe is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "LGBT Pepe";
    string private constant _symbol = "LGBTP";
    ...
    address payable private _developmentAddress = payable(0x479C76CD48Ea7e731512cb2d8EEadEb865DF2751); 
    address payable private _marketingAddress = payable(0x479C76CD48Ea7e731512cb2d8EEadEb865DF2751);
