/**
https://t.me/PrintDefi
print-defi.com

Rooted and Conceived in the Bear Market, Born in the Beginning of a Bull Market, $PRINT boldly sets a new standard of asset management aiming to stay points ahead of the average market cycle. Diversification is your closest friend, and when it all funnels back into one coin, its easy to see who the winner is. Print Defi was conceptually a product of over 10 years experience among the team. Our mission is to end the volatility of basic tokens, and deliver better growth percentiles over time than the overall Crypto Market.
*/
...
contract PRINT is ERC20, Ownable {
    ...
    constructor() ERC20("PRINT DEFI", "PRINT") {
        ...
        marketingAddress = 0x87A57C873567bDE84837091d18D53b1a9e5642D2;
        devAddress = 0x00f7509B9851Ef805Da19a09456d61685c70F694;
