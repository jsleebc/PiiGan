...
contract Quill is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"クイール";
    string private constant _symbol = unicode"Quill";
