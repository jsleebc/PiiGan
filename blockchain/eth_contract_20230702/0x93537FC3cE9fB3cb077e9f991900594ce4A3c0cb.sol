...
contract SHERLOCK is Context, IERC20, Ownable {
    ...
    string private constant _name = "SHERLOCK HOLMES";
    ...
    address payable private _developmentAddress = payable(0x2186238536843FF05a0d0D327f82db1f3990F90f); 
    address payable private _marketingAddress = payable(0x2186238536843FF05a0d0D327f82db1f3990F90f);
