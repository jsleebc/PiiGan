/** 
Today, our beloved Boonie bears have made their enchanting debut, stepping into the realm of Blockchain, a fascinating world of cryptocurrency. 
They are here to nurture this digital forest and form delightful bonds with the diverse MEMEs inhabiting this domain, all while wholeheartedly safeguarding them. 
Boonie bears, who are the protectors of the forest and best friends of MEMEs, will make our cryptocurrency world safer and MEMEs' lives more fun. 
Because Boonie bears are humorous jokers.

Website: https://www.boonie.fun
Telegram: https://t.me/booniebearsETH
Twitter: https://twitter.com/booniebearsETH
**/
...
contract BOONIE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Boonie Bears";
    string private _symbol = "BOONIE";
    uint8 private _decimals = 9;

    address private operationAddress = msg.sender;
