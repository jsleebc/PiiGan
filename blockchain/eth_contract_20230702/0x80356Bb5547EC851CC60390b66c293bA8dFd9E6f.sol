...
contract WAGMI is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0x13B5282D1C9F1C40fDFbb3c1F189608c30e68604);
    address payable private _marketingAddress = payable(0x13B5282D1C9F1C40fDFbb3c1F189608c30e68604);
    ...
    function wagmiTax(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyOwner {
