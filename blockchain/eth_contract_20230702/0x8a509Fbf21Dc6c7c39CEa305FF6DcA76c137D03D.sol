...
https://twitter.com/muhladymaker

Mint one of our NFT's for 0.01 ETH, https://muhlady.lol/
...
contract MuhLady is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"MuhLady";
    string private constant _symbol = unicode"MUHLADYS";
