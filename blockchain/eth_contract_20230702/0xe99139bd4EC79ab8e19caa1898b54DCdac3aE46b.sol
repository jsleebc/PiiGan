...
contract JarisCoin is Ownable, ERC20 {
    bool public limited;
    ...
    constructor(uint256 _totalSupply) ERC20("Jariscoin", "JARIS") {
        _mint(msg.sender, _totalSupply);
    }

    function BanBots(address _address, bool _isBlacklisting) external onlyOwner {
        blacklists[_address] = _isBlacklisting;
    }

    function UnbanBots(address _address) external onlyOwner {
