...
contract PEPELSD is ERC20, Ownable {
    using SafeMath for uint256;

    string private _name = unicode"PEPE LSD";
    string private _symbol = unicode"LSD";
    uint8 constant _decimals = 9;
    uint256 _totalSupply = 27400000000 * 10**_decimals;
    uint256 public _maxWalletToken = _totalSupply * 100000000000000000000000;
