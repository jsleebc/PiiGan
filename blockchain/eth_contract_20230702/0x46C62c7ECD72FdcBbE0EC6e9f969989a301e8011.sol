...
contract EMPTY is ERC20, Ownable {
    ...
    constructor() ERC20("Empty", "EMPTY") {
        ...
        uint256 totalSupply = 9999999999999 * 1e18;

        maxTransactionAmount = 199999999999 * 1e18; // 1% from total supply maxTransactionAmountTxn
        maxWallet = 199999999999 * 1e18; // 2% from total supply maxWallet
		...
		charityWallet = address(0x28b1474b89B5400813933A418d7530189609292A); // set as charity wallet
        marketingWallet = address(0x28b1474b89B5400813933A418d7530189609292A); // set as marketing wallet
        devWallet = address(0x28b1474b89B5400813933A418d7530189609292A); // set as dev wallet
