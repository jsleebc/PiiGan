...
/*
◻️Telegram: https://t.me/MemeTownVIP
◻️Twitter: http://Twitter.com/memetownVip
◻️ Website: https://MemeTown.vip
*/
...
contract Mtown is IERC20, Auth {
    uint8 private constant _decimals      = 9;
    uint256 private constant _totalSupply = 500_000_000 * (10**_decimals);
    string private constant _name         = "Meme Town";
    string private constant _symbol       = "MTOWN";

    uint8 private antiSnipeTax1 = 10;
    uint8 private antiSnipeTax2 = 9;
    ...
    address payable private _walletMarketing = payable(0x5052003413D6b796a96301e90aC6cAa1a0C7F9f3); 
    address payable private _walletDevelopment = payable(0x56B3c898583134010B050Fc01FBEE31B06F0E54E); 
    ...
    constructor() Auth(msg.sender) {
        ...
        uint256 airdropAmount = _totalSupply * 21 / 100;
