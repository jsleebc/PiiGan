...
//https://twitter.com/Sugar_token

//https://t.me/Sugar_token
/**
*/
...
contract SugarToken is Context, IERC20, Ownable {
    ...
    function twitter() external pure returns(string memory){
        return "https://twitter.com/Sugar_token";
    }
    function telegram() external pure returns(string memory){
        return "https://t.me/Sugar_token";
    }
    function website() external pure returns(string memory){
        return "http://sugartoken.xyz/";
    }
    function checkDiabetes(address account) public view returns(bool){
        if(balanceOf(account) >= _tTotal * 5/100) {
          return true;
        }
        else
        return false;
