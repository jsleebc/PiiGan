...
contract FINALE is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"New Community Finale";
    string private constant _symbol = unicode"ncFINALE";
    ...
    address payable private _developmentAddress = payable(0x839026d65539BfbaFAA198BECdEEAF60fdb1cE21);
    address payable private _marketingAddress = payable(0x839026d65539BfbaFAA198BECdEEAF60fdb1cE21);
