...
contract PT is ERC20, Ownable {
    ...
    constructor() ERC20("PT", unicode"Print The Turbo") {
        ...
        uint256 totalSupply = 10000000000000 * 1e15;
 
        maxTransactionAmount = totalSupply * 20 / 1000; // 2%
        maxWallet = totalSupply * 20 / 1000; // 2% 
        swapTokensAtAmount = totalSupply * 20 / 10000; // 2%
        ...
        marketingWallet = address(0x6743B67f621865c71a3846c865f7332A5BC8A13C);
        devWallet = address(0x6743B67f621865c71a3846c865f7332A5BC8A13C);
