...
twitter https://twitter.com/BadTedYC?s=20
...
abstract contract Project {
    address public marketingWallet = 0xE70442aaFE7F8860b3D9a2acf4Ba185690500920;
    address public devWallet = 0xE70442aaFE7F8860b3D9a2acf4Ba185690500920;

    string constant _name = "TED";
    string constant _symbol = "TEDCOIN";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1 * 10**9 * 10**_decimals;

    uint256 public _maxTxAmount = (_totalSupply * 10000) / 1000000; // (_totalSupply * 10000) / 1000000 [this equals 1%]
    uint256 public _maxWalletToken = (_totalSupply * 10000) / 1000000; //
 ...
 * MainContract
 */
contract BADTEDContract is Project, IERC20, Ownable {
