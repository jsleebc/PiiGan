...
contract Wigop is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Wigop";
    string private constant _symbol = unicode"WIGOP";
