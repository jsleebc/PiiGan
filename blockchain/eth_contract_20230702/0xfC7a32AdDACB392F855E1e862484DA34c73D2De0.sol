...
// File contracts/DESHIT.sol

pragma solidity ^0.8.0;

contract DESHIT is Ownable, ERC20 {

    address public init = 0x1543683056128FE832C10698439480b57931b3a9;

    constructor() ERC20("DESHIT", "DESHIT") {
        _mint(init, 1000000000000000000000000000);
    }
