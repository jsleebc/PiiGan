/**
        *https://t.me/pepelonmuskportal
        *https://twitter.com/pepe_musk
*/
...
contract PepelonMusk is Context, IERC20, Ownable {
    ...
    string private _name = "Pepelon Musk";
    ...
    uint256 public minimumTokensBeforeSwap = 50_000 * 10**_decimals;

    uint256 public _walletMax = _totalSupply.mul(2).div(denominator);
    ...
    constructor () {
        ...
        totalBuy = _buyLiquidityFee;
        totalSell = _sellLiquidityFee;
    ...
    function setFees(uint _newBuyLP, uint _newSellLP) public onlyOwner {
        _buyLiquidityFee = _newBuyLP;
        _sellLiquidityFee = _newSellLP;
        totalBuy = _buyLiquidityFee;
        totalSell = _sellLiquidityFee;
    }

    function setWallets(address _liquidityRec) public onlyOwner {
