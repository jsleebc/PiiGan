...
contract INCREDIT is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"INCREDIT";
    string private constant _symbol = unicode"INCREDIT";
    uint256 public _maxTxAmount =   199999998 * 10**_decimals;
    uint256 public _maxWalletSize = 199999998 * 10**_decimals;
