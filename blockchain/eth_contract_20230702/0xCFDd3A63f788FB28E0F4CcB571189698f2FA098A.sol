...
// Opensea - https://opensea.io/collection/pixeladymaker
...
contract PixeladyMaker is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Pixelady Maker";
    string private constant _symbol = unicode"PLADY";
