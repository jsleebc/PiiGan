...
Welcome Contract Enjoyer!
Low liquidity coins -> Faster Number Goes Up -> More Profit
Twitter & Website Coming Sooooooon
...
contract WaldoToken is Ownable, ERC20 {
    bool public limited;
    ...
    constructor(uint256 _totalSupply) ERC20("Waldo", "WALDO") {
        _mint(msg.sender, _totalSupply); //420690000000000000000000000000000
    }
