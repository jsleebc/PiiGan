...
/**
 * "Pulse Pepe! $PULSE PEPE (pulse Pepe), Pepe is back with a PULSE!
 * "twitter.com/pulsepepeerc
 * "t.me/pulsepepeerc
 * "pulsep.vip
 */
...
contract pulsePepe is Context, IERC20, Ownable {
    ...
    string private _name = "Pulse Pepe ERC";
    string private _symbol = "Pulse PEPE";
    ...
    constructor () {
        ...
        marketingW = payable(address(0x92004eF2fAa47547F275Fb7525E3B92262f3789a));
    }
