...
contract GOKUBLCK is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"GOKUBLCK";
    string private constant _symbol = unicode"GOKUBLCK";
