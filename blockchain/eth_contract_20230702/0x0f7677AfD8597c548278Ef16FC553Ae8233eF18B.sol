...
contract MISSOOOR  is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "THE MISSOOOR";
    string private constant _symbol = "MISSOOOR ";
    ...
    address payable private _developmentAddress = payable(0x9643dB174cdF5e8D11b4D3157f578147eA0C1bCC); 
    address payable private _marketingAddress = payable(0x9643dB174cdF5e8D11b4D3157f578147eA0C1bCC);
