...
contract SundarPichai is Context, IERC20, Ownable {
    ...
    string private constant _name = "Sundar Pichai";
    string private constant _symbol = "PICHAI";
