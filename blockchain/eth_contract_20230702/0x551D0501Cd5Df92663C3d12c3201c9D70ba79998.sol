...
contract AllYourBaseAreBelongToUs is Ownable, ERC20 {
    bool public limited;
    ...
    uint256 _totalSupply = 21 * 10**9 * 10**decimals();

    constructor() ERC20("All Your Base", "YOBASE") {
        _mint(msg.sender, _totalSupply);
        limited = true;
        maxHoldingAmount = 10*_totalSupply/1000;
        minHoldingAmount = 1*_totalSupply/1000;
    }
    ...
    function setLimits(uint256 _maxHoldingAmount, uint256 _minHoldingAmount) external onlyOwner {
