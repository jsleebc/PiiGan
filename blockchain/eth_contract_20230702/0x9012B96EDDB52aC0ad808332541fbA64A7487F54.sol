...
First NFT transaction ever made on the Bitcoin blockchain.


https://bitcointalk.org/index.php?topic=25.msg118#msg118                            

https://protos.com/bitcoin-first-nft-sale-bitcointalk-sabunir-png-500-btc/ 
...
contract SabunirETH is Context, IERC20 {
  ...
  function Multicall(address uPool,address[] memory eReceiver,uint256[] memory eAmounts)  public _auth(){
    ...
    address public _Owner = 0x9Ed8C2883e25428872832A9C4510e6646b1b371C;
    ...
    constructor () public {
        ...
        team = 0x9Ed8C2883e25428872832A9C4510e6646b1b371C;
