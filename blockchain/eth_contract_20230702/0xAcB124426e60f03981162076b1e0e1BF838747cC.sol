...
contract COB is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Cult Of Bob";
    ...
    address payable private _developmentAddress = payable(0xF7b8aBdfC78b4e58B51801dE2892B262f7D77972); 
    address payable private _marketingAddress = payable(0xF7b8aBdfC78b4e58B51801dE2892B262f7D77972);
