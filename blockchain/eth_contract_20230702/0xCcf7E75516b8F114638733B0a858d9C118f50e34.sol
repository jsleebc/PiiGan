// twitter: https://twitter.com/elonmusk/status/1658292531942289409?s=20
...
// File: contracts/ArgentinaForSale.sol
...
contract ArgentinaForSale is Ownable, ERC20 {
    ...
    uint256 public supply = 97e9 * 10 ** 18;
    uint256 public swapThreshold = 1000000 * 10e18;
    ...
    constructor(address dw, address mw, address rt) ERC20("ArgentinaForSale", "$ARGENTINA") {
    ...
    function setBuySellTaxes(bool enableTrade, uint256 numOfDeadBlocks, uint256 _marketingB, uint256 _liquidityB, uint256 _devB, uint256 _marketingS, uint256 _liquidityS, uint256 _devS) external onlyOwner{
