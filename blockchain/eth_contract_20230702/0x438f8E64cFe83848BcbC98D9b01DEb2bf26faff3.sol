...
contract YIPPY is Context, IERC20, Ownable { 
    ...
    address payable public ProjectWallet = payable(0x494C0F34B2167D3F9C6Eb51fc00973A9857E52D7);
    address payable public DeadWallet = payable(0x000000000000000000000000000000000000dEaD); 

    string public _name = "Yippy Coin";
    string public _symbol = "YIPPY";
