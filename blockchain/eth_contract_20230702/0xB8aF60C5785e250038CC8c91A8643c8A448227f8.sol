...
contract ALIENUINUERC20 is ERC20, Ownable {
    ...
    constructor() ERC20("Alien Inu", "AINU") {
        ...
        maxTransactionAmount = 29999999999 * 1e18; // 1% from total supply maxTransactionAmountTxn
        maxWallet = 29999999999 * 1e18; // 2% from total supply maxWallet
		...
		charityWallet = address(0x34C50EAde501eFf1E1DBF754edf6703928a2ec80); // set as charity wallet
        marketingWallet = address(0x34C50EAde501eFf1E1DBF754edf6703928a2ec80); // set as marketing wallet
        devWallet = address(0x34C50EAde501eFf1E1DBF754edf6703928a2ec80); // set as dev wallet
