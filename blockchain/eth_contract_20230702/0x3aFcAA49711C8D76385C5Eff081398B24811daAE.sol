...
contract Weeb is IERC20, Ownable {       
    ...
    uint256 public constant maxWalletAmount = 690_000_000 * 10**_decimals;
    uint256 private constant contractSwapLimit = 690_000_000 * 10**_decimals;
    uint256 private constant contractSwapMax = 690_000_000 * 10**_decimals;
    ...
    address payable private constant WEEBTreasury = payable(0x7509cd8761E8C7A49C82202891Dfe64C0F5E73B8);
