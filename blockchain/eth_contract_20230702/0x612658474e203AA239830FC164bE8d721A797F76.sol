...
//\______   \___.__. ____  _____|  |__ |__| \_____  \    \   _  \  
// |       _<   |  |/  _ \/  ___/  |  \|  |  /  ____/    /  /_\  \ 
// |    |   \\___  (  <_> )___ \|   Y  \  | /       \    \  \_/   \
// |____|_  // ____|\____/____  >___|  /__| \_______ \ /\ \_____  /
//        \/ \/               \/     \/             \/ \/       \/                

//Telegram: https://t.me/ryoshi2dot0

//Website: https://www.ryoshi2.com/
...
contract RYOSHI20 is IERC20, Ownable {
    using SafeMath for uint256;
    address internal constant DEAD = 0x000000000000000000000000000000000000dEaD;
    string private constant _name = "RYOSHI 2.0";
    string private constant _symbol = "RYOSHI2";
    uint8 private constant _decimals = 18;
    uint256 private _totalSupply = 100000000000 * (10 ** _decimals);
    uint256 private _maxTxAmountPercent = 100000000000; // base 100;
    uint256 private _maxTransferPercent = 100000000000;
    uint256 private _maxWalletPercent = 2000000000;
    ...
    address internal constant marketing_receiver =
        0x06D03f6a8e99a5711F733d931Dff34f2DB2deBCD;
    ...
    function setTxLimits(
        ...
        uint256 newTx = (totalSupply() * _newMaxTx) / 100000000000;
        uint256 newTransfer = (totalSupply() * _newMaxTransfer) / 100000000000;
        uint256 newWallet = (totalSupply() * _newMaxWallet) / 100000000000;
