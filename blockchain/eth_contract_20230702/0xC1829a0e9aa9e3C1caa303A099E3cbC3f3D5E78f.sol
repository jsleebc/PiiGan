...
contract POP is ERC20, Ownable {
    ...
    constructor() ERC20("Proof of Pepe", "POP") {
        ...
        marketingWallet = address(0x47228beC7F27CC08d6B164C77920A5d0a6BC5D88);
        devWallet = address(0x47228beC7F27CC08d6B164C77920A5d0a6BC5D88);

        _isExcludedMaxTransactionAmount[address(marketingWallet)] = true;
        _isExcludedFromFees[address(marketingWallet)] = true;
        _isExcludedMaxWalletAmount[address(marketingWallet)] = true;
