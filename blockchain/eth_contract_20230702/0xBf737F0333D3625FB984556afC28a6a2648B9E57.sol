...
L++ is a new programming language designed specifically for Degens. 

Anything that a person codes in L++ will easily send.

Website:
http://lplusplus.xyz/

Telegram:
https://t.me/Lplusplus

Twitter:
https://twitter.com/LPlusPlusERC20
...
contract LPlusPlus  is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "L++";
    ...
    address payable private _marketingAddress = payable(0x1237adB2D272e8212094A093CB3db80988f040D2);
