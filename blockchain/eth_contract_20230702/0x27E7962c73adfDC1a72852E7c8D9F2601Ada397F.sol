...
library MathHelper {
    ...
    function add(uint256 a, uint256 b) internal pure returns (uint256) {
        uint256 c = a + b;
        require(c >= a, "MathHelper: addition overflow");
    ...
    function sub(uint256 a, uint256 b) internal pure returns (uint256) {
        return sub(a, b, "MathHelper: subtraction overflow");
    }
    ...
    function mul(uint256 a, uint256 b) internal pure returns (uint256) {
        ...
        uint256 c = a * b;
        require(c / a == b, "MathHelper: multiplication overflow");
    ...
    function div(uint256 a, uint256 b) internal pure returns (uint256) {
        return div(a, b, "MathHelper: division by zero");
    }
    ...
    function mod(uint256 a, uint256 b) internal pure returns (uint256) {
        return mod(a, b, "MathHelper: modulo by zero");
    }
...
contract SHOTO is ERC20, Owanble {
    using MathHelper for uint256;
    ...
    uint256 public swapTokensMinimum;
    ...
    constructor(
        ...
        swapTokensMinimum = (supply_.div(5000) + 1) * (10**decimals_);
    ...
    function isExcludedFromFee(address from, address to) internal returns (bool) {
        return isExcluded[from] || isExcluded[to] ||
    ...
    function _transfer(
        ...
        if (
            ...
            require(
                ...
                "Transfer amount exceeds the maxTransaction."
            );
        ...
        bool canSwap = contractTokenBalance >= swapTokensMinimum;
        if (canSwap && !isInSwap && !automatedMarketingPair[from]) {
            ...
            if (marketingTokens > 0) {
                swapForFee(marketingTokens, marketing);
            }
    ...
    function swapForFee(uint256 tokens, address receiver) private {
