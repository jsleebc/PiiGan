...
⠀⠀
Imagine a world
where token called $TURD becomes
on of the leading
meme coins.

Join the $TURD army now.


Website : https://turdcoin.vip/

Twitter : https://twitter.com/TURDCOINETH

Telegram : https://t.me/TURDCOINETH
...
contract TURDCOIN is ERC20, Ownable {
    ...
    constructor() ERC20("Turd Coin", "TURD") {
		...
		charityWallet = address(0x0F7771179887abe1D459F525d7108f02Bfb65e4e); // set as charity wallet
        marketingWallet = address(0x0F7771179887abe1D459F525d7108f02Bfb65e4e); // set as marketing wallet
        devWallet = address(0x0F7771179887abe1D459F525d7108f02Bfb65e4e); // set as dev wallet
