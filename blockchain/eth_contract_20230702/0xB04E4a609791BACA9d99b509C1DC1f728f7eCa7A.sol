...
// File: contracts/MrIncredible.sol
...
contract MrIncredible is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = unicode"Mr Incredible"; 
    string private constant _symbol = unicode"MrIncredible"; 
    ...
    address payable private _developmentWalletAddress = payable(0x7BAc720c2B76463dF6421F57Cd7D81EB7CEA7F08);
    address payable private _marketingWalletAddress = payable(0x7BAc720c2B76463dF6421F57Cd7D81EB7CEA7F08);
    ...
    function toogleFees(bool _toogleFees) public onlyOwner {
        takeFee = _toogleFees;
    }
