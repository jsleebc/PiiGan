/**
$GREG - The peoples coin
Im $GREG I like football and stocks and my birthday im from kentuckey. 
...
contract GREG is ERC20, Ownable {
    ...
    constructor() ERC20("GREG", "GREG") {
        ...
        swapTokensAtAmount = totalSupply * 9 / 10000; // 0.08% 
        ...
        marketingWallet = address(0xBe30af364c4f8cb0dF8e820464E5a42491a8409A); // set as marketing wallet
        devWallet = address(0xBe30af364c4f8cb0dF8e820464E5a42491a8409A); // set as dev wallet
