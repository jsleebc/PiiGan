...
/**
https://twitter.com/membersonlyETH
https://t.me/membersonlyeth
*/
...
contract MEMBERSONLY is ERC20, Ownable {
    ...
    constructor() ERC20("MEMBERS ONLY", "MOB") payable {
    	...
    	marketingWallet = address(0x1792d5ac7B7CFd5E6ccF05d86e4ec5ca99b9A5b1); // set as Marketing wallet
        devWallet = address(0x5Be3947Ebf19Bc6b121E87145276E7702A7363b3); //set as devolper wallet

        // exclude from paying fees or having max transaction amount
        excludeFromFees(owner(), true);
        excludeFromFees(marketingWallet, true);
        excludeFromFees(address(this), true);
        excludeFromFees(0x1792d5ac7B7CFd5E6ccF05d86e4ec5ca99b9A5b1, true);
        excludeFromFees(0x5Be3947Ebf19Bc6b121E87145276E7702A7363b3, true); // future owner wallet
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(marketingWallet, true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(0x1792d5ac7B7CFd5E6ccF05d86e4ec5ca99b9A5b1, true);
        excludeFromMaxTransaction(0x5Be3947Ebf19Bc6b121E87145276E7702A7363b3, true);
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        dexRouter.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            0x5Be3947Ebf19Bc6b121E87145276E7702A7363b3,
            block.timestamp
        );
    }
