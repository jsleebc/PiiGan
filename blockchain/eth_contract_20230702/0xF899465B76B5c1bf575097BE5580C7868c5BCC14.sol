...
contract MINT is Context, IERC20, Ownable {
    ...
    string private constant _name = "Dick Breath";
    ...
    address payable private _developmentAddress = payable(0x237E34409d8A6B3df4BB4d9A6055CD13ed179d78);
    address payable private _marketingAddress = payable(0x54D87796D729475a6967D5147aFFe52dEF5d3e83);
