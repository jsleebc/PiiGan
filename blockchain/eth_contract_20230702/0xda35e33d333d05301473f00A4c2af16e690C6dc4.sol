...
Community needs decentralization. Provide decentralization and win.
...
contract TRUTHGPT is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0xD71F664D047bE7d6FeD1C4A71FC298e00898cC42); 
    address payable private _marketingAddress = payable(0xD71F664D047bE7d6FeD1C4A71FC298e00898cC42);
    ...
    uint256 public _maxTxAmount = 7000 * 10**9; 
    uint256 public _maxWalletSize = 7000 * 10**9; 
