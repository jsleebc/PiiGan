/**
GOD has made his first creations, Presenting ~ ADAM & ETH ~

Telegram: https://t.me/ADAMandETHportal

Web: http://adamandeth.vip/
*/ 
...
contract AdamAndETH  is Context, IERC20, Ownable {
    ...
    string private constant _name = "ADAM & ETH";
    string private constant _symbol = "ADAMETH";
    ...
    uint256 private constant _tTotal = 970000000000 * 10**9;
    ...
    address payable private _developmentAddress = payable(0xF9240b24042A0280A49479f7dF388b5Ed94c6292); 
    address payable private _marketingAddress = payable(0x9369412E13de65C7ad71253eE994faFF286a23d2);
