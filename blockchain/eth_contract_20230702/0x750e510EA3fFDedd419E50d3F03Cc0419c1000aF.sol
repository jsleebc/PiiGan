...
contract SwissGoldenCalf is ERC20, ERC20Burnable, ERC20Permit, Ownable {
    constructor() ERC20("SwissGoldenCalf", "SGC") ERC20Permit("SwissGoldenCalf") {
        _mint(msg.sender, 7800780078007800 * 10 ** decimals());
    }
}