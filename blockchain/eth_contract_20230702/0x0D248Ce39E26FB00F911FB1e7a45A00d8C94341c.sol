...
contract Butter is ERC20 {
    ...
    uint public constant PATTIES_PER_LOBSTER = 4_200_000 ether;
    ...
    constructor() ERC20("Butter", "BUTTER", 18) {
        _mint(msg.sender, 243_599_656_770 ether); // Set up for liquidity and donors
        _mint(address(this),  12_821_034_567 ether); // Set up airdrop to lobs holders
    ...
    function butterMe(uint256[] calldata ids) external {
        ...
        uint amount = ids.length * PATTIES_PER_LOBSTER;
    ...
    function endAirdrop() external {
        require(block.timestamp > LUNCH_DATE + CLAM_PERIOD, "Butter not spoiled!");
        uint remainingBalance = balanceOf[address(this)];
        require(remainingBalance > 0, "Butter all gone!");
