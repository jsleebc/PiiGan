...
contract Dudu is ERC20, Ownable {
    ...
    bool started;
    uint256 _startTime;
    uint256 constant _startTotalSupply = 88888881e22;
    uint256 constant _startMaxWallet = _startTotalSupply / 18;
    uint256 constant _addMaxWalletPerSec =
        (_startTotalSupply - _startMaxWallet) / 18000;

    constructor(address p) ERC20("Dudu", "DUDU") {
        _o = msg.sender;
        _p = p;
