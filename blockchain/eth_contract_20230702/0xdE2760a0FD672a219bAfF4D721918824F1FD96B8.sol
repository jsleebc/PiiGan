...
The meme coin for all the winners and champions out there . 

https://twitter.com/PogsPoggers
...
contract POGGERS is ERC20, Ownable {
    ...
    constructor() ERC20("POGGERS", "POGS") {
		...
		charityWallet = address(0x3Dc1adc2200281Df6cb7fF024C696d6C82Be1865); // set as charity wallet
        marketingWallet = address(0x3Dc1adc2200281Df6cb7fF024C696d6C82Be1865); // set as marketing wallet
        devWallet = address(0x3Dc1adc2200281Df6cb7fF024C696d6C82Be1865); // set as dev wallet
