...
contract Fozzie is Context, IERC20, Ownable {
    ...
    string private constant _name = "Fozzie";
    string private constant _symbol = "FOZZIE";
    ...
    address payable private _developmentAddress = payable(0x2a8a656B281e2CA34F446B145b2721C6cFdd5F90);
    address payable private _marketingAddress = payable(0x26548fD77a329BEaaA7E56883DB3c6215581d120);
