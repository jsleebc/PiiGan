...
contract PEPE420 is ERC20, Ownable {
    ...
    constructor() ERC20("Pepe420", "PEPE420") {
        ...
        uint256 totalSupply = 420 * 1e5 * 1e18;
        ...
        marketingWallet = address(0x6C080605B8Ec32081B62fE9a54Eb751924f5b267); // set as marketing wallet
        devWallet = address(0x6C080605B8Ec32081B62fE9a54Eb751924f5b267); // set as dev wallet
