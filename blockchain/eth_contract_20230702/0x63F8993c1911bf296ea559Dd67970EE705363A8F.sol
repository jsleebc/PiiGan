...
contract PepeChan is Ownable { using SafeMath for uint256;
...
string private  _symbol = "PEPECHAN"; string private _name = "Pepe-Chan";
uint256 public _totalSupply = 1000000000001 * 10 ** _decimals;
