...
contract MONGO is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Mongoose Coin";
    string private constant _symbol = unicode"MONGO";
