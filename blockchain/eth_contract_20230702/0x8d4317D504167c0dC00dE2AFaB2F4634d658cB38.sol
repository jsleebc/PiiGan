...
Twitter: https://twitter.com/DolanTokens
Medium: https://medium.com/@DolanTokens
Instagram: https://instagram.com/DolanTokens
Youtube: https://www.youtube.com/@DolanTokens
Reddit: https://www.reddit.com/user/DolanTokens
Vimeo: https://vimeo.com/dolantokens
Dailymotion: https://dailymotion.com/DolanTokens
...
contract DOLANDUK is Context, IERC20, Ownable {
    ...
    uint256 private _reduceBuyTaxAt = 4; // 5 first transactions
    uint256 private _reduceSellTaxAt = 4; // 5 first transactions
    uint256 private _preventSwapBefore = 4; // 5 first transactions
    ...
    uint256 public _maxWalletSize = _tTotal.mul(4).div(100);   // 4% of total supply
    uint256 public _taxSwapThreshold = _tTotal.mul(1).div(100); // 1% of total supply
