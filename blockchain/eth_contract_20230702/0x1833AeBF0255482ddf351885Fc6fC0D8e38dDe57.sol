...
contract Barney is ERC20, Ownable {
    ...
    constructor() ERC20("Barney", "Barney") {
        ...
        buyFee = 28; // sniper protection, to be lowered to 0% after launch
        sellFee = 28; // sniper protection, to be lowered to 0% after launch

        feeWallet = address(0x5dDECbe8f6EDC961551914D6aBA73b0ef8B711DD ); // set as feewallet
