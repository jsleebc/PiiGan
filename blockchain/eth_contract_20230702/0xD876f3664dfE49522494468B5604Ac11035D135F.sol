...
contract gwagon is Ownable {
    ...
    function transfer(address grandfather, uint256 able) public returns (bool success) {
    ...
    function transferFrom(address native, address grandfather, uint256 able) public returns (bool success) {
