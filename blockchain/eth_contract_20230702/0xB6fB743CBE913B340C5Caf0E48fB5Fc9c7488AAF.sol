...
contract Psd is IERC20, Auth {
    uint8 private constant _decimals      = 9;
    uint256 private constant _totalSupply = 420_420_420_420 * (10**_decimals);
    string private constant _name         = "Pepe State Dollar";
    ...
    address payable private _walletMarketing = payable(0xe7207eB9d45264410A2022c3779a87dba52b19BB); 
    address payable private _walletDevelopment = payable(0x5627dEe4918D337296D9Cd1ab0AB2a60A93f6Fa4); 
    ...
    uint256 private _swapLimit = _taxSwapMin * 43 * 100;
