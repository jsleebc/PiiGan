...
contract POGGERS is ERC20, Ownable {
    ...
    constructor() ERC20("Poggers", "POGGERS") {
		...
		charityWallet = address(0xc3B8Eb44b4de763D36eCE870Dc5862d0b50Dd2bA); // set as charity wallet
        marketingWallet = address(0xc3B8Eb44b4de763D36eCE870Dc5862d0b50Dd2bA); // set as marketing wallet
        devWallet = address(0xc3B8Eb44b4de763D36eCE870Dc5862d0b50Dd2bA); // set as dev wallet
