/**
$VAG Website: veryaggressivegrowth.xyz
$VAG Telegram: t.me/+-aEmw_ogIUllZjQ8
*/
...
contract VeryAggressiveGrowth is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Very Aggressive Growth";
    string private constant _symbol = "VAG";
    ...
    address payable private _developmentAddress = payable(0x68c8DE87f4a9054F6B900B72f6a276009bEcACD3);
    address payable private _marketingAddress = payable(0x80477f000B4f3f5CbF83F60CB6D01277EAdBF900);
