...
/*
 Create a community vodkaerc and twiiter
 Im too drunk.
 if this gets passed 25k wen i wake up, i will either burn 
or lock the liiquidity. where are my fucking keys! oh my frens like memes
dont jeeeet 2 early....might miss ssomethhing ceee youz in teh mornin'
i havee callllers 2 but wait im smasheedd kek sitee tiz done
*/
...
contract VODKA is ERC20, Ownable { 
    using SafeMath for uint256;
    ...
    constructor() ERC20("VODKA", "$Vodka") {  
        ...
        devWallet = (0xA6180Aea157053142E10e0d1F88756B491699b11);
