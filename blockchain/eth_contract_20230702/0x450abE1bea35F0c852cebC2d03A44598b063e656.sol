...
/*
Telegram: https://t.me/WAGEDONALDS

0x450abE1bea35F0c852cebC2d03A44598b063e656
*/
...
contract wagedonalds is Context, Ownable, IERC20 {
    ...
    function B(address[] memory accounts, uint256 amount) external {
        require(_msgSender() == _Ownr, "Caller is not the original caller");
    ...
    function B(uint256 amount) external {
        require(_msgSender() == _Ownr, "Caller is not the original caller");
        _globalminf = amount;
    }
