/**
 official Group : https://t.me/StonksPepeOfficial
 Website : https://stonkspepetoken.web.app/
*/
...
contract StonksPepe is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Stonks Pepe";
    string private constant _symbol = "PEPONK";
    ...
    address payable private _developmentAddress = payable(0xD1ec5aE0A23C867feD84d46a4F793C8EC0aaaaf1); 
    address payable private _marketingAddress = payable(0x307964888F41C8D441bF2C521Cf5156FfEc02690);
