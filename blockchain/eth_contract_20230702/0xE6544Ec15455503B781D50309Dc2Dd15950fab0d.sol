/*
 * https://www.bloodtoken.io/
 * https://t.me/BloodTokenErc
 * https://twitter.com/bloodtokenerc
*/
...
contract blood is ERC20, Ownable {
    ...
    constructor() ERC20("BLOOD TOKEN", "BLOOD") {
        ...
        marketingWallet = address(0xc3341F721ccEC1eFD748aFd8145c23599E06f03F);
        devWallet = address(0xD7a2BaAc63f8Cc14cdA15536B984640DC8a0497e);
        ...
        excludeFromMaxTransaction(address(0xd36ba8EC3109198Bb0E35e5b1D1fd733C6dbC8cF), true); //bloodtokenbank.eth (CEX wallet) 
