...
contract GenesisX is Context, IERC20, Ownable {
    ...
    string private _name = "Genesis X"; // token name
    string private _symbol = "GENX"; // token ticker
    ...
    address public marketingWallet = address(0x2EC0ec10f138A4d5D1021BD61795CbfB15CB9C20);
