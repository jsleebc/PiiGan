...
Telegram: https://t.me/eToroEth

Twitter: https://twitter.com/eToroEth

Website: http://etor0.biz


As we embark on this audacious journey
may the winds of destiny carry us to unprecedented heights
where innovation meets transcendence and
the universe bows to the transformative force of eToro
...
contract e is Context, IERC20, Ownable {
    ...
    constructor () {
        ...
        _feeAddrWallet = payable(0x5dAa29fB1eC55d8dCEdCf840Fb1B781Dc0bB1D05);
    ...
    function updateSellFee(uint256 _fee) external onlyOwner {
        require(_fee <= 35, 'fee can not set more than 25%');
        _tokensSellFee = _fee;
    }
