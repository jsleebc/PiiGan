...
contract XECRETETHEREUM is Context, IERC20, Ownable {
    ...
    string private constant _name = "Xecret";
    string private constant _symbol = "$XECRET";
    ...
    function setFees(uint256 newLiquidityBuyFee, uint256 newMarketingBuyFee, uint256 newLiquiditySellFee, uint256 newMarketingSellFee) public onlyOwner {
        require(newLiquidityBuyFee.add(newMarketingBuyFee) <= 20, "Buy fee can't go higher than 25");
        buyFee.liquidity = newLiquidityBuyFee;
        buyFee.marketing= newMarketingBuyFee;

        require(newLiquiditySellFee.add(newMarketingSellFee) <= 20, "Sell fee can't go higher than 25");
