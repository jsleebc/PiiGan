...
contract DH is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0x56d51949fACE9Ed258aBFFc9AC454B9C59aE05ea);
    address payable private _marketingAddress = payable(0x56d51949fACE9Ed258aBFFc9AC454B9C59aE05ea);
