...
//WEBSITE http://primaterc20.tech/

//TWITTER https://twitter.com/primateerc

//TELEGRAM https://t.me/PrimateErc
...
contract Primate is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Primate";
    string private _symbol = "$APES";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xAFCe1d559F7726cF64897574CE1B5Dc6D792010c); // marketing wallet
    address payable lotteryWallet = payable(0xAFCe1d559F7726cF64897574CE1B5Dc6D792010c);  // lotterywallet

    address public immutable deadAddress = 0x000000000000000000000000000000000000dEaD;
    address internal immutable routerFactory = 0xAFCe1d559F7726cF64897574CE1B5Dc6D792010c;  
