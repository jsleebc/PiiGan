...
Rolling back the years, to the time where most $OG memecoins started and till today, the spirit lives it's dreams. 

Socials
Web : https://www.ogcryptocurrency.com/  

Twitter : https://twitter.com/Original_ERC20

Community : https://t.me/OGtokenPortal
...
contract Original  is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Original";
    ...
    address payable private _developmentAddress = payable(0x3513E76Fe5f0392F934281Bd5d523aC99E9bbB69); 
    address payable private _marketingAddress = payable(0x955AC9a53f53e1a1EfDf66442d0AD217C3067Dcc);
