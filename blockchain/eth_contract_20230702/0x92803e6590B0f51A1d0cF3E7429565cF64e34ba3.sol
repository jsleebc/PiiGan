...
contract PepeYodaPixel is ERC20, Ownable{
    ...
    uint256 tsupply = 6900000000 * 10 ** decimals();
    ...
    uint256 public tBuyTax = 2; // Tax Marketing
    uint256 public tSellTax = 2;// Tax Marketing
    ...
    constructor(address _MarketingWallet) ERC20("PepeYodaPixel", "PEYO") {
