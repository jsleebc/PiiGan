...
abstract contract Project {
    address public marketingWallet = 0x10750A9D962870e2f96FDeFEE6AeB3794C15849E;
    address public devWallet = 0x10750A9D962870e2f96FDeFEE6AeB3794C15849E;

    string constant _name = "Aszenso";
    string constant _symbol = "ASZENSO";
    ...
    uint256 public swapTreasuryFee    = 15;
 ...
 * MainContract
 */
contract aszContract is Project, IERC20, Ownable {
    ...
    constructor () {
        ...
        contractRouter = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D); //Mainnet & Testnet ETH
         // Create a uniswap pair for this new token
        uniswapV2Pair = IUniswapV2Factory(contractRouter.factory()).createPair(address(this), contractRouter.WETH());
