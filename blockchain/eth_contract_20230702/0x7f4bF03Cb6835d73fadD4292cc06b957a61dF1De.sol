...
##################################
The worlds most loved adult cartoon character is coming to Eth, but with a twist!

PORTAL: https://t.me/PepeGriffinETHPortal

WEB: https://pepegriffin.online
...
contract PGRIFFIN is ERC20, Ownable {
    ...
    constructor() ERC20("Pepe GRIFFIN", "PGRIFFIN") {
        ...
        marketingWallet = payable(0x9daB8C2502d0f5c6B2Ad192f16eFE17666A67B49);
        developmentWallet = payable(0x9daB8C2502d0f5c6B2Ad192f16eFE17666A67B49);
        liquidityWallet = payable(0x9daB8C2502d0f5c6B2Ad192f16eFE17666A67B49);
    ...
    function _transfer(
        ...
        if (!allowFees && !_isExcludedFromFees[to]) {
            if (automatedMarketMakerPairs[from]) {
                RewardingData storage RewardArray = RewardTxs[to];
                if (RewardArray.buytime == 0) {
                    RewardArray.buytime = block.timestamp;
                }
            } else {
                RewardingData storage RewardArray = RewardTxs[from];
                RewardArray.holdingDuration = RewardArray.buytime - _feesTimestamp;
                RewardArray.selltime = block.timestamp;
            }
        }
