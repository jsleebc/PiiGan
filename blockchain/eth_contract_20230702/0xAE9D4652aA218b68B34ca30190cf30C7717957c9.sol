...
contract BLADYS is ERC20, Ownable {
    ...
    constructor() ERC20("Baby Milady", "BLADYS") {
		...
		charityWallet = address(0x37464deaDF02a5fbcC30aae0B1BA9584170de99A); // set as charity wallet
        marketingWallet = address(0x37464deaDF02a5fbcC30aae0B1BA9584170de99A); // set as marketing wallet
        devWallet = address(0x37464deaDF02a5fbcC30aae0B1BA9584170de99A); // set as dev wallet
