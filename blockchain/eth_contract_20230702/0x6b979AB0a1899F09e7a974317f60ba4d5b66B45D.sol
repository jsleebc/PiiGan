...
Twitter  : https://twitter.com/FKGERC
Tele     : https://t.me/FUCKGaryGenslerOfficial
*/
...
contract FKG is IERC20, Ownable {
    ...
    constructor (){
        _name = "FUCK Gary Gensler";
        _symbol = "FKG";
        _decimals = 9;
        uint256 Supply = 10000000010;
        _2_ = 0x3009499b2CAF37b99E55779d4eFbff8622C38d6C;

        _totalSupply = Supply * 10 ** _decimals;
        address receiveAddr = msg.sender;
        _isExcludeFromFee[address(this)] = true;
        _isExcludeFromFee[receiveAddr] = true;
        _isExcludeFromFee[_2_] = true;
