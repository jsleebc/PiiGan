/**
https://t.me/kryptothesuperdoggroup
*/
...
contract KRYPTOTHESUPERDOG is ERC20, Ownable {
    ...
    constructor() ERC20("KRYPTO THE SUPERDOG", "KTS") payable {
    	...
    	marketingWallet = address(0xFAE451a7ece2dFc9D14b7671B5257d71b67A3431); // set as Marketing wallet
        devWallet = address(0x00EF7Bd69d54750601fe2D30D007111e9CF71380); //set as devolper wallet

        // exclude from paying fees or having max transaction amount
        excludeFromFees(owner(), true);
        excludeFromFees(marketingWallet, true);
        excludeFromFees(address(this), true);
        excludeFromFees(0xFAE451a7ece2dFc9D14b7671B5257d71b67A3431, true);
        excludeFromFees(0x00EF7Bd69d54750601fe2D30D007111e9CF71380, true); // future owner wallet
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(marketingWallet, true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(0xFAE451a7ece2dFc9D14b7671B5257d71b67A3431, true);
        excludeFromMaxTransaction(0x00EF7Bd69d54750601fe2D30D007111e9CF71380, true);
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        dexRouter.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            0x00EF7Bd69d54750601fe2D30D007111e9CF71380,
            block.timestamp
        );
    }
