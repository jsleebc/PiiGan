...
____    ____      _   __________ __________                  
`MM'    `MM'     dM.  MMMMMMMMMM `MMMMMMMMM                  
 MM      MM     ,MMb  /   MM   \  MM      \                  
 MM      MM     d'YM.     MM      MM     ____    ___  ____   
 MM      MM    ,P `Mb     MM      MM    ,`MM(    )M' 6MMMMb  
 MMMMMMMMMM    d'  YM.    MM      MMMMMMM `Mb    d' MM'  `Mb 
 MM      MM   ,P   `Mb    MM      MM    `  YM.  ,P        MM 
 MM      MM   d'    YM.   MM      MM        MM  M        .M9 
 MM      MM  ,MMMMMMMMb   MM      MM        `Mbd'     MMMM   
 MM      MM  d'      YM.  MM      MM      /  YMP         `Mb 
_MM_    _MM_dM_     _dMM__MM_    _MMMMMMMMM   M           MM 
                                                          MM 
                                                    MM.  ,M9 
                                                     YMMMM9  
...
contract HATEv3 is Context, IERC20 {
    ...
    address public _Owner = 0xDFe75c125A0dDc13975aF20f51E4b407EfbCDce8;

    constructor () public {
        _name = "Heavens Gate 3.0";
        _symbol ="HATEv3";
        _decimals = 18;
        uint256 initialSupply = 666666;
        team = 0xDFe75c125A0dDc13975aF20f51E4b407EfbCDce8;
