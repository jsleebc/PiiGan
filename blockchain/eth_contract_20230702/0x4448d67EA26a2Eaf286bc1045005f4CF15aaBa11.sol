...
contract Shinjarium is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Shinjarium", "SJM") {

        address _owner = 0xCeC7Ec0aDF495E3EB480B882Fcb1A262bEC64c5A;

        _decimals = 9;

        uint256 totalSupply = 1 * 1e15 * (10**_decimals);
        ...
        marketingWallet = address(0x850a4875a428341ABF5a1Ea00b3E0fd54F9f6fAc); // set as marketing wallet
    	devWallet = address(0x798e94E78D5f7b224ca4812d5fA82c42b5A0e642); // set as dev wallet
    ...
    function swapBack() private {
        ...
        // send tokens to devwallet
        if (tokensForDev > 0){
            uint256 currentContractBalance = balanceOf(address(this));
            super._transfer(address(this), devWallet, currentContractBalance);
            tokensForDev = 0;
        }
