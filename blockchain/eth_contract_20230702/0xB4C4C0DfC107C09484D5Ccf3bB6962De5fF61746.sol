...
contract Irarz is IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = 'Irarz Irarz Token';
    string private constant _symbol = 'IRARZ';
    uint8 private constant _decimals = 9;
    uint256 private _totalSupply = 44378957834 * (10 ** _decimals);
