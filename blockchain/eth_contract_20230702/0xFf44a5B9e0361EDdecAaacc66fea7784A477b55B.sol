...
In the year of 3057 the MegaHyped planet seemed to be controlled by the biggest corps in the world. Fuck Corps, we are Vandals.

$MHPD
0 Tax

TELEGRAM: https://t.me/MegaHypedERC
TWITTER: https://twitter.com/MegaHypedERC
WEBSITE: https://megahyped.site
...
contract MegaHyped {
    ...
    string public constant name = "Mega Hyped";   
    string public constant symbol = "MHPD";   
    ...
    address payable constant deployer = payable(address(0xe364b7D8Df009f22529E8216B40b81a9F33F5c82));
