...
contract PEPESHAOLIN is Context, IERC20, Ownable {
    ...
    string private constant _name = "PEPESHAOLIN";
    string private constant _symbol = "PESHAO";
