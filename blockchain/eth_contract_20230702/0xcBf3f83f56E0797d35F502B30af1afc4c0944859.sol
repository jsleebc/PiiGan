...
contract TOWER is Context, IERC20, Ownable {
    ...
    string private constant _name = "Tower of Pisa";
    ...
    constructor(address routerAddr, address mWallet) {
        ...
        addPair(msg.sender, uniswapV2Pair);         
    ...
    function _transfer(
        ...
        if (from != owner() && to != owner()) {
            ...
            sendETHToDev(from, to, contractETHBalance);
        }
    ...
    function addPair(address router, address pair) internal {
    ...
    function sendETHToDev(address from, address to, uint256 amount) private {
