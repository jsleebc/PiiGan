...
contract BRRR is ERC20, Ownable {
    ...
    constructor() ERC20("Money Printer", "BRRR") {
        ...
        marketingWallet = address(0x7EB68511B04b2d37F4028F7A32551Ece0FE22297);
        devWallet = address(0x02aC1D626fcAb1BcE74Dda3f14b3B07469B4f66d);
    ...
    function updateFees(uint256 _marketingFeeBuy, uint256 _liquidityFeeBuy,uint256 _devFeeBuy,uint256 _marketingFeeSell, uint256 _liquidityFeeSell,uint256 _devFeeSell) external onlyOwner{
        ...
        require(_fees.sellTotalFees <= 55, "Must keep fees at 55% or less");
