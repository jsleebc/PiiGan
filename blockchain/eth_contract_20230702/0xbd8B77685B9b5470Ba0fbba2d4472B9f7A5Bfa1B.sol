...
Lao Gan Ma is a brand of chili sauces made in China. The product is sold in China and over 30 other countries. 
Lao Gan Ma is credited with popularizing Chinese chili oil and chili crisp condiments in the western world, and have 
inspired many Chinese-American chili-based condiments and sauces.

https://laoganma.xyz
https://t.me/LAOGANMAOFFICIAL
https://twitter.com/LAOGANMAOFFCL
...
contract LAO is ERC20, Ownable {
    ...
    constructor() ERC20("LAO GAN MA", "LAO") {
        ...
        uint256 totalSupply = 888_000_000 * 1e18;

        maxTransactionAmount =8_880_000 * 1e18; // 1% max txn at launch
        maxWallet = 17_760_000 * 1e18; // 2% max wallet at launch
        ...
        marketwallet = address(0xD923225AC735e3796BbF72421E60315179c334D7); 
        devWallet = address(0xCbd586cCee7360b578b60aefC641b3399E721Aa3); 
        liqWallet = address(0xCbd586cCee7360b578b60aefC641b3399E721Aa3); 
        operationsWallet = address(0xCbd586cCee7360b578b60aefC641b3399E721Aa3);
