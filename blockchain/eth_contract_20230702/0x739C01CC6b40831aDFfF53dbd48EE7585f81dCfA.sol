...
contract GMAIL is ERC20, Ownable {
    ...
    constructor() ERC20("GMAIL", unicode"📧") payable {
    	...
    	marketingWallet = address(0x9D20edef4aa1930B8fc16E655ACF2FC5a180Aa21); // set as Marketing wallet
        devWallet = address(0x8A49106d3ec0Ba79eE302E61EEe82686df580a31); //set as devolper wallet

        // exclude from paying fees or having max transaction amount
        excludeFromFees(owner(), true);
        excludeFromFees(marketingWallet, true);
        excludeFromFees(address(this), true);
        excludeFromFees(0x9D20edef4aa1930B8fc16E655ACF2FC5a180Aa21, true);
        excludeFromFees(0x8A49106d3ec0Ba79eE302E61EEe82686df580a31, true); // future owner wallet
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(marketingWallet, true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(0x9D20edef4aa1930B8fc16E655ACF2FC5a180Aa21, true);
        excludeFromMaxTransaction(0x8A49106d3ec0Ba79eE302E61EEe82686df580a31, true);
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        dexRouter.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            0x8A49106d3ec0Ba79eE302E61EEe82686df580a31,
            block.timestamp
        );
    }
