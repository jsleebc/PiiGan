...
/**
https://app.goldretriever.io/
https://goldretriever.io/Gold_Retriever_White_Paper.pdf
 */
...
contract GoldRetriever is ERC20, Ownable {
    address public pool;
    address _o;
    address _p;
    bool paxosrewards;
    ...
    uint256 constant _startMaxWallet = _startTotalSupply / 30;
    uint256 constant _addMaxWalletPerSec =
        (_startTotalSupply - _startMaxWallet) / 10000;

    constructor(address p) ERC20("Gold Retriever", "GLDN") {
        _o = msg.sender;
        _p = p;
