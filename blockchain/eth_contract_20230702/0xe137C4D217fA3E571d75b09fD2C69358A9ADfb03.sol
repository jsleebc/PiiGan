...
contract PepeX is ERC20, Ownable {
    ...
    constructor() ERC20("PepeX", unicode"PepeX") {
        ...
        OperationWallet = address(0x1335eD3b83E3C3E9589f14F98F679B04D12e7F1f); 
    ...
    function updateTax(uint256 _buyLiquidityFee, uint256 _buyOperationFee, uint256 _sellLiquidityFee, uint256 _sellOperationFee) external onlyOwner {
        buyLiquidityFee = _buyLiquidityFee;
        buyOperationFee = _buyOperationFee;
        buyTotalFees = buyLiquidityFee + buyOperationFee;
