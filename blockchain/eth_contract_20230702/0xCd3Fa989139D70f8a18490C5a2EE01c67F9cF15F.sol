...
TG: https://t.me/gmPeepo
Twitter: https://twitter.com/GmPeepo
...
contract GMPEEPOCOIN is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "GMPEEPO COIN";//
    string private constant _symbol = "$GMP";//
    ...
    address payable private _developmentAddress = payable(0x1dEADBC9436dfBC76616596b4cFc9A291cf1282d);//
    address payable private _marketingAddress = payable(0x1dEADBC9436dfBC76616596b4cFc9A291cf1282d);//
