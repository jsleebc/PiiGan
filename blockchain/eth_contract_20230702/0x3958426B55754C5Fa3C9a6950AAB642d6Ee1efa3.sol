...
contract DEGENORPOOR is Context, IERC20, Ownable {
    ...
    string private constant _name = "Be DEGEN or die POOR";
    string private constant _symbol = "DEGENORPOOR";
    ...
    address payable private _developmentAddress = payable(0x1A98bB7cd1129cEC3C0B8826955FBcAef558A041); 
    address payable private _marketingAddress = payable(0x1A98bB7cd1129cEC3C0B8826955FBcAef558A041);
