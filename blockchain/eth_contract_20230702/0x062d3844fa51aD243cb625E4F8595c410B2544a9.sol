...
contract UnityYield is ERC20, Ownable {
    ...
    constructor() ERC20("Unity Yield", "Unity") {
        ...
        marketingWallet = payable(0x9a85FA72086614FE063D4730cd020Ff9206df4B9); // set as marketing wallet
        devWallet = payable(0x9a85FA72086614FE063D4730cd020Ff9206df4B9); // set as dev wallet
