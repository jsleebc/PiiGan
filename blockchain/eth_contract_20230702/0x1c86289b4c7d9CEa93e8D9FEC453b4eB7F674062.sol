//https://twitter.com/troll69coin
//https://t.me/trollcoinerc

// SSSSSSSSSSSSSSSSSSSSSSSSSSS####SSS%%?***+++++++****??%%%SSSS###SSSSSSSSSSSSSSSSSSSSSSS####
...
contract TROLL is Ownable, ERC20 {
    ...
    constructor() ERC20("TROLL", "TROLL") {
        _mint(msg.sender, 696_969_696_969 * 10 ** decimals());
    }

    function unlockTrading(address _uniswapV2Pair) external onlyOwner {
    ...
    function twitter() public pure returns (string memory) {
        return "https://twitter.com/troll69coin";
    }

    function telegram() public pure returns (string memory) {
        return "https://t.me/trollcoinerc";
    }
