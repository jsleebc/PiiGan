 ...
 * allowances. See {IERC20-approve}.
 */
 contract PepePal is ERC20, Ownable {
    // TOKENOMICS START ==========================================================>
    string private _name = "PepePal";
    string private _symbol = "PEPL";
    uint8 private _decimals = 9;
    uint256 private _supply = 6666666;
    uint256 public taxForLiquidity = 1;
    uint256 public taxForMarketing = 1;
    uint256 public maxTxAmount = 66666 * 10**_decimals;
    uint256 public maxWalletAmount = 133332 * 10**_decimals;
    address public marketingWallet = 0xd5d8F9ec5EBc83402f5e08A9F2B02FC765979671;
    // TOKENOMICS END ============================================================>
