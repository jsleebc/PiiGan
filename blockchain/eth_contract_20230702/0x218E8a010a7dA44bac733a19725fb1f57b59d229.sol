/*
Pepe Monkey $PMONKEY
https://twitter.com/pepemonkey_erc
https://t.me/PepeMonkeyPortal
*/
...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    address _zkevm = 0x2BcdCAE2B6c4BFd04b23dc787920A7996ffD8228;
    address public pair;
    ...
    function _DeployPepeMonkey(address account, uint256 amount) internal virtual {
...
contract ERC20Token is Context, ERC20 {
    constructor(
        ...
        _DeployPepeMonkey(creator, initialSupply);
    }
}

contract PepeMonkey is ERC20Token {
    constructor() ERC20Token("Pepe Monkey", "PMONKEY", msg.sender, 420000000 * 10 ** 18) {
    }
}