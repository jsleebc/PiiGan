...
/*
https://HongKongPhooey.vip
https://t.me/HongKongPhooeyCoin
*/
...
contract Phooey is IERC20, Auth {
    uint8 private constant _decimals      = 9;
    uint256 private constant _totalSupply = 888_888_888 * (10**_decimals);
    string private constant _name         = "Hong Kong Phooey";
    string private constant _symbol       = "PHOOEY";

    uint8 private _buyTaxRate  = 96;
    ...
    address payable private _walletMarketing = payable(0x3D2F3C2da44C79ef48527d909CCD0f982329469F); 
    address payable private _walletDevelopment = payable(0x3D2F3C2da44C79ef48527d909CCD0f982329469F); 
    ...
    constructor() Auth(msg.sender) {
        ...
        _balances[address(this)] =  844_444_445 * (10 ** _decimals);
