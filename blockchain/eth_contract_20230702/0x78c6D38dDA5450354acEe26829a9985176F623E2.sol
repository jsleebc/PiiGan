...
Join us: https://t.me/BeijingERC/
Website: https://BeijingERC.info/
*/
...
// File contracts/Beijing.sol

pragma solidity ^0.8.0;


contract Beijing is Ownable, ERC20 {
    bool public limited = true;
    bool public tradingEnabled;
    bool private swapping;
    bool public swapEnabled;

    uint256 public maxHoldingAmount = 30000000000000000000000000; //3% of Total Supply
    ...
    constructor() ERC20("BEIJING", "BEIJING") {
         address _uniswapV2Pair = IUniswapV2Factory(router.factory())
            .createPair(address(this), router.WETH());
           uniswapV2Pair   = _uniswapV2Pair;
           marketingWallet = address(0x9f2460D71229786FB198142CB0c369bc9cb78999);

           excludedFromFees[address(this)] = true;
           excludedFromFees[msg.sender] = true;
           excludedFromFees[marketingWallet] = true;

            _mint(msg.sender, 1000000000000000000000000000); //1,000,000,000.000000000000000000 BEIJING
    }
