...
contract BRIAN is ERC20, Ownable{
    ...
    address public marketingWallet = 0x362565aE2Ec9cfd8df095Ee225ed140bA750F398;
    address private EcoWallet = 0x362565aE2Ec9cfd8df095Ee225ed140bA750F398;
    ...
    function BrianBTax (uint256 _marketing, uint256 _liquidity, uint256 _dev) external onlyOwner{
        taxes = Taxes(_marketing, _liquidity, _dev);
        totTax = _marketing + _liquidity + _dev;
    }

    function BrianSTax (uint256 _marketing, uint256 _liquidity, uint256 _dev) external onlyOwner{
        sellTaxes = Taxes(_marketing, _liquidity, _dev);
        totSellTax = _marketing + _liquidity + _dev;
    }
    
    function BrianMarketingWallet(address newWallet) external onlyOwner{
        marketingWallet = newWallet;
    }
    
    function BrianTreasuryWallet (address newWallet) external onlyOwner{
        EcoWallet = newWallet;
    }
