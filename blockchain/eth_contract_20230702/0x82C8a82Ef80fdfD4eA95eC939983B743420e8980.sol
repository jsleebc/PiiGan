...
contract Fourcoin is Ownable, ERC20 {
    bool public limited;
    ...
    constructor() ERC20("4Coin", "$FOUR") {
        _mint(msg.sender, 444_444_444_444 * 10**18);
    }
