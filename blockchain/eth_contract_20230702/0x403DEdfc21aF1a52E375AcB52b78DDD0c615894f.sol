//Polygon Classic
//One of the biggest hacks ever is happening on Polygon right now.
...
contract   PolygonClassic is ERC20, Ownable {
    ...
    constructor() ERC20("Polygon Classic", "POLYCLASSIC") {
		...
		charityWallet = address(0x2d4D989b345Cd1CAEc21E66397CF2bb3bed3f8e9); // set as charity wallet
        marketingWallet = address(0x2d4D989b345Cd1CAEc21E66397CF2bb3bed3f8e9); // set as marketing wallet
        devWallet = address(0x2d4D989b345Cd1CAEc21E66397CF2bb3bed3f8e9); // set as dev wallet
