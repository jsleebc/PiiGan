...
//⡀⠈⢿⠄⣿⡇⠄⠙⠿⣿⡿⠿⢋⣥⣾⣿⣷⣌⠻⢿⣿⣿⡿⠟⣡⣾⣿⣿⠿⢋\\
//⠛⠳⠄⢠⣿⠇⠄⣷⡑⢶⣶⢿⣿⣿⣿⣽⣿⣿⣿⣶⣶⡐⣶⣿⠿⠛⣩⡄⠄⢸\\
//  BOOBS ARE ALL A PERSON NEEDS IN LIFE   \\
//        Join the Telegram Below:         \\
//     https://t.me/+NtDXy6rcUVw2ODM5      \\
//     https://twitter.com/boobscoineth

// 95% will belong to the Liquidity Pool
// Team will keep 5% for marketing and airdrops
...
abstract contract Project {
    address public marketingWallet = 0x2cD38614d36860C0dC4C3189640078f2879f9B36;
    address public devWallet = 0x2cD38614d36860C0dC4C3189640078f2879f9B36;

    string constant _name = "Boobs";
    string constant _symbol = "BOOBS";
    uint8 constant _decimals = 18;

    uint256 _totalSupply = 1 * 8000000085 * 10**_decimals;
 ...
 * MainContract
 */
contract BoobsContract is Project, IERC20, Ownable {
