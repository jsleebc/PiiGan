               ...
               ==:.    .==.        =@%%= =.               :=         .+=#+++-          -+++#********
                .-======.          +@@-= -                 :=-:....-==. :**++=        -+++*#********
                                   ...
                                   -.    -                                 :*++=.   :++++#**********
                                         ...
                                         =                                       +******************
                                         =                                       ******************#
 https://twitter.com/DrPepeErc20
 https://t.me/doctorpepeportal
 */
 ...
 contract DrPepe is ERC20, Ownable {
     ...
     constructor() ERC20("Doctor Pepe", "DrPepe") {
         ...
         maxTransactionAmount = (totalSupply * 100) / 100; // 100% of total supply (no limits)
         maxWallet = (totalSupply * 2) / 100; // 2% of total supply
         
         swapTokensAtAmount = (totalSupply * 5) / 10000; // 0.05% swapback trigger
         maxTokensForSwapback = (totalSupply * 100) / 1000; // 10% max swapback
        
         buyFee = 45;
         sellFee = 55;
 
         marketingWallet = address(0x82cD5e53BB9179f6Cebb4E2E6716Eb7f933662e9); 
     ...
     function updateFees(uint256 _newBuyFee, uint256 _newSellFee
     ) external onlyOwner {
         buyFee = _newBuyFee;
         sellFee = _newSellFee;
     }
