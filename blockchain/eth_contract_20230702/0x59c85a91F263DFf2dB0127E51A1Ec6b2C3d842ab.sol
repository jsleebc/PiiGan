...
The all new ultimate crypto wallet is here to take over the space. Blind eye was created by a team of professionals who have been in this market for years on end and have came together to piece their knowledge to build blind eye.
...
contract BlindEye is Context, IERC20, Ownable {
    ...
    string private _name = "BLIND EYE"; // token name
    string private _symbol = "BEYE"; // token ticker
    ...
    address public marketingWallet = address(0x924f1f7a42f0a134b7c911f32b38fDacAE12ff68);
