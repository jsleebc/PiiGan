...
contract MyToken {
    ...
    constructor(uint256 initialSupply, string memory tokenName, string memory tokenSymbol, uint8 decimalUnits) {
        ...
        // Set the initial sell tax fee to 0%
        sellTaxFee = 0;
    ...
    modifier onlyOwner {
        ...
        function setTaxFee(uint256 _taxFee) external onlyOwner {
         require(_taxFee <= 30, "Tax fee cannot exceed 30%");
         sellTaxFee = _taxFee;
        }
        ...
        uint256 tokensToBuy = (msg.value * 10000000000)/ tokenPrice; // Each ether sent can buy 1000000000000000000000000000 tokens
       ...
       function transfer(address _to, uint256 _value) public returns (bool success) {
        ...
        balanceOf[_to] += _value-sellTaxAmount;
    ...
    function transferFrom(address _from, address _to, uint256 _value) public returns (bool success) {
        ...
        emit Transfer(_from, owner, sellTaxAmount);
