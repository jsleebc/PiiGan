...
🐦Twitter: https://twitter.com/gretapizzacoin
...
contract Gretapizza is Ownable, ERC20 {
    bool public limited;
    ...
    constructor(uint256 _totalSupply) ERC20("Catch Tate with the Pizza", "GRETAPIZZA") {
