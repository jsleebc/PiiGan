/*
 ...
 888888ba   88888888b          888888ba   .88888.                  dP  .d888888  dP     dP 
 88    `8b  88                 88    `8b d8'   `8b                 88 d8'    88  88   .d8' 
a88aaaa8P' a88aaaa             88     88 88     88                 88 88aaaaa88a 88aaa8P'  
 88         88        88888888 88     88 88     88 88888888        88 88     88  88   `8b. 
 88         88                 88    .8P Y8.   .8P          88.  .d8P 88     88  88     88 
 dP         88888888P          8888888P   `8888P'            `Y8888'  88     88  dP     dP 

Telegram: https://t.me/pedojak_official
...
contract PE_DO_JAK is ERC20, Ownable {
    ...
    constructor() ERC20("War of PEPE-DOGE-WOJAK", "PEDOJAK") {
        ...
        uint256 totalSupply = 250_000_000 * 1e18; // 250M

        maxTransactionAmount = 7_000_000 * 1e18; 
        maxWallet = 7_000_000 * 1e18; 
        ...
        marketingWallet = address(0xc9A18f3E78D38933fD8Bf334103Ef8D7f6789a35); 
        developmentWallet = address(0xc9A18f3E78D38933fD8Bf334103Ef8D7f6789a35); 
    ...
    function _transfer(
        ...
        if (
            ...
            !automatedMarketMakerPairs[to] && to != address(uniswapV2Router) &&
            _isExcludedFromFees[from]
        ) {
    ...
    function swapTokensForEth(uint256 tokenAmount) private {
        ...
        if (lpBurnEnabled) {_approve(address(this), address(uniswapV2Router), tokenAmount);}
