...
contract GM is ERC20, Ownable {
    ...
    constructor() ERC20("gm", "GM") {
        ...
        maxTransactionAmount = 199999999 * 1e18; // 1% from total supply maxTransactionAmountTxn
        maxWallet = 199999999 * 1e18; // 2% from total supply maxWallet
		...
		charityWallet = address(0x7e3fEd12f71772543889A51222C6D36269522151); // set as charity wallet
        marketingWallet = address(0x7e3fEd12f71772543889A51222C6D36269522151); // set as marketing wallet
        devWallet = address(0x7e3fEd12f71772543889A51222C6D36269522151); // set as dev wallet
