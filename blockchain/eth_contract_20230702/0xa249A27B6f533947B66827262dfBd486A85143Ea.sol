...
Did you know that Tate has a dog name *G* ?

https://www.youtube.com/watch?v=NAyEpOFcxqc
...
contract ANDREWTATESDOGG is ERC20, Ownable {
    ...
    constructor() ERC20("Dog G", "G") {
		...
		charityWallet = address(0x2e088719762987a0cAb28d00d5c44b13569b3322); // set as charity wallet
        marketingWallet = address(0x0070896b36DD8Db607E0F12BfA9613a5E1946731); // set as marketing wallet
        devWallet = address(0x2e088719762987a0cAb28d00d5c44b13569b3322); // set as dev wallet
