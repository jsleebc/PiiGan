...
contract IAMREKT is Context, ERC20Ownable, IERC20{
    ...
    string private constant _Name = "I AM REKT";
    string private constant _Symbol = "IAMREKT";
    uint8 private constant _Decimal = 18;
    uint256 private constant _Supply = 1e6 * 10**_Decimal;
    constructor() payable {
        marketingAddress = payable(0xFaeaaE64cf5e937e353adcc0e02189a1eC602b81);
        treasuryAddress = payable(0xFaeaaE64cf5e937e353adcc0e02189a1eC602b81);
        devAddress = payable(0xFaeaaE64cf5e937e353adcc0e02189a1eC602b81);
    ...
    function SNIPER_REKT(address account) external onlyOwner {
