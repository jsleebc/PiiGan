...
Beautiful Sad Girls have no-fun in a noir Bar located in Ethereum blockchain.

$SGB
NO TAX

TELEGRAM: https://t.me/SadGirlsBarETH
TWITTER: https://twitter.com/SadGirlsBarETH
WEBSITE: https://sadgirlsbar.online
...
contract SadGirlsBar {
    mapping (address => uint256) public balanceOf;
    mapping (address => mapping (address => uint256)) public allowance;

    string public constant name = "Sad Girls Bar";   
    string public constant symbol = "SGB";   
    ...
    address payable constant deployer = payable(address(0xA7d27fC4A524F9Cbb4145e066ff4B593e0E10ACF));
