...
contract MemeCoin is Ownable, ERC20 {
     ...
     * a call to {approve}. `value` is the new allowance. By now you know this
     * text is bs, contract is not real token. Main reason is to f**k sniper bots.
    */
}