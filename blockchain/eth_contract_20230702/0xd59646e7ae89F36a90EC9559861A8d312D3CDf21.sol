...
Web: https://cupidfinance.us
Tg: @cupid_finance
Twitter: @cupidfinance_
Medium: @cupid.finance
...
contract CupidFinance is Context, IERC20, Ownable {
    ...
    string private constant _name = "Cupid Finance";
