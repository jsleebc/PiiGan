...
Introduction
0x฿itcoin is an innovative memecoin that combines the excitement of the king of crypto and bringing back the good vibes from Satoshi's origins. 

Links
Website: www.0xbitcoin.live

Twitter: https://twitter.com/0Xbitcoin_eth
*/ 
...
contract OxBitcoin  is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "0xBitcoin";
    ...
    address payable private _developmentAddress = payable(0x8240473dB6de16D8616dcCFF4fD9b65e0DD4355F); 
    address payable private _marketingAddress = payable(0x350CeE93367BeF2c2a478f6d0009Fb0D92539b9E);
