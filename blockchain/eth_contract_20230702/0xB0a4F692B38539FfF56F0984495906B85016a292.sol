...
Welcome to PEPE TRUMP (PTRUMP)

Pepe Trump is a crypto token that cleverly combines the features of two cultural icons - Donald Trump and the internet meme Pepe. The result is a unique digital currency that has caught the attention of both meme enthusiasts and investors alike.

Telegram: https://t.me/pepe_trump_eth
...
contract PTRUMP is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "PTRUMP";
