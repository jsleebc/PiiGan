...
contract WollSmoth is IERC20, Ownable {
    string private constant _name = "Woll Smoth";
    string private constant _symbol = "WOLL";
    ...
    uint256 private _taxFeeOnBuy = 25; //Launch Tax - Final Buy Tax is 0
    uint256 private _taxFeeOnSell = 25; //Launch Tax - Final Sell Tax is 0
    ...
    address payable private constant _developmentAddress =
        payable(0xC11c8017897f24799D42Ea4C479DE45a7EF9DE87);
