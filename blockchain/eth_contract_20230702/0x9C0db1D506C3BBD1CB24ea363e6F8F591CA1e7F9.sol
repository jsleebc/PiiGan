...
/*
Web: https://mrsbobo.vip
Telegram: https://t.me/MrsBoboETH
Twitter: https://twitter.com/MrsBoboETH
*/
...
contract MrsBobo is ERC20, Ownable{
    ...
    constructor(address _devWallet) ERC20("MrsBobo.vip", "MRSBOBO") {
    ...
    function setBuyTaxes(uint256 _liquidity, uint256 _dev) external onlyOwner{
        require(_liquidity + _dev <= 10, "Total buy tax cannot exceed 10%");
    ...
    function setSellTaxes(uint256 _liquidity, uint256 _dev) external onlyOwner{
        require(_liquidity + _dev <= 25, "Total sell tax cannot exceed 25%");
