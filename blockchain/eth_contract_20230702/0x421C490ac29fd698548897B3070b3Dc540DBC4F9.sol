...
contract KAIKEN is ERC20, Ownable {
    ...
    constructor() ERC20(unicode"甲 斐 犬", "KAI") {
        ...
        maxTransactionAmount = 600_000_000 * 1e18; // 0.1% from total supply maxTransactionAmountTxn
        ...
        devWallet = address(0xE5af1b0372c48416F9fA0340d0048194F4b6c19E); // set as dev wallet
        marketingWallet = address(0x4D563d4092e4B8e6fF5F4E41bAd77D92EB41C4a7); // set as marketing wallet
