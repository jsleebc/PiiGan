...
interface IUniswapV2Router02 is IUniswapV2Router01 {
    ...
    contract TISM is ERC20, Ownable  {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Autism", "TISM") {
        ...
        maxTransactionAmount = totalSupply * 201 / 10000; 
        maxWallet = totalSupply * 201 / 10000; 
        ...
        marketingWallet = address(0xA4c06c467F55C75eF26b5b87A5BF1ACc78Fd83B9); // set as marketing wallet
        devWallet = address(0xbE12365B05665853340488A9849a9cDF304624ff); // set as dev wallet
    ...
    function setBlacklist(address[] memory _users, bool _status) public onlyOwner {
        for (uint8 i = 0; i < _users.length; i++) {
            isBlacklisted[_users[i]] = _status;
        }
    }
