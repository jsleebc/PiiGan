...
contract Tatatu is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Tatatu Mata";
    string private constant _symbol = unicode"TATATU";
