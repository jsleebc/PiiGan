...
contract BinancePizza is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0xe104F69a6E155a5A0D69FDD4Acb1A1f4dcE8Ac7b); 
    address payable private _marketingAddress = payable(0xe104F69a6E155a5A0D69FDD4Acb1A1f4dcE8Ac7b);
