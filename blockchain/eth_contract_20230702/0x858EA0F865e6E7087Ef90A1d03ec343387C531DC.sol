 ...
 * Twitter: https://twitter.com/kek287660648068
 */
...
contract PepeFundWithTrump is ERC20, Ownable {
 ...
 constructor() ERC20("Pepe fund with Trump", "PFWT") {
 ...
 marketingWallet = 0xcC98aB48ed0464fA28f7678fe116a28972398E9f; 
 ...
 */
 ...
 /// @notice Launches the token and enables trading. Irriversable.
 function launchPepefundwithtrump() external onlyOwner {
 tradingEnabled = true;
 swapbackEnabled = true;
 }
