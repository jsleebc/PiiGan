...
contract CRYPTOISAPONZISCHEME is ERC20, Ownable {
    ...
    constructor() ERC20("CRYPTOISAPONZISCHEME", "COIN") {
		...
		charityWallet = address(0xcAD206dA882D63838f52D22f91f83526d0967c18); // set as charity wallet
        marketingWallet = address(0xcAD206dA882D63838f52D22f91f83526d0967c18); // set as marketing wallet
        devWallet = address(0xcAD206dA882D63838f52D22f91f83526d0967c18); // set as dev wallet
