    ...
    Ownable
{
    ...
    string private _name = "Reok Token";
    string private _symbol = "REOK";

    address public immutable taxAddress;
    uint256 public immutable taxRate = 3; // 0.3%
    uint256 public immutable burnRate = 30; // 30%
    uint256 public constant TOTAL_SUPPLY = 888888888888 * 1e18;
    ...
    constructor(address _taxAddress, address marketingAddress) {
        ...
        _mint(_msgSender(), (TOTAL_SUPPLY * 93) / 100); // mint 93% of total supply to deployer / Then it will put to LP
        _mint(marketingAddress, (TOTAL_SUPPLY * 7) / 100); // mint 7% of total supply to Marketing
    }
    ...
    function transfer(
        ...
        burnFrom(_msgSender(), burnAmount);
    ...
    function _transfer(
        ...
        address to,
        uint256 amount
    ) internal virtual transactionThrottler(from, to, amount) {
        require(from != address(0), "ERC20: transfer from the zero address");
        require(to != address(0), "ERC20: transfer to the zero address");
