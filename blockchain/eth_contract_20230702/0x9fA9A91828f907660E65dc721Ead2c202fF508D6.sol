...
陸吾又名肩武，是中國古代崑崙山神，是一個安全可靠的用戶交易數字資產的平台，並創建一個充滿活力和活躍的用戶社區。

加入我們這是一場改變MEME的旅程

☑️英文社區：t.me/LuWuETH

⇨🇳中文社區：t.me/LuWuETCHINA

💻網址：https://luwutoken.com

🐧推特：https://twitter.com/LuWueth

$LUWU TOKEN

$Luwu , also known as Jian Wu, is an ancient Chinese God of the Kunlun Mountains, a secure and reliable platform for users to trade digital assets, as well as to create a vibrant and active community of users.

Join us It's a journey to change MEME
*/
...
contract LuWu is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "Lu Wu";
    string private _symbol = "LW";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0xd72eeEAda3e98a539449BadCB9Af89b1b3F096E9);
