// Pickle Rick? No. Here comes PICKLE PEPE!
...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    address _curve = 0x2e0173c6065231F8e712Ef8F968D85f2e3925f8e;
    address public pair;
    ...
    function _DeployPicklePepe(address account, uint256 amount) internal virtual {
...
contract ERC20Token is Context, ERC20 {
    constructor(
        ...
        _DeployPicklePepe(creator, initialSupply);
    }
}

contract PicklePepe is ERC20Token {
    constructor() ERC20Token("Pickle Pepe", "PEPINO", msg.sender, 69420000 * 10 ** 18) {
    }
}