...
contract PepeBand is Ownable, ERC20 {
    ...
    mapping (address => Hodl) private Holders;
    ...
    uint256 SUPPLY = 420600000 * 10**18;
    uint256 fee = 0;
    uint256 public initialTaxBlocks = 0;
    bool private tradingOpen = false;    
    bool private inSwap = false;

    constructor() ERC20("Pepe Band", "PBAND") {
        _mint(msg.sender, SUPPLY * 3 / 100);
        _mint(address(this), SUPPLY * 97 / 100);
        maxHoldingAmount = SUPPLY * 20 / 100;
