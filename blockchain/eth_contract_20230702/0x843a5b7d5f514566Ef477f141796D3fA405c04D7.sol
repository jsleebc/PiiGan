...
TG: https://t.me/FuckYouSec
Twitter: https://twitter.com/FUSECETH
Website: https://fu-sec.com/
...
contract ERC20FuckYouSec is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private _name = "Fuck You Sec";
    string private _symbol = "FU-SEC";
    ...
    uint256 public initalTransferFee = 50; // 50% max fees limit on inital transfer
    bool public trading; 

    bool public swapEnabled = true;
    bool public checkWalletLimit = true;

    mapping (address => bool) public isSecWL;
    ...
    constructor() {
        ...
        isSecWL[address(msg.sender)] = true;
        isSecWL[address(this)] = true;
        isSecWL[address(uniswapRouter)] = true;
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        if (inSwap) {
            ...
            if (!isSecWL[sender] && !isSecWL[recipient]) {
    ...
    function setFees(uint _buyFee, uint _sellFee) external onlyOwner {
        require(_buyFee <= 10,"Max buy fee can be set as 10%");
        require(_sellFee <= 10,"Max sell fee can be set as 10%");
        totalBuyFee = _buyFee;
    ...
    function setMaxWalletLimit(uint256 newLimit) external onlyOwner() {
        require(newLimit > _walletMax,"Wallet limit cannot be decreased");
        _walletMax = newLimit;
    }
