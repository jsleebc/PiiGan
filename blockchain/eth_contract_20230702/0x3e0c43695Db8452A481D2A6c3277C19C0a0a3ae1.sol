...
// |   |   |   _   |   __ \     __|
// |       |       |      <__     |
// |__|_|__|___|___|___|__|_______|
// Web:             https://www.marsrejects.com/
// Twitter:         https://twitter.com/marsrejects
// Pepe Torrado:    https://twitter.com/josecable
// Tiktok:          https://www.tiktok.com/@themarsrejects
// IG:              https://www.instagram.com/marsrejects/
...
contract MARS is ERC20, Ownable {
    ...
    constructor() ERC20("MARS", "MARS") {
        ...
        uint256 totalSupply = 1111111111 * 1e18;
        
        maxBuyAmount = totalSupply * 111 / 10000;
        maxSellAmount = totalSupply * 111 / 1000;
        maxWalletAmount = totalSupply * 111 / 1000;
        swapTokensAtAmount = totalSupply * 200 / 100000; // 0.2% swap amount
        ...
        marketingAddress = 0xBCdc3cfA00a5B7Dd0403FaaDa3C904Cd9a833a19;
