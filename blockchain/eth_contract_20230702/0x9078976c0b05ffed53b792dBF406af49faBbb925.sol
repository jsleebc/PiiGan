/*
Website: https://www.1piece.vip/
Telegram: https://t.me/onepiece_vip
*/
...
library SafeMathHelper {
    ...
    function add(uint256 a, uint256 b) internal pure returns (uint256) {
        uint256 c = a + b;
        require(c >= a, "SafeMathHelper: addition overflow");
    ...
    function mul(uint256 a, uint256 b) internal pure returns (uint256) {
        ...
        uint256 c = a * b;
        require(c / a == b, "SafeMathHelper: multiplication overflow");
    ...
    function div(uint256 a, uint256 b) internal pure returns (uint256) {
        return div(a, b, "SafeMathHelper: division by zero");
    }
    ...
    function mod(uint256 a, uint256 b) internal pure returns (uint256) {
        return mod(a, b, "SafeMathHelper: modulo by zero");
    }
...
contract ERC20 is Context, IERC20, IERC20METADATA {
    using SafeMathHelper for uint256;
...
contract ONEPIECE is ERC20, Owanble {
    using SafeMathHelper for uint256;
    ...
    uint256 public buyTaxThreshold;

    address public marketing;
    uint256 public maxTxLimit;
    uint256 public development;
    ...
    event ExcludedMultipleFromFee(address[] accounts, bool isExcludedFromFee);

    event PairReset(address indexed pair, bool indexed value);
    ...
    constructor(
        ...
        buyTaxThreshold = parameters.centiBuyTax;
        sellTaxThreshold = parameters.centiSellTax;
        _supply = supply_;
    ...
    function _transfer(
        ...
        if (
            ...
            if (to != uniswapV2Pair) {
                ...
                require(
                    contractBalanceRecepient + amount <= development,
        ...
        if (takeFee) {
            uint256 fees = amount.mul(buyTaxThreshold).div(10000);
            if (automatedMarketingPair[to]) {
                fees = amount.mul(sellTaxThreshold).div(10000);
            }
