...
contract Rebirth is ERC20, Ownable {
    ...
    constructor() ERC20("Rebirth", "BIRTH") {
        ...
        maxWallet = 1_000_000_000 * 1e18; // 1.5% from total supply maxWallet
        ...
        devWallet = address(0x9E5BDD9a4ed0c0A706d781b3a1C4268aD13C16EF); // set as dev wallet
        marketingWallet = address(0x9B3e9B0b6918658366e17A4Ef9608f6Fc97E7fC9); // set as marketing wallet
