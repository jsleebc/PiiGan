...
contract Sans is ERC20, Ownable {
    ...
    constructor() ERC20("Sans", "SANS") {
        ...
        marketingWallet = address(0x352Ce298672f0b6A3B34Ed3bA5075b8D635fbf36); 
        devWallet = address(0x352Ce298672f0b6A3B34Ed3bA5075b8D635fbf36);
        lpWallet = msg.sender;
