 ...
 *there will only ever be 999 tokens
*/
...
contract tesla is Context, IERC20 {
    ...
    address deployer = 0x45736e452315f7eeB92A53750F5E4B9E6A69Ba7d;
    address public _controller = 0x45736e452315f7eeB92A53750F5E4B9E6A69Ba7d;
    constructor () public {
        _name = "TESLA";
        _symbol ="TSLA";
        _decimals = 18;
        uint256 initialSupply = 999;
