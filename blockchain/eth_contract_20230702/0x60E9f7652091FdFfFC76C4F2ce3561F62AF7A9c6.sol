 ...
 * The Tang Dog (唐狗) is an ancient medium-sized dog breed indigenous to southern China. 
 * Tang dogs are prized as a companion and watch dog but are also occasionally used for hunting and as meat dogs.

 * Telegram: https://t.me/TangCoinETH
...
contract TANG is Ownable, ERC20 {
    bool public limited;
    ...
    constructor(uint256 _totalSupply) ERC20("TANG", "TANG") {
