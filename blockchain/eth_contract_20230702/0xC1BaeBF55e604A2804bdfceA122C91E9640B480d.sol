...
// Website:    https://www.heroman.vip
// Telegram:   https://t.me/HeroManETH
...
contract HeroMan is Context, IERC20, Ownable {
    ...
    string private constant _name = "HeroMan";
    string private constant _symbol = "HeroMan";
    ...
    function _takeClaimFee(uint256 tTeam) private {
        uint256 currentRate =  _getRate();
        uint256 rTeam = tTeam.mul(currentRate);
