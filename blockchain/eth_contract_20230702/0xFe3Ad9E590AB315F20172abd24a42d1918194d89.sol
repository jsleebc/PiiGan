/*
$PEPEXL the most memeable memecoin in existence. The dogs have had their day, it’s time for PEPEXL to take reign.
Social: 
https://pepexl.club/
https://t.me/pepexlcoineth
...
contract PEPEXL is ERC20, Ownable{
    ...
    uint256 tsupply = 690420000 * 10 ** decimals();
    ...
    uint256 private tBuyTax = 29; // Tax Marketing
    uint256 private tSellTax = 69;// Tax Marketing
    ...
    constructor(address _MarketingWallet) ERC20("PepeXL", "PEPEXL") {
