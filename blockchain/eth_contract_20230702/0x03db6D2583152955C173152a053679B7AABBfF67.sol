/*
Will "Crypto Chad" rise victorious? Or will "Hodl Wojak" show us the true meaning of resilience?
community:
TELEGRAM : https://t.me/wojakbuyersclub 
TWITTER : https://twitter.com/wojakbuyersclub
MEDIUM : https://wojakbuyersclub.medium.com/
**/
...
contract WOJAKBUYERSCLUB is Context, IERC20, Ownable {
    ...
    string private constant _name = "WOJAKBUYERSCLUB";
    ...
    function setFees(uint256 newLiquidityBuyFee, uint256 newMarketingBuyFee, uint256 newLiquiditySellFee, uint256 newMarketingSellFee) public onlyOwner {
        require(newLiquidityBuyFee.add(newMarketingBuyFee) <= 10, "Buy fee can't go higher than 10");
        buyFee.liquidity = newLiquidityBuyFee;
        buyFee.marketing= newMarketingBuyFee;

        require(newLiquiditySellFee.add(newMarketingSellFee) <= 10, "Sell fee can't go higher than 8");
