...
$PEEPO Fumo is a meme based cryptocurrency ERC-20 token operating on the ETH Blockchain ☀️ 
Peepo 👉👈

Initial taxes: 20% / 20% (first 10 transactions)
Later on: 4% / 4%
MEV Protection: ON

Twitter: https://twitter.com/peepotokens
Telegram: https://t.me/peepo_tokens
...
contract PEEPOFUMO is Context, IERC20, Ownable {
    ...
    uint256 private _ts = 1687485400;

    uint8 private constant _decimals = 18;
    uint256 private constant _tTotal = 1000000000 * 10**_decimals;
    string private constant _name = "Peepo Fumo";
    string private constant _symbol = "PEEPO";
    uint256 public _maxTxAmount = _tTotal.mul(3).div(100);     // 3% of total supply
