...
https://www.tiktok.com/@basedaf_?is_from_webapp=1&sender_device=pc
https://www.youtube.com/@Based-AF
https://discord.com/invite/basedaf
...
contract BasedAF is Context , IERC20, Ownable {
    using SafeMath for uint256;

    string private constant _name = "we are BasedAF";
    string private constant _symbol = "BasedAF";
