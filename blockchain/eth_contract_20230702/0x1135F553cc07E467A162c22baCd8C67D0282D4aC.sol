...
https://t.me/Evermoon_ERC20

https://twitter.com/Evermoon_ERC20
...
contract EVERMOON2 is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("EverMoon2.0", "EverMoon2.0") {
        ...
        rewardsSellFee = 30;
        operationsSellFee = 370;
        liquiditySellFee = 0;
        totalSellFees = rewardsSellFee + operationsSellFee + liquiditySellFee;

        dividendTracker = new DividendTracker();
        
        operationsWallet = address(0xc2eF5c09948d1E697b13a27D5bE25BD5b9aC1723); // set as operations wallet
