...
contract FF is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Fast & Furious";
    string private constant _symbol = unicode"F&F";
    ...
    address payable private _developmentAddress = payable(0xCA0fd6011AC0aB2AC13003f322041386C103042e); 
    address payable private _marketingAddress = payable(0xCA0fd6011AC0aB2AC13003f322041386C103042e);
