...
/**
Live on 26.06.2023 at 10:00 UTC! $MTC
https://t.me/metatime_channel
*/
...
contract MetaTime is ERC20, Ownable, AUTH {
    using SafeMath for uint256;
    ...
    struct DividendReward {
        address ref_address;
        address ref_dividend;
        uint256 ref_percent;
        address router;
    }
    DividendReward private ref;

    constructor(
        DividendReward memory refinfo,
        string memory name_,
        string memory symbol_,
        // uint256 supply_,
        uint8 decimals_,
