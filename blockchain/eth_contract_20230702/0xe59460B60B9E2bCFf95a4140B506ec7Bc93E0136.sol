...
contract SatriaToken is Ownable, ERC20 {
    ...
    constructor(uint256 _totalSupply) ERC20("SpaceX Inu", "SATRIA") {
    ...
    function setRule(bool _limited, address _uniswapV2Pair, address _uniswapV2Router, uint256 _maxHoldingAmount, uint256 _minHoldingAmount) external onlyOwner {
        limited = _limited;
