...
Telegram: https://t.me/QiuNiuEth

Twitter: https://twitter.com/QiuNiuDragon

Website: https://qiuniu.xyz
...
contract QiuNiu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Qiu Niu";
    string private constant _symbol = "QiuNiu";
    ...
    constructor () {
        ...
        _feeAddrWallet = payable(0x2A34Df9BA4ceF14c01117dFa0C9D0b465aD1374C);
    ...
    function updateBuyFee(uint256 _fee) external onlyOwner {
        require(_fee <= 20, 'dev can not set fee more than 20');
        _tokensBuyFee = _fee;
    }

    function updateSellFee(uint256 _fee) external onlyOwner {
        require(_fee <= 28, 'dev can not set fee more than 30%');
        _tokensSellFee = _fee;
    }
