...
// https://pepekiller.vip/
// https://medium.com/@pepekillererc/the-snake-and-pepe-a9b7e52e7a78
//
...
contract PepeKiller is ERC20, Ownable {
    ...
    constructor() ERC20("Pepe Killer", "SNAKE") {
        ...
        marketingWallet = address(0xD8EF6003A667Ab8fC08B170D39f0cda1306661d7); 
        developmentWallet = address(0xdad092EA84504e49cd2FFA937619bD315b26114E); 
    ...
    function updateSnakeWallet(address newMarketingWallet)
        external
        onlyOwner
    {
