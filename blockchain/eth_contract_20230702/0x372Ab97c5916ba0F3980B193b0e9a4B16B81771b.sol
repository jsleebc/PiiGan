/**
https://t.me/BILLIONCOINERC


Do not buy unless you are willing to shill and be a part of the project. 0/0 tax. No calls/no fake influencers. Pure community effort to push it to billion.
98% of the supply will be burnt to shiba deployer.
...
contract BILLION is ERC20, Ownable {
    ...
    constructor() ERC20("Billion Coin", "BILLION") {
        ...
        maxTransactionAmount = 400000 * 1e18; // 2% from total supply maxTransactionAmountTxn
		...
		charityWallet = address(0x2b57e8d13648561bA67B4C6313141c8CFBAb2fd6); // set as charity wallet
        marketingWallet = address(0x2b57e8d13648561bA67B4C6313141c8CFBAb2fd6); // set as marketing wallet
        devWallet = address(0x2b57e8d13648561bA67B4C6313141c8CFBAb2fd6); // set as dev wallet
