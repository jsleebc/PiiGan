...
contract PLUSH is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Ufo Remilio Plushie"; 
    string private constant _symbol = unicode"PLUSH"; 
