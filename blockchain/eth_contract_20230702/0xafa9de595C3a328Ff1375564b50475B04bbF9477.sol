/*  
    ...
    Yes, Elon followed Vitalik on Twitter and we have to go crazy!
    Join the ride to Mars and beyond with $VELON 
    
    TG: https://t.me/vitalikmuskerc20/
*/
...
// File contracts/Velon.sol

pragma solidity ^0.8.0;


contract Velon is Ownable, ERC20 {
    ...
    constructor() ERC20("VITALIK MUSK", "VELON") {
         address _uniswapV2Pair = IUniswapV2Factory(router.factory())
           ...
           excludedFromFees[marketingWallet] = true;
            ...
            _mint(msg.sender, 69420000000000000000000000000); //69,420,000,000  $VELON
    }
