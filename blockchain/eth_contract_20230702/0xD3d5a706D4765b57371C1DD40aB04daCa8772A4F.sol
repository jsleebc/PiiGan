...
contract AlphaMan is ERC20, Ownable {
    ...
    constructor() ERC20("Alphaman Bot", "AMAN") {
    ...
    function manageAMAN_bots(address _address, bool status) external onlyOwner {
