...
contract MrsSponge is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Mrs Sponge";
    string private constant _symbol = unicode"MrsSPONGE";
