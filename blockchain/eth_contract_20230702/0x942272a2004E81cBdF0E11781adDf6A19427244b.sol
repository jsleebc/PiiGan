...
contract MoonCoin is ERC20, Ownable {
    ...
    uint256 private  tokenLiquidityThreshold = 76000 * 10**18;
    uint256 public maxWalletLimit = 760000 * 10**18;

    uint256 private  genesis_block;
    uint256 private deadline = 1;
    uint256 private launchtax = 99;

    address private  marketingWallet = 0xF08732C2beB92ad7D809B92e6c539c9128172A9e;
    ...
    constructor() ERC20("MoonCoin", "MOON") {
        _tokengeneration(msg.sender, 38000000 * 10**decimals());
