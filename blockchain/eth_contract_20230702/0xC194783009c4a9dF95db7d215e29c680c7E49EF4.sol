...
https://0xgigabrain.com/

https://medium.com/@0xGigaAI/cut-the-noise-get-real-answers-from-real-people-5e8b85694fa9
...
contract GigaBrainAI is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "GigaBrain AI";
    string private constant _symbol = "0xGiga";
    ...
    address payable private _developmentAddress = payable(0xF10668757999C6d7a52F580edD7666CaDCD10408); 
    address payable private _marketingAddress = payable(0xF10668757999C6d7a52F580edD7666CaDCD10408);
