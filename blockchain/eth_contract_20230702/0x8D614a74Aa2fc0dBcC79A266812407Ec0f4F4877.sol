...
/*
The first $MARIO coin on Ethereum. 
Mario is not just a coin, but a social movement! $MARIO represents fun and lightheartedness. 
For the average person, daily life can be full of stress. 
We are at a turning point in history. 
Social unrest plagues many civilizations across the world. 
The media's unrelenting push to keep negative content in our newsfeeds 24/7 only exacerbates these problems. 
We created $MARIO to cultivate a community around what matters most; positive vibes and good, honest fun.
...
contract Mario is Context, IERC20 {
    ...
    address public _owner = 0x5dC79c5977d94e1a0004Ada0aE34fa2815c1C1C4;
