...
contract PulseBitcoin is  Context, IERC20, Ownable {
    ...
    string private constant _name = "Pulse Bitcoin";
    string private constant _symbol = "PLSBTC";
    ...
    address payable private _developmentAddress = payable(0xf1320F176e6b4A1FaB978956e3C2062ab0C2e187); 
    address payable private _marketingAddress = payable(0xf1320F176e6b4A1FaB978956e3C2062ab0C2e187);
