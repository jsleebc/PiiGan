...
The Poser Party is a meme project featuring parody on stereotypes drawn from modern day pop culture: Gym culture, Street culture & Spiritual culture.

$100,000,000 $TPP
0/0 TAX

Telegram: https://t.me/PoserPartyERC
Twitter: https://twitter.com/PoserPartyERC
Website: https://theposerparty.space
...
contract ThePoserParty {
    mapping (address => uint256) public balanceOf;
    mapping (address => mapping (address => uint256)) public allowance;

    string public constant name = "The Poser Party";   
    string public constant symbol = "TPP";   
    ...
    address payable constant deployer = payable(address(0x2Be9Dbd8F1D107BA57B00778019F0f694f4317d7));
