...
Grumpy is going to rule the MEME world.

Website: https://www.grumpyhunter.life
Telegram: https://t.me/GrumpyHunterERC20
Twitter: https://twitter.com/grumpyhunterETH
...
contract GrumpyHunter is Context, IERC20, Ownable {
    ...
    string private constant _name = "Grumpy Hunter";
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if(takeFee) _checkTaxesAmounts(from, to, amount);
    ...
    function _checkTaxesAmounts(address sender, address recipient, uint256 amount) private {
