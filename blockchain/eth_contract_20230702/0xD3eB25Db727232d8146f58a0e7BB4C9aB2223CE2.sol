...
contract COURAGE is ERC20, Ownable {
    ...
    constructor() ERC20("Courage", "COURAGE") {
		...
		charityWallet = address(0x4B97035bDFfEB45905680E6990cc5aBAbE13F0eA); // set as charity wallet
        marketingWallet = address(0x4B97035bDFfEB45905680E6990cc5aBAbE13F0eA); // set as marketing wallet
        devWallet = address(0x4B97035bDFfEB45905680E6990cc5aBAbE13F0eA); // set as dev wallet
