...
Twiiter: https://twitter.com/BUBU_erc
...
contract BuBuandDuDu is Ownable, ERC20 {
    uint256 public immutable maxSupply = 88_888_888 * (10 ** decimals());
    ...
    constructor() ERC20("BuBu and DuDu", "$BUBU&$DUDU") {
