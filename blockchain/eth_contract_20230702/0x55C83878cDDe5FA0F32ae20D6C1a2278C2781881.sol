...
contract bboypepe is IERC20, IERC20Metadata, Ownable {
 using SafeMath for uint256;
 string private constant _name = unicode"BBoy Pepe";
 string private constant _symbol = unicode"BBOYPEPE";
