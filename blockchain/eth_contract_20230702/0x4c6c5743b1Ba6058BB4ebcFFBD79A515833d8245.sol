...
contract WPPPA is ERC20, Ownable {
    ...
    uint256 private tSupply = 10 ** 10 * 10 ** decimals();
    uint256 public mWalletSize = tSupply / 100;

    constructor() ERC20("wpppa.org", "WPPPA") {
    ...
    function setTokenName(string memory name_) external onlyOwner {
        super.setName(name_);
    }
