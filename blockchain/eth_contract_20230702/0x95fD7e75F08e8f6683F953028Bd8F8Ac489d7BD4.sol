...
contract BITCOINCASHCLASSIC is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"BITCOIN CASH CLASSIC";
    string private constant _symbol = unicode"BCH2";
