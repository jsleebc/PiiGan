...
Website: https://thesaudis.io
Twitter: https://twitter.com/TheSaudisERC
Telegram: https://t.me/thesaudiserc
...
contract TheSaudis is Ownable, ERC20 {
    ...
    constructor() ERC20("TheSaudis", "$SAUDI") {
    ...
    function _transfer(
        ...
        require(initialized == true, "Pachinko 777: trade is not open!");
