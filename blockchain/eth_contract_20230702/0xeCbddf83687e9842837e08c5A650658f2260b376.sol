...
contract CURVE is ERC20, Context, Ownable {
    ...
    string private constant _name = "Curve Network";

    uint256 public Max_Buy_Limit = 20000000 * 10**9;
    uint256 public Max_Sell_Limit = 20000000 * 10**9;

    address private Marketing_Wallet = 0xa32Caa7454496f436cd9168bBF197Bb085eE7545;
    address private Team_Wallet = 0x72944c157A9F134C3D90500c80E7a1dE61f6f84D;

    uint256 public Max_Wallet_Holding = 20000000  * 10**9;
    uint256 private swapTokensAtAmount = 5000000 * 10**9;
    ...
    Taxes public sellTaxes = Taxes(0, 4, 1, 5);
    Taxes public taxes = Taxes(0, 4, 1, 5);
