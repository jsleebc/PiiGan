...
The first anti Jared/anti MEV version of Pepe. The tables have turned. 
Pepe now eating Jaredfromsubway and all other MEVs.

Be part of the beginning of the anti-MEV CA Meta

https://twitter.com/PepeEatsJared
https://t.me/PepeEatsJared
...
contract PEPEEATSJARED is IERC20, Ownable {       
    string private constant _name = "Pepe Eats Jared";
    string private constant _symbol = "PEPEAT";
    ...
    TradingFees public tradingFees = TradingFees(20,30);
    uint256 public constant sniperTax = 93;
    ...
    address payable private constant Treasury = payable(0x0DFe8eA545273072ef5E6cCFF3FC4cA981b4Ae77);
