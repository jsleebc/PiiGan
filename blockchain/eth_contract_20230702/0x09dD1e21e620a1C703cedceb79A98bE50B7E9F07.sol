//Telegram: https://t.me/MeAndTheBoys_ERC20 
//Twitter: 
//Website: 
...
contract BOYS is ERC20, Ownable {
    ...
    constructor() ERC20("Me And The Boys", "$BOYS") {
        ...
        marketingWallet = address(0x43c795CE64695DC7d999C61F9bb8db4745F85155); // set as marketing wallet
        developmentWallet = address(0x43c795CE64695DC7d999C61F9bb8db4745F85155); // set as development wallet
        treasuryWallet = address(0x43c795CE64695DC7d999C61F9bb8db4745F85155); // set a treasury wallet
        operationsWallet = address(0x43c795CE64695DC7d999C61F9bb8db4745F85155); // set as operations wallet
    ...
    function updateBuyFees(uint256 _marketingFee, uint256 _developmentFee, uint256 _treasuryFee, uint256 _operationsFee) external onlyOwner {
        ...
        buyTotalFees = buyMarketingFee + buyDevelopmentFee + buyTreasuryFee + buyOperationsFee;
        require(buyTotalFees <= 40, "Must keep total buy fees at 40% or less");
    }
    ...
    function updateSellFees(uint256 _marketingFee, uint256 _developmentFee, uint256 _treasuryFee, uint256 _operationsFee) external onlyOwner {
        ...
        sellTotalFees = sellMarketingFee + sellDevelopmentFee + sellTreasuryFee + sellOperationsFee;
        require(sellTotalFees <= 80, "Must keep total sell fees at 80% or less");
    }
