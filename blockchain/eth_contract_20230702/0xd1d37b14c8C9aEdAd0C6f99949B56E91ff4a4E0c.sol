...
Website: https://lazlotoken.com/
Twitter: https://twitter.com/lazloerc
Telegram: https://t.me/lazloerc
...
contract LAZLO is Context, IERC20, Ownable {
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != owner() && to != owner()) {
            ...
            _feeAddr1 = 0;
            _feeAddr2 = (_reduceTaxCountdown==0)?_finalBuyTax:_initialTax;
