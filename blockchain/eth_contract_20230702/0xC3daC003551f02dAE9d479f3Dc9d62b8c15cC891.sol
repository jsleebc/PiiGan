...
Docs       
https://struct-finance.notion.site/Struct-Knowledge-Repository-8caae1b7e6b2434d97d13c7e87750b1f

Medium     
https://structfi.medium.com/ 
...
contract STRUCT is ERC20, Ownable {
    ...
    constructor() ERC20("STRUCT", "STRUCT") { 
        ...
        uint256 totalSupply = 17 * 1e8 * 1e18;

        maxTransactionAmount = 34 * 1e5 * 1e18; 
        maxWallet = 34 * 1e5 * 1e18; 
        ...
        devWallet = address(0xB362fA1A499480Eb7147b282e2832718ce3360e0); 
