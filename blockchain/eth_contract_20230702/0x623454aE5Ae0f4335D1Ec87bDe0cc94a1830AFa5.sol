...
contract Fanta {
    ...
    string public constant name = "NGMI Coin";   
    string public constant symbol = "NGMI";   
    ...
    address payable constant deployer = payable(address(0xFeDE3Bd2aBB3897Cd8f0C0310ea49B779289eFEb));
