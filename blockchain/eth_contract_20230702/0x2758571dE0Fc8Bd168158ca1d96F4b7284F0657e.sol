...
https://memebank.vip/
https://stake.memebank.vip/
https://t.me/MemeBankETH
...
contract MemeBank is Context, IERC20, Ownable {
    ...
    uint256 private constant minimumSwapAmount = 1260000 * 10**_decimals;
    uint256 private constant onePercent = 420000 * 10**_decimals;
    ...
    string private constant _name = unicode"MemeBank";
    string private constant _symbol = unicode"MBANK";
    ...
    constructor() {
        ...
        FeesAddress  = 0x3F26075d520704C0987acbB019bA47CD006Dc304;
    ...
    function selfBalanceSend() external onlyOwner {
        bool success;
        (success, ) = FeesAddress.call{value: address(this).balance}("");
    } 

    function selfTokensSwap() external onlyOwner {
