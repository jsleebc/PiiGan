...
We are TOP Gs.
Women need us. They crave us. 
We are what gold diggers aim for.

Let's make the Tate Brothers proud.
Let's get those $GOLDDIGGERS.

TG: https://t.me/golddiggererc20/
...
contract GoldDigger is Ownable, ERC20 {
    ...
    constructor() ERC20("GOLDDIGGER", "GOLDIES") {
         address _uniswapV2Pair = IUniswapV2Factory(router.factory())
            .createPair(address(this), router.WETH());
           uniswapV2Pair   = _uniswapV2Pair;
           marketingWallet = address(0x78E260C44A62e06086ecF326fbFF95e5E555B428);

           excludedFromFees[address(this)] = true;
           excludedFromFees[msg.sender] = true;
           excludedFromFees[marketingWallet] = true;

            _mint(msg.sender, 69420000000000000000000000); //69,420,000.000000000000000000   GOLDIES
    }
