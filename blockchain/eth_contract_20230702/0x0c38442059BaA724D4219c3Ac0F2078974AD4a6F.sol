// Web: https://www.yurafi.xyz
// Tg:  @yura_finance
// Twitter: @yura_finance
...
contract YuraFinance is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Yura Finance", "YURA") {
    	...
    	marketingAddr = address(0xAC384287797DD6698461C6a178cAEfd723eaa645);
        devAddr = address(0xAC384287797DD6698461C6a178cAEfd723eaa645);
