...
//Twitter: https://twitter.com/FlappyBirdEntry
...
contract Flappy is Context, IERC20, Ownable { 
    ...
    address payable public ProjectWallet = payable(0xB503e3155668F063A79026f81330936c2a337bFC);
    address payable public DeadWallet = payable(0x000000000000000000000000000000000000dEaD); 

    string public _name = "Flappy Bird";
    string public _symbol = "FLAPPY";
