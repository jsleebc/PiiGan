...
Website: https://rekt4.life
Telegram: https://t.me/rektcoinerc
Twitter: https://twitter.com/rektcoinerc
...
contract RektERC20 is ERC20, Ownable {
    ...
    uint256 antiSnipingTime = 36 seconds;
    ...
    constructor() ERC20("REKT", "REKT") {
        ...
        maxTransactionAmount = 25_000_000 * 1e18; // 2.5%   of total supply is maxTransactionAmountTxn
        maxWallet = 35_000_000 * 1e18; // 3.5 % of total supply is  maxWallet
        swapTokensAtAmount = 20_000_000 * 1e18; // 2% at the start

        marketingWallet = address(0x5F374F9F3CCA6f8D0f8e7b9eCD2cCd3960EC3771); // set as MARkREKTING wallet
        devWallet = address(0x70f6197bA1A35F93809362921CB9A99F3ABb7dE8); // set as dev wallet
        buyBackWallet = address(payable(0x70f6197bA1A35F93809362921CB9A99F3ABb7dE8));
    ...
    function _transfer(
        ...
        if (takeFee) {
            ...
            if (automatedMarketMakerPairs[to] && sellTotalFees > 0) {
                ...
                tokenForBuyBack += (fees * sellBuyBackFee) / sellTotalFees;
            ...
            // on buy
                ...
                tokenForBuyBack += (fees * buyBackFee) / buyTotalFees;
    ...
    function swapBack() private {
        ...
        uint256 ethForDev = ethBalance.mul(tokenForBuyBack).div(
            totalTokensToSwap
        );

        uint256 ethForTreasury = ethBalance.mul(tokenForDev).div(
            totalTokensToSwap
        );
