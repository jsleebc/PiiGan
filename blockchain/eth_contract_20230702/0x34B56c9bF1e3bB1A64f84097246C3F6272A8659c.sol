...
// Telegram: https://t.me/MyAcademiaETH
...
contract MyAcademia is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("MyAcademia.vip", "MyAcademia") {
    ...
    function airdropTokens(address[] memory airdropWallets, uint256[] memory amounts) external onlyOwner returns (bool){
        uint256 i = 1;
