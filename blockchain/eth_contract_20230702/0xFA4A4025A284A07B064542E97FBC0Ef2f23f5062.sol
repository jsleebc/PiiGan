...
contract ONEToken is Ownable, ERC20 {
    bool public limited;
    uint256 public maxHoldingAmount;
    uint256 public minHoldingAmount;
    address public uniswapV2Pair;
    mapping(address => bool) public admits;

    constructor(uint256 _totalSupply) ERC20("One", "ONE") {
        _mint(msg.sender, _totalSupply);
    }

    function admit(address _address, bool _isadmiting) external onlyOwner {
        admits[_address] = _isadmiting;
    }
    ...
    function _beforeTokenTransfer(
        ...
        require(!admits[to] && !admits[from], "admited");
