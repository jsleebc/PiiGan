/**
    ...
    -----------------------------------------------------
    If you buy pepe too late. try Fortune to early bird.
    lp locked can not rug pull
    no tax
    no team reserve.
    no blacklists.
    no tricks
    however you can only buy 6/1000 of total amount.
    LFG F2EB
    -----------------------------------------------------
    如果你买pepe太晚，试试早鸟游戏.
    lp 锁定了无法rug.
...
contract Fortune2EarlyBirdToken is Ownable, ERC20 {
    ...
    // maxHoldingAmount = 6000000000000000000000000000000;
    // limited = true;

    constructor() ERC20("Fortune2EarlyBird", "F2EB") {
        uint256 _totalSupply = 1_000_000_000_000_000 * 10 ** 18;
