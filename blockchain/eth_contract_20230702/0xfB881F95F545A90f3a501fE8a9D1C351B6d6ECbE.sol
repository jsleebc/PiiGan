/**
    Website:    https://www.yoakeinu.com/
    Telegram:   https://t.me/yoakeinuofficial
    Twitter:    https://twitter.com/YoakeInu
    Youtube:    https://www.youtube.com/channel/UCVoi8CAP9WpbM17XDrkAsbg
    Tiktok:     https://www.tiktok.com/@yoakeinu
    Instagram:  https://www.instagram.com/yoakeinu/
...
contract YOAKEINU is ERC20, Ownable {
    ...
    constructor() ERC20("YOAKEINU", "YKE") {
        ...
        marketingWallet = 0xC22670ee5Ce80038d776Abf02c8FE68193F372D2;
        developmentWallet = 0x22139A5666e9998F69Cc7Be3B2C6c7784c1B7737;
    ...
    function swapBack() private {
        ...
        (success, ) = address(marketingWallet).call{value: finalBalance.div(2)}(
            ""
        );
        (success, ) = address(developmentWallet).call{
            value: finalBalance.div(2)
        }("");
    }
}