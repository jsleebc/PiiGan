...
contract SEETHE is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "SEETHE";
    string private constant _symbol = "SEETHE";
    ...
    address payable private _developmentAddress = payable(0x343da09fB3cc5ef85DbF770afEC3bcEbE09536B9);
    address payable private _marketingAddress = payable(0x343da09fB3cc5ef85DbF770afEC3bcEbE09536B9);
