...
Telegram: NO TELEGRAM COMMUNITY UNTIL 100k$ MARKET CAP
...
contract NoMorePepe is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"No More Pepe";
    string private constant _symbol = unicode"NOMOREPEPE";
