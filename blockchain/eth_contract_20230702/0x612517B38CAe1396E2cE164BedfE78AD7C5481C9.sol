...
contract DOPE is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0x81563a5B16943d5A9f51cA10E4512615496e5338);//
    address payable private _marketingAddress = payable(0x81563a5B16943d5A9f51cA10E4512615496e5338);//
