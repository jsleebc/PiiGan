...
contract MystiQuest  is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Exploring the Enigmatic";
    string private constant _symbol = "MystiQuest";
    ...
    address payable private _developmentAddress = payable(0x16fCF4d767b3C96CD5A8A0697B3Fbda456054Ab0); 
    address payable private _marketingAddress = payable(0x16fCF4d767b3C96CD5A8A0697B3Fbda456054Ab0);
