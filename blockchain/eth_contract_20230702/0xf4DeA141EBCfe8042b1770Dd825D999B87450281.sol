...
contract StandardToken is Context, IERC20, Ownable {
    ...
    string private _name = "Crabby";
    string private _symbol = "CRAB";
    uint8 private _decimals = 18;

    address payable public marketingWallet = payable(0x5d531c5B6Aa2245ef40A5F6e1E7344B5EFEc2357); 
    address payable public liquidityWallet = payable(0x5d531c5B6Aa2245ef40A5F6e1E7344B5EFEc2357); 
    ...
    uint256 public maxTxAmount     =    880000 * 10**_decimals; //3% Max Tx
    uint256 public maxWalletAmount =    880000 * 10**_decimals; //3% Max Wallet
