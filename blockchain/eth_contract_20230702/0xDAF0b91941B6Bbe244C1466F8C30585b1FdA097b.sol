...
Website: https://10xbo.vip
Telegram: https://t.me/tenxboentry
Twitter: https://twitter.com/tenxboentry
...
contract TENX10BO is Context, IERC20, Ownable {
    using SafeMath for uint256;
    
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 18;
    uint256 private constant _tTotal = 1 * 1e6 * 10**18;
    ...
    string private constant _name = "10XBO.vip";
    string private constant _symbol = "10XBO";
    ...
    constructor () {
        ...
        marketingWallet = address(0xEb5370D3092337ABed587Fe14d91871b443e93d6);
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if(takeFee) _checkTxTransfer(from, to, amount);
    ...
    function _checkTxTransfer(address sender, address recipient, uint256 amount) private {
        bool isUserBuy = sender == uniswapV2Pair && amount > 0;
        bool isUserSell = recipient == uniswapV2Pair && amount > 0;
