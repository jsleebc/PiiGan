...
contract Statix is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = unicode"Statix"; 
    string private constant _symbol = unicode"Stat"; 
    ...
    address payable private _marketingWalletAddress = payable(0x61266CF98578529a7cb47c51939c694c4b10871f);
