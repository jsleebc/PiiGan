...
contract BOBc is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "BOBc";
    ...
    address payable private _developmentAddress = payable(0x5A878cA4e5b5B6e62c72A17BDe2d3b1203AfA63b); 
    address payable private _marketingAddress = payable(0x5A878cA4e5b5B6e62c72A17BDe2d3b1203AfA63b);
