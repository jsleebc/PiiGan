...
contract SYX is ERC20, Ownable {
    ...
    {   
        ...
        marketingWallet = 0x409F3f177C26FF100bEA46a01ef8A8515DF4A920;
    ...
    function updateFees(uint256 _marketingFeeOnSell, uint256 _marketingFeeOnBuy) external onlyOwner {
        ...
        require(marketingFeeOnSell + marketingFeeOnBuy <= 25, "Total Fees cannot exceed the maximum");
