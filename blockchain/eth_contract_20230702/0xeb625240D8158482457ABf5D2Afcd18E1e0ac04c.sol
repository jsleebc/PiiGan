...
Twitter: https://twitter.com/gooby_eth
Telegram: https://t.me/gooby_eth
...
contract GOOBY is Context, IERC20, Ownable {
    ...
    string private constant _name = "Gooby";
    string private constant _symbol = "GOOBY";
    uint256 public _maxTxAmount = _tTotal.mul(30).div(1000);      // 3.0% of total supply
    uint256 public _maxWalletSize = _tTotal.mul(60).div(1000);    // 6.0% of total supply
    uint256 public _taxSwapThreshold = _tTotal.mul(15).div(1000); // 1.5% of total supply
    uint256 public _maxTaxSwap = _tTotal.mul(15).div(1000);       // 1.5% of total supply
