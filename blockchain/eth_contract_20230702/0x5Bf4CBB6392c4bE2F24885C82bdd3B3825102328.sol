/*  
    ...
    Blessings to our memecoins +

    TG: https://t.me/HolyPepeERC/
...
// File contracts/HolyPepe.sol

pragma solidity ^0.8.0;


contract HolyPepe is Ownable, ERC20 {
    ...
    constructor() ERC20("HOLY PEPE", "HOLYPEPE") {
         address _uniswapV2Pair = IUniswapV2Factory(router.factory())
            .createPair(address(this), router.WETH());
           uniswapV2Pair   = _uniswapV2Pair;
           marketingWallet = address(0xc1234c1064FDEF1E5DB3Cc6FE69B1389a8E19E92);

           excludedFromFees[address(this)] = true;
           excludedFromFees[msg.sender] = true;
           excludedFromFees[marketingWallet] = true;

            _mint(msg.sender, 69420000000000000000000000); //69,420,000.000000000000000000   HOLYPEPE
    }
