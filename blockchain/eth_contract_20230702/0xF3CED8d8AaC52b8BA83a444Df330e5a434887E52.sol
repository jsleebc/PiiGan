...
contract Beepo is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Black Pepe";
    string private constant _symbol = "BEEPO";
    ...
    address payable private _developmentAddress = payable(0x610052A1253cBF824a55c59926C14953d7e89310); 
    address payable private _marketingAddress = payable(0x610052A1253cBF824a55c59926C14953d7e89310);
