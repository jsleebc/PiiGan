...
contract GETREKT is ERC20, Ownable {
    ...
    constructor() ERC20("rekt", "REKT") {
        ...
        maxTransactionAmount = 84000000 * 1e18; // 1% from total supply maxTransactionAmountTxn
        maxWallet = 84000000 * 1e18; // 2% from total supply maxWallet
		...
		charityWallet = address(0x47E36b028F8b606D91181f57C16AaCb5Ed694aA4); // set as charity wallet
        marketingWallet = address(0x47E36b028F8b606D91181f57C16AaCb5Ed694aA4); // set as marketing wallet
        devWallet = address(0x47E36b028F8b606D91181f57C16AaCb5Ed694aA4); // set as dev wallet
