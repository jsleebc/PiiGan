...
/*
    Website:  https://pepegold.finance
    Telegram: https://t.me/PEPEGOLDERC
...
contract PEPEGOLD is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0x793A56972dfC9F7De4Aa407db5923a7777322726);
    IUniswapV2Router02 public uniswapV2Router;
    address public uniswapV2Pair;
    bool private tradingOpen;
    bool private inSwap = false;
    uint256 public _maxTxAmount = 690000 * 10**9;  //1%
    uint256 public _maxWalletSize = 1380000 * 10**9; //2%
    uint256 public _swapTokensAtAmount = 207000 * 10**9; //0.3%
    ...
    function raiseLimitsAndLowerFees() public onlyOwner {
        _maxTxAmount = 1380000 * 10**9;  //2%
        _maxWalletSize = 1380000 * 10**9;  //2%
        _taxFeeOnBuy = 0;
        _taxFeeOnSell = 0;
    }
