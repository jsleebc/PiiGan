...
🌐 https://tokenringeth.com/
🦜 https://Twitter.com/tokenRingEth
📝 KYC: https://twitter.com/auditsfinance/status/1664731854446944257
*/
...
contract Ring is IERC20, Auth {
    uint8 private constant _decimals      = 9;
    uint256 private constant _totalSupply = 100_000_000 * (10**_decimals);
    string private constant _name         = "Token Ring";
    ...
    uint16 private _taxSharesMarketing   = 56;
    uint16 private _taxSharesDevelopment = 44;
    uint16 private _taxSharesLP          = 0;
    uint16 private _totalTaxShares = _taxSharesMarketing + _taxSharesDevelopment + _taxSharesLP;

    address payable private _walletMarketing = payable(0x0dc0bED97a59E817c565E74323ca5A468CAe86D3); 
    address payable private _walletDevelopment = payable(0x70b3efF92006Da2eD3e5725960A885952AB22D3A); 
