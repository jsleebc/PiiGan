...
contract Oxmeme is ERC20, Ownable{  
    ...
    uint256 public maxTxAmount = 2_103_4000 * 10**18; 
    uint256 public maxWalletAmount = 2_103_4000 * 10**18; 
    
    address public marketingWallet = 0x2E75E5Db15CB19F3EdaBbcadfca5d8EA99CE5722; 
    address public devWallet = 0x2E75E5Db15CB19F3EdaBbcadfca5d8EA99CE5722;
    ...
    Taxes public sellTaxes = Taxes(14,0,1); 
