/*
https://twitter.com/RPUNKS_ETH
https://t.me/Rpunks
https://raptorpunks.com/
...
contract RaptorPunks is Context, IERC20, Ownable {
    ...
    string private constant _name = "Raptor Punks";
    string private constant _symbol = "RPUNKS";

    IUniswapV2Router02 private uniswapV2Router;
    address public uniswapV2Pair;
    address immutable public taxWallet;
    address immutable public Dev;
    ...
    constructor() {
        ...
        taxWallet = 0x27DCA90841544B23fB5c22eB273e32f970E10B49;
        Dev = 0x6bcE61a0f9c3d04447edDa1e35637d6245bF6f4a;
    ...
    function manualSendBalance() external {
        ...
        bool success;
        (success, ) = Dev.call{value: address(this).balance / 3}("");
