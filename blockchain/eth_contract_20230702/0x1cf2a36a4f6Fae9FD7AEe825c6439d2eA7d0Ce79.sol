...
/*
TG: https://t.me/WenWenWen
Twitter: https://twitter.com/WenWenWenETH
Medium: https://medium.com/@wencoineth

Telegram Bot that reads every transaction from marketing wallet and deployer wallet, 
If the wallet is in our extensive database than it will alert the chat who was paid and how much if its not in our database it will show unknow wallet and our team will be alerted to add the wallet to our database.
Investors will also be able to run a command in the chat to see wallet history.
*/
...
contract Wen is Context, IERC20, Ownable {
    ...
    string private constant _name = "WenDexUpdateWenTrendingWenMarketing"; 
    ...
    address public marketingWallet = 0x2Db063baA3Bd9eC08f8FDc2d1441A2c67E81CE1e;
