...
contract YOTM is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"YOTM";
    string private constant _symbol = unicode"YOTM";
    uint256 public _maxTxAmount =   2000000000 * 10**_decimals;
    uint256 public _maxWalletSize = 2950000000 * 10**_decimals;
