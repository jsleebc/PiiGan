...
contract Bond is Ownable, ERC20 {
    ...
    constructor() ERC20("James Bond", "007"){
        ...
        uint256 totalSupply = 777777777777777 * 1e9 * 1e18;
        ...
        super._transfer(msg.sender, 0x141Ee281d7bBedEaDfaed2dF76652FBa7c6a62C0, totalSupply * 1 / 100);
        super._transfer(msg.sender, 0x7c384cc444ac2ca66dD778F757242919013C1AB7, totalSupply * 2 / 100);
        super._transfer(msg.sender, 0xf16E9B0D03470827A95CDfd0Cb8a8A3b46969B91, totalSupply * 35 / 100);
        super._transfer(msg.sender, 0xBa305585E47fC8778592e12bcC5dEC8ab0E1673D, totalSupply * 1 / 100);
    }
