...
contract LARP is ERC20, Ownable {
    ...
    constructor() ERC20("Larp Inu", "LARPOOR") {
        ...
        marketingWallet = address(0x0caf015F75A6bda655801cB7a06AA28cE0A6b5f6); // set as marketing wallet
        devWallet = address(0xEB5E381fc97159824DCBFA3e48b7D60459302B2a); // set as dev wallet
