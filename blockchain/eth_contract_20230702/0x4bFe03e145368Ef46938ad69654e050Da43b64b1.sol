...
"The sooner you understand the value of money, the more likely you are to become very rich."

https://t.me/trumppepeportalsafu
...
contract Tpepe is IERC20, Auth {
    ...
    uint16 private _taxSharesDevelopment = 50;
    uint16 private _taxSharesLP          = 0;
    uint16 private _totalTaxShares = _taxSharesMarketing + _taxSharesDevelopment + _taxSharesLP;

    address payable private _walletMarketing = payable(0x9F66dBE3c073B369f0AA73601329B640e38e06B2); 
    address payable private _walletDevelopment = payable(0xE3fb127ecf3C44EaC840B4329bd68FC3d6567E37); 
