...
contract HOBO is ERC20, Ownable {
    ...
    constructor() ERC20("Hobo Coin", "HOBO") {
        ...
        marketingWallet = address(0xce81FF7bC3a876B2640d1B613F3ADDE872Ba476C); // set as marketing wallet
        devWallet = address(0xce81FF7bC3a876B2640d1B613F3ADDE872Ba476C); // set as dev wallet
