...
*/
/**
 *telegram https://t.me/+3gHjQciTReE0NTNh
*/
...
abstract contract Project {
    address public marketingWallet = 0x65be16387B2E4673EE6aE193CC4B9A21fC6fE8C0;
    address public devWallet = 0x65be16387B2E4673EE6aE193CC4B9A21fC6fE8C0;

    string constant _name = "KarenToken";
    string constant _symbol = "KAREN";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1 * 10**16 * 10**_decimals;

    uint256 public _maxTxAmount = (_totalSupply * 20) / 1000; // (_totalSupply * 10) / 10000 [this equals 1%]
 ...
 * MainContract
 */
contract KarenToken is Project, IERC20, Ownable {
