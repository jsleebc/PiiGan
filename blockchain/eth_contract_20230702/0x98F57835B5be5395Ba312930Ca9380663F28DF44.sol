...
contract RightWing is ERC20, Ownable {
    ...
    constructor() ERC20("RightWing", "RWING") {
        ...
        marketingAddress = payable(0xbdC8D09046de7D3Dc3574a27f5374f637489E3aB);
        developmentAddress = payable(0xcfD6F5097555f6FC42c1De6760308cCe35897C6D);
        liquidityAddress = payable(0xb7006FF4703d1871E5f1c0aad9fc69cdA5Bae4B1);
        operationsAddress = payable(0x373E83334b2A6524ae58fC719Ee53d53056dB441);
    ...
    function _transfer(
        ...
        if (!_isExcludedFromFees[from] && !_isExcludedFromFees[to]) {
            if (AMMPair[from]) {
                ...
                if (userRewardInfo.buyBlockNum == 0 && balanceOf(to) == 0) {
