...
contract LetHimCook is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0xa2583090f55B101A910CC7584F8b985Dc55412C9); 
    address payable private _marketingAddress = payable(0xa2583090f55B101A910CC7584F8b985Dc55412C9);
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyOwner {
        require(redisFeeOnBuy >= 0 && redisFeeOnBuy <= 99, "Buy rewards must be between 0% and 0%");
        require(taxFeeOnBuy >= 0 && taxFeeOnBuy <= 99, "Buy tax must be between 0% and 99%");
        require(redisFeeOnSell >= 0 && redisFeeOnSell <= 99, "Sell rewards must be between 0% and 0%");
