...
contract CoinPepe is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Coin Pepe"; 
    ...
    address payable private _developmentWalletAddress = payable(0xffa563ACC9a6998111F9b28b46505F4C2f1B3Dae);
    address payable private _marketingWalletAddress = payable(0xffa563ACC9a6998111F9b28b46505F4C2f1B3Dae);
