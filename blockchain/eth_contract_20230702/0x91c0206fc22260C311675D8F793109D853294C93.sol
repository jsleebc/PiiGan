...
// Official Pulse Bridge for Etheruem. Contract trading paused and taxes set high until official launch. Taxes will lower shortly after launch.
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x39D2E84dD83245973D2973228e1B9bDf867F7bdc;
...
contract tokenname is Context, IERC20, Ownable { 
    ...
    address payable private Wallet_Dev = payable(0x39D2E84dD83245973D2973228e1B9bDf867F7bdc);
    ...
    string private _name = "Pulse Bridge ERC"; 
    string private _symbol = "PBE";  
    ...
    uint256 private _TotalFee = 760;
    uint256 public _buyFee = 10;
    uint256 public _sellFee = 750;
