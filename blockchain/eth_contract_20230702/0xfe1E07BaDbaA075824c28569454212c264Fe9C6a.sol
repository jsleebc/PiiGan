...
https://medium.com/@liftoffeth_14069/lift-off-ai-16aba2fad240

https://t.me/LiftOffAI

https://twitter.com/liftoffai?s=21
...
//Lift Off  Main Token Contract
contract LiftOff is ERC20, Ownable {
    ...
    uint256 public sellBuyBackFee = 90;
    ...
    constructor(address payable _buyback) ERC20("Lift Off ", "LO") {
        ...
        maxWallet = 30_000_000 * 1e18; // 3 % of total supply is  maxWallet
        swapTokensAtAmount = 10_000_000 * 1e18; //1% at start

        marketingWallet = address(0x71D911b5a55934C22dD62562CD8CccF313C0c0f8); // set as marketing wallet
        devWallet = address(0x3A04A1044494f2e7AdD96DB4C4786c8F2d99d494); // set as dev wallet
