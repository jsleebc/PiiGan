...
contract NikolaJokic is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Nikola Jokic";
    string private constant _symbol = unicode"JOKIC";
