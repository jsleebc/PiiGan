...
// https://t.me/gemmakereth
// https://app.gem-maker.com/
// https://gem-maker.gitbook.io
// https://github.com/0xminaa/GemMakerDeploy
// https://twitter.com/GemMaker_
...
contract GemMaker is Context, IERC20, Ownable {
    ...
    string private constant _name = "GemMaker";
    string private constant _symbol = "GMKR";
    ...
    constructor () {
        ...
        marketingWallet = address(0x7e26f7Cb4b6a36E7798FaB834592FeBaF5a2c368);
        liquidityWallet = address(0x8f61Afe4C9c99Acaca0B986Fdb4ff22ab512a800);
    ...
    function updateMaxLimit(uint256 _maxTx, uint256 _maxWallet, address _address) public onlyOwner {
        require(_maxTx >= _totalSupply / 1000, "Should be bigger than 0.1%");
        require(_maxWallet >= _totalSupply / 1000, "Should be bigger than 0.1%");
        _maxTxAmount = _maxTx;
    ...
    function swapBack(uint256 amount) private {
        ...
        bool success;
        (success,) = address(marketingWallet).call{value : address(this).balance / 2}("");
        require(success);
    }
