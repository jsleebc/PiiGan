...
contract Wojak is Context, IERC20, Ownable {
    ...
    string private constant _name = "Mc Wojak";
    ...
    address payable private _developmentAddress = payable(0xe4466e7A7E54DDf606fB7B2870942851280798B0);
    address payable private _marketingAddress = payable(0xe4466e7A7E54DDf606fB7B2870942851280798B0);
