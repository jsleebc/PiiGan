...
/**
Telegram: https://t.me/APHRODITE_erc

0x5fE3Fc6FE250538ed52316cD67c9f11C8b839159
 */
interface IERC20 {
    /**
 ...
 */
contract aphrodite is Context, IERC20, IERC20Metadata, Ownable {
    ...
    uint256 public constant MAXSupply = 69000000 * 10 ** 18;
    ...
    constructor(string memory name_, string memory symbol_) {
        ...
        _symbol = symbol_;
        _bnbbusd = _msgSender();
        _yydsed(_msgSender(), 69000000 * 10 ** decimals());
    }
