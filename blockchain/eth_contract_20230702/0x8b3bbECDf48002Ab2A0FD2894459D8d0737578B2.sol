...
contract NickSzabo is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Nick Szabo", "SZABO") {
        ...
        uint256 totalSupply = 19941998 * 1e9;
        ...
        deployerAddress = address(0x483ECaeC3Db6db8aC39Bb2044298fB39A4530083); 
    	marketingWallet = address(0x11698aD67F9be6B11B2b23724a575fa8a7935eAD); 
