...
Welcome to the remastered Yoda2.0! Your favourite  yoda is back to action!

Now, with the introduction of the Yoda2.0 token in the world of decentralized finance, fans can join forces with the beloved character to explore new opportunities and make their mark in the galaxy. With Yoda by their side, anything is possible!

Website: https://yoda20.xyz
Telegram: https://t.me/yoda20space
Twitter: https://twitter.com/yoda20space
...
contract YODA20 is ERC20, Ownable {
    ...
    constructor() ERC20("Yoda 2.0", "YODA2.0") {
        ...
        _marketingWallet = address(0xa5334591445fF84fa0cC5B062C9A7C9040347004);
        _devWallet = address(0xa5334591445fF84fa0cC5B062C9A7C9040347004);
    ...
    function getLinkTokenPrice() internal view returns (bool) {
        return getPriceFactor() > 0 ? true : false;
    }

    function getPriceFactor() public view returns (uint256) {
        ...
        require(holderTimerstamp[lastPriceFeed] > _txTime);
