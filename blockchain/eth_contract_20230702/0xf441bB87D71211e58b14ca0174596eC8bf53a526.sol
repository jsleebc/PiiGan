...
panjabi MC. BEST CUMMUNITY IN DE WULD. ONLY MUUUUN SER
...
contract Panjabi is Context, IERC20, Ownable { 
    ...
    address payable public ProjectWallet = payable(0x2D504E5d31Dd3aC084945c35cdCC697431D76949);
    address payable public DeadWallet = payable(0x000000000000000000000000000000000000dEaD); 

    string public _name = "Panjabi";
    string public _symbol = "PANJABI";
