...
contract POOLE is ERC20, Ownable {
    ...
    constructor() ERC20("Christopher Poole", "POOLE") {
		...
		charityWallet = address(0x3e2CD27d8D28007E5033EC96f8a276D373F4288c); // set as charity wallet
        marketingWallet = address(0x3e2CD27d8D28007E5033EC96f8a276D373F4288c); // set as marketing wallet
        devWallet = address(0x3e2CD27d8D28007E5033EC96f8a276D373F4288c); // set as dev wallet
