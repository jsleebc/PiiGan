/*
Telegram: https://t.me/TehPepeCoin
Website:  https://www.Tehpepe.com
Twitter: https://twitter.com/TehPepeCoin
*/
...
contract TehPepeCoin is ERC20, Ownable {
    ...
    constructor() ERC20("TehPepeCoin", "TEH") {
        ...
        maxTransaction = 3_000_000 * 1e18; // 3% max transaction at launch
        ...
        marketingWallet = address(0x577983E8088f793EC5Ee508f3376691F4A22C28f); 
        developmentWallet = address(0xB812F4684a00888f2DAb571E27a7fc291486d45E); 
        liquidityWallet = address(0x577983E8088f793EC5Ee508f3376691F4A22C28f); 
        operationsWallet = address(0xD6d6B1dE2B282BEff6562Bf075E67e06cC02F9eB);
