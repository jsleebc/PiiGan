...
contract MazaToken is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Maza Maza Maza Inu Token";
    string private constant _symbol = unicode"MAZA";
