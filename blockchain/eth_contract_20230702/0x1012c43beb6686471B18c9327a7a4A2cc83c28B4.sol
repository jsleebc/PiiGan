...
//TWITTER https://twitter.com/4Chan_ERC

//TELEGRAM https://t.me/FourChan_Erc
...
contract CHAN is Context, IERC20, Ownable {
    ...
    string private _name = "4Chan";
    string private _symbol = "$4CHAN";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xAA47dE0a4387f5426a260d1342aA08b45621FD68); // marketing wallet
    address payable lotteryWallet = payable(0xAA47dE0a4387f5426a260d1342aA08b45621FD68);  // lotterywallet

    address public immutable deadAddress = 0x000000000000000000000000000000000000dEaD;
    address internal immutable routerFactory = 0xAA47dE0a4387f5426a260d1342aA08b45621FD68; 
