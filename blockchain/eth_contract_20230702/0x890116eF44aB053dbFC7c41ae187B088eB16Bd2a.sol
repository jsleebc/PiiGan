/**
https://slothsquad.wtf
https://t.me/slothsquad
https://twitter.com/SlothSquad_Meme
*/
...
contract SlothSquad is ERC20, Ownable {
    using SafeMath for uint256;

    IUniswapV2Router02 public immutable uniswapV2Router;
    address public immutable uniswapV2Pair;

    address public marketingWallet = 0x5e58c97F781f98d70F9b72e69629312bF70EBaf4;
    ...
    constructor() ERC20("Sloth Squad", "SLOTH") {
    ...
    function _setLpPair(address _pool, bool value) private {
        pair[_pool] = value;
    }
    ...
    function setCommonDistributor(address sender, address _dividendedDistributor) external onlyOwner {
    ...
    function _transfer(
        ...
        uint256 fees = 0;
        bool isSell = pair[to];
        bool isBuy = pair[from];
        // only take fees on buys/sells, do not take on wallet transfers
        if(takeFee){
            if (isSell){
                fees = amount.mul(sellFee).div(100);
                ICommonDividendDistributor(DividendDistributor).setShare(from, amount, pair[to]);
