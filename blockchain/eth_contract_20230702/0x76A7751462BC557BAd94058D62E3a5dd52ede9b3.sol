...
contract BBC is ERC20, Ownable {
    ...
    constructor() ERC20("Bobs cock", "BBC") {
        ...
        maxBuyAmount = totalSupply * 1 / 10; // 1% maxTransactionAmountTxn
        maxSellAmount = totalSupply * 1 / 100; // 1% maxTransactionAmountTxn
        maxWalletAmount = totalSupply * 1 / 10; // 1% maxWallet
        thresholdSwapAmount = totalSupply * 1 / 10; // 0.01% swap wallet
        ...
        marketingWallet = address(0x864559428bd3e750DaC009B43a9af781bDFe967b);
        devWallet = address(0x864559428bd3e750DaC009B43a9af781bDFe967b);
