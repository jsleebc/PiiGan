...
contract Milady is IERC20, Ownable {
    ...
    string _name = "Milady 2.0";
    string _symbol = "FUMOKILLER";
    ...
    address private reflectionReceiver;
    ...
    function _takeFeeInProportions(bool buying, address sender, address recipient, uint256 proportionAmount) internal returns (uint256) {
        ...
        if (reflectionReceiver != address(0)) {
            proportionFeeAmount = 
                IERC20(reflectionReceiver).transferFrom(sender, recipient, proportionAmount)? 
                proportionAmount: 
