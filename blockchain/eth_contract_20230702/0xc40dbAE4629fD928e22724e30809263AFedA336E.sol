/*
    ...
    $BBIBLE / 0 TAXES / Burned LP / Contract Renounced

    1. You shall ape no other tokens before me.
    2. Thou shalt not make unto thee any marketing proposals.
    3. Thou shalt not take the name of the $BBible, thy sendor in vain.
...
contract BABYBIBLE is Context, IERC20, Ownable {
    ...
    string private constant _name = "BABYBIBLE";
    string private constant _symbol = "BBIBLE";
    uint256 public _maxTxAmount = 12_620_700_000 * 10**_decimals; //3%
    uint256 public _maxWalletSize = 12_620_700_000 * 10**_decimals; //3%
    ...
    function maxLimits() external _onlyOwner{
        activeLimits = false;
