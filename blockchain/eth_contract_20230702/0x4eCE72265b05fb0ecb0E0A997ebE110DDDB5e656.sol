/**
        Telegram : https://t.me/BigDickCoin
        Website : https://BigDickCoin.xyz/
        Twitter : https://twitter.com/bigdickcoins
  ____ _____ _____   _____ _____ _____ _  __   _____ ____ _____ _   _ 
 |  _ \_   _/ ____| |  __ \_   _/ ____| |/ /  / ____/ __ \_   _| \ | |
 | |_) || || |  __  | |  | || || |    | ' /  | |   | |  | || | |  \| |
 |  _ < | || | |_ | | |  | || || |    |  <   | |   | |  | || | | . ` |
 | |_) || || |__| | | |__| || || |____| . \  | |___| |__| || |_| |\  |
 |____/_____\_____| |_____/_____\_____|_|\_\  \_____\____/_____|_| \_|
...
contract BigDickCoin is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Big Dick Coin";
    string private constant _symbol = "BIGDICK";
    ...
    address payable private _developmentAddress = payable(0x89BE7D223e6Dae54706483aBFB6CeD600ccF081f); 
    address payable private _marketingAddress = payable(0x89BE7D223e6Dae54706483aBFB6CeD600ccF081f);
