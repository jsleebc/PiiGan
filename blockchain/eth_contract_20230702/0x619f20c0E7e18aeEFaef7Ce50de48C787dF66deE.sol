/*  
    ...
    TG: https://t.me/DontApeMePleaseERC20/
...
contract Dontapeme is Ownable, ERC20 {
    ...
    constructor() ERC20("DON'T APE ME PLEASE", "DAMP") {
         address _uniswapV2Pair = IUniswapV2Factory(router.factory())
            .createPair(address(this), router.WETH());
           uniswapV2Pair   = _uniswapV2Pair;
           marketingWallet = address(0x621518b3FbCC8593B9024592d2D9C39F77F8c884);

           excludedFromFees[address(this)] = true;
           excludedFromFees[msg.sender] = true;
           excludedFromFees[marketingWallet] = true;

            _mint(msg.sender, 1000000000000000000000000000); //1,000,000,000  $DAMP
    }
