...
/// Telegram: https://t.me/wojakerc
/// Website:  https://wojaketh.com
...
contract WOJAK is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0x144B779097f94A4F79f94759b62FcED382f93621);
    address payable private _marketingAddress = payable(0x144B779097f94A4F79f94759b62FcED382f93621);
    ...
    uint256 public _maxTxAmount = 1404200000 * 10**9; //
    uint256 public _maxWalletSize = 1404200000 * 10**9; //
    uint256 public _swapTokensAtAmount = 354200000 * 10**9; //
