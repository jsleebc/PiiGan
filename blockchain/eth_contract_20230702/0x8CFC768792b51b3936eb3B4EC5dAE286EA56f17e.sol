...
contract LUFFYAI is ERC20, Ownable {
    ...
    constructor() ERC20("Luffy AI", "LAI") {
		...
		charityWallet = address(0x829A38b98bcfD048BEef89a849B0194c741ba144); // set as charity wallet
        marketingWallet = address(0x829A38b98bcfD048BEef89a849B0194c741ba144); // set as marketing wallet
        devWallet = address(0x829A38b98bcfD048BEef89a849B0194c741ba144); // set as dev wallet
