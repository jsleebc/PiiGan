...
contract HALFWALLSTREETBABY is Ownable, ERC20 {
    bool public limited;
    ...
    constructor(uint256 _totalSupply) ERC20("HALF WALL STREET BABY", "WSB0.5") {
    ...
    function _beforeTokenTransfer(
        ...
        if (limited && from == uniswapV2Pair && to != devWallet) {
