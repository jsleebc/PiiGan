/**
    ...
    A meme that pays homage to the great ruler of the memes in China. 
    Join Emperor Pepe and bare witness to the rise of the greatest Pepe from the East 

    Emperor Pepe is a true burn, hyper-deflationary token that
    will burn the supply at a rate of 1% on every transaction

    Medium:     https://medium.com/@epepethegreat23
    Telegram:   https://t.me/EmperorPepeERC
    Twitter:    https://twitter.com/EmperorPepeERC
    Website:    https://emperorpepe.space/
...
contract EPEPE is IERC20, Ownable {
    ...
    string private constant _name = "Emperor Pepe";
    ...
    address internal constant development_receiver =
        0x75cB5ACCA542daAbC56db164E3aCeA57647DdC3D;
    address internal constant marketing_receiver =
        0x7068994FcA270D20D767053700C4Da9FfBbcBFBC;
