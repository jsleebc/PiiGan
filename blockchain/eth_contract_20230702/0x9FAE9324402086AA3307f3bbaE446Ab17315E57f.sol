...
contract PoTA is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"PoTA Token";
    string private constant _symbol = unicode"PoTA";
    uint256 public _maxTxAmount =   124000000 * 10**_decimals;
    uint256 public _maxWalletSize = 124000000 * 10**_decimals;
