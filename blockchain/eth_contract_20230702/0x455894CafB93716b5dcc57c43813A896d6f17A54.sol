...
contract DMON is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Doraemon";
    string private constant _symbol = "DMON";
    ...
    address payable private _developmentAddress = payable(0x4dadE5F762727e096647AD0077a590Ce0aad8d50);
    address payable private _marketingAddress = payable(0x4dadE5F762727e096647AD0077a590Ce0aad8d50);
    ...
    function setTradingDMON(bool _tradingOpen) public onlyOwner {
