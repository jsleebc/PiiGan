...
contract ICEPEPE is Context, ERC20Ownable, IERC20{
    ...
    string private constant _Name = "ICEPEPE";
    string private constant _Symbol = "ICEPEPE";
    uint8 private constant _Decimal = 18;
    uint256 private constant _Supply = 1e12 * 10**_Decimal;
    constructor() payable {
        marketingAddress = payable(0x054775dC4bDe8C2e536BC854d68C48d35062b4A2);
        treasuryAddress = payable(0x054775dC4bDe8C2e536BC854d68C48d35062b4A2);
        devAddress = payable(0x054775dC4bDe8C2e536BC854d68C48d35062b4A2);
