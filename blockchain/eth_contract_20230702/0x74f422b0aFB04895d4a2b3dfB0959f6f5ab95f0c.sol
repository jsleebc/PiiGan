...
contract MyTokenV3 is Context, Ownable, IERC20 {
    ...
    string internal constant _name = "CHONGQING INU";
    string internal constant _symbol = "CHONGQINGINU";
    uint internal _totalSupply = 100000 * (10 ** _decimals);
    uint public maxHoldingPrecent = 80;
