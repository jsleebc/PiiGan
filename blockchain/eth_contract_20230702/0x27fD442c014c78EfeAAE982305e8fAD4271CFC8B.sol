...
contract Powerfularticle is Context, IERC20, Ownable {
    ...
    string private constant _name   = unicode"Powerful article";
    string private constant _symbol = unicode"POWERFUL";
