...
contract GatesOfOlympus is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Gates of Olympus";
    ...
    address payable private _developmentAddress = payable(0x7d870465E341EDd21f6227Ba6b2d13dd838794d0);
    address payable private _marketingAddress = payable(0x7d870465E341EDd21f6227Ba6b2d13dd838794d0);
    ...
    function setFee(uint256 MFeeOnBuy, uint256 MFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyOwner {
        ...
        require (totalFee <= 99,"Total Fees cannot be more than 25%");
    }
