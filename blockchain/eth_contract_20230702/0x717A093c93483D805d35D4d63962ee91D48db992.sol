...
contract WorldWideWeb is ERC20, Ownable {
    ...
    constructor() ERC20("World Wide Web", "WWW") {
        ...
        buyFee = 10; // sniper protection, to be lowered to 0% after launch
        sellFee = 30; // sniper protection, to be lowered to 0% after launch

        feeWallet = address(0x18831cf01C73Ce2eD204a3e0b505De7166378fb7 ); // set as feewallet
