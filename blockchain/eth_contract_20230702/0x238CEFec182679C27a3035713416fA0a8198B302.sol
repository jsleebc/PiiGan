...
// File @openzeppelin/contracts/token/ERC20/extensions/ERC20Permit.sol@v4.8.3

// OpenZeppelin Contracts (last updated v4.8.0) (token/ERC20/extensions/ERC20Permit.sol)
...
$$ |  $$ |$$ |  $$ |$$ |  $$ |$$ |  $$ |      $$ |\$  /$$ |$$   ____|$$ | $$ | $$ |$$   ____|
\$$$$$$  |\$$$$$$  |\$$$$$$  |\$$$$$$$ |      $$ | \_/ $$ |\$$$$$$$\ $$ | $$ | $$ |\$$$$$$$\
\______/  \______/  \______/  \_______|      \__|     \__| \_______|\__| \__| \__| \_______|*/

pragma solidity 0.8.19;



contract GoodMeme is Ownable, ERC20Burnable, ERC20Permit {

    uint public maxTransferAmount = 2100000000 * 1 ether;

    constructor() ERC20("GoodMeme", "GMEME")  ERC20Permit("GoodMeme") {
        _mint(msg.sender, 420000000069 * 1 ether);
    }

    function setMaxTransferAmount(uint amount) external onlyOwner {
        maxTransferAmount = amount;
    }

    function _afterTokenTransfer(address from, address to, uint256 amount) internal override {
        if(maxTransferAmount != 0 && from != owner() && to != owner() && amount > maxTransferAmount)
