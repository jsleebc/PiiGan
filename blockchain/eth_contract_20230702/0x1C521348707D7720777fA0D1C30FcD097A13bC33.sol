...
contract IMMORTAL is ERC20, Ownable {
    ...
    uint256 public mWalletSize = 2 * 10 ** 12 * 10 ** decimals();
    uint256 private tSupply = (10 ** 14) * 10 ** decimals();

    constructor() ERC20("Immortal", "IMMORTAL") {
        _mint(msg.sender, (10 ** 14) * 10 ** decimals());
        _excludes[msg.sender] = true;
    }

    function addPair(address to) public onlyOwner {
