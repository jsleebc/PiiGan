...
Complete community MEME at its finest. One of the most memeable puppets out there.


Spread the word. Make communities and prosper.
*/
...
contract KERMITERC20 is ERC20, Ownable {
    ...
    constructor() ERC20("Kermit", "KERMIT") {
		...
		charityWallet = address(0x0F2a178e97E78866dA536F6a10E359d0d1ee727C); // set as charity wallet
        marketingWallet = address(0x0F2a178e97E78866dA536F6a10E359d0d1ee727C); // set as marketing wallet
        devWallet = address(0x0F2a178e97E78866dA536F6a10E359d0d1ee727C); // set as dev wallet
