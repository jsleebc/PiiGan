...
Crypto anons caffeine-fueled, sleep-deprived, chasing moonshots. 
Fear not, Pepecino's here. Stop rotating, buy a bag, grab a cuppa, and strap up for the ride.

Medium:     https://medium.com/@pepecino02
Telegram:   https://t.me/Pepecino
Twitter:    https://twitter.com/PepecinoERC
 */
...
contract PEPECINO is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Pepecino";
    string private constant _symbol = "PEPECINO";
    ...
    address payable private _developmentAddress = payable(0xdeB231F23E45De4D070c2663a6daa7D117A9DF29);
    address payable private _marketingAddress = payable(0xdeB231F23E45De4D070c2663a6daa7D117A9DF29);
    ...
    uint256 public _amountMaxforTx = 8413800000000 * 10**9;
    uint256 public _WalletSizeLimit = 8413800000000 * 10**9;
