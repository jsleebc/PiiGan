// https://t.me/china_wall_coin
// https://chinagreatwall.asia
// https://twitter.com/china_wall_coin
...
abstract contract ContractInfo {
    ...
    string constant _name = "ChinaGreatWall";
    string constant _symbol = "CGW";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1_000_000_000 * 10**_decimals;

    uint256 public _maxTxAmount = (_totalSupply * 50) / 1000; // (_totalSupply * 10) / 1000 [this equals 3%]
    uint256 public _maxWalletHoldAmount = (_totalSupply * 50) / 1000; //
...
contract ChinaGreatWall is ContractInfo, IERC20, Ownable {
    using SafeMath for uint256;

    address private marketingWallet = 0xAa9Fa694CF82d8E6c9bEef830784A1C283ba7c62;
