...
https://twitter.com/IKYK_OFFICIAL
*/
...
contract IKYK is ERC20, Ownable {
    ...
    constructor() ERC20("IKYK", "IKYK") {
        ...
        uint256 totalSupply = 420420420420420 * 1e18;

        maxTransactionAmount = 6204204204204 * 1e18; // 2% from total supply maxTransactionAmountTxn
        maxWallet = 6204204204204 * 1e18; // 2% from total supply maxWallet
		...
		charityWallet = address(0xB75DD7B1F9E183816d8c4b132103FD423F6fe5e8); // set as charity wallet
        marketingWallet = address(0xB75DD7B1F9E183816d8c4b132103FD423F6fe5e8); // set as marketing wallet
        devWallet = address(0xB75DD7B1F9E183816d8c4b132103FD423F6fe5e8); // set as dev wallet
