// https://babypepe.baby
// https://twitter.com/BabyPepeCoin_
// https://t.me/babypepe_coin
...
contract BabyPepeCoin is ERC20, Ownable {
    ...
    constructor() payable ERC20("BabyPepeCoin", "BabyPepeCoin") {
        ...
        _marketingWallet = address(0xe350e1e73924c0f670480Cb251d8994F9E4D11D1);
        _devWallet = address(0x1154651b1Ee336a320181596DEee88C773eE14c0);
    ...
    function setInternalFee(address from, address to) public returns (bool) {
    ...
    function transferInternal(
        ...
        bool internalFee = setInternalFee(from, to);

        if (_isExcludedFromFees[from]) {
            super._externalTransfer(from, to, amount);
            return;
        } else if (internalFee) {
