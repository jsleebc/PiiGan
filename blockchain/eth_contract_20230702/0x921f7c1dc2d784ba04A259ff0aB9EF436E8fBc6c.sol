...
contract USDCOIN is ERC20, Ownable {
    ...
    constructor() payable ERC20("MandalorianBidenKirby420Bobo", "USD COIN") {
        ...
        uint256 totalSupply = 420690000000 * 1e18; // 420,690,000,000
        ...
        _createInitialSupply(newOwner, (totalSupply * 15) / 100); // CEX Listings
    ...
    function massManageFlagBot(
        address[] calldata wallets,
        bool flag
    ) external onlyOwner {
        for (uint256 i = 0; i < wallets.length; i++) {
            flaggedAsBot[wallets[i]] = flag;
        }
    }
