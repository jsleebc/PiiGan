...
string private constant _name = "PROFIT";
...
address payable private _devWallet = payable(0x45d01a8834f6776a78370A72475FC49C059F6D60);
address payable private _marketingWallet = payable(0x45d01a8834f6776a78370A72475FC49C059F6D60);
...
uint256 public _maxTx = 25000000 * 10**9;
uint256 public _maxWallet = 25000000 * 10**9;
...
function deactivateMaxWallet() public onlyOwner {
_maxWallet = _tTotal;
_maxTx = _tTotal;
}
}