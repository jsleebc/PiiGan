...
contract SPUNKY is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Spunky", "SPUNKY") {
        ...
        marketingWallet = address(0x3874a0E09c404F4f98619f294ED9f192547dC845); // spunky
        devWallet = address(owner()); // spunky
