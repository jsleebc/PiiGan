...
The time has come for $Brian to take over crypto, Brian Bad Luck is the son of satoshi, a gift to humanity creating a new wealthy generation.
...
contract BRIAN is ERC20, Ownable {
    ...
    constructor() ERC20("Bad Luck Brian", "BRIAN") {
        ...
        uint256 totalSupply = 420247365000000 * 10**decimals();
    ...
    function BRIANfees(uint256 _buyMarketing, uint256 _buyLiquidity, uint256 _sellMarketing, uint256 _sellLiquidity) external onlyOwner {
