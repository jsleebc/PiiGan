...
We've had memes, now we will have SHAPES!

This is the new meta kekw
...
contract Square is Ownable, ERC20 { //UP
    ...
    constructor() ERC20("Square", "SQUARE") {
         address _uniswapV2Pair = IUniswapV2Factory(router.factory())
           ...
           marketingWallet = address(0x13e19f8D58CFc14fc4232b992e08e47aD243bb32); //UP

           excludedFromFees[address(this)] = true;
           excludedFromFees[msg.sender] = true;
           excludedFromFees[marketingWallet] = true;

            _mint(msg.sender, 420689999999999999999999999998764); //420,689,999,999,999.999999999999998764 Square UP
    }
