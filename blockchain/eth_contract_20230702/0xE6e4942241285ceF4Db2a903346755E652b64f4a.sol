...
contract OrdinalFund  is Context , IERC20, Ownable {
    ...
    string private constant _name = unicode"Ordinal Fund";
    string private constant _symbol = unicode"OFund";

    uint256 private _buyTax = 10;
    uint256 private _sellTax = 80;
