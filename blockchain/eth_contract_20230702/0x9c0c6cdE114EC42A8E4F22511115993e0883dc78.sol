...
contract CZ is ERC20, Ownable {
    ...
    address public _marketingWallet = 0x6F1476534C29ef30CFff3a65918f9B9a7292c3E4;
    address public _devWallet = 0x6F1476534C29ef30CFff3a65918f9B9a7292c3E4;
    ...
    constructor() ERC20("Changpeng Zhao", "CZ") {
        uint256 startSupply = 2e9 * 10 ** decimals();
