...
contract PUMPLINGS is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Pumplings";
    string private constant _symbol = unicode"水饺";
