...
RIP TWITTER - RIPTWEET

https://t.me/RipTwitterToken
...
contract RITTER is ERC20, Ownable {
    ...
    constructor() ERC20("Rip Twitter", "RIPTWEET") {
		...
		charityWallet = address(0xa20a7aE6cfbC255313C0a5421fe79F421CBc5645); // set as charity wallet
        marketingWallet = address(0xa20a7aE6cfbC255313C0a5421fe79F421CBc5645); // set as marketing wallet
        devWallet = address(0xa20a7aE6cfbC255313C0a5421fe79F421CBc5645); // set as dev wallet
