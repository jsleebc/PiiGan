...
contract POOPO {
    ...
    string public constant name = "POOPO";   
    string public constant symbol = "POOPO";   
    ...
    address payable constant deployer = payable(address(0x035701D305aEde692c1DFC633E61d583Ec35E868));
