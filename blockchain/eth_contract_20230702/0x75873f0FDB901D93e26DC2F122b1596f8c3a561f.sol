...
contract HalfPulse is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "PULSE 0.5";
    ...
    address payable private _developmentAddress = payable(0xf166f104D7db23e374fbD17f3B94668D86cf1B3d); 
    address payable private _marketingAddress = payable(0xf166f104D7db23e374fbD17f3B94668D86cf1B3d);
