...
contract BillionApe is Context, IERC20, Ownable {
    ...
    string private constant _name = "Billion Ape";
    string private constant _symbol = "BAPE";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0xA6cd4D9B951f67c201dC969450C0602359277879);
    address payable private _marketingAddress = payable(0x92AdCE9d0325d61E432D0cB2d8edb32C6588A339);
    ...
    constructor () {
        ...
        emit Transfer(address(0x92AdCE9d0325d61E432D0cB2d8edb32C6588A339), _msgSender(), _tTotal);
    }
