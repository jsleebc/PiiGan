...
/**
oWOJAK ~ Ordinal Wojak

We are currently working on acquiring an Ordinal Inscription for Wojak on Bitcoin. 

Wojak's unwavering faith in Bitcoin is a testament to his foresight and dedication. As he HODLs on for dear life, we believe he deserves recognition for his visionary stance. An Ordinal Inscription would not only symbolize his belief in Bitcoin but also serve as a valuable asset that he can hold onto for years to come. We are committed to our efforts to ensure that Wojak is acknowledged as a true pioneer of Bitcoin.

Website: https://owojak.com
Telegram: https://t.me/owojakchat
Twitter: https://twitter.com/owojakchat
*/
...
contract OrdinalWOJAK is Context, IERC20, Ownable {
    ...
    string private constant _name = "Ordinal Wojak";
    string private constant _symbol = "oWOJAK";
    ...
    function liftLimit() external onlyOwner returns (bool){
