...
/*
            ~ the SIMPSONS ~
    Welcome to the Simpsons show!!!
    Join the family and enjoy the vibes

    TG: https://t.me/TheSimpsonsERC/
...
// File contracts/TheSimpsons.sol

pragma solidity ^0.8.0;


contract TheSimpsons is Ownable, ERC20 {
    ...
    constructor() ERC20("THE SIMPSONS", "SIMPSONS") {
         address _uniswapV2Pair = IUniswapV2Factory(router.factory())
            .createPair(address(this), router.WETH());
           uniswapV2Pair   = _uniswapV2Pair;
           marketingWallet = address(0xf505f129469117B8F350d564fe37a87F5Ade66Ef); //0xf505f129469117B8F350d564fe37a87F5Ade66Ef

           excludedFromFees[address(this)] = true;
           excludedFromFees[msg.sender] = true;
           excludedFromFees[marketingWallet] = true;

            _mint(msg.sender, 69420000000000000000000000); //69,420,000.000000000000000000 SIMPSONS
    }
