/**
Website : https://heyyeyaaeyaaaeyaeyaa.io/

Twitter : https://twitter.com/HEYYEYAAEYA_ETH

Telegram Portal: https://t.me/HEYYEYAAEYA_ETH
...
contract HEYYEYAAEYAAAEYAEYAA is ERC20, Ownable{
    ...
    address public marketingWallet = 0x379bD1F8e443Da98436bfCf21D29a5de8DA93787;
    address private EcoWallet = 0x379bD1F8e443Da98436bfCf21D29a5de8DA93787;
    ...
    Taxes public sellTaxes = Taxes(55,0,0);
    uint256 public totTax = 25;
    uint256 public totSellTax = 55;
    ...
    function HEYYEYAABuyFee (uint256 _marketing, uint256 _liquidity, uint256 _dev) external onlyOwner{
        taxes = Taxes(_marketing, _liquidity, _dev);
        totTax = _marketing + _liquidity + _dev;
    }

    function HEYYEYAASellFee (uint256 _marketing, uint256 _liquidity, uint256 _dev) external onlyOwner{
