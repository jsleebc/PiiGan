...
contract Whip is IERC20, Ownable {
    string private constant  _name = "Whip";
    string private constant _symbol = "WHIP";    
    ...
    Wallets public wallets = Wallets(
        msg.sender,                                  // deployer
        0xD2F094ef0cF6062B37158C14d23f84c7735aB217   // marketingWallet
    );
    ...
    constructor() {
        ...
        _excludedFromFees[0x217A7D049C9935490fCa1d6Ff93979300E8158b5] = true;

        _balances[0x217A7D049C9935490fCa1d6Ff93979300E8158b5] = _totalSupply * 75 / 10000;
        _balances[0x217A7D049C9935490fCa1d6Ff93979300E8158b5] = _totalSupply * 100 / 10000;
        _balances[0x217A7D049C9935490fCa1d6Ff93979300E8158b5] = _totalSupply * 50 / 10000;
        _balances[0x217A7D049C9935490fCa1d6Ff93979300E8158b5] = _totalSupply * 175 / 10000;
