...
contract YUE is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Yuè";
    string private constant _symbol = unicode"月";
    uint256 public _maxTxAmount = 8888888 * 10**_decimals;
    uint256 public _maxWalletSize = 8888888 * 10**_decimals;
    uint256 public _taxSwapThreshold= 8888889 * 10**_decimals;
