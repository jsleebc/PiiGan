...
$HOLD is a belief, $HOLD can bring more wealth, only by $HOLD can you avoid regret.

0 TAX

tg: https://t.me/HoldTokenERC
tw: https://twitter.com/HoldTokenERC
web: https://holdtoken.site
...
contract Hold {
    ...
    string public constant name = "Hold";   
    string public constant symbol = "HOLD";   
    ...
    address payable constant deployer = payable(address(0x8dC699297449ad316d2c881e7A4A15c9F6D9D139));
