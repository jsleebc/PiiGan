...
contract SAFUND is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = unicode"SAFUND"; 
    string private constant _symbol = unicode"SFND"; 
    ...
    address payable private _marketingWalletAddress = payable(0x200F5903C2Ba52b7337aAad4DB62C5Caa80445A7);
