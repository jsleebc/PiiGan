...
contract DYOR is ERC20, Ownable, ERC20Permit {
    constructor() ERC20("DYOR", "DYOR") ERC20Permit("DYOR"){}
    ...
    /// 35% of tokens reserved for LP
    uint256 public constant LP_SUPPLY = 2415000000000 * 10 ** 18;
