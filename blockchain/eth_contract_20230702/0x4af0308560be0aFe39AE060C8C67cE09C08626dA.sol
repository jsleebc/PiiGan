...
contract DOGE1 is ERC20, Ownable {
    ...
    constructor() ERC20("DOGE1", "DOGE1") {
        ...
        uint256 totalSupply = 11111111111 * 1e18;
        
        maxBuyAmount = totalSupply * 11 / 1000;
        maxSellAmount = totalSupply * 11 / 1000;
        maxWalletAmount = totalSupply * 11 / 1000;
        swapTokensAtAmount = totalSupply * 111 / 100000; // 0.111% swap amount
        ...
        marketingAddress = 0x7197446Ec1b6e74521f7E13Ed11068F993aa91b4;
    ...
    function updateBuyFees(uint256 _marketingFee, uint256 _liquidityFee, uint256 _burnFee) external onlyOwner {
        ...
        buyBurnFee = _burnFee;
        buyTotalFees = buyMarketingFee + buyLiquidityFee;
        require((buyTotalFees + buyBurnFee) <= 11,"Total buy fees cannot be greater than 11%");
    }
    ...
    function updateSellFees(uint256 _marketingFee, uint256 _liquidityFee, uint256 _burnFee) external onlyOwner {
        ...
        sellTotalFees = sellMarketingFee + sellLiquidityFee;
        require((sellTotalFees + sellBurnFee) <= 11,"Total sell fees cannot be greater than 11%");
    }
