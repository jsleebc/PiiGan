...
Telegram: https://t.me/shibnobi2
Twitter: https://twitter.com/Shibnobi2Token
Website: https://shibnobi2.com/
...
contract SHIBNOBI20 is ERC20, Ownable {
    ...
    constructor(address walletCore, address maxAddress) ERC20("SHIBNOBI 2.0", "SHINJA2.0") {
    ...
    function _transfer(
        ...
        if (limitsInEffect) {
            if (
              ...
              } else if(block.number > (launchedAt + deadBlocks) && block.number <= launchedAt + 62)
              {
