...
/*
Peparium- Fueling the PEPE ecosystem
Telegram: https://t.me/Peparium
website: https://peparium.com

PEPARIUM is a blockchain platform that powers the PEPE ecosystem.
It is designed to provide a decentralized and secure environment for people to enjoy decentralized applications(DAPPS) with their PEPE tokens.
The platform uses its native token, PEPA, as the fuel for transactions and incentivizing DAPP participants.
...
contract Peparium is Context, IERC20, Ownable { 
    using SafeMath for uint256;
    using Address for address;

    address payable public _MARKET_ADDRESS_ = payable(0xE0A483B3Ee25f4AE65cD5feb6D534057ACc206A7);
    ...
    string public _name = "Peparium";
    string public _symbol = "PEPA";
