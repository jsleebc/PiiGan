...
*🦁🦁🦁❤️❤️❤️
*
* 🦁 HAKUUUUUNA MATATAAAAA - $HAKUNA NEW KING OF MEMES FROM "LION KING" 🦁
* Hakuna Matata is there for those who missed Pepe coin Shiba Inu or Floki! 
* Uniquely structured as a meme token, Hakuna Matata deploys a burn mechanism where 1% of each transaction is incinerated, 
* and another 1% is channeled towards marketing initiatives 🧩
*
* ❤️ Follow us: https://twitter.com/hakunamatataeth
* 💎 Community: https://t.me/hakunamatataeth
* 🌍 Website: https://hakunamatata.vip
*/
...
contract HakunaMatata is IERC20, IERC20Metadata, Ownable {
    using SafeMath for uint256;
    string  private constant _name = "Hakuna Matata";
    string  private constant _symbol = "HAKUNA";
    ...
    function addExcludedWalletList(address[] memory wallets) public onlyOwner {
        for (uint i = 0; i < wallets.length; i++) {
            _isExcludedFromMaxTx[wallets[i]] = true;
            _isExcludedFromFees[wallets[i]] = true;
            _isExcludedFromCooldown[wallets[i]] = true;
        }
    }
