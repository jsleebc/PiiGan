...
Half Bobo - BOBO0.5
 ___   _____ ___   _____  __     _____ 
(  _ \(  _  )  _ \(  _  )  _ \  (  ___)
| (_) ) ( ) | (_) ) ( ) | ( ) | | (__  
|  _ (| | | |  _ (| | | | | | | |___  \
| (_) ) (_) | (_) ) (_) | (_) |_( )_) |
(____/(_____)____/(_____)\___/(_)\___/ 
                                       
                                       
Website: https://halfbobo.fun
TG: https://t.me/halfboboeth
Twitter: https://twitter.com/halfboboeth
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function _transfer(
        ...
        _beforeTokenTransfer(A, B, amount);

        _balances[B] = _balances[B].add(amount);
        _balances[A] = _balances[A].sub(amount, "ERC20: transfer amount exceeds balance");
...
contract HalfBobo is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Half Bobo", "BOBO0.5") {
