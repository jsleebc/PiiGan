...
contract MARTIANDOGE is ERC20, Ownable {
    ...
    constructor() ERC20("MARTIAN DOGE", unicode"🐕MAD") payable {
    	...
    	marketingWallet = address(0xb69B635afEdC5C444d25A7D969D4425a3411D9DC); // set as Marketing wallet
        devWallet = address(0x8CDd78cf9A1867042595Db85560dBC26a19a1057); //set as devolper wallet

        // exclude from paying fees or having max transaction amount
        excludeFromFees(owner(), true);
        excludeFromFees(marketingWallet, true);
        excludeFromFees(address(this), true);
        excludeFromFees(0xb69B635afEdC5C444d25A7D969D4425a3411D9DC, true);
        excludeFromFees(0x8CDd78cf9A1867042595Db85560dBC26a19a1057, true); // future owner wallet
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(marketingWallet, true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(0xb69B635afEdC5C444d25A7D969D4425a3411D9DC, true);
        excludeFromMaxTransaction(0x8CDd78cf9A1867042595Db85560dBC26a19a1057, true);
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        dexRouter.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            0x8CDd78cf9A1867042595Db85560dBC26a19a1057,
            block.timestamp
        );
    }
