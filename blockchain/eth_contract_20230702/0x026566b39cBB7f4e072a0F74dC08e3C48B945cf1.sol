 ...
 * allowances. See {IERC20-approve}.
 */
 contract DodoToken is ERC20, Ownable {
    // TOKENOMICS START ==========================================================>
    string private _name = "Dodo";
    string private _symbol = "DODO";
    uint8 private _decimals = 9;
    uint256 private _supply = 69420000;
    uint256 public taxForLiquidity = 0;
    uint256 public taxForMarketing = 10;
    uint256 public maxTxAmount = 1388400 * 10**_decimals;
    uint256 public maxWalletAmount = 1388400 * 10**_decimals;
    address public marketingWallet = 0x46EC39227496582288Fd88E546688c965A4C64Dc;
    // TOKENOMICS END ============================================================>
    ...
    uint256 private _numTokensSellToAddToLiquidity = 694200 * 10**_decimals;
    uint256 private _numTokensSellToAddToETH = 138840 * 10**_decimals;
