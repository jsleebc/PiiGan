...
contract SHIBPLUS is IERC20, Auth {
    ...
    string private constant  _name = "SHIB PLUS";
    ...
    address payable public marketingWallet = payable(0x93BAf125Ee1A769c17Aa273db681622F5f14eF64);
