...
contract LiuBeiToken is IERC20, Auth {
    uint8 private constant _decimals      = 9;
    uint256 private constant _totalSupply = 888_888_888_888 * (10**_decimals);
    string private constant _name         = "Liu Bei";
    string private  constant _symbol      = "LIU BEI";
    ...
    address payable private _walletMarketing = payable(0x0E9B951767220dd3d29b79928d9fcEB261Abef28); 
    ...
    uint256 private _swapLimit = _taxSwapMin * 56 * 100;
    ...
    constructor() Auth(msg.sender) {
        ...
        uint256 airdropFunds   = _totalSupply * 17 / 100;
