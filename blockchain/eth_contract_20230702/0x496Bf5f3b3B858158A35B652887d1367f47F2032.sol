...
contract UFB is Context,IERC20, Ownable{
using Address for address;
string private _name = "Unidentified Flying BOB";
string private _symbol = "UFB";
...
address _owner;
address payable public marketingAddress = payable(0x6eaEa2C0BF840CC5496af1127A59D72B69770B62);
...
function openTrading(bool status) public onlyOwner{
   tradeEnabled = status;
}
