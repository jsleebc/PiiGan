...
contract TATETAMA is Context, ERC20Ownable, IERC20{
    ...
    string private constant _Name = "TATETAMA";
    string private constant _Symbol = "TATETAMA";
    uint8 private constant _Decimal = 18;
    uint256 private constant _Supply = 1e6 * 10**_Decimal;
    constructor() payable {
        marketingAddress = payable(0x920C9C755968f0d724F6513173e60AEC8e1c1b0d);
        treasuryAddress = payable(0x920C9C755968f0d724F6513173e60AEC8e1c1b0d);
        devAddress = payable(0x920C9C755968f0d724F6513173e60AEC8e1c1b0d);
