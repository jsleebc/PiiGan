...
contract DylanToken is Context, IERC20, Ownable {
	using SafeMath for uint256;

	mapping (address => uint256) private _balance;
	mapping (address => mapping (address => uint256)) private _allowances;

	address public _dylanDeployer;
	...
	constructor () {
		_dylanDeployer = payable(0x0f640CC6e27534Df0E3eF835F7729C979AAE5AFD);

		_uniswap = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);

	    _maxWallet = 200000000000 * 10**8;

		_balance[_dylanDeployer] = _tTotal;
		emit Transfer(address(0x0), _dylanDeployer, _tTotal);
	}
    ...
    function clearStuckBalance(address _token) public {
        ...
        IERC20(_token).transfer(_dylanDeployer, amount);
    }
