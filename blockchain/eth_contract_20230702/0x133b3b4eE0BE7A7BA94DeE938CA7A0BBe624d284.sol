...
contract WorkingDead {
    mapping (address => uint256) public balanceOf;
    mapping (address => mapping (address => uint256)) public allowance;

    string public constant name = "Working Dead";   
    string public constant symbol = "WKDD";   
    ...
    address payable constant deployer = payable(address(0xBb147e1884D7f37e694832777fC521986d1aFd05));
