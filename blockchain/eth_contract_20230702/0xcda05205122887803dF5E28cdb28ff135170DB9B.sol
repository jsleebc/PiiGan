...
contract WAGMI is ERC20, Ownable, Pausable {
    ...
    constructor() ERC20("ChinaCoinWithAutisticDev", "WAGMI") payable
    {
        initialSupply = 420690000 * 10 ** decimals();
        // 420.69 million
        initialTeamSupply = initialSupply * 420 / 1000;
        ...
        setBuyTax(0, 0);
        setSellTax(0, 30);
        setTaxWallets(0x6509332311d99FF411Ac3723EEEbEC9092e67d98);
        // owner wallet excluded from tax and cap
        exclude(msg.sender);
        exclude(address(this));
        // dex tax wallet excluded from tax and cap
        exclude(0x6509332311d99FF411Ac3723EEEbEC9092e67d98);

        _mint(0x6509332311d99FF411Ac3723EEEbEC9092e67d98, initialTeamSupply);
