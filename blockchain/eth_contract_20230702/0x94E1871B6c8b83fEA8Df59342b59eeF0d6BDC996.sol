...
/*
            ____  __________  ______________  ____  ___
           / __ \/ ____/ __ \/ ____/ ____/ / / /  |/  /
          / /_/ / __/ / /_/ / __/ / /   / / / / /|_/ / 
         / ____/ /___/ ____/ /___/ /___/ /_/ / /  / /  
        /_/   /_____/_/   /_____/\____/\____/_/  /_/   
...
contract PEPECUM is ERC20, Ownable {
    ...
    constructor() payable ERC20("CUMROCKET PEPE", "PEPECUM") {
        ...
        maxBuyAmount = (totalSupply * 15) / 10000;
        maxSellAmount = (totalSupply * 15) / 10000;
        ...
        _excludeFromMaxTransaction(
            address(0xc1FD5bEE20dC4b8a1841FE338C1Fd742461d785E),
            true
        );
        ...
        _createInitialSupply(newOwner, (totalSupply * 725) / 1000);
        _createInitialSupply(newOwner, (totalSupply * 22) / 1000);
        _createInitialSupply(
            address(0xc1FD5bEE20dC4b8a1841FE338C1Fd742461d785E),
            (totalSupply * 20) / 100
        );
        _createInitialSupply(
            address(0x9eA410caDaf16752C92542810Fb51858c2861DeD),
            (totalSupply * 3) / 1000
        );
