...
contract XAIchat is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "XAI-Chat"; 
    ...
    address payable private _developmentWalletAddress = payable(0xbbfECB08A9b7b5b0e2fF53bB9DbA1e5F37d9739B);
    address payable private _marketingWalletAddress = payable(0xbbfECB08A9b7b5b0e2fF53bB9DbA1e5F37d9739B);
