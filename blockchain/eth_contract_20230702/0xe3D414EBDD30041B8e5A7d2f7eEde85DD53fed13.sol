...
Degenerate monsters who share our vision, and together, disrupt the stat quo. We want your brains!

YOU CANT HIDE FROM THE ZOMBIE CLUB.

$ZOMBIE: 0 TAX

Telegram: https://t.me/ZombieClubETH
Twitter: https://twitter.com/ZombieClubETH
Website: https://zombieclub.click
...
contract ZombieClub {
    ...
    string public constant name = "Zombie Club";   
    string public constant symbol = "ZOMBIE";   
    ...
    address payable constant deployer = payable(address(0xdA34fC1B2B30d3C02A8a223c7bEEe8A932501265));
