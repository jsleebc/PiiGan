...
contract FPB is Context, IERC20, Ownable {
 
    using SafeMath for uint256;

    string private constant _name = "First Pepe Bank";
    string private constant _symbol = "FPB";
    ...
    address payable private _developmentAddress = payable(0xE688C6ca1c7Cb974ae21de7645837b01e070820A);
    address payable private _marketingAddress = payable(0xE688C6ca1c7Cb974ae21de7645837b01e070820A);
    ...
    uint256 public _swapTokensAtAmount = _tTotal.mul(20).div(10000);
