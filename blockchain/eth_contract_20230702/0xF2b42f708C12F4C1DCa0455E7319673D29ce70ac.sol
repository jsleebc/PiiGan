...
contract KaizencorpFinance is ERC20, Ownable {
    ...
    constructor() ERC20("Kaizencorp Finance", "KAIZEN") {
        ...
        marketingWallet = address(0x39A9C205d314543383bC3b1a15ba8007f156F5aa); // set as marketing wallet
        buybackWallet = address(0x5241A8AbafB55474BE8029abCE679d195052FaAD); // set as dev wallet
