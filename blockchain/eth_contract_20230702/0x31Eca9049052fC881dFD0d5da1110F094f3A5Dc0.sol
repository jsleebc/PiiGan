...
contract CHAN is ERC20, Ownable {
	using SafeMath for uint256;
	...
	constructor() ERC20("4chan", "0x4c") {
		...
		uint256 totalSupply = 690 * 1e9 * 1e18;
		...
		marketingWallet = address(0x0D93F011B4feD97919169F46f77Ff8101d7976C8);
