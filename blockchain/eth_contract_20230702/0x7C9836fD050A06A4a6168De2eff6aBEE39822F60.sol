...
/**
Buy if you are a $GAMBLE addict
🐦: https://twitter.com/GAMBLEADDICT_
...
contract gamble is IERC20, IERC20Metadata, Ownable {
 using SafeMath for uint256;
 string private constant _name = "Gamble Addicts";
