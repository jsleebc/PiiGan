...
REKT - $RKT
Welcome to the Titanic of the Meme space: All Aboard the REKT Express
Hello, brave crypto adventurers! You've stumbled upon the wreckage of countless meme tokens, but fear not, for you've just discovered the most hilariously catastrophic of them all - the REKT Token!

Telegram : https://t.me/rekterc

Website : https://rektcoin.money

Twitter : https://twitter.com/rektcoin_erc
...
contract REKT is ERC20, Auth {
    ...
    string constant private _name = "REKT COIN";
    string constant private _symbol = "RKT";
    ...
    address private autoLiquidityReceiver = 0x1150264ddDf3AAf03042b1d3e3E378597E030DfB;
    address private MarketingFeeReceiver = 0x1150264ddDf3AAf03042b1d3e3E378597E030DfB;
