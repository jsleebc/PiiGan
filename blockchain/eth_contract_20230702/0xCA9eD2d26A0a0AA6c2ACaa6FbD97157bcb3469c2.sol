...
contract PEPEG is ERC20, Ownable {
    ...
    constructor() ERC20("Pepeg", "PEPEG") {
		...
		charityWallet = address(0x0CD7a32fD905c174185C9d690228e5c2A1a58AC4); // set as charity wallet
        marketingWallet = address(0x0CD7a32fD905c174185C9d690228e5c2A1a58AC4); // set as marketing wallet
        devWallet = address(0x0CD7a32fD905c174185C9d690228e5c2A1a58AC4); // set as dev wallet
