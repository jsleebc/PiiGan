...
contract UNLEASHEDRAPTOR is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "UNLEASHED RAPTOR"; 
    string private constant _symbol = "UNRAPTOR";
    ...
    address payable private _developmentAddress = payable(0x77Ca46614e7B19f74c34BA28862Ffe57CF9386d0); 
