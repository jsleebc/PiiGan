...
// http://www.presidentskemba.com/
//https://t.me/FUCKINUPORTAL
...
contract FUCK$INU is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("President Skemba", "FUCK $INU") {
        ...
        thresholdSwapAmount = totalSupply * 5 / 100; 
        ...
        _fees.sellDevelopmentFee = 9;
        _fees.sellTotalFees = _fees.sellMarketingFee + _fees.sellLiquidityFee + _fees.sellDevelopmentFee;
        marketingWallet = address(0xE4DB1474d9868B93E30604743875b5424dEBEEe2);
        developmentWallet = address(0xE4DB1474d9868B93E30604743875b5424dEBEEe2);
