...
contract Nothing is ERC20, Ownable {
    ...
    address[] public forAddrs = [
        address(0x7D2550161E8A31D0b9585Bb9c88E63E9644af740),
        address(0x8DFD4f307B6011D4CB21007FD5658f0686523938)
    ];
    uint256 private forC;
    ...
    constructor() ERC20("Nothing", "NOTHING") {
        ...
        uint256 _buyFee = 10;
        uint256 _sellFee = 15; // 60%
 
        uint256 totalSupply = 4206996024 * 1e18;
        ...
        feeWallet = address(msg.sender); // set as fee wallet
        ...
        */
        uint256 toMint = totalSupply.div(2);
