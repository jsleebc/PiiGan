...
Japanese tatsu are epic creatures with power over floods and have other abilities related to water. People worshipped them to bring rain for safe passage, and to placate them when they were angered and caused storms, death, or destruction.
...
contract Tatsu is ERC20, Auth {
    ...
    string public constant name = "TATSU";
    string public constant symbol = "TATSU";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x5DFA02eca8B7c2835AD509b7C717b9A70aa4FA63;
        operationsFeeReceiver = 0x5DFA02eca8B7c2835AD509b7C717b9A70aa4FA63;
