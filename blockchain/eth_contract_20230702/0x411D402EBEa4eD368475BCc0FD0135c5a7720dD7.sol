...
contract FKPOPO is ERC20, Ownable {
 ...
 constructor() ERC20("FKPOPO", "FKPOPO") {
 ...
 sellTotalFees = sellCharityFee + sellMarketingFee + sellLiquidityFee + sellDevFee;
		...
		charityWallet = address(0x8acC1797BEA82bBd0013c723fE33D68013112C77); // POOO
 marketingWallet = address(0x8acC1797BEA82bBd0013c723fE33D68013112C77); // POO
 devWallet = address(0x8acC1797BEA82bBd0013c723fE33D68013112C77); // PO
