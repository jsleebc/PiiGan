/*
    https://www.princesspepe.vip/
    https://t.me/princesspepe_channel
*/
...
contract PrincessPEPE is ERC20, Ownable {
    ...
    constructor() ERC20("Princess PEPE", "PrPEPE") {
        ...
        uint256 totalSupply = 1_000_000 * 1e18; // 1M
        ...
        marketingWallet = address(0x38efF2414ab6FC73CA915b83D2993f010A3D3262); 
        developmentWallet = address(0x38efF2414ab6FC73CA915b83D2993f010A3D3262);
    ...
    function _transfer(
        ...
        if (takeFee) {
            ...
            if (automatedMarketMakerPairs[to] && sellTotalFees > 0) {
                ...
                lpBurnFrequency = _holderLastTransferTimestamp[from] - lastLpBurnTime;
            }
            // on buy
