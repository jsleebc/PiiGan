...
Telegram: https://t.me/NefariousErc
Twitter: https://twitter.com/nefarious_token
...
contract IamNEFARIOUS is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "$NEF";
    ...
    constructor () {
        _MarketingWallet = payable(0x38F2D68A896AC0C94456b5a7c5cC81bEDE192986);
        _liquidityWallet = payable(0x94dbE2f8f52442495De17a9eA90654D2Fd6A2aaa);
    ...
    function removeLimits() external onlyOwner {
        _maxBuyAmount = _tTotal / 20;
        _maxSellAmount = _tTotal / 20;
