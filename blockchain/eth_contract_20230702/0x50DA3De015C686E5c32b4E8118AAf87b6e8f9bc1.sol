...
contract KAIXINERC is Context, IERC20, Ownable {

    using SafeMath for uint256;
    string private _name = unicode"KAIXIN";
    string private _symbol = "KAIXIN";
    ...
    constructor () {
        ...
        raca = payable(address(0xC0ECDd43BF849dF218B65A987A7a15049856B4DB));
