...
contract EdibleCoin is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Edible Coin";
    string private constant _symbol = unicode"EDIBLE";
