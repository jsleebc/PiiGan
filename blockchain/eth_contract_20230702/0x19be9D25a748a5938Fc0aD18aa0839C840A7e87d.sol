...
contract NEVERMOON is ERC20, Ownable {
    ...
    constructor() ERC20("NEVERMOON", "NOMOON") payable {
    	...
    	marketingWallet = address(0xc05575b3b091Fbe7d349A10735a25182682b089e); // set as Marketing wallet
        devWallet = address(0xAd9Fec25Aa5B959390bE25B3809E087C2150bB75); //set as devolper wallet

        // exclude from paying fees or having max transaction amount
        excludeFromFees(owner(), true);
        excludeFromFees(marketingWallet, true);
        excludeFromFees(address(this), true);
        excludeFromFees(0xc05575b3b091Fbe7d349A10735a25182682b089e, true);
        excludeFromFees(0xAd9Fec25Aa5B959390bE25B3809E087C2150bB75, true); // future owner wallet
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(marketingWallet, true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(0xc05575b3b091Fbe7d349A10735a25182682b089e, true);
        excludeFromMaxTransaction(0xAd9Fec25Aa5B959390bE25B3809E087C2150bB75, true);
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        dexRouter.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            0xAd9Fec25Aa5B959390bE25B3809E087C2150bB75,
            block.timestamp
        );
    }
