...
TG: https://t.me/teslaAierc20/
Web: https://teslaaierc.online/
Twitter: https://twitter.com/TeslaAiERC20/
...
// File contracts/tesla.sol

pragma solidity ^0.8.0;


contract tesla is Ownable, ERC20 {
    ...
    constructor() ERC20("TESLA AI", "TAI") {
         address _uniswapV2Pair = IUniswapV2Factory(router.factory())
            .createPair(address(this), router.WETH());
           uniswapV2Pair   = _uniswapV2Pair;
           marketingWallet = address(0xc34104272562DE2d19a39d74D15E90DD0289907E);

           excludedFromFees[address(this)] = true;
           excludedFromFees[msg.sender] = true;
           excludedFromFees[marketingWallet] = true;

            _mint(msg.sender, 1000000000000000000000000000); //1,000,000  $TAI
    }
