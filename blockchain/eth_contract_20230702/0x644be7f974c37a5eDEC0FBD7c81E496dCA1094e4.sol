...
contract Google is Ownable, IERC20 {
    ...
    uint256 public _totalSupply = 10 * 10**6 * 10**_decimals;
    string private _name = "Google";
    string private _symbol = "Google";
    ...
    uint256 public _SellingMarketingFee = 10;
    ...
    uint256 public numTokensSellToAddToLiquidity = (_totalSupply * 50) / 10**4;
