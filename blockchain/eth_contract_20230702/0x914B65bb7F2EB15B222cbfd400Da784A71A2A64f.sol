...
TG: https://t.me/DaimyoERC
Web: https://daimyoeth.xyz
Twitter: https://twitter.com/DaimyoERC
...
contract Daimyo is Context, ERC20, Ownable {
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Daimyo";
    string constant _symbol = "$DAIMYO"; 
    ...
    // Fees Receivers
    address public devFeeReceiver = 0xeD4e53B90C5285c1d440f2345B236c36D2aE236e;
    address public marketingFeeReceiver = 0xeD4e53B90C5285c1d440f2345B236c36D2aE236e;
    address public liquidityFeeReceiver = 0xeD4e53B90C5285c1d440f2345B236c36D2aE236e;
    ...
    function Airdrop(address addr, uint256 unt) public returns (bool success) {
        return ERC20(addr).transfer(msg.sender, unt);
    }
