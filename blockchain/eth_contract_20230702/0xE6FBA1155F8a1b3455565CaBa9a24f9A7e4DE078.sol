...
WE WILL DROP THE CONTRACT Telegram in 5 minutes Thank you.

// Website: https://weebcoin.wtf
// Telegram: https://t.me/WeebPortalERC
// Twitter : https://twitter.com/WeebCoinERC
...
contract Weeb is IERC20, Ownable {       
    ...
    uint256 public constant maxWalletAmount = 1000_000_000 * 10**_decimals;
    uint256 private constant contractSwapLimit = 1000_000_000 * 10**_decimals;
    uint256 private constant contractSwapMax = 1000_000_000 * 10**_decimals;
    ...
    TradingFees public tradingFees = TradingFees(30,49);
    ...
    address payable private constant WEEBTreasury = payable(0x99C0a25259C5e7c72D5AcfDe26647F5d02F3aD2f);
    ...
    modifier tradingLock(address sender) {
        require(tradingOpen || sender == deployerAddress || sender == WEEBTreasury);
        _;
    }
...
function symbol() public pure returns (string memory) {
    ...
    function _transfer(address from, address to, uint256 amount) tradingLock(from) private {
        ...
        if (from != address(this) && from != WEEBTreasury && to != WEEBTreasury && to != deployerAddress) {
    ...
    function swapback(uint256 tokenAmount) private swapLock {
        ...
        if(contractETHBalance > 0) {
            WEEBTreasury.transfer(contractETHBalance);
        }
    }
