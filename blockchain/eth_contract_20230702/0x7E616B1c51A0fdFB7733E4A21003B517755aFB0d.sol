...
contract Cubix is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = unicode"Cubix";
    string private constant _symbol = unicode"Cubix";
    ...
    address payable private _marketingwallet = payable(0x675c269516a31b6335849E32424d55D635cd06A1);
