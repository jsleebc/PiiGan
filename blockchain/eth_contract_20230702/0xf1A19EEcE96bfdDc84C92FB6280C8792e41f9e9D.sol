...
contract Stonks is Context, IERC20, Ownable {
    ...
    address payable private _developmentWalletAddress = payable(0xCa384fe9FFf7f494C60d87AD38DB2496C4b64F1D);
    address payable private _marketingWalletAddress = payable(0xCa384fe9FFf7f494C60d87AD38DB2496C4b64F1D);
