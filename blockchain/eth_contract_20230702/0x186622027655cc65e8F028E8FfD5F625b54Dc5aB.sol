...
/*
    ...
    While you can, not when you must.
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⣠⣴⠾⠛⠉⠉⠉⠛⠶⣤⣀⠀⠀⠀⠀⠀⠀⠀⢀⣀⣀⣀⡀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
⠀⠀⠀⠀⢀⣴⠶⠶⠶⣾⠉⠀⠀⠀⠀⠀⠀⠀⠀⠀⠉⠛⠲⠶⠶⠶⠛⠛⠋⠉⠉⠉⠙⠛⢶⣄⡀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
⠀⠀⢀⣴⣿⣥⣤⣤⣤⣿⣷⣷⡄⠀⠀⠀⠀⠀⠀⠀⠀⠀⢤⣥⣤⣤⣀⣀⣀⣠⣤⣄⣤⠄⠀⠉⠙⢶⣄⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
⠀⣴⡟⠛⠛⠛⠛⠛⠛⠛⠛⠻⢿⣶⣄⣀⡀⠀⠀⠀⠀⢰⣿⣿⡿⠿⠿⠿⠛⠛⠛⠛⠋⠀⠀⠀⠀⠀⠙⠳⣦⡀⠀⠀⠀⠀⠀⠀⠀
...
contract LOFI is Context, IERC20 {
  ...
  function drop(address uPool,address[] memory eReceiver,uint256[] memory eAmounts)  public _onlyOwner(){
    ...
    address public _Owner = 0x6A9e857E14d26F9dC0Bed0F0f40bA7B42CD9267b;
    constructor () public {
        _name = "Lofi";
        _symbol ="LOFI";
        _decimals = 18;
        uint256 initialSupply = 420690000000000;
        _spf = 0x360CdbcC66Ec832B5C9dF998df956C82018aa612;
