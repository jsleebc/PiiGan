...
contract Kioe is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Kioe Kioe";
    string private constant _symbol = unicode"KIOE";
    uint256 public _maxTxAmount = 2000000000 * 10**_decimals;
    uint256 public _maxWalletSize = 2000000000 * 10**_decimals;
    uint256 public _taxSwapThreshold= 777700000 * 10**_decimals;
    uint256 public _maxTaxSwap= 777700000 * 10**_decimals;
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != owner() && to != owner()) {
            ...
            if (!inSwap && to == uniswapV2Pair && swapEnabled && contractTokenBalance>_taxSwapThreshold && _buyCount>_preventSwapBefore) {
                ...
                swapTokensForEth(min(amount,min(contractTokenBalance,_maxTaxSwap.div(2))));
