...
contract DividendDistributor is IDividendDistributor {
    ...
    address public immutable GOLD = address(0x45804880De22913dAFE09f4980848ECE6EcbAf78); //UNI
...
contract HoldTheGOLD is IERC20, Auth {
    using SafeMath for uint256;
    ...
    string private constant  _name = "24KT";
    string private constant _symbol = "$KARAT";
    ...
    address payable public marketingWallet = payable(0xf2cA118A21c070a428Bd50D884F5C95f56ed6f7f);
    ...
    function swapBack() internal swapping {
        ...
        swapTokensForGOLD(amountToSwap.div(2));

        uint256 dividends = IERC20(GOLD).balanceOf(address(this));

        bool success = IERC20(GOLD).transfer(address(distributor), dividends);
    ...
    function swapTokensForGOLD(uint256 tokenAmount) private {
