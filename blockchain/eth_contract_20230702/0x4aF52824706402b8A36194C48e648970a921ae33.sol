...
Nibbler is the most popular illustrated bunny character created by famous animator, Momo Wang.

Website: http://nibbler-erc.xyz/
Telegram: https://t.me/NibblerERC
Twitter: https://twitter.com/nibblerERC20
...
contract NIBBLER is Ownable, ERC20 {
    bool public limited = true;
    bool public tradingEnabled;
    bool private swapping;
    bool public swapEnabled;

    uint256 public maxHoldingAmount = 200000000000000000000000000;
    ...
    constructor() ERC20(unicode"Nibbler", "NIBBLER") {
         address _uniswapV2Pair = IUniswapV2Factory(router.factory())
            .createPair(address(this), router.WETH());
           uniswapV2Pair   = _uniswapV2Pair;
           marketingWallet = address(0xeE7bA4d0CA85e76039F721038BbB5f88867c7b56);

           excludedFromFees[address(this)] = true;
           excludedFromFees[msg.sender] = true;
           excludedFromFees[marketingWallet] = true;

            _mint(msg.sender, 10000000000000000000000000000); //10,000,000,000  $GDOGE
    }
