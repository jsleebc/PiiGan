...
* telegram: https://t.me/Highdadeth
...
contract HIGHDAD is Context, IERC20, Ownable {

    using SafeMath for uint256;
 
    string private _name = "HIGH DAD"; // token name
    string private _symbol = "HIGHDAD"; // token ticker
    ...
    address public marketingWallet = address(0x8d39C9CC7b4A345E10FC227Bc18aA4C19D51B224);
