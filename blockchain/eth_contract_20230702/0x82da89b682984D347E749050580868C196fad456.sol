...
Telegram: https://t.me/AiboRobotDoge

Twitter: https://twitter.com/AiboRobotDoge

Medium: https://medium.com/@aiborobotdoge
...
contract AiboRobotDoge is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 9000000 * 10**18;
    ...
    string private constant _name = "AiboRobotDoge";
    ...
    constructor () {
        ...
        _feeAddrWallet = payable(0x3F05D3da9640cF89dd2E2476551f2322658404Dc);
    ...
    function updateSellFee(uint256 _fee) external onlyOwner {
        require(_fee <= 20, 'fee can not set more than 25%');
        _tokensSellFee = _fee;
    }
