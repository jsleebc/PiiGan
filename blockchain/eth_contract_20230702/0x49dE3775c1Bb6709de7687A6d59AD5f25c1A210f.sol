...
contract Degen is Context, IERC20, Ownable {
    ...
    string private constant _name = "THE DEGEN";
    string private constant _symbol = unicode"ΝΤΕΤΖΕΝ";
    ...
    address payable private _developmentAddress = payable(0x40Ab022ADC761DDa610809ba340100e8E107b805); 
    address payable private _marketingAddress = payable(0x40Ab022ADC761DDa610809ba340100e8E107b805);
