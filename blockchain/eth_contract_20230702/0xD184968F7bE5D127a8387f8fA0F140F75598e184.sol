/*
   Ethereum Savior is here to Reign #VITALIK

   Website: https://www.etherman.io/
   Telegram: https://t.me/EthermanERC20
   Twitter: https://twitter.com/EthermanERC20
*/
...
contract Etherman is Context, IERC20, Ownable {
    ...
    string private constant _name = "Etherman"; 
    string private constant _symbol = "ETHMAN"; 
    ...
    address payable private _developmentWalletAddress = payable(0x2b969111F5A1f29BcF5fd3122F7E8a549675f544);
    address payable private _marketingWalletAddress = payable(0x60982750117374541fc283dea4146B32A5FFB63C);
