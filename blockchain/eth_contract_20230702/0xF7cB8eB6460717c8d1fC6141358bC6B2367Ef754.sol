...
contract DividendDistributor is IDividendDistributor {
    ...
    address public immutable USDT = address(0xdAC17F958D2ee523a2206206994597C13D831ec7); //UNI
...
contract TheFederalReserve is IERC20, Auth {
    ...
    uint256 private maxBuy = 250000 * (10 ** _decimals);
    ...
    function swapBack() internal swapping {
        ...
        swapTokensForUSDT(amountToSwap.div(2));

        uint256 dividends = IERC20(USDT).balanceOf(address(this));

        bool success = IERC20(USDT).transfer(address(distributor), dividends);
