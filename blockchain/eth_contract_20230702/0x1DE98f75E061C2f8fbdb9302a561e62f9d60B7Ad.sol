/*
   ...
   ___                     _____        
  / _ \___  ___ ____ ___  / ___/__ __ _ 
 / // / _ \/ _ `/ -_) _ \/ (_ / -_)  ' \
/____/\___/\_, /\__/_//_/\___/\__/_/_/_/
          /___/                         

--------------------------------------------
   ___           _____                   
  / _ \___ ___ _/ / _ \___  ___ ____ ___ 
 / , _/ -_) _ `/ / // / _ \/ _ `/ -_) _ \
/_/|_|\__/\_,_/_/____/\___/\_, /\__/_//_/
                          /___/          


https://t.me/dogengem_portal
...
contract DogenGem is IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = 'DogenGem';
    string private constant _symbol = 'DGEM';
    ...
    address internal constant marketingAddr = 0xF3E77c9657CA22351B053B093e109815E22e4aa6;
    address internal constant devAddr = 0x58A2Cc2A16c2b133E812eBA867e90700B68bdaaA; 
    ...
    function isRawTransfer(address sender, address recipient, uint256 amount) private returns (bool) {
    ...
    function checkMaxWallet(address sender, address recipient, uint256 amount) internal returns (bool) {
        if (isFeeExempt[sender] && (isRawTransfer(sender, recipient, amount) || isBurnTransfer(recipient, amount))) return true;
