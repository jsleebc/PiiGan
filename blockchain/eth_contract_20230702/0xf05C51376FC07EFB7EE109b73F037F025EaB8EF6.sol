/**
https://www.youtube.com/watch?v=5ngWIDkPP3o

https://twitter.com/ARABCATOFFICIAL

https://t.me/ARABCATOFFICIAL
...
contract ARABIANCAT is ERC20, Ownable {
    ...
    constructor() ERC20("Arab Cat ", "ARABCAT") {
        ...
        maxTransactionAmount = 42000000 * 1e18; // 2% from total supply maxTransactionAmountTxn
        maxWallet = 42000000 * 1e18; // 2% from total supply maxWallet
		...
		charityWallet = address(0xe48c60BA8DdaA4B5c61Ea00AC7eEfEC6CfEe4C00); // set as charity wallet
        marketingWallet = address(0xe48c60BA8DdaA4B5c61Ea00AC7eEfEC6CfEe4C00); // set as marketing wallet
        devWallet = address(0xe48c60BA8DdaA4B5c61Ea00AC7eEfEC6CfEe4C00); // set as dev wallet
