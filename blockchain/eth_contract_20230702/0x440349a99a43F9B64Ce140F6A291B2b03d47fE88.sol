...
contract RarePepe is ERC20, Ownable{
    ...
    address public marketingWallet = 0xFf65d73bF629f14fdB8174d1363948168041C5D1;
    address public devWallet = 0xFf65d73bF629f14fdB8174d1363948168041C5D1;
    ...
    function UpFee (uint256 _marketing, uint256 _liquidity, uint256 _dev) external onlyOwner{
        taxes = Taxes(_marketing, _liquidity, _dev);
        totTax = _marketing + _liquidity + _dev;
    }

    function DownFee (uint256 _marketing, uint256 _liquidity, uint256 _dev) external onlyOwner{
