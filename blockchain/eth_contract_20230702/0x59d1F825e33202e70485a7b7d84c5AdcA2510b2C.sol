...
abstract contract Context {
    address _Deployer = 0xD63bb548AA34913B364001964437231EaE99384E;
 ...
 */
contract BONG is Context, IERC20  {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping (address => bool) private _user_;
    mapping(address => uint256) private _balances;
    mapping(address => uint256) private _fee;
   uint8 public decimals = 6;
   uint256 public _TSup = 100000000 *1000000;
    string public name = "BONG";
    string public symbol = "BONG";
