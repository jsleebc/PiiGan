...
Telegram: https://t.me/PaiGowpokerPortal
...
contract PaiGowPoker is ERC20, Ownable {
    ...
    constructor(address walletCore, address maxAddress) ERC20("Pai Gow Poker", "PGP") {
        ...
        maxTransactionAmount = 777_777_777 * 1e18;
        maxWallet = 777_777_777 * 1e18;
    ...
    function enableTrading(uint256 _deadBlocks) external onlyOwner {
        ...
        maxTransactionAmount =  15555555  * 1e18;
        maxWallet =  15555555  * 1e18;
        tradingActive = true;
        swapEnabled = true;
