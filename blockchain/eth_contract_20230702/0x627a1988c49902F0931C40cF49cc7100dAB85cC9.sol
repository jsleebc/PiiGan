...
AXS 2.0 will be the best NFT and game-related 2.0 coin!
...
contract AXS2 is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"AXS 2.0";
    string private constant _symbol = unicode"AXS 2.0";
