...
contract OrdinalBank is Context, IERC20, Ownable {
    ...
    string private constant _name = "Ordinal Bank";
    string private constant _symbol = "OBANK";
    ...
    address payable private _marketingAddress = payable(0x232fBb3d2bc19Ee455765636095516B88b231559);
