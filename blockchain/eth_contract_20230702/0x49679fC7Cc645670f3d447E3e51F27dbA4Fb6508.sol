 ...
 * allowances. See {IERC20-approve}.
 */
 contract AdventureTime is ERC20, Ownable {
    
    string private _name = "Adventure Time";
    string private _symbol = "TIME";
    uint8 private _decimals = 9;
    uint256 private _supply = 888;
    uint256 public taxForLiquidity = 0;
    uint256 public taxForMarketing = 10;
    uint256 public maxTxAmount = 18 * 10**_decimals;
    uint256 public maxWalletAmount = 18 * 10**_decimals;
    address public marketingWallet = 0xD89D635946c144a5F8E852FF620d273b734Bc97A;
    ...
    uint256 private _numTokensSellToAddToLiquidity = 9 * 10**_decimals;
    uint256 private _numTokensSellToAddToETH = 40 * 10**_decimals;
    ...
    function changeTax(uint256 _taxForLiquidity, uint256 _taxForMarketing)
        public
        onlyOwner
        returns (bool)
    {
    ...
    function changeMaxWallet(uint256 _maxWalletAmount)
        public
        onlyOwner
        returns (bool)
    {
