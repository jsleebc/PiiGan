// BEN.ETH HAS BEEN SUCKING LIQUIDITY FROM THE MARKET FOR TOO LONG NOW. BY BUYING $FKLL YOU STAND AGAINST WHAT HE DOES. HE IS A PEST AND HIS GREED WILL SUCK THE MARKETS DRY. SAY NO TO BEN.ETH. BUY $FKLL.

// https://twitter.com/fvckloyaltylabs
// https://t.me/fuckloyal
...
contract FKLL is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Fuck Loyalty Labs", "$FKLL") {
        ...
        devOpsWallet = address(0x26DbD17eCb721563A7d8a403d75E9906916E8B8c); // set as devOps wallet
 
        // exclude from paying fees or having max transaction amount
        excludeFromFees(owner(), true);
        excludeFromFees(address(this), true);
        excludeFromFees(address(0xdead), true);
        excludeFromFees(address(0x26DbD17eCb721563A7d8a403d75E9906916E8B8c), true);
 
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0xdead), true);
        excludeFromMaxTransaction(address(0x26DbD17eCb721563A7d8a403d75E9906916E8B8c), true);
