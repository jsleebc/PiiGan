...
contract RefundInu is Context, IERC20, Ownable {

    using SafeMath for uint256;
    string private _name = "RefundInu";
    string private _symbol = "RFDINU";
    ...
    constructor () {
        ...
        fundToAddr = payable(address(0xc8Ab0d6b4a5FCF63BEA4b050e65fCeB44cffDD3e));
