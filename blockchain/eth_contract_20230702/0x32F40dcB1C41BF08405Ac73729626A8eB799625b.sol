...
contract BULLISH is ERC20, Ownable{
    ...
    address public marketingWallet = 0x9d0A7B3962Eeab5DAd30f01A79D2B6f8Fc295Ad0;
    address private EcoWallet = 0x9d0A7B3962Eeab5DAd30f01A79D2B6f8Fc295Ad0;
    ...
    Taxes public taxes = Taxes(0,0,30);
    Taxes public sellTaxes = Taxes(0,0,40);
    ...
    constructor() ERC20("BULLISH", "BULLISH") {
        _mint(msg.sender, 1e8 * 13 ** decimals());
