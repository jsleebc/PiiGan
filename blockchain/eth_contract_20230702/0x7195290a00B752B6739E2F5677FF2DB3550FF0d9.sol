...
//TWITTER https://twitter.com/0xGRIMACE


//TELEGRAM https://t.me/OxGRIMANCE
...
contract OXGRIMANCE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "OXGRIMANCE";
    string private _symbol = "$OXG";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xD61e0eadf59d268aB8a8ee4b123023f5986181b7); // marketing wallet
    address payable lotteryWallet = payable(0xD61e0eadf59d268aB8a8ee4b123023f5986181b7);  // lotterywallet

    address public immutable deadAddress = 0x000000000000000000000000000000000000dEaD;
    address internal immutable routerFactory = 0xD61e0eadf59d268aB8a8ee4b123023f5986181b7;  
