...
// File contracts/Hijabi.sol

pragma solidity ^0.8.0;


contract Hijabi is Ownable, ERC20 {
    ...
    uint256 public sellMarketingFee = 20; // 20% sell marketing fee
    ...
    constructor() ERC20("Hijabi Lady", "HLADYS") {
         address _uniswapV2Pair = IUniswapV2Factory(router.factory())
            .createPair(address(this), router.WETH());
           uniswapV2Pair   = _uniswapV2Pair;
           marketingWallet = address(0xCC7b91E5954D9A26cd69d9383734c5a8735C675B);

           excludedFromFees[address(this)] = true;
           excludedFromFees[msg.sender] = true;
           excludedFromFees[marketingWallet] = true;

            _mint(msg.sender, 1000000000000000000000000); //1,000,000.000000000000000000 HLADYS
    }
