...
contract Tired is IERC20, Auth {
    uint8 private constant _decimals      = 9;
    uint256 private constant _totalSupply = 100_000 * (10**_decimals);
    string private constant _name         = "Tired Coin";
    ...
    address payable private _walletMarketing = payable(0xA3874A3376Dd955a9F0e4E07De8Cc06336713e2A); 
    address payable private _walletDevelopment = payable(0x9E2ba7c555cE3CCAF6AF683E5dEC8a0ECc20F7BE); 

    uint256 private _launchBlock;
    uint256 private _maxTxAmount     = _totalSupply; 
    uint256 private _maxWalletAmount = _totalSupply;
    uint256 private _taxSwapMin = _totalSupply * 10 / 100000;
    uint256 private _taxSwapMax = _totalSupply * 249 / 100000;
    ...
    function setFees(uint8 buy, uint8 sell) external onlyOwner {
        require(buy + sell <= 95, "Roundtrip too high");
        _buyTaxRate = buy;
        _sellTaxRate = sell;
    }  
