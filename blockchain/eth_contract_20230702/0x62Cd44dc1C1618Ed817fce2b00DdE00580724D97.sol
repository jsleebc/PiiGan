...
contract WINDOWS98 is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Windows 98";
    string private constant _symbol = unicode"WIN98";
