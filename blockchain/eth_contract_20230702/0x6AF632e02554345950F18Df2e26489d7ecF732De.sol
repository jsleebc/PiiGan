// Website: https://printdollars.gg/
// Twitter: https://twitter.com/fed_erc20
// Telegram: https://t.me/FED_erc20
...
contract DividendDistributor is IDividendDistributor {
    ...
    address public immutable MIM = address(0x99D8a9C45b2ecA8864373A26D1459e3Dff1e17F3); //UNI
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            shares[shareholder].totalExcluded = getCumulativeDividends(shares[shareholder].amount);
            IERC20(MIM).transfer(shareholder, amount);
        }
    }
...
contract TheFederalReserve is IERC20, Auth {
    using SafeMath for uint256;
    ...
    string private constant  _name = "The Federal Reserve";
    ...
    address payable public marketingWallet = payable(0x77ece67AE192820c12797F8220af8c579079e857);
    ...
    function swapBack() internal swapping {
        ...
        swapTokensForMIM(amountToSwap.div(2));

        uint256 dividends = IERC20(MIM).balanceOf(address(this));

        bool success = IERC20(MIM).transfer(address(distributor), dividends);
