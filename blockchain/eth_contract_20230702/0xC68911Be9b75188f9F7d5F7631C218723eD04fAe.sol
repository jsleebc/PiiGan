...
Experience the divine intervention your portfolio needs with Jesus 2.0
...
Website: https://jesus2.pro
Twitter: https://twitter.com/jesus2eth
Chat:    https://t.me/jesus2eth
...
contract JESUS2 is ERC20, Ownable {
    ...
    address private marketingWallet=0x50B4f9741b377057bD8E60FC177d2040cA5c5395;
    address private devWallet=0x50B4f9741b377057bD8E60FC177d2040cA5c5395;
    ...
    constructor() ERC20("Jesus 2.0", "JESUS 2.0") { 
        ...
        uint256 totalSupply = 777 * 10 ** decimals(); 
 
        maxTransactionAmount = 8 * 10 ** decimals(); 
        maxWalletAmount = 16 * 10 ** decimals(); 
        swapTokensAtAmount = 8 * 10 ** decimals(); 
