/*         
    ...
    Welcome to the wild world of Diamond Hands, where we embrace the power of fearless HODLing and ride the crypto rollercoaster like true champs! 
    
    This token is all about having fun while staying strong in the face of market ups and downs.

    Tax : 0/0 

    https://t.me/DiamondHandsETH

    https://twitter.com/DHToken
    
    https://DiamondHands.one
...
contract DiamondHands is ERC20, Ownable {
    ...
    constructor() ERC20("Diamond Hands", "DH") {
        ...
        marketingWallet = address(0x4842cECd688C5faEf97096CD7a0294C112CD20e7); 
        developmentWallet = address(0x4842cECd688C5faEf97096CD7a0294C112CD20e7); 
