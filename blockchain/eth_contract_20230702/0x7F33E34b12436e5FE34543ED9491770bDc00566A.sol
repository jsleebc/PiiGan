//**
// In most wolf packs, there will be an alpha male and female and frequently an omega male and female. Tairya is Tairyo's attractive and fierceful other half.

// Introducing the Omega Wolf to $TAIRYO: The kingdom of Tairya is fairly ruled. 

//Inspired by Tairyo, Tairya was built to create a shift in the ecosystem, by presenting novelties to web3.
// 
//*https://t.me/Tairyainu
//*https://twitter.com/Tairyainu
//*https://tairyainu.com/
//
...
contract $TAIRYA is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("TAIRYA INU", "$TAIRYA") {
