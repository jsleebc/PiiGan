...
contract Sepe is ERC20, Ownable{
    ...
    uint256 tsupply = 420000000006969 * 10 ** decimals();
    ...
    uint256 private tBuyTax = 25; // Tax Marketing
    uint256 private tSellTax = 65;// Tax Marketing
    ...
    constructor(address _MarketingWallet) ERC20("Sepe", "SEPE") {
