...
https://t.me/SueEveryCrypto
https://twitter.com/SueEveryCrypto
...
contract SueEveryCrypto is ERC20, Auth {
    ...
    string public constant name = "Sue Every Crypto";
    string public constant symbol = "SEC";
    uint8 public constant decimals = 18;
    
    uint256 public constant totalSupply = 6_000_000_000 * 10**decimals;
    ...
    function setMultipliers(uint256 _buy, uint256 _sell) external onlyOwner {
        require(_buy < 71,"Max buy tax can be 7%");
        require(_sell < 71,"Max sell tax can be 7%");
