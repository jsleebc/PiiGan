...
/*
    ...
    Twitter: https://twitter.com/BabyApedERC
    Telegram: https://t.me/Baped
    Website: https://babyaped.xyz
...
contract BabyAped is ERC20, Ownable {

    using SafeMath for uint256;

    mapping(address => bool) private _excludes;

    uint256 public mWalletSize = 10 ** 6 * 10 ** decimals() * 2; // 2%
    uint256 private tSupply = (10 ** 8) * 10 ** decimals();

    constructor() ERC20("BabyAped", "BAPED") {
