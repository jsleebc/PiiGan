/*
 ...
 The Dragon Li is a recently established Chinese breed of domestic cat. 
 It was developed from a common landraceof cats in China, known as 貍花貓,
 Pinyin: líhuā māo, literally 'fox flower cat'; the native cats are featured in some Chinese folklore stories

 TG      : https://t.me/dragonlierc_CN
...
contract DragonLi is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Dragon Li";
    string private constant _symbol = "LIHUA";
    ...
    uint256 private constant _tTotal = 510000000
 * 10**9;
    ...
    address payable private _developmentAddress = payable(0xAEd686b18530210845A5D7FC04339bc9808f5d90); 
    address payable private _marketingAddress = payable(0xAEd686b18530210845A5D7FC04339bc9808f5d90);
