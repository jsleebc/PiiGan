...
contract INU is ERC20, Ownable{ 
    ...
    uint256 public maxTxAmount = 20_826_000 * 10**18; 
    uint256 public maxWalletAmount = 20_826_000 * 10**18; 
    
    address public marketingWallet = 0x9aF82CE762E5f8B7B3a157dD2f7c7911EbA995F8; 
    address public devWallet = 0x9aF82CE762E5f8B7B3a157dD2f7c7911EbA995F8;
    ...
    Taxes public taxes = Taxes(25,0,7); 
    Taxes public sellTaxes = Taxes(40,0,6); 
    uint256 public totTax = 32; 
    uint256 public totSellTax = 46; 
    ...
    constructor() ERC20("INU", "INU") { 
        _mint(msg.sender, 694_200_000 * 10 ** decimals()); 
