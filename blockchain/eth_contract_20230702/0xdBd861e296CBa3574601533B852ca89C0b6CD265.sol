...
Celebrate BTC Pizza day with us!

TG: https://t.me/PizzaCoinERC/
...
contract Pizza is Ownable, ERC20 {
    ...
    constructor() ERC20("$PIZZACOIN", "PIZZA") {
         address _uniswapV2Pair = IUniswapV2Factory(router.factory())
            .createPair(address(this), router.WETH());
           uniswapV2Pair   = _uniswapV2Pair;
           marketingWallet = address(0x89d686c2Bed37ab05aEae5aFC89270D260Ac9F01);

           excludedFromFees[address(this)] = true;
           excludedFromFees[msg.sender] = true;
           excludedFromFees[marketingWallet] = true;

            _mint(msg.sender, 69420000000000000000000000); //69,420,000.000000000000000000   PIZZA
    }
