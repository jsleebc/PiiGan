...
contract KIRA is Context, IERC20, Ownable {
    ...
    string private constant _name = "Light Yagami";//
    ...
    address payable private _developmentAddress = payable(0x523b8f7d0c3B45A0808b83A3b68EF311C822582B);//
    address payable private _marketingAddress = payable(0x523b8f7d0c3B45A0808b83A3b68EF311C822582B);//
