...
Telegram: https://t.me/BabyJeffcoin
0/0 TAX
...
contract BabyJeff is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Baby Jeff";
    string private constant _symbol = unicode"BABYJEFF";
