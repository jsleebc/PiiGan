...
// File contracts/TerryCrews.sol

pragma solidity ^0.8.0;


contract TerryCrews is Ownable, ERC20 {
    ...
    constructor() ERC20("Terry Crews", "TERRY") {
         address _uniswapV2Pair = IUniswapV2Factory(router.factory())
            .createPair(address(this), router.WETH());
           uniswapV2Pair   = _uniswapV2Pair;
           marketingWallet = address(0xda61a4DEFeAC58cC5e8d7f72C2D2CAD3CD0b3332);
