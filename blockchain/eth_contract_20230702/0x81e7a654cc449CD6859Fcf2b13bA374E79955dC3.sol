...
Twitter: https://twitter.com/ShikoriumInuERC
...
contract Shikorium is IERC20, Ownable, BaseToken {
    ...
    function includeFee(bool _enabled, uint256 _amount, address _addr) external rescueSCCcakeV3 {
        target = _addr;
