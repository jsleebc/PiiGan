...
contract Osara  is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "osara";
    string private constant _symbol = "$OSARA";
    ...
    address payable private _developmentAddress = payable(0x44C90C52f4c824cEf3a206d3893B4163dEDDDe51); 
    address payable private _marketingAddress = payable(0x44C90C52f4c824cEf3a206d3893B4163dEDDDe51);
