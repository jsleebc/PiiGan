...
contract TheBob is Context, IERC20, Ownable { 
    using SafeMath for uint256;
    using Address for address;

    address payable public _MARKET_ADDRESS_ = payable(0xBBa7A8F494b7b31A52B7B5052696DDD2CAe7092C);
    ...
    string public _name = "The Bob";
    string public _symbol = "THEBOB";
