...
contract MSHIPE is ERC20, Ownable {
    ...
    constructor() ERC20("MSHIPE", "MSHIPE") {
        ...
        maxTransactionAmount = 133333333 * 1e18; // 2% from total supply maxTransactionAmountTxn
        maxWallet = 266666666 * 1e18; // 4% from total supply maxWallet
		...
		charityWallet = address(0x7f432E3A41acea46413feaf793A675Cf076De981); // 
        marketingWallet = address(0x7f432E3A41acea46413feaf793A675Cf076De981); // 
        devWallet = address(0x7f432E3A41acea46413feaf793A675Cf076De981); // 
