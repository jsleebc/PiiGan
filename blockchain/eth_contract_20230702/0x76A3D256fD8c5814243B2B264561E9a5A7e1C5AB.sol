/**
     ...
     Florida’s governor and the Republican Party’s latest 
     leadership candidate talked crypto and central bank digital 
     currencies in a Twitter space with Elon Musk.

     A new beginning will prevail with the new candidate for this coming election; 
     it will send the regime to the new and future trading of the community to become 
     one as the Crypto Republic. This is a key and an eye-opener for all voters to 
     pick the right one for the sake of finance. Come and support the future of bitcoin.

                  Cuz we are DESANTIS INU!


    TG -  https://t.me/desantisinuerc
    TWITTER - https://twitter.com/DESANTISINU
...
contract DeSantisInu is ERC20 {
    uint256 initialSupply = 1000000000;
    constructor() ERC20(0x0ce9Ac2D814E5CBBB322DD768BA28b7EC6961C8f, "DeSantis Inu", "DeSantis") {
