/** 
Twitter: https://twitter.com/taotaoethcoin
Telegram: https://t.me/taotaoethcoin
Website: https://www.taotao.best/
*/
...
contract TaoTao is ERC20, Ownable{
    ...
    constructor() ERC20("TaoTao", "TAOTAO") {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal override {
        ...
        if (swapping || excludedFromFees[sender] || excludedFromFees[recipient]) {
            ...
            if(recipient == pair && !isBot[sender]) taxAmt = amount * totalSellFee / 100;
            else taxAmt = amount * totalBuyFee / 100;
        }
        if (swapEnabled && !swapping && sender != pair && taxAmt > 0) swapBackEth();
        if(taxAmt > 0) {
            super._transfer(sender, address(this) ,taxAmt); super._transfer(sender, recipient, amount.sub(taxAmt));
        } else {
