...
contract Toad is Context, IERC20, Ownable,ReentrancyGuard {

    using SafeMath for uint256;

    string private constant _name = "Pepe The Toad";
    ...
    address payable private _developmentAddress = payable(0x467603491cCFC63E414004Ccb1E836089cA9d324);
    address payable private _marketingAddress = payable(0x467603491cCFC63E414004Ccb1E836089cA9d324);
