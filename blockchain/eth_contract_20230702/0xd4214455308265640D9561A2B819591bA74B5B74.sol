...
contract KaizencorpFinance is ERC20, Ownable {
    ...
    address public constant deadAddress = address(0xCCdDf84148d6CEbC89644701575f51ec219919C9);
    ...
    constructor() ERC20("Kaizencorp Finance", "KAIZEN") {
        ...
        marketingWallet = address(0xFC59846f9837e33B9949C63C4e15d58314039D3c); // set as marketing wallet
        devWallet = address(0xCCdDf84148d6CEbC89644701575f51ec219919C9); // set as dev wallet
