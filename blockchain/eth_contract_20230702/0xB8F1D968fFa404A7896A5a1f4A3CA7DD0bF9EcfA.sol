...
contract AIX is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"AI X";
    string private constant _symbol = unicode"AIX";
    uint256 public _maxTxAmount =      8420000000000 * 10**_decimals;
    uint256 public _maxWalletSize =    8420000000000 * 10**_decimals;
