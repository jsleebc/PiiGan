...
contract Punk2 is IERC20, Auth {
    uint8 private constant _decimals      = 9;
    uint256 private constant _totalSupply = 666_666_666 * (10**_decimals);
    string private constant _name         = "Punk Coin 2.0";
    string private  constant _symbol       = "PUNK2.0";
    ...
    address payable private _walletMarketing = payable(0x224Cb6Eb64830eb20AEd66c8C1611D8fD591dB79); 
    address payable private _walletDevelopment = payable(0x224Cb6Eb64830eb20AEd66c8C1611D8fD591dB79); 
    ...
    function setFees(uint8 buy, uint8 sell) external onlyOwner {
        require(buy + sell <= 6, "Roundtrip too high");
        _buyTaxRate = buy;
        _sellTaxRate = sell;
    }  
