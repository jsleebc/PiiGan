// Twitter: https://twitter.com/sendtxeth
// Telegram: @Sendtx_erc
...
contract sendTX is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "SEND TX"; 
    ...
    address payable private _developmentWalletAddress = payable(0xF6AbF8Ada31b15f77AE776B9aBd9bCf5F1d8B7D1);
    address payable private _marketingWalletAddress = payable(0xF6AbF8Ada31b15f77AE776B9aBd9bCf5F1d8B7D1);
