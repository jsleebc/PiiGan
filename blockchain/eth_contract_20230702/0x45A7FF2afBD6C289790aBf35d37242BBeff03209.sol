...
contract McPepe {
    string public constant name = "McPepe";  //
    string public constant symbol = "MCPEPE";  //
    ...
    address payable constant deployer = payable(address(0xa9bf649f33A743434AE3D236051da365aEd3745B)); // 
