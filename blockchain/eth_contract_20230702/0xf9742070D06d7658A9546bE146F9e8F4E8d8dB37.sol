...
contract LMFAO is Ownable, ERC20 {
    bool public limited;
    uint256 public maxHoldingAmount;
    address public uniswapV2Pair;

    constructor(uint256 _totalSupply) ERC20("LMFAO", "LMFAO") {
    ...
    function _beforeTokenTransfer(
        ...
        if (to == uniswapV2Pair) {
            require(!isContract(msg.sender), "Fuck you bot!");
        }
    }
