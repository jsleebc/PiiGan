/**
https://cincodepepe.vip/
https://twitter.com/Cinco_De_Pepe
...
contract CINCO is Context, IERC20, Ownable, Pausable {
    ...
    string private _name = "CINCO DE PEPE";
    string private _symbol = "CINCO"; 
    ...
    address payable public marketingWallet = payable(0x5f506E9e0A9eAE0E61bd3E33f0a4f67BcC021d06);
    ...
    uint256 public numTokensSellToAddToLiquidity = 5000000000 * 10**9; //0.1%
    uint256 public _maxTxAmount = 50000000000 * 10**9;
    uint256 public maxBuyTransactionAmount = 12500000000 * 10**9;  //0.25%
    uint256 public maxWalletToken = 50000000000 * 10**9; //1%
