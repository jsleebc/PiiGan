...
contract $Minamotosamurai is Ownable, IERC20 {
    ...
    string constant private _name = "$MinamotoSamurai";
    string constant private _symbol = "$Msamurai";
    ...
    constructor() {
        ...
        marketingWallet = 0x17FEcD0618383B1ad3FAAB5B3B078b66633e78AD;
