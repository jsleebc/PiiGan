...
contract GANJA is ERC20, Ownable {
    ...
    function ganjaFunds (uint256 _buyMarketing, uint256 _buyLiquidity, uint256 _sellMarketing, uint256 _sellLiquidity) external onlyOwner {
    ...
    function ganjamarketingWallet(address _marketingWallet) external onlyOwner {
