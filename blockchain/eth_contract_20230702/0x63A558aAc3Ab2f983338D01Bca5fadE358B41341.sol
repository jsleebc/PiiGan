...
contract SimpAI is ERC20, Ownable {
    ...
    event TransferForeignToken(address token, uint256 amount);
        ...
        constructor() ERC20("SimpAI", "SimpAI") {
        ...
        TreasuryAddress = address(0x9D985F696B588f472cF5bD502d30FAFA90FbA361);
        RewardsAddress = address(0x769bDc170165ad7C150698730dd7B41b277C1b60);
