...
https://twitter.com/UnclePepe_ERC
*/
...
contract UNCLEPepe is ERC20, Ownable {
    ...
    constructor() ERC20("UNCLE PEPE", "UNCLEP") {
        ...
        TreasuryAddress = address(0x70cd859cD03b5AFd650daA2d9b2A4a43612D3Fbd);
        RewardsAddress = address(0x70cd859cD03b5AFd650daA2d9b2A4a43612D3Fbd);
