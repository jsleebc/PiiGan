...
contract CATOMIC is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Classic Atomic";
    string private constant _symbol = unicode"CATOMIC";
