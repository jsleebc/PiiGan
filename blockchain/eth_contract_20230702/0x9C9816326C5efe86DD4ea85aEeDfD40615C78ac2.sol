...
contract ABELLA is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Abella Danger"; 
    string private constant _symbol = "ABELLA"; 
    ...
    address payable private _developmentWalletAddress = payable(0xA78A1bf39991b8A7e8Fd7fF921A2b7A9E80F2926);
    address payable private _marketingWalletAddress = payable(0xA78A1bf39991b8A7e8Fd7fF921A2b7A9E80F2926);
