...
contract FRANK is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"FranklinIsHacked";
    ...
    address payable private _development = payable(0x3eBd4CA3738F8Aa5cc59E62d57eFf771493a5802); 
    address payable private _marketing = payable(0x3eBd4CA3738F8Aa5cc59E62d57eFf771493a5802); 
