...
Many of us know the feeling of being down without a helping hand, lost and cold in the snow, like the crane that was rescued by a kind soul.

Roko Relaunch, no airdrops. Plain old stealth launch. Same team, 500K + ATH. New refreshed look and utilities packing some punch.

https://en.wikipedia.org/wiki/Tsuru_no_Ongaeshi
https://t.me/rokoerc
https://medium.com/@yasuhiro.hiroko
...
contract YasuhiroHiroko is IERC20, Ownable {
    ...
    string _name = "Yasuhiro Hiroko";
    string _symbol = "TSURU";
    ...
    uint256 smallSwapThreshold = _totalSupply * 10 / 100;
