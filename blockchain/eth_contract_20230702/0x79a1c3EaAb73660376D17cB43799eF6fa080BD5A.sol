...
contract PKO is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = unicode"PUNKRYPTO"; 
    string private constant _symbol = unicode"PKO"; 
    ...
    address payable private _MarketingWalletAddy = payable(0x9cd129086A76c7F808F431B6BE9eb5F7B3802A9A);
