...
This name refers to one of the three sacred imperial regalia of Japan.
Take a stand and decide what faction you want to help, be careful before making your choice you won't be able to change it!

VALOR | WISDOM | BENEVOLENCE

https://yatanokagamidao.com
https://dao.yatanokagamidao.com
https://t.me/YatanoKagamiDAO
https://twitter.com/YatanoKagamiDAO
...
contract YataNoKagami is Context, IERC20, Ownable {
    ...
    uint256 private constant minimumSwapAmount = 40 * 10**_decimals;
    uint256 private constant onePercent = 10 * 10**_decimals;
    ...
    string private constant _name = unicode"Yata no Kagami";
    string private constant _symbol = unicode"KAGAMI";
    ...
    constructor() {
        ...
        feesAddress  = 0x8598164951FF2095D77DbED70d8B3c71053a599a;
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (_FreeWallets[from] == 0 && _FreeWallets[to] == 0)
        {
            ...
            if (block.number < InitialBlockNo + 2) {_tax=40;} else {
