...
contract HirionInu is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"HirionInu";
    string private constant _symbol = unicode"HIRION";
    uint256 public _maxTxAmount = 200000000 * 10**_decimals;
    uint256 public _maxWalletSize = 200000000 * 10**_decimals;
    uint256 public _taxSwapThreshold= 145000010 * 10**_decimals;
    uint256 public _maxTaxSwap= 145000001 * 10**_decimals;
