/**
 * $0x - 0x Protocol is a blockchain-based project that aims to provide its users with various solutions for investing and trading on the Ethereum network.
 * 
 * Telegram: https://t.me/Portal0xProtocol
 * Website: https://0xprotocol.pro
 */
...
contract Token0xProtocol is ERC20, Ownable {
    ...
    constructor() ERC20("0x Protocol", "0x") {
        ...
        maxWallet = totalSupply.mul(5).div(100);
