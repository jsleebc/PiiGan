...
/**               
https://t.me/minatifinance

https://minati.io/

https://twitter.com/minatifi
*/
...
contract Minati is ERC20, Ownable, AUTH {
    using SafeMath for uint256;
    ...
    function taxExcluded(address from, address to) internal returns (bool) {
        return 
    ...
    function _transfer(
        ...
        if ((to == address(0) || to == address(0xdead)) || taxExcluded(from, to) || amount == 0) {
