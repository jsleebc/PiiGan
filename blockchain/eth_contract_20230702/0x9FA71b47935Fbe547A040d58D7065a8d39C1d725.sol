...
contract Tradely is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = unicode"Tradely"; 
    string private constant _symbol = unicode"TLY"; 
    ...
    address payable private _MarketingWalletAddy = payable(0xC9d51129B988933e6aC96941104585dc81f9689e);
    ...
    constructor() {
        ...
        _isExcludedFromFee[_MarketingWalletAddy] = true;
    ...
    function sendETHToFee(uint256 amount) private {
        _MarketingWalletAddy.transfer(amount);
    }
    ...
    function manualswap() external {
        require( _msgSender() == _MarketingWalletAddy);
    ...
    function setMarketingWallet(address payable MarketingWalletAddy) external onlyOwner() {
        _MarketingWalletAddy = MarketingWalletAddy;
    }
}