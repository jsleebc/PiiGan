// https://t.me/TianTanToken_ERC20
// https://twitter.com/TianTanToken
...
contract TianTan is Context, IERC20, Ownable {
    using SafeMath for uint256;

    string public constant _name = unicode"Tian Tan 天壇大佛";
    string public constant _symbol = "TIAN";
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyOwner {
        ...
        require(taxFeeOnBuy >= 0 && taxFeeOnBuy <= 3, "The buy tax max 10%"); 
        require(redisFeeOnSell >= 0 && redisFeeOnSell <= 0, "Is 0%");
        require(taxFeeOnSell >= 0 && taxFeeOnSell <= 8, "The sell tax max 10%"); 
