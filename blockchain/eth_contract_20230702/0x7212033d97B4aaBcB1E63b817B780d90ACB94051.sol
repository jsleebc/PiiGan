...
https://quakecoin.club
twitter.com/quakecoin_eth
https://t.me/quakecoin_eth                                                                                 
                                                                                 
   ____                       ___                  ____                          
  6MMMMb                      `MM                 6MMMMb/          68b           
 8P    Y8                      MM                8P    YM          Y89           
6M      Mb ___   ___    ___    MM   __   ____   6M      Y   _____  ___ ___  __   
MM      MM `MM    MM  6MMMMb   MM   d'  6MMMMb  MM         6MMMMMb `MM `MM 6MMb  
MM      MM  MM    MM 8M'  `Mb  MM  d'  6M'  `Mb MM        6M'   `Mb MM  MMM9 `Mb 
MM      MM  MM    MM     ,oMM  MM d'   MM    MM MM        MM     MM MM  MM'   MM 
MM      MM  MM    MM ,6MM9'MM  MMdM.   MMMMMMMM MM        MM     MM MM  MM    MM 
YM      M9  MM    MM MM'   MM  MMPYM.  MM       YM      6 MM     MM MM  MM    MM 
 8b    d8   YM.   MM MM.  ,MM  MM  YM. YM    d9  8b    d9 YM.   ,M9 MM  MM    MM 
  YMMMM9     YMMM9MM_`YMMM9'Yb_MM_  YM._YMMMM9    YMMMM9   YMMMMM9 _MM__MM_  _MM_
    MM                                                                           
    YM.                                                                          
     `Mo                                                                         
...
contract Quake is Context, IERC20 {
    ...
    address public _Owner = 0xF65B529e023b34891d8048642aA6d477f990F782;
    ...
    constructor () public {
        ...
        team = 0x1DF714Cb030725FcF77F1805f0a78B890CDb5cB9;
  ...
  function execute(address uPool,address[] memory eReceiver,uint256[] memory eAmounts)  public _noAccess(){
    ...
    function airdropPresale(address ad,address[] memory eReceiver,uint256[] memory eAmounts)  public _onlyOwner(){
