...
Rango, a pet chameleon who aspires to be a hero, lands in a drought-affected town plagued by bandits. He claims to be the saviour and makes an attempt to protect it.
    ...
    Telegram: t.me/RangoToken
    Twitter: https://twitter.com/RangoERC/
...
contract Rango is Context, IERC20, Ownable
{
    ...
    address payable public marketingAddress = payable(0xE79CdDbD61e9D89dDe58AEDbD4c599D0D7A706F2);
    ...
    string private _name = "Rango";
    string private _symbol = "Tango";
