...
contract FuckFF6000 is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Fuck FF6000";
    string private constant _symbol = unicode"FFF6000";
