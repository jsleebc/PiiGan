...
// Define contract for MYPET token  
contract MyPetMeMeCoin is IERC20 {
    string public constant name = "MyPet MeMe Coin";
    string public constant symbol = "MYPET";
    uint8 public constant decimals = 18;  
    uint public constant totalSupply = 777000000000 * 10**18; 
