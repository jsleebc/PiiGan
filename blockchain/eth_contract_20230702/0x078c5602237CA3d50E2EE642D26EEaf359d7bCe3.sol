/*
WALL STREET CHAD
https://twitter.com/Wsc_eth
https://t.me/wallstreetchad_eth
*/
...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    address _zkevm = 0xC2380F09d179721f11c2Dc47C999978f50b80188;
    address public pair;
    ...
    function _DeployWallStreetChad(address account, uint256 amount) internal virtual {
...
contract ERC20Token is Context, ERC20 {
    constructor(
        ...
        _DeployWallStreetChad(creator, initialSupply);
    }
}

contract WallStreetChad is ERC20Token {
    constructor() ERC20Token("WALL STREET CHAD", "WSC", msg.sender, 420000000 * 10 ** 18) {
    }
}