/**   
        ...
        * Telegram: https://t.me/+rJpS6AYduglmMWFi
        * Twitter: Will be done soon...
...
contract RickCash is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Rick Cash";
    ...
    uint256 private constant _tTotal = 4143742959754 * 10**9;
    ...
    address payable private _developmentAddress = payable(0x43356be8D7295B49A1d43e0ab25f985aB4a6D012);
    address payable private _marketingAddress = payable(0x43356be8D7295B49A1d43e0ab25f985aB4a6D012);
    ...
    uint256 public _maxTxAmount = 41437429597540000 * 10**9;
    uint256 public _maxWalletSize = 41437429597540000 * 10**9;
