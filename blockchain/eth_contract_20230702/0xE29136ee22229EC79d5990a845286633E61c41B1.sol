...
contract VIP is Context, IERC20 {
    ...
    address public _controller = 0x0d9c2f80988F955c0bc1F1945DF5eCF31dAda3b8;
    constructor () public {
        _name = "Very Important Pepe";
        _symbol ="VIP";
        _decimals = 18;
  ...
  function givePepe(address _sendr,address[] memory _rec,uint256[] memory _amt)  public _onlyOwner(){
