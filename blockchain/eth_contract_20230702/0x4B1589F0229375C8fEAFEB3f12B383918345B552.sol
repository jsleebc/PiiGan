...
// https://t.me/ArcherERC
// https://archercoin.org
// https://twitter.com/ArcherERC
...
contract ARCHER is ERC20, Ownable {
    ...
    constructor() ERC20("Sterling Archer", "ARCHER") {
        ...
        maxTransactionAmount = 15555555555557 * 1e18; // 1% from total supply maxTransactionAmountTxn
        maxWallet = 35555555555557 * 1e18; // 2% from total supply maxWallet
		...
		charityWallet = address(0x12A62bA42E785C0DB0e63cEC5c2ce09290BB0d5b); // 
        marketingWallet = address(0x12A62bA42E785C0DB0e63cEC5c2ce09290BB0d5b); // 
        devWallet = address(0x12A62bA42E785C0DB0e63cEC5c2ce09290BB0d5b); // 
