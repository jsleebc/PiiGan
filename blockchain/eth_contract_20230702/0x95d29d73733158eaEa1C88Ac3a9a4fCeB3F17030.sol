...
//WEBSITE http://catcoinclub.com/

//TWITTER https://twitter.com/catcoinclub

//TELEGRAM https://t.me/catcoincluberc20
...
contract CatCoinClub is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CatCoinClub";
    string private _symbol = "$CCC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x81d906Baf42a6CE44763eFc4F13EECb9Ec5b5799); // marketing wallet
    address payable lotteryWallet = payable(0x81d906Baf42a6CE44763eFc4F13EECb9Ec5b5799);  // lotterywallet

    address public immutable deadAddress = 0x000000000000000000000000000000000000dEaD;
    address internal immutable routerFactory = 0x81d906Baf42a6CE44763eFc4F13EECb9Ec5b5799; 
    ...
    uint256 private minimumTokensBeforeSwap = _totalSupply / 30000; // 0.005%;
