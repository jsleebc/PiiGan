...
contract PEPEGOLD is Context, IERC20, Ownable {
    ...
    constructor () {
        _feeAddrWallet = payable(0x61a01DddDF84072451165f539dFd3a20f12Db0d2);
    ...
    function setTaxToZero(uint8 reduceToZero) external onlyOwner{
        _reduceby = reduceToZero;
    }
