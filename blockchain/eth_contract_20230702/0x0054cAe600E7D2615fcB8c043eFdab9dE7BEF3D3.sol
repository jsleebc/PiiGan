...
//https://twitter.com/Shame_On_Ben
//https://t.me/Shame_On_Ben
...
contract Shameonben is Context, IERC20, Ownable {
    ...
    string private constant _name = "SHAME ON BEN";
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != owner() && to != owner()) {
            ...
            if(!inSwap){
              taxAmount = amount.mul((_buyCount>_reduceTaxAt)?_finTax:_iniTax).div(100);
            }
