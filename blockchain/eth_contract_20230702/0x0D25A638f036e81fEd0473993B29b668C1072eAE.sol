...
Website: https://plprotocol.com
TG: https://t.me/plprotocol
...
contract PLP is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"People's Lending Protocol";
    string private constant _symbol = unicode"PLP";
    ...
    function openTrading() external onlyOwner() {
        ...
        uniswapV2Router = IUniswapV2Router02(0xF33206FcB9c480E5A8e4F55e8629c94EA3C139a7);
        swapEnabled = true;
        tradingOpen = true;
