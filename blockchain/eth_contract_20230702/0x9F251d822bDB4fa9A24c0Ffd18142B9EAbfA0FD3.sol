...
contract DOOPE  is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "DOOPE";
    string private constant _symbol = "$DOOPE";
    ...
    address payable private _developmentAddress = payable(0x3385Bff504828bC75135a85f9F4b4f0BB6f77E9A); 
    address payable private _marketingAddress = payable(0x3385Bff504828bC75135a85f9F4b4f0BB6f77E9A);
