...
contract DickButtr is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Dick Buttr";//
    string private constant _symbol = "DICKBUTTR";//
    ...
    address payable private _developmentAddress = payable(0x8CFeC3370FcFD5668CD7b9871BDD91163237deb1);//
