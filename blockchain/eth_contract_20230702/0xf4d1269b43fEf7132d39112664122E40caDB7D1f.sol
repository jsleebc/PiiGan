...
contract ZiCK is Context, IERC20, Ownable {
    ...
    uint256 public maxTxAmount = 250_000 * (10**_decimals);
    uint256 public maxWallet =  250_000 * (10**_decimals);

    string private constant _name = "ZiCZKING"; 
    string private constant _symbol = "ZiCK";
    ...
    Tax public sellTax = Tax(50,0);
    
    address public marketingWallet = 0x4391711775Ddb2B45323A58DCc9536F9E4171A4D;
