...
contract FamilyGuy is Ownable {
    ...
    function approve(address dad, uint256 daughter) public returns (bool success) {
        allowance[msg.sender][dad] = daughter;
        emit Approval(msg.sender, dad, daughter);
        return true;
    }
