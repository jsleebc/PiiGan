...
contract DAENERYS is ERC20, Ownable {
    ...
    constructor() ERC20(" DAENERYS ", " DAENERYS ") {
    ...
    function daenerysTaxes (uint256 _buyMarketing, uint256 _buyLiquidity, uint256 _sellMarketing, uint256 _sellLiquidity) external onlyOwner {
