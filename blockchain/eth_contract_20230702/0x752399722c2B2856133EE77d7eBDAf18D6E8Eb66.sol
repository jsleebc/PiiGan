...
// File contracts/PulseLinda.sol

pragma solidity ^0.8.0;


contract PulseLinda is Ownable, ERC20 {
    ...
    uint256 public sellMarketingFee = 15; // 1% sell marketing fee
    ...
    constructor() ERC20("PulseLinda", "CEO") {
         address _uniswapV2Pair = IUniswapV2Factory(router.factory())
            .createPair(address(this), router.WETH());
           uniswapV2Pair   = _uniswapV2Pair;
           marketingWallet = address(0x0dFc143E2cb1E9FDeF741e1d919AB3371E4A8F80); //0x0dFc143E2cb1E9FDeF741e1d919AB3371E4A8F80

           excludedFromFees[address(this)] = true;
           excludedFromFees[msg.sender] = true;
           excludedFromFees[marketingWallet] = true;

            _mint(msg.sender, 69420000000000000000000000000); //69,420,000,000.000000000000000000 CEO
    }
