...
Communication through Twitter Soon !!!!!!
...
contract UNSWYPE is Context, IERC20, Ownable {
    ...
    string private constant _name = "UNSWYPE";
    string private constant _symbol = "USWYPE";
    ...
    constructor () {
        ...
        _feeAddrWallet = payable(0x95DA25A212a5cB1Ac6fd33956dFB8fC0ba9D0E13);
    ...
    function updateBuyFee(uint256 _fee) external onlyOwner {
        require(_fee <= 5, 'fee can not set more than 10%');
        _tokensBuyFee = _fee;
    }
