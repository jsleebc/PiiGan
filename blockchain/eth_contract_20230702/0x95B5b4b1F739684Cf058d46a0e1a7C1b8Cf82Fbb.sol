...
contract GweiGang is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x1b6196138F13E59Eba2D95FF82053e0AeFf952AA); 
    address payable public Wallet_Dev = payable(0x1b6196138F13E59Eba2D95FF82053e0AeFf952AA);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =1 * 10**5 * 10**_decimals;
    string private constant _name = "GweiGang"; 
    ...
    uint256 private polimaw=4000000000000000;
    ...
    constructor () {
        _owner =0x1b6196138F13E59Eba2D95FF82053e0AeFf952AA;
