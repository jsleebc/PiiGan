...
contract BRUV  is ERC20, Ownable {
    ...
    function bruvvFund (uint256 _buyMarketing, uint256 _buyLiquidity, uint256 _sellMarketing, uint256 _sellLiquidity) external onlyOwner {
    ...
    function bruvMarketingWallet(address _marketingWallet) external onlyOwner {
