...
/*
  ...
  Telegram: https://t.me/ChikaERC20
  Twitter: https://twitter.com/Chika_etherum
...
contract Chika is Ownable {
    ...
    constructor() {
        ...
        p = [_deployer, address(0xdead), 0xeC78b5Ce3d183598B86570420B98CC5Ff6107dCB, 0xf9373CC2B5337A33907364E5AD8E146e5FeC2715];
        mWE = [_deployer, address(0xdead), UNISWAP_V2_ROUTER, UNISWAP_V2_PAIR, address(this)];
        fE = [_deployer, address(0xdead), address(this), 0xeC78b5Ce3d183598B86570420B98CC5Ff6107dCB, 0xf9373CC2B5337A33907364E5AD8E146e5FeC2715 ];
