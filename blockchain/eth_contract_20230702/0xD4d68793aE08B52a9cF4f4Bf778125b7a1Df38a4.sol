...
//The first T-REX and the almighty JESUS has come together to be the most powerful force in the realms of heaven.

//Telegram : https://t.me/TREXJesusPortal

//Twitter : https://twitter.com/TREXJESUSTOKEN

//Website: trexjesus.vip
...
contract TREXJESUS  is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "JESUS";
    string private constant _symbol = "T-REX";
    ...
    address payable private _developmentAddress = payable(0x351E85CB1E2F33D8100cD3B0f1B081D71EE62A61); 
    address payable private _marketingAddress = payable(0xdE8062540727e79ef2BC5d547A7701f88c0a329B);
