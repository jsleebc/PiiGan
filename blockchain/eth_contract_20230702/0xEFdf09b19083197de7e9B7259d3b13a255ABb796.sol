...
contract Pangea is Context, IERC20, Ownable { 
    ...
    address payable public _MARKET_ADDRESS_ = payable(0xeBf251630279f2b3FdF5D6804DaF8aa184744d25);
    ...
    string public _name = "Pangea";
    string public _symbol = "Pangea";
