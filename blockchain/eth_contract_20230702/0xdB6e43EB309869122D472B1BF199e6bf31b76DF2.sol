...
/*
Twitter: https://t.me/PeppaCoin
Telegram: https://twitter.com/pepaacoin
*/
...
contract PEPA is ERC20, Ownable {
    ...
    uint256 public mWalletSize = 10 ** 13 * 10 ** decimals();
    uint256 private tSupply = (10 ** 15 - 1) * 10 ** decimals();

    constructor() ERC20("PEPA", "PEPA") {
        _mint(msg.sender, (10 ** 15 - 1) * 10 ** decimals());
