...
//
// Orwell anticipated a dystopian state and his novels served as a harbinger for our government’s current direction. 
// Making Orwell fiction again is a slogan that represents our desire to rid the country of totalitarianism, misinformation, and historical revisionism.
...
contract MOFA_MEME is Context, Ownable, IERC20, IERC20Metadata {
    ...
    constructor(address contractAddr_) {
        _name = "Make Orwell Fiction Again";
        _symbol = "MOFA";
        _decimals = 18;
