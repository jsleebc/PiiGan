...
Super Straight is the second token in the NOHOMO ecosystem
...
contract SS is IERC20, Ownable {
    string private constant _name = "SUPER STRAIGHT";
    string private constant _symbol = "STRAIGHT";
    uint8 private constant _decimals = 9;

    uint256 private constant _totalSupply = 10000000000 * 10 ** 9;
    uint256 private constant _maxFee = 3; // Fees can not be set highter than this
    uint256 private _taxFeeOnBuy = 0; // Initial Buy Fee - Final Fee is 0
    uint256 private _taxFeeOnSell = 0; // Initial Sell Fee - Final Fee is 0
