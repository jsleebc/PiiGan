...
contract BOOBS {
    ...
    string public constant name = "Boobies";   
    string public constant symbol = "BOOBS";   
    ...
    address payable constant deployer = payable(address(0x2219c660117ad116C9E5792DbAfEFaAcf54026e5));
