...
/*
I remember the good old days when I could invest in $ETH at a very low cost and make decisive decisions on whether I should invest. The returns on these projects were often hundreds or even thousands of times my initial investment. However, as more project teams entered the field, things changed. Nonetheless, we still had opportunities to invest in projects such as $Aave and $Babydoge, which still offered considerable returns. I could decide to HODL.
...
contract HOLD is Ownable, ERC20 {
    ...
    constructor(address router_, address marketing_) ERC20("HOLD", "HOLD") payable 
    {
