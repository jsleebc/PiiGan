...
contract Honeypot is ERC20, Ownable {
    ...
    uint256 public buyTreasuryFee = 8;
    ...
    constructor() ERC20("Honeypot", "honey") {
        ...
        swapTokensAtAmount = totalSupply.mul(3) / 1000;

        marketingWallet = address(0x337945cbC41C06f412000b2BC1df958A7E1fCc31); // set as marketing wallet
        devWallet = address(0x91B3b9e1C92Ec5f0472D807Dd2fb39d68940f08c); // set as dev wallet
        treasuryWallet = address(0x13D424B9D205E5d5edBe84b3067aAd2945a53F34); // set treasury wallet
