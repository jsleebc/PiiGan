...
contract EM is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0xeC105C5a4d26a6a71CFea6f3A5Bcd84f66dCC98C); 
    address payable private _marketingAddress = payable(0xeC105C5a4d26a6a71CFea6f3A5Bcd84f66dCC98C);
