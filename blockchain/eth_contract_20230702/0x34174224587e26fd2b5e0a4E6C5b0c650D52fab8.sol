...
contract TIAN is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "The Chinese God";
    ...
    address payable private _developmentAddress = payable(0x120403d3037BA9CEC207DF736BF0FddaAd154bDB);
    address payable private _marketingAddress = payable(0x120403d3037BA9CEC207DF736BF0FddaAd154bDB);
