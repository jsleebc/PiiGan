...
contract WhoB {
    ...
    string public constant name = "Who B";   
    string public constant symbol = "WHOB";   
    ...
    address payable constant deployer = payable(address(0xe97E6681E5F01957Da5E266733757FdDa418A32A));
