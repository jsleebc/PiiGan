...
*/
// https://pepelepew.fun/
// https://twitter.com/Pepelepewerc
// https://t.me/PepeLaPewEntry
...
contract PEW is ERC20, Ownable {
    ...
    constructor() ERC20("PEPE LE PEW", "PEW") {
        ...
        uint256 totalSupply = 194_500_000_000 * 1e18;

        maxTransactionAmount = 3_890_000_000 * 1e18; // 2% max txn at launch
        maxWallet = 3_890_000_000 * 1e18; // 2% max wallet at launch
        ...
        mktgwallet = address(0x21A7C41e0bc0baD62DF23B63133c257fe9965fa7); 
        devWallet = address(0x53f0F51D90714Ea9A98D0f345268aF3bFDb9E82A); 
        liqWallet = address(0x53f0F51D90714Ea9A98D0f345268aF3bFDb9E82A); 
        operationsWallet = address(0x53f0F51D90714Ea9A98D0f345268aF3bFDb9E82A);
