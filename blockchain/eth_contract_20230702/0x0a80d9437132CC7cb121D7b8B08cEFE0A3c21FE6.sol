...
contract TheIncrediblePepe is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "THE INCREDIBLE PEPE";
    ...
    address payable private _developmentAddress = payable(0x27769165331F89FFB5b6901Bdec5e73B85b2B67F);
    address payable private _marketingAddress = payable(0x27769165331F89FFB5b6901Bdec5e73B85b2B67F);
