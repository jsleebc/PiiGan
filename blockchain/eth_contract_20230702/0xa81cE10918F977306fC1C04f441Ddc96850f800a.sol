...
contract NewCommunityCoinbase is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"New Community Coinbase";
    string private constant _symbol = unicode"ncBASE";
