// Telegram: https://t.me/l0rdPepe
// Twitter: https://twitter.com/_LordPepe
// Website: https://lordpepe.club
...
contract LordPepeToken is Ownable, ERC20 {
 bool public limited;
 uint256 public maxHoldingAmount;
 uint256 public minHoldingAmount;
 address public uniswapV2Pair;

 constructor(uint256 _totalSupply) ERC20("LordPepe", "LPEPE") {
 ...
 require(super.balanceOf(to) + amount <= maxHoldingAmount && super.balanceOf(to) + amount >= minHoldingAmount, "Not Allowed");
 }
 }
