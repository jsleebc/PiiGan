...
contract WildShooter is ERC20 , ReentrancyGuard, Ownable {
    constructor() ERC20("WildShooter", "WILD") {}
    ...
    function claimSocialExperimentTokenThisIsNotAnInvestment() external nonReentrant callerIsUser {
        ...
        require(balanceOf(msg.sender) == 0, "You already have some");
