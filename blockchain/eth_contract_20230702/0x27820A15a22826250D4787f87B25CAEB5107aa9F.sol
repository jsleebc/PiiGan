...
Web:https://www.TadeoCoin.com
Telegram: https://T.Me/TadeoCoin
Twitter: https://twitter.com/TadeoCoin
...
contract Tadeo is ERC20, Ownable {
    ...
    function removeTadlimits() external onlyOwner returns (bool){
    ...
    function manageTad_bots(address _address, bool status) external onlyOwner {
