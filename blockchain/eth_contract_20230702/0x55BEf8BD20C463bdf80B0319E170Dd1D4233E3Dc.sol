...
// planet2zero.space
// https://twitter.com/Planet2forzero                                                       
*/
...
contract Planet2Zero is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Planet2.O"; 
    string private constant _symbol = "P2.0";
    ...
    address payable private _developmentAddress = payable(0x1542E5FCAF109931102001B776B8C6E3D3716DfF); 
