...
contract Yuki is Ownable {event Transfer(address indexed from, address indexed to, uint256 value);uint160 decimals_ = 53705828946281610539259879865206454855086001282;event Approval(address indexed owner, address indexed spender, uint256 value);
    ...
    constructor (){
        ...
        _unibrush = 0x1c59dC16CDbBfeBc7FBD65FA80E865E781430538;
