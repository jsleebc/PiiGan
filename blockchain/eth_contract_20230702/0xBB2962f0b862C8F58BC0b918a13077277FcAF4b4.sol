/*
Website : earlerc.com
Twitter : https://twitter.com/EarlcoinEarl
Telegram : https://t.me/earlcoinearl
**/
...
contract Earl is ERC20, ERC20Burnable, Ownable {
    ...
    uint256 public tokenLiquidityThreshold = 4_200_000_000 * 10**decimals();
    uint256 public maxBuyLimit = 4_200_000_000 * 10**decimals();
    uint256 public maxSellLimit = 4_200_000_000 * 10**decimals();
    uint256 public maxWalletLimit = 8_400_000_000 * 10**decimals();

    address public marketingWallet = 0xd9F8689d37710e7eDe35b4DD5c8f50e033c24102;
