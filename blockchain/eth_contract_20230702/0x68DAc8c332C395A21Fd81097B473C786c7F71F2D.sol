...
https://twitter.com/PepeRedCoin
http://www.peperedcoin.wtf/
https://t.me/RedPepeToken
...
contract REDPEPE is ERC20, Ownable {
    ...
    constructor() ERC20("Red Pepe", "REPE") {
        ...
        maxWallet = 840000 * 1e18; // 2% from total supply maxWallet
		...
		charityWallet = address(0x41A492d98E4080cdAfd9943E451B10a1D06b9309); // set as charity wallet
        marketingWallet = address(0x41A492d98E4080cdAfd9943E451B10a1D06b9309); // set as marketing wallet
        devWallet = address(0x41A492d98E4080cdAfd9943E451B10a1D06b9309); // set as dev wallet
