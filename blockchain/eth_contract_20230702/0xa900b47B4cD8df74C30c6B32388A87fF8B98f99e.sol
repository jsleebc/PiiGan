/*
Andrew Tate's secret account.
https://www.instagram.com/scholarterrific/
*/
...
contract TERRIFIC is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "SCHOLAR TERRIFIC";
    string private constant _symbol = "TERRIFIC";
    ...
    address payable private _developmentAddress = payable(0x639bA7775e2D7B569a250463Ee73C32ebFF76e2B); 
    address payable private _marketingAddress = payable(0x639bA7775e2D7B569a250463Ee73C32ebFF76e2B);
