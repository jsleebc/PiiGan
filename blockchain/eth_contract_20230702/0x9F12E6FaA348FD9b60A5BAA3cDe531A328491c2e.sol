...
/*
https://twitter.com/NOMEVERC

$NOMEV is the first actual token that takes care of bots.


Bots will not be able to front run you and you aren't limited in anyway.


$NOMEV features  a 20% tax is you sell withing 24 hours.

But here is a catch. To avoid paying the tax you simply transfer the tokens to another wallet

and you are paying 0% tax to sell.

This is the safest way to avoid MEV bots.
...
contract NOMEV is ERC20, Ownable {
    ...
    address payable public marketingWallet = payable(0xc13A559a0a4806772A87459c2C420654E4dB7BeB);
    address payable public devWallet = payable(0xcEc2Bc745de5E5b170411F599996E28403BC5bE6);
    ...
    constructor() ERC20("NO MEVS", "NOMEV") {
