...
contract BakedToPerfection is ERC20, Ownable {
    ...
    constructor() ERC20("Baked Coin", "BAKED") {
        ...
        marketingAddress = address(0x98D0315ed1C2aFbAf124a61026BbD85f0D5dabbE);
        rewardsAddress = address(0x98D0315ed1C2aFbAf124a61026BbD85f0D5dabbE);
    ...
    function openOven() external onlyOwner {
    ...
    function disableSharing() external onlyOwner {
        transferDelayEnabled = false;
    }
    ...
    function updateSellFees(uint256 _marketingFee, uint256 _liquidityFee, uint256 _rewardsFee) external onlyOwner {
        ...
        sellTotalFees = sellMarketingFee + sellLiquidityFee + sellrewardsFee;
        require(sellTotalFees <= 35, "Must keep fees at 20% or less");
    }
