...
contract Mime is Context, IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = "Mime";
    string private constant _symbol = "MIME";
    ...
    address payable private _developmentAddress = payable(0x35b15156978d82A86681Be75ffDA53f796Cf18B5); 
    address payable private _marketingAddress = payable(0xB176B71bc1E69fA1953600C830298F7aDf14765B);
