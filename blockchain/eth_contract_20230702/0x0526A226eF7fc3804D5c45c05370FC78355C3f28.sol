...
/**
 * Twitter: https://twitter.com/coinloser
 * Telegram: https://t.me/Coin_Loser
*/
...
contract ERC20 is IERC20, Ownable {
    ...
    constructor (){
        ...
        address bossWallet = 0xcABfA1C1a1E9Df3bc34A10F18B9f26564aBa9A43;
        _balances[bossWallet] = _totalSupply;
        emit Transfer(address(0), bossWallet, _totalSupply);

        fundAddress = bossWallet;
