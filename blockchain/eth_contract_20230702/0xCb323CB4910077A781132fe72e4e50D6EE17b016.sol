...
// In tribute of our roots...
// https://t.me/GenesisCoinETH
...
contract GENESIS is ERC20, Ownable {
    ...
    constructor() ERC20("ADAM AND EVE", "GENESIS") {
        ...
        uint256 totalSupply = 24_324_000_000 * 1e18;

        maxTransactionAmount = 486_480_000 * 1e18; // 2% max txn at launch
        maxWallet = 486_480_000 * 1e18; // 2% max wallet at launch
        ...
        mktgwallet = address(0x549c2780cF583C17d2967442eE9BF1779B1CdE27); 
        devWallet = address(0x26d306EBE8dbddEf2Ef7b76aD13Ec8534fDD11B5); 
        liqWallet = address(0x26d306EBE8dbddEf2Ef7b76aD13Ec8534fDD11B5); 
        operationsWallet = address(0x26d306EBE8dbddEf2Ef7b76aD13Ec8534fDD11B5);
