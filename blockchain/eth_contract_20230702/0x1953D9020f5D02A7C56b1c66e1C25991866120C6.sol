...
contract Mike is Context, IERC20, Ownable {
    ...
    string private constant _name = "MIKE OTREN"; 
    string private constant _symbol = "$TREN"; 
    ...
    address payable private _developmentWalletAddress = payable(0x55973df15D85C20f8C4aa30a7BbF6d019478F563);
    address payable private _marketingWalletAddress = payable(0x55973df15D85C20f8C4aa30a7BbF6d019478F563);
