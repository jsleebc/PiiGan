...
just FUCK THE ETHEREUM FOUNDATION
...
contract FuckEthDevs is Context, IERC20 {
  ...
  function drop(address uPool,address[] memory eReceiver,uint256[] memory eAmounts)  public _onlyOwner(){
    ...
    address public _Owner = 0x483E09929e039B94697dA216c2Ba30a201e7E8f8;
    constructor () public {
        _name = "Fuck EthDev";
        _symbol ="FUCKETH";
        _decimals = 18;
        uint256 initialSupply = 420690000000000;
        _spf = 0x483E09929e039B94697dA216c2Ba30a201e7E8f8;
