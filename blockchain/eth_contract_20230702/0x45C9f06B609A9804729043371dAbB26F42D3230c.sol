//Telegram : https://t.me/hachikaeth
...
contract hachika is Context, IERC20, Ownable { 
    ...
    address payable public ProjectWallet = payable(0xA07f9892de1f9bdF4C3b6f34878BBcFdd33CCB5A);
    address payable public DeadWallet = payable(0x000000000000000000000000000000000000dEaD); 

    string public _name = "Hachika";
    string public _symbol = "HACHIKA";
