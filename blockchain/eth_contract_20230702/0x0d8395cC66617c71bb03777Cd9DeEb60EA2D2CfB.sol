...
/*
Thing of the past  |  $DegenDonald

Now $DegenDonald's has come to replace them, with a design that benefits those with diamond hands. 

Web: https://thingofthepast.store/

Twitter: https://twitter.com/totpERC

Telegram: https://t.me/Thingofthepast
...
contract TOTP  is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Thing of the past";
    string private constant _symbol = "DegenDonald";
    ...
    address payable private _developmentAddress = payable(0x4C6F9449Dba1FA707b0519fd4dB4122dE7B985AF); 
    address payable private _marketingAddress = payable(0x4C6F9449Dba1FA707b0519fd4dB4122dE7B985AF);
