...
/**
       ...
       A DeFi token on ERC-20 coin that supports and celebrates space
        exploration and building a full service suite of DeFi products 
        including Staking Pools to earn boosted rewards and an all 
        encompassing data analytics and trading platform for DOMO COIN holders.

Twitter  : https://twitter.com/DOMOCOINERC
Website  : https://www.domocoin.info/
...
contract DOMO {
    ...
    string public name = "DOMO COIN";
    string public symbol = "DOMO";
    uint256 public totalSupply = 699999999999999900000000000;
