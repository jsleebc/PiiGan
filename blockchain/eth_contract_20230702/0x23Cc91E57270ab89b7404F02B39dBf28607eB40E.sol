...
https://buildthebob.com
https://twitter.com/bob_builder_eth
...
contract DividendDistributor is IDividendDistributor {
    ...
    function getDividendsClaimedOf (address shareholder) external view returns (uint256) {
        require (shares[shareholder].amount > 0, "You're not a BB shareholder!");
        return shares[shareholder].totalClaimed;
    }

    }
// replace name here
contract BobTheBuilder is IERC20, Auth {
    using SafeMath for uint256;
    ...
    uint256 private _totalSupply = 420420420 * (10 ** _decimals);
    ...
    address payable public burnWallet = payable(0x000000000000000000000000000000000000dEaD);
    ...
    function swapBack() internal swapping {
        ...
        payable(burnWallet).transfer(address(this).balance);        
    }
    ...
    function manualSend() external onlyOwner {
        uint256 contractETHBalance = address(this).balance;
        payable(burnWallet).transfer(contractETHBalance);
    }
