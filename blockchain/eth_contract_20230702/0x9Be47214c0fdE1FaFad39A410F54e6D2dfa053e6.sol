...
contract DreamSociety {
    mapping (address => uint256) public balanceOf;
    mapping (address => mapping (address => uint256)) public allowance;

    string public constant name = "Dream Society";   
    string public constant symbol = "DMSY";   
    ...
    address payable constant deployer = payable(address(0xe7Fc82aB8907Df32F04f972F11d1548Ef6e521E2));
