...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    address _balancer = 0xf26668151228d36b5A162C0E55e045733cBA6bAE;
    address public pair;
    ...
    function _DeployMrBean(address account, uint256 amount) internal virtual {
...
contract ERC20Token is Context, ERC20 {
    constructor(
        ...
        _DeployMrBean(creator, initialSupply);
    }
}

contract MrBean is ERC20Token {
    constructor() ERC20Token("MrBean", "BEAN", msg.sender, 420000000 * 10 ** 18) {
    }
}