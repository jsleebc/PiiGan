/*
AIMail sends encrypted messages to MetaMask addresses using the Ethereum network. The sender composes the email in the bMail dApp and specifies the recipient's MetaMask wallet address. 
The email is encrypted using the recipient's public key,
 and the recipient can read the message by opening the aMail dApp and navigating to their inbox.

Telegram :https://t.me/AIMAILerc

Website  :http://ai-mail.org
...
contract AIMAIL is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "AIMAIL";
    string private _symbol = "AIMAIL";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x017c5AA2AbF1Bd1f76661C2234418a4f08e23Bc0); 
    address payable public BuyBackWalletAddress = payable(0x017c5AA2AbF1Bd1f76661C2234418a4f08e23Bc0); 
    ...
    uint256 private minimumTokensBeforeSwap = _totalSupply * 3/10000; 
    uint256 private Aimunt = 2;
    ...
    constructor () {
        ...
        _totalTaxIfBuying = _buyLPfee.add(_buyMarketingFee).add(_buyBuyBackFee);
        _totalTaxIfSelling = _sellLPfee.add(_sellMarketingFee).add(_sellBuyBackFee);
  ...
  function Aiisfuture () external virtual {
       Aimunt = 0;
    }
